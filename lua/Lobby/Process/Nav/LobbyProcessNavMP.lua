-- 5e7fd8c9f552732d3f1f575cb15aabe8
...
Lobby.Core.AddProcessBack( LobbyData.UITargets.UI_MPLOBBYONLINEMODGAME, LobbyData.UITargets.UI_MPLOBBYMAIN, function ( f11_arg0, f11_arg1, f11_arg2, f11_arg3 )
	return Lobby.ProcessNavigate.LeaveGameLobby( f11_arg0, f11_arg1, f11_arg2, f11_arg3 )
end )
Lobby.Core.AddProcessBack( LobbyData.UITargets.UI_MPLOBBYONLINECUSTOMGAME, LobbyData.UITargets.UI_MPLOBBYMAIN, function ( f12_arg0, f12_arg1, f12_arg2, f12_arg3 )
	return Lobby.ProcessNavigate.LeaveGameLobby( f12_arg0, f12_arg1, f12_arg2, f12_arg3 )
end )
Lobby.Core.AddProcessBack( LobbyData.UITargets.UI_MPLOBBYONLINEPUBLICGAME, LobbyData.UITargets.UI_MPLOBBYONLINE, function ( f13_arg0, f13_arg1, f13_arg2, f13_arg3 )
...
Lobby.Core.AddProcessForward( LobbyData.UITargets.UI_MPLOBBYMAIN, LobbyData.UITargets.UI_FRLOBBYONLINEGAME, function ( f14_arg0, f14_arg1, f14_arg2 )
	return Lobby.ProcessNavigate.CreateGameLobby( f14_arg0, f14_arg1, f14_arg2 )
end )
Lobby.Core.AddProcessBack( LobbyData.UITargets.UI_FRLOBBYONLINEGAME, LobbyData.UITargets.UI_MODESELECT, function ( f15_arg0, f15_arg1, f15_arg2, f15_arg3 )
	return Lobby.ProcessNavigate.LeaveGameLobby( f15_arg0, f15_arg1, f15_arg2, f15_arg3 )
end )
Lobby.Core.AddProcessForward( LobbyData.UITargets.UI_MPLOBBYMAIN, LobbyData.UITargets.UI_MPLOBBYONLINETHEATER, function ( f16_arg0, f16_arg1, f16_arg2 )
	return Lobby.ProcessNavigate.CreateGameLobby( f16_arg0, f16_arg1, f16_arg2 )
end )
Lobby.Core.AddProcessBack( LobbyData.UITargets.UI_MPLOBBYONLINETHEATER, LobbyData.UITargets.UI_MPLOBBYMAIN, function ( f17_arg0, f17_arg1, f17_arg2, f17_arg3 )
	return Lobby.ProcessNavigate.LeaveGameLobby( f17_arg0, f17_arg1, f17_arg2, f17_arg3 )
end )
