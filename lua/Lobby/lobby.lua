-- 3fb68d8ee744d35ff6f0949aa678c1ed
...
LobbyVM = {
	...
	lobbyMonitor = {},
	lobbyMonitor = false,
	DevGui = function ( f2_arg0, f2_arg1 )
		if f2_arg0 ~= nil then
	...
	PlaySound = function ( f5_arg0, f5_arg1 )
	...
	ExecuteLobbyVMRequest = function ( f6_arg0 )
	...
	ErrorShutdown = function ( f7_arg0 )
	...
	OnSessionStart = function ( f12_arg0 )
	...
	OnSessionEnd = function ( f13_arg0 )
	...
	OnClientAdded = function ( f14_arg0 )
	...
	OnClientRemoved = function ( f15_arg0 )
	...
	OnMatchStart = function ( f16_arg0 )
	...
	OnMatchLaunchClient = function ( f17_arg0 )
	...
	OnMatchChangeGameType = function ( f18_arg0 )
		Lobby.Steam.OnMatchChangeGameType( f18_arg0 )
	end,
	OnMatchChangeMap = function ( f19_arg0 )
	...
	OnMatchRecordStart = function ( f21_arg0 )
		LuaUtils.LogQoS( "match_record", f21_arg0 )
	end,
	OnLobbyServerListRetrieved = function ( f22_arg0 )
		Lobby.Steam.OnLobbyServerListRetrieved( f22_arg0 )
	end,
	OnLobbyServerCountUpdated = function ( f23_arg0 )
		Lobby.Steam.OnLobbyServerCountUpdated( f23_arg0 )
	end,
	OnLobbyServerListSorted = function ( f24_arg0 )
		Lobby.Steam.OnLobbyServerListSorted( f24_arg0 )
	end,
	ShouldShowContentChangedMessage = function ( f25_arg0, f25_arg1 )
	...
	OnDisconnect = function ( f26_arg0 )
	...
	OnLobbyOnlineUpdate = function ( f27_arg0 )
		Lobby.Matchmaking.OnLobbyOnlineUpdate( f27_arg0 )
	end,
	OnLeaveWithParty = function ( f28_arg0 )
	...
	OnGametypeSettingsChange = function ( f29_arg0 )
	...
	ShutdownCleanupMP = function ( f36_arg0 )
		
	end,
	ShutdownCleanupZM = function ( f37_arg0 )
		
	end,
	ShutdownCleanupCP = function ( f38_arg0 )
		
	end,
	ShutdownCleanup = function ( f39_arg0 )
	...
	OnComErrorCleanup = function ( f40_arg0 )
	...
	OnErrorShutdown = function ( f41_arg0 )
		LobbyVM.ErrorShutdown( f41_arg0 )
	end,
	OnStorageRead = function ( f42_arg0 )
	...
	OnStorageWrite = function ( f43_arg0 )
	...
	OnStorageWriteDispatch = function ( f44_arg0 )
		local f44_local0 = f44_arg0.controller
	end,
	OnRecordComScoreEvent = function ( f45_arg0 )
	...
	OnLimitedItemPromoUpdate = function ( f51_arg0 )
	...
	InitilizeGunsmithBuffer = function ( f54_arg0 )
	...
	InitilizeZMLoadoutBuffer = function ( f55_arg0 )
	...
	OnInitializeStats = function ( f56_arg0 )
	...
	SetDefaultShowcaseWeapon = function ( f57_arg0, f57_arg1 )
	...
	OnInitializeLoadouts = function ( f58_arg0 )
	...
	LobbyHostLeftNoMigration = function ( f59_arg0 )
	...
	LobbyHostLeft_InGameMigrateFinished = function ( f60_arg0 )
	...
	LobbyClientLeftEvent = function ( f61_arg0 )
	...
	NetworkModeChanged = function ( f65_arg0 )
	...
	ManagePartyLeave = function ( f68_arg0 )
		if LobbyVM.IsHostLaunching() then
			return 
		end
	...
	InGameJoin = function ( f69_arg0, f69_arg1 )
	...
	GetJoinProcess = function ( f70_arg0 )
	...
	CreateDedicatedLANLobby = function ()
	...
	CreateDedicatedLobby = function ( f75_arg0 )
		local f75_local0 = {}
	...
	CreateDedicatedModsLobby = function ( f76_arg0 )
	...
	LobbyClientPromoteToHost = function ( f78_arg0 )
	...
	LobbyLeaveWithParty = function ( f79_arg0 )
	...
	CanLobbyCanMigrate = function ( f80_arg0 )
	...
	LobbyLocalClientLeave = function ( f81_arg0 )
	...
	Leaderboard_PopulateCustomList = function ( f86_arg0 )
		return Lobby.Leaderboard.PopulateCustomList( f86_arg0 )
	end,
	Leaderboard_CalculateLBColValue = function ( f87_arg0 )
		return Lobby.Leaderboard.CalculateLBColValue( f87_arg0 )
	end,
	OnShouldWriteLeaderboard = function ( f88_arg0 )
		return Lobby.Leaderboard.OnShouldWriteLeaderboard( f88_arg0 )
	end,
	CheckDLCBit = function ( f89_arg0, f89_arg1 )
	...
	LaunchGameExec = function ( f90_arg0, f90_arg1 )
	...
	LaunchDemoExec = function ( f91_arg0, f91_arg1 )
	...
	CheckNeedInstallUGC = function ( f93_arg0, f93_arg1 )
		if f93_arg0 then
	...
	HostLaunchPump = function ( f94_arg0 )
	...
	CheckAdvertizeSteamServer = function ()
	...
	DLCMapCheck = function ( f101_arg0 )
	...
	CanClientLaunch = function ( f102_arg0 )
	...
	ClientLaunchInit = function ( f103_arg0 )
	...
	ClientLaunchPump = function ( f104_arg0 )
		if Engine.GetModelValue( Engine.CreateModel( Engine.GetGlobalModel(), "lobbyRoot.spinnerActive" ) ) == false then
			Engine.SetModelValue( Engine.CreateModel( Engine.GetGlobalModel(), "lobbyRoot.spinnerActive" ), true )
		end
	...
	ClientLaunchClear = function ()
		Engine.SetModelValue( Engine.CreateModel( Engine.GetGlobalModel(), "lobbyRoot.hideMenusForGameStart" ), 0 )
		Engine.SetModelValue( Engine.CreateModel( Engine.GetGlobalModel(), "lobbyRoot.spinnerActive" ), false )
	end,
	ClientLaunch = function ( f106_arg0 )
	...
	JoinResultToString = function ( f129_arg0, f129_arg1 )
		local f129_local0 = {
			debug = "",
			errorMsg = ""
		}
	...
	LobbyStatusUpdate = function ( f131_arg0 )
	...
	CheckStarterPack = function ( f132_arg0 )
	...
	OnModUpdate = function ( f134_arg0 )
	...
	OnUsermapUpdate = function ( f135_arg0, f135_arg1 )
	...
	DoChunksAllowJoin = function ( f136_arg0, f136_arg1 )
	...
	JoinableCheck = function ( f138_arg0 )
	...
	ProcessCompleteSuccess = function ( f139_arg0 )
		Lobby.ProcessQueue.Success( f139_arg0 )
	end,
	ProcessCompleteFailure = function ( f140_arg0 )
		Lobby.ProcessQueue.Failure( f140_arg0 )
	end,
	ProcessCompleteError = function ( f141_arg0 )
		Lobby.ProcessQueue.Error( f141_arg0 )
	end,
	ProcessUpdate = function ( f142_arg0 )
		Lobby.ProcessQueue.Update( f142_arg0 )
	end,
	GameLobbyGameServerDataUpdate = function ( f143_arg0 )
	...
	PrivateLobbyServerDataUpdate = function ( f144_arg0 )
	...
	GameLobbyClientDataUpdate = function ( f145_arg0 )
	...
	HopperClientJoin = function ( f146_arg0 )
		return Lobby.Hopper.ClientJoin( f146_arg0 )
	end,
	HopperIsParked = function ()
		return Lobby.Hopper.IsParked()
	end,
	GetMatchmakingExperimentActive = function ( f148_arg0 )
		return Lobby.Matchmaking.IsExperimentActive( f148_arg0 )
	end,
	OnExperimentReset = function ( f149_arg0 )
	...
	PopulateMutableClientDDLBuff = function ( f151_arg0 )
		local f151_local0 = f151_arg0.controller
		local f151_local1 = f151_arg0.ddlData
	end,
	ReceiveMutableClientDDLBuff = function ( f152_arg0 )
	...
	OnEnableJoins = function ( f154_arg0 )
	...
	GetRecentItemTags = function ( f166_arg0, f166_arg1 )
	...
	GetLootPossibleCount = function ( f167_arg0 )
	...
	GetLootItemList = function ( f168_arg0, f168_arg1 )
	...
	OnSpendVials = function ( f170_arg0 )
	...
	OnCookGobbleGumRecipe = function ( f171_arg0 )
		return " \"Recipe\": " .. f171_arg0.recipeIndex + f171_arg0.itemOffset
	end,
	OnInventoryFetched = function ( f172_arg0 )
		local f172_local0 = {
			"na_team_mtx",
			"eu_team_mtx",
			"anz_team_mtx",
	...
	CheckSpecialPlaylistRules = function ( f173_arg0 )
