require( "ui.uieditor.widgets.HUD.S4ScoreboardWidget.S4ScoreboardListItem" )
...
CoD.S4Scoreboard = InheritFrom( LUI.UIElement )
CoD.S4Scoreboard.new = function ( menu, controller )
	...
	self:setClass( CoD.S4Scoreboard )
	self.id = "S4Scoreboard"
	...
	self.Team1:setWidgetType( CoD.S4ScoreboardListItem )
