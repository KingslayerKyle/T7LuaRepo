CoD.S4AmmoInfo = InheritFrom( LUI.UIElement )
CoD.S4AmmoInfo.new = function ( menu, controller )
    ...
    self.AmmoClip:setLeftRight( true, true, 0, 245 )
    self.AmmoClip:setTopBottom( false, true, -98.5, -42.5 )
    ...
    self.AmmoClipDW:setLeftRight( true, true, 0 - 45, 245 - 45 )
    self.AmmoClipDW:setTopBottom( false, true, -98.5, -42.5 )
    ...
    self.AmmoStock:setLeftRight( true, true, 0, 245 )
    self.AmmoStock:setTopBottom( false, true, -69, -27 )
	self.AmmoStock:setTTF( "fonts/main_bold.ttf" )
	self.AmmoStock:setScale( 0.5 )
	self.AmmoStock:setAlpha( 0.5 )
		...
		DefaultState = {
			...
			AmmoPulse = function ()
				...
				local AmmoPulseTransition = function ( element, event )
					...
					element:setTopBottom( false, true, -98.5 - 10, -42.5 + 10 )
		...
		AmmoPulse = {
			...
			DefaultState = function ()
				...
				local AmmoPulseTransition = function ( element, event )
					...
					element:setTopBottom( false, true, -98.5, -42.5 )
				...
				self.AmmoClip:completeAnimation()
				self.AmmoClip:setTopBottom( false, true, -98.5 - 10, -42.5 + 10 )
				AmmoPulseTransition( self.AmmoClip, {} )
			end
		},
		Hidden = {
