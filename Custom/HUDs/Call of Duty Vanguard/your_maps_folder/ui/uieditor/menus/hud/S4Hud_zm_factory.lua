...
-- VG Widgets
require( "ui.uieditor.menus.StartMenu.S4StartMenu_Main" )
require( "ui.uieditor.widgets.HUD.S4AmmoWidget.S4AmmoContainer" )
require( "ui.uieditor.widgets.HUD.S4NotificationWidget.S4Notification" )
require( "ui.uieditor.widgets.HUD.S4PerksWidget.S4PerksContainer" )
require( "ui.uieditor.widgets.HUD.S4ScoreWidget.S4ScoreContainer" )
require( "ui.uieditor.widgets.HUD.S4ScoreboardWidget.S4Scoreboard" )
...
LUI.createMenu.T7Hud_zm_factory = function ( controller )
	...
	self.ZMPerksContainerFactory = CoD.S4PerksContainer.new( self, controller )
	...
	self.Ammo = CoD.S4AmmoContainer.new( self, controller )
	self.Ammo:setLeftRight( true, true, 0, 0 )
	self.Ammo:setTopBottom( true, true, 0, 0 )
	self:addElement( self.Ammo )
	
	self.Score = CoD.S4ScoreContainer.new( self, controller )
	...
	self.S4Notification = CoD.S4Notification.new( self, controller )
	self.S4Notification:setLeftRight( true, true, 0, 0 )
	self.S4Notification:setTopBottom( true, true, 0, 0 )
	self:addElement( self.S4Notification )
	...
	self.CursorHint.cursorhinttext0.CursorHintText:setTTF( "fonts/main_bold.ttf" )
	...
	self.ScoreboardWidget = CoD.S4Scoreboard.new( self, controller )
