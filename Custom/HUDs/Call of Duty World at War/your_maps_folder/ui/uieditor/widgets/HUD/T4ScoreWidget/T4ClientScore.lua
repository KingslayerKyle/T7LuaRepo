...
CoD.T4ClientScore = InheritFrom( LUI.UIElement )
CoD.T4ClientScore.new = function ( menu, controller )
	...
	self:setClass( CoD.T4ClientScore )
	self.id = "T4ClientScore"
	...
	self.ScoreBG:setLeftRight( false, true, -155, -36.5 )
	self.ScoreBG:setTopBottom( false, true, -124, -92.5 - 5 )
	...
	self.Score:setLeftRight( true, true, 1084 + 5, 0 )
	self.Score:setTopBottom( false, true, -125, -87 - 5 )
