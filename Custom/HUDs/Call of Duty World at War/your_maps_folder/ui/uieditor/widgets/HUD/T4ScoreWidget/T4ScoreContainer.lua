require( "ui.uieditor.widgets.HUD.T4ScoreWidget.T4ClientScore" )
require( "ui.uieditor.widgets.HUD.T4ScoreWidget.T4PlusPointsContainer" )
require( "ui.uieditor.widgets.HUD.T4ScoreWidget.T4SelfScore" )
...
local CreateNewPlusPointsElement = function ( element, score, controller, menu, small, table )
	...
	local newPlusPointsElement = CoD.T4PlusPointsContainer.new( menu, controller )
...
CoD.T4ScoreContainer = InheritFrom( LUI.UIElement )
CoD.T4ScoreContainer.new = function ( menu, controller )
	...
	self:setClass( CoD.T4ScoreContainer )
	self.id = "T4ScoreContainer"
	...
	self.ListingUser:setWidgetType( CoD.T4SelfScore )
	self.ListingUser:setDataSource( "PlayerListZM" )
	self:addElement( self.ListingUser )
	
	self.Listing2 = CoD.T4ClientScore.new( menu, controller )
	self.Listing2:setLeftRight( true, true, 0, 0 )
	self.Listing2:setTopBottom( true, true, 0, -23 )
	...
	self.Listing3 = CoD.T4ClientScore.new( menu, controller )
	self.Listing3:setLeftRight( true, true, 0, 0 )
	self.Listing3:setTopBottom( true, true, 0, -46 )
	...
	self.Listing4 = CoD.T4ClientScore.new( menu, controller )
	...
	self.ZMScrPlusPoints0 = CoD.T4PlusPointsContainer.new( menu, controller )
	...
	self.ZMScrPlusPoints1 = CoD.T4PlusPointsContainer.new( menu, controller )
	self.ZMScrPlusPoints1:setLeftRight( true, true, 0, 0 )
	self.ZMScrPlusPoints1:setTopBottom( true, true, 0, -23 )
	self:addElement( self.ZMScrPlusPoints1 )
	
	self.ZMScrPlusPoints2 = CoD.T4PlusPointsContainer.new( menu, controller )
	self.ZMScrPlusPoints2:setLeftRight( true, true, 0, 0 )
	self.ZMScrPlusPoints2:setTopBottom( true, true, 0, -46 )
	self:addElement( self.ZMScrPlusPoints2 )
	
	self.ZMScrPlusPoints3 = CoD.T4PlusPointsContainer.new( menu, controller )
	self.ZMScrPlusPoints3:setLeftRight( true, true, 0, 0 )
	self.ZMScrPlusPoints3:setTopBottom( true, true, 0, -69 )
