...
-- MWR Widgets
require( "ui.uieditor.menus.StartMenu.H1StartMenu_Main" )
require( "ui.uieditor.widgets.HUD.H1AmmoWidget.H1AmmoContainer" )
require( "ui.uieditor.widgets.HUD.H1NotificationWidget.H1Notification" )
require( "ui.uieditor.widgets.HUD.H1PerksWidget.H1PerksContainer" )
require( "ui.uieditor.widgets.HUD.H1RoundWidget.H1Round" )
require( "ui.uieditor.widgets.HUD.H1ScoreWidget.H1ScoreContainer" )
...
LUI.createMenu.T7Hud_zm_factory = function ( controller )
	...
	self.DummyFont1:setTTF( "fonts/defaultbold.otf" )
	...
	self.ZMPerksContainerFactory = CoD.H1PerksContainer.new( self, controller )
	self.ZMPerksContainerFactory:setLeftRight( true, true, 0, 0 )
	self.ZMPerksContainerFactory:setTopBottom( true, true, 0, 110 )
	self.ZMPerksContainerFactory:setScale( 0.8 )
	self:addElement( self.ZMPerksContainerFactory )
	
	self.Rounds = CoD.H1Round.new( self, controller )
	self.Rounds:setLeftRight( true, true, 0, 0 )
	self.Rounds:setTopBottom( true, true, 0, 0 )
	self:addElement( self.Rounds )
	
	self.Ammo = CoD.H1AmmoContainer.new( self, controller )
	self.Ammo:setLeftRight( true, true, 0, 0 )
	self.Ammo:setTopBottom( true, true, 0, 0 )
	self:addElement( self.Ammo )
	
	self.Score = CoD.H1ScoreContainer.new( self, controller )
	...
	self.H1Notification = CoD.H1Notification.new( self, controller )
	self.H1Notification:setLeftRight( true, true, 0, 0 )
	self.H1Notification:setTopBottom( true, true, 0, 0 )
	self:addElement( self.H1Notification )
	...
	self.CursorHint.cursorhinttext0.CursorHintText:setTTF( "fonts/defaultbold.otf" )
	...
	self.MPScore:setLeftRight( false, false, -50 + 110, 50 + 110 )
	self.MPScore:setTopBottom( true, false, 233.5 + 40, 258.5 + 40 )
	self.MPScore:setRGB( 0.94, 0.72, 0.07 )
	self.MPScore:setScale( 0.6 )
	...
	self.ScoreboardWidget = CoD.H1Scoreboard.new( self, controller )
