require( "ui.uieditor.menus.StartMenu.H1StartMenu_GameOptions_ZM" )
        ...
        if Engine.IsZombiesGame() then
			table.insert( tabList, {
				models = {
					...
					tabWidget = "CoD.H1StartMenu_GameOptions_ZM",
					tabIcon = ""
				},
				properties = {
					tabId = "gameOptions"
...
LUI.createMenu.StartMenu_Main = function ( controller )
	...
	self.PausedText:setLeftRight( true, true, -341, 0 )
	self.PausedText:setTopBottom( true, false, 50, 118 )
	self.PausedText:setTTF( "fonts/defaultbold.otf" )
	self.PausedText:setText( Engine.Localize( "PAUSE MENU" ) )
	...
	self.TabFrame:setLeftRight( true, true, 67.5, 0 )
	self.TabFrame:setTopBottom( true, true, 124, 0 )
