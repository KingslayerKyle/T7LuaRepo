...
CoD.KingslayerMinimap.new = function ( menu, controller )
	...
	self.CompassMinimapMap:setTopBottom( true, false, 50, 275 )
	...
	self.CompassMinimapItems:setTopBottom( true, false, 50, 275 )
	...
	self.CompassMinimapMask:setTopBottom( true, false, 50, 275 )
