...
CoD.S2PerksContainer.new = function ( menu, controller )
	...
	self.PerkSlots:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "S2.PerkSlots" ), function ( model )
		local perkslots = Engine.GetModelValue( model )
