require( "ui.uieditor.menus.StartMenu.S4StartMenu_GameOptions_ZM" )
require( "ui.uieditor.menus.StartMenu.S4StartMenu_Options" )
        ...
        if Engine.IsZombiesGame() then
			table.insert( tabList, {
				models = {
					...
					tabWidget = "CoD.S4StartMenu_GameOptions_ZM",
					tabIcon = ""
				},
				properties = {
					tabId = "gameOptions"
...
LUI.createMenu.StartMenu_Main = function ( controller )
	...
	self.PausedText:setLeftRight( true, true, -342, 0 )
	self.PausedText:setTopBottom( true, false, 32 - 16, 100 - 16 )
	self.PausedText:setTTF( "fonts/main_bold.ttf" )
	...
	self.TabFrame:setLeftRight( true, true, 86.5, 0 )
	self.TabFrame:setTopBottom( true, true, 103.5, 0 )
