...
require( "ui.uieditor.widgets.HUD.S4PerksWidget.S4PerksListItem" )

-- A table that contains the clientfield names and images of the perks
local perksTable = {
	additional_primary_weapon = "v_ui_icons_zombies_perks_mulekick",
	dead_shot = "v_ui_icons_zombies_perks_diabolicaldamage",
	doubletap2 = "v_ui_icons_zombies_perks_doubletap",
	juggernaut = "v_ui_icons_zombies_perks_fiendishfortitude",
	marathon = "v_ui_icons_zombies_perks_aetherealhaste",
	quick_revive = "v_ui_icons_zombies_perks_venemousvigor",
	sleight_of_hand = "v_ui_icons_zombies_perks_demonicfrenzy",
	widows_wine = "v_ui_icons_zombies_perks_widowswine",
	electric_cherry = "v_ui_icons_zombies_perks_electriccherry"
}
...
CoD.S4PerksContainer = InheritFrom( LUI.UIElement )
CoD.S4PerksContainer.new = function ( menu, controller )
	...
	self:setClass( CoD.S4PerksContainer )
	self.id = "S4PerksContainer"
	...
	self.PerkList:setWidgetType( CoD.S4PerksListItem )
