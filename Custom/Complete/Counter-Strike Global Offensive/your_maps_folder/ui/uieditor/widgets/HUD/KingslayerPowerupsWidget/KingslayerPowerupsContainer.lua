...
CoD.PowerUps.ClientFieldNames = {
	{
		...
		image = "csgo_powerup_instakill"
	},
	{
		clientFieldName = "powerup_double_points",
		image = "csgo_powerup_doublepoints"
	},
	{
		clientFieldName = "powerup_fire_sale",
		image = "csgo_powerup_firesale"
	},
	{
		clientFieldName = "powerup_mini_gun",
		image = "csgo_powerup_deathmachine"
	}
}
...
CoD.KingslayerPowerupsContainer.new = function ( menu, controller )
	...
	self.PowerupList:setLeftRight( false, true, 0, -50 )
	self.PowerupList:setTopBottom( true, false, 50, 0 )
