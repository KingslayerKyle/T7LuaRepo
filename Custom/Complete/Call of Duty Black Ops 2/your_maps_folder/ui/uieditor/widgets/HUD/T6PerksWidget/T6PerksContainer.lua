...
local perksTable = {
	additional_primary_weapon = "t6_specialty_mulekick_zombies",
	dead_shot = "t6_specialty_ads_zombies",
	doubletap2 = "t6_specialty_doubletap_zombies",
	juggernaut = "t6_specialty_juggernaut_zombies",
	marathon = "t6_specialty_marathon_zombies",
	quick_revive = "t6_specialty_quickrevive_zombies",
	sleight_of_hand = "t6_specialty_fastreload_zombies",
	widows_wine = "t6_specialty_widows_wine_zombies",
	electric_cherry = "t6_specialty_electric_cherry_zombies"
}
