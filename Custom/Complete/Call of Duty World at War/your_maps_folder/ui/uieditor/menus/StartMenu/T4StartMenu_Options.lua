...
local PostLoadFunc = function ( self, controller )
	...
	if CoD.isCampaign then
		self:setModel( Engine.CreateModel( Engine.GetModelForController( controller ), "T4StartMenu_Options" ) )
	end
...
LUI.createMenu.T4StartMenu_Options = function ( controller )
	local self = CoD.Menu.NewForUIEditor( "T4StartMenu_Options" )
	...
	self.buttonModel = Engine.CreateModel( Engine.GetModelForController( controller ), "T4StartMenu_Options.buttonPrompts" )
	...
	LUI.OverrideFunction_CallOriginalSecond( self, "close", function ( element )
		...
		Engine.UnsubscribeAndFreeModel( Engine.GetModel( Engine.GetModelForController( controller ), "T4StartMenu_Options.buttonPrompts" ) )
	end )
