...
CoD.T4ScoreboardListItem.new = function ( menu, controller )
	...
	self.Gamertag:setLeftRight( true, true, -15.5, 749.5 )
	...
	self.ScoreColumn1:setLeftRight( true, true, 352, 750 )
	...
	self.ScoreColumn2:setLeftRight( true, true, 463, 750 )
	...
	self.ScoreColumn3:setLeftRight( true, true, 564.5, 719.5 )
	...
	self.ScoreColumn4:setLeftRight( true, true, 668, 685 )
	...
	self.ScoreColumn5:setLeftRight( true, true, 770, 651 )
	...
	self.ScoreColumn6:setLeftRight( true, true, 871, 613 )
