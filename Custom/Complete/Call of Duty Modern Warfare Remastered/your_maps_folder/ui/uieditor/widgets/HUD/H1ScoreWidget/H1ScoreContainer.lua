require( "ui.uieditor.widgets.HUD.H1ScoreWidget.H1ClientScore" )
require( "ui.uieditor.widgets.HUD.H1ScoreWidget.H1PlusPointsContainer" )
require( "ui.uieditor.widgets.HUD.H1ScoreWidget.H1SelfScore" )
...
local CreateNewPlusPointsElement = function ( element, score, controller, menu, small, table )
	...
	local newPlusPointsElement = CoD.H1PlusPointsContainer.new( menu, controller )
...
local PreLoadFunc = function ( self, controller )
	for index = 0, Dvar.com_maxclients:get() - 1 do
		...
		local healthModel = Engine.CreateModel( controllerModel, "h1_health_" .. index )
		local shieldModel = Engine.CreateModel( controllerModel, "h1_shield_" .. index )
		local shieldHealthModel = Engine.CreateModel( controllerModel, "h1_shield_health_" .. index )
...
CoD.H1ScoreContainer = InheritFrom( LUI.UIElement )
CoD.H1ScoreContainer.new = function ( menu, controller )
	...
	self:setClass( CoD.H1ScoreContainer )
	self.id = "H1ScoreContainer"
	...
	self.ListingUser:setWidgetType( CoD.H1SelfScore )
	self.ListingUser:setDataSource( "PlayerListZM" )
	self:addElement( self.ListingUser )
	
	self.Listing2 = CoD.H1ClientScore.new( menu, controller )
	self.Listing2:setLeftRight( true, true, 0, 0 )
	self.Listing2:setTopBottom( true, true, 0, 15 )
	...
	self.Listing3 = CoD.H1ClientScore.new( menu, controller )
	self.Listing3:setLeftRight( true, true, 0, 0 )
	self.Listing3:setTopBottom( true, true, 0, -18.5 )
	...
	self.Listing4 = CoD.H1ClientScore.new( menu, controller )
	self.Listing4:setLeftRight( true, true, 0, 0 )
	self.Listing4:setTopBottom( true, true, 0, -52 )
	...
	self.ZMScrPlusPoints0 = CoD.H1PlusPointsContainer.new( menu, controller )
	self.ZMScrPlusPoints0:setLeftRight( true, false, 40, 0 )
	self.ZMScrPlusPoints0:setTopBottom( false, true, 0, -7.5 )
