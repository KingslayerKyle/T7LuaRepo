...
require( "ui.uieditor.widgets.HUD.H1PerksWidget.H1PerksListItem" )

-- A table that contains the clientfield names and images of the perks
local perksTable = {
	additional_primary_weapon = "h1_perk_three_guns",
	dead_shot = "h1_perk_ads",
	doubletap2 = "h1_perk_doubletap",
	juggernaut = "h1_perk_juggernaut",
	marathon = "h1_perk_marathon",
	quick_revive = "h1_perk_quickrevive",
	sleight_of_hand = "h1_perk_fastreload",
	widows_wine = "h1_perk_widows_wine",
	electric_cherry = "h1_perk_electric_cherry"
}
...
CoD.H1PerksContainer = InheritFrom( LUI.UIElement )
CoD.H1PerksContainer.new = function ( menu, controller )
	...
	self:setClass( CoD.H1PerksContainer )
	self.id = "H1PerksContainer"
	self.soundSet = "default"
	self:setLeftRight( true, false, 0, 1280 )
	self:setTopBottom( true, false, 0, 720 )
	self.anyChildUsesUpdateState = true
	
	self.PerkList = LUI.UIList.new( menu, controller, 1, 0, nil, false, false, 0, 0, false, false )
	self.PerkList:makeFocusable()
	self.PerkList:setLeftRight( false, false, 0, 0 )
	self.PerkList:setTopBottom( false, true, 0, -44 )
	self.PerkList:setWidgetType( CoD.H1PerksListItem )
