-- 5733b58fcbcf1aab1493060995f2e5cd
...
CoD.ChatClientUtility.UpdateOptionsModels = function ( f22_arg0 )
	Engine.SetModelValue( CoD.ChatClientUtility.GetFilterChannelModel(), Engine.ChatClient_FilterChannelGet( f22_arg0, Enum.chatChannel_e.CHAT_CHANNEL_COUNT ) )
	CoD.ChatClientUtility.ResetMenuShow()
	CoD.ChatClientUtility.ResetFilterChannelModels( f22_arg0 )
	CoD.ChatClientUtility.ResetSettingsModels( f22_arg0 )
	Engine.Exec( f22_arg0, "chatClientUpdate" )
end
