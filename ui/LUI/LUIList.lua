-- e13937ee5bb22d4abf5af6de4c310d76
...
LUI.UIList.new = function ( f7_arg0, f7_arg1, f7_arg2, f7_arg3, f7_arg4, f7_arg5, f7_arg6, f7_arg7, f7_arg8, f7_arg9, f7_arg10 )
	...
	CoD.Menu.AddButtonCallbackFunction( f7_arg0, f7_local0, f7_arg1, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f8_arg0, f8_arg1, f8_arg2, f8_arg3 )
		if f8_arg0 == f7_local0.activeWidget then
			if CoD.Menu.AnyButtonConditionTrue( f8_arg0, f8_arg1, f8_arg2, Enum.LUIButton.LUI_KEY_XBA_PSCROSS ) then
				f7_local0:playSound( "list_action" )
			elseif CoD.isPC and not IsGamepad( f8_arg2 ) and not f7_local0.m_disableNavigation then
	...
	CoD.Menu.AddButtonCallbackFunction( f7_arg0, f7_local0, f7_arg1, Enum.LUIButton.LUI_KEY_UP, "UPARROW", function ( f10_arg0, f10_arg1, f10_arg2, f10_arg3 )
	...
	CoD.Menu.AddButtonCallbackFunction( f7_arg0, f7_local0, f7_arg1, Enum.LUIButton.LUI_KEY_DOWN, "DOWNARROW", function ( f11_arg0, f11_arg1, f11_arg2, f11_arg3 )
	...
	CoD.Menu.AddButtonCallbackFunction( f7_arg0, f7_local0, f7_arg1, Enum.LUIButton.LUI_KEY_LEFT, "LEFTARROW", function ( f12_arg0, f12_arg1, f12_arg2, f12_arg3 )
	...
	CoD.Menu.AddButtonCallbackFunction( f7_arg0, f7_local0, f7_arg1, Enum.LUIButton.LUI_KEY_RIGHT, "RIGHTARROW", function ( f13_arg0, f13_arg1, f13_arg2, f13_arg3 )
	...
	if not CoD.isPC and CoD.isMultiplayer then
		CoD.Menu.AddButtonCallbackFunction( f7_arg0, f7_local0, f7_arg1, Enum.LUIButton.LUI_KEY_NONE, "UPARROW", function ( f14_arg0, f14_arg1, f14_arg2, f14_arg3 )
			if CoD.IsShoutcaster( f14_arg2 ) and not f7_local0.m_disableNavigation and f7_local0:navigateItemUp() then
				return true
			else
				
			end
		end, nil, false, true )
		CoD.Menu.AddButtonCallbackFunction( f7_arg0, f7_local0, f7_arg1, Enum.LUIButton.LUI_KEY_NONE, "DOWNARROW", function ( f15_arg0, f15_arg1, f15_arg2, f15_arg3 )
			if CoD.IsShoutcaster( f15_arg2 ) and not f7_local0.m_disableNavigation and f7_local0:navigateItemDown() then
				return true
			else
				
			end
		end, nil, false, true )
		CoD.Menu.AddButtonCallbackFunction( f7_arg0, f7_local0, f7_arg1, Enum.LUIButton.LUI_KEY_NONE, "LEFTARROW", function ( f16_arg0, f16_arg1, f16_arg2, f16_arg3 )
			if CoD.IsShoutcaster( f16_arg2 ) and not f7_local0.m_disableNavigation and f7_local0:navigateItemLeft() then
				return true
			else
				
			end
		end, nil, false, true )
		CoD.Menu.AddButtonCallbackFunction( f7_arg0, f7_local0, f7_arg1, Enum.LUIButton.LUI_KEY_NONE, "RIGHTARROW", function ( f17_arg0, f17_arg1, f17_arg2, f17_arg3 )
			if CoD.IsShoutcaster( f17_arg2 ) and not f7_local0.m_disableNavigation and f7_local0:navigateItemRight() then
				return true
			else
	...
	if CoD.isPC then
		CoD.Menu.AddButtonCallbackFunction( f7_arg0, f7_local0, f7_arg1, Enum.LUIButton.LUI_KEY_PCKEY_MWHEELUP, "MWHEELUP", function ( f18_arg0, f18_arg1, f18_arg2, f18_arg3 )
		...
		CoD.Menu.AddButtonCallbackFunction( f7_arg0, f7_local0, f7_arg1, Enum.LUIButton.LUI_KEY_PCKEY_MWHEELDOWN, "MWHEELDOWN", function ( f19_arg0, f19_arg1, f19_arg2, f19_arg3 )
			if not f7_local0.m_disableNavigation then
