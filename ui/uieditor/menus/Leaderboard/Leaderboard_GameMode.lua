-- 6dfd8314ef933411413a235c81025146
...
LUI.createMenu.Leaderboard_GameMode = function ( controller )
	...
	local GameModeTabs = CoD.Leaderboard_GameModeTabWidget.new( f4_local1, controller )
	...
	local LeaderboardWarningText = CoD.Leaderboard_WarningText.new( f4_local1, controller )
	...
	LeaderboardWarningText:subscribeToModel( Engine.GetModel( Engine.GetGlobalModel(), "leaderboardDef" ), function ( model )
		f4_local1:updateElementState( LeaderboardWarningText, {
	...
	f4_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, nil, function ( f18_arg0, f18_arg1, f18_arg2, f18_arg3 )
	...
	f4_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBY_PSTRIANGLE, "F", function ( f20_arg0, f20_arg1, f20_arg2, f20_arg3 )
		if not IsCustomLeaderboard( f20_arg2 ) then
			OpenPopup( self, "Leaderboard_Filters", f20_arg2, "", "" )
			PlaySoundAlias( "uin_paint_decal_nav" )
			return true
		elseif IsCustomLeaderboard( f20_arg2 ) then
			OpenPopup( self, "Leaderboard_Filters", f20_arg2, "", "" )
			PlaySoundAlias( "uin_paint_decal_nav" )
			return true
		else
		...
		if not IsCustomLeaderboard( f21_arg2 ) then
			CoD.Menu.SetButtonLabel( f21_arg1, Enum.LUIButton.LUI_KEY_XBY_PSTRIANGLE, "MENU_LB_CHANGE_FILTER" )
			return true
		elseif IsCustomLeaderboard( f21_arg2 ) then
			CoD.Menu.SetButtonLabel( f21_arg1, Enum.LUIButton.LUI_KEY_XBY_PSTRIANGLE, "MENU_LB_CHANGE_RESET_FILTER" )
			return true
		else
			return false
		end
