-- 461ca24729d57bf062d22b5caad40a58
...
LUI.createMenu.RoadToCWL = function ( controller )
	...
	local PromoThermometerTabWidget = CoD.Promo_ThermometerTabWidget.new( f2_local1, controller )
	...
	f2_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, nil, function ( f6_arg0, f6_arg1, f6_arg2, f6_arg3 )
		GoBack( self, f6_arg2 )
		HandleGoBackFromPromo( self, f6_arg0, f6_arg2, "", f6_arg1 )
		return true
