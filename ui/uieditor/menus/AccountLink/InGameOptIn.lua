-- ab13f0cf433bea77ba1cf892a94d9045
...
LUI.createMenu.InGameOptIn = function ( controller )
	...
	f1_local1:AddButtonCallbackFunction( skipbtn, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f6_arg0, f6_arg1, f6_arg2, f6_arg3 )
		FinishRegistrationFlow( self, f6_arg2, f6_arg1 )
		return true
	...
	local optinbtn = CoD.MOTD_Button.new( f1_local1, controller )
	...
	f1_local1:AddButtonCallbackFunction( optinbtn, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f10_arg0, f10_arg1, f10_arg2, f10_arg3 )
		OptInToEmailMarketing( self, f10_arg0, f10_arg2, f10_arg1 )
		return true
	...
	f1_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, "ENTER", function ( f14_arg0, f14_arg1, f14_arg2, f14_arg3 )
