-- 96d2cff1aa1c52b3ae12351db09515a1
...
LUI.createMenu.WeaponBuildKitsCustomizeVariant = function ( controller )
	...
	local InfoPaneItemName = CoD.InfoPaneItemName.new( f3_local1, controller )
	...
	local WeaponBuildKitsVariantDescription = CoD.WeaponBuildKitsVariantDescription.new( f3_local1, controller )
	...
	local attachmentListFrame = CoD.WeaponBuildKitsVariantAttachmentList.new( f3_local1, controller )
	...
	f3_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, nil, function ( f14_arg0, f14_arg1, f14_arg2, f14_arg3 )
		SaveWeaponBuildKit( self, f14_arg0, f14_arg2 )
		return true
	end, function ( f15_arg0, f15_arg1, f15_arg2 )
		CoD.Menu.SetButtonLabel( f15_arg1, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, "MP_BACK" )
		return true
	end, false )
	f3_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, nil, function ( f16_arg0, f16_arg1, f16_arg2, f16_arg3 )
		return true
	end, function ( f17_arg0, f17_arg1, f17_arg2 )
		CoD.Menu.SetButtonLabel( f17_arg1, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "MENU_SELECT" )
		return true
	end, false )
	f3_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_RSTICK_PRESSED, nil, function ( f18_arg0, f18_arg1, f18_arg2, f18_arg3 )
		return true
	end, function ( f19_arg0, f19_arg1, f19_arg2 )
		CoD.Menu.SetButtonLabel( f19_arg1, Enum.LUIButton.LUI_KEY_RSTICK_PRESSED, "PLATFORM_EMBLEM_ROTATE_LAYER" )
		return true
	end, false )
