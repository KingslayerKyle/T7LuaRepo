-- e8e9ccf16ccf690470eea59ef317c21c
...
LUI.createMenu.Prestige_CustomizePrestigeIcon = function ( controller )
	...
	local PrestigeIconList = LUI.UIList.new( f3_local1, controller, 5, 0, nil, true, false, 0, 0, false, true )
	...
	f3_local1:AddButtonCallbackFunction( PrestigeIconList, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f10_arg0, f10_arg1, f10_arg2, f10_arg3 )
		if not IsSelfModelValueTrue( f10_arg0, f10_arg2, "isLocked" ) then
			SetParagonIcon( self, f10_arg0, f10_arg2 )
		...
		if not IsSelfModelValueTrue( f11_arg0, f11_arg2, "isLocked" ) then
	...
	local PrestigeIconProfiler = CoD.Prestige_PrestigeIconProfiler.new( f3_local1, controller )
	...
	PrestigeIconProfiler:linkToElementModel( PrestigeIconProfiler, "isLocked", true, function ( model )
		f3_local1:updateElementState( PrestigeIconProfiler, {
			name = "model_validation",
			menu = f3_local1,
			modelValue = Engine.GetModelValue( model ),
			modelName = "isLocked"
