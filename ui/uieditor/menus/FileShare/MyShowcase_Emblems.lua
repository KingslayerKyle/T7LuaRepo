-- ebb498d2cd736a689222959e68353729
...
LUI.createMenu.MyShowcase_Emblems = function ( controller )
	...
	local FileshareEmblemList = LUI.UIList.new( f5_local1, controller, 10, 0, nil, true, false, 0, 0, false, false )
	...
	FileshareEmblemList:linkToElementModel( FileshareEmblemList, "isPublishNew", true, function ( model )
		...
		CoD.Menu.UpdateButtonShownState( f10_local0, f5_local1, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS )
		CoD.Menu.UpdateButtonShownState( f10_local0, f5_local1, controller, Enum.LUIButton.LUI_KEY_START )
	end )
	...
	f5_local1:AddButtonCallbackFunction( FileshareEmblemList, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, nil, function ( f16_arg0, f16_arg1, f16_arg2, f16_arg3 )
		if IsSelfModelValueTrue( f16_arg0, f16_arg2, "isPublishNew" ) then
			FileshareSetShowcasePublishMode( f16_arg2, true )
			return true
		elseif not IsSelfModelValueTrue( f16_arg0, f16_arg2, "isPublishNew" ) then
			FileshareSetSelectedItem( self, f16_arg0, f16_arg2, "true" )
			FileshareOpenFullscreenView( self, f16_arg0, f16_arg2, f16_arg1 )
			return true
		else
			
		end
	end, function ( f17_arg0, f17_arg1, f17_arg2 )
		if IsSelfModelValueTrue( f17_arg0, f17_arg2, "isPublishNew" ) then
			CoD.Menu.SetButtonLabel( f17_arg1, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "MENU_PUBLISH" )
			return true
		elseif not IsSelfModelValueTrue( f17_arg0, f17_arg2, "isPublishNew" ) then
	...
	f5_local1:AddButtonCallbackFunction( FileshareEmblemList, controller, Enum.LUIButton.LUI_KEY_START, "O", function ( f18_arg0, f18_arg1, f18_arg2, f18_arg3 )
		if not IsSelfModelValueTrue( f18_arg0, f18_arg2, "isPublishNew" ) then
			OpenPopup( self, "FileshareOptions", f18_arg2, "", "" )
			return true
		else
			
		end
	end, function ( f19_arg0, f19_arg1, f19_arg2 )
		CoD.Menu.SetButtonLabel( f19_arg1, Enum.LUIButton.LUI_KEY_START, "MENU_OPTIONS" )
		if not IsSelfModelValueTrue( f19_arg0, f19_arg2, "isPublishNew" ) then
			return true
		else
			return false
		end
	...
	local emblemList = LUI.UIList.new( f5_local1, controller, 10, 0, nil, true, false, 0, 0, false, false )
	...
	emblemList:linkToElementModel( emblemList, "isBMClassified", true, function ( model )
		...
		CoD.Menu.UpdateButtonShownState( f22_local0, f5_local1, controller, Enum.LUIButton.LUI_KEY_XBY_PSTRIANGLE )
	end )
	...
	emblemList:registerEventHandler( "gain_focus", function ( element, event )
		...
		CoD.Menu.UpdateButtonShownState( element, f5_local1, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS )
		CoD.Menu.UpdateButtonShownState( element, f5_local1, controller, Enum.LUIButton.LUI_KEY_XBY_PSTRIANGLE )
		return f24_local0
	end )
	...
	f5_local1:AddButtonCallbackFunction( emblemList, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, nil, function ( f26_arg0, f26_arg1, f26_arg2, f26_arg3 )
		if FileshareCanPublish( f26_arg2 ) and FileshareCanPublishItem( self, f26_arg0, f26_arg2 ) then
			FileshareShowcasePublishSelectedItem( self, f26_arg0, f26_arg2 )
			return true
		else
			
		end
	end, function ( f27_arg0, f27_arg1, f27_arg2 )
		CoD.Menu.SetButtonLabel( f27_arg1, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "MENU_PUBLISH" )
		if FileshareCanPublish( f27_arg2 ) and FileshareCanPublishItem( self, f27_arg0, f27_arg2 ) then
			return true
		else
			return false
		end
	end, true )
	f5_local1:AddButtonCallbackFunction( emblemList, controller, Enum.LUIButton.LUI_KEY_XBY_PSTRIANGLE, nil, function ( f28_arg0, f28_arg1, f28_arg2, f28_arg3 )
		if not IsSelfModelValueTrue( f28_arg0, f28_arg2, "isBMClassified" ) then
			EmblemSelect_SetAsEmblem( self, f28_arg0, f28_arg2 )
			PlaySoundSetSound( self, "toggle" )
			UpdateSelfState( self, f28_arg2 )
			return true
		else
			
		end
	end, function ( f29_arg0, f29_arg1, f29_arg2 )
		if not IsSelfModelValueTrue( f29_arg0, f29_arg2, "isBMClassified" ) then
			CoD.Menu.SetButtonLabel( f29_arg1, Enum.LUIButton.LUI_KEY_XBY_PSTRIANGLE, "" )
			return false
		else
			return false
		end
	...
	emblemList:linkToElementModel( emblemList, "isBMClassified", true, function ( model )
		f5_local1:updateElementState( emblemList, {
			name = "model_validation",
			menu = f5_local1,
			modelValue = Engine.GetModelValue( model ),
			modelName = "isBMClassified"
	...
	local LocalEmblemName = CoD.WeaponNameWidget.new( f5_local1, controller )
	...
	local EmblemName = CoD.WeaponNameWidget.new( f5_local1, controller )
	...
	self:subscribeToModel( Engine.GetModel( Engine.GetGlobalModel(), "FileshareRoot.PublishMode" ), function ( model )
		...
		CoD.Menu.UpdateButtonShownState( f61_local0, f5_local1, controller, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE )
	end )
	...
	f5_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, nil, function ( f63_arg0, f63_arg1, f63_arg2, f63_arg3 )
		if FileshareShowcaseIsPublishMode( f63_arg0, f63_arg2 ) then
			FileshareSetShowcasePublishMode( f63_arg2, false )
			return true
		else
			GoBack( self, f63_arg2 )
			ClearSavedState( self, f63_arg2 )
			return true
		end
	end, function ( f64_arg0, f64_arg1, f64_arg2 )
		if FileshareShowcaseIsPublishMode( f64_arg0, f64_arg2 ) then
			CoD.Menu.SetButtonLabel( f64_arg1, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, "MENU_BACK" )
			return true
		else
			CoD.Menu.SetButtonLabel( f64_arg1, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, "MP_BACK" )
			return true
		end
	end, false )
