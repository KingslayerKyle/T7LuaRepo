-- afe7dbb9aaaf37d6a5890a242c479dd7
...
LUI.createMenu.Challenges_Specialists = function ( controller )
	local self = CoD.Menu.NewForUIEditor( "Challenges_Specialists" )
	if PreLoadFunc then
	...
	self.buttonModel = Engine.CreateModel( Engine.GetModelForController( controller ), "Challenges_Specialists.buttonPrompts" )
	...
	MenuFrame.titleLabel:setText( Engine.Localize( "HEROES_SPECIALISTS_CAPS" ) )
	MenuFrame.cac3dTitleIntermediary0.FE3dTitleContainer0.MenuTitle.TextBox1.Label0:setText( Engine.Localize( "HEROES_SPECIALISTS_CAPS" ) )
	...
	FETabBar:setTopBottom( true, false, 86, 126 )
	FETabBar.Tabs.grid:setDataSource( "SpecialistsTabs" )
	...
	LUI.OverrideFunction_CallOriginalSecond( self, "close", function ( element )
		...
		Engine.UnsubscribeAndFreeModel( Engine.GetModel( Engine.GetModelForController( controller ), "Challenges_Specialists.buttonPrompts" ) )
	end )
