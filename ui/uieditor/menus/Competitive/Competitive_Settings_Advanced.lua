-- cd3f7bdb46a21eb1b2acfc049cc904a4
...
LUI.createMenu.Competitive_Settings_Advanced = function ( controller )
	...
	local StageTimers = CoD.Competitive_SettingsList.new( f8_local1, controller )
	...
	local EditSettings = CoD.Competitive_SettingsList.new( f8_local1, controller )
	...
	local PlayerOrderSettings = CoD.Competitive_SettingsList.new( f8_local1, controller )
	...
	f8_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, nil, function ( f9_arg0, f9_arg1, f9_arg2, f9_arg3 )
		GoBack( self, f9_arg2 )
		return true
	...
	f8_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_START, "O", function ( f11_arg0, f11_arg1, f11_arg2, f11_arg3 )
