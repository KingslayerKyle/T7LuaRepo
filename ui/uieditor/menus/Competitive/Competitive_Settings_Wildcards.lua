-- b632824d9c96717f50e0c72ad52b0c33
...
DataSources.CompetitiveSettingsWildcardOptions = DataSourceHelpers.ListSetup( "CompetitiveSettingsWildcardOptions", function ( f1_arg0 )
	local f1_local0 = {}
	local f1_local1 = {}
	for f1_local2 = 0, 255, 1 do
		if Engine.ItemIndexValid( f1_local2 ) then
			local f1_local5 = Engine.GetUnlockableInfoByIndex( f1_local2 )
			if 0 <= f1_local5.allocation and LUI.startswith( f1_local5.loadoutSlot, "bonuscard" ) then
