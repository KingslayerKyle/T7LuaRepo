-- fe3dab297c33995d49318c0463cb2cfc
...
LUI.createMenu.Competitive_Settings_Attachment_Weapons = function ( controller )
	...
	local f27_local1 = self
	self.anyChildUsesUpdateState = true
	
	local GameSettingsBackground = CoD.GameSettings_Background.new( f27_local1, controller )
	...
	local Options = LUI.UIList.new( f27_local1, controller, 2, 0, nil, false, false, 0, 0, false, true )
	...
	Options:registerEventHandler( "gain_focus", function ( element, event )
		...
		CoD.Menu.UpdateButtonShownState( element, f27_local1, controller, Enum.LUIButton.LUI_KEY_LB )
		CoD.Menu.UpdateButtonShownState( element, f27_local1, controller, Enum.LUIButton.LUI_KEY_RB )
		CoD.Menu.UpdateButtonShownState( element, f27_local1, controller, Enum.LUIButton.LUI_KEY_START )
		return f28_local0
	end )
	...
	f27_local1:AddButtonCallbackFunction( Options, controller, Enum.LUIButton.LUI_KEY_LB, nil, function ( f30_arg0, f30_arg1, f30_arg2, f30_arg3 )
		AdjustGameSettingsTab( self, f30_arg0, f30_arg2, "-1" )
		return true
	end, function ( f31_arg0, f31_arg1, f31_arg2 )
		CoD.Menu.SetButtonLabel( f31_arg1, Enum.LUIButton.LUI_KEY_LB, "" )
		return false
	end, false )
	f27_local1:AddButtonCallbackFunction( Options, controller, Enum.LUIButton.LUI_KEY_RB, nil, function ( f32_arg0, f32_arg1, f32_arg2, f32_arg3 )
		AdjustGameSettingsTab( self, f32_arg0, f32_arg2, "1" )
		return true
	end, function ( f33_arg0, f33_arg1, f33_arg2 )
		CoD.Menu.SetButtonLabel( f33_arg1, Enum.LUIButton.LUI_KEY_RB, "" )
		return false
	end, false )
	f27_local1:AddButtonCallbackFunction( Options, controller, Enum.LUIButton.LUI_KEY_START, "O", function ( f34_arg0, f34_arg1, f34_arg2, f34_arg3 )
		OpenGameSettingsOptionsMenu( self, f34_arg0, f34_arg2, f34_arg1 )
		return true
	end, function ( f35_arg0, f35_arg1, f35_arg2 )
		CoD.Menu.SetButtonLabel( f35_arg1, Enum.LUIButton.LUI_KEY_START, "MENU_OPTIONS" )
		return true
	end, false )
	...
	local CompetitiveSettingsSelectedItemInfo = CoD.Competitive_Settings_SelectedItemInfo.new( f27_local1, controller )
	...
	local AllWeaponsOption = LUI.UIList.new( f27_local1, controller, 2, 0, nil, false, false, 0, 0, false, true )
	...
	f27_local1:AddButtonCallbackFunction( AllWeaponsOption, controller, Enum.LUIButton.LUI_KEY_LB, nil, function ( f39_arg0, f39_arg1, f39_arg2, f39_arg3 )
		AdjustGameSettingsTab( self, f39_arg0, f39_arg2, "-1" )
		return true
	end, function ( f40_arg0, f40_arg1, f40_arg2 )
		CoD.Menu.SetButtonLabel( f40_arg1, Enum.LUIButton.LUI_KEY_LB, "" )
		return false
	end, false )
	f27_local1:AddButtonCallbackFunction( AllWeaponsOption, controller, Enum.LUIButton.LUI_KEY_RB, nil, function ( f41_arg0, f41_arg1, f41_arg2, f41_arg3 )
		AdjustGameSettingsTab( self, f41_arg0, f41_arg2, "1" )
		return true
	end, function ( f42_arg0, f42_arg1, f42_arg2 )
		CoD.Menu.SetButtonLabel( f42_arg1, Enum.LUIButton.LUI_KEY_RB, "" )
		return false
	end, false )
	f27_local1:AddButtonCallbackFunction( AllWeaponsOption, controller, Enum.LUIButton.LUI_KEY_START, "O", function ( f43_arg0, f43_arg1, f43_arg2, f43_arg3 )
		OpenGameSettingsOptionsMenu( self, f43_arg0, f43_arg2, f43_arg1 )
		return true
	end, function ( f44_arg0, f44_arg1, f44_arg2 )
		CoD.Menu.SetButtonLabel( f44_arg1, Enum.LUIButton.LUI_KEY_START, "MENU_OPTIONS" )
		return true
	end, false )
	self:addElement( AllWeaponsOption )
	self.AllWeaponsOption = AllWeaponsOption
	
	local Tabs = CoD.GameSettings_TabBar.new( f27_local1, controller )
	...
	CoD.Menu.AddNavigationHandler( f27_local1, self, controller )
	f27_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, nil, function ( f46_arg0, f46_arg1, f46_arg2, f46_arg3 )
		GoBack( self, f46_arg2 )
		ClearSavedState( self, f46_arg2 )
		return true
	end, function ( f47_arg0, f47_arg1, f47_arg2 )
		CoD.Menu.SetButtonLabel( f47_arg1, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, "MENU_BACK" )
		return true
	end, false )
