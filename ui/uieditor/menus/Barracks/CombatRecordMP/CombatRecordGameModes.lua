-- 7b8347093be75a88e12fea7a3a1972c7
...
LUI.createMenu.CombatRecordGameModes = function ( controller )
	...
	local WinsStat = CoD.CombatRecordStatHeader.new( f2_local1, controller )
	...
	local KDRatioStat = CoD.CombatRecordStatHeader.new( f2_local1, controller )
	...
	local SPMStat = CoD.CombatRecordStatHeader.new( f2_local1, controller )
	...
	local GameModeName = CoD.CombatRecordLeftTitleWithBackground.new( f2_local1, controller )
	...
	local Streak = CoD.CombatRecordGameModeStat.new( f2_local1, controller )
	...
	local LossRecord = CoD.CombatRecordGameModeStat.new( f2_local1, controller )
	...
	local WinsRecord = CoD.CombatRecordGameModeStat.new( f2_local1, controller )
	...
	local StartMenuframenoBG0 = CoD.StartMenu_frame_noBG.new( f2_local1, controller )
	...
	local Place3Record = CoD.CombatRecordWinnersCircleStat.new( f2_local1, controller )
	...
	local Place2Record = CoD.CombatRecordWinnersCircleStat.new( f2_local1, controller )
	...
	local Place1Record = CoD.CombatRecordWinnersCircleStat.new( f2_local1, controller )
	...
	local CombatRecordStatRing = CoD.CombatRecordStatRing.new( f2_local1, controller )
	...
	self:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "CombatRecordComparing" ), function ( model )
		...
		CoD.Menu.UpdateButtonShownState( f22_local0, f2_local1, controller, Enum.LUIButton.LUI_KEY_XBX_PSSQUARE )
	end )
	self:subscribeToModel( Engine.GetModel( Engine.GetGlobalModel(), "OtherPlayerStats.InProgress" ), function ( model )
		...
		CoD.Menu.UpdateButtonShownState( f23_local0, f2_local1, controller, Enum.LUIButton.LUI_KEY_XBX_PSSQUARE )
	end )
	self:subscribeToModel( Engine.GetModel( Engine.GetGlobalModel(), "OtherPlayerStats.Success" ), function ( model )
		...
		CoD.Menu.UpdateButtonShownState( f24_local0, f2_local1, controller, Enum.LUIButton.LUI_KEY_XBX_PSSQUARE )
	end )
	...
	f2_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, nil, function ( f26_arg0, f26_arg1, f26_arg2, f26_arg3 )
		...
		ClearMenuSavedState( f26_arg1 )
		return true
	end, function ( f27_arg0, f27_arg1, f27_arg2 )
		CoD.Menu.SetButtonLabel( f27_arg1, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, "MENU_BACK" )
		return true
	end, false )
	f2_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_START, "F", function ( f28_arg0, f28_arg1, f28_arg2, f28_arg3 )
		if EnableCombatRecordCompare( f28_arg2 ) and not IsCombatRecordForRemotePlayer() then
			OpenPopup( self, "CombatRecordFriendSidebar", f28_arg2 )
			return true
		elseif EnableCombatRecordCompare( f28_arg2 ) and IsCombatRecordForRemotePlayer() then
			CombatRecordSetComparing( self, f28_arg2, true )
			CombatRecordCompareAgainstLocalPlayer( f28_arg2 )
		...
		if EnableCombatRecordCompare( f29_arg2 ) and not IsCombatRecordForRemotePlayer() then
			CoD.Menu.SetButtonLabel( f29_arg1, Enum.LUIButton.LUI_KEY_START, "MENU_COMPARE" )
			return true
		elseif EnableCombatRecordCompare( f29_arg2 ) and IsCombatRecordForRemotePlayer() then
			CoD.Menu.SetButtonLabel( f29_arg1, Enum.LUIButton.LUI_KEY_START, "MENU_COMPARE" )
			return true
		else
			return false
	...
	f2_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBX_PSSQUARE, "C", function ( f30_arg0, f30_arg1, f30_arg2, f30_arg3 )
		if IsComparingStats( f30_arg2 ) then
			CombatRecordSetComparing( self, f30_arg2, false )
			return true
		else
			
		end
	end, function ( f31_arg0, f31_arg1, f31_arg2 )
		if IsComparingStats( f31_arg2 ) then
			CoD.Menu.SetButtonLabel( f31_arg1, Enum.LUIButton.LUI_KEY_XBX_PSSQUARE, "MENU_CLEAR_COMPARE" )
			return true
		else
			return false
		end
