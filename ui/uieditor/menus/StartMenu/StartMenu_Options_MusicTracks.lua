-- db8c558e297c255266b5e80fe199e77a
...
LUI.createMenu.StartMenu_Options_MusicTracks = function ( controller )
	...
	local MenuFrame = CoD.GenericMenuFrame.new( f21_local1, controller )
	...
	local FEMenuLeftGraphics0 = CoD.FE_Menu_LeftGraphics.new( f21_local1, controller )
	...
	local cacItemTitleGlow0 = CoD.cac_ItemTitleGlow.new( f21_local1, controller )
	...
	local ButtonList = LUI.UIList.new( f21_local1, controller, 10, 0, nil, false, false, 0, 0, false, true )
	...
	ButtonList:linkToElementModel( ButtonList, "selected", true, function ( model )
		...
		CoD.Menu.UpdateButtonShownState( f22_local0, f21_local1, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS )
	end )
	ButtonList:subscribeToModel( Engine.GetModel( Engine.GetGlobalModel(), "musicTracksBase.currentFilterSelected" ), function ( model )
		...
		CoD.Menu.UpdateButtonShownState( f23_local0, f21_local1, controller, Enum.LUIButton.LUI_KEY_XBX_PSSQUARE )
	end )
	ButtonList:registerEventHandler( "gain_list_focus", function ( element, event )
		local f24_local0 = nil
		SetMenuState( f21_local1, "DefaultState" )
		return f24_local0
	end )
	ButtonList:registerEventHandler( "gain_focus", function ( element, event )
		...
		CoD.Menu.UpdateButtonShownState( element, f21_local1, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS )
		CoD.Menu.UpdateButtonShownState( element, f21_local1, controller, Enum.LUIButton.LUI_KEY_XBY_PSTRIANGLE )
		CoD.Menu.UpdateButtonShownState( element, f21_local1, controller, Enum.LUIButton.LUI_KEY_XBX_PSSQUARE )
		return f25_local0
	end )
	...
	f21_local1:AddButtonCallbackFunction( ButtonList, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f27_arg0, f27_arg1, f27_arg2, f27_arg3 )
		if not IsSelfModelValueTrue( f27_arg0, f27_arg2, "selected" ) then
			ToggleMusicTrackSelected( f27_arg2, f27_arg0, f27_arg1 )
			return true
		else
			ToggleMusicTrackSelected( f27_arg2, f27_arg0, f27_arg1 )
			return true
		...
		if not IsSelfModelValueTrue( f28_arg0, f28_arg2, "selected" ) then
			CoD.Menu.SetButtonLabel( f28_arg1, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "MENU_SELECT" )
			return true
		else
			CoD.Menu.SetButtonLabel( f28_arg1, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "MENU_DESELECT" )
			return true
		end
	end, true )
	f21_local1:AddButtonCallbackFunction( ButtonList, controller, Enum.LUIButton.LUI_KEY_XBY_PSTRIANGLE, "P", function ( f29_arg0, f29_arg1, f29_arg2, f29_arg3 )
		PlayMusicTrackPreview( f29_arg0, f29_arg1 )
		return true
	end, function ( f30_arg0, f30_arg1, f30_arg2 )
		CoD.Menu.SetButtonLabel( f30_arg1, Enum.LUIButton.LUI_KEY_XBY_PSTRIANGLE, "MENU_PLAY_SELECTED_TRACK" )
		return true
	end, false )
	f21_local1:AddButtonCallbackFunction( ButtonList, controller, Enum.LUIButton.LUI_KEY_XBX_PSSQUARE, "A", function ( f31_arg0, f31_arg1, f31_arg2, f31_arg3 )
		if ShouldDeselectAllTracks( f31_arg2 ) then
			DeselectAllMusicTracksInFilter( f31_arg1, f31_arg2, f31_arg0 )
			return true
		else
			SelectAllMusicTracksInFilter( f31_arg1, f31_arg2 )
			return true
		end
	end, function ( f32_arg0, f32_arg1, f32_arg2 )
		if ShouldDeselectAllTracks( f32_arg2 ) then
			CoD.Menu.SetButtonLabel( f32_arg1, Enum.LUIButton.LUI_KEY_XBX_PSSQUARE, "MENU_DESELECT_ALL" )
			return true
		else
			CoD.Menu.SetButtonLabel( f32_arg1, Enum.LUIButton.LUI_KEY_XBX_PSSQUARE, "MENU_SELECT_ALL" )
			return true
		end
	end, false )
	...
	local verticalCounter0 = CoD.verticalCounter.new( f21_local1, controller )
	...
	local MissionRecordVaultlines01 = CoD.MissionRecordVault_lines.new( f21_local1, controller )
	...
	local globalOnOffSwitch = LUI.UIList.new( f21_local1, controller, 2, 0, nil, false, false, 0, 0, false, true )
	...
	globalOnOffSwitch:registerEventHandler( "gain_list_focus", function ( element, event )
		...
		SetMenuState( f21_local1, "HideInfo" )
		return f34_local0
	end )
	...
	f21_local1:AddButtonCallbackFunction( globalOnOffSwitch, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f37_arg0, f37_arg1, f37_arg2, f37_arg3 )
		ProcessListAction( self, f37_arg0, f37_arg2 )
		return true
	...
	local StartMenuMusicTracksTrackListInfo0 = CoD.StartMenu_MusicTracks_TrackListInfo.new( f21_local1, controller )
	...
	local playlistBacking = CoD.cac_ItemTitleGlow.new( f21_local1, controller )
	...
	CoD.Menu.AddNavigationHandler( f21_local1, self, controller )
	...
	f21_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, nil, function ( f47_arg0, f47_arg1, f47_arg2, f47_arg3 )
		GoBack( self, f47_arg2 )
		UpdateGamerprofile( self, f47_arg0, f47_arg2 )
		return true
	end, function ( f48_arg0, f48_arg1, f48_arg2 )
		CoD.Menu.SetButtonLabel( f48_arg1, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, "MENU_BACK" )
		return true
	end, false )
	f21_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_START, "M", function ( f49_arg0, f49_arg1, f49_arg2, f49_arg3 )
		OpenPopup( self, "StartMenu_Options_MusicTracks_Options", f49_arg2, "", "" )
		return true
	end, function ( f50_arg0, f50_arg1, f50_arg2 )
		CoD.Menu.SetButtonLabel( f50_arg1, Enum.LUIButton.LUI_KEY_START, "MENU_OPTIONS" )
		return true
	end, false )
	LUI.OverrideFunction_CallOriginalFirst( self, "close", function ( element )
		ResumeFrontendMusicForMusicTracks( f21_local1 )
	end )
