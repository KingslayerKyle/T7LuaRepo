-- a8c31a8ca93fc6c0533ab3b256576753
...
LUI.createMenu.StartMenu_Options_Controls_StickLayout = function ( controller )
	...
	local stickLayoutButtonList = LUI.UIList.new( f23_local1, controller, 1, 0, nil, false, false, 0, 0, false, true )
	...
	local leftStickUpText = CoD.StartMenu_Options_Controls_GenericControllerItem.new( f23_local1, controller )
	...
	local leftStickDownText = CoD.StartMenu_Options_Controls_GenericControllerItem.new( f23_local1, controller )
	...
	local leftStickLeftRightText = CoD.StartMenu_Options_Controls_GenericControllerItem.new( f23_local1, controller )
	...
	local rightStickUpText = CoD.StartMenu_Options_Controls_GenericControllerItem.new( f23_local1, controller )
	...
	local rightStickDownText = CoD.StartMenu_Options_Controls_GenericControllerItem.new( f23_local1, controller )
	...
	local rightStickLeftRightText = CoD.StartMenu_Options_Controls_GenericControllerItem.new( f23_local1, controller )
	...
	local MenuFrame = CoD.GenericMenuFrame.new( f23_local1, controller )
	...
	local stickLayoutDropdownList = LUI.UIList.new( f23_local1, controller, 0, 0, nil, false, false, 0, 0, false, false )
	...
	if self.m_eventHandlers.input_source_changed then
		...
		self:registerEventHandler( "input_source_changed", function ( element, event )
			event.menu = event.menu or f23_local1
			element:updateState( event )
			return f23_local17( element, event )
		end )
	else
		self:registerEventHandler( "input_source_changed", LUI.UIElement.updateState )
	end
	self:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "LastInput" ), function ( model )
		f23_local1:updateElementState( self, {
	...
	CoD.Menu.AddNavigationHandler( f23_local1, self, controller )
	f23_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, nil, function ( f43_arg0, f43_arg1, f43_arg2, f43_arg3 )
		GoBack( self, f43_arg2 )
		ForceNotifyControllerModel( f43_arg2, "forceUpdateVehicleBindings" )
		UpdateGamerprofile( self, f43_arg0, f43_arg2 )
		ClearSavedState( self, f43_arg2 )
		return true
	...
	LUI.OverrideFunction_CallOriginalFirst( self, "setState", function ( element, controller )
		if IsMenuInState( f23_local1, "PC" ) then
