-- c28898bd182287143921e3251976200e
...
LUI.createMenu.StartMenu_Options_Controls_PC = function ( controller )
	...
	local MenuFrame = CoD.GenericMenuFrame.new( f17_local1, controller )
	...
	local StartMenulineGraphicsOptions0 = CoD.StartMenu_lineGraphics_Options.new( f17_local1, controller )
	...
	local categoryFrame = LUI.UIFrame.new( f17_local1, controller, 0, 0, false )
	...
	local StartMenulineGraphics20 = CoD.StartMenu_lineGraphics2.new( f17_local1, controller )
	...
	local Tabs = CoD.basicTabList.new( f17_local1, controller )
	...
	self:registerEventHandler( "menu_loaded", function ( element, event )
		...
		ShowHeaderIconOnly( f17_local1 )
		if not f19_local0 then
			f19_local0 = element:dispatchEventToChildren( event )
		end
		return f19_local0
	end )
	f17_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, nil, function ( f20_arg0, f20_arg1, f20_arg2, f20_arg3 )
	...
	f17_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_START, "M", function ( f22_arg0, f22_arg1, f22_arg2, f22_arg3 )
		CloseStartMenu( f22_arg1, f22_arg2 )
		return true
	end, function ( f23_arg0, f23_arg1, f23_arg2 )
		CoD.Menu.SetButtonLabel( f23_arg1, Enum.LUIButton.LUI_KEY_START, "MENU_DISMISS_MENU" )
		return true
	end, false )
	f17_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBX_PSSQUARE, "R", function ( f24_arg0, f24_arg1, f24_arg2, f24_arg3 )
		OpenPCResetControlsPopup( self, f24_arg0, f24_arg2 )
		return true
	end, function ( f25_arg0, f25_arg1, f25_arg2 )
		CoD.Menu.SetButtonLabel( f25_arg1, Enum.LUIButton.LUI_KEY_XBX_PSSQUARE, "MENU_RESET_TO_DEFAULT" )
		return true
	end, false )
	f17_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, nil, function ( f26_arg0, f26_arg1, f26_arg2, f26_arg3 )
		return true
