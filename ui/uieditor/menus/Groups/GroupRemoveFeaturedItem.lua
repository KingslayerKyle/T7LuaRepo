-- d78780d9b074eb6f209ddb53d481ee45
...
LUI.createMenu.GroupRemoveFeaturedItem = function ( controller )
	...
	local itemList = LUI.UIList.new( f4_local1, controller, 16, 0, nil, false, false, 0, 0, false, false )
	...
	f4_local1:AddButtonCallbackFunction( itemList, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f10_arg0, f10_arg1, f10_arg2, f10_arg3 )
		if not IsSelfModelValueTrue( f10_arg0, f10_arg2, "featureIsProcessing" ) then
			SwitchGroupShowcaseContentFeatured( self, f10_arg0, f10_arg2, f10_arg1 )
			Close( self, f10_arg2 )
			return true
		else
		...
		if not IsSelfModelValueTrue( f11_arg0, f11_arg2, "featureIsProcessing" ) then
			return true
		else
			return false
		end
	...
	itemList:linkToElementModel( itemList, "featureIsProcessing", true, function ( model )
		f4_local1:updateElementState( itemList, {
			name = "model_validation",
			menu = f4_local1,
			modelValue = Engine.GetModelValue( model ),
			modelName = "featureIsProcessing"
	...
	local FileshareSpinner = CoD.FileshareSpinner.new( f4_local1, controller )
	...
	f4_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, nil, function ( f25_arg0, f25_arg1, f25_arg2, f25_arg3 )
