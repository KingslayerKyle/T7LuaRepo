-- f33954008a0e8318cac3a7317caa6c05
...
LUI.createMenu.GroupInvitesOptions = function ( controller )
	local self = CoD.Menu.NewForUIEditor( "GroupInvitesOptions" )
	if PreLoadFunc then
	...
	self.buttonModel = Engine.CreateModel( Engine.GetModelForController( controller ), "GroupInvitesOptions.buttonPrompts" )
	...
	optionsList:setDataSource( "GroupInvitesOverviewButtonList" )
	...
	title:setText( Engine.Localize( "GROUPS_GROUP_INVITES_OPTIONS_CAPS" ) )
	...
	HintText:setTopBottom( true, false, 234, 254 )
	...
	Arrow1:setTopBottom( true, false, 239.5, 248.5 )
	Arrow1:setAlpha( 0.6 )
	...
	LUI.OverrideFunction_CallOriginalSecond( self, "close", function ( element )
		...
		Engine.UnsubscribeAndFreeModel( Engine.GetModel( Engine.GetModelForController( controller ), "GroupInvitesOptions.buttonPrompts" ) )
	end )
