-- e3a37779560a35de698d2fb149fbfc5b
...
LUI.createMenu.ShowFriendsGroups = function ( controller )
	...
	local FindGroupsTabSearchGroupsCommonWidget = CoD.FindGroupsTabSearchGroupsCommonWidget.new( f2_local1, controller )
	...
	local IdentityBadge = CoD.IdentityBadge.new( f2_local1, controller )
	...
	f2_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, nil, function ( f6_arg0, f6_arg1, f6_arg2, f6_arg3 )
		...
		ClearLastGroupSearchResults( self, f6_arg0, f6_arg2 )
		GoBack( self, f6_arg2 )
		return true
