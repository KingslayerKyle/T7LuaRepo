-- 52ca6ac1c14f1630a91b28ce18142148
...
LUI.createMenu.CPMissionFailed = function ( controller )
	...
	local scorestreakVignetteContainer0 = CoD.scorestreakVignetteContainer.new( f1_local1, controller )
	...
	local feLeftContainerNOTLobby0 = CoD.fe_LeftContainer_NOTLobby.new( f1_local1, controller )
	...
	local MissionFailedFailreasonText = CoD.MissionFailed_FailreasonText.new( f1_local1, controller )
	...
	local MissionFailedFailreasonText0 = CoD.MissionFailed_FailreasonText.new( f1_local1, controller )
	...
	local AbilityWheelPixel10 = CoD.AbilityWheel_Pixel.new( f1_local1, controller )
	...
	local AbilityWheelPixel30 = CoD.AbilityWheel_Pixel.new( f1_local1, controller )
	...
	local AbilityWheelPixel000 = CoD.AbilityWheel_Pixel.new( f1_local1, controller )
	...
	local AbilityWheelPixel200 = CoD.AbilityWheel_Pixel.new( f1_local1, controller )
	...
	local outofboundsdotblinkwidget11 = CoD.outofbounds_dotblinkwidget.new( f1_local1, controller )
	...
	local outofboundsdotblinkwidget110 = CoD.outofbounds_dotblinkwidget.new( f1_local1, controller )
