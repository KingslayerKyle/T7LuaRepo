-- 814317315606895e67eeb2528d6ae4fb
...
local PostLoadFunc = function ( f2_arg0, f2_arg1 )
	...
	LockInput( f2_arg0, f2_arg1, true )
	Engine.SetUIActive( f2_arg1, true )
	f2_arg0.close = function ( f3_arg0 )
		LockInput( f3_arg0, f2_arg1, false )
...
LUI.createMenu.DOA_PlayerReady = function ( controller )
	...
	local feLeftContainerNOTLobby0 = CoD.fe_LeftContainer_NOTLobby.new( f4_local1, controller )
	...
	f4_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, "ENTER", function ( f13_arg0, f13_arg1, f13_arg2, f13_arg3 )
		SendOwnMenuResponse( f13_arg1, f13_arg2, "MENU_READY" )
		return true
	end, function ( f14_arg0, f14_arg1, f14_arg2 )
		CoD.Menu.SetButtonLabel( f14_arg1, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, "DOA_PLAYER_READY" )
		return true
	end, false )
