-- b6730f17be1866c9d3a151d32ae12679
...
LUI.createMenu.CPChyron = function ( controller )
	...
	local Chyron = CoD.ChyronScrollingText.new( f11_local1, controller )
	...
	local ChyronFlashLine1 = CoD.ChyronFlashLine.new( f11_local1, controller )
	...
	local ChyronFlashLine2 = CoD.ChyronFlashLine.new( f11_local1, controller )
	...
	local ChyronFlashLine3 = CoD.ChyronFlashLine.new( f11_local1, controller )
	...
	local ChyronFlashLine4 = CoD.ChyronFlashLine.new( f11_local1, controller )
	...
	local Team1PlayerList = LUI.UIList.new( f11_local1, controller, 5, 0, nil, false, false, 0, 0, false, false )
