-- 0d106f8e84dde68be0e63ba87e93574e
...
LUI.createMenu.MediaManager = function ( controller )
	...
	local ElemsSideList = CoD.cac_ElemsSideList.new( f2_local1, controller )
	...
	local EmblemsList = LUI.UIList.new( f2_local1, controller, 5, 0, nil, false, false, 0, 0, false, true )
	...
	f2_local1:AddButtonCallbackFunction( EmblemsList, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f8_arg0, f8_arg1, f8_arg2, f8_arg3 )
		if not IsSelfModelValueEqualTo( f8_arg0, f8_arg2, "isBuyMore", true ) and IsMenuInState( f8_arg1, "Emblems" ) and ListHasElements( f8_arg0 ) then
			MediaManagerClearEmblem( self, f8_arg0, f8_arg2, "", f8_arg1 )
			return true
		elseif IsSelfModelValueEqualTo( f8_arg0, f8_arg2, "isBuyMore", true ) and ListHasElements( f8_arg0 ) then
			OpenPurchaseExtraSlotsOverlay( self, f8_arg2, f8_arg1 )
			return true
		else
			
		end
	end, function ( f9_arg0, f9_arg1, f9_arg2 )
		if not IsSelfModelValueEqualTo( f9_arg0, f9_arg2, "isBuyMore", true ) and IsMenuInState( f9_arg1, "Emblems" ) and ListHasElements( f9_arg0 ) then
			CoD.Menu.SetButtonLabel( f9_arg1, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "MENU_DELETE" )
			return true
		elseif IsSelfModelValueEqualTo( f9_arg0, f9_arg2, "isBuyMore", true ) and ListHasElements( f9_arg0 ) then
			CoD.Menu.SetButtonLabel( f9_arg1, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "MENU_INGAMESTORE" )
			return true
		else
			return false
		end
	...
	EmblemsList:subscribeToGlobalModel( controller, "MediaManager", "dirty", function ( model )
		...
		UpdateButtonPromptState( f2_local1, f10_local0, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS )
	end )
	self:addElement( EmblemsList )
	self.EmblemsList = EmblemsList
	
	local VariantsList = LUI.UIList.new( f2_local1, controller, 5, 0, nil, false, false, 0, 0, false, true )
	...
	VariantsList:linkToElementModel( VariantsList, "isBuyMore", true, function ( model )
		...
		CoD.Menu.UpdateButtonShownState( f11_local0, f2_local1, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS )
	end )
	...
	f2_local1:AddButtonCallbackFunction( VariantsList, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f16_arg0, f16_arg1, f16_arg2, f16_arg3 )
		if not IsSelfModelValueEqualTo( f16_arg0, f16_arg2, "isBuyMore", true ) and IsMenuInState( f16_arg1, "Variants" ) and ListHasElements( f16_arg0 ) then
			MediaManagerClearVariant( self, f16_arg0, f16_arg2, "", f16_arg1 )
			return true
		elseif IsSelfModelValueEqualTo( f16_arg0, f16_arg2, "isBuyMore", true ) and ListHasElements( f16_arg0 ) then
			OpenPurchaseExtraSlotsOverlay( self, f16_arg2, f16_arg1 )
			return true
		else
			
		end
	end, function ( f17_arg0, f17_arg1, f17_arg2 )
		if not IsSelfModelValueEqualTo( f17_arg0, f17_arg2, "isBuyMore", true ) and IsMenuInState( f17_arg1, "Variants" ) and ListHasElements( f17_arg0 ) then
			CoD.Menu.SetButtonLabel( f17_arg1, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "MENU_DELETE" )
			return true
		elseif IsSelfModelValueEqualTo( f17_arg0, f17_arg2, "isBuyMore", true ) and ListHasElements( f17_arg0 ) then
			CoD.Menu.SetButtonLabel( f17_arg1, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "MENU_INGAMESTORE" )
			return true
		else
			return false
		end
	...
	VariantsList:subscribeToGlobalModel( controller, "MediaManager", "dirty", function ( model )
		...
		UpdateButtonPromptState( f2_local1, f18_local0, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS )
	end )
	self:addElement( VariantsList )
	self.VariantsList = VariantsList
	
	local PaintjobList = LUI.UIList.new( f2_local1, controller, 5, 0, nil, false, false, 0, 0, false, true )
	...
	f2_local1:AddButtonCallbackFunction( PaintjobList, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f24_arg0, f24_arg1, f24_arg2, f24_arg3 )
		if not IsSelfModelValueEqualTo( f24_arg0, f24_arg2, "isBuyMore", true ) and IsMenuInState( f24_arg1, "Paintjobs" ) and ListHasElements( f24_arg0 ) then
			MediaManagerClearPaintjob( self, f24_arg0, f24_arg2, "1", f24_arg1 )
			return true
		elseif IsSelfModelValueEqualTo( f24_arg0, f24_arg2, "isBuyMore", true ) and ListHasElements( f24_arg0 ) then
			OpenPurchaseExtraSlotsOverlay( self, f24_arg2, f24_arg1 )
			return true
		else
			
		end
	end, function ( f25_arg0, f25_arg1, f25_arg2 )
		if not IsSelfModelValueEqualTo( f25_arg0, f25_arg2, "isBuyMore", true ) and IsMenuInState( f25_arg1, "Paintjobs" ) and ListHasElements( f25_arg0 ) then
			CoD.Menu.SetButtonLabel( f25_arg1, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "MENU_DELETE" )
			return true
		elseif IsSelfModelValueEqualTo( f25_arg0, f25_arg2, "isBuyMore", true ) and ListHasElements( f25_arg0 ) then
			CoD.Menu.SetButtonLabel( f25_arg1, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "MENU_INGAMESTORE" )
			return true
		else
			return false
		end
	...
	PaintjobList:subscribeToGlobalModel( controller, "MediaManager", "dirty", function ( model )
		...
		UpdateButtonPromptState( f2_local1, f26_local0, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS )
	end )
	self:addElement( PaintjobList )
	self.PaintjobList = PaintjobList
	
	local CustomGamesList = LUI.UIList.new( f2_local1, controller, 5, 0, nil, false, false, 0, 0, false, true )
	...
	CustomGamesList:linkToElementModel( CustomGamesList, "isBuyMore", true, function ( model )
		...
		CoD.Menu.UpdateButtonShownState( f27_local0, f2_local1, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS )
	end )
	...
	f2_local1:AddButtonCallbackFunction( CustomGamesList, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, nil, function ( f32_arg0, f32_arg1, f32_arg2, f32_arg3 )
		if not IsSelfModelValueEqualTo( f32_arg0, f32_arg2, "isBuyMore", true ) and IsMenuInState( f32_arg1, "CustomGames" ) and ListHasElements( f32_arg0 ) then
			MediaManagerClearCustomGame( self, f32_arg0, f32_arg2, "", f32_arg1 )
			return true
		elseif IsSelfModelValueEqualTo( f32_arg0, f32_arg2, "isBuyMore", true ) and ListHasElements( f32_arg0 ) then
			OpenPurchaseExtraSlotsOverlay( self, f32_arg2, f32_arg1 )
			return true
		else
			
		end
	end, function ( f33_arg0, f33_arg1, f33_arg2 )
		if not IsSelfModelValueEqualTo( f33_arg0, f33_arg2, "isBuyMore", true ) and IsMenuInState( f33_arg1, "CustomGames" ) and ListHasElements( f33_arg0 ) then
			CoD.Menu.SetButtonLabel( f33_arg1, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "MENU_DELETE" )
			return true
		elseif IsSelfModelValueEqualTo( f33_arg0, f33_arg2, "isBuyMore", true ) and ListHasElements( f33_arg0 ) then
			CoD.Menu.SetButtonLabel( f33_arg1, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "MENU_INGAMESTORE" )
			return true
		else
			return false
		end
	...
	CustomGamesList:subscribeToGlobalModel( controller, "MediaManager", "dirty", function ( model )
		...
		UpdateButtonPromptState( f2_local1, f34_local0, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS )
	end )
	self:addElement( CustomGamesList )
	self.CustomGamesList = CustomGamesList
	
	local ScreenshotsList = LUI.UIList.new( f2_local1, controller, 5, 0, nil, false, false, 0, 0, false, true )
	...
	ScreenshotsList:linkToElementModel( ScreenshotsList, "isBuyMore", true, function ( model )
		...
		CoD.Menu.UpdateButtonShownState( f35_local0, f2_local1, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS )
	end )
	...
	f2_local1:AddButtonCallbackFunction( ScreenshotsList, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, nil, function ( f40_arg0, f40_arg1, f40_arg2, f40_arg3 )
		if not IsSelfModelValueEqualTo( f40_arg0, f40_arg2, "isBuyMore", true ) and IsMenuInState( f40_arg1, "Screenshots" ) and ListHasElements( f40_arg0 ) then
			MediaManagerDeleteTheaterFile( self, f40_arg0, f40_arg2, "", f40_arg1 )
			return true
		elseif IsSelfModelValueEqualTo( f40_arg0, f40_arg2, "isBuyMore", true ) and ListHasElements( f40_arg0 ) then
			OpenPurchaseExtraSlotsOverlay( self, f40_arg2, f40_arg1 )
			return true
		else
			
		end
	end, function ( f41_arg0, f41_arg1, f41_arg2 )
		if not IsSelfModelValueEqualTo( f41_arg0, f41_arg2, "isBuyMore", true ) and IsMenuInState( f41_arg1, "Screenshots" ) and ListHasElements( f41_arg0 ) then
			CoD.Menu.SetButtonLabel( f41_arg1, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "MENU_DELETE" )
			return true
		elseif IsSelfModelValueEqualTo( f41_arg0, f41_arg2, "isBuyMore", true ) and ListHasElements( f41_arg0 ) then
			CoD.Menu.SetButtonLabel( f41_arg1, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "MENU_INGAMESTORE" )
			return true
		else
			return false
		end
	...
	ScreenshotsList:subscribeToGlobalModel( controller, "FileshareRoot", "dirty", function ( model )
		...
		UpdateButtonPromptState( f2_local1, f43_local0, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS )
	end )
	self:addElement( ScreenshotsList )
	self.ScreenshotsList = ScreenshotsList
	
	local ClipsList = LUI.UIList.new( f2_local1, controller, 5, 0, nil, false, false, 0, 0, false, true )
	...
	ClipsList:linkToElementModel( ClipsList, "isBuyMore", true, function ( model )
		...
		CoD.Menu.UpdateButtonShownState( f44_local0, f2_local1, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS )
	end )
	...
	f2_local1:AddButtonCallbackFunction( ClipsList, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, nil, function ( f49_arg0, f49_arg1, f49_arg2, f49_arg3 )
		if not IsSelfModelValueEqualTo( f49_arg0, f49_arg2, "isBuyMore", true ) and ListHasElements( f49_arg0 ) then
			MediaManagerDeleteTheaterFile( self, f49_arg0, f49_arg2, "", f49_arg1 )
			return true
		elseif IsSelfModelValueEqualTo( f49_arg0, f49_arg2, "isBuyMore", true ) and ListHasElements( f49_arg0 ) then
			OpenPurchaseExtraSlotsOverlay( self, f49_arg2, f49_arg1 )
			return true
		else
			
		end
	end, function ( f50_arg0, f50_arg1, f50_arg2 )
		if not IsSelfModelValueEqualTo( f50_arg0, f50_arg2, "isBuyMore", true ) and ListHasElements( f50_arg0 ) then
			CoD.Menu.SetButtonLabel( f50_arg1, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "MENU_DELETE" )
			return true
		elseif IsSelfModelValueEqualTo( f50_arg0, f50_arg2, "isBuyMore", true ) and ListHasElements( f50_arg0 ) then
			CoD.Menu.SetButtonLabel( f50_arg1, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "MENU_INGAMESTORE" )
			return true
		else
			return false
		end
	...
	ClipsList:subscribeToGlobalModel( controller, "FileshareRoot", "dirty", function ( model )
		...
		UpdateButtonPromptState( f2_local1, f52_local0, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS )
	end )
	self:addElement( ClipsList )
	self.ClipsList = ClipsList
	
	local MediaManagerEmblemItemLarge = CoD.MediaManager_EmblemItemLarge.new( f2_local1, controller )
	...
	MediaManagerEmblemItemLarge:subscribeToModel( Engine.GetModel( Engine.GetGlobalModel(), "MediaManager.isBuyMoreSlot" ), function ( model )
		f2_local1:updateElementState( MediaManagerEmblemItemLarge, {
			name = "model_validation",
			menu = f2_local1,
			modelValue = Engine.GetModelValue( model ),
	...
	local MediaManagerVariantItemLarge0 = CoD.MediaManager_VariantItemLarge.new( f2_local1, controller )
	...
	MediaManagerVariantItemLarge0:subscribeToModel( Engine.GetModel( Engine.GetGlobalModel(), "MediaManager.isBuyMoreSlot" ), function ( model )
		f2_local1:updateElementState( MediaManagerVariantItemLarge0, {
			name = "model_validation",
			menu = f2_local1,
			modelValue = Engine.GetModelValue( model ),
			modelName = "MediaManager.isBuyMoreSlot"
	...
	local MediaManagerPaintshopItemLarge0 = CoD.MediaManager_PaintshopItemLarge.new( f2_local1, controller )
	...
	MediaManagerPaintshopItemLarge0:subscribeToModel( Engine.GetModel( Engine.GetGlobalModel(), "MediaManager.isBuyMoreSlot" ), function ( model )
		f2_local1:updateElementState( MediaManagerPaintshopItemLarge0, {
			name = "model_validation",
			menu = f2_local1,
			modelValue = Engine.GetModelValue( model ),
			modelName = "MediaManager.isBuyMoreSlot"
	...
	local MediaManagerCustomGameItemLarge0 = CoD.MediaManager_CustomGameItemLarge.new( f2_local1, controller )
	...
	MediaManagerCustomGameItemLarge0:subscribeToModel( Engine.GetModel( Engine.GetGlobalModel(), "MediaManager.isBuyMoreSlot" ), function ( model )
		f2_local1:updateElementState( MediaManagerCustomGameItemLarge0, {
			name = "model_validation",
			menu = f2_local1,
			modelValue = Engine.GetModelValue( model ),
			modelName = "MediaManager.isBuyMoreSlot"
	...
	local MediaManagerTheaterFileItemScreenshot = CoD.MediaManager_TheaterFileItemLarge.new( f2_local1, controller )
	...
	MediaManagerTheaterFileItemScreenshot:subscribeToModel( Engine.GetModel( Engine.GetGlobalModel(), "MediaManager.isBuyMoreSlot" ), function ( model )
		f2_local1:updateElementState( MediaManagerTheaterFileItemScreenshot, {
			name = "model_validation",
			menu = f2_local1,
			modelValue = Engine.GetModelValue( model ),
			modelName = "MediaManager.isBuyMoreSlot"
	...
	local MediaManagerTheaterFileItemClip = CoD.MediaManager_TheaterFileItemLarge.new( f2_local1, controller )
	...
	MediaManagerTheaterFileItemClip:subscribeToModel( Engine.GetModel( Engine.GetGlobalModel(), "MediaManager.isBuyMoreSlot" ), function ( model )
		f2_local1:updateElementState( MediaManagerTheaterFileItemClip, {
			name = "model_validation",
			menu = f2_local1,
			modelValue = Engine.GetModelValue( model ),
			modelName = "MediaManager.isBuyMoreSlot"
	...
	local MediaManagerSelectedItemInfo0 = CoD.MediaManager_SelectedItemInfo.new( f2_local1, controller )
	...
	MediaManagerSelectedItemInfo0:subscribeToModel( Engine.GetModel( Engine.GetGlobalModel(), "MediaManager.isBuyMoreSlot" ), function ( model )
		f2_local1:updateElementState( MediaManagerSelectedItemInfo0, {
			name = "model_validation",
			menu = f2_local1,
			modelValue = Engine.GetModelValue( model ),
			modelName = "MediaManager.isBuyMoreSlot"
	...
	local MediaManagerBuyExtraSlots = CoD.MediaManager_BuyExtraSlots.new( f2_local1, controller )
	...
	local MediaManagerNoContent = CoD.MediaManager_NoContent.new( f2_local1, controller )
	...
	MediaManagerNoContent:subscribeToModel( Engine.GetModel( Engine.GetGlobalModel(), "MediaManager.slotsUsed" ), function ( model )
		f2_local1:updateElementState( MediaManagerNoContent, {
			name = "model_validation",
			menu = f2_local1,
			modelValue = Engine.GetModelValue( model ),
			modelName = "MediaManager.slotsUsed"
	...
	self:registerEventHandler( "menu_loaded", function ( element, event )
		...
		SetIsMediaManager( self, element, controller, "true", f2_local1 )
		if not f96_local0 then
			f96_local0 = element:dispatchEventToChildren( event )
		end
		return f96_local0
	end )
	f2_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, nil, function ( f97_arg0, f97_arg1, f97_arg2, f97_arg3 )
		MediaManagerClose( self, f97_arg0, f97_arg2 )
		GoBack( self, f97_arg2 )
		ClearSavedState( self, f97_arg2 )
		MediaManagerClearDisplay( self, f97_arg0, f97_arg2 )
		SendClientScriptMenuChangeNotify( f97_arg2, f97_arg1, false )
		SetIsMediaManager( self, f97_arg0, f97_arg2, "false", f97_arg1 )
		MediaManagerReloadWeaponModelIfNeeded( f97_arg2 )
		return true
	end, function ( f98_arg0, f98_arg1, f98_arg2 )
		CoD.Menu.SetButtonLabel( f98_arg1, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, "MENU_BACK" )
		return true
	end, false )
	...
	self:subscribeToGlobalModel( controller, "FileshareRoot", "dirty", function ( model )
		...
		UpdateMenuState( f2_local1, event )
	end )
