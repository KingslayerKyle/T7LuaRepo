-- 3f40ef8c53b3c5d50d323ddd7d1edca9
...
local f0_local0 = function ( f1_arg0, f1_arg1 )
	...
	if f1_local1 then
		...
		if (f1_local0 == "primary" or f1_local0 == "secondary") and f1_local2 then
			f1_arg0.desc.desc:setText( Engine.Localize( "MENU_TOO_MANY_WILDCARDS_WEAPVAR_CAPS", Engine.MarkAsLocalize( Engine.GetModelValue( f1_local2 ) ), f1_local5 ) )
		else
...
LUI.createMenu.WildcardCapacity = function ( controller )
	...
	local background = CoD.CACFullPopupBackground.new( f4_local1, controller )
	...
	local selectionList = LUI.UIList.new( f4_local1, controller, 10, 0, nil, true, false, 0, 0, false, false )
	...
	f4_local1:AddButtonCallbackFunction( selectionList, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f8_arg0, f8_arg1, f8_arg2, f8_arg3 )
		RemoveOverflowWildcardFromClass( self, f8_arg0, f8_arg2 )
		return true
	...
	local StartMenuTitlePopup = CoD.StartMenu_TitlePopup.new( f4_local1, controller )
	...
	local desc = CoD.cac_wildcardwarningtext.new( f4_local1, controller )
	...
	local cac2lines0 = CoD.cac_2lines.new( f4_local1, controller )
	...
	f4_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, nil, function ( f12_arg0, f12_arg1, f12_arg2, f12_arg3 )
	...
	f4_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, nil, function ( f14_arg0, f14_arg1, f14_arg2, f14_arg3 )
		return true
