-- ccb832e8b753fbbe3242513816a385a0
...
LUI.createMenu.UnlockConfirmation = function ( controller )
	...
	local background = CoD.CACFullPopupBackground.new( f7_local1, controller )
	...
	local buttonList = LUI.UIList.new( f7_local1, controller, 10, 0, nil, false, false, 0, 0, false, true )
	...
	f7_local1:AddButtonCallbackFunction( buttonList, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f11_arg0, f11_arg1, f11_arg2, f11_arg3 )
	...
	local UnlockTokensWidget = CoD.UnlockTokensWidget.new( f7_local1, controller )
	...
	f7_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, nil, function ( f14_arg0, f14_arg1, f14_arg2, f14_arg3 )
	...
	f7_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, nil, function ( f16_arg0, f16_arg1, f16_arg2, f16_arg3 )
		return true
