-- 9374520e09950658f0b7f2b88e96d340
...
LUI.createMenu.CustomClass = function ( controller )
	...
	local chooseClassWidget = CoD.chooseClassWidget.new( f14_local1, controller )
	...
	local previewWidget = CoD.InfopanePreviewWidget.new( f14_local1, controller )
	...
	local feFooterContainer = CoD.fe_FooterContainer_NOTLobby.new( f14_local1, controller )
	...
	local CACBackground0 = CoD.CACBackgroundNew.new( f14_local1, controller )
	...
	local PregameTimerOverlay = CoD.Pregame_TimerOverlay.new( f14_local1, controller )
	...
	PregameTimerOverlay:subscribeToModel( Engine.GetModel( Engine.GetGlobalModel(), "lobbyRoot.Pregame.state" ), function ( model )
		f14_local1:updateElementState( PregameTimerOverlay, {
	...
	local cacrestrictionwarning = CoD.cac_restriction_warning.new( f14_local1, controller )
	...
	self:registerEventHandler( "input_source_changed", function ( element, event )
		CoD.Menu.UpdateButtonShownState( element, f14_local1, controller, Enum.LUIButton.LUI_KEY_PCKEY_0 )
	end )
	self:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "LastInput" ), function ( model )
		...
		CoD.Menu.UpdateButtonShownState( f38_local0, f14_local1, controller, Enum.LUIButton.LUI_KEY_PCKEY_0 )
	end )
	...
	self:registerEventHandler( "menu_loaded", function ( element, event )
		...
		SendClientScriptMenuChangeNotify( controller, f14_local1, true )
		ShowHeaderKickerAndIcon( f14_local1 )
	...
	f14_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f45_arg0, f45_arg1, f45_arg2, f45_arg3 )
		if CACShowSelectPrompt( self, f45_arg0, f45_arg2 ) then
			NavigateToLoadoutMenu( self, f45_arg2 )
			return true
		else
		...
		if CACShowSelectPrompt( self, f46_arg0, f46_arg2 ) then
			return true
		else
			return false
		end
	end, true )
	f14_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, nil, function ( f47_arg0, f47_arg1, f47_arg2, f47_arg3 )
		SetBackFromCustomClass( self )
		SendClientScriptMenuChangeNotify( f47_arg2, f47_arg1, false )
		SendClientScriptNotifyForAdjustedClient( f47_arg2, "CustomClass_closed", "" )
		SetPerControllerTableProperty( f47_arg2, "weaponCategory", nil )
		SetPerControllerTableProperty( f47_arg2, "weaponSlot", nil )
	...
	f14_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBX_PSSQUARE, "R", function ( f49_arg0, f49_arg1, f49_arg2, f49_arg3 )
		if CACShowRemovePrompt( self, f49_arg0 ) then
			RemoveItemFromClass( self, f49_arg0, f49_arg2 )
			UpdateButtonPromptState( f49_arg1, f49_arg0, f49_arg2, Enum.LUIButton.LUI_KEY_XBX_PSSQUARE )
			UpdateButtonPromptState( f49_arg1, f49_arg0, f49_arg2, Enum.LUIButton.LUI_KEY_RSTICK_PRESSED )
			EnableMouseButton( self, f49_arg2 )
			return true
		else
			
		end
	end, function ( f50_arg0, f50_arg1, f50_arg2 )
		CoD.Menu.SetButtonLabel( f50_arg1, Enum.LUIButton.LUI_KEY_XBX_PSSQUARE, "MENU_REMOVE" )
		if CACShowRemovePrompt( self, f50_arg0 ) then
			return true
		else
			return false
		end
	end, true )
	f14_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBY_PSTRIANGLE, "P", function ( f51_arg0, f51_arg1, f51_arg2, f51_arg3 )
		if not IsGamesComBuild() and not IsCPHeroWeapon( self, f51_arg2 ) then
			NavigateToPersonalizeMenu( self, f51_arg2 )
			PlaySoundSetSound( self, "cac_enter_wpn_cust_sub" )
			return true
		else
		...
		if not IsGamesComBuild() and not IsCPHeroWeapon( self, f52_arg2 ) then
			CoD.Menu.SetButtonLabel( f52_arg1, Enum.LUIButton.LUI_KEY_XBY_PSTRIANGLE, "" )
			return false
		else
			return false
		end
	end, false )
	f14_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_RSTICK_PRESSED, nil, function ( f53_arg0, f53_arg1, f53_arg2, f53_arg3 )
		if CACShowRotatePrompt( self, f53_arg0, f53_arg2 ) then
			return true
		else
			
		end
	end, function ( f54_arg0, f54_arg1, f54_arg2 )
		if CACShowRotatePrompt( self, f54_arg0, f54_arg2 ) then
			CoD.Menu.SetButtonLabel( f54_arg1, Enum.LUIButton.LUI_KEY_RSTICK_PRESSED, "PLATFORM_EMBLEM_ROTATE_LAYER" )
			return true
		else
			return false
		end
	end, false )
	f14_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_PCKEY_0, "SPACE", function ( f55_arg0, f55_arg1, f55_arg2, f55_arg3 )
		if not IsGamepad( f55_arg2 ) and IsPC() and AlwaysFalse() then
			ToggleMouse( self, f55_arg2 )
			return true
		else
			
		end
	end, function ( f56_arg0, f56_arg1, f56_arg2 )
		if not IsGamepad( f56_arg2 ) and IsPC() and AlwaysFalse() then
			CoD.Menu.SetButtonLabel( f56_arg1, Enum.LUIButton.LUI_KEY_PCKEY_0, "TEST" )
			return true
		else
			return false
		end
