-- 6d52f017b4f0d2e34a7c8b0d7bb153ef
...
LUI.createMenu.Social_InspectPlayerPopup = function ( controller )
	...
	local VignetteBack = CoD.VehicleGround_VignetteBack.new( f1_local1, controller )
	...
	local StartMenuframenoBG00 = CoD.StartMenu_frame_noBG.new( f1_local1, controller )
	...
	local CallingCardShowcaseList = LUI.UIList.new( f1_local1, controller, 4, 0, nil, false, false, 0, 0, false, false )
	...
	local callingCard = CoD.Social_CallingCard.new( f1_local1, controller )
	...
	local Kills = CoD.CombatRecordSummaryStat.new( f1_local1, controller )
	...
	local Wins = CoD.CombatRecordSummaryStat.new( f1_local1, controller )
	...
	local Score = CoD.CombatRecordSummaryStat.new( f1_local1, controller )
	...
	local FavoriteSpecialistName = CoD.scorestreaks_BoxLabel.new( f1_local1, controller )
	...
	local BoxButtonLrgInactive = CoD.cac_ButtonBoxLrgInactive.new( f1_local1, controller )
	...
	local CombatRecordSummaryStat0 = CoD.CombatRecordSummaryStat.new( f1_local1, controller )
	...
	local PrimaryProfileSnapshot = CoD.Primary_Profile_Snapshot.new( f1_local1, controller )
	...
	local CombatRecordLineDivider20 = CoD.CombatRecord_LineDivider.new( f1_local1, controller )
	...
	local CombatRecordLineDivider1 = CoD.CombatRecord_LineDivider.new( f1_local1, controller )
	...
	local CombatRecordLineDivider200 = CoD.CombatRecord_LineDivider.new( f1_local1, controller )
	...
	local CombatRecordLineDivider10 = CoD.CombatRecord_LineDivider.new( f1_local1, controller )
