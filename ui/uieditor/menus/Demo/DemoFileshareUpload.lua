-- 02e4719c09f1b09fb02f3564b1d9451a
...
LUI.createMenu.DemoFileshareUpload = function ( controller )
	...
	f2_local1:AddButtonCallbackFunction( inputDescription, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f10_arg0, f10_arg1, f10_arg2, f10_arg3 )
		if IsMenuInState( f10_arg1, "DefaultState" ) then
			OpenDemoSaveKeyboard( self, f10_arg0, f10_arg2, "desc" )
			return true
		else
	...
	local GunsmithInputButton = CoD.GunsmithInputButton.new( f2_local1, controller )
	...
	f2_local1:AddButtonCallbackFunction( GunsmithInputButton, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f16_arg0, f16_arg1, f16_arg2, f16_arg3 )
		if IsMenuInState( f16_arg1, "DefaultState" ) then
			OpenDemoSaveKeyboard( self, f16_arg0, f16_arg2, "name" )
			return true
		else
			
		end
	end, function ( f17_arg0, f17_arg1, f17_arg2 )
		if IsMenuInState( f17_arg1, "DefaultState" ) then
	...
	local BtnUpload = CoD.List1ButtonLarge_Left_ND.new( f2_local1, controller )
	...
	f2_local1:AddButtonCallbackFunction( BtnUpload, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f22_arg0, f22_arg1, f22_arg2, f22_arg3 )
		if FileshareIsReady( f22_arg2 ) and not FileshareIsUploading() then
			FilesharePrivateUpload( self, f22_arg0, f22_arg2 )
			return true
		else
			
		end
	end, function ( f23_arg0, f23_arg1, f23_arg2 )
		if FileshareIsReady( f23_arg2 ) and not FileshareIsUploading() then
	...
	BtnUpload:subscribeToModel( Engine.GetModel( Engine.GetGlobalModel(), "fileshareRoot.ready" ), function ( model )
		f2_local1:updateElementState( BtnUpload, {
			name = "model_validation",
			menu = f2_local1,
			modelValue = Engine.GetModelValue( model ),
			modelName = "fileshareRoot.ready"
	...
	local AllowDownload0 = CoD.AllowDownload.new( f2_local1, controller )
	...
	local FileshareSlotsAvailable0 = CoD.FileshareSlotsAvailable.new( f2_local1, controller )
	...
	local DialogSpinner0 = CoD.DialogSpinner.new( f2_local1, controller )
	...
	self:registerEventHandler( "fileshare_upload_success", function ( element, event )
		local f35_local0 = nil
		UploadClip_GoBack( self, element, controller, f2_local1 )
		FileshareShowUploadSuccessToast( self, element, controller )
	...
	self:registerEventHandler( "fileshare_upload_failure", function ( element, event )
	...
	f2_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, nil, function ( f37_arg0, f37_arg1, f37_arg2, f37_arg3 )
		UploadClip_GoBack( self, f37_arg0, f37_arg2, f37_arg1 )
		return true
