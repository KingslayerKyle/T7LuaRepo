-- 44230d89bd0458d3bdb8959506eb8a7a
...
local PostLoadFunc = function ( self, controller, menu )
	self.cheatCode = ""
	self:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f2_arg0, f2_arg1, f2_arg2, f2_arg3 )
...
LUI.createMenu.NumericKeypad = function ( controller )
	...
	local BackGround = CoD.DialogBackground.new( f4_local1, controller )
	BackGround:setLeftRight( true, false, 540.5, 739.5 )
	BackGround:setTopBottom( true, false, 232, 449 )
	self:addElement( BackGround )
	self.BackGround = BackGround
	
	local BackButtonPrompt = CoD.buttonprompt.new( f4_local1, controller )
	...
	local buttonA = CoD.button.new( f4_local1, controller )
	...
	local buttonB = CoD.button.new( f4_local1, controller )
	...
	local buttonC = CoD.button.new( f4_local1, controller )
	...
	local buttonD = CoD.button.new( f4_local1, controller )
	...
	local buttonE = CoD.button.new( f4_local1, controller )
	...
	local buttonF = CoD.button.new( f4_local1, controller )
	...
	local buttonG = CoD.button.new( f4_local1, controller )
	...
	local buttonH = CoD.button.new( f4_local1, controller )
	...
	local buttonI = CoD.button.new( f4_local1, controller )
	...
	local buttonP = CoD.button.new( f4_local1, controller )
	...
	local OkButton = CoD.button.new( f4_local1, controller )
	...
	local buttonJ = CoD.button.new( f4_local1, controller )
	...
	local buttonK = CoD.button.new( f4_local1, controller )
	...
	local buttonL = CoD.button.new( f4_local1, controller )
	...
	local buttonM = CoD.button.new( f4_local1, controller )
	...
	local buttonN = CoD.button.new( f4_local1, controller )
	...
	local buttonO = CoD.button.new( f4_local1, controller )
	...
	local buttonQ = CoD.button.new( f4_local1, controller )
	...
	local buttonR = CoD.button.new( f4_local1, controller )
	...
	local buttonS = CoD.button.new( f4_local1, controller )
	...
	local buttonT = CoD.button.new( f4_local1, controller )
	...
	local buttonU = CoD.button.new( f4_local1, controller )
	...
	local buttonV = CoD.button.new( f4_local1, controller )
	...
	local buttonW = CoD.button.new( f4_local1, controller )
	...
	local buttonX = CoD.button.new( f4_local1, controller )
	...
	local buttonY = CoD.button.new( f4_local1, controller )
	...
	local buttonZ = CoD.button.new( f4_local1, controller )
	...
	if self.m_eventHandlers.input_source_changed then
		...
		self:registerEventHandler( "input_source_changed", function ( element, event )
			event.menu = event.menu or f4_local1
			element:updateState( event )
			return f4_local32( element, event )
		end )
	else
	...
	f4_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, nil, function ( f13_arg0, f13_arg1, f13_arg2, f13_arg3 )
		GenericSmallPopupGoBack( self, f13_arg2 )
		return true
