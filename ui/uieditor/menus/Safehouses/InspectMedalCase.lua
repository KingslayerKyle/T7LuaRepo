-- 45429c05ad5d25fe409f10cfa1a00923
...
LUI.createMenu.InspectMedalCase = function ( controller )
	...
	local Texture = CoD.AbilityWheel_Texture.new( f2_local1, controller )
	...
	local medalList = LUI.UIList.new( f2_local1, controller, 10, 0, nil, false, false, 0, 0, false, false )
	...
	local medalInspectionArea0 = CoD.medalInspectionArea.new( f2_local1, controller )
	...
	local FETitleLineU = CoD.FE_TitleLine.new( f2_local1, controller )
	...
	local ElemssidelistLinesMedals0 = CoD.ElemssidelistLines_Medals.new( f2_local1, controller )
	...
	local FETitleLineU0 = CoD.FE_TitleLine.new( f2_local1, controller )
	...
	local FETitleLineU00 = CoD.FE_TitleLine.new( f2_local1, controller )
	...
	self:registerEventHandler( "menu_opened", function ( element, event )
		...
		if TestAndSetFirstTimeMenu( controller, "com_firsttime_medalcase" ) then
			OpenGenericLargePopup( f2_local1, controller, "MENU_FIRSTTIME_MEDALCASE", "MENU_FIRSTTIME_MEDALCASE2", "com_firsttime_medalcase_image", "MENU_FIRSTTIME_MEDALCASE_BUTTONTEXT", "", "" )
		end
	...
	f2_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, nil, function ( f7_arg0, f7_arg1, f7_arg2, f7_arg3 )
		PrepareCloseMenuInSafehouse( f7_arg2 )
	...
	LUI.OverrideFunction_CallOriginalFirst( self, "close", function ( element )
		...
		SendOwnMenuResponse( f2_local1, controller, "closed" )
