-- 2f0e9c6db087414d28a00d2b73159af2
...
LUI.createMenu.OverwriteProgressWarning = function ( controller )
	...
	local leftButtonPrompts = CoD.fe_LeftContainer.new( f1_local1, controller )
	...
	f1_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, nil, function ( f6_arg0, f6_arg1, f6_arg2, f6_arg3 )
		SendMenuResponse( self, "OverwriteProgressWarning", "cancel", f6_arg2 )
		return true
	...
	f1_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f8_arg0, f8_arg1, f8_arg2, f8_arg3 )
		SendMenuResponse( self, "OverwriteProgressWarning", "", f8_arg2 )
		return true
	end, function ( f9_arg0, f9_arg1, f9_arg2 )
		CoD.Menu.SetButtonLabel( f9_arg1, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "CP_SH_CAIRO_READY_ROOM2" )
		return true
	end, false )
