-- 0a9f4e65fe2e42833f9e0b96bd590388
...
LUI.createMenu.T7Hud_FR = function ( controller )
	...
	local FRInfoContainer = CoD.FR_InfoContainer.new( f8_local1, controller )
	...
	local FRDpadContainer = CoD.FR_DpadContainer.new( f8_local1, controller )
	...
	local AmmoWidgetContainer = CoD.AmmoWidgetMPContainer.new( f8_local1, controller )
	...
	local ScrStkContainer = CoD.ScrStk_Container.new( f8_local1, controller )
	...
	ScrStkContainer:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "hudItems.playerSpawned" ), function ( model )
		f8_local1:updateElementState( ScrStkContainer, {
	...
	local FRNotificationFlashes = CoD.FR_NotificationFlashes.new( f8_local1, controller )
	...
	local FRTopScoreContainer = CoD.FR_TopScoreContainer.new( f8_local1, controller )
	...
	FRTopScoreContainer:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "FreeRun.runState" ), function ( model )
		f8_local1:updateElementState( FRTopScoreContainer, {
			name = "model_validation",
			menu = f8_local1,
			modelValue = Engine.GetModelValue( model ),
	...
	local FRTimerContainer = CoD.FR_TimerContainer.new( f8_local1, controller )
	...
	local FRDistanceBarContainer = CoD.FR_DistanceBarContainer.new( f8_local1, controller )
	...
	local IngameChatClientContainer = CoD.IngameChatClientContainer.new( f8_local1, controller )
	...
	local FRCheckpoint = CoD.FR_Checkpoint.new( f8_local1, controller )
