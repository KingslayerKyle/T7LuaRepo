-- f284478a53e6b23b94c5ff74a36d0306
...
LUI.createMenu.ChangeTeam = function ( controller )
	...
	local playerList = LUI.UIList.new( f11_local1, controller, 2, 0, nil, false, false, 0, 0, false, true )
	...
	local buttonList = LUI.UIList.new( f11_local1, controller, 2, 0, nil, false, false, 0, 0, false, false )
	...
	buttonList:registerEventHandler( "gain_focus", function ( element, event )
		...
		CoD.Menu.UpdateButtonShownState( element, f11_local1, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS )
		return f12_local0
	end )
	...
	f11_local1:AddButtonCallbackFunction( buttonList, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f14_arg0, f14_arg1, f14_arg2, f14_arg3 )
		ProcessListAction( self, f14_arg0, f14_arg2 )
		return true
	...
	local MenuFrame = CoD.GenericMenuFrame.new( f11_local1, controller )
	...
	local FEMenuLeftGraphics0 = CoD.FE_Menu_LeftGraphics.new( f11_local1, controller )
	...
	f11_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, nil, function ( f16_arg0, f16_arg1, f16_arg2, f16_arg3 )
