-- e0e932a8d04f957431232bf2180d6745
...
local PostLoadFunc = function ( f3_arg0, f3_arg1 )
	...
	f3_arg0.updateButtonStates = function ( f5_arg0, f5_arg1, f5_arg2 )
		...
		local f5_local1 = Engine.GetModel( Engine.GetModelForController( f3_arg1 ), "AbilityWheel" )
		local f5_local2 = Engine.GetModel( Engine.GetModelForController( f3_arg1 ), "AbilityWheel.Selected" .. f5_arg1 )
		local f5_local3 = Engine.GetModel( Engine.GetModelForController( f3_arg1 ), "AbilityWheel" )
		if f5_arg0 == nil then
			if Engine.GetModelValue( f5_local2 ) == nil then
				local f5_local4 = 1
				for f5_local5 = 1, CoD.CACUtility.maxAbilityWheelItems, 1 do
					if CoD.SafeGetModelValue( f5_local3, "AbilityWheelWeapon" .. f5_local5 .. ".enabled" ) then
						f5_local4 = f5_local5
						break
					end
				end
				Engine.SetModelValue( f5_local2, f5_local4 )
			end
			f5_arg0 = Engine.GetModelValue( f5_local2 )
			f3_local0()
			f5_local0 = true
		end
		f3_arg0.previousFocusWidget = f3_arg0.currentFocusWidget
		local f5_local4 = Engine.GetModel( f5_local3, "AbilityWheelWeapon" .. f5_arg0 )
		if CoD.SafeGetModelValue( f5_local4, "enabled" ) == true then
			...
			if f5_arg2 == nil then
				...
				Engine.SetModelValue( f5_local2, f5_arg0 )
			end
		end
		if f3_arg0.currentFocusWidget ~= f3_arg0.previousFocusWidget or f5_local0 then
			if f5_local4 ~= nil then
				local f5_local5 = Engine.GetModel( f5_local4, "displayName" )
				local f5_local6 = Engine.GetModel( f5_local4, "description" )
				local f5_local7 = Engine.GetModel( f5_local4, "enemyTypeIcon" )
				local f5_local8 = Engine.SetModelValue
				local f5_local9 = Engine.GetModel( f5_local3, "selectedAbilityDisplayName" )
				local f5_local10
				if f5_local5 then
					f5_local10 = Engine.GetModelValue( f5_local5 )
					if not f5_local10 then
					
					else
						f5_local8( f5_local9, f5_local10 )
						f5_local8 = Engine.SetModelValue
						f5_local9 = Engine.GetModel( f5_local3, "selectedAbilityDisplayDesc" )
						if f5_local6 then
							f5_local10 = Engine.GetModelValue( f5_local6 )
							if not f5_local10 then
							
							else
								f5_local8( f5_local9, f5_local10 )
								f5_local8 = Engine.SetModelValue
								f5_local9 = Engine.GetModel( f5_local3, "selectedAbilityDisplayIcon" )
								if f5_local7 then
									f5_local10 = Engine.GetModelValue( f5_local7 )
									if not f5_local10 then
...
LUI.createMenu.AbilityWheel = function ( controller )
	...
	local f11_local1 = self
	self.anyChildUsesUpdateState = true
	
	local Panel = CoD.AbilityWheel_Panel.new( f11_local1, controller )
	...
	local Multiply0 = CoD.AbilityWheel_Multiply.new( f11_local1, controller )
	...
	local Vignette = CoD.AbilityWheel_Vignette.new( f11_local1, controller )
	...
	local Texture = CoD.AbilityWheel_Texture.new( f11_local1, controller )
	Texture:setLeftRight( true, true, 240, -240 )
	Texture:setTopBottom( true, false, 81, 617 )
	self:addElement( Texture )
	self.Texture = Texture
	
	local HexCenter = CoD.AbilityWheel_CenterHex.new( f11_local1, controller )
	...
	local ElementsSideL = CoD.AbilityWheel_ElementsSide.new( f11_local1, controller )
	...
	local ElementsSideR = CoD.AbilityWheel_ElementsSide.new( f11_local1, controller )
	...
	local DNIContainer = CoD.AbilityWheel_DNIContainer.new( f11_local1, controller )
	...
	local CenterElements = CoD.AbilityWheel_CenterElements.new( f11_local1, controller )
	...
	local BracketBlurBack = CoD.AbilityWheel_BracketBlur.new( f11_local1, controller )
	...
	local AbilityButton6 = CoD.AbilityButtonNew.new( f11_local1, controller )
	...
	local AbilityButton5 = CoD.AbilityButtonNew.new( f11_local1, controller )
	...
	local AbilityButton4 = CoD.AbilityButtonNew.new( f11_local1, controller )
	...
	local AbilityButton3 = CoD.AbilityButtonNew.new( f11_local1, controller )
	...
	local AbilityButton2 = CoD.AbilityButtonNew.new( f11_local1, controller )
	...
	local AbilityButton1 = CoD.AbilityButtonNew.new( f11_local1, controller )
	...
	local BracketBlur = CoD.AbilityWheel_BracketBlur.new( f11_local1, controller )
	...
	local TabC = CoD.AbilityWheel_TabC.new( f11_local1, controller )
	...
	local Description = CoD.AbilityWheel_Description.new( f11_local1, controller )
	...
	local Contextual1 = CoD.AbilityWheel_AbilityContextual2.new( f11_local1, controller )
	...
	Contextual1:linkToElementModel( Contextual1, "enabled", true, function ( model )
		f11_local1:updateElementState( Contextual1, {
	...
	local Contextual2 = CoD.AbilityWheel_AbilityContextual2.new( f11_local1, controller )
	...
	Contextual2:linkToElementModel( Contextual2, "enabled", true, function ( model )
		f11_local1:updateElementState( Contextual2, {
			name = "model_validation",
			menu = f11_local1,
			modelValue = Engine.GetModelValue( model ),
			modelName = "enabled"
	...
	local AbilityWheelCenterCore0 = CoD.AbilityWheel_CenterCore.new( f11_local1, controller )
	...
	local AbilityWheelButtonBumperWidget = CoD.AbilityWheel_ButtonBumperWidget.new( f11_local1, controller )
	...
	self:registerEventHandler( "input_source_changed", function ( element, event )
		CoD.Menu.UpdateButtonShownState( element, f11_local1, controller, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE )
	end )
	self:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "LastInput" ), function ( model )
		...
		CoD.Menu.UpdateButtonShownState( f242_local0, f11_local1, controller, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE )
	end )
	CoD.Menu.AddNavigationHandler( f11_local1, self, controller )
	self:registerEventHandler( "menu_loaded", function ( element, event )
		...
		if not f243_local0 then
			f243_local0 = element:dispatchEventToChildren( event )
		end
		return f243_local0
	end )
	f11_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_LB, nil, function ( f244_arg0, f244_arg1, f244_arg2, f244_arg3 )
		if IsMulticoreActivated( f244_arg2 ) then
			ChangeAbilityWheelItems( f244_arg2, f244_arg1, -1 )
			PlaySoundSetSound( self, "left_bumper" )
			UpdateMenuState( f244_arg1, event )
			return true
		else
			
		end
	end, function ( f245_arg0, f245_arg1, f245_arg2 )
		CoD.Menu.SetButtonLabel( f245_arg1, Enum.LUIButton.LUI_KEY_LB, "" )
		if IsMulticoreActivated( f245_arg2 ) then
			return false
		else
			return false
		end
	end, false )
	f11_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_RB, nil, function ( f246_arg0, f246_arg1, f246_arg2, f246_arg3 )
		if IsMulticoreActivated( f246_arg2 ) then
			ChangeAbilityWheelItems( f246_arg2, f246_arg1, 1 )
			PlaySoundSetSound( self, "right_bumper" )
			UpdateMenuState( f246_arg1, event )
			return true
		else
			
		end
	end, function ( f247_arg0, f247_arg1, f247_arg2 )
		CoD.Menu.SetButtonLabel( f247_arg1, Enum.LUIButton.LUI_KEY_RB, "" )
		if IsMulticoreActivated( f247_arg2 ) then
			return false
		else
			return false
		end
	end, false )
	f11_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, nil, function ( f248_arg0, f248_arg1, f248_arg2, f248_arg3 )
		if not IsGamepad( f248_arg2 ) then
			Close( self, f248_arg2 )
			return true
		else
			
		end
	end, function ( f249_arg0, f249_arg1, f249_arg2 )
		CoD.Menu.SetButtonLabel( f249_arg1, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, "MENU_BACK" )
		if not IsGamepad( f249_arg2 ) then
			return true
		else
			return false
		end
