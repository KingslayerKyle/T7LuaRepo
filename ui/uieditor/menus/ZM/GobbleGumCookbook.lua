-- 7d1f07488be152b6562ac295d2bbab14
...
LUI.createMenu.GobbleGumCookbook = function ( controller )
	...
	local GenericMenuFrameCookbook = CoD.GenericMenuFrame_Cookbook.new( f33_local1, controller )
	...
	local RecipeList = LUI.UIList.new( f33_local1, controller, 59, 0, nil, false, false, 0, 0, false, false )
	...
	f33_local1:AddButtonCallbackFunction( RecipeList, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f36_arg0, f36_arg1, f36_arg2, f36_arg3 )
		OpenGobbleGumRecipe( self, f36_arg0, f36_arg2 )
		return true
	...
	local GobbleGumCookbookDistillsBalance = CoD.GobbleGumCookbookDistillsBalance.new( f33_local1, controller )
	...
	local GobbleGumCookbookRemainingTime = CoD.GobbleGumCookbookRemainingTime.new( f33_local1, controller )
	...
	self:registerEventHandler( "menu_opened", function ( element, event )
		...
		if not HasSeenNewtonsCookbookFirstTimePopup( controller ) then
			OpenSystemOverlay( self, f33_local1, controller, "NewtonsCookbookWelcomePopup", "" )
		elseif CanGetFreeGobblegumCookbookUses( controller ) and HasSeenNewtonsCookbookFirstTimePopup( controller ) then
			OpenSystemOverlay( self, f33_local1, controller, "PurchaseDistills", nil )
		end
	...
	f33_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, nil, function ( f40_arg0, f40_arg1, f40_arg2, f40_arg3 )
		GoBack( self, f40_arg2 )
		HandleGoBackFromCookbook( self, f40_arg0, f40_arg2, "", f40_arg1 )
		return true
	end, function ( f41_arg0, f41_arg1, f41_arg2 )
		CoD.Menu.SetButtonLabel( f41_arg1, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, "MENU_BACK" )
		return true
	end, false )
	f33_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBX_PSSQUARE, "P", function ( f42_arg0, f42_arg1, f42_arg2, f42_arg3 )
		OpenSystemOverlay( self, f42_arg1, f42_arg2, "PurchaseDistills", nil )
		return true
	end, function ( f43_arg0, f43_arg1, f43_arg2 )
		CoD.Menu.SetButtonLabel( f43_arg1, Enum.LUIButton.LUI_KEY_XBX_PSSQUARE, "ZMUI_COOKBOOK_BUY_DISTILLS" )
		return true
	end, true )
