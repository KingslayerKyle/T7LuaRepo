-- 2f36361bb4f645c94705ca8ef22f548d
...
LUI.createMenu.CopyBubblegumPack = function ( controller )
	...
	local bubblegumPacksList = LUI.UIList.new( f2_local1, controller, 2, 0, nil, false, false, 0, 0, false, false )
	...
	bubblegumPacksList:registerEventHandler( "list_item_gain_focus", function ( element, event )
		local f3_local0 = nil
		if IsBubbleGumPackClassSelectedBubbleGumPack( f2_local1, element ) then
	...
	f2_local1:AddButtonCallbackFunction( bubblegumPacksList, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f6_arg0, f6_arg1, f6_arg2, f6_arg3 )
		if not IsBubbleGumPackClassSelectedBubbleGumPack( f6_arg1, f6_arg0 ) then
			BubblegumPackOptionsCopy( self, f6_arg0, f6_arg2 )
			return true
		else
		...
		if not IsBubbleGumPackClassSelectedBubbleGumPack( f7_arg1, f7_arg0 ) then
			return true
		else
			return false
		end
