-- 9c14e1518ba65553a751d8a999bf131e
...
LUI.createMenu.Main = function ( controller )
	...
	local StartLabel = CoD.StartLabel.new( f14_local1, controller )
	...
	f14_local1:AddButtonCallbackFunction( StartLabel, controller, Enum.LUIButton.LUI_KEY_PCKEY_0, nil, function ( f19_arg0, f19_arg1, f19_arg2, f19_arg3 )
		SendButtonPressToMenu( f19_arg1, f19_arg2, f19_arg3, Enum.LUIButton.LUI_KEY_XBA_PSCROSS )
		return true
	end, function ( f20_arg0, f20_arg1, f20_arg2 )
		CoD.Menu.SetButtonLabel( f20_arg1, Enum.LUIButton.LUI_KEY_PCKEY_0, "" )
		return false
	end, false )
	...
	local feFooterContainer = CoD.fe_FooterContainerMain.new( f14_local1, controller )
	...
	local AtviCopyDurango = CoD.AtviCopy.new( f14_local1, controller )
	...
	f14_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_BACK, nil, function ( f36_arg0, f36_arg1, f36_arg2, f36_arg3 )
		if IsDurango() then
			ShowAccountPicker( f36_arg2 )
			return true
		else
			
		end
	end, function ( f37_arg0, f37_arg1, f37_arg2 )
		CoD.Menu.SetButtonLabel( f37_arg1, Enum.LUIButton.LUI_KEY_BACK, "" )
		if IsDurango() then
			return false
		else
			return false
