-- 1c53191594a7df251116f31256d85849
...
CoD.Social_Options_Slider = InheritFrom( LUI.UIElement )
CoD.Social_Options_Slider.new = function ( menu, controller )
	...
	self:setClass( CoD.Social_Options_Slider )
	self.id = "Social_Options_Slider"
	...
	Socialbackground000:setLeftRight( true, false, 334, 536.53 )
	Socialbackground000:setTopBottom( true, false, 3, 63 )
	...
	Socialbackground00:setLeftRight( true, false, 41, 329 )
	Socialbackground00:setTopBottom( true, false, 3, 63 )
	self:addElement( Socialbackground00 )
	self.Socialbackground00 = Socialbackground00
	
	local Title = LUI.UIText.new()
	Title:setLeftRight( true, false, 102, 321 )
	Title:setTopBottom( true, false, 24, 43 )
	...
	Slider:setLeftRight( true, false, 351.27, 519.27 )
	Slider:setTopBottom( true, false, 18, 48 )
	...
	Icon:setLeftRight( true, false, 49.39, 92.39 )
	Icon:setTopBottom( true, false, 12, 55 )
	self:addElement( Icon )
	self.Icon = Icon
	
	local pixel1 = LUI.UIImage.new()
	pixel1:setLeftRight( false, true, -633.25, -624.75 )
	...
	pixel00:setLeftRight( false, true, -633.25, -624.75 )
	...
	pixel10:setLeftRight( false, true, -345.25, -336.75 )
	...
	pixel000:setLeftRight( false, true, -345.25, -336.75 )
	...
	FocusBarT:setLeftRight( true, true, 39, -339 )
	...
	FocusBarB:setLeftRight( true, true, 39, -339 )
	...
	FocusBorder:setLeftRight( true, true, 41, -341 )
	...
	glitch:setLeftRight( true, true, 29, -334 )
	...
	glitch2:setLeftRight( true, true, 32.5, -332.5 )
	...
	buttonText:setLeftRight( true, true, 334, -133.47 )
	buttonText:setTopBottom( false, false, -10, 10 )
	buttonText:setAlpha( 0 )
	buttonText:setTTF( "fonts/RefrigeratorDeluxe-Regular.ttf" )
	...
	buttonText:linkToElementModel( self, "altText", true, function ( model )
		local altText = Engine.GetModelValue( model )
		if altText then
			buttonText:setText( Engine.Localize( altText ) )
		end
	end )
	self:addElement( buttonText )
	self.buttonText = buttonText
	
	self.Slider:linkToElementModel( self, "optionsDatasource", true, function ( model )
	...
	self.clipsPerState = {
		DefaultState = {
			...
			GainFocus = function ()
							...
							local FocusBarTFrame5 = function ( FocusBarT, event )
								local FocusBarTFrame6 = function ( FocusBarT, event )
									local FocusBarTFrame7 = function ( FocusBarT, event )
										...
										FocusBarT:setLeftRight( true, true, 331.25, -131.47 )
										FocusBarT:setTopBottom( true, false, 1, 5 )
							...
							local FocusBarBFrame5 = function ( FocusBarB, event )
								local FocusBarBFrame6 = function ( FocusBarB, event )
									local FocusBarBFrame7 = function ( FocusBarB, event )
										...
										FocusBarB:setLeftRight( true, true, 331.25, -131.47 )
										FocusBarB:setTopBottom( false, true, -4, 0 )
								...
								local FocusBorderFrame6 = function ( FocusBorder, event )
									local FocusBorderFrame7 = function ( FocusBorder, event )
										local FocusBorderFrame8 = function ( FocusBorder, event )
											...
											FocusBorder:setLeftRight( true, true, 333.25, -133.47 )
											FocusBorder:setTopBottom( true, true, -0.5, 0 )
											FocusBorder:setAlpha( 0 )
											if event.interrupted then
							...
							local glitchFrame5 = function ( glitch, event )
								local glitchFrame6 = function ( glitch, event )
									local glitchFrame7 = function ( glitch, event )
										...
										glitch:setLeftRight( true, true, 324.75, -126.47 )
										glitch:setTopBottom( true, false, -3.75, 9.75 )
										glitch:setAlpha( 0 )
										glitch:setMaterial( LUI.UIImage.GetCachedMaterial( "ui_add" ) )
										if event.interrupted then
				...
				self.glitch:setLeftRight( true, true, 324.75, -126.47 )
							...
							local glitch2Frame5 = function ( glitch2, event )
								local glitch2Frame6 = function ( glitch2, event )
									local glitch2Frame7 = function ( glitch2, event )
										...
										glitch2:setLeftRight( true, true, 324.75, -124.97 )
										glitch2:setTopBottom( false, true, -10, 5 )
										glitch2:setAlpha( 0 )
										if event.interrupted then
		...
		ButtonOnly = {
			...
			GainFocus = function ()
				...
				self.glitch2:setAlpha( 0 )
				glitch2Frame2( glitch2, {} )
				local buttonTextFrame2 = function ( buttonText, event )
					if not event.interrupted then
						buttonText:beginAnimation( "keyframe", 109, false, false, CoD.TweenType.Linear )
					end
					buttonText:setAlpha( 1 )
					if event.interrupted then
						self.clipFinished( buttonText, event )
					else
						buttonText:registerEventHandler( "transition_complete_keyframe", self.clipFinished )
					end
				end
				
				buttonText:completeAnimation()
				self.buttonText:setAlpha( 0.7 )
				buttonTextFrame2( buttonText, {} )
			end,
			Focus = function ()
				self:setupElementClipCounter( 8 )
			...
			LoseFocus = function ()
				...
				local buttonTextFrame2 = function ( buttonText, event )
					if not event.interrupted then
						buttonText:beginAnimation( "keyframe", 159, false, false, CoD.TweenType.Linear )
					end
