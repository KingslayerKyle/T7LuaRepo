-- fe25df1bcd5782a362f03c7de37b91ff
...
CoD.Social_PlayersListButton_ManageParty.new = function ( menu, controller )
	...
	self:setLeftRight( true, false, 0, 631 )
	...
	Socialbackground0000:setLeftRight( true, false, 0, 96 )
	...
	emblem:setTopBottom( true, true, 0.25, -0.25 )
	...
	Socialbackground000:setLeftRight( true, false, 380.47, 583 )
	Socialbackground000:setTopBottom( true, false, 0, 59.5 )
	...
	local ManagePartyOperation = LUI.UIText.new()
	ManagePartyOperation:setLeftRight( true, false, 398.23, 565.23 )
	ManagePartyOperation:setTopBottom( true, false, 19.5, 41.5 )
	ManagePartyOperation:setAlpha( 0 )
	ManagePartyOperation:setTTF( "fonts/RefrigeratorDeluxe-Regular.ttf" )
	ManagePartyOperation:setAlignment( Enum.LUIAlignment.LUI_ALIGNMENT_CENTER )
	ManagePartyOperation:setAlignment( Enum.LUIAlignment.LUI_ALIGNMENT_TOP )
	ManagePartyOperation:subscribeToGlobalModel( controller, "SocialMainMenu", "managePartyButtonText", function ( model )
		local managePartyButtonText = Engine.GetModelValue( model )
		if managePartyButtonText then
			ManagePartyOperation:setText( Engine.Localize( managePartyButtonText ) )
		end
	end )
	self:addElement( ManagePartyOperation )
	self.ManagePartyOperation = ManagePartyOperation
	
	local FocusBarT = CoD.FE_FocusBarContainer.new( menu, controller )
	FocusBarT:setLeftRight( true, true, 378.47, -46 )
	...
	FocusBarB:setLeftRight( true, true, 378.47, -46 )
	...
	FocusBorder:setLeftRight( true, true, 380.47, -48 )
	FocusBorder:setTopBottom( true, true, -2.5, -2 )
	...
	glitch:setLeftRight( true, false, 368.47, 590 )
	glitch:setTopBottom( true, false, -10.75, 2.75 )
	...
	glitch2:setLeftRight( true, true, 371.97, -39.5 )
	glitch2:setTopBottom( false, true, -8, 7 )
	...
	presence.platformPresenceScroller.textBox:setText( Engine.Localize( "Watching Netflix" ) )
	...
	pixel:setLeftRight( false, true, -262, -253.5 )
	...
	pixel0:setLeftRight( false, true, -262, -253.5 )
	...
	pixel1:setLeftRight( false, true, -634.25, -625.75 )
	...
	pixel00:setLeftRight( false, true, -634.25, -625.75 )
		...
		DefaultState = {
			...
			GainFocus = function ()
				...
				local Socialbackground000Frame2 = function ( Socialbackground000, event )
					...
					Socialbackground000:setAlpha( 1 )
					if event.interrupted then
						self.clipFinished( Socialbackground000, event )
					else
						Socialbackground000:registerEventHandler( "transition_complete_keyframe", self.clipFinished )
					end
				end
							...
							local FocusBorderFrame5 = function ( FocusBorder, event )
								local FocusBorderFrame6 = function ( FocusBorder, event )
									local FocusBorderFrame7 = function ( FocusBorder, event )
										local FocusBorderFrame8 = function ( FocusBorder, event )
											if not event.interrupted then
												FocusBorder:beginAnimation( "keyframe", 100, false, false, CoD.TweenType.Linear )
											end
											FocusBorder:setAlpha( 0 )
											if event.interrupted then
												self.clipFinished( FocusBorder, event )
	...
	LUI.OverrideFunction_CallOriginalSecond( self, "close", function ( element )
		...
		element.ManagePartyOperation:close()
	end )
