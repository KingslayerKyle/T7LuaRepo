-- 996b2e5b4019817d15a52b57ed065de2
...
CoD.RocketShieldBlueprintWidget_Castle.new = function ( menu, controller )
	...
	BG:setLeftRight( true, false, -38.54, 314 )
	BG:setTopBottom( true, false, -47.52, 187.83 )
	BG:setAlpha( 0 )
	BG:setImage( RegisterImage( "uie_t7_base_quest_shield_dlc" ) )
	self:addElement( BG )
	self.BG = BG
	
	local RocketShieldPieceWidget1 = CoD.RocketShieldPieceWidget.new( menu, controller )
	RocketShieldPieceWidget1:setLeftRight( true, false, 124.74, 213.26 )
	RocketShieldPieceWidget1:setTopBottom( true, false, 24.24, 112.76 )
	RocketShieldPieceWidget1.PieceImageNewGreen:setImage( RegisterImage( "uie_t7_icon_inventory_dlc_shield_a_new" ) )
	RocketShieldPieceWidget1.PieceImage:setImage( RegisterImage( "uie_t7_icon_inventory_dlc_shield_a" ) )
	...
	RocketShieldPieceWidget2:setLeftRight( true, false, 228.74, 317.26 )
	RocketShieldPieceWidget2:setTopBottom( true, false, 23.24, 111.76 )
	...
	RocketShieldPieceWidget3.PieceImageNewGreen:setImage( RegisterImage( "uie_t7_icon_inventory_dlc_shield_b_new" ) )
	RocketShieldPieceWidget3.PieceImage:setImage( RegisterImage( "uie_t7_icon_inventory_dlc_shield_b" ) )
	...
	self.clipsPerState = {
		...
		BgVisible = {
			DefaultClip = function ()
				...
				local BGFrame2 = function ( BG, event )
					local BGFrame3 = function ( BG, event )
						local BGFrame4 = function ( BG, event )
							...
							BG:setLeftRight( true, false, -39.8, 292.26 )
							BG:setTopBottom( true, false, -49.52, 191.83 )
							BG:setAlpha( 0 )
				...
				BG:completeAnimation()
				self.BG:setLeftRight( true, false, -39.8, 292.26 )
