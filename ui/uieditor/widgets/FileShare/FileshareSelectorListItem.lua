-- 24727db16093f1e04875ead06953c9e8
...
CoD.FileshareSelectorListItem.new = function ( menu, controller )
	...
	LabelButton0:setLeftRight( true, false, 82, 265 )
	...
	WCFileshareIconExtraCamRender0:setLeftRight( true, false, 0, 66 )
	WCFileshareIconExtraCamRender0:setTopBottom( true, false, 1, 65 )
	...
	GameTypeImage:setLeftRight( true, false, 0, 66 )
	GameTypeImage:setTopBottom( true, false, 1, 65 )
	...
	ImageViewer:setLeftRight( true, false, 0, 66 )
	ImageViewer:setTopBottom( true, false, 13.69, 50.81 )
	...
	FileSlotLabel:setLeftRight( true, false, 242, 276 )
	FileSlotLabel:setTopBottom( true, false, 24.75, 39.75 )
	...
	PlusImage:setLeftRight( true, false, 8.5, 56.5 )
	PlusImage:setTopBottom( true, false, 8.25, 56.25 )
	...
	self.LabelButton0:linkToElementModel( self, "fileName", true, function ( model )
		...
		if fileName then
			LabelButton0.itemName:setText( fileName )
		end
	end )
	self.FileSlotLabel:linkToElementModel( self, "fileSlot", true, function ( model )
		local fileSlot = Engine.GetModelValue( model )
		if fileSlot then
			FileSlotLabel:setText( Engine.Localize( fileSlot ) )
		end
	end )
	self.clipsPerState = {
		DefaultState = {
			DefaultClip = function ()
				...
				self.WCFileshareIconExtraCamRender0:setAlpha( 1 )
	...
	self:mergeStateConditions( {
		...
		},
		{
			stateName = "Clip",
			condition = function ( menu, element, event )
				return IsSelfModelValueEqualTo( element, controller, "fileCategory", "clip" )
			end
		}
	} )
