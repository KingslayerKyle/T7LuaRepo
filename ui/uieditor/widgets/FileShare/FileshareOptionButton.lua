-- a7d057c5ff87e8a0d85383a49e4403c8
...
CoD.FileshareOptionButton.new = function ( menu, controller )
	...
	FEButtonPanelShaderContainer:setLeftRight( true, true, -10, 8 )
	FEButtonPanelShaderContainer:setTopBottom( false, false, -16, 16 )
	...
	btnDisplayTextStroke:setLeftRight( true, false, 36, 284 )
		...
		},
		{
			...
			condition = function ( menu, element, event )
				...
				if not IsDisabled( element, controller ) then
					f88_local0 = IsCurrentLanguageArabic()
				else
					f88_local0 = false
				end
				return f88_local0
