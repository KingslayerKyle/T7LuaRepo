-- ffc0c4e1adb001e475e4c1b17c36fdda
...
CoD.FileshareSelector.new = function ( menu, controller )
	...
	menu:AddButtonCallbackFunction( itemList, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f11_arg0, f11_arg1, f11_arg2, f11_arg3 )
		if IsSelfModelValueTrue( f11_arg0, f11_arg2, "isPublishNew" ) then
			FileshareSetShowcasePublishMode( f11_arg2, true )
			return true
		elseif not IsSelfModelValueTrue( f11_arg0, f11_arg2, "isPublishNew" ) and FileshareCanOpenDetailsView( f11_arg0, f11_arg2 ) then
			FileshareSetSelectedItem( self, f11_arg0, f11_arg2, "true" )
			FileshareOpenFullscreenView( self, f11_arg0, f11_arg2, f11_arg1 )
			return true
		else
		...
		if IsSelfModelValueTrue( f12_arg0, f12_arg2, "isPublishNew" ) then
			return true
		elseif not IsSelfModelValueTrue( f12_arg0, f12_arg2, "isPublishNew" ) and FileshareCanOpenDetailsView( f12_arg0, f12_arg2 ) then
			return true
		else
			return false
		end
	end, true )
	menu:AddButtonCallbackFunction( itemList, controller, Enum.LUIButton.LUI_KEY_START, "O", function ( f13_arg0, f13_arg1, f13_arg2, f13_arg3 )
		if not IsSelfModelValueTrue( f13_arg0, f13_arg2, "isPublishNew" ) and FileshareCanShowOptionsMenu( f13_arg2 ) then
		...
		if not IsSelfModelValueTrue( f14_arg0, f14_arg2, "isPublishNew" ) and FileshareCanShowOptionsMenu( f14_arg2 ) then
