-- fc0540f76956c8f0b00d6d5602265286
...
CoD.FileshareSelectorItem = InheritFrom( LUI.UIElement )
CoD.FileshareSelectorItem.new = function ( menu, controller )
	...
	self:setClass( CoD.FileshareSelectorItem )
	self.id = "FileshareSelectorItem"
	...
	FileImage:setLeftRight( true, false, 2.5, 105.5 )
	FileImage:setTopBottom( true, false, -2, 79.5 )
	...
	PlusImage:setLeftRight( true, false, 22, 86 )
	PlusImage:setTopBottom( true, false, 11.25, 75.25 )
	...
	WCFileshareIconExtraCamRender0:setLeftRight( true, false, 0, 105.5 )
	WCFileshareIconExtraCamRender0:setTopBottom( true, false, 1.25, 104 )
	...
	Panel0:setLeftRight( true, true, 3.5, -4.5 )
	...
	horizontalScrollingTextBox20pt:setLeftRight( true, false, 3.5, 106.5 )
	...
	self.horizontalScrollingTextBox20pt:linkToElementModel( self, "fileName", true, function ( model )
		local fileName = Engine.GetModelValue( model )
		if fileName then
			horizontalScrollingTextBox20pt.textBox:setText( fileName )
		end
	end )
	self.clipsPerState = {
		DefaultState = {
