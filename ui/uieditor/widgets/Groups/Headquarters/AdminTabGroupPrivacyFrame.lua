-- e24ecc864318f0763e8d04469f60ebe3
...
CoD.AdminTabGroupPrivacyFrame.new = function ( menu, controller )
	...
	menu:AddButtonCallbackFunction( ButtonList, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f14_arg0, f14_arg1, f14_arg2, f14_arg3 )
		if IsSelfModelValueTrue( f14_arg0, f14_arg2, "selected" ) then
			SetElementModelValue( f14_arg0, "selected", false )
			EnableNavigation( self, "ButtonList" )
			EnableMouseOnElement( self, "ButtonList", f14_arg2 )
			GroupsVariableOptionsSet( self, f14_arg0, f14_arg2 )
			MakeSiblingFocusable( self, "AdminOptions", f14_arg2 )
			return true
		elseif not IsSelfModelValueTrue( f14_arg0, f14_arg2, "selected" ) then
			SetElementModelValue( f14_arg0, "selected", true )
			DisableNavigation( self, "ButtonList" )
			DisableMouseOnElement( self, "ButtonList", f14_arg2 )
			DispatchEventToChildren( f14_arg0, "gain_focus", f14_arg2 )
			MakeSiblingNotFocusable( self, "AdminOptions", f14_arg2 )
			return true
		else
			
		end
	end, function ( f15_arg0, f15_arg1, f15_arg2 )
		if IsSelfModelValueTrue( f15_arg0, f15_arg2, "selected" ) then
			CoD.Menu.SetButtonLabel( f15_arg1, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "MENU_SELECT" )
			return true
		elseif not IsSelfModelValueTrue( f15_arg0, f15_arg2, "selected" ) then
			CoD.Menu.SetButtonLabel( f15_arg1, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "MENU_SELECT" )
			return true
		else
			return false
	...
	menu:AddButtonCallbackFunction( ButtonList, controller, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, nil, function ( f16_arg0, f16_arg1, f16_arg2, f16_arg3 )
		if IsSelfModelValueTrue( f16_arg0, f16_arg2, "selected" ) then
			SetElementModelValue( f16_arg0, "selected", false )
			EnableNavigation( self, "ButtonList" )
			DispatchEventToChildren( f16_arg0, "lose_focus", f16_arg2 )
			MakeSiblingFocusable( self, "AdminOptions", f16_arg2 )
			GroupsVariableOptionsSet( self, f16_arg0, f16_arg2 )
			return true
		else
