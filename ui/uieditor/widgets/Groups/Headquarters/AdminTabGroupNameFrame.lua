-- b3e7c2578684266c2f86056072383e0c
...
CoD.AdminTabGroupNameFrame.new = function ( menu, controller )
	...
	menu:AddButtonCallbackFunction( GroupsInputButton, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, nil, function ( f6_arg0, f6_arg1, f6_arg2, f6_arg3 )
		if HasAdminPrivilege( f6_arg2, Enum.GroupAdminPrivilege.GROUP_ADMIN_PRIVILEGE_EDIT_GROUP_NAME ) then
		...
		if HasAdminPrivilege( f7_arg2, Enum.GroupAdminPrivilege.GROUP_ADMIN_PRIVILEGE_EDIT_GROUP_NAME ) then
