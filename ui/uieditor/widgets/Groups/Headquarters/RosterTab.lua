-- 39edd73ebef180c236d248252a07bb84
...
CoD.RosterTab.new = function ( menu, controller )
	...
	menu:AddButtonCallbackFunction( GroupsRosterList, controller, Enum.LUIButton.LUI_KEY_START, nil, function ( f7_arg0, f7_arg1, f7_arg2, f7_arg3 )
		if ShouldOpenGroupAdminOptionsPopupForGroupMember( f7_arg0, f7_arg2 ) then
			SetSelectedFriendXUID( self, f7_arg0, f7_arg2 )
			OpenGroupAdminOptionsPopupForGroupMember( self, f7_arg0, f7_arg2 )
			return true
		else
			
		end
	end, function ( f8_arg0, f8_arg1, f8_arg2 )
		if ShouldOpenGroupAdminOptionsPopupForGroupMember( f8_arg0, f8_arg2 ) then
			CoD.Menu.SetButtonLabel( f8_arg1, Enum.LUIButton.LUI_KEY_START, "MENU_OPTIONS" )
			return true
		else
			return false
		end
	...
	self:registerEventHandler( "gain_focus", function ( element, event )
		if element.m_focusable and element.GroupsRosterList:processEvent( event ) then
			return true
		else
