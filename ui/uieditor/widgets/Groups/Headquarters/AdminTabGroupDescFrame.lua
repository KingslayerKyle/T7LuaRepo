-- 7ed1035fbc3b5cd78f8cc9cbcaedf2f4
-- This hash is used for caching, delete to decompile the file again

require( "ui.uieditor.widgets.Groups.GroupsInputButton" )

CoD.AdminTabGroupDescFrame = InheritFrom( LUI.UIElement )
CoD.AdminTabGroupDescFrame.new = function ( menu, controller )
	...
	self:setClass( CoD.AdminTabGroupDescFrame )
	self.id = "AdminTabGroupDescFrame"
	...
	GroupsInputButton:subscribeToGlobalModel( controller, "SelectedGroup", "description", function ( model )
		local description = Engine.GetModelValue( model )
		if description then
			GroupsInputButton.Text:setText( description )
		end
	end )
