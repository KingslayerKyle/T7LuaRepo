-- fd82293df6d8c42d63d775989b200b41
...
CoD.GroupsSocialMainFindButton.new = function ( menu, controller )
	...
	f1_local7:setLeftRight( true, true, -8.5, 8.5 )
	f1_local7:setTopBottom( false, true, -6, 9 )
	f1_local7:setRGB( 1, 0.15, 0 )
	f1_local7:setAlpha( 0 )
	f1_local7:setImage( RegisterImage( "uie_t7_effect_glitches_menu10" ) )
	f1_local7:setMaterial( LUI.UIImage.GetCachedMaterial( "ui_add" ) )
	if IsPC() then
		self:addElement( f1_local7 )
	end
	self.glitch2 = f1_local7
	...
	self.clipsPerState = {
		DefaultState = {
			...
			GainFocus = function ()
				...
				glitchFrame2( glitch, {} )
				local f1_local7Frame2 = function ( f1_local7, event )
					local f1_local7Frame3 = function ( f1_local7, event )
						local f1_local7Frame4 = function ( f1_local7, event )
							local f1_local7Frame5 = function ( f1_local7, event )
								local f1_local7Frame6 = function ( f1_local7, event )
									local f1_local7Frame7 = function ( f1_local7, event )
										if not event.interrupted then
											f1_local7:beginAnimation( "keyframe", 39, false, false, CoD.TweenType.Linear )
										end
										f1_local7:setAlpha( 0 )
										if event.interrupted then
											self.clipFinished( f1_local7, event )
										else
											f1_local7:registerEventHandler( "transition_complete_keyframe", self.clipFinished )
										end
									end
									
									if event.interrupted then
										f1_local7Frame7( f1_local7, event )
										return 
									else
										f1_local7:beginAnimation( "keyframe", 10, false, false, CoD.TweenType.Linear )
										f1_local7:registerEventHandler( "transition_complete_keyframe", f1_local7Frame7 )
									end
								end
								
								if event.interrupted then
									f1_local7Frame6( f1_local7, event )
									return 
								else
									f1_local7:beginAnimation( "keyframe", 9, false, false, CoD.TweenType.Linear )
									f1_local7:setAlpha( 1 )
									f1_local7:registerEventHandler( "transition_complete_keyframe", f1_local7Frame6 )
								end
							end
							
							if event.interrupted then
								f1_local7Frame5( f1_local7, event )
								return 
							else
								f1_local7:beginAnimation( "keyframe", 20, false, false, CoD.TweenType.Linear )
								f1_local7:registerEventHandler( "transition_complete_keyframe", f1_local7Frame5 )
							end
						end
						
						if event.interrupted then
							f1_local7Frame4( f1_local7, event )
							return 
						else
							f1_local7:beginAnimation( "keyframe", 9, false, false, CoD.TweenType.Linear )
							f1_local7:setAlpha( 0 )
							f1_local7:registerEventHandler( "transition_complete_keyframe", f1_local7Frame4 )
						end
					end
					
					if event.interrupted then
						f1_local7Frame3( f1_local7, event )
						return 
					else
						f1_local7:beginAnimation( "keyframe", 19, false, false, CoD.TweenType.Linear )
						f1_local7:registerEventHandler( "transition_complete_keyframe", f1_local7Frame3 )
					end
				end
					...
					local f1_local7Frame3 = function ( f1_local7, event )
						local f1_local7Frame4 = function ( f1_local7, event )
							local f1_local7Frame5 = function ( f1_local7, event )
								local f1_local7Frame6 = function ( f1_local7, event )
									local f1_local7Frame7 = function ( f1_local7, event )
										local f1_local7Frame8 = function ( f1_local7, event )
											if not event.interrupted then
												f1_local7:beginAnimation( "keyframe", 80, false, false, CoD.TweenType.Linear )
											end
											f1_local7:setAlpha( 0 )
											if event.interrupted then
												self.clipFinished( f1_local7, event )
										...
										if event.interrupted then
											f1_local7Frame8( f1_local7, event )
											return 
										else
											f1_local7:beginAnimation( "keyframe", 10, false, false, CoD.TweenType.Linear )
											f1_local7:setAlpha( 0.57 )
											f1_local7:registerEventHandler( "transition_complete_keyframe", f1_local7Frame8 )
										end
									end
