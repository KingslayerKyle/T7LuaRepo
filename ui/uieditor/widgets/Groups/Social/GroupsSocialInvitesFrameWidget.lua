-- e8995141e87bd45e982a0312fefe264c
...
CoD.GroupsSocialInvitesFrameWidget.new = function ( menu, controller )
	...
	menu:AddButtonCallbackFunction( InvitesList, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f4_arg0, f4_arg1, f4_arg2, f4_arg3 )
		OpenGroupsInviteConfirmation( self, f4_arg0, f4_arg2 )
		return true
	...
	self:registerEventHandler( "gain_focus", function ( element, event )
		if element.m_focusable and element.InvitesList:processEvent( event ) then
			return true
		else
