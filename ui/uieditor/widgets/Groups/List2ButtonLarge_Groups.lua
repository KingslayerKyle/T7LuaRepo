-- 5e9404c5907338c21599398ce9f0c705
...
CoD.List2ButtonLarge_Groups = InheritFrom( LUI.UIElement )
CoD.List2ButtonLarge_Groups.new = function ( menu, controller )
	local self = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc( self, controller )
	end
	self:setUseStencil( false )
	self:setClass( CoD.List2ButtonLarge_Groups )
	self.id = "List2ButtonLarge_Groups"
	self.soundSet = "default"
	self:setLeftRight( true, false, 0, 282 )
	...
	commonButtonLabel:setLeftRight( true, false, 8.82, 271.82 )
	commonButtonLabel:setTopBottom( true, false, 14.23, 34.23 )
