-- b86f2eef3dbe82125d112f590d1aafff
...
CoD.List1ButtonLarge_Groups = InheritFrom( LUI.UIElement )
CoD.List1ButtonLarge_Groups.new = function ( menu, controller )
	...
	self:setClass( CoD.List1ButtonLarge_Groups )
	self.id = "List1ButtonLarge_Groups"
	...
	LabelButton:setLeftRight( true, false, 8.82, 151.82 )
	LabelButton:setTopBottom( false, false, -10.77, 9.23 )
	...
	DimCoverImage:setLeftRight( true, true, 0, 0 )
	DimCoverImage:setTopBottom( true, true, 0, 0 )
	DimCoverImage:setRGB( 0, 0, 0 )
	DimCoverImage:setAlpha( 0 )
	...
	self.clipsPerState = {
		DefaultState = {
			DefaultClip = function ()
				...
				LabelButton.itemName:completeAnimation()
				self.LabelButton.itemName:setRGB( 0.82, 0.85, 0.88 )
