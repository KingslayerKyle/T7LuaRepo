-- b29713c4e0aa4a443cd4b1c608a6dbfb
...
CoD.GroupSelectListItemRow = InheritFrom( LUI.UIElement )
CoD.GroupSelectListItemRow.new = function ( menu, controller )
	...
	self:setClass( CoD.GroupSelectListItemRow )
	self.id = "GroupSelectListItemRow"
	...
	LabelButton:setLeftRight( true, false, 73.5, 218.5 )
	LabelButton:setTopBottom( false, false, -7.77, 12.23 )
	LabelButton:linkToElementModel( self, "displayText", true, function ( model )
		local displayText = Engine.GetModelValue( model )
		if displayText then
			LabelButton.itemName:setText( displayText )
		end
	end )
	...
	GroupEmblemWidget:setLeftRight( true, false, -2, 65 )
	GroupEmblemWidget:setTopBottom( true, false, -1, 47 )
	...
	local SentText = LUI.UIText.new()
	SentText:setLeftRight( true, false, 236.5, 345.5 )
	SentText:setTopBottom( true, false, 11.33, 36.33 )
	SentText:setAlpha( 0 )
	SentText:setText( Engine.Localize( "MENU_SENT" ) )
	SentText:setTTF( "fonts/default.ttf" )
	SentText:setAlignment( Enum.LUIAlignment.LUI_ALIGNMENT_RIGHT )
	SentText:setAlignment( Enum.LUIAlignment.LUI_ALIGNMENT_TOP )
	self:addElement( SentText )
	self.SentText = SentText
	
	local FocusBarT = CoD.FE_FocusBarContainer.new( menu, controller )
	FocusBarT:setLeftRight( true, true, -4.25, 2.34 )
	FocusBarT:setTopBottom( true, false, -2, 0 )
	...
	FocusBarB:setLeftRight( true, true, -4.25, 2.34 )
	...
	self.clipsPerState = {
		DefaultState = {
			DefaultClip = function ()
				...
				SentText:completeAnimation()
				self.SentText:setAlpha( 0 )
				self.clipFinished( SentText, {} )
	...
	self:mergeStateConditions( {
		{
			stateName = "InviteSent",
			condition = function ( menu, element, event )
				return IsSelfModelValueTrue( element, controller, "inviteSent" )
			end
		}
	} )
	self:linkToElementModel( self, "inviteSent", true, function ( model )
