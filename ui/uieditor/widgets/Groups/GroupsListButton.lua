-- 03dc6c4ee0939a36579e7d3b7770b4af
...
CoD.GroupsListButton.new = function ( menu, controller )
	...
	SelectedIcon:setLeftRight( true, false, 255, 271 )
	SelectedIcon:setTopBottom( true, false, 17, 33 )
	...
	LabelButton0:setLeftRight( true, false, 12, 152 )
	LabelButton0:setTopBottom( false, false, -10, 10 )
	LabelButton0:linkToElementModel( self, "displayText", true, function ( model )
		local displayText = Engine.GetModelValue( model )
		if displayText then
			LabelButton0.itemName:setText( Engine.Localize( displayText ) )
		end
	end )
	...
	FocusBarT:setLeftRight( true, true, -2.5, 2 )
	...
	FocusWhiteT:setTopBottom( true, false, -2, 3 )
	FocusWhiteT:setAlpha( 0 )
	FocusWhiteT:setZoom( 1 )
	self:addElement( FocusWhiteT )
	self.FocusWhiteT = FocusWhiteT
	
	local FocusWhiteT0 = CoD.cac_FocusBarContainer.new( menu, controller )
	FocusWhiteT0:setLeftRight( true, true, -2, 2 )
	FocusWhiteT0:setTopBottom( true, false, 46.5, 51.5 )
	FocusWhiteT0:setAlpha( 0 )
	FocusWhiteT0:setZoom( 1 )
	self:addElement( FocusWhiteT0 )
	self.FocusWhiteT0 = FocusWhiteT0
	...
	self.clipsPerState = {
		DefaultState = {
			DefaultClip = function ()
				...
				self.LabelButton0:setRGB( 1, 1, 1 )
		...
		Disabled = {
			...
			GainFocus = function ()
						...
						local FocusWhiteTFrame4 = function ( FocusWhiteT, event )
							local FocusWhiteTFrame5 = function ( FocusWhiteT, event )
								local FocusWhiteTFrame6 = function ( FocusWhiteT, event )
									if not event.interrupted then
										FocusWhiteT:beginAnimation( "keyframe", 40, false, false, CoD.TweenType.Linear )
									end
								...
								if event.interrupted then
									...
									FocusWhiteT:beginAnimation( "keyframe", 39, false, false, CoD.TweenType.Linear )
									FocusWhiteT:setAlpha( 0.5 )
							...
							if event.interrupted then
								...
								FocusWhiteT:beginAnimation( "keyframe", 30, false, false, CoD.TweenType.Linear )
								FocusWhiteT:setAlpha( 0.48 )
				...
				local FocusWhiteT0Frame2 = function ( FocusWhiteT0, event )
					local FocusWhiteT0Frame3 = function ( FocusWhiteT0, event )
						local FocusWhiteT0Frame4 = function ( FocusWhiteT0, event )
							local FocusWhiteT0Frame5 = function ( FocusWhiteT0, event )
								local FocusWhiteT0Frame6 = function ( FocusWhiteT0, event )
									if not event.interrupted then
										FocusWhiteT0:beginAnimation( "keyframe", 40, false, false, CoD.TweenType.Linear )
									end
									FocusWhiteT0:setAlpha( 1 )
									if event.interrupted then
										self.clipFinished( FocusWhiteT0, event )
									else
										FocusWhiteT0:registerEventHandler( "transition_complete_keyframe", self.clipFinished )
									end
								end
								
								if event.interrupted then
									FocusWhiteT0Frame6( FocusWhiteT0, event )
									return 
								else
									FocusWhiteT0:beginAnimation( "keyframe", 39, false, false, CoD.TweenType.Linear )
									FocusWhiteT0:setAlpha( 0.5 )
									FocusWhiteT0:registerEventHandler( "transition_complete_keyframe", FocusWhiteT0Frame6 )
								end
							end
							
							if event.interrupted then
								FocusWhiteT0Frame5( FocusWhiteT0, event )
								return 
							else
								FocusWhiteT0:beginAnimation( "keyframe", 30, false, false, CoD.TweenType.Linear )
								FocusWhiteT0:setAlpha( 0.48 )
								FocusWhiteT0:registerEventHandler( "transition_complete_keyframe", FocusWhiteT0Frame5 )
							end
						end
						
						if event.interrupted then
							FocusWhiteT0Frame4( FocusWhiteT0, event )
							return 
						else
							FocusWhiteT0:beginAnimation( "keyframe", 29, false, false, CoD.TweenType.Linear )
							FocusWhiteT0:setAlpha( 0 )
							FocusWhiteT0:registerEventHandler( "transition_complete_keyframe", FocusWhiteT0Frame4 )
						end
					end
					
					if event.interrupted then
						FocusWhiteT0Frame3( FocusWhiteT0, event )
						return 
					else
						FocusWhiteT0:beginAnimation( "keyframe", 29, false, false, CoD.TweenType.Linear )
						FocusWhiteT0:setAlpha( 0.25 )
						FocusWhiteT0:registerEventHandler( "transition_complete_keyframe", FocusWhiteT0Frame3 )
					end
				end
				
				FocusWhiteT0:completeAnimation()
				self.FocusWhiteT0:setAlpha( 0 )
				FocusWhiteT0Frame2( FocusWhiteT0, {} )
			end,
			Focus = function ()
				self:setupElementClipCounter( 5 )
				...
				FocusWhiteT:completeAnimation()
				self.FocusWhiteT:setLeftRight( true, true, -2, 2 )
				self.FocusWhiteT:setTopBottom( true, false, -2, 3 )
				self.FocusWhiteT:setAlpha( 1 )
				self.clipFinished( FocusWhiteT, {} )

				FocusWhiteT0:completeAnimation()
				self.FocusWhiteT0:setLeftRight( true, true, -2, 2 )
				self.FocusWhiteT0:setTopBottom( true, false, 46.5, 51.5 )
				self.FocusWhiteT0:setAlpha( 1 )
				self.clipFinished( FocusWhiteT0, {} )
			end,
			LoseFocus = function ()
				self:setupElementClipCounter( 7 )
