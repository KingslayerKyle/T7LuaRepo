-- 48cf4d55dc2dcc05df85cacd414a0d65
-- This hash is used for caching, delete to decompile the file again

CoD.MPScr_PlusPoints = InheritFrom( LUI.UIElement )
CoD.MPScr_PlusPoints.new = function ( menu, controller )
	...
	Label2:setRGB( 0, 0.42, 1 )
	Label2:setAlpha( 0.01 )
	Label2:setZoom( -8 )
	Label2:setText( Engine.Localize( "+50" ) )
	Label2:setTTF( "fonts/UnitedSansSmCdBd_0.ttf" )
	...
	Label1:setRGB( 0.62, 0.78, 0.99 )
	Label1:setAlpha( 0 )
	Label1:setText( Engine.Localize( "+50" ) )
	Label1:setTTF( "fonts/UnitedSansSmCdBd_0.ttf" )
