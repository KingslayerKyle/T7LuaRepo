-- 8df844a1248e2354e15abe5f40d88fe0
...
local f0_local1 = function ( f2_arg0, f2_arg1 )
	...
	local f2_local4 = f2_local3.imagename .. "_mini"
	if f2_arg0.visible == true then
		f2_arg0:show()
		f2_local2:update( f2_arg1 )
		f2_local2:setCompassObjectiveIcon( f2_local0, f2_local1, f2_local4, f2_local3.imagecolor )
...
local f0_local2 = function ( f3_arg0, f3_arg1 )
	if f3_arg1.objId then
		...
		f3_arg0.flagObjectiveIndex = Engine.GetObjectiveIndexFromName( f3_arg1.controller, string.sub( f3_local1, 1, -5 ) .. "goal" )
		...
		f3_local0.never_contested = true
	end
end
