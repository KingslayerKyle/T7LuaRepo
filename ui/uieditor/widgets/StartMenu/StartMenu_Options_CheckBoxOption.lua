-- b4066ef078de039b975217830e3724ea
...
local PostLoadFunc = function ( self, controller, menu )
	...
	CoD.Menu.AddButtonCallbackFunction( menu, self, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f3_arg0, f3_arg1, f3_arg2, f3_arg3 )
		if not self.disabled and not f3_arg1.m_disableNavigation and f3_arg1:AcceptGamePadButtonInputFromModelCallback( f3_arg2 ) then
			if type( self.checkboxAction ) == "function" then
				self.checkboxAction( f3_arg2, self )
				self:processEvent( {
					name = "update_state",
					controller = f3_arg2
				} )
