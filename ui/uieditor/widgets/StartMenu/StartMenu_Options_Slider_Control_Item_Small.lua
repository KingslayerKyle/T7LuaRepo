-- 4a6d5ec7a9e5d1c0247c3fa5c3670bcc
...
CoD.StartMenu_Options_Slider_Control_Item_Small = InheritFrom( LUI.UIElement )
CoD.StartMenu_Options_Slider_Control_Item_Small.new = function ( menu, controller )
	...
	self:setClass( CoD.StartMenu_Options_Slider_Control_Item_Small )
	self.id = "StartMenu_Options_Slider_Control_Item_Small"
