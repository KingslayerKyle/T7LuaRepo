-- c6399efbabc4114ce01789d9b8b7ac3d
...
local PostLoadFunc = function ( self, controller, menu )
	...
	CoD.Menu.AddButtonCallbackFunction( menu, self, controller, Enum.LUIButton.LUI_KEY_LEFT, "LEFTARROW", function ( f12_arg0, f12_arg1, f12_arg2, f12_arg3 )
	...
	CoD.Menu.AddButtonCallbackFunction( menu, self, controller, Enum.LUIButton.LUI_KEY_RIGHT, "RIGHTARROW", function ( f13_arg0, f13_arg1, f13_arg2, f13_arg3 )
		if not self.m_disableNavigation then
			if not self.m_beat then
				self:updateSlideDirection( 1 )
				self:addElement( self.m_timer )
