-- 9549e77a871fb003572d5ef985a29c22
...
local PostLoadFunc = function ( self, controller, menu )
	...
	CoD.Menu.AddButtonCallbackFunction( menu, self, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f3_arg0, f3_arg1 )
		local f3_local0 = f3_arg0:getModel()
		if f3_local0 then
			local f3_local1 = Engine.GetModel( f3_local0, "menu" )
			if f3_local1 then
				OpenPopup( f3_arg0, Engine.GetModelValue( f3_local1 ), controller )
			end
		end
	end )
end
