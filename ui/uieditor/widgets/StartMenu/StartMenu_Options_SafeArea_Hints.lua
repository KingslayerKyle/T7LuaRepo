-- a9a00092fa7771caf1c20bc894c6e753
...
CoD.StartMenu_Options_SafeArea_Hints.new = function ( menu, controller )
	...
	ConfirmButtonPrompt:subscribeToGlobalModel( controller, "Controller", "primary_button_image", function ( model )
		...
		if primaryButtonImage then
			ConfirmButtonPrompt.buttonPromptImage:setImage( RegisterImage( primaryButtonImage ) )
		end
	end )
	...
	GotItButtonPrompt:subscribeToGlobalModel( controller, "Controller", "primary_button_image", function ( model )
		local primaryButtonImage = Engine.GetModelValue( model )
		if primaryButtonImage then
			GotItButtonPrompt.buttonPromptImage:setImage( RegisterImage( primaryButtonImage ) )
		end
	end )
