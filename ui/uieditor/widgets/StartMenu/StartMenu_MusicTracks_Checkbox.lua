-- e38b95876b3333877d84390348c7ae26
-- This hash is used for caching, delete to decompile the file again

require( "ui.uieditor.widgets.Border" )

CoD.StartMenu_MusicTracks_Checkbox = InheritFrom( LUI.UIElement )
CoD.StartMenu_MusicTracks_Checkbox.new = function ( menu, controller )
	...
	self:setClass( CoD.StartMenu_MusicTracks_Checkbox )
	self.id = "StartMenu_MusicTracks_Checkbox"
