-- 006fe3547866ee8e12435e3d61a99b33
...
CoD.StartMenu_Barracks_Button_MP.new = function ( menu, controller )
	...
	RankBackground0:setLeftRight( false, false, -99, 104.33 )
	RankBackground0:setTopBottom( true, false, 208, 236 )
	...
	RankNameBackground0:setLeftRight( false, false, -99, 104.33 )
	RankNameBackground0:setTopBottom( true, false, 177.5, 205.5 )
	...
	RankName:setLeftRight( false, false, -137, 151 )
	RankName:setTopBottom( true, false, 183, 203 )
	...
	Rank:setLeftRight( false, false, -137, 151 )
	Rank:setTopBottom( true, false, 210, 232 )
	...
	TotalKills:setLeftRight( true, false, 1, 120.67 )
	...
	KD:setLeftRight( true, false, 125, 201.67 )
	KD:setTopBottom( true, false, 375.94, 436.94 )
	...
	SPM:setLeftRight( true, false, 206.67, 283.33 )
	...
	WL:setLeftRight( true, false, 288.33, 365 )
	WL:setTopBottom( true, false, 375.94, 436.94 )
	...
	lockedIcon:setTopBottom( true, false, 158.75, 190.75 )
	lockedIcon:setAlpha( 0 )
	self:addElement( lockedIcon )
	self.lockedIcon = lockedIcon
	
	local StartMenuframenoBG00 = CoD.StartMenu_frame_noBG.new( menu, controller )
	StartMenuframenoBG00:setLeftRight( false, false, -101, 105.33 )
	...
	PrestigeMasterTierWidget:setLeftRight( false, false, -99, 104.33 )
