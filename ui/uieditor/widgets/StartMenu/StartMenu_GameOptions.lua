-- dd39f33492a096c6be2f5d416eb296ae
...
local PostLoadFunc = function ( self, controller, menu )
	...
	self.mapName:setText( Engine.Localize( CoD.GetMapValue( Engine.DvarString( nil, "mapname" ), "mapName", Engine.DvarString( nil, "mapname" ) ) .. "_CAPS" ) )
	self.mapLocation:setText( "" )
	self.GameTypeDesc:setText( "" )
	local f1_local0 = Dvar.ui_gametype:get()
	if f1_local0 ~= nil and f1_local0 ~= "" then
		self.GameTypeDesc:setText( Engine.Localize( Engine.StructTableLookupString( "game_types", "name", f1_local0, "description" ) ) )
	end
...
CoD.StartMenu_GameOptions.new = function ( menu, controller )
	...
	menu:AddButtonCallbackFunction( buttonList, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f5_arg0, f5_arg1, f5_arg2, f5_arg3 )
	...
	GameType:setText( LocalizedGameType( "Domination" ) )
