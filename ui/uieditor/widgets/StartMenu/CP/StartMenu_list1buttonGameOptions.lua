-- c6aa79cc43628ee593f7771dd3b4088e
-- This hash is used for caching, delete to decompile the file again

require( "ui.uieditor.widgets.Lobby.Common.FE_ButtonPanelShaderContainer" )
require( "ui.uieditor.widgets.Lobby.Common.FE_HelpItemsLabel" )

CoD.StartMenu_list1buttonGameOptions = InheritFrom( LUI.UIElement )
CoD.StartMenu_list1buttonGameOptions.new = function ( menu, controller )
	local self = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc( self, controller )
	end
	self:setUseStencil( false )
	self:setClass( CoD.StartMenu_list1buttonGameOptions )
	self.id = "StartMenu_list1buttonGameOptions"
	...
	FEButtonFocus:setShaderVector( 0, 0.19, 0.5, 0.38, 0.2 )
	...
	btnDisplayText:setLeftRight( true, false, 12, 240 )
	...
	btnDisplayText:linkToElementModel( self, "displayText", true, function ( model )
		...
		if displayText then
			btnDisplayText:setText( LocalizeToUpperString( displayText ) )
		end
	end )
	...
	btnDisplayTextStroke:setLeftRight( true, false, 12, 240 )
	...
	btnDisplayTextStroke:linkToElementModel( self, "displayText", true, function ( model )
		local displayText = Engine.GetModelValue( model )
		if displayText then
			btnDisplayTextStroke:setText( LocalizeToUpperString( displayText ) )
		end
	end )
			...
			LoseFocus = function ()
				...
				local FEButtonPanelShaderContainerFrame2 = function ( FEButtonPanelShaderContainer, event )
					if not event.interrupted then
						FEButtonPanelShaderContainer:beginAnimation( "keyframe", 159, false, false, CoD.TweenType.Linear )
					end
					FEButtonPanelShaderContainer:setRGB( 0.5, 0.5, 0.5 )
					FEButtonPanelShaderContainer:setAlpha( 0 )
				...
				local FEButtonIdleFrame2 = function ( FEButtonIdle, event )
					if not event.interrupted then
						FEButtonIdle:beginAnimation( "keyframe", 159, false, false, CoD.TweenType.Linear )
					end
				...
				local FEButtonFocusFrame2 = function ( FEButtonFocus, event )
					local FEButtonFocusFrame3 = function ( FEButtonFocus, event )
						if not event.interrupted then
							FEButtonFocus:beginAnimation( "keyframe", 79, false, false, CoD.TweenType.Linear )
						end
				...
				local btnDisplayTextFrame2 = function ( btnDisplayText, event )
					if not event.interrupted then
						btnDisplayText:beginAnimation( "keyframe", 159, false, false, CoD.TweenType.Linear )
					end
				...
				local btnDisplayTextStrokeFrame2 = function ( btnDisplayTextStroke, event )
					if not event.interrupted then
						btnDisplayTextStroke:beginAnimation( "keyframe", 159, false, false, CoD.TweenType.Linear )
					end
