-- ae051b79c9d1b1693cae89fe96988c07
-- This hash is used for caching, delete to decompile the file again

require( "ui.uieditor.widgets.Lobby.Common.FE_ButtonPanelShaderContainer" )
require( "ui.uieditor.widgets.Lobby.Common.FE_HelpItemsLabel" )

CoD.StartMenu_list1button = InheritFrom( LUI.UIElement )
CoD.StartMenu_list1button.new = function ( menu, controller )
	...
	self:setClass( CoD.StartMenu_list1button )
	self.id = "StartMenu_list1button"
	...
	equippedIcon:setLeftRight( false, true, 5, 21 )
	equippedIcon:setTopBottom( false, false, -8, 8 )
	equippedIcon:setRGB( ColorSet.SelectedGreen.r, ColorSet.SelectedGreen.g, ColorSet.SelectedGreen.b )
	...
	self:mergeStateConditions( {
		...
		},
		{
			stateName = "Equipped",
			condition = function ( menu, element, event )
				return IsStartMenuItemEquipped( element, controller )
			end
		}
	} )
