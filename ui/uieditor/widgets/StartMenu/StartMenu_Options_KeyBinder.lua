-- 34d41934c4eec2235b27dc6f21532602
...
local PostLoadFunc = function ( self, controller, menu )
	CoD.Menu.AddButtonCallbackFunction( menu, self, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f3_arg0, f3_arg1, f3_arg2, f3_arg3 )
		if not f3_arg1.m_disableNavigation and f3_arg1:AcceptGamePadButtonInputFromModelCallback( f3_arg2 ) then
			if not Engine.LastInput_Gamepad( f3_arg2 ) then
				...
				if f3_local0 then
					...
					if f3_local1 and f3_local2 then
						...
						Engine.ExecNow( f3_arg2, "clearKeyStates" )
						Engine.BindCommand( f3_arg2, f3_local1, f3_local2 )
					end
				end
			end
			return true
