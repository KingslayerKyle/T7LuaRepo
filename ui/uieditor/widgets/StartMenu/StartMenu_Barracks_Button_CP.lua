-- 6fdbf196fae8a419e0bbcf009f3b3e0c
...
CoD.StartMenu_Barracks_Button_CP.new = function ( menu, controller )
	...
	TotalKills:setLeftRight( true, false, 2, 183 )
	...
	PercentComplete:setLeftRight( true, false, 189, 364 )
	PercentComplete:setTopBottom( true, false, 375.94, 436.94 )
	PercentComplete.BorderThin0:setAlpha( 0.3 )
	PercentComplete.Value:setText( Engine.Localize( "MENU_PERCENT_COMPLETE_CAPS" ) )
	PercentComplete.Title:setText( Engine.Localize( "-" ) )
	...
	lockedIcon:setTopBottom( false, false, -58.5, -26.5 )
