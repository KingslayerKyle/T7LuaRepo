-- 3f911f4f8ed5c447b0204f2c287e14ae
...
CoD.Store_NonFeaturedFrame.new = function ( menu, controller )
	...
	menu:AddButtonCallbackFunction( productList, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, nil, function ( f15_arg0, f15_arg1, f15_arg2, f15_arg3 )
		if IsSelfModelValueEqualToEnum( f15_arg0, f15_arg2, "purchasestatus", Enum.StoreProductPurchaseStatus.STORE_PRODUCT_NOT_PURCHASED ) and not IsPerControllerTablePropertyValue( f15_arg2, "selectedStoreCategory", "EXTRASLOTS" ) and not IsPerControllerTablePropertyValue( f15_arg2, "selectedStoreCategory", "ESPORTS" ) and not IsPerControllerTablePropertyValue( f15_arg2, "selectedStoreCategory", "EXTRAPACKS" ) and not IsPerControllerTablePropertyValue( f15_arg2, "selectedStoreCategory", "OUTFITS" ) then
			PurchaseProduct( self, f15_arg0, f15_arg2 )
			PlaySoundSetSound( self, "action" )
			return true
		elseif IsSelfModelValueEqualToEnum( f15_arg0, f15_arg2, "purchasestatus", Enum.StoreProductPurchaseStatus.STORE_PRODUCT_PURCHASED ) and not IsPerControllerTablePropertyValue( f15_arg2, "selectedStoreCategory", "EXTRASLOTS" ) and not IsPerControllerTablePropertyValue( f15_arg2, "selectedStoreCategory", "ESPORTS" ) and not IsPerControllerTablePropertyValue( f15_arg2, "selectedStoreCategory", "EXTRAPACKS" ) and not IsPerControllerTablePropertyValue( f15_arg2, "selectedStoreCategory", "OUTFITS" ) then
			PurchaseProduct( self, f15_arg0, f15_arg2 )
			return true
		elseif IsPerControllerTablePropertyValue( f15_arg2, "selectedStoreCategory", "EXTRASLOTS" ) and not DoesPlayerHaveExtraSlotsItem( f15_arg2 ) then
			OpenBuyExtraSlotsPackDialog( self, f15_arg0, f15_arg2 )
			return true
		elseif IsPerControllerTablePropertyValue( f15_arg2, "selectedStoreCategory", "ESPORTS" ) and not DoesPlayerHaveEsportsPackItem( f15_arg0, f15_arg2 ) then
			OpenBuyInventoryItemDialog( self, f15_arg0, f15_arg2, "Store" )
			return true
		elseif IsPerControllerTablePropertyValue( f15_arg2, "selectedStoreCategory", "EXTRAPACKS" ) and not DoesPlayerHaveEsportsPackItem( f15_arg0, f15_arg2 ) then
			OpenBuyInventoryItemDialog( self, f15_arg0, f15_arg2, "Store" )
			return true
		elseif IsPerControllerTablePropertyValue( f15_arg2, "selectedStoreCategory", "OUTFITS" ) and not DoesPlayerHaveOutfitItem( f15_arg0, f15_arg2 ) then
			OpenBuyInventoryItemDialog( self, f15_arg0, f15_arg2, "Store" )
			return true
		else
		...
		if IsSelfModelValueEqualToEnum( f16_arg0, f16_arg2, "purchasestatus", Enum.StoreProductPurchaseStatus.STORE_PRODUCT_NOT_PURCHASED ) and not IsPerControllerTablePropertyValue( f16_arg2, "selectedStoreCategory", "EXTRASLOTS" ) and not IsPerControllerTablePropertyValue( f16_arg2, "selectedStoreCategory", "ESPORTS" ) and not IsPerControllerTablePropertyValue( f16_arg2, "selectedStoreCategory", "EXTRAPACKS" ) and not IsPerControllerTablePropertyValue( f16_arg2, "selectedStoreCategory", "OUTFITS" ) then
			CoD.Menu.SetButtonLabel( f16_arg1, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "MENU_PURCHASE" )
			return true
		elseif IsSelfModelValueEqualToEnum( f16_arg0, f16_arg2, "purchasestatus", Enum.StoreProductPurchaseStatus.STORE_PRODUCT_PURCHASED ) and not IsPerControllerTablePropertyValue( f16_arg2, "selectedStoreCategory", "EXTRASLOTS" ) and not IsPerControllerTablePropertyValue( f16_arg2, "selectedStoreCategory", "ESPORTS" ) and not IsPerControllerTablePropertyValue( f16_arg2, "selectedStoreCategory", "EXTRAPACKS" ) and not IsPerControllerTablePropertyValue( f16_arg2, "selectedStoreCategory", "OUTFITS" ) then
			CoD.Menu.SetButtonLabel( f16_arg1, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "MENU_STORE_DOWNLOAD" )
			return true
		elseif IsPerControllerTablePropertyValue( f16_arg2, "selectedStoreCategory", "EXTRASLOTS" ) and not DoesPlayerHaveExtraSlotsItem( f16_arg2 ) then
			CoD.Menu.SetButtonLabel( f16_arg1, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "MENU_PURCHASE" )
			return true
		elseif IsPerControllerTablePropertyValue( f16_arg2, "selectedStoreCategory", "ESPORTS" ) and not DoesPlayerHaveEsportsPackItem( f16_arg0, f16_arg2 ) then
			CoD.Menu.SetButtonLabel( f16_arg1, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "MENU_PURCHASE" )
			return true
		elseif IsPerControllerTablePropertyValue( f16_arg2, "selectedStoreCategory", "EXTRAPACKS" ) and not DoesPlayerHaveEsportsPackItem( f16_arg0, f16_arg2 ) then
			CoD.Menu.SetButtonLabel( f16_arg1, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "MENU_PURCHASE" )
			return true
		elseif IsPerControllerTablePropertyValue( f16_arg2, "selectedStoreCategory", "OUTFITS" ) and not DoesPlayerHaveOutfitItem( f16_arg0, f16_arg2 ) then
			CoD.Menu.SetButtonLabel( f16_arg1, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "" )
			return false
		else
			return false
		end
	end, false )
	menu:AddButtonCallbackFunction( productList, controller, Enum.LUIButton.LUI_KEY_XBY_PSTRIANGLE, "F", function ( f17_arg0, f17_arg1, f17_arg2, f17_arg3 )
		if IsSelfModelValueNonEmptyString( f17_arg0, f17_arg2, "videoHighResRef" ) and IsElementPropertyValue( f17_arg0, "rightPaneFrameWidget", "StorePreviewMovieWidget" ) then
			OpenStoreNonFeatureFrameVOD( self, f17_arg0, f17_arg2 )
			return true
		else
			
		end
	end, function ( f18_arg0, f18_arg1, f18_arg2 )
		if IsSelfModelValueNonEmptyString( f18_arg0, f18_arg2, "videoHighResRef" ) and IsElementPropertyValue( f18_arg0, "rightPaneFrameWidget", "StorePreviewMovieWidget" ) then
			CoD.Menu.SetButtonLabel( f18_arg1, Enum.LUIButton.LUI_KEY_XBY_PSTRIANGLE, "" )
			return false
		else
			return false
		end
	...
	productList:subscribeToGlobalModel( controller, "PerController", "StoreRoot.ready", function ( model )
		...
		SetFocusToSpecialistOutfit( self, controller )
	end )
	...
	self:registerEventHandler( "gain_focus", function ( element, event )
		if element.m_focusable and element.productList:processEvent( event ) then
			return true
		else
