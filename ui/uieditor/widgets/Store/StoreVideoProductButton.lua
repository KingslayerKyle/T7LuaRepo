-- 9d2af6f6987ced5a26254056fa4d690e
...
CoD.StoreVideoProductButton.new = function ( menu, controller )
	...
	local frameWidget = LUI.UIFrame.new( menu, controller, 0, 0, true )
	frameWidget:setLeftRight( true, false, -1, 268 )
	frameWidget:setTopBottom( true, false, -1, 151 )
	...
	productName:setLeftRight( true, true, 1, -1 )
