-- 340cf4cd5b4d3ecf24d44dee3eaff0ed
-- This hash is used for caching, delete to decompile the file again

CoD.MissionRecordVault_AccoladesCybernetics = InheritFrom( LUI.UIElement )
CoD.MissionRecordVault_AccoladesCybernetics.new = function ( menu, controller )
	...
	self:setClass( CoD.MissionRecordVault_AccoladesCybernetics )
	self.id = "MissionRecordVault_AccoladesCybernetics"
	...
	image:setRGB( 1, 0.98, 0.63 )
	image:setImage( RegisterImage( "uie_cybernetics" ) )
