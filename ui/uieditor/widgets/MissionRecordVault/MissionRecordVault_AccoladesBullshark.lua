-- 2203daec7b47d06004447e7675efd876
-- This hash is used for caching, delete to decompile the file again

CoD.MissionRecordVault_AccoladesBullshark = InheritFrom( LUI.UIElement )
CoD.MissionRecordVault_AccoladesBullshark.new = function ( menu, controller )
	...
	self:setClass( CoD.MissionRecordVault_AccoladesBullshark )
	self.id = "MissionRecordVault_AccoladesBullshark"
	...
	image:setImage( RegisterImage( "uie_bullshark" ) )
