-- 539c914f821ec0f9958c05a895c425b5
-- This hash is used for caching, delete to decompile the file again

CoD.MissionRecordVault_AccoladesTraversal = InheritFrom( LUI.UIElement )
CoD.MissionRecordVault_AccoladesTraversal.new = function ( menu, controller )
	...
	self:setClass( CoD.MissionRecordVault_AccoladesTraversal )
	self.id = "MissionRecordVault_AccoladesTraversal"
	...
	image:setImage( RegisterImage( "uie_traversal" ) )
