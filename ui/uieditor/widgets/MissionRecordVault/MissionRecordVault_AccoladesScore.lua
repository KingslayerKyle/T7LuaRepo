-- 67058971cc90a027d83259a4c03b83d0
...
CoD.MissionRecordVault_AccoladesScore = InheritFrom( LUI.UIElement )
CoD.MissionRecordVault_AccoladesScore.new = function ( menu, controller )
	local self = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc( self, controller )
	end
	self:setUseStencil( false )
	self:setClass( CoD.MissionRecordVault_AccoladesScore )
	self.id = "MissionRecordVault_AccoladesScore"
	...
	image:setRGB( 0.98, 0.96, 0.51 )
	image:setImage( RegisterImage( "uie_score" ) )
