-- 64665d0d05d780189def42bdc42ff5f4
-- This hash is used for caching, delete to decompile the file again

CoD.MissionRecordVault_AccoladesHeavyWeapon = InheritFrom( LUI.UIElement )
CoD.MissionRecordVault_AccoladesHeavyWeapon.new = function ( menu, controller )
	...
	self:setClass( CoD.MissionRecordVault_AccoladesHeavyWeapon )
	self.id = "MissionRecordVault_AccoladesHeavyWeapon"
	...
	image:setRGB( 1, 0.98, 0.57 )
	image:setImage( RegisterImage( "uie_heavy_weapon" ) )
