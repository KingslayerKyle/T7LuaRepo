-- da680d8845fd416cab7d9957753fae7c
-- This hash is used for caching, delete to decompile the file again

CoD.MissionRecordVault_AccoladesGroundVehicleDestroy = InheritFrom( LUI.UIElement )
CoD.MissionRecordVault_AccoladesGroundVehicleDestroy.new = function ( menu, controller )
	...
	self:setClass( CoD.MissionRecordVault_AccoladesGroundVehicleDestroy )
	self.id = "MissionRecordVault_AccoladesGroundVehicleDestroy"
	...
	image:setRGB( 1, 0.98, 0.49 )
	image:setImage( RegisterImage( "uie_ground_vehicle" ) )
