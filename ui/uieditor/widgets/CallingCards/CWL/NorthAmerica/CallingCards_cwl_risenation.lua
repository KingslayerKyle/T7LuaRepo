-- 75db7dd76e4629e886208b8f1d888891
-- This hash is used for caching, delete to decompile the file again

require( "ui.uieditor.widgets.CallingCards.CWL.CallingCards_cwl_worldmap_widget" )

CoD.CallingCards_cwl_risenation = InheritFrom( LUI.UIElement )
CoD.CallingCards_cwl_risenation.new = function ( menu, controller )
	...
	self:setClass( CoD.CallingCards_cwl_risenation )
	self.id = "CallingCards_cwl_risenation"
	...
	LOGO:setImage( RegisterImage( "uie_callingcards_cwl_risenation" ) )
