-- f50c689b5bea0c4a619d812713cfca03
-- This hash is used for caching, delete to decompile the file again

require( "ui.uieditor.widgets.CallingCards.CWL.CallingCards_cwl_worldmap_widget" )

CoD.CallingCards_cwl_cloud9 = InheritFrom( LUI.UIElement )
CoD.CallingCards_cwl_cloud9.new = function ( menu, controller )
	...
	self:setClass( CoD.CallingCards_cwl_cloud9 )
	self.id = "CallingCards_cwl_cloud9"
	...
	LOGO:setLeftRight( true, false, 11.71, 480 )
	LOGO:setTopBottom( true, false, 0, 119.93 )
	LOGO:setImage( RegisterImage( "uie_callingcards_cwl_cloud9" ) )
