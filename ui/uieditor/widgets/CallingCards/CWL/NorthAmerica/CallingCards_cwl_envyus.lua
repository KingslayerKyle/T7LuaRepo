-- ba429c47e3f158ec14499babeb2fb8af
...
CoD.CallingCards_cwl_envyus.new = function ( menu, controller )
	...
	LOGO:setLeftRight( true, false, 9, 477.51 )
	LOGO:setTopBottom( true, false, 1.07, 120.07 )
	LOGO:setImage( RegisterImage( "uie_callingcards_cwl_envyus" ) )
