-- 6a6b3ef55d54b6d658153ed3a7c1d6e6
-- This hash is used for caching, delete to decompile the file again

require( "ui.uieditor.widgets.CallingCards.CWL.CallingCards_cwl_worldmap_widget" )

CoD.CallingCards_cwl_elevate = InheritFrom( LUI.UIElement )
CoD.CallingCards_cwl_elevate.new = function ( menu, controller )
	...
	self:setClass( CoD.CallingCards_cwl_elevate )
	self.id = "CallingCards_cwl_elevate"
	...
	LOGO:setImage( RegisterImage( "uie_callingcards_cwl_elevate" ) )
