-- 94f6035ddc6a62cf8e71b7f66def03c3
-- This hash is used for caching, delete to decompile the file again

require( "ui.uieditor.widgets.CallingCards.CWL.CallingCards_cwl_worldmap_widget" )

CoD.CallingCards_cwl_fazeclan = InheritFrom( LUI.UIElement )
CoD.CallingCards_cwl_fazeclan.new = function ( menu, controller )
	local self = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc( self, controller )
	end
	self:setUseStencil( true )
	self:setClass( CoD.CallingCards_cwl_fazeclan )
	self.id = "CallingCards_cwl_fazeclan"
	...
	BG5Empty:setImage( RegisterImage( "uie_callingcards_cwl_red_01" ) )
	...
	BG1:setImage( RegisterImage( "uie_callingcards_cwl_red_bg0b" ) )
	self:addElement( BG1 )
	self.BG1 = BG1
	...
	BG2:setImage( RegisterImage( "uie_callingcards_cwl_red_bg0c" ) )
	self:addElement( BG2 )
	self.BG2 = BG2
	...
	BG5Glow:setImage( RegisterImage( "uie_callingcards_cwl_red_02c" ) )
	...
	LOGO:setLeftRight( true, false, 0, 476.1 )
	LOGO:setTopBottom( true, false, -1.93, 120 )
	LOGO:setImage( RegisterImage( "uie_callingcards_cwl_fazeclan" ) )
