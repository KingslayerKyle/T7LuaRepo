-- 91dba6db96cd1f6be10d9dce356ccc24
-- This hash is used for caching, delete to decompile the file again

require( "ui.uieditor.widgets.CallingCards.CWL.CallingCards_cwl_worldmap_widget" )

CoD.CallingCards_cwl_splyce = InheritFrom( LUI.UIElement )
CoD.CallingCards_cwl_splyce.new = function ( menu, controller )
	...
	self:setClass( CoD.CallingCards_cwl_splyce )
	self.id = "CallingCards_cwl_splyce"
	...
	LOGO:setImage( RegisterImage( "uie_callingcards_cwl_splyce" ) )
