-- 83e8994c1d8bb3b12c00c90b8af9cfc0
-- This hash is used for caching, delete to decompile the file again

require( "ui.uieditor.widgets.CallingCards.CWL.CallingCards_cwl_worldmap_widget" )

CoD.CallingCards_cwl_ldlc = InheritFrom( LUI.UIElement )
CoD.CallingCards_cwl_ldlc.new = function ( menu, controller )
	...
	self:setClass( CoD.CallingCards_cwl_ldlc )
	self.id = "CallingCards_cwl_ldlc"
	...
	LOGO:setLeftRight( true, false, 11.71, 480.29 )
	LOGO:setTopBottom( true, false, 0, 120 )
	LOGO:setImage( RegisterImage( "uie_callingcards_cwl_ldlc" ) )
