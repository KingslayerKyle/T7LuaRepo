-- c5236076790231b8ff4d99c4a4399423
-- This hash is used for caching, delete to decompile the file again

require( "ui.uieditor.widgets.CallingCards.CWL.CallingCards_cwl_worldmap_widget" )

CoD.CallingCards_cwl_supremacy = InheritFrom( LUI.UIElement )
CoD.CallingCards_cwl_supremacy.new = function ( menu, controller )
	local self = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc( self, controller )
	end
	self:setUseStencil( true )
	self:setClass( CoD.CallingCards_cwl_supremacy )
	self.id = "CallingCards_cwl_supremacy"
	...
	LOGO:setImage( RegisterImage( "uie_callingcards_cwl_supremacy" ) )
