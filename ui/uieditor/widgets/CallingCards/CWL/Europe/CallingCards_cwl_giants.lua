-- 5310bdb77f9831722047caba93728da3
-- This hash is used for caching, delete to decompile the file again

require( "ui.uieditor.widgets.CallingCards.CWL.CallingCards_cwl_worldmap_widget" )

CoD.CallingCards_cwl_giants = InheritFrom( LUI.UIElement )
CoD.CallingCards_cwl_giants.new = function ( menu, controller )
	...
	self:setClass( CoD.CallingCards_cwl_giants )
	self.id = "CallingCards_cwl_giants"
	...
	BG5Empty:setImage( RegisterImage( "uie_callingcards_cwl_blue_01" ) )
	...
	BG1:setAlpha( 0 )
	BG1:setImage( RegisterImage( "uie_callingcards_cwl_blue_bg0b" ) )
	self:addElement( BG1 )
	self.BG1 = BG1
	...
	BG2:setAlpha( 0 )
	BG2:setImage( RegisterImage( "uie_callingcards_cwl_blue_bg0c" ) )
	self:addElement( BG2 )
	self.BG2 = BG2
	...
	BG5Glow:setImage( RegisterImage( "uie_callingcards_cwl_blue_02c" ) )
	...
	LOGO:setImage( RegisterImage( "uie_callingcards_cwl_giants" ) )
