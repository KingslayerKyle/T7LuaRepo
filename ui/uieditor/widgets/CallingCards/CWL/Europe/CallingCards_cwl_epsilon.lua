-- ccc4571222cce043f778756f32cbb2b6
-- This hash is used for caching, delete to decompile the file again

require( "ui.uieditor.widgets.CallingCards.CWL.CallingCards_cwl_worldmap_widget" )

CoD.CallingCards_cwl_epsilon = InheritFrom( LUI.UIElement )
CoD.CallingCards_cwl_epsilon.new = function ( menu, controller )
	local self = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc( self, controller )
	end
	self:setUseStencil( true )
	self:setClass( CoD.CallingCards_cwl_epsilon )
	self.id = "CallingCards_cwl_epsilon"
	...
	BG5Empty:setRGB( 0.64, 0.91, 1 )
	BG5Empty:setImage( RegisterImage( "uie_callingcards_cwl_bluedrk_01" ) )
	...
	BG1:setRGB( 0.64, 0.91, 1 )
	BG1:setAlpha( 0 )
	BG1:setImage( RegisterImage( "uie_callingcards_cwl_bluedrk_bg0b" ) )
	self:addElement( BG1 )
	self.BG1 = BG1
	...
	BG2:setRGB( 0.64, 0.91, 1 )
	BG2:setAlpha( 0 )
	BG2:setImage( RegisterImage( "uie_callingcards_cwl_bluedrk_bg0c" ) )
	self:addElement( BG2 )
	self.BG2 = BG2
	...
	BG5Glow:setRGB( 0.49, 0.86, 1 )
	BG5Glow:setImage( RegisterImage( "uie_callingcards_cwl_bluedrk_02c" ) )
	...
	LOGO:setLeftRight( true, false, 6, 480 )
	LOGO:setTopBottom( true, false, -2.46, 118.93 )
	LOGO:setImage( RegisterImage( "uie_callingcards_cwl_epsilon" ) )
	...
	GLOWBALL:setRGB( 0, 0.67, 0.95 )
	GLOWBALL:setAlpha( 0.82 )
	GLOWBALL:setZRot( -54 )
