-- aaa09818dc9c9e4973ce405cc648bc97
-- This hash is used for caching, delete to decompile the file again

require( "ui.uieditor.widgets.CallingCards.CWL.CallingCards_cwl_worldmap_widget" )

CoD.CallingCards_cwl_excellence = InheritFrom( LUI.UIElement )
CoD.CallingCards_cwl_excellence.new = function ( menu, controller )
	...
	self:setClass( CoD.CallingCards_cwl_excellence )
	self.id = "CallingCards_cwl_excellence"
	...
	BG5Empty:setImage( RegisterImage( "uie_callingcards_cwl_gold_01" ) )
	...
	BG1:setImage( RegisterImage( "uie_callingcards_cwl_gold_bg0b" ) )
	self:addElement( BG1 )
	self.BG1 = BG1
	...
	BG2:setImage( RegisterImage( "uie_callingcards_cwl_gold_bg0c" ) )
	self:addElement( BG2 )
	self.BG2 = BG2
	...
	BG5Glow:setImage( RegisterImage( "uie_callingcards_cwl_gold_02c" ) )
	...
	LOGO:setLeftRight( true, false, 9, 480 )
	LOGO:setTopBottom( true, false, 0.07, 120.7 )
	LOGO:setImage( RegisterImage( "uie_callingcards_cwl_excellence" ) )
