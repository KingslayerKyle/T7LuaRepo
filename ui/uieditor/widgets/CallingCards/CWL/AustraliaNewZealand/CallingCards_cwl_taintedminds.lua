-- 15f2459d2dc0665b0b433865da77499f
-- This hash is used for caching, delete to decompile the file again

require( "ui.uieditor.widgets.CallingCards.CWL.CallingCards_cwl_worldmap_widget" )

CoD.CallingCards_cwl_taintedminds = InheritFrom( LUI.UIElement )
CoD.CallingCards_cwl_taintedminds.new = function ( menu, controller )
	...
	self:setClass( CoD.CallingCards_cwl_taintedminds )
	self.id = "CallingCards_cwl_taintedminds"
	...
	BG5Empty:setImage( RegisterImage( "uie_callingcards_cwl_green_01" ) )
	...
	BG1:setImage( RegisterImage( "uie_callingcards_cwl_green_bg0b" ) )
	self:addElement( BG1 )
	self.BG1 = BG1
	...
	BG2:setImage( RegisterImage( "uie_callingcards_cwl_green_bg0c" ) )
	self:addElement( BG2 )
	self.BG2 = BG2
	...
	BG5Glow:setImage( RegisterImage( "uie_callingcards_cwl_green_02c" ) )
	...
	LOGO:setLeftRight( true, false, 1, 481 )
	LOGO:setTopBottom( true, false, -0.93, 122 )
	LOGO:setImage( RegisterImage( "uie_callingcards_cwl_taintedminds" ) )
	...
	self.clipsPerState = {
		DefaultState = {
			DefaultClip = function ()
				...
				local BG1Frame2 = function ( BG1, event )
					local BG1Frame3 = function ( BG1, event )
						local BG1Frame4 = function ( BG1, event )
							...
							BG1:setAlpha( 0 )
							BG1:setImage( RegisterImage( "uie_callingcards_cwl_green_02" ) )
				...
				self.BG1:setAlpha( 0 )
				self.BG1:setImage( RegisterImage( "uie_callingcards_cwl_green_02" ) )
				BG1Frame2( BG1, {} )
				local BG2Frame2 = function ( BG2, event )
					local BG2Frame3 = function ( BG2, event )
						local BG2Frame4 = function ( BG2, event )
							...
							BG2:setAlpha( 0 )
							BG2:setImage( RegisterImage( "uie_callingcards_cwl_green_02b" ) )
							if event.interrupted then
				...
				self.BG2:setAlpha( 0 )
				self.BG2:setImage( RegisterImage( "uie_callingcards_cwl_green_02b" ) )
				BG2Frame2( BG2, {} )
