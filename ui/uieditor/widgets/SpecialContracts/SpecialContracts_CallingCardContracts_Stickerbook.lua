-- 7613aeba5b16532357814139c8e7041c
...
CoD.SpecialContracts_CallingCardContracts_Stickerbook.new = function ( menu, controller )
	...
	menu:AddButtonCallbackFunction( CallingCardGrid, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f6_arg0, f6_arg1, f6_arg2, f6_arg3 )
		if IsSpecialContractAvailable( self, f6_arg0, f6_arg2 ) then
		...
		if IsSpecialContractAvailable( self, f7_arg0, f7_arg2 ) then
			return true
		else
			return false
		end
