-- d97412b568a5ba7789554e59de1101ed
-- This hash is used for caching, delete to decompile the file again

CoD.SpikeLuancherSpikeCounter_MeterFill4 = InheritFrom( LUI.UIElement )
CoD.SpikeLuancherSpikeCounter_MeterFill4.new = function ( menu, controller )
	...
	self:setClass( CoD.SpikeLuancherSpikeCounter_MeterFill4 )
	self.id = "SpikeLuancherSpikeCounter_MeterFill4"
	...
	Image0:setAlpha( 0.5 )
	Image0:setImage( RegisterImage( "uie_t7_cp_hud_system_spikelaunchercounter_fillmeter4" ) )
