-- 6c5816ef1b7d2eba33a1dd1b67bd5ea6
...
CoD.Challenges_CP_Summary.new = function ( menu, controller )
	...
	menu:AddButtonCallbackFunction( MissionsButton, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f12_arg0, f12_arg1, f12_arg2, f12_arg3 )
		if not IsElementInState( f12_arg0, "Disabled" ) then
			SetGlobalModelValue( "challengeCategory", "missions" )
			OpenPopup( self, "Challenges_CP_Stickerbooks", f12_arg2 )
			return true
		else
	...
	menu:AddButtonCallbackFunction( ToolsOfTheTradeButton, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f20_arg0, f20_arg1, f20_arg2, f20_arg3 )
		if not IsElementInState( f20_arg0, "Disabled" ) then
			SetGlobalModelValue( "challengeCategory", "tott" )
			OpenPopup( self, "Challenges_CP_Stickerbooks", f20_arg2 )
			return true
		else
	...
	menu:AddButtonCallbackFunction( CareerButton, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f28_arg0, f28_arg1, f28_arg2, f28_arg3 )
		if not IsElementInState( f28_arg0, "Disabled" ) then
			SetGlobalModelValue( "challengeCategory", "career" )
			OpenPopup( self, "Challenges_CP_Stickerbooks", f28_arg2 )
			return true
		else
	...
	self:registerEventHandler( "gain_focus", function ( element, event )
		if element.m_focusable and element.MissionsButton:processEvent( event ) then
			return true
		else
