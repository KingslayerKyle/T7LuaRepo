-- b3cbec65543912971295d0ba6f334f50
...
CoD.CombatRecordPublicMatchPanel.new = function ( menu, controller )
	...
	menu:AddButtonCallbackFunction( SpecialistButton, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f19_arg0, f19_arg1, f19_arg2, f19_arg3 )
		OpenOverlay( self, "CombatRecordSpecialists", f19_arg2, "", "" )
		return true
	...
	menu:AddButtonCallbackFunction( ScorestreakButton, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f25_arg0, f25_arg1, f25_arg2, f25_arg3 )
		OpenOverlay( self, "CombatRecordScorestreaks", f25_arg2, "", "" )
		return true
	...
	menu:AddButtonCallbackFunction( CombatRecordItemButton0, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f32_arg0, f32_arg1, f32_arg2, f32_arg3 )
		OpenOverlay( self, "CombatRecordGameModes", f32_arg2, "", "" )
		return true
	...
	self.clipsPerState = {
		DefaultState = {
			DefaultClip = function ()
				...
				RankName:setAlpha( 0 )
				RankName:registerEventHandler( "transition_complete_keyframe", f35_local1 )
				local f35_local2 = function ( f38_arg0, f38_arg1 )
					if not f38_arg1.interrupted then
						f38_arg0:beginAnimation( "keyframe", 29, false, false, CoD.TweenType.Bounce )
					end
					f38_arg0:setAlpha( 1 )
				...
				Rank:setAlpha( 0 )
				Rank:registerEventHandler( "transition_complete_keyframe", f35_local2 )
