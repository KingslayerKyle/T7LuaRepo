-- f02538647ab9a16ec51538f438873919
...
CoD.GenderList = InheritFrom( LUI.UIElement )
CoD.GenderList.new = function ( menu, controller )
	...
	DropdownList:setDataSource( "Gender" )
	DropdownList:setWidgetType( CoD.GenderItem )
	...
	DropdownList:registerEventHandler( "list_item_button_action", function ( element, event )
		...
		ToggleDropdownListInUse_Console( self, controller )
		UpdateState( self, event )
		AccountLink_SelectGender( self, element, controller )
		return f3_local0
	end )
