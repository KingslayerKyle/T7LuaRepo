-- 2e5e4c20a2a9d71490060b9d67b8edab
...
CoD.RegionList = InheritFrom( LUI.UIElement )
CoD.RegionList.new = function ( menu, controller )
	...
	DropdownList:setWidgetType( CoD.DropdownItem )
	...
	DropdownList:registerEventHandler( "list_item_button_action", function ( element, event )
		...
		ToggleDropdownListInUse_Console( self, controller )
		UpdateState( self, event )
		AccountLink_SelectRegion( self, element, controller )
		return f3_local0
	end )
