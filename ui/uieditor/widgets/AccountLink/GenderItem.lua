-- e23bb513080d5154ffb2bb2cd87dd86f
-- This hash is used for caching, delete to decompile the file again

require( "ui.uieditor.widgets.StartMenu.StartMenu_frame_noBG" )
require( "ui.uieditor.widgets.Lobby.Common.FE_FocusBarContainer" )

CoD.GenderItem = InheritFrom( LUI.UIElement )
CoD.GenderItem.new = function ( menu, controller )
	...
	self.Text:linkToElementModel( self, "gender", true, function ( model )
		local gender = Engine.GetModelValue( model )
		if gender then
			Text:setText( gender )
		end
	end )
