-- 7b6e126512c4f9e20d532378d41abf68
-- This hash is used for caching, delete to decompile the file again

require( "ui.uieditor.widgets.StartMenu.StartMenu_frame_noBG" )
require( "ui.uieditor.widgets.Lobby.Common.FE_FocusBarContainer" )

CoD.YearItem = InheritFrom( LUI.UIElement )
CoD.YearItem.new = function ( menu, controller )
	...
	self.Text:linkToElementModel( self, "year", true, function ( model )
		local year = Engine.GetModelValue( model )
		if year then
			Text:setText( year )
		end
	end )
