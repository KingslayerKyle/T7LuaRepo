-- 56ef07013c461525fbe30f574f7cce12
...
CoD.SPMGraphWidget.new = function ( menu, controller )
	...
	Average:subscribeToGlobalModel( controller, "AARSPMGraph", "avgSPM", function ( model )
		...
		if avgSPM then
			Average.Text:setText( Engine.Localize( avgSPM ) )
		end
	end )
	...
	Segment4:setLeftRight( true, false, 55, 136 )
	...
	Segment2:setLeftRight( true, false, 204, 287 )
	...
	Segment1:setLeftRight( true, false, 280, 361 )
