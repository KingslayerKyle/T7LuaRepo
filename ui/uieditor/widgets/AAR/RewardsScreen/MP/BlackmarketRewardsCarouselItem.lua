-- 309d33603ede2c2e14b7105a7e2214cd
...
CoD.BlackmarketRewardsCarouselItem = InheritFrom( LUI.UIElement )
CoD.BlackmarketRewardsCarouselItem.new = function ( menu, controller )
	local self = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc( self, controller )
	end
	self:setUseStencil( false )
	self:setClass( CoD.BlackmarketRewardsCarouselItem )
	self.id = "BlackmarketRewardsCarouselItem"
	self.soundSet = "HUD"
	...
	BlackmarketRewardsCarouselItemInternal.CardTitleBacking:setRGB( ColorSet.BlackMarketCommon.r, ColorSet.BlackMarketCommon.g, ColorSet.BlackMarketCommon.b )
