-- 3e52dcd8aa4942c446e49047c46e9539
...
CoD.RewardsCarouselItemInternal.new = function ( menu, controller )
	...
	ParagonRankUpDesc:setLeftRight( false, false, -85.22, 85.22 )
	ParagonRankUpDesc:setTopBottom( true, false, 173, 193 )
	...
	ParagonRankUpDesc:linkToElementModel( self, "paragonRankDescVisible", true, function ( model )
		local paragonRankDescVisible = Engine.GetModelValue( model )
		if paragonRankDescVisible then
			ParagonRankUpDesc:setAlpha( paragonRankDescVisible )
		end
	end )
	...
	ExtraParagonIconsText:setLeftRight( false, false, -85.22, 85.22 )
	ExtraParagonIconsText:setTopBottom( true, false, 388.5, 408.5 )
	ExtraParagonIconsText:setText( Engine.Localize( LocalizeIntoString( "PRESENCE_PLUS_NUM_MORE", "6" ) ) )
	...
	ExtraParagonIconsText:linkToElementModel( self, "extraParagonIconsVisible", true, function ( model )
		local extraParagonIconsVisible = Engine.GetModelValue( model )
		if extraParagonIconsVisible then
			ExtraParagonIconsText:setAlpha( extraParagonIconsVisible )
		end
	end )
	...
	LUI.OverrideFunction_CallOriginalSecond( self, "close", function ( element )
		...
		element.ParagonRankUpDesc:close()
		element.ExtraParagonIconsText:close()
