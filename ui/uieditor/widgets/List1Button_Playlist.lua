-- f3a4ec92ab1586c747fdb43ac104ed2b
...
CoD.List1Button_Playlist.new = function ( menu, controller )
	...
	btnDisplayText:linkToElementModel( self, "buttonText", true, function ( model )
		local buttonText = Engine.GetModelValue( model )
		if buttonText then
			btnDisplayText:setText( buttonText )
		end
	end )
	...
	btnDisplayTextStroke:linkToElementModel( self, "buttonText", true, function ( model )
		local buttonText = Engine.GetModelValue( model )
		if buttonText then
			btnDisplayTextStroke:setText( buttonText )
		end
	end )
	...
	FEHelpItemsLabel0:linkToElementModel( FEHelpItemsLabel0, "hasBonusIcon", true, function ( model )
		menu:updateElementState( FEHelpItemsLabel0, {
			name = "model_validation",
			menu = menu,
			modelValue = Engine.GetModelValue( model ),
