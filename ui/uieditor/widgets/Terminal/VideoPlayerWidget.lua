-- 39382fe0eed2cff7ed0b66222d95adbb
	...
	self.Movie0:linkToElementModel( self.List0, "Video", true, function ( model )
		...
		if modelValue then
			...
			if self.closedInitialBlack == nil then
				...
				self.closeInitialBlackAfter = LUI.UITimer.newElementTimer( 550, false, function ( f4_arg0 )
			...
			self.playAfterTimer = LUI.UITimer.newElementTimer( 500, false, function ( f5_arg0 )
...
CoD.VideoPlayerWidget.new = function ( menu, controller )
	...
	List0:makeFocusable()
	List0:setLeftRight( true, false, 16.27, 141.27 )
