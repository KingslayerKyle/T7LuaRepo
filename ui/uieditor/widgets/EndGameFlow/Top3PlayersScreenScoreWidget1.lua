-- e91746bbbe066a22b814d4d97cdb9bf7
...
CoD.Top3PlayersScreenScoreWidget1 = InheritFrom( LUI.UIElement )
CoD.Top3PlayersScreenScoreWidget1.new = function ( menu, controller )
	local self = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc( self, controller )
	end
	self:setUseStencil( false )
	self:setClass( CoD.Top3PlayersScreenScoreWidget1 )
	self.id = "Top3PlayersScreenScoreWidget1"
	...
	PlayerCard:setLeftRight( true, false, 3, 301 )
	PlayerCard:setTopBottom( true, false, 47, 107 )
	...
	Score0:setTopBottom( true, false, 6, 42 )
	Score0:setAlpha( 0 )
	...
	RibbonImageInvert:setLeftRight( true, false, 47, 104 )
	...
	RibbonImage:setLeftRight( true, false, 47, 104 )
