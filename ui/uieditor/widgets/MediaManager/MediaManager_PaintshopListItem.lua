-- 956e1dea3ab6f3efda8276275c07bc85
...
CoD.MediaManager_PaintshopListItem.new = function ( menu, controller )
	...
	extraCamRender:linkToElementModel( self, "showBuyImage", true, function ( model )
	...
	LabelButton:linkToElementModel( self, "paintjobName", true, function ( model )
		...
		if paintjobName then
			LabelButton.itemName:setText( GetPaintjobName( paintjobName ) )
		end
	end )
	...
	PlusImage:setLeftRight( true, false, 13, 57 )
