-- 3d109ffbce848eb5e26f1b7fc0ff2bb4
...
CoD.paintshopTabWidget.new = function ( menu, controller )
	...
	FETabFocus:setShaderVector( 0, 0.47, 0.5, 0.42, 0.33 )
	...
	textDark:setLeftRight( true, true, 0, 0 )
	...
	GameSettingsChangedIndicator:setLeftRight( true, false, 4, 34 )
	GameSettingsChangedIndicator:setTopBottom( true, false, -15, 15 )
	...
	breadcrumbCount:setLeftRight( false, true, -22, -4 )
	breadcrumbCount:setTopBottom( true, false, -5, 13 )
	...
	if self.m_eventHandlers.input_source_changed then
		local f3_local11 = self.m_eventHandlers.input_source_changed
		self:registerEventHandler( "input_source_changed", function ( element, event )
			event.menu = event.menu or menu
			element:updateState( event )
			return f3_local11( element, event )
		end )
	else
