-- 81fc0569ec1be942827d4ca99e4a0c86
...
local f0_local1 = function ( f2_arg0, f2_arg1, f2_arg2 )
	...
	f2_arg0:registerEventHandler( "dropdown_item_selected", function ( element, event )
		...
		CoD.Menu.UpdateButtonShownState( element, f2_arg2, f2_arg1, Enum.LUIButton.LUI_KEY_XBY_PSTRIANGLE )
		return true
	end )
	...
	f2_arg2:AddButtonCallbackFunction( f2_arg0, f2_arg1, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f10_arg0, f10_arg1, f10_arg2, f10_arg3 )
		if not f2_arg0.disabled and not f10_arg1.m_disableNavigation and f10_arg1:AcceptGamePadButtonInputFromModelCallback( f10_arg2 ) then
			if not f2_arg0.inUse then
				f0_local0( f2_arg0, f10_arg2 )
				UpdateState( f2_arg0, {
					name = "update_state",
					controller = f10_arg2
				} )
	...
	if f2_arg2.menuName == "StartMenu_Options_Sound_PC" then
		local f2_local0 = function ( f11_arg0, f11_arg1, f11_arg2 )
			if type( f11_arg0.dropDownCurrentValue ) == "function" then
				local f11_local0 = f11_arg0.DropDownList:findItem( {
					value = f11_arg0.dropDownCurrentValue( f11_arg1, f11_arg0 )
				}, nil, false, false )
				if f11_local0 then
					local f11_local1 = f11_local0:getModel()
					if f11_local1 then
						local f11_local2 = Engine.GetModel( f11_local1, f11_arg2 )
						if f11_local2 then
							local f11_local3 = Engine.GetModelValue( f11_local2 )
		...
		local f2_local1 = function ( f12_arg0, f12_arg1 )
			...
			if f12_local0 then
				Engine.SetModelValue( Engine.CreateModel( f12_local0, "alias" ), f12_arg1 )
			end
		end
		
		f2_arg0:registerEventHandler( "list_item_lose_focus", function ( element, event )
		...
		f2_arg2:AddButtonCallbackFunction( f2_arg0, f2_arg1, Enum.LUIButton.LUI_KEY_XBY_PSTRIANGLE, "P", function ( f15_arg0, f15_arg1, f15_arg2, f15_arg3 )
			local f15_local0 = f2_local0( f2_arg0, f15_arg2, "alias" )
			if f15_local0 then
				f2_local1( f2_arg0, f15_local0 )
				StopMPMusicPreview( f15_arg2, f2_arg0 )
				PlayMPMusicPreview( f15_arg2, f2_arg0 )
				return true
			else
				return false
			end
		end, function ( f16_arg0, f16_arg1, f16_arg2 )
			if f2_local0( f2_arg0, f16_arg2, "alias" ) then
				CoD.Menu.SetButtonLabel( f16_arg1, Enum.LUIButton.LUI_KEY_XBY_PSTRIANGLE, "MENU_PLAY_MUSIC_SAMPLE" )
				return true
			else
				return false
			end
