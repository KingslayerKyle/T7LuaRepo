-- f3e44ce3fd0f2f9104e61cc7098d42af
...
CoD.List1ButtonConfirmSelection = InheritFrom( LUI.UIElement )
CoD.List1ButtonConfirmSelection.new = function ( menu, controller )
	...
	self:setClass( CoD.List1ButtonConfirmSelection )
	self.id = "List1ButtonConfirmSelection"
	...
	RestrictedItemWarning:setLeftRight( true, false, -64, -20 )
	RestrictedItemWarning:setTopBottom( true, false, -3, 35 )
	RestrictedItemWarning:mergeStateConditions( {
		{
			stateName = "Visible",
			condition = function ( menu, element, event )
				return ClassContainsRestrictedItems( menu, element, controller )
			end
		}
	} )
	RestrictedItemWarning:linkToElementModel( RestrictedItemWarning, "classNum", true, function ( model )
