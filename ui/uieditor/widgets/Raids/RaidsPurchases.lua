-- 39241ca8464d3cbc640f7bb0976d2dc9
...
CoD.RaidsPurchases.new = function ( menu, controller )
	...
	menu:AddButtonCallbackFunction( PurchasesList, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f6_arg0, f6_arg1, f6_arg2, f6_arg3 )
		if RaidPurchaseAllowed( f6_arg1, f6_arg0, f6_arg2 ) then
			MakeRaidPurchase( self, f6_arg0, f6_arg2 )
			GoBack( self, f6_arg2 )
			PlaySoundSetSound( self, "purchase" )
			LockInput( self, f6_arg2, false )
			return true
		elseif not RaidPurchaseAllowed( f6_arg1, f6_arg0, f6_arg2 ) then
		...
		if RaidPurchaseAllowed( f7_arg1, f7_arg0, f7_arg2 ) then
			return true
		elseif not RaidPurchaseAllowed( f7_arg1, f7_arg0, f7_arg2 ) then
			return true
		else
			return false
		end
	...
	self:registerEventHandler( "gain_focus", function ( element, event )
		if element.m_focusable and element.PurchasesList:processEvent( event ) then
			return true
		else
