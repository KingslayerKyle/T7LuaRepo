-- 0ffbecc78dd4afe31dc1fae49d72fd86
...
CoD.overCapacityScorestreakButtonNew.new = function ( menu, controller )
	...
	image:linkToElementModel( self, "itemIndex", true, function ( model )
		...
		if itemIndex then
			image:setImage( RegisterImage( AppendString( "_menu", GetItemImageFromIndex( itemIndex ) ) ) )
		end
	end )
	...
	info:setLeftRight( false, false, -96, 236 )
	info:setTopBottom( false, true, 20, 109 )
	...
	scorestreaksArrow:setLeftRight( true, false, 56, 65 )
	scorestreaksArrow:setTopBottom( true, false, 130, 140 )
	...
	RestrictedItemWarning:setLeftRight( true, false, 0, 120 )
	RestrictedItemWarning:setTopBottom( true, false, 7, 110.64 )
	...
	self.clipsPerState = {
		DefaultState = {
			DefaultClip = function ()
				...
				self.itemImage:setRGB( 0.48, 0.48, 0.48 )
				self.itemImage:setAlpha( 0.15 )
				...
				self.info:setLeftRight( false, false, -96, 236 )
				self.info:setTopBottom( false, true, 20, 109 )
	...
	LUI.OverrideFunction_CallOriginalSecond( self, "close", function ( element )
		...
		element.info:close()
		element.scorestreaksArrow:close()
