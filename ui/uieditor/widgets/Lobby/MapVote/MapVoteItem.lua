-- 310c030c023205f51f4450be8e47e2b2
...
CoD.MapVoteItem.new = function ( menu, controller )
	...
	MapNameNew:setLeftRight( true, false, 13, 200 )
	...
	black:setLeftRight( true, false, 0, 355 )
	black:setTopBottom( true, false, 0, 60 )
	black:setRGB( 0, 0, 0 )
	black:setAlpha( 0 )
	...
	LUI.OverrideFunction_CallOriginalSecond( self, "close", function ( element )
		...
		element.Stroke:close()
		element.MapNameNew:close()
