-- ad964ae8566d6459d8a0021bcc164c1c
...
CoD.LobbyMemberList.new = function ( menu, controller )
	...
	menu:AddButtonCallbackFunction( lobbyList, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f16_arg0, f16_arg1, f16_arg2, f16_arg3 )
		if IsLobbyNetworkModeLAN() then
			SetSelectedFriendXUID( self, f16_arg0, f16_arg2 )
			OpenPlatformProfile( self, f16_arg0, f16_arg2, "", f16_arg1 )
			return true
		else
			SetSelectedFriendXUID( self, f16_arg0, f16_arg2 )
			OpenOverlay( self, "Social_PlayerDetailsPopup", f16_arg2, "", "" )
			return true
		end
	...
	menu:AddButtonCallbackFunction( lobbyList, controller, Enum.LUIButton.LUI_KEY_XBX_PSSQUARE, "N", function ( f18_arg0, f18_arg1, f18_arg2, f18_arg3 )
		if IsLobbyNetworkModeLive() and IsMultiplayer() and AlwaysFalse() then
			SetSelectedFriendXUID( self, f18_arg0, f18_arg2 )
			SetGlobalModelValue( "combatRecordMode", "mp" )
			CombatRecordSetXUIDFromSelectedFriend( f18_arg2 )
			CombatRecordSetMenuForPostStatsLoad( self, "Social_InspectPlayerPopup" )
			OpenPopup( self, "Social_InspectPlayerPopupLoading", f18_arg2, "", "" )
			CombatRecordReadOtherPlayerStats( f18_arg2 )
			return true
		else
		...
		if IsLobbyNetworkModeLive() and IsMultiplayer() and AlwaysFalse() then
			CoD.Menu.SetButtonLabel( f19_arg1, Enum.LUIButton.LUI_KEY_XBX_PSSQUARE, "MENU_INSPECT_PLAYER" )
			return true
		else
			return false
		end
	end, false )
	menu:AddButtonCallbackFunction( lobbyList, controller, Enum.LUIButton.LUI_KEY_LB, "Q", function ( f20_arg0, f20_arg1, f20_arg2, f20_arg3 )
		if not IsRepeatButtonPress( f20_arg3 ) and IsLobbyGameHost() and IsLobbyWithTeamAssignment() and IsTeamAssignment( LuaEnums.TEAM_ASSIGNMENT.HOST ) then
			LobbyTeamSelectionLB( self, f20_arg0, f20_arg2 )
		...
		if not IsRepeatButtonPress( nil ) and IsLobbyGameHost() and IsLobbyWithTeamAssignment() and IsTeamAssignment( LuaEnums.TEAM_ASSIGNMENT.HOST ) then
			CoD.Menu.SetButtonLabel( f21_arg1, Enum.LUIButton.LUI_KEY_LB, "MPUI_CHANGE_ROLE" )
			return true
		else
			return false
		end
	end, false )
	menu:AddButtonCallbackFunction( lobbyList, controller, Enum.LUIButton.LUI_KEY_RB, "W", function ( f22_arg0, f22_arg1, f22_arg2, f22_arg3 )
		if not IsRepeatButtonPress( f22_arg3 ) and IsLobbyGameHost() and IsLobbyWithTeamAssignment() and IsTeamAssignment( LuaEnums.TEAM_ASSIGNMENT.HOST ) then
			LobbyTeamSelectionRB( self, f22_arg0, f22_arg2 )
			PlaySoundSetSound( self, "team_switch" )
			return true
		else
		...
		if not IsRepeatButtonPress( nil ) and IsLobbyGameHost() and IsLobbyWithTeamAssignment() and IsTeamAssignment( LuaEnums.TEAM_ASSIGNMENT.HOST ) then
			CoD.Menu.SetButtonLabel( f23_arg1, Enum.LUIButton.LUI_KEY_RB, "" )
			return false
		else
			return false
		end
	end, false )
	menu:AddButtonCallbackFunction( lobbyList, controller, Enum.LUIButton.LUI_KEY_XBX_PSSQUARE, "X", function ( f24_arg0, f24_arg1, f24_arg2, f24_arg3 )
		if IsLobbyNetworkModeLAN() and CanMuteLobbyPlayerLAN( f24_arg2, f24_arg0 ) and IsPlayerMuted( f24_arg2, f24_arg0 ) then
			UnmuteLobbyPlayerLAN( f24_arg0, f24_arg2, f24_arg1 )
			return true
		elseif IsLobbyNetworkModeLAN() and CanMuteLobbyPlayerLAN( f24_arg2, f24_arg0 ) then
			MuteLobbyPlayerLAN( f24_arg0, f24_arg2, f24_arg1 )
			return true
		else
			
		end
	end, function ( f25_arg0, f25_arg1, f25_arg2 )
		if IsLobbyNetworkModeLAN() and CanMuteLobbyPlayerLAN( f25_arg2, f25_arg0 ) and IsPlayerMuted( f25_arg2, f25_arg0 ) then
			CoD.Menu.SetButtonLabel( f25_arg1, Enum.LUIButton.LUI_KEY_XBX_PSSQUARE, "MENU_UNMUTE" )
			return true
		elseif IsLobbyNetworkModeLAN() and CanMuteLobbyPlayerLAN( f25_arg2, f25_arg0 ) then
			CoD.Menu.SetButtonLabel( f25_arg1, Enum.LUIButton.LUI_KEY_XBX_PSSQUARE, "MENU_MUTE" )
			return true
		else
			return false
		end
	...
	menu:AddButtonCallbackFunction( friendsAndGroups, controller, Enum.LUIButton.LUI_KEY_XBX_PSSQUARE, "J", function ( f34_arg0, f34_arg1, f34_arg2, f34_arg3 )
		if IsPlayerJoinable( f34_arg0 ) then
			LobbyQuickJoin( self, f34_arg0, f34_arg2, Enum.JoinType.JOIN_TYPE_FRIEND, false )
			return true
		else
			
		end
	end, function ( f35_arg0, f35_arg1, f35_arg2 )
		if IsPlayerJoinable( f35_arg0 ) then
			CoD.Menu.SetButtonLabel( f35_arg1, Enum.LUIButton.LUI_KEY_XBX_PSSQUARE, "MENU_JOIN" )
			return true
		else
			return false
		end
	end, false )
	menu:AddButtonCallbackFunction( friendsAndGroups, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f36_arg0, f36_arg1, f36_arg2, f36_arg3 )
		SetSelectedFriendXUID( self, f36_arg0, f36_arg2 )
		OpenOverlay( self, "Social_PlayerDetailsPopup", f36_arg2, "", "" )
		return true
	...
	self:registerEventHandler( "gain_focus", function ( element, event )
		if element.m_focusable and element.lobbyList:processEvent( event ) then
			return true
		else
