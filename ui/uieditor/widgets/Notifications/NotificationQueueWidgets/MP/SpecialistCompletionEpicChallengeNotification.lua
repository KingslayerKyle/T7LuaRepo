-- d11c3a7937f1f6f47d9892fde7a543b8
	...
	self.clipsPerState = {
		DefaultState = {
				...
				local Side02Frame2 = function ( Side02, event )
					local Side02Frame3 = function ( Side02, event )
						...
						if event.interrupted then
							...
							Side02:beginAnimation( "keyframe", 189, false, true, CoD.TweenType.Back )
							Side02:setLeftRight( true, false, 214.69, 334.69 )
							Side02:setAlpha( 0.94 )
					...
					if event.interrupted then
						...
						Side02:beginAnimation( "keyframe", 300, false, false, CoD.TweenType.Linear )
						Side02:registerEventHandler( "transition_complete_keyframe", Side02Frame3 )
					end
				end
				
				Side02:completeAnimation()
				self.Side02:setLeftRight( true, false, 148.03, 268.03 )
				...
				local Side01Frame2 = function ( Side01, event )
					local Side01Frame3 = function ( Side01, event )
						...
						if event.interrupted then
							...
							Side01:beginAnimation( "keyframe", 189, false, true, CoD.TweenType.Back )
							Side01:setLeftRight( true, false, 13.31, 133.31 )
							Side01:setAlpha( 0.94 )
					...
					if event.interrupted then
						...
						Side01:beginAnimation( "keyframe", 300, false, false, CoD.TweenType.Linear )
						Side01:registerEventHandler( "transition_complete_keyframe", Side01Frame3 )
					end
				end
				
				Side01:completeAnimation()
				self.Side01:setLeftRight( true, false, 79.97, 199.97 )
				...
				local ParticleFX01Frame2 = function ( ParticleFX01, event )
					local ParticleFX01Frame3 = function ( ParticleFX01, event )
						local ParticleFX01Frame4 = function ( ParticleFX01, event )
							if not event.interrupted then
								ParticleFX01:beginAnimation( "keyframe", 50, false, true, CoD.TweenType.Linear )
							end
							ParticleFX01:setAlpha( 0 )
							ParticleFX01:setScale( 1.5 )
							if event.interrupted then
						...
						if event.interrupted then
							...
							ParticleFX01:beginAnimation( "keyframe", 60, false, true, CoD.TweenType.Linear )
							ParticleFX01:setScale( 0.86 )
			...
			TimeUp = function ()
					...
					local Side02Frame3 = function ( Side02, event )
						local Side02Frame4 = function ( Side02, event )
							local Side02Frame5 = function ( Side02, event )
								if not event.interrupted then
									Side02:beginAnimation( "keyframe", 39, false, true, CoD.TweenType.Bounce )
								end
								Side02:setAlpha( 0 )
								if event.interrupted then
									self.clipFinished( Side02, event )
							...
							if event.interrupted then
								...
								Side02:beginAnimation( "keyframe", 40, false, true, CoD.TweenType.Bounce )
								Side02:setAlpha( 1 )
					...
					local Side01Frame3 = function ( Side01, event )
						local Side01Frame4 = function ( Side01, event )
							local Side01Frame5 = function ( Side01, event )
								if not event.interrupted then
									Side01:beginAnimation( "keyframe", 39, false, true, CoD.TweenType.Bounce )
								end
								Side01:setAlpha( 0 )
								if event.interrupted then
									self.clipFinished( Side01, event )
							...
							if event.interrupted then
								...
								Side01:beginAnimation( "keyframe", 40, false, true, CoD.TweenType.Bounce )
								Side01:setAlpha( 1 )
				...
				CenterShadow:completeAnimation()
				self.CenterShadow:setAlpha( 0.6 )
				CenterShadowFrame2( CenterShadow, {} )
				local CenterFillFrame2 = function ( CenterFill, event )
					local CenterFillFrame3 = function ( CenterFill, event )
						local CenterFillFrame4 = function ( CenterFill, event )
							local CenterFillFrame5 = function ( CenterFill, event )
								if not event.interrupted then
									CenterFill:beginAnimation( "keyframe", 39, false, true, CoD.TweenType.Bounce )
								end
								CenterFill:setAlpha( 0 )
								if event.interrupted then
									self.clipFinished( CenterFill, event )
								else
									CenterFill:registerEventHandler( "transition_complete_keyframe", self.clipFinished )
							...
							if event.interrupted then
								CenterFillFrame5( CenterFill, event )
								return 
							else
								CenterFill:beginAnimation( "keyframe", 40, false, true, CoD.TweenType.Bounce )
								CenterFill:registerEventHandler( "transition_complete_keyframe", CenterFillFrame5 )
							end
						end
						
						if event.interrupted then
							CenterFillFrame4( CenterFill, event )
							return 
						else
							CenterFill:beginAnimation( "keyframe", 39, false, true, CoD.TweenType.Bounce )
							CenterFill:registerEventHandler( "transition_complete_keyframe", CenterFillFrame4 )
						end
					end
					
					if event.interrupted then
						CenterFillFrame3( CenterFill, event )
						return 
					else
						CenterFill:beginAnimation( "keyframe", 119, false, false, CoD.TweenType.Linear )
						CenterFill:registerEventHandler( "transition_complete_keyframe", CenterFillFrame3 )
					end
				end
				
				CenterFill:completeAnimation()
				self.CenterFill:setAlpha( 0.4 )
				CenterFillFrame2( CenterFill, {} )
				local SideFillFrame2 = function ( SideFill, event )
					local SideFillFrame3 = function ( SideFill, event )
						local SideFillFrame4 = function ( SideFill, event )
							local SideFillFrame5 = function ( SideFill, event )
								if not event.interrupted then
									SideFill:beginAnimation( "keyframe", 39, false, true, CoD.TweenType.Bounce )
								end
								SideFill:setAlpha( 0 )
								if event.interrupted then
									self.clipFinished( SideFill, event )
							...
							if event.interrupted then
								SideFillFrame5( SideFill, event )
								return 
							else
								SideFill:beginAnimation( "keyframe", 40, false, true, CoD.TweenType.Bounce )
								SideFill:setAlpha( 1 )
								SideFill:registerEventHandler( "transition_complete_keyframe", SideFillFrame5 )
							end
						end
						
						if event.interrupted then
							SideFillFrame4( SideFill, event )
							return 
						else
							SideFill:beginAnimation( "keyframe", 39, false, true, CoD.TweenType.Bounce )
							SideFill:setAlpha( 0 )
							SideFill:registerEventHandler( "transition_complete_keyframe", SideFillFrame4 )
						end
					end
				...
				SideFill:completeAnimation()
				self.SideFill:setAlpha( 1 )
				SideFillFrame2( SideFill, {} )
				local SideStrokeFrame2 = function ( SideStroke, event )
					local SideStrokeFrame3 = function ( SideStroke, event )
						local SideStrokeFrame4 = function ( SideStroke, event )
							local SideStrokeFrame5 = function ( SideStroke, event )
								if not event.interrupted then
									SideStroke:beginAnimation( "keyframe", 39, false, true, CoD.TweenType.Bounce )
								end
								SideStroke:setAlpha( 0 )
								if event.interrupted then
									self.clipFinished( SideStroke, event )
								else
									SideStroke:registerEventHandler( "transition_complete_keyframe", self.clipFinished )
							...
							if event.interrupted then
								SideStrokeFrame5( SideStroke, event )
								return 
							else
								SideStroke:beginAnimation( "keyframe", 40, false, true, CoD.TweenType.Bounce )
								SideStroke:setAlpha( 1 )
								SideStroke:registerEventHandler( "transition_complete_keyframe", SideStrokeFrame5 )
							end
						end
						
						if event.interrupted then
							SideStrokeFrame4( SideStroke, event )
							return 
						else
							SideStroke:beginAnimation( "keyframe", 39, false, true, CoD.TweenType.Bounce )
							SideStroke:setAlpha( 0 )
							SideStroke:registerEventHandler( "transition_complete_keyframe", SideStrokeFrame4 )
						end
					end
					...
					local highlightFrame3 = function ( highlight, event )
						local highlightFrame4 = function ( highlight, event )
							local highlightFrame5 = function ( highlight, event )
								if not event.interrupted then
									highlight:beginAnimation( "keyframe", 40, false, true, CoD.TweenType.Bounce )
								end
