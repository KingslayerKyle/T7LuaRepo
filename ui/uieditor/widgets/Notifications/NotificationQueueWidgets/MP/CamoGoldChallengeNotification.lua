-- 39f09a82501b38b9029a30e69ea118ad
...
CoD.CamoGoldChallengeNotification.new = function ( menu, controller )
	...
	Sound:setLeftRight( true, false, -181.5, -133.5 )
	Sound:setTopBottom( true, false, 95.5, 143.5 )
				...
				local ParticleFX01Frame2 = function ( ParticleFX01, event )
					local ParticleFX01Frame3 = function ( ParticleFX01, event )
						local ParticleFX01Frame4 = function ( ParticleFX01, event )
							if not event.interrupted then
								ParticleFX01:beginAnimation( "keyframe", 200, false, true, CoD.TweenType.Linear )
							end
							ParticleFX01:setAlpha( 0 )
						...
						if event.interrupted then
							...
							ParticleFX01:beginAnimation( "keyframe", 80, false, true, CoD.TweenType.Linear )
					...
					local NotifCamoCenterBackingFrame3 = function ( NotifCamoCenterBacking, event )
						local NotifCamoCenterBackingFrame4 = function ( NotifCamoCenterBacking, event )
							local NotifCamoCenterBackingFrame5 = function ( NotifCamoCenterBacking, event )
								if not event.interrupted then
									NotifCamoCenterBacking:beginAnimation( "keyframe", 49, false, false, CoD.TweenType.Linear )
								end
							...
							if event.interrupted then
								...
								NotifCamoCenterBacking:beginAnimation( "keyframe", 50, false, false, CoD.TweenType.Linear )
								NotifCamoCenterBacking:setAlpha( 0.5 )
