-- c0d54cd386cc470a76e9d14d05605780
...
CoD.MPDailyContractNotification = InheritFrom( LUI.UIElement )
CoD.MPDailyContractNotification.new = function ( menu, controller )
	...
	self:setClass( CoD.MPDailyContractNotification )
	self.id = "MPDailyContractNotification"
	self.soundSet = "HUD"
	...
	NotificationWeeklyDailyWidget.NotificationWeeklyDailyTextWidget.WeeklyText:setText( Engine.Localize( "MPUI_BM_CONTRACT_DAILY" ) )
	...
	imageG:setImage( RegisterImage( "uie_t7_hud_notif_daily_challenge" ) )
	...
	imageR:setImage( RegisterImage( "uie_t7_hud_notif_daily_challenge" ) )
							...
							local NotificationWeeklyDailyWidgetFrame5 = function ( NotificationWeeklyDailyWidget, event )
								local NotificationWeeklyDailyWidgetFrame6 = function ( NotificationWeeklyDailyWidget, event )
									if not event.interrupted then
										NotificationWeeklyDailyWidget:beginAnimation( "keyframe", 139, false, false, CoD.TweenType.Linear )
									end
