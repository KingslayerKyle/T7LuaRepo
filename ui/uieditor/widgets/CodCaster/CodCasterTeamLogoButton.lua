-- a5b7f4be477cc847342cbb668150590d
...
CoD.CodCasterTeamLogoButton.new = function ( menu, controller )
	...
	unfocused:linkToElementModel( self, "ref", true, function ( model )
		...
		if ref then
			unfocused:setImage( RegisterImage( ref ) )
		end
	end )
	...
	alertIcon:setLeftRight( false, true, -19, -3 )
	alertIcon:setTopBottom( true, false, 3, 19 )
