-- 5de4a1129c2a28458fa4eee5abf40e1f
...
local f0_local0 = function ( f1_arg0, f1_arg1 )
	...
	elseif f1_local0 == "contested" then
		...
		f1_arg0.Icon.HardpointFriendly:setRGB( f1_local3.r, f1_local3.g, f1_local3.b )
	end
end
...
CoD.CodCasterHardpointWidget.new = function ( menu, controller )
	...
	Timer:setLeftRight( false, false, 18, 55 )
	Timer:setTopBottom( true, false, 9, 29 )
