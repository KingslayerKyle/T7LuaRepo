-- fb2c6c245ca59288534d2582014e05db
...
CoD.codcaster_options_button_small.new = function ( menu, controller )
	...
	BlackBox2:setLeftRight( true, false, 243, 435.02 )
	BlackBox2:setTopBottom( true, false, 3, 31 )
	...
	BlackBox:setLeftRight( true, false, 15, 234.02 )
	BlackBox:setTopBottom( true, false, 3, 31 )
	...
	BoxButtonLrgIdle:setLeftRight( true, false, 11, 236 )
	BoxButtonLrgIdle:setTopBottom( true, false, 3, 31 )
	...
	BoxButtonLrgIdle0:setLeftRight( true, false, 240.53, 436.98 )
	BoxButtonLrgIdle0:setTopBottom( true, false, 3, 31 )
	...
	StartMenuframenoBG1:setLeftRight( true, false, 240.52, 436.98 )
	StartMenuframenoBG1:setTopBottom( true, false, 1, 33 )
	self:addElement( StartMenuframenoBG1 )
	self.StartMenuframenoBG1 = StartMenuframenoBG1
	
	local StartMenuframenoBG0 = CoD.StartMenu_frame_noBG.new( menu, controller )
	StartMenuframenoBG0:setLeftRight( false, true, -436.98, -214 )
	StartMenuframenoBG0:setTopBottom( true, false, 1, 33 )
	self:addElement( StartMenuframenoBG0 )
	self.StartMenuframenoBG0 = StartMenuframenoBG0
	
	local Title = LUI.UIText.new()
	Title:setLeftRight( true, false, 24, 225 )
	Title:setTopBottom( true, false, 7, 27 )
	...
	FocusBarT:setLeftRight( true, true, 240.52, -13.02 )
	FocusBarT:setTopBottom( true, false, 2, 6 )
	...
	FocusBarB:setLeftRight( true, true, 240.52, -13.02 )
	...
	glitch:setLeftRight( true, true, 234.02, -13.02 )
	glitch:setTopBottom( true, false, -2.75, 10.75 )
	...
	glitch2:setLeftRight( true, true, 234.02, -13.02 )
	glitch2:setTopBottom( false, true, -9, 6 )
	...
	local Action = LUI.UIText.new()
	Action:setLeftRight( true, false, 254, 427 )
	Action:setTopBottom( true, false, 7, 27 )
	Action:setTTF( "fonts/RefrigeratorDeluxe-Regular.ttf" )
	Action:setLetterSpacing( 0.5 )
	Action:setAlignment( Enum.LUIAlignment.LUI_ALIGNMENT_LEFT )
	Action:setAlignment( Enum.LUIAlignment.LUI_ALIGNMENT_TOP )
	Action:linkToElementModel( self, "actionText", true, function ( model )
		local actionText = Engine.GetModelValue( model )
		if actionText then
			Action:setText( Engine.Localize( actionText ) )
		end
	end )
	...
	self:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				return IsDisabled( element, controller ) and not IsSelfModelValueTrue( element, controller, "buttonOnly" )
			end
		},
		{
			stateName = "Selected",
		...
		},
		{
			...
			condition = function ( menu, element, event )
				return IsSelfModelValueTrue( element, controller, "buttonOnly" ) and not IsDisabled( element, controller )
			end
		},
		{
