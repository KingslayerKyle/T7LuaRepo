-- c3b0b128c792e218414b78c4f7ba62f4
...
CoD.CodCasterEnemyFlagStatus = InheritFrom( LUI.UIElement )
CoD.CodCasterEnemyFlagStatus.new = function ( menu, controller )
	...
	self:setClass( CoD.CodCasterEnemyFlagStatus )
	self.id = "CodCasterEnemyFlagStatus"
	...
	ShadowGlow:setLeftRight( true, false, 220, 260 )
	...
	FriendlyFlagStatus:setLeftRight( true, false, 40, 220 )
	...
	FriendlyFlagStatus:setAlignment( Enum.LUIAlignment.LUI_ALIGNMENT_RIGHT )
	...
	FriendlyFlagCarrier:setLeftRight( true, false, 32, 228 )
	...
	FriendlyFlagCarrier:setAlignment( Enum.LUIAlignment.LUI_ALIGNMENT_RIGHT )
	...
	PlayerFlag:setLeftRight( true, false, 228, 247 )
	...
	self:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "CTF.enemyFlagAway" ), function ( model )
		menu:updateElementState( self, {
			name = "model_validation",
			menu = menu,
			modelValue = Engine.GetModelValue( model ),
