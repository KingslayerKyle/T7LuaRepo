-- 8ce3be06ccc99919a65d1a1e9b2fcba1
...
CoD.codcaster_options_slider_small = InheritFrom( LUI.UIElement )
CoD.codcaster_options_slider_small.new = function ( menu, controller )
	...
	self:setClass( CoD.codcaster_options_slider_small )
	self.id = "codcaster_options_slider_small"
	...
	Slider:setLeftRight( true, false, 260.25, 415.25 )
