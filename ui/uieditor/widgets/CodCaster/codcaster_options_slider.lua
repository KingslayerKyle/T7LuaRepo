-- 2f9fbdd1507be39e3de91acee43d6745
...
CoD.codcaster_options_slider.new = function ( menu, controller )
	...
	StartMenuframenoBG1:setLeftRight( true, false, 336.53, 544 )
	StartMenuframenoBG1:setTopBottom( true, false, 0, 32 )
	...
	Title:setLeftRight( true, false, 58, 320 )
	...
	Slider:setLeftRight( true, false, 356, 511 )
	...
	FocusBarT:setLeftRight( true, true, 39.5, -339.47 )
	...
	FocusBarB:setLeftRight( true, true, 39.5, -339.47 )
	...
	glitch:setLeftRight( true, true, 39.5, -339.47 )
	...
	glitch2:setLeftRight( true, true, 39.5, -339.47 )
	...
	self.clipsPerState = {
		DefaultState = {
			...
			GainFocus = function ()
							...
							local glitchFrame5 = function ( glitch, event )
								local glitchFrame6 = function ( glitch, event )
									local glitchFrame7 = function ( glitch, event )
										...
										glitch:setLeftRight( true, true, 330.03, -122.5 )
										glitch:setTopBottom( true, false, -3.75, 9.75 )
										glitch:setAlpha( 0 )
										glitch:setMaterial( LUI.UIImage.GetCachedMaterial( "ui_add" ) )
										if event.interrupted then
				...
				glitch:completeAnimation()
				self.glitch:setLeftRight( true, true, 330.03, -122.5 )
							...
							local glitch2Frame5 = function ( glitch2, event )
								local glitch2Frame6 = function ( glitch2, event )
									local glitch2Frame7 = function ( glitch2, event )
										...
										glitch2:setLeftRight( true, true, 330.03, -122.5 )
										glitch2:setTopBottom( false, true, -10, 5 )
										glitch2:setAlpha( 0 )
										if event.interrupted then
				...
				glitch2:completeAnimation()
				self.glitch2:setLeftRight( true, true, 330.03, -122.5 )
			...
			LoseFocus = function ()
								...
								local glitchFrame6 = function ( glitch, event )
									local glitchFrame7 = function ( glitch, event )
										local glitchFrame8 = function ( glitch, event )
											...
											glitch:setLeftRight( true, true, 330.03, -128.73 )
											glitch:setTopBottom( true, false, -3.75, 9.75 )
											glitch:setAlpha( 0 )
											if event.interrupted then
												self.clipFinished( glitch, event )
				...
				glitch:completeAnimation()
				self.glitch:setLeftRight( true, true, 330.03, -128.73 )
				self.glitch:setTopBottom( true, false, -3.75, 9.75 )
				self.glitch:setAlpha( 0 )
				glitchFrame2( glitch, {} )
				local glitch2Frame2 = function ( glitch2, event )
								...
								local glitch2Frame6 = function ( glitch2, event )
									local glitch2Frame7 = function ( glitch2, event )
										local glitch2Frame8 = function ( glitch2, event )
											...
											glitch2:setLeftRight( true, true, 330.03, -128.73 )
											glitch2:setTopBottom( false, true, -10, 5 )
											glitch2:setAlpha( 0 )
											if event.interrupted then
												self.clipFinished( glitch2, event )
				...
				glitch2:completeAnimation()
				self.glitch2:setLeftRight( true, true, 330.03, -128.73 )
				self.glitch2:setTopBottom( false, true, -10, 5 )
				self.glitch2:setAlpha( 0 )
				glitch2Frame2( glitch2, {} )
			end
	...
	LUI.OverrideFunction_CallOriginalFirst( self, "setState", function ( element, controller )
		...
		elseif not IsElementInState( element, "Selected" ) then
