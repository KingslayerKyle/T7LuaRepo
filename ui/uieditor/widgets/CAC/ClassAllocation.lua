-- 54381cb7f334b50da55ba6b7ff36c733
...
local PostLoadFunc = function ( f1_arg0, f1_arg1 )
	f1_arg0:subscribeToElementModel( f1_arg0, "allocationSpent", function ( f2_arg0 )
		UpdateAllocationBar( f1_arg0, f1_arg0.allocationSpent, f1_arg1 )
	end )
end
...
CoD.ClassAllocation.new = function ( menu, controller )
	...
	TitleNumBrdr:setLeftRight( false, true, 0, -297 )
	...
	capacityValueLabel:linkToElementModel( self, "allocationSpent", true, function ( model )
		local allocationSpent = Engine.GetModelValue( model )
		if allocationSpent then
			capacityValueLabel:setText( Engine.Localize( allocationSpent ) )
		end
	end )
	...
	LUI.OverrideFunction_CallOriginalSecond( self, "close", function ( element )
		...
		element.capacityValueLabel:close()
	end )
