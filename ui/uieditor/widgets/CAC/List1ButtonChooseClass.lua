-- ed1890391f2e0d48b137d197c0a4c1ec
	...
	RestrictedItemWarning:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				return ClassContainsRestrictedItemsLobby( menu, element, controller )
			end
		}
	} )
