-- cd79bfb577ce2c7a03c787dee85a7d31
...
CoD.WeaponAttributesBar.new = function ( menu, controller )
	...
	LUI.OverrideFunction_CallOriginalSecond( self, "close", function ( element )
		...
		element.Dash8Empty:close()
		element.Dash7Empty:close()
		element.Dash6Empty:close()
		element.Dash5Empty:close()
		element.Dash4Empty:close()
		element.Dash3Empty:close()
		element.Dash2Empty:close()
		element.Dash1Empty:close()
	end )
