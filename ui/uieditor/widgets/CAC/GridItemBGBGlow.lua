-- 8a6f28efdbff8df126368582f7fc96ff
...
CoD.GridItemBGBGlow.new = function ( menu, controller )
	...
	Purple:setLeftRight( true, true, 0, 0 )
	Purple:setTopBottom( true, true, 0, 0 )
	Purple:setAlpha( 0 )
	...
	Green:setLeftRight( true, true, 0, 0 )
	Green:setTopBottom( true, true, 0, 0 )
	Green:setAlpha( 0 )
	Green:setScale( 0.97 )
	...
	Orange:setLeftRight( true, true, 0, 0 )
	Orange:setTopBottom( true, true, 0, 0 )
