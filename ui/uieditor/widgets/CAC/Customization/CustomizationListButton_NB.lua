-- 97b7e5cd9a91b06bf43b97c4f80df22b
...
CoD.CustomizationListButton_NB.new = function ( menu, controller )
	...
	LabelButton:setLeftRight( true, false, 73, 218 )
	...
	itemImage:setTopBottom( false, false, -32, 32 )
	...
	self.LabelButton:linkToElementModel( self, "displayText", true, function ( model )
		...
		if displayText then
			LabelButton.itemName:setText( Engine.Localize( displayText ) )
		end
	end )
	self.clipsPerState = {
		DefaultState = {
