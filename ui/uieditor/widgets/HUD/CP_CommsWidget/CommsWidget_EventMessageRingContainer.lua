-- 41f4deae0bf2a5b1ed13f8bf669fd600
...
CoD.CommsWidget_EventMessageRingContainer.new = function ( menu, controller )
	...
	local CommsWidgetEventMessageRing00 = CoD.CommsWidget_EventMessageRing.new( menu, controller )
	CommsWidgetEventMessageRing00:setLeftRight( true, false, 0, 104 )
	CommsWidgetEventMessageRing00:setTopBottom( true, false, 0, 104 )
	CommsWidgetEventMessageRing00:setAlpha( 0.5 )
	CommsWidgetEventMessageRing00:setZRot( 22.53 )
	CommsWidgetEventMessageRing00:setScale( 0.9 )
	CommsWidgetEventMessageRing00:setRFTMaterial( LUI.UIImage.GetCachedMaterial( "ui_add" ) )
	self:addElement( CommsWidgetEventMessageRing00 )
	self.CommsWidgetEventMessageRing00 = CommsWidgetEventMessageRing00
		...
		DefaultState = {
			DefaultClip = function ()
				...
				local CommsWidgetEventMessageRing00Frame2 = function ( CommsWidgetEventMessageRing00, event )
					...
					CommsWidgetEventMessageRing00:setZRot( 180 )
					if event.interrupted then
						self.clipFinished( CommsWidgetEventMessageRing00, event )
					else
						CommsWidgetEventMessageRing00:registerEventHandler( "transition_complete_keyframe", self.clipFinished )
					end
				end
				
				CommsWidgetEventMessageRing00:completeAnimation()
				self.CommsWidgetEventMessageRing00:setZRot( 22.53 )
				CommsWidgetEventMessageRing00Frame2( CommsWidgetEventMessageRing00, {} )
