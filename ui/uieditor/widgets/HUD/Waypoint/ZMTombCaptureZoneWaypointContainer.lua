-- 295e8a26cb03e830cbe464c95e5d8ac9
-- This hash is used for caching, delete to decompile the file again

require( "ui.uieditor.widgets.HUD.Waypoint.ZMTombCaptureZoneWaypoint" )
...
local f0_local0 = function ( f1_arg0, f1_arg1 )
	if f1_arg1.objId then
		...
		if f1_local0.waypoint_label_default == "" then
			...
			f1_local0.WaypointText:setState( "DefaultState" )
		end
...
CoD.ZMTombCaptureZoneWaypointContainer.new = function ( menu, controller )
	...
	local Waypoint = CoD.ZMTombCaptureZoneWaypoint.new( menu, controller )
