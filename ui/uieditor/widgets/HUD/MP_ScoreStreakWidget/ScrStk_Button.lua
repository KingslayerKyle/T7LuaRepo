-- 2dee69e8bac959bb69cc60fd67a43beb
...
CoD.ScrStk_Button.new = function ( menu, controller )
	...
	menu:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_RIGHT, nil, function ( f177_arg0, f177_arg1, f177_arg2, f177_arg3 )
		if IsDpadButton( f177_arg3 ) then
			HandleScoreStreakDpadRight( self, f177_arg2 )
			return true
		else
			
		end
	end, function ( f178_arg0, f178_arg1, f178_arg2 )
		if IsDpadButton( nil ) then
			CoD.Menu.SetButtonLabel( f178_arg1, Enum.LUIButton.LUI_KEY_RIGHT, "" )
			return false
		else
			return false
		end
