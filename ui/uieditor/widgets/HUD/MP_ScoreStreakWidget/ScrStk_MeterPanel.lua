-- f5b0a70f98e3a4fb9dc119640ac58462
...
CoD.ScrStk_MeterPanel.new = function ( menu, controller )
	...
	Fill:setLeftRight( true, false, -1, 7 )
	...
	local Fill2 = LUI.UIImage.new()
	Fill2:setLeftRight( true, false, -1, 7 )
	Fill2:setTopBottom( false, false, -60, 60 )
	Fill2:setRGB( 0, 0, 0 )
	Fill2:setAlpha( 0.5 )
	Fill2:setImage( RegisterImage( "uie_t7_mp_hud_scorestreak_focusmeterfillbacker" ) )
	self:addElement( Fill2 )
	self.Fill2 = Fill2
	
	local FEButtonPanel0 = CoD.FE_ButtonPanel.new( menu, controller )
	FEButtonPanel0:setLeftRight( true, false, -4, 10 )
