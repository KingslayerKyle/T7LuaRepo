-- ff41b251b727cfa0d8eda8969898c55f
...
CoD.RoundsContainer.new = function ( menu, controller )
	...
	local Games = CoD.Games.new( menu, controller )
	Games:setLeftRight( false, false, -53.5, 53.5 )
	Games:setTopBottom( false, false, -7.13, 18.13 )
	Games:setAlpha( 0 )
	Games:setRFTMaterial( LUI.UIImage.GetCachedMaterial( "uie_aberration_no_blur" ) )
	Games:setShaderVector( 0, 0, 1, 0, 0 )
	Games:setShaderVector( 1, 0, 0, 0, 0 )
	Games:setShaderVector( 2, 0, 0, 0, 0 )
	Games:setShaderVector( 3, 0, 0, 0, 0 )
	Games:setShaderVector( 4, 0, 0, 0, 0 )
