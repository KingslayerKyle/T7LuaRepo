-- f7119ada7e4e198cac5279cc9d7e8d71
			...
			condition = function ( menu, element, event )
				...
				if f5_local0 then
					...
					if f5_local0 then
						...
						if f5_local0 then
							if not IsSplitscreenAndInGame( controller ) and not IsArenaMode() then
								f5_local0 = not IsPropHuntProp( controller )
							else
								f5_local0 = false
							end
						end
		...
		},
		{
			...
			condition = function ( menu, element, event )
				...
				if f6_local0 then
					...
					if f6_local0 then
						if not IsSplitscreenAndInGame( controller ) and not IsArenaMode() then
							f6_local0 = not IsPropHuntProp( controller )
						else
							f6_local0 = false
						end
					end
