-- ccfea75eec9bfebaafef621c40933cf5
...
CoD.CompassGroupMP.new = function ( menu, controller )
	...
	NotificationSixthSense:subscribeToGlobalModel( controller, "HUDItems", "colorBlindSensitiveEnemyScorestreakTargetColor", function ( model )
		local colorBlindSensitiveEnemyScorestreakTargetColor = Engine.GetModelValue( model )
		if colorBlindSensitiveEnemyScorestreakTargetColor then
			NotificationSixthSense:setRGB( colorBlindSensitiveEnemyScorestreakTargetColor )
		end
	end )
