-- ee35df8f652a3a66443ec471b8136fe3
-- This hash is used for caching, delete to decompile the file again

require( "ui.uieditor.widgets.HUD.core_AmmoWidget.AmmoWidget_EquipmentEmpty" )

local PostLoadFunc = function ( self, controller, menu )
	CoD.AmmoWidgetUtility.InitLethalEmptyPulse( self, self.LethalEmpty, controller, CoD.AmmoWidget_EquipmentEmpty )
end
...
CoD.AmmoWidget_EquipmentLethalItem.new = function ( menu, controller )
	...
	Lethal2b:setupUIStreamedImage( 0 )
	...
	Lethal2:setupUIStreamedImage( 0 )
	...
	Lethal3b:setAlpha( 0 )
	Lethal3b:setupUIStreamedImage( 0 )
	...
	Lethal3:setAlpha( 0 )
	Lethal3:setupUIStreamedImage( 0 )
