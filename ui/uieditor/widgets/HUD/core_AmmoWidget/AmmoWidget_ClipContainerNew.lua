-- 83a72d3de121b54391f4c136966ec1bf
...
CoD.AmmoWidget_ClipContainerNew.new = function ( menu, controller )
	...
	ClipContainerPress:subscribeToGlobalModel( controller, "CurrentWeapon", "ammoInClip", function ( model )
		local ammoInClip = Engine.GetModelValue( model )
		if ammoInClip then
			ClipContainerPress.Clip:setText( ammoInClip )
		end
	end )
