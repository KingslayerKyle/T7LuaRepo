-- 431baf07ad3474623196dc77f5a36229
...
local PreLoadFunc = function ( self, controller )
	...
	Engine.CreateModel( f1_local0, "SearchAndDestroy.defending" )
end
...
CoD.AmmoWidget_SDBomb.new = function ( menu, controller )
	...
	self:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "SearchAndDestroy.defending" ), function ( model )
		menu:updateElementState( self, {
			name = "model_validation",
			menu = menu,
			modelValue = Engine.GetModelValue( model ),
	...
	self:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_BOMB_TIMER_B ), function ( model )
		menu:updateElementState( self, {
			name = "model_validation",
			menu = menu,
			modelValue = Engine.GetModelValue( model ),
