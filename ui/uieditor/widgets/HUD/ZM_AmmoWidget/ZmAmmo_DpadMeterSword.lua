-- 788e39eb8484e2f10172a81cf3395ceb
...
CoD.ZmAmmo_DpadMeterSword.new = function ( menu, controller )
	...
	SwordRing:setRGB( 1, 0.41, 0 )
	SwordRing:setImage( RegisterImage( "uie_t7_zm_hud_ammo_dpadmtr_new" ) )
	...
	SwordRingGlow:setImage( RegisterImage( "uie_t7_zm_hud_ammo_dpadmtr_new_flash" ) )
	...
	SwordRingEdge:setImage( RegisterImage( "uie_t7_zm_hud_ammo_dpadmtr_new_edge" ) )
	...
	SwordRingEdge:setShaderVector( 3, 0.05, -0.23, 0, 0 )
			...
			DefaultClip = function ()
				...
				local AbilitySwirlFrame2 = function ( AbilitySwirl, event )
					...
					if event.interrupted then
						...
						AbilitySwirl:setRGB( 1, 0.61, 0.25 )
				...
				AbilitySwirl:completeAnimation()
				self.AbilitySwirl:setRGB( 1, 0.89, 0.51 )
				self.AbilitySwirl:setAlpha( 0 )
