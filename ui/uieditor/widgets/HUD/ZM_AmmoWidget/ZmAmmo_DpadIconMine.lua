-- 55fb455419b47818cea0cfa90026a1a2
...
CoD.ZmAmmo_DpadIconMine.new = function ( menu, controller )
	...
	IconImgMineBaseInvalid:setLeftRight( false, false, -42, 46 )
	IconImgMineBaseInvalid:setTopBottom( false, false, -71, 66 )
	IconImgMineBaseInvalid:setAlpha( 0 )
	IconImgMineBaseInvalid:setImage( RegisterImage( "uie_t7_zm_hud_ammo_nomine" ) )
	...
	IconImgMineBaseNew:setLeftRight( false, false, -43, 46 )
	IconImgMineBaseNew:setTopBottom( false, false, -71, 66 )
	IconImgMineBaseNew:setAlpha( 0 )
	IconImgMineBaseNew:setImage( RegisterImage( "uie_t7_zm_hud_ammo_newmine" ) )
	self:addElement( IconImgMineBaseNew )
	self.IconImgMineBaseNew = IconImgMineBaseNew
	
	local IconImgMineDisabled = LUI.UIImage.new()
	IconImgMineDisabled:setLeftRight( false, false, -19, 19 )
	IconImgMineDisabled:setTopBottom( false, false, -22, 15 )
	IconImgMineDisabled:setAlpha( 0 )
	IconImgMineDisabled:setImage( RegisterImage( "uie_t7_zm_hud_ammo_dpadicnmine_new_inactive" ) )
	self:addElement( IconImgMineDisabled )
	self.IconImgMineDisabled = IconImgMineDisabled
	
	local IconImgMineActive = LUI.UIImage.new()
	IconImgMineActive:setLeftRight( false, false, -19, 19 )
	IconImgMineActive:setTopBottom( false, false, -22, 15 )
	IconImgMineActive:setAlpha( 0 )
	IconImgMineActive:setImage( RegisterImage( "uie_t7_zm_hud_ammo_dpadicnmine_new" ) )
