-- d96ffb7d0eec492f3e502e30933d5446
...
local f0_local2 = function ( f6_arg0, f6_arg1, f6_arg2 )
	...
	if Dvar.ui_gametype:get() == "infect" then
		f6_local8 = f6_local7 == "MP_VICTORY_CAPS"
		f6_local9 = f6_local7 == "MP_DEFEAT_CAPS"
	end
	f6_arg0.TitleNew.isOvertime = f6_local7 == "MP_OVERTIME_CAPS"
	f6_arg0.TitleNew.KillcamText0:setText( Engine.Localize( f6_local7 ) )
	local f6_local10 = Engine.GetIString( f6_local2, "CS_LOCALIZED_STRINGS" )
	if CoD.IsShoutcaster( f6_local0 ) and f6_local10 == "MP_TEAM_ELIMINATED" then
		local f6_local11 = Enum.team_t.TEAM_AXIS
		if f6_local4 == Enum.team_t.TEAM_AXIS then
			f6_local11 = Enum.team_t.TEAM_ALLIES
		end
		f6_local10 = Engine.Localize( f6_local10, CoD.GetTeamName( f6_local11 ) )
	end
	f6_arg0.SubTitleNew.MatchText:setText( Engine.Localize( f6_local10 ) )
	local f6_local11 = Engine.GetGametypeSetting( "teamCount" )
	if f6_local11 == 2 then
		f0_local1( f6_arg0, f6_local0, f6_local4, f6_local5, f6_local8, f6_local9, f6_arg1 )
		if CoD.IsShoutcaster( f6_local0 ) and f6_local4 ~= Enum.team_t.TEAM_FREE then
			local f6_local12 = CoD.GetColorFromFormattedColorString( CoD.GetTeamFactionColor( f6_local4 ) )
			f6_arg0.TitleNew.TopFrame:setRGB( f6_local12.r, f6_local12.g, f6_local12.b )
			f6_arg0.TitleNew.CornerFrameUL:setRGB( f6_local12.r, f6_local12.g, f6_local12.b )
			f6_arg0.TitleNew.CornerFrameUR:setRGB( f6_local12.r, f6_local12.g, f6_local12.b )
			f6_arg0.TitleNew.CornerFrameLL:setRGB( f6_local12.r, f6_local12.g, f6_local12.b )
			f6_arg0.TitleNew.CornerFrameLR:setRGB( f6_local12.r, f6_local12.g, f6_local12.b )
			f6_arg0.TitleNew.LineColorLeft:setRGB( f6_local12.r, f6_local12.g, f6_local12.b )
			f6_arg0.TitleNew.LineColorRight:setRGB( f6_local12.r, f6_local12.g, f6_local12.b )
		end
		f6_arg0:playClip( "Show_Two_Team" )
	elseif f6_local11 == 1 then
		local f6_local12 = f6_arg1.data[4]
		if f6_arg0.TitleNew.KillcamText0:getText() == Engine.Localize( "MP_MATCH_TIE" ) then
			f6_arg0:playClip( "ShowFFATie" )
		else
			if f6_local12 < 3 then
				if f6_local12 < 2 then
