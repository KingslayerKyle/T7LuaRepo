-- 284112e1dd6673437b8d113edc47a5a3
-- This hash is used for caching, delete to decompile the file again

require( "ui.uieditor.widgets.Lobby.Common.FE_ButtonPanel" )

CoD.PrematchCountdown_2xpWeaponLabel = InheritFrom( LUI.UIElement )
CoD.PrematchCountdown_2xpWeaponLabel.new = function ( menu, controller )
	...
	self:setClass( CoD.PrematchCountdown_2xpWeaponLabel )
	self.id = "PrematchCountdown_2xpWeaponLabel"
