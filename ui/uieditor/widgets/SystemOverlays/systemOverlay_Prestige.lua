-- 7226b710af56e3b01390db737b609cdd
...
CoD.systemOverlay_Prestige.new = function ( menu, controller )
	...
	supportInfo:setLeftRight( true, false, 85.4, 359.4 )
	...
	largeImage:setLeftRight( true, false, 85.4, 359.4 )
	largeImage:setTopBottom( true, true, 18, -52 )
