-- d0496b931970d2c071936e18e49b2f90
...
CoD.systemOverlay_DemoCustomizeHighlightReel_Layout.new = function ( menu, controller )
	...
	backing:setTopBottom( true, false, 156, 594 )
	...
	Smokebkg:setTopBottom( true, false, 160, 562 )
	...
	frameWidget:setTopBottom( true, false, 160, 560 )
	...
	buttonBacking:setTopBottom( false, true, -158, -126 )
	...
	buttons:setTopBottom( false, true, -158, -126 )
	...
	alertStatusBar:setTopBottom( true, false, 156, 160 )
	...
	LineLeft:setTopBottom( false, true, -160, -155.85 )
