-- bd1e85fd2305d18bf7861b76da5d92b1
...
CoD.systemOverlay_DailyChallengeFrame.new = function ( menu, controller )
	...
	menu:AddButtonCallbackFunction( ChallengeButtonlist, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "N", function ( f7_arg0, f7_arg1, f7_arg2, f7_arg3 )
