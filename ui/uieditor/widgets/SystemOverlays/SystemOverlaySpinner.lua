-- 190247fde99b3edf93e912f186933a1d
...
CoD.SystemOverlaySpinner.new = function ( menu, controller )
	...
	self:setLeftRight( true, false, 0, 299 )
	self:setTopBottom( true, false, 0, 14 )
	
	local Image1 = LUI.UIImage.new()
	Image1:setLeftRight( true, false, 0, 97 )
	Image1:setTopBottom( true, false, 0, 14 )
	Image1:setRGB( 1, 0.68, 0 )
	self:addElement( Image1 )
	self.Image1 = Image1
	
	local Image10 = LUI.UIImage.new()
	Image10:setLeftRight( true, false, 101, 198 )
	Image10:setTopBottom( true, false, 0, 14 )
	...
	Image100:setLeftRight( true, false, 202, 299 )
	Image100:setTopBottom( true, false, 0, 14 )
	...
	self.clipsPerState = {
		DefaultState = {
			DefaultClip = function ()
				...
				self.Image1:setMaterial( LUI.UIImage.GetCachedMaterial( "ui_normal" ) )
				Image1Frame2( Image1, {} )
