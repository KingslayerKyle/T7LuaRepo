-- c0a92235af75ab7a1cc5acee57cc087c
-- This hash is used for caching, delete to decompile the file again

require( "ui.uieditor.widgets.HUD.ZM_FX.ZmFx_Spark2" )

CoD.BucketWidgetBucket = InheritFrom( LUI.UIElement )
CoD.BucketWidgetBucket.new = function ( menu, controller )
	local self = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc( self, controller )
	end
	self:setUseStencil( false )
	self:setClass( CoD.BucketWidgetBucket )
	self.id = "BucketWidgetBucket"
	...
	ZmFxSpark20:setLeftRight( true, true, 0, 0 )
	ZmFxSpark20:setTopBottom( true, true, -25, 0 )
	...
	PieceImageNewGreen:setLeftRight( true, true, 0, 0 )
	PieceImageNewGreen:setTopBottom( true, true, 0, 0 )
	self:addElement( PieceImageNewGreen )
	self.PieceImageNewGreen = PieceImageNewGreen
	
	local PieceImage = LUI.UIImage.new()
	PieceImage:setLeftRight( true, true, 0, 0 )
	PieceImage:setTopBottom( true, true, 0, 0 )
			...
			Found = function ()
				...
				local f3_local1 = function ( f7_arg0, f7_arg1 )
					local f7_local0 = function ( f8_arg0, f8_arg1 )
						local f8_local0 = function ( f9_arg0, f9_arg1 )
								...
								local f10_local0 = function ( f11_arg0, f11_arg1 )
									local f11_local0 = function ( f12_arg0, f12_arg1 )
										if not f12_arg1.interrupted then
											f12_arg0:beginAnimation( "keyframe", 259, false, false, CoD.TweenType.Linear )
										end
										f12_arg0:setAlpha( 0 )
									...
									if f11_arg1.interrupted then
										...
										f11_arg0:beginAnimation( "keyframe", 629, false, false, CoD.TweenType.Linear )
										f11_arg0:setAlpha( 1 )
							...
							if f9_arg1.interrupted then
								...
								f9_arg0:beginAnimation( "keyframe", 580, false, false, CoD.TweenType.Linear )
								f9_arg0:setAlpha( 1 )
					...
					if f7_arg1.interrupted then
						...
						f7_arg0:beginAnimation( "keyframe", 340, false, false, CoD.TweenType.Linear )
						f7_arg0:setAlpha( 1 )
				...
				PieceImageNewGreen:registerEventHandler( "transition_complete_keyframe", f3_local1 )
	...
	self:mergeStateConditions( {
		...
		},
		{
			stateName = "Found",
			condition = function ( menu, element, event )
				return ShowBucketPartsWidget( controller )
			end
		},
		{
			stateName = "Visible",
			condition = function ( menu, element, event )
				return ShowBucketOrSeedWidget( controller )
			end
		}
	} )
