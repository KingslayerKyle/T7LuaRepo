-- d01b451e31834e26bd54cc8e53755373
-- This hash is used for caching, delete to decompile the file again

require( "ui.uieditor.widgets.HUD.ZM_FX.ZmFx_Spark2" )

CoD.MachineToolsPieceWidget = InheritFrom( LUI.UIElement )
CoD.MachineToolsPieceWidget.new = function ( menu, controller )
	...
	self:setClass( CoD.MachineToolsPieceWidget )
	self.id = "MachineToolsPieceWidget"
		...
		},
		{
			...
			condition = function ( menu, element, event )
				...
				if not Engine.IsVisibilityBitSet( controller, Enum.UIVisibilityBit.BIT_SCOREBOARD_OPEN ) then
					f26_local0 = ShowMachineToolsPartsWidget( controller )
				else
					f26_local0 = false
				end
				return f26_local0
