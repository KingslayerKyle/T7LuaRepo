-- 5c8e382e1055502c78e6e564a1c503dd
...
CoD.ChooseCharacterLoadoutCarouselItem_Back.new = function ( menu, controller )
	...
	menu:AddButtonCallbackFunction( selectionList, controller, Enum.LUIButton.LUI_KEY_XBY_PSTRIANGLE, "P", function ( f7_arg0, f7_arg1, f7_arg2, f7_arg3 )
		if IsSelfModelValueNonEmptyString( f7_arg0, f7_arg2, "alias" ) then
			PlaySpecialistTransmission( f7_arg0, f7_arg2 )
		...
		if IsSelfModelValueNonEmptyString( f8_arg0, f8_arg2, "alias" ) then
			CoD.Menu.SetButtonLabel( f8_arg1, Enum.LUIButton.LUI_KEY_XBY_PSTRIANGLE, "" )
			return false
		else
			return false
		end
