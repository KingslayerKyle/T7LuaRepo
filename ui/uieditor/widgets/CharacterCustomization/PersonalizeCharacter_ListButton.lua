-- 29161da8b9ac1e4ee63bb3c0bb34c024
...
CoD.PersonalizeCharacter_ListButton.new = function ( menu, controller )
	...
	sizeElement:setLeftRight( true, false, 0, 335 )
	...
	categoryImage:setLeftRight( false, false, -147, 147 )
	categoryImage:setTopBottom( false, false, -49, 49 )
	categoryImage:linkToElementModel( self, "categoryImage", true, function ( model )
		local _categoryImage = Engine.GetModelValue( model )
		if _categoryImage then
			categoryImage:setImage( RegisterImage( _categoryImage ) )
		end
	end )
	...
	text:setLeftRight( true, false, 5, 330 )
	...
	text:linkToElementModel( self, "categoryName", true, function ( model )
		...
		if categoryName then
			text.text:setText( Engine.Localize( categoryName ) )
		end
	end )
	...
	breadcrumbCount:setLeftRight( false, true, -19, -1 )
	breadcrumbCount:setTopBottom( true, false, 1, 19 )
	...
	self:registerEventHandler( "gain_focus", function ( element, event )
		if element.m_focusable and element.sizeElement:processEvent( event ) then
			return true
		else
