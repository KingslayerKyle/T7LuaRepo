-- b173029762c914cd915735bb1cf9393d
...
CoD.PersonalizeCharacterCarouselItem_InfoPanel.new = function ( menu, controller )
	...
	CallsignWidget:linkToElementModel( self, "name", true, function ( model )
		...
		if name then
			CallsignWidget.weaponNameLabel:setText( Engine.Localize( name ) )
		end
	end )
	...
	LUI.OverrideFunction_CallOriginalSecond( self, "close", function ( element )
		...
		element.selectedBody:close()
		element.selectedShowcaseWeapon:close()
		element.selectedTaunt:close()
		element.CallsignWidget:close()
