-- 39916d04d2d3e1a242f2c95015a7a5d6
...
CoD.PersonalizeCharacter_ColorsList.new = function ( menu, controller )
	...
	menu:AddButtonCallbackFunction( colorsList, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f5_arg0, f5_arg1, f5_arg2, f5_arg3 )
		HeroColorsSelected( f5_arg1, f5_arg0, f5_arg2 )
		return true
	...
	self:registerEventHandler( "gain_focus", function ( element, event )
		if element.m_focusable and element.colorsList:processEvent( event ) then
			return true
		else
