-- 4c9ad6cc040d960e8796ada1732555b4
-- This hash is used for caching, delete to decompile the file again

require( "ui.uieditor.widgets.Lobby.Common.FE_ButtonPanelShaderContainer" )
require( "ui.uieditor.widgets.Lobby.Common.FE_HelpItemsLabel" )

CoD.list1ButtonNewStyle = InheritFrom( LUI.UIElement )
CoD.list1ButtonNewStyle.new = function ( menu, controller )
	local self = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc( self, controller )
	end
	self:setUseStencil( false )
	self:setClass( CoD.list1ButtonNewStyle )
	self.id = "list1ButtonNewStyle"
	...
	Glow:setLeftRight( true, true, 45, -126.01 )
	Glow:setTopBottom( false, false, -131.5, 131.5 )
