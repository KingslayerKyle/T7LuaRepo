-- 9ad6bb31190edff0236a5d207614b7f7
...
CoD.ChooseTaunts_GestureOptions.new = function ( menu, controller )
	...
	menu:AddButtonCallbackFunction( optionsList, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f8_arg0, f8_arg1, f8_arg2, f8_arg3 )
		if not IsSelfModelValueTrue( f8_arg0, f8_arg2, "isBMClassified" ) then
			GestureItemSelected( f8_arg1, f8_arg0, f8_arg2 )
	...
	menu:AddButtonCallbackFunction( optionsList, controller, Enum.LUIButton.LUI_KEY_XBY_PSTRIANGLE, "P", function ( f10_arg0, f10_arg1, f10_arg2, f10_arg3 )
		if not IsSelfModelValueTrue( f10_arg0, f10_arg2, "isBMClassified" ) and IsSelfModelValueTrue( f10_arg0, f10_arg2, "canPreview" ) then
			PreviewGesture( f10_arg2, f10_arg0 )
			PlaySoundAlias( "uin_paint_decal_nav" )
			return true
		else
		...
		CoD.Menu.SetButtonLabel( f11_arg1, Enum.LUIButton.LUI_KEY_XBY_PSTRIANGLE, "HEROES_PREVIEW_GESTURE" )
		if not IsSelfModelValueTrue( f11_arg0, f11_arg2, "isBMClassified" ) and IsSelfModelValueTrue( f11_arg0, f11_arg2, "canPreview" ) then
			return true
		else
			return false
		end
