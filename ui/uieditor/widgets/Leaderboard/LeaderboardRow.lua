-- 3cba1b31fe5781461e02ba0023d53195
...
CoD.LeaderboardRow.new = function ( menu, controller )
	...
	Position:setLeftRight( true, false, 3, 84 )
	...
	Position:linkToElementModel( self, "positionUI", true, function ( model )
		local positionUI = Engine.GetModelValue( model )
		if positionUI then
			Position:setText( Engine.Localize( positionUI ) )
		end
	end )
	...
	Rank:setLeftRight( true, false, 74, 108.72 )
	...
	Name:setTopBottom( true, false, 2.5, 22.5 )
	...
	Column0:setTTF( "fonts/RefrigeratorDeluxe-Regular.ttf" )
	...
	Column1:setTTF( "fonts/RefrigeratorDeluxe-Regular.ttf" )
	...
	Column2:setTTF( "fonts/RefrigeratorDeluxe-Regular.ttf" )
	...
	Column3:setTTF( "fonts/RefrigeratorDeluxe-Regular.ttf" )
	...
	Column4:setLeftRight( true, false, 682, 779 )
	Column4:setTopBottom( true, false, LanguageOverrideNumber( "traditionalchinese", 4, 2.5 ), LanguageOverrideNumber( "traditionalchinese", 20, 22.5 ) )
	Column4:setTTF( "fonts/RefrigeratorDeluxe-Regular.ttf" )
	...
	self.Rank:linkToElementModel( self, "rankColor", true, function ( model )
		local rankColor = Engine.GetModelValue( model )
		if rankColor then
			Rank:setRGB( rankColor )
		end
	end )
	self.clipsPerState = {
		DefaultState = {
