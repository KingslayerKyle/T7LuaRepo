-- e99f18d64731e87cbc23e9df8e11dd02
...
CoD.PaintshopColorLayerInfo.new = function ( menu, controller )
	...
	color0OpacityText:setLeftRight( true, false, 10, 147.47 )
	color0OpacityText:setTopBottom( true, false, 71.5, 90.5 )
	...
	color0OpacityValue:setLeftRight( true, false, 22, 161.5 )
	...
	layerUsedValue:setLeftRight( true, false, 5.5, 161.5 )
	...
	color1OpacityText:setLeftRight( true, false, 10, 147.47 )
	color1OpacityText:setTopBottom( true, false, 94.5, 113.5 )
	...
	color1OpacityValue:setLeftRight( true, false, 22, 161.5 )
	...
	rotationText:setLeftRight( true, false, 10, 147.47 )
	rotationText:setTopBottom( true, false, 117.5, 136.5 )
	...
	rotationValue:setLeftRight( true, false, 22, 161.5 )
	rotationValue:setTopBottom( true, false, 117.5, 136.5 )
