-- 9bd339b38701b823a0061853a45e89c7
...
CoD.GunsmithVariantItemND.new = function ( menu, controller )
	...
	variantOptionsButton:setLeftRight( true, false, 84, 104 )
	variantOptionsButton:setTopBottom( true, false, 3.5, 23.5 )
	...
	Panel0:setLeftRight( true, true, 4, -4 )
	Panel0:setTopBottom( true, true, 84, -4 )
	Panel0:setRGB( 0, 0, 0 )
	Panel0:setAlpha( 0.4 )
	...
	horizontalScrollingTextBox20pt:setTopBottom( true, false, 84, 106 )
	...
	LUI.OverrideFunction_CallOriginalSecond( self, "close", function ( element )
		...
		element.variantOptionsButton:close()
