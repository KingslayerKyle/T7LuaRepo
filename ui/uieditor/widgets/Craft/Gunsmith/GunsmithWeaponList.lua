-- aaeca363831ec9bedc02b3f8e0cab1ec
...
CoD.GunsmithWeaponList.new = function ( menu, controller )
	...
	LabelButtonCount0:setLeftRight( false, true, -76, -16 )
	...
	LabelButton0:setLeftRight( true, false, 78.5, 200.5 )
	LabelButton0:setTopBottom( true, false, 23, 43 )
