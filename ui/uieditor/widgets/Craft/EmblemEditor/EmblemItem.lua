-- 9f1f277695f6a15339afde117b3c4c2b
...
CoD.EmblemItem.new = function ( menu, controller )
	...
	BMGoldBarMed:setLeftRight( true, false, 6, 171 )
	BMGoldBarMed:setTopBottom( true, false, 42, 62 )
	BMGoldBarMed:setAlpha( 0 )
	self:addElement( BMGoldBarMed )
	self.BMGoldBarMed = BMGoldBarMed
	
	local black = LUI.UIImage.new()
	black:setLeftRight( true, false, 176, 176 )
	black:setTopBottom( true, false, 85.82, 108 )
	...
	blackMarketBrandIcon0:setLeftRight( false, false, -31.5, 32.5 )
	blackMarketBrandIcon0:setTopBottom( true, false, 20, 84 )
	...
	itemImage:linkToElementModel( self, "emblemIndex", true, function ( model )
		...
		if emblemIndex then
			itemImage:setupEmblemByEmblemIndex( GetEmblemIndexParams( controller, emblemIndex ) )
		end
	end )
	...
	LabelButton:setLeftRight( true, true, 3, -3 )
	...
	LabelButton:linkToElementModel( self, "emblemName", true, function ( model )
		...
		if emblemName then
			LabelButton.itemName:setText( emblemName )
		end
	end )
	...
	BoxButtonLrgInactiveDiag0:setShaderVector( 0, 0.13, 0.22, 0, 0 )
	...
	itemHintText:setTopBottom( false, true, 1, 31 )
	...
	hintArrow:setTopBottom( false, true, -12, -2 )
	...
	local IconNew0 = CoD.cac_LabelNew.new( menu, controller )
	IconNew0:setLeftRight( false, false, -54, 54 )
	IconNew0:setTopBottom( false, false, -11.5, 12.5 )
	IconNew0:setAlpha( 0 )
	self:addElement( IconNew0 )
	self.IconNew0 = IconNew0
	...
	self.clipsPerState = {
		DefaultState = {
			DefaultClip = function ()
				...
				IconNew0:completeAnimation()
				self.IconNew0:setAlpha( 0 )
				self.clipFinished( IconNew0, {} )
			...
			GainFocus = function ()
				...
				BoxButtonLrgIdle:beginAnimation( "keyframe", 90, false, false, CoD.TweenType.Linear )
				BoxButtonLrgIdle:setAlpha( 0.5 )
			...
			Focus = function ()
				...
				local itemHintTextFrame2 = function ( itemHintText, event )
					local itemHintTextFrame3 = function ( itemHintText, event )
						if not event.interrupted then
							itemHintText:beginAnimation( "keyframe", 240, false, false, CoD.TweenType.Linear )
						end
						itemHintText:setAlpha( 0 )
						if event.interrupted then
							self.clipFinished( itemHintText, event )
					...
					if event.interrupted then
						...
						itemHintText:beginAnimation( "keyframe", 1309, false, false, CoD.TweenType.Linear )
				...
				local hintArrowFrame2 = function ( hintArrow, event )
					local hintArrowFrame3 = function ( hintArrow, event )
						if not event.interrupted then
							hintArrow:beginAnimation( "keyframe", 240, false, false, CoD.TweenType.Linear )
						end
						hintArrow:setAlpha( 0 )
						if event.interrupted then
							self.clipFinished( hintArrow, event )
					...
					if event.interrupted then
						...
						hintArrow:beginAnimation( "keyframe", 1309, false, false, CoD.TweenType.Linear )
							...
							local FocusBorderFrame5 = function ( FocusBorder, event )
								local FocusBorderFrame6 = function ( FocusBorder, event )
									local FocusBorderFrame7 = function ( FocusBorder, event )
										local FocusBorderFrame8 = function ( FocusBorder, event )
											if not event.interrupted then
												FocusBorder:beginAnimation( "keyframe", 20, false, false, CoD.TweenType.Linear )
											end
											FocusBorder:setAlpha( 0 )
											if event.interrupted then
												self.clipFinished( FocusBorder, event )
		...
		EmptySlot = {
			DefaultClip = function ()
				...
				self.black:setLeftRight( true, false, 49.5, 127.5 )
				self.black:setTopBottom( true, false, 48.41, 52 )
		...
		BMClassified = {
			DefaultClip = function ()
				...
				self.clipFinished( BoxButtonLrgInactive, {} )
				bgImage:completeAnimation()
				self.bgImage:setLeftRight( true, true, 1, -1 )
				self.bgImage:setTopBottom( true, true, 1, -1 )
				...
				black:completeAnimation()
				self.black:setLeftRight( true, false, 60.5, 116.5 )
				self.black:setTopBottom( true, false, 47.41, 56.59 )
			...
			GainFocus = function ()
				...
				local bgImageFrame2 = function ( bgImage, event )
					if not event.interrupted then
						bgImage:beginAnimation( "keyframe", 70, false, false, CoD.TweenType.Linear )
					end
					bgImage:setAlpha( 1 )
					if event.interrupted then
				...
				local BMGoldBarMedFrame2 = function ( BMGoldBarMed, event )
					if not event.interrupted then
						BMGoldBarMed:beginAnimation( "keyframe", 70, false, false, CoD.TweenType.Linear )
					end
				...
				self.black:setAlpha( 1 )
				self.clipFinished( black, {} )
				local blackMarketBrandIcon0Frame2 = function ( blackMarketBrandIcon0, event )
					local blackMarketBrandIcon0Frame3 = function ( blackMarketBrandIcon0, event )
						if not event.interrupted then
							blackMarketBrandIcon0:beginAnimation( "keyframe", 19, false, false, CoD.TweenType.Linear )
						end
						blackMarketBrandIcon0:setAlpha( 1 )
						if event.interrupted then
							self.clipFinished( blackMarketBrandIcon0, event )
						else
							blackMarketBrandIcon0:registerEventHandler( "transition_complete_keyframe", self.clipFinished )
						end
					end
					
					if event.interrupted then
						blackMarketBrandIcon0Frame3( blackMarketBrandIcon0, event )
						return 
					else
						blackMarketBrandIcon0:beginAnimation( "keyframe", 59, false, false, CoD.TweenType.Linear )
						blackMarketBrandIcon0:setAlpha( 1 )
						blackMarketBrandIcon0:registerEventHandler( "transition_complete_keyframe", blackMarketBrandIcon0Frame3 )
					end
				end
				
				blackMarketBrandIcon0:completeAnimation()
				self.blackMarketBrandIcon0:setAlpha( 0.65 )
				blackMarketBrandIcon0Frame2( blackMarketBrandIcon0, {} )
				itemImage:completeAnimation()
				self.itemImage:setAlpha( 0 )
				self.clipFinished( itemImage, {} )
				LabelButton:completeAnimation()
			...
			LoseFocus = function ()
				...
				BoxButtonLrgInactiveFrame2( BoxButtonLrgInactive, {} )
				bgImage:completeAnimation()
				self.bgImage:setRGB( 0.11, 0.11, 0.11 )
				self.bgImage:setAlpha( 1 )
				self.clipFinished( bgImage, {} )
				local BMGoldBarMedFrame2 = function ( BMGoldBarMed, event )
					if not event.interrupted then
				...
				local blackFrame2 = function ( black, event )
					if not event.interrupted then
						black:beginAnimation( "keyframe", 79, false, false, CoD.TweenType.Linear )
					end
					black:setLeftRight( true, false, 60.5, 115.5 )
					black:setTopBottom( true, false, 47.41, 56.59 )
					black:setAlpha( 1 )
					if event.interrupted then
				...
				black:completeAnimation()
				self.black:setLeftRight( true, false, 60.5, 115.5 )
				self.black:setTopBottom( true, false, 47.41, 56.59 )
				self.black:setAlpha( 1 )
				blackFrame2( black, {} )
				local blackMarketBrandIcon0Frame2 = function ( blackMarketBrandIcon0, event )
					if not event.interrupted then
						blackMarketBrandIcon0:beginAnimation( "keyframe", 100, false, false, CoD.TweenType.Linear )
					end
					blackMarketBrandIcon0:setAlpha( 0.65 )
					if event.interrupted then
						self.clipFinished( blackMarketBrandIcon0, event )
					else
						blackMarketBrandIcon0:registerEventHandler( "transition_complete_keyframe", self.clipFinished )
			...
			GainFocus = function ()
				...
				local BoxButtonLrgInactiveFrame2 = function ( BoxButtonLrgInactive, event )
					local BoxButtonLrgInactiveFrame3 = function ( BoxButtonLrgInactive, event )
						if not event.interrupted then
							BoxButtonLrgInactive:beginAnimation( "keyframe", 9, false, false, CoD.TweenType.Linear )
						end
	...
	self:mergeStateConditions( {
		...
		},
		{
			stateName = "New",
			condition = function ( menu, element, event )
				return Emblems_IsEmblemNew( element, controller )
			end
		},
		{
			stateName = "Equipped",
