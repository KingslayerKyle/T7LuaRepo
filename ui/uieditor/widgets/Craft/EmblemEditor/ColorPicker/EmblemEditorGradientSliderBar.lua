-- 668861d361f7bc6ead5131da3aea7907
...
local f0_local0 = function ( f1_arg0, f1_arg1, f1_arg2 )
	...
	local f1_local0 = function ( f2_arg0, f2_arg1 )
		...
		return CoD.ClampColor( f2_arg1.x - f2_local0, 0, f2_local4 ) / f2_local4
	end
	
	f1_arg0:registerEventHandler( "leftmouseup", function ( element, event )
		EmblemGradient_SetGradientFill( element, element, f1_local0( element, event ), f1_arg1 )
		return true
	end )
