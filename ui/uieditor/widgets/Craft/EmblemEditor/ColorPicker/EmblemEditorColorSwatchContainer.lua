-- 43f5695a945cca06f2fcd471b77fa2a4
...
CoD.EmblemEditorColorSwatchContainer.new = function ( menu, controller )
	...
	menu:AddButtonCallbackFunction( lastSavedColor, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f5_arg0, f5_arg1, f5_arg2, f5_arg3 )
		EmblemChooseColor_SelectionChanged( self, f5_arg0, f5_arg2 )
		GoBack( self, f5_arg2 )
		return true
