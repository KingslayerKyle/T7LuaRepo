-- 082e0f2324a710a45d22ace2964e8d8e
...
CoD.TrialWidget.new = function ( menu, controller )
	...
	CompleteImage:setLeftRight( false, false, -37.5, 37.5 )
	...
	InProgressImage:setLeftRight( false, false, -37.5, 37.5 )
