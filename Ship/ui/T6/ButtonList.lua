-- e8ea9632407e64286c52687822fced2f
...
CoD.ButtonList.AddGametypeSettingLeftRightSelector = function ( f20_arg0, f20_arg1, f20_arg2, f20_arg3, f20_arg4, f20_arg5, f20_arg6, f20_arg7 )
	...
	f20_arg1:AddButtonCallbackFunction( f20_arg0, f20_arg2, Enum.LUIButton.LUI_KEY_RIGHT, nil, function ( f21_arg0, f21_arg1, f21_arg2, f21_arg3 )
		f21_arg0:handleGamepadButton( {
			button = "right",
			down = true
		} )
	...
	f20_arg1:AddButtonCallbackFunction( f20_arg0, f20_arg2, Enum.LUIButton.LUI_KEY_LEFT, nil, function ( f23_arg0, f23_arg1, f23_arg2, f23_arg3 )
		f23_arg0:handleGamepadButton( {
			button = "left",
			down = true
		} )
