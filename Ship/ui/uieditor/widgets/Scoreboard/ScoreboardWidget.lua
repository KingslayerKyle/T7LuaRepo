-- 96383587d5bb1fbd9efbc98cc06d8d8a
...
CoD.ScoreboardWidget.new = function ( menu, controller )
	...
	menu:AddButtonCallbackFunction( ScoreboardFactionScoresList, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f16_arg0, f16_arg1, f16_arg2, f16_arg3 )
	...
	self:registerEventHandler( "gain_focus", function ( element, event )
		if element.m_focusable and element.ScoreboardFactionScoresList:processEvent( event ) then
			return true
		else
