-- 8fdfb7abf49c920240babf32d69c2f45
...
CoD.Social_PlayersListButton_Offline = InheritFrom( LUI.UIElement )
CoD.Social_PlayersListButton_Offline.new = function ( menu, controller )
	...
	self:setClass( CoD.Social_PlayersListButton_Offline )
	self.id = "Social_PlayersListButton_Offline"
	...
	Socialbackground00:setLeftRight( true, false, 99.47, 374 )
	Socialbackground00:setTopBottom( true, false, 0, 59.75 )
	...
	Label0:setLeftRight( true, false, 112, 342 )
	Label0:setTopBottom( false, false, -10, 10 )
	Label0:setTTF( "fonts/default.ttf" )
	Label0:linkToElementModel( self, "gamertag", true, function ( model )
		local gamertag = Engine.GetModelValue( model )
		if gamertag then
			Label0:setText( Engine.Localize( gamertag ) )
		end
	end )
	...
	pixel:setTopBottom( true, false, -4, 4.5 )
	pixel:setAlpha( 0.15 )
	...
	pixel0:setTopBottom( false, true, -4.5, 4 )
