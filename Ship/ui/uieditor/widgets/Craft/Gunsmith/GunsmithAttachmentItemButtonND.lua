-- 55e023342faf514f241663bee73b17f2
...
CoD.GunsmithAttachmentItemButtonND = InheritFrom( LUI.UIElement )
CoD.GunsmithAttachmentItemButtonND.new = function ( menu, controller )
	...
	self:setClass( CoD.GunsmithAttachmentItemButtonND )
	self.id = "GunsmithAttachmentItemButtonND"
	...
	LabelButton:setLeftRight( true, false, 3, 104 )
			...
			Focus = function ()
				...
				local itemHintTextFrame2 = function ( itemHintText, event )
					local itemHintTextFrame3 = function ( itemHintText, event )
						if not event.interrupted then
							itemHintText:beginAnimation( "keyframe", 280, false, false, CoD.TweenType.Linear )
						end
						itemHintText:setAlpha( 0 )
						if event.interrupted then
							self.clipFinished( itemHintText, event )
				...
				local hintArrowFrame2 = function ( hintArrow, event )
					local hintArrowFrame3 = function ( hintArrow, event )
						if not event.interrupted then
							hintArrow:beginAnimation( "keyframe", 280, false, false, CoD.TweenType.Linear )
						end
						hintArrow:setAlpha( 0 )
						if event.interrupted then
							self.clipFinished( hintArrow, event )
		...
		Equipped = {
			...
			Focus = function ()
				...
				local itemHintTextFrame2 = function ( itemHintText, event )
					local itemHintTextFrame3 = function ( itemHintText, event )
						if not event.interrupted then
							itemHintText:beginAnimation( "keyframe", 260, false, false, CoD.TweenType.Linear )
						end
						itemHintText:setAlpha( 0 )
						if event.interrupted then
							self.clipFinished( itemHintText, event )
				...
				local hintArrowFrame2 = function ( hintArrow, event )
					local hintArrowFrame3 = function ( hintArrow, event )
						if not event.interrupted then
							hintArrow:beginAnimation( "keyframe", 260, false, false, CoD.TweenType.Linear )
						end
						hintArrow:setAlpha( 0 )
						if event.interrupted then
							self.clipFinished( hintArrow, event )
