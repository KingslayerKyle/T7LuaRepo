-- cd91efe56ba537952ada3989813ce2a1
			...
			Focus = function ()
				...
				local f116_local0 = function ( f117_arg0, f117_arg1 )
					if not f117_arg1.interrupted then
						f117_arg0:beginAnimation( "keyframe", 250, false, false, CoD.TweenType.Linear )
					end
				...
				itemHintText:registerEventHandler( "transition_complete_keyframe", f116_local0 )
				local f116_local1 = function ( f118_arg0, f118_arg1 )
					if not f118_arg1.interrupted then
						f118_arg0:beginAnimation( "keyframe", 250, false, false, CoD.TweenType.Linear )
					end
				...
				hintArrow:registerEventHandler( "transition_complete_keyframe", f116_local1 )
			end,
			LoseFocus = function ()
				self:setupElementClipCounter( 10 )
