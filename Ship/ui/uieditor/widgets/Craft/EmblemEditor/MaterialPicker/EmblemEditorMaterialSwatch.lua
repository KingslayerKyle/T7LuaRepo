-- 2f635cd176472ced5d3ee7f69c689a85
...
CoD.EmblemEditorMaterialSwatch.new = function ( menu, controller )
	...
	menu:AddButtonCallbackFunction( lastSavedColor, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, nil, function ( f5_arg0, f5_arg1, f5_arg2, f5_arg3 )
		GoBackToMenu( f5_arg1, f5_arg2, "EmblemEditor" )
		return true
	...
	local materialSwatch = LUI.UIList.new( menu, controller, -3, 0, nil, true, false, 0, 0, false, false )
	...
	menu:AddButtonCallbackFunction( materialSwatch, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f11_arg0, f11_arg1, f11_arg2, f11_arg3 )
		if not IsSelfModelValueTrue( f11_arg0, f11_arg2, "isBMClassified" ) then
			EmblemChooseMaterial_SelectionChanged( self, f11_arg0, f11_arg2 )
			GoBackToMenu( f11_arg1, f11_arg2, "EmblemEditor" )
			return true
		else
			
		end
	end, function ( f12_arg0, f12_arg1, f12_arg2 )
		if not IsSelfModelValueTrue( f12_arg0, f12_arg2, "isBMClassified" ) then
