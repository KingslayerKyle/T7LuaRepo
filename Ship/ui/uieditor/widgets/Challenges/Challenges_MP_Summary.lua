-- acd30a011ba57dea48a00ad2e8eba8d5
...
CoD.Challenges_MP_Summary.new = function ( menu, controller )
	...
	menu:AddButtonCallbackFunction( NearCompletionButton, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f4_arg0, f4_arg1, f4_arg2, f4_arg3 )
		if not IsElementInState( f4_arg0, "AllChallengesComplete" ) then
			OpenPopup( self, "Challenges_NearCompletion", f4_arg2, "", "" )
			return true
		else
	...
	self:registerEventHandler( "gain_focus", function ( element, event )
		if element.m_focusable and element.NearCompletionButton:processEvent( event ) then
			return true
		else
