-- e3c30774bde19610e9905b6cfe93dbe8
-- This hash is used for caching, delete to decompile the file again

require( "ui.uieditor.widgets.HUD.ZM_FX.ZmFx_Spark2" )

CoD.RagnarokPieceWidget = InheritFrom( LUI.UIElement )
CoD.RagnarokPieceWidget.new = function ( menu, controller )
	...
	self:setClass( CoD.RagnarokPieceWidget )
	self.id = "RagnarokPieceWidget"
	...
	self:mergeStateConditions( {
		...
		},
		{
			stateName = "Found",
			condition = function ( menu, element, event )
				return IsModelValueEqualTo( controller, "zmInventory.widget_gravityspike_parts", 1 )
			end
		}
	} )
