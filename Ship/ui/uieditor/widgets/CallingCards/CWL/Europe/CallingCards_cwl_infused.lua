-- fe4f88aa8f9cf3224b608bdd98ea59d2
-- This hash is used for caching, delete to decompile the file again

require( "ui.uieditor.widgets.CallingCards.CWL.CallingCards_cwl_worldmap_widget" )

CoD.CallingCards_cwl_infused = InheritFrom( LUI.UIElement )
CoD.CallingCards_cwl_infused.new = function ( menu, controller )
	...
	self:setClass( CoD.CallingCards_cwl_infused )
	self.id = "CallingCards_cwl_infused"
	...
	LOGO:setImage( RegisterImage( "uie_callingcards_cwl_infused" ) )
