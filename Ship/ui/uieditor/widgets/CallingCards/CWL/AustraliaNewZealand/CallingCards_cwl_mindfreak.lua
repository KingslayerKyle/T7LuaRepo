-- fa9e07b9e9cb9e74ec1f7bb4b77fa5fe
-- This hash is used for caching, delete to decompile the file again

require( "ui.uieditor.widgets.CallingCards.CWL.CallingCards_cwl_worldmap_widget" )

CoD.CallingCards_cwl_mindfreak = InheritFrom( LUI.UIElement )
CoD.CallingCards_cwl_mindfreak.new = function ( menu, controller )
	...
	self:setClass( CoD.CallingCards_cwl_mindfreak )
	self.id = "CallingCards_cwl_mindfreak"
	...
	LOGO:setImage( RegisterImage( "uie_callingcards_cwl_mindfreak" ) )
