-- 568b6ffe7a5987ada2518e6356c8e152
...
CoD.CommsWidget_CharacterImages.new = function ( menu, controller )
	...
	ImgCharRachel:linkToElementModel( self, "characterImage", true, function ( model )
		local characterImage = Engine.GetModelValue( model )
		if characterImage then
			ImgCharRachel:setImage( RegisterImage( characterImage ) )
		end
	end )
	...
	ImgCharRachel0:linkToElementModel( self, "characterImage", true, function ( model )
		local characterImage = Engine.GetModelValue( model )
		if characterImage then
			ImgCharRachel0:setImage( RegisterImage( characterImage ) )
		end
	end )
