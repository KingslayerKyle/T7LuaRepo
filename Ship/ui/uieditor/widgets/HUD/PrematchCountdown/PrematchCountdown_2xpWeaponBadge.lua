-- 1a91efb2fcdd4348fd4a293162bbcd7d
-- This hash is used for caching, delete to decompile the file again

CoD.PrematchCountdown_2xpWeaponBadge = InheritFrom( LUI.UIElement )
CoD.PrematchCountdown_2xpWeaponBadge.new = function ( menu, controller )
	...
	DoubleXPIcon:setImage( RegisterImage( "uie_t7_hud_mp_notifications_2xp_weapon" ) )
