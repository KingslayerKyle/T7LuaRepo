-- f4002bcd85e22591597070af507796d3
			...
			Double = function ()
				...
				local f16_local1 = function ( f18_arg0, f18_arg1 )
					if not f18_arg1.interrupted then
						f18_arg0:beginAnimation( "keyframe", 210, false, false, CoD.TweenType.Linear )
					end
					f18_arg0:setLeftRight( true, false, 4.75, 30.25 )
					f18_arg0:setTopBottom( true, false, 3.25, 28.75 )
					f18_arg0:setAlpha( 1 )
				...
				Tactical2b:registerEventHandler( "transition_complete_keyframe", f16_local1 )
			...
			Triple = function ()
				...
				local f25_local3 = function ( f29_arg0, f29_arg1 )
					if not f29_arg1.interrupted then
						f29_arg0:beginAnimation( "keyframe", 190, false, false, CoD.TweenType.Linear )
					end
					f29_arg0:setLeftRight( true, false, 1.75, 27.25 )
					f29_arg0:setTopBottom( true, false, 3.25, 28.75 )
					f29_arg0:setAlpha( 1 )
				...
				Tactical3b:registerEventHandler( "transition_complete_keyframe", f25_local3 )
