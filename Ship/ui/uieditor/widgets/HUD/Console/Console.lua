-- feb3d424c9d5cfc20cfb9ed65b8f6156
...
local PreLoadFunc = function ( self, controller )
	Engine.CreateModel( Engine.GetModelForController( controller ), "factions.isCoDCaster" )
	Engine.CreateModel( Engine.GetModelForController( controller ), "CodCaster.profileSettingsUpdated" )
end
