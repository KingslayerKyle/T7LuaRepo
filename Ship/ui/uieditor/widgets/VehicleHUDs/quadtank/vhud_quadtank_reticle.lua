-- d55e5d40cd74487155e1f811d6d66645
...
CoD.vhud_quadtank_reticle.new = function ( menu, controller )
	...
	local quadtankDamageIcon = CoD.genericVHUDdamageArea.new( menu, controller )
	quadtankDamageIcon:setLeftRight( false, false, 406.53, 506.53 )
	quadtankDamageIcon:setTopBottom( false, false, -259, -159 )
	quadtankDamageIcon:setYRot( -20 )
	quadtankDamageIcon.lineBack:setRGB( 0.49, 1, 0.74 )
	quadtankDamageIcon.lineBack:setImage( RegisterImage( "uie_t7_cp_hud_vehicle_quadtank_damageiconlinergb" ) )
	quadtankDamageIcon.fill:setImage( RegisterImage( "uie_t7_cp_hud_vehicle_quadtank_damageiconred" ) )
	quadtankDamageIcon.lineFront:setRGB( 0.49, 1, 0.74 )
	quadtankDamageIcon.lineFront:setImage( RegisterImage( "uie_t7_cp_hud_vehicle_quadtank_damageiconlinergb" ) )
	quadtankDamageIcon:linkToElementModel( self, nil, false, function ( model )
		quadtankDamageIcon:setModel( model, controller )
	end )
	self:addElement( quadtankDamageIcon )
	self.quadtankDamageIcon = quadtankDamageIcon
