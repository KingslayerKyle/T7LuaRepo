-- 8ee1b5dedb8a24f5c93a3e4f0649ca67
-- This hash is used for caching, delete to decompile the file again

require( "ui.uieditor.widgets.VehicleHUDs.mothership.vhud_ModDNITime" )

CoD.vhud_hellstorm_timebar = InheritFrom( LUI.UIElement )
CoD.vhud_hellstorm_timebar.new = function ( menu, controller )
	...
	self:setClass( CoD.vhud_hellstorm_timebar )
	self.id = "vhud_hellstorm_timebar"
