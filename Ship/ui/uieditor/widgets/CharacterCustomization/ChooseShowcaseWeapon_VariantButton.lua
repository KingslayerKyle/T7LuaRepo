-- 6e997b621460fd052bd40230ec8b8ffc
...
CoD.ChooseShowcaseWeapon_VariantButton.new = function ( menu, controller )
	...
	lockBackground:setLeftRight( true, true, 0, 0 )
	lockBackground:setTopBottom( true, true, 0, 0 )
	lockBackground:setRGB( 0.49, 0.49, 0.49 )
	...
	lockIcon:setLeftRight( true, true, 16, -16 )
	lockIcon:setTopBottom( true, true, 16, -16 )
	...
	Panel:setLeftRight( true, true, 3, -4 )
	Panel:setTopBottom( true, true, 86, -2 )
	Panel:setRGB( 0, 0, 0 )
	Panel:setAlpha( 0.4 )
	...
	horizontalScrollingTextBox20pt0:setLeftRight( true, false, 3, 104 )
	horizontalScrollingTextBox20pt0:setTopBottom( true, false, 86, 106 )
	...
	horizontalScrollingTextBox20pt0:linkToElementModel( self, nil, false, function ( model )
		horizontalScrollingTextBox20pt0:setModel( model, controller )
	end )
	horizontalScrollingTextBox20pt0:linkToElementModel( self, "variantName", true, function ( model )
		local variantName = Engine.GetModelValue( model )
		if variantName then
			horizontalScrollingTextBox20pt0.textBox:setText( variantName )
		end
	end )
	...
	self:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				return DoesWeaponVariantContainLockedAttachments( self, element, controller )
			end
		}
	} )
