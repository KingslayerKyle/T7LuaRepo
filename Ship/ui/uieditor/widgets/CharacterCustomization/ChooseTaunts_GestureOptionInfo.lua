-- 07dc3537f37270a1f4abd902b288dc38
...
CoD.ChooseTaunts_GestureOptionInfo.new = function ( menu, controller )
	...
	itemDescription.weaponDescTextBox:setText( Engine.Localize( LocalizeIntoString( "MPUI_BLACKMARKET_ITEM_CLASSIFIED_DESC", "MENU_GESTURE" ) ) )
	...
	buttonprompt0:setTopBottom( true, false, 40, 71 )
