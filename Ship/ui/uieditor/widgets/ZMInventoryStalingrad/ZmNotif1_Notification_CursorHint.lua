-- bddb017087ce51ecd9ff5a1f34488fb6
-- This hash is used for caching, delete to decompile the file again

require( "ui.uieditor.widgets.Lobby.Common.FE_ButtonPanel" )

CoD.ZmNotif1_Notification_CursorHint = InheritFrom( LUI.UIElement )
CoD.ZmNotif1_Notification_CursorHint.new = function ( menu, controller )
	...
	self:setClass( CoD.ZmNotif1_Notification_CursorHint )
	self.id = "ZmNotif1_Notification_CursorHint"
	self.soundSet = "HUD"
	...
	CursorHintText:setTopBottom( true, false, 3, 27 )
