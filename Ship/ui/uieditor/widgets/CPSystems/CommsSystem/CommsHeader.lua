-- c729c5acd6f9e89df59807dcecb5e8d3
...
CoD.CommsHeader.new = function ( menu, controller )
	...
	title:setLeftRight( true, false, 24.33, 201.33 )
	title:setTopBottom( true, false, 3.66, 19.67 )
	title:setAlpha( 0.38 )
	title:setZoom( 5 )
	title:setText( Engine.Localize( "CPUI_ACTIVE_COMMUNICATION" ) )
	...
	self.clipsPerState = {
		DefaultState = {
			...
			Add = function ()
						...
						local f5_local0 = function ( f6_arg0, f6_arg1 )
							local f6_local0 = function ( f7_arg0, f7_arg1 )
								if not f7_arg1.interrupted then
									f7_arg0:beginAnimation( "keyframe", 20, false, false, CoD.TweenType.Linear )
								end
								f7_arg0:setRGB( 0.09, 0.09, 0.13 )
							...
							if f6_arg1.interrupted then
								...
								f6_arg0:beginAnimation( "keyframe", 20, false, false, CoD.TweenType.Linear )
				...
				panel:setAlpha( 0 )
				panel:registerEventHandler( "transition_complete_keyframe", f3_local0 )
				...
				self.title:setAlpha( 0 )
				titleFrame2( title, {} )
				local f3_local3 = function ( f24_arg0, f24_arg1 )
					if not f24_arg1.interrupted then
						f24_arg0:beginAnimation( "keyframe", 280, false, false, CoD.TweenType.Linear )
					end
				...
				BarBase:setAlpha( 0 )
				BarBase:registerEventHandler( "transition_complete_keyframe", f3_local3 )
			end,
			Off = function ()
				self:setupElementClipCounter( 4 )
