-- 67ceb745282811f78f6ef52babb31548
-- This hash is used for caching, delete to decompile the file again

CoD.SpikeLuancherSpikeCounter_MeterFill3 = InheritFrom( LUI.UIElement )
CoD.SpikeLuancherSpikeCounter_MeterFill3.new = function ( menu, controller )
	...
	self:setClass( CoD.SpikeLuancherSpikeCounter_MeterFill3 )
	self.id = "SpikeLuancherSpikeCounter_MeterFill3"
	...
	Image0:setAlpha( 0.5 )
	Image0:setImage( RegisterImage( "uie_t7_cp_hud_system_spikelaunchercounter_fillmeter3" ) )
