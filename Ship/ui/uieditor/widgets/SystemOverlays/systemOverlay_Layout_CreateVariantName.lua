-- bb2612b756f60e21351247a37b002463
...
CoD.systemOverlay_Layout_CreateVariantName.new = function ( menu, controller )
	...
	menu:AddButtonCallbackFunction( input, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f9_arg0, f9_arg1, f9_arg2, f9_arg3 )
		ProcessKeyboardCompleteAction( self, f9_arg0, f9_arg2, f9_arg1 )
		return true
	...
	menu:AddButtonCallbackFunction( confirmButton, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f13_arg0, f13_arg1, f13_arg2, f13_arg3 )
		ProcessConfirmVariantNameAction( self, f13_arg0, f13_arg2, f13_arg1 )
		return true
	...
	self:registerEventHandler( "gain_focus", function ( element, event )
		if element.m_focusable and element.input:processEvent( event ) then
			return true
		else
