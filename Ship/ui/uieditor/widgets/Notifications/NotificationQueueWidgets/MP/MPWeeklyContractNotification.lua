-- c36c310cae4cc92456551d6855155a02
...
CoD.MPWeeklyContractNotification.new = function ( menu, controller )
	...
	NotificationWeeklyDailyWidget.NotificationWeeklyDailyTextWidget.WeeklyText:setText( Engine.Localize( "MPUI_BM_CONTRACT_WEEKLY" ) )
