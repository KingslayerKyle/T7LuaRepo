-- a10c6a1dcad46a722931b5041bae8957
...
CoD.SpecialistChallengeNotification.new = function ( menu, controller )
	...
	NotchPanels:setRGB( 0.16, 0.16, 0.16 )
	NotchPanels:setAlpha( 0.3 )
	...
	self.clipsPerState = {
		DefaultState = {
			...
			TimeUp = function ()
				...
				CenterShadow:setAlpha( 0.6 )
				CenterShadow:registerEventHandler( "transition_complete_keyframe", f53_local0 )
				local f53_local1 = function ( f55_arg0, f55_arg1 )
					local f55_local0 = function ( f56_arg0, f56_arg1 )
						local f56_local0 = function ( f57_arg0, f57_arg1 )
							if not f57_arg1.interrupted then
								f57_arg0:beginAnimation( "keyframe", 39, false, true, CoD.TweenType.Bounce )
							end
							f57_arg0:setAlpha( 0 )
						...
						if f56_arg1.interrupted then
							...
							f56_arg0:beginAnimation( "keyframe", 40, false, true, CoD.TweenType.Bounce )
					...
					if f55_arg1.interrupted then
						...
						f55_arg0:beginAnimation( "keyframe", 39, false, true, CoD.TweenType.Bounce )
				...
				CenterFill:setAlpha( 0.4 )
				CenterFill:registerEventHandler( "transition_complete_keyframe", f53_local1 )
				...
				SideFill:setAlpha( 0.2 )
				SideFill:registerEventHandler( "transition_complete_keyframe", f53_local2 )
				local f53_local3 = function ( f61_arg0, f61_arg1 )
				...
				SideStroke:setAlpha( 1 )
				SideStroke:registerEventHandler( "transition_complete_keyframe", f53_local3 )
				local DescBackingFrame2 = function ( DescBacking, event )
					local DescBackingFrame3 = function ( DescBacking, event )
						local DescBackingFrame4 = function ( DescBacking, event )
							if not event.interrupted then
				...
				NotifGlobalTitleLine:setAlpha( 1 )
				NotifGlobalTitleLine:registerEventHandler( "transition_complete_keyframe", f53_local6 )
				local f53_local7 = function ( f73_arg0, f73_arg1 )
				...
				NotifGlobalTitle:setAlpha( 1 )
				NotifGlobalTitle:registerEventHandler( "transition_complete_keyframe", f53_local7 )
				local f53_local8 = function ( f76_arg0, f76_arg1 )
					local f76_local0 = function ( f77_arg0, f77_arg1 )
						local f77_local0 = function ( f78_arg0, f78_arg1 )
							if not f78_arg1.interrupted then
								f78_arg0:beginAnimation( "keyframe", 40, false, true, CoD.TweenType.Bounce )
							end
							f78_arg0:setAlpha( 0 )
				...
				local f53_local9 = function ( f79_arg0, f79_arg1 )
				...
				NotchPanels:setAlpha( 0.3 )
				NotchPanels:registerEventHandler( "transition_complete_keyframe", f53_local9 )
				local f53_local10 = function ( f82_arg0, f82_arg1 )
					local f82_local0 = function ( f83_arg0, f83_arg1 )
						local f83_local0 = function ( f84_arg0, f84_arg1 )
							if not f84_arg1.interrupted then
								f84_arg0:beginAnimation( "keyframe", 40, false, true, CoD.TweenType.Bounce )
							end
							f84_arg0:setAlpha( 0 )
						...
						if f83_arg1.interrupted then
							...
							f83_arg0:beginAnimation( "keyframe", 39, false, true, CoD.TweenType.Bounce )
							f83_arg0:setAlpha( 1 )
					...
					if f82_arg1.interrupted then
						...
						f82_arg0:beginAnimation( "keyframe", 39, false, true, CoD.TweenType.Bounce )
						f82_arg0:setAlpha( 0 )
				...
				image:setAlpha( 1 )
				image:registerEventHandler( "transition_complete_keyframe", f53_local10 )
			end
		}
	}
