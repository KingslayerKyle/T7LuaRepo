-- fb260490af351d6bd210c18e15de7619
...
CoD.LoadingScreenHeaderFooter.new = function ( menu, controller )
	...
	LoadingScreenDoubleXPWidget:setLeftRight( false, true, -208, -64 )
	LoadingScreenDoubleXPWidget:setTopBottom( true, false, 12, 60 )
	...
	LUI.OverrideFunction_CallOriginalSecond( self, "close", function ( element )
		...
		element.LoadingScreenDoubleXPWidget:close()
