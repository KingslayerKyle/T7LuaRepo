-- 71609f03e67751a513bb48f1f8c5ff63
...
local f0_local1 = function ( f1_arg0, f1_arg1 )
	...
	if f1_local2 ~= CoD.OBJECTIVESTATE_ACTIVE and f1_local2 ~= CoD.OBJECTIVESTATE_CURRENT and f1_local2 ~= CoD.OBJECTIVESTATE_DONE then
		return false
	elseif not CoD.IsShoutcaster( f1_local0 ) and Engine.GetObjectiveEntity( f1_local0, f1_local1 ) == Engine.GetPredictedClientNum( f1_local0 ) then
		return false
	elseif CoD.IsShoutcaster( f1_local0 ) and CoD.ShoutcasterProfileVarBool( f1_local0, "shoutcaster_waypoint_markers" ) == false then
		return false
...
local f0_local3 = function ( f3_arg0, f3_arg1 )
	...
	elseif f3_local2 == "clean" then
		local gameTypeContainer = nil
		if f3_local1 == "clean_deposit" then
			gameTypeContainer = CoD.CleanWaypointDepositContainer.new( f3_arg0.menu, f3_local0 )
		elseif f3_local1 == "clean_carry" then
			gameTypeContainer = CoD.CleanWaypointCarryContainer.new( f3_arg0.menu, f3_local0 )
		end
...
local f0_local4 = function ( f4_arg0, f4_arg1 )
	...
	if CoD.IsShoutcaster( f4_local0 ) and CoD.ShoutcasterProfileVarBool( f4_local0, "shoutcaster_waypoint_markers" ) == false then
		f4_arg0:setAlpha( 0 )
	else
		f4_arg0:setAlpha( 1 )
	end
...
local f0_local5 = function ( f5_arg0, f5_arg1, f5_arg2 )
	f5_arg0.update = f0_local2
	f5_arg0.setupWaypoint = f0_local3
	f5_arg0.menu = f5_arg2
	f5_arg0:registerEventHandler( "visibility_update", f0_local4 )
end
