-- 41f444af77d505dad9445a2a2dad8032
	...
	self:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				local f30_local0
				if Engine.IsVisibilityBitSet( controller, Enum.UIVisibilityBit.BIT_HUD_VISIBLE ) and (Engine.IsVisibilityBitSet( controller, Enum.UIVisibilityBit.BIT_WEAPON_HUD_VISIBLE ) or IsGameTypeEqualToString( "prop" )) then
