-- ce81db98e703556da6228ce419ad667e
...
local f0_local0 = function ( f1_arg0, f1_arg1, f1_arg2 )
	...
	if f1_local1.playerUsing then
		f1_local0.waypointType = f1_arg0.waypoint_text_depositing
		f1_local0.imagecolor = CoD.GetColorSetFriendlyColor( f1_arg1, Engine.GetTeamID( f1_arg1, Engine.GetPredictedClientNum( f1_arg1 ) ) )
...
local f0_local1 = function ( f2_arg0, f2_arg1 )
	...
	if f2_local3.centerPulse then
		f2_local2.WaypointCenter:setState( "PulsingDeposit" )
	else
...
local f0_local2 = function ( f3_arg0, f3_arg1 )
	if f3_arg1.objId then
		...
		f3_local0.snapToCenterWhenContested = true
		f3_local0.snapToCenterForObjectiveTeam = true
		f3_local0.snapToCenterForOtherTeams = true
		f3_local0.updateState = false
		...
		f3_arg0.waypoint_text_depositing = Engine.StructTableLookupString( "objectives", "id", f3_local1, "waypoint_text_depositing" )
