-- ce7f83a609fe1d5afc8236c3d5a4d62e
-- This hash is used for caching, delete to decompile the file again

require( "ui.uieditor.widgets.Promo.Promo_RewardImage" )

CoD.Promo_UnlockableReward = InheritFrom( LUI.UIElement )
CoD.Promo_UnlockableReward.new = function ( menu, controller )
	...
	self:setClass( CoD.Promo_UnlockableReward )
	self.id = "Promo_UnlockableReward"
	...
	Lock:setLeftRight( true, false, 117, 206 )
	Lock:setTopBottom( true, false, 10.25, 54.75 )
	Lock:setImage( RegisterImage( "uie_t7_blackmarket_promo_meter_lock" ) )
