-- 55ff7aed42ff4f303cfb145ddc69e601
...
CoD.MedalsGridItem.new = function ( menu, controller )
	...
	BoxButtonLrgInactiveStroke:setAlpha( 0.4 )
	...
	BoxButtonLrgInactiveStroke:setShaderVector( 0, 0.09, 0.1, 0, 0 )
	...
	BoxButtonLrgInactive:setAlpha( 0.1 )
	...
	MedalImageBacking:setLeftRight( false, false, -50.58, 50.58 )
	MedalImageBacking:setTopBottom( true, false, 23.17, 124.33 )
	...
	MedalImage:setLeftRight( false, false, -50.58, 50.58 )
	MedalImage:setTopBottom( true, false, 23.17, 124.33 )
	...
	self.name:linkToElementModel( self, "medalIndex", true, function ( model )
		local medalIndex = Engine.GetModelValue( model )
		if medalIndex then
			name.name:setText( Engine.Localize( GetAARMedalName( medalIndex ) ) )
		end
	end )
	self.TimesEarned:linkToElementModel( self, "medalTimesObtained", true, function ( model )
		local medalTimesObtained = Engine.GetModelValue( model )
		if medalTimesObtained then
			TimesEarned:setAlpha( HideIfEmptyString( medalTimesObtained ) )
		end
	end )
	self.TimesEarned:linkToElementModel( self, "medalTimesObtained", true, function ( model )
		local medalTimesObtained = Engine.GetModelValue( model )
		if medalTimesObtained then
			TimesEarned.name:setText( Engine.Localize( LocalizeIntoString( "MENU_MULTIPLIER_X", medalTimesObtained ) ) )
		end
	end )
	self.clipsPerState = {
		Arabic = {
