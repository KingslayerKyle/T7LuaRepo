-- 91a2660878c7319f2fffb6b547702b38
...
CoD.SpecialistRewardsCarouselItem = InheritFrom( LUI.UIElement )
CoD.SpecialistRewardsCarouselItem.new = function ( menu, controller )
	...
	self:setClass( CoD.SpecialistRewardsCarouselItem )
	self.id = "SpecialistRewardsCarouselItem"
	self.soundSet = "HUD"
