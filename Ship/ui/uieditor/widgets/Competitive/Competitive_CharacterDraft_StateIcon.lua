-- b16f9e713f43957200ca361e512b638f
...
CoD.Competitive_CharacterDraft_StateIcon.new = function ( menu, controller )
	...
	Arrow0:setLeftRight( true, false, -4.22, 30.32 )
	...
	Arrow:setLeftRight( true, false, -4.22, 30.32 )
	...
	checkmark:setLeftRight( true, false, -5.45, 31.55 )
	...
	self.clipsPerState = {
		DefaultState = {
			...
			Choosing = function ()
				...
				Arrow0:completeAnimation()
				self.Arrow0:setLeftRight( true, false, 27, 61.54 )
				...
				Arrow:completeAnimation()
				self.Arrow:setLeftRight( true, false, 27, 61.54 )
