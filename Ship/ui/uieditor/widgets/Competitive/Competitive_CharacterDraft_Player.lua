-- 431cbf2d311cca2da686b856cc7d71cf
...
CoD.Competitive_CharacterDraft_Player.new = function ( menu, controller )
	...
	CharacterAbility:linkToElementModel( self, "characterLoadoutName", true, function ( model )
		...
		if characterLoadoutName then
			CharacterAbility:setText( Engine.Localize( characterLoadoutName ) )
		end
	end )
	...
	CharacterRender:linkToElementModel( CharacterRender, "clientState", true, function ( model )
	...
	LUI.OverrideFunction_CallOriginalSecond( self, "close", function ( element )
		...
		element.CharacterAbility:close()
		element.Rank:close()
