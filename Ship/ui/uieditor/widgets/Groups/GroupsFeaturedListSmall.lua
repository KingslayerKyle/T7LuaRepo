-- d91ef5cd3967d480f03397198087ca2d
...
local PostLoadFunc = function ( f1_arg0, f1_arg1 )
	local f1_local0 = LUI.UITimer.newElementTimer( 5000, false, function ()
...
CoD.GroupsFeaturedListSmall = InheritFrom( LUI.UIElement )
CoD.GroupsFeaturedListSmall.new = function ( menu, controller )
	...
	self:setClass( CoD.GroupsFeaturedListSmall )
	self.id = "GroupsFeaturedListSmall"
	...
	FileshareNoContentGraphic:setLeftRight( true, false, 1, 325 )
	FileshareNoContentGraphic:setTopBottom( true, false, 1, 177 )
	self:addElement( FileshareNoContentGraphic )
	self.FileshareNoContentGraphic = FileshareNoContentGraphic
	
	local contentList = LUI.UIList.new( menu, controller, 10, 500, nil, true, true, 0, 0, false, false )
	contentList:makeFocusable()
	contentList:setLeftRight( true, false, 0, 320 )
	contentList:setTopBottom( true, false, 0, 174 )
	contentList:setWidgetType( CoD.GroupsFeaturedItemSmall )
	...
	FileshareNoContent:setLeftRight( true, false, 36, 290 )
	FileshareNoContent:setTopBottom( true, false, 73.55, 103.45 )
