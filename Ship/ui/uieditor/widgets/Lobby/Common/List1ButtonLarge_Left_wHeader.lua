-- 7132fbfe7269eb9c2a56bb0c466f70c3
...
CoD.List1ButtonLarge_Left_wHeader.new = function ( menu, controller )
	...
	self:setLeftRight( true, false, 0, 365 )
	...
	FocusBarT:setLeftRight( true, true, -1.75, 1.75 )
	...
	FocusBarB:setLeftRight( true, true, -1.75, 1.75 )
	...
	f1_local10:setLeftRight( true, true, -12, 7 )
	f1_local10:setTopBottom( true, false, -8.75, 4.75 )
	f1_local10:setRGB( 1, 0.09, 0 )
	f1_local10:setAlpha( 0 )
	f1_local10:setImage( RegisterImage( "uie_t7_effect_glitches_menu10" ) )
	f1_local10:setMaterial( LUI.UIImage.GetCachedMaterial( "ui_add" ) )
	if IsPC() then
		self:addElement( f1_local10 )
	end
	self.glitch0 = f1_local10
	
	local commonButtonLabel = CoD.common_ButtonLabel_01.new( menu, controller )
	commonButtonLabel:setLeftRight( true, false, 12.82, 351.82 )
	commonButtonLabel:setTopBottom( true, false, 16, 36 )
	commonButtonLabel:linkToElementModel( self, "displayText", true, function ( model )
