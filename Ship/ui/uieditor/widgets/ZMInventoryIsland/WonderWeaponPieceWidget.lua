-- 8bb4d4bff555f6181d9a6216195913fa
-- This hash is used for caching, delete to decompile the file again

require( "ui.uieditor.widgets.HUD.ZM_FX.ZmFx_Spark2" )

CoD.WonderWeaponPieceWidget = InheritFrom( LUI.UIElement )
CoD.WonderWeaponPieceWidget.new = function ( menu, controller )
	...
	self:setClass( CoD.WonderWeaponPieceWidget )
	self.id = "WonderWeaponPieceWidget"
		...
		},
		{
			...
			condition = function ( menu, element, event )
				...
				if not Engine.IsVisibilityBitSet( controller, Enum.UIVisibilityBit.BIT_SCOREBOARD_OPEN ) then
					f26_local0 = ShowWonderWeaponPartsWidget( controller )
				else
					f26_local0 = false
				end
				return f26_local0
