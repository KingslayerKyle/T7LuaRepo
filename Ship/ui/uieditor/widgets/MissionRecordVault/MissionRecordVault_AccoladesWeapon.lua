-- 44e2a7be5588ad4bbdcaa53fd46d25c6
-- This hash is used for caching, delete to decompile the file again

CoD.MissionRecordVault_AccoladesWeapon = InheritFrom( LUI.UIElement )
CoD.MissionRecordVault_AccoladesWeapon.new = function ( menu, controller )
	...
	self:setClass( CoD.MissionRecordVault_AccoladesWeapon )
	self.id = "MissionRecordVault_AccoladesWeapon"
	...
	image:setImage( RegisterImage( "uie_weapons" ) )
