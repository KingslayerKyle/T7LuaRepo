-- 0b4daaa52ed3cbe2d85c29efb0b51848
...
function SetupTabs( f470_arg0, f470_arg1, f470_arg2 )
	f470_arg0:AddButtonCallbackFunction( f470_arg0, f470_arg2, Enum.LUIButton.LUI_KEY_LB, nil, function ( f471_arg0, f471_arg1, f471_arg2, f471_arg3 )
		if not PropertyIsTrue( f470_arg1, "m_disableNavigation" ) then
			f470_arg1:navigateItemLeft()
		end
	end, AlwaysFalse, false )
	f470_arg0:AddButtonCallbackFunction( f470_arg0, f470_arg2, Enum.LUIButton.LUI_KEY_RB, nil, function ( f472_arg0, f472_arg1, f472_arg2, f472_arg3 )
		if not PropertyIsTrue( f470_arg1, "m_disableNavigation" ) then
...
function Gunsmith_FocusCamo( f1066_arg0, f1066_arg1, f1066_arg2 )
	...
	CoD.CraftUtility.Gunsmith.DisplayWeaponWithVariant( f1066_arg2, CoD.perController[f1066_arg2].gunsmithVariantModel, false, false, false, f1066_local0 )
end
...
function Gunsmith_FocusReticle( f1069_arg0, f1069_arg1, f1069_arg2 )
	CoD.CraftUtility.Gunsmith.DisplayWeaponWithVariant( f1069_arg2, CoD.perController[f1069_arg2].gunsmithVariantModel, false, false, false, Engine.GetModelValue( Engine.GetModel( CoD.perController[f1069_arg2].gunsmithVariantModel, "camoIndex" ) ) )
end
