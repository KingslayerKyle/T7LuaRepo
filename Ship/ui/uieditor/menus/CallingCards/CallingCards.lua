-- 664ba95cc691a334fc4c74837fe8f51c
...
LUI.createMenu.CallingCards = function ( controller )
	...
	Tabs:registerEventHandler( "list_active_changed", function ( element, event )
		local f8_local0 = nil
		CallingCards_UpdateListFromTabChanged( f4_local1, element, controller )
		return f8_local0
	end )
	...
	f4_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, nil, function ( f10_arg0, f10_arg1, f10_arg2, f10_arg3 )
		...
		SetPerControllerTableProperty( f10_arg2, "currentCallingCardTabElement", nil )
		UploadStats( self, f10_arg2 )
		return true
