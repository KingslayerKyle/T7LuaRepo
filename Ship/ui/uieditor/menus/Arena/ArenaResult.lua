-- bf6b4d858763d98951126f28ae13305e
...
LUI.createMenu.ArenaResult = function ( controller )
	...
	local VignetteBack = CoD.VehicleGround_VignetteBack.new( f9_local1, controller )
	...
	local MenuFrame = CoD.GenericMenuFrame.new( f9_local1, controller )
	...
	local RankImageBorder = CoD.FE_TitleNumBrdr.new( f9_local1, controller )
	...
	local RankFrame = CoD.FE_SlideSubHeader.new( f9_local1, controller )
	...
	local PlayListBG = CoD.FE_ListHeaderGlow.new( f9_local1, controller )
	...
	local CurrentStars = LUI.UIList.new( f9_local1, controller, 2, 0, nil, false, false, 0, 0, false, false )
	...
	local CurrentRank = CoD.ArenaRankSmall.new( f9_local1, controller )
	...
	local PreviousStars = LUI.UIList.new( f9_local1, controller, 2, 0, nil, false, false, 0, 0, false, false )
	...
	local PreviousRankAdd = CoD.ArenaRankSmall.new( f9_local1, controller )
	...
	local ArenaVictory = CoD.ArenaVictory.new( f9_local1, controller )
	...
	local CurrentRankglint = CoD.ArenaRankSmall.new( f9_local1, controller )
	...
	f9_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f111_arg0, f111_arg1, f111_arg2, f111_arg3 )
		if AnyRewardsEarnedDuringMatch( f111_arg2 ) then
			GoBackAndOpenOverlayOnParent( self, "RewardsOverlay", f111_arg2 )
			return true
		else
			GoBackAndOpenOverlayOnParent( self, "MPAAR", f111_arg2 )
			return true
		end
	end, function ( f112_arg0, f112_arg1, f112_arg2 )
		CoD.Menu.SetButtonLabel( f112_arg1, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "MENU_CONTINUE" )
		return true
	end, false )
	f9_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, nil, function ( f113_arg0, f113_arg1, f113_arg2, f113_arg3 )
		if AnyRewardsEarnedDuringMatch( f113_arg2 ) then
			GoBackAndOpenOverlayOnParent( self, "RewardsOverlay", f113_arg2 )
			return true
		else
			GoBackAndOpenOverlayOnParent( self, "MPAAR", f113_arg2 )
			return true
		end
	end, function ( f114_arg0, f114_arg1, f114_arg2 )
		CoD.Menu.SetButtonLabel( f114_arg1, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, "" )
		return false
	end, false )
