-- 4a09f7d2a63c13976fc7840f2bf9666a
...
LUI.createMenu.BubblegumPackOptions = function ( controller )
	...
	local TitleGlow1 = CoD.cac_ItemTitleGlow.new( f3_local1, controller )
	...
	BubbleGumPackNameLabel:linkToElementModel( self, "bubbleGumPackName", true, function ( model )
		...
		if bubbleGumPackName then
			BubbleGumPackNameLabel:setText( bubbleGumPackName )
		end
	end )
	...
	local ElemsSideList = CoD.cac_ElemsSideList.new( f3_local1, controller )
	...
	local renameButton = CoD.List1ButtonLarge_PH.new( f3_local1, controller )
	...
	f3_local1:AddButtonCallbackFunction( renameButton, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f7_arg0, f7_arg1, f7_arg2, f7_arg3 )
		BubblegumPackOptionsRename( self, f7_arg0, f7_arg2 )
		return true
	...
	local copyButton = CoD.List1ButtonLarge_PH.new( f3_local1, controller )
	...
	f3_local1:AddButtonCallbackFunction( copyButton, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f11_arg0, f11_arg1, f11_arg2, f11_arg3 )
		OpenPopup( self, "CopyBubblegumPack", f11_arg2, "", "" )
		return true
