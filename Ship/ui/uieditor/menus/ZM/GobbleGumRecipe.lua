-- 7015da4bdb7ca712fa53a393e158509c
...
LUI.createMenu.GobbleGumRecipe = function ( controller )
	...
	local GenericMenuFrameCookbook = CoD.GenericMenuFrame_Cookbook.new( f18_local1, controller )
	...
	local GobbleGumCookbookDistillsBalance = CoD.GobbleGumCookbookDistillsBalance.new( f18_local1, controller )
	...
	local GobbleGumCookbookRemainingTime = CoD.GobbleGumCookbookRemainingTime.new( f18_local1, controller )
	...
	local IngredientList = LUI.GridLayout.new( f18_local1, controller, false, 0, 0, 31, 0, nil, nil, false, false, 0, 0, false, false )
	...
	local CookbookFlipbook0 = CoD.Cookbook_Flipbook.new( f18_local1, controller )
	...
	local CookbookIndicatorTriangleTopLeft = CoD.Cookbook_Indicator_Triangle.new( f18_local1, controller )
	...
	local CookbookIndicatorTriangleTopRight = CoD.Cookbook_Indicator_Triangle.new( f18_local1, controller )
	...
	local CookbookIndicatorTriangleBottomRight = CoD.Cookbook_Indicator_Triangle.new( f18_local1, controller )
	...
	local CookbookIndicatorTriangleBottomLeft = CoD.Cookbook_Indicator_Triangle.new( f18_local1, controller )
	...
	local CookboookResultListItem = CoD.Cookboook_ResultListItem.new( f18_local1, controller )
	...
	local PipeAnimLeft = CoD.Cookbook_Main.new( f18_local1, controller )
	...
	local PipeAnimResult = CoD.Cookbook_Main_Result.new( f18_local1, controller )
	...
	local CookbookDistillsRequired = CoD.Cookbook_Distills_Required.new( f18_local1, controller )
	...
	self:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "GobbleGumDistills.totalDistills" ), function ( model )
		...
		CoD.Menu.UpdateButtonShownState( f32_local0, f18_local1, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS )
	end )
	self:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "GobbleGumRecipeInfo.haveAllIngredients" ), function ( model )
		...
		CoD.Menu.UpdateButtonShownState( f33_local0, f18_local1, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS )
	end )
	self:registerEventHandler( "menu_opened", function ( element, event )
		local f34_local0 = nil
		if not HasSeenNewtonsCookbookFirstTimePopup( controller ) then
			OpenSystemOverlay( self, f18_local1, controller, "NewtonsCookbookWelcomePopup", "" )
		elseif HasSeenNewtonsCookbookFirstTimePopup( controller ) and CanGetFreeGobblegumCookbookUses( controller ) and IsPerControllerTablePropertyValue( controller, "came_from_lobby", true ) then
			OpenSystemOverlay( self, f18_local1, controller, "PurchaseDistills", nil )
		end
	...
	f18_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, nil, function ( f35_arg0, f35_arg1, f35_arg2, f35_arg3 )
	...
	f18_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f37_arg0, f37_arg1, f37_arg2, f37_arg3 )
		if not IsSelfInState( self, "Cooking" ) and not HasGobbleGumCookbookUses( f37_arg2 ) then
			OpenSystemOverlay( self, f37_arg1, f37_arg2, "PurchaseDistills", nil )
			return true
		elseif not IsSelfInState( self, "Cooking" ) and not HasGobbleGumCookbookIngredients( f37_arg2 ) then
			OpenSystemOverlay( self, f37_arg1, f37_arg2, "NotEnoughIngredients", "" )
			return true
		elseif not IsSelfInState( self, "Cooking" ) then
			CookGobbleGumRecipe( self, f37_arg2 )
			return true
		else
			
		end
	end, function ( f38_arg0, f38_arg1, f38_arg2 )
		CoD.Menu.SetButtonLabel( f38_arg1, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ZMUI_COOKBOOK_ACTIVATE_RECIPE" )
		if not IsSelfInState( self, "Cooking" ) and not HasGobbleGumCookbookUses( f38_arg2 ) then
			return true
		elseif not IsSelfInState( self, "Cooking" ) and not HasGobbleGumCookbookIngredients( f38_arg2 ) then
			return true
		elseif not IsSelfInState( self, "Cooking" ) then
			return true
		else
	...
	f18_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBX_PSSQUARE, "P", function ( f39_arg0, f39_arg1, f39_arg2, f39_arg3 )
		if not IsSelfInState( self, "Cooking" ) then
			OpenSystemOverlay( self, f39_arg1, f39_arg2, "PurchaseDistills", nil )
			return true
		else
			
		end
	end, function ( f40_arg0, f40_arg1, f40_arg2 )
		CoD.Menu.SetButtonLabel( f40_arg1, Enum.LUIButton.LUI_KEY_XBX_PSSQUARE, "ZMUI_COOKBOOK_BUY_DISTILLS" )
		if not IsSelfInState( self, "Cooking" ) then
			return true
		else
			return false
