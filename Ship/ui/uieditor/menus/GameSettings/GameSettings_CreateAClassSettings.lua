-- d2e7cbd06a12d35d9338eef1f4878d6f
...
local f0_local2 = function ( f4_arg0, f4_arg1, f4_arg2, f4_arg3, f4_arg4 )
	...
	CoD.perController[f4_arg2].isPreset = true
	Engine.BeginEditingPresetClass( f4_local0 )
	Engine.SetModelValue( Engine.CreateModel( Engine.GetModelForController( f4_arg2 ), "currentClassSetIndex" ), 0 )
...
LUI.createMenu.GameSettings_CreateAClassSettings = function ( controller )
	...
	local Options = CoD.GameSettings_GameModeRulesList.new( f8_local1, controller )
	...
	f8_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, nil, function ( f10_arg0, f10_arg1, f10_arg2, f10_arg3 )
