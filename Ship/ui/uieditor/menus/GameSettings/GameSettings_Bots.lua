-- 932f3ac1667971251d1755792dca2e2e
...
LUI.createMenu.GameSettings_Bots = function ( controller )
	...
	local GameSettingsBackground = CoD.GameSettings_Background.new( f6_local1, controller )
	...
	local Options = CoD.Competitive_SettingsList.new( f6_local1, controller )
	...
	f6_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, nil, function ( f10_arg0, f10_arg1, f10_arg2, f10_arg3 )
		GoBack( self, f10_arg2 )
		ClearSavedState( self, f10_arg2 )
		SetPerControllerTableProperty( f10_arg2, "disableGameSettingsOptions", nil )
		return true
