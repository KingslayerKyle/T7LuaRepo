-- 3a21e051d9aa5c253eafe40f8647a099
...
LUI.createMenu.GameSettings_EditModeSpecificOptions = function ( controller )
	...
	GameSettingsBackground.MenuFrame.titleLabel:setText( Engine.Localize( GametypeSettingsGametypeHeader( "" ) ) )
	GameSettingsBackground.MenuFrame.cac3dTitleIntermediary0.FE3dTitleContainer0.MenuTitle.TextBox1.Label0:setText( Engine.Localize( GametypeSettingsGametypeHeader( "" ) ) )
	...
	Options:setTopBottom( true, false, 134, 723 )
