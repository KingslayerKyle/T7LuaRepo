-- 78ad6e7f0481a8de5683847476fca6d7
...
DataSources.HealthAndDamageSettings = DataSourceHelpers.ListSetup( "HealthAndDamageSettings", function ( f1_arg0 )
	local f1_local0 = {}
	local f1_local1 = nil
	for f1_local5, f1_local6 in ipairs( CoD.GameOptions.HealthAndDamageSettings ) do
		f1_local1 = CoD.GameOptions.GameSettings[f1_local6]
		table.insert( f1_local0, CoD.OptionsUtility.CreateListOptions( f1_arg0, f1_local1.name, f1_local1.hintText, f1_local6, f1_local1, "HealthAndDamageSettingsOptionsList_" .. f1_local6 ) )
	end
	return f1_local0
