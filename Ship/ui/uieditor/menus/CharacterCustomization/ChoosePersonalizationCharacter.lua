-- 158c65a9337c7eda1205de94271d04fe
...
LUI.createMenu.ChoosePersonalizationCharacter = function ( controller )
	...
	local characterCarousel = LUI.UIList.new( f2_local1, controller, 4, 200, nil, false, true, 232, 0, false, false )
	...
	characterCarousel:registerEventHandler( "gain_focus", function ( element, event )
		...
		CoD.Menu.UpdateButtonShownState( element, f2_local1, controller, Enum.LUIButton.LUI_KEY_LB )
	...
	f2_local1:AddButtonCallbackFunction( characterCarousel, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f8_arg0, f8_arg1, f8_arg2, f8_arg3 )
		if not IsDisabled( f8_arg0, f8_arg2 ) then
			NavigateToMenu( self, "PersonalizeCharacter", true, f8_arg2 )
			return true
		else
	...
	f2_local1:AddButtonCallbackFunction( characterCarousel, controller, Enum.LUIButton.LUI_KEY_LB, "A", function ( f10_arg0, f10_arg1, f10_arg2, f10_arg3 )
		SelectPreviousItemIfPossible( self, f10_arg0, f10_arg2 )
		return true
	end, function ( f11_arg0, f11_arg1, f11_arg2 )
		CoD.Menu.SetButtonLabel( f11_arg1, Enum.LUIButton.LUI_KEY_LB, "" )
		return false
	end, false )
	f2_local1:AddButtonCallbackFunction( characterCarousel, controller, Enum.LUIButton.LUI_KEY_RB, "D", function ( f12_arg0, f12_arg1, f12_arg2, f12_arg3 )
		SelectNextItemIfPossible( self, f12_arg0, f12_arg2 )
		return true
	end, function ( f13_arg0, f13_arg1, f13_arg2 )
		CoD.Menu.SetButtonLabel( f13_arg1, Enum.LUIButton.LUI_KEY_RB, "" )
		return false
	end, false )
	self:addElement( characterCarousel )
	self.characterCarousel = characterCarousel
	
	local leftBumper = CoD.onOffText.new( f2_local1, controller )
	...
	local rightBumper = CoD.onOffText.new( f2_local1, controller )
	...
	local FETitleNumBrdr0 = CoD.FE_TitleNumBrdr.new( f2_local1, controller )
	...
	local PersonalizeElemsSideList = CoD.PersonalizeElemsSideList.new( f2_local1, controller )
	...
	f2_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, nil, function ( f24_arg0, f24_arg1, f24_arg2, f24_arg3 )
		return true
	end, function ( f25_arg0, f25_arg1, f25_arg2 )
		CoD.Menu.SetButtonLabel( f25_arg1, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "MENU_SELECT_CAPS" )
		return true
	end, false )
	f2_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, nil, function ( f26_arg0, f26_arg1, f26_arg2, f26_arg3 )
		ClearSavedHeroForEdits( f26_arg2 )
