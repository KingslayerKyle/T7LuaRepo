-- 7309bf3bb22e089b518d5d4ed1ed94af
...
LUI.createMenu.CombatRecordMedals = function ( controller )
	...
	local StartMenuframenoBG0 = CoD.StartMenu_frame_noBG.new( f3_local1, controller )
	...
	local FEMenuLeftGraphics0 = CoD.FE_Menu_LeftGraphics.new( f3_local1, controller )
	...
	local MedalsGrid = LUI.UIList.new( f3_local1, controller, 8, 0, nil, false, false, 0, 0, false, false )
	...
	local EmblemName = CoD.WeaponNameWidget.new( f3_local1, controller )
