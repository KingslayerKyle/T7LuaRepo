-- b8d97e2d1d6a18facc1313b2c322eb22
...
LUI.createMenu.CombatRecordZMMaps = function ( controller )
	...
	local MenuFrame = CoD.GenericMenuFrameIdentity.new( f1_local1, controller )
	...
	local HighestRound = CoD.CombatRecordStatHeader.new( f1_local1, controller )
	...
	local AverageRounds = CoD.CombatRecordStatHeader.new( f1_local1, controller )
	...
	local AverageDowns = CoD.CombatRecordStatHeader.new( f1_local1, controller )
	...
	local MapNameTitle = CoD.CombatRecordRightTitleWithBackground.new( f1_local1, controller )
