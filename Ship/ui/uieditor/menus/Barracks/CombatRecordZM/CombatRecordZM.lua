-- 03ecc86da8d64fcfa26533469ee305f8
...
LUI.createMenu.CombatRecordZM = function ( controller )
	...
	local Kills = CoD.CombatRecordSummaryStat.new( f2_local1, controller )
	...
	local RoundsSurvived = CoD.CombatRecordSummaryStat.new( f2_local1, controller )
	...
	local AvgGameScore = CoD.CombatRecordSummaryStat.new( f2_local1, controller )
	...
	local Headshots = CoD.CombatRecordSummaryStatSmall.new( f2_local1, controller )
	...
	local AvgRoundsPerGame = CoD.CombatRecordSummaryStatSmall.new( f2_local1, controller )
	...
	local SPM = CoD.CombatRecordSummaryStatSmall.new( f2_local1, controller )
	...
	local WeaponsButton = CoD.CombatRecordItemButton.new( f2_local1, controller )
	...
	f2_local1:AddButtonCallbackFunction( WeaponsButton, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f11_arg0, f11_arg1, f11_arg2, f11_arg3 )
		NavigateToMenu( self, "CombatRecordWeaponsZM", true, f11_arg2 )
		return true
	...
	local BubblegumBuffsButton = CoD.CombatRecordItemButton.new( f2_local1, controller )
	...
	f2_local1:AddButtonCallbackFunction( BubblegumBuffsButton, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f17_arg0, f17_arg1, f17_arg2, f17_arg3 )
		NavigateToMenu( self, "CombatRecordBubblegumBuffs", true, f17_arg2 )
		return true
	...
	local MapsButton = CoD.CombatRecordItemButton.new( f2_local1, controller )
	...
	f2_local1:AddButtonCallbackFunction( MapsButton, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f23_arg0, f23_arg1, f23_arg2, f23_arg3 )
		NavigateToMenu( self, "CombatRecordZMMaps", true, f23_arg2 )
		return true
	...
	local CombatRecordLineDivider1 = CoD.CombatRecord_LineDivider.new( f2_local1, controller )
	...
	local CombatRecordLineDivider2 = CoD.CombatRecord_LineDivider.new( f2_local1, controller )
	...
	local CombatRecordLineDivider = CoD.CombatRecord_LineDivider.new( f2_local1, controller )
	...
	local CombatRecordLineDivider0 = CoD.CombatRecord_LineDivider.new( f2_local1, controller )
	...
	local StartMenuframenoBG00 = CoD.StartMenu_frame_noBG.new( f2_local1, controller )
	...
	local PrestigeMasterTierWidget = CoD.Prestige_MasterTierWidget.new( f2_local1, controller )
