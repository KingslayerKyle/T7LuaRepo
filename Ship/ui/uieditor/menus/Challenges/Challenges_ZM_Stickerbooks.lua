-- 5baf5d133053f27afd733426877d4add
...
LUI.createMenu.Challenges_ZM_Stickerbooks = function ( controller )
	local self = CoD.Menu.NewForUIEditor( "Challenges_ZM_Stickerbooks" )
	if PreLoadFunc then
	...
	self.buttonModel = Engine.CreateModel( Engine.GetModelForController( controller ), "Challenges_ZM_Stickerbooks.buttonPrompts" )
	...
	FETabBar.Tabs.grid:setDataSource( "ZMChallengesTabs" )
	...
	LUI.OverrideFunction_CallOriginalSecond( self, "close", function ( element )
		...
		Engine.UnsubscribeAndFreeModel( Engine.GetModel( Engine.GetModelForController( controller ), "Challenges_ZM_Stickerbooks.buttonPrompts" ) )
	end )
