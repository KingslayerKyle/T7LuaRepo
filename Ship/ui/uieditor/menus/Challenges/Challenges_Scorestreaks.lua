-- f6cd8698baac4f6bdf24a144e1acfd53
...
LUI.createMenu.Challenges_Scorestreaks = function ( controller )
	local self = CoD.Menu.NewForUIEditor( "Challenges_Scorestreaks" )
	if PreLoadFunc then
	...
	self.buttonModel = Engine.CreateModel( Engine.GetModelForController( controller ), "Challenges_Scorestreaks.buttonPrompts" )
	...
	FETabBar.Tabs.grid:setDataSource( "ScorestreaksTabs" )
	...
	LUI.OverrideFunction_CallOriginalSecond( self, "close", function ( element )
		...
		Engine.UnsubscribeAndFreeModel( Engine.GetModel( Engine.GetModelForController( controller ), "Challenges_Scorestreaks.buttonPrompts" ) )
	end )
