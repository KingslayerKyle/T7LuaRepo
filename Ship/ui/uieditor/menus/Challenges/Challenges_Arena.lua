-- 2dbe0439881ede3438d94ecb8c88e48a
...
LUI.createMenu.Challenges_Arena = function ( controller )
	local self = CoD.Menu.NewForUIEditor( "Challenges_Arena" )
	if PreLoadFunc then
	...
	self.buttonModel = Engine.CreateModel( Engine.GetModelForController( controller ), "Challenges_Arena.buttonPrompts" )
	...
	MenuFrame.titleLabel:setText( Engine.Localize( "MENU_ARENA_CAPS" ) )
	MenuFrame.cac3dTitleIntermediary0.FE3dTitleContainer0.MenuTitle.TextBox1.Label0:setText( Engine.Localize( "MENU_ARENA_CAPS" ) )
	...
	FETabBar.Tabs.grid:setDataSource( "ArenaChallengesTabs" )
	...
	LUI.OverrideFunction_CallOriginalSecond( self, "close", function ( element )
		...
		Engine.UnsubscribeAndFreeModel( Engine.GetModel( Engine.GetModelForController( controller ), "Challenges_Arena.buttonPrompts" ) )
	end )
