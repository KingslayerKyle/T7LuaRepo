-- 1c669f610e7309c920c5134621462f39
...
LUI.createMenu.Competitive_Settings_Specialists = function ( controller )
	...
	local GameSettingsBackground = CoD.GameSettings_Background.new( f9_local1, controller )
	...
	local Options = LUI.UIList.new( f9_local1, controller, 0, 0, nil, false, false, 0, 0, false, false )
	...
	local CompetitiveSettingsSelectedItemInfo = CoD.Competitive_Settings_SelectedItemInfo.new( f9_local1, controller )
	...
	f9_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, nil, function ( f11_arg0, f11_arg1, f11_arg2, f11_arg3 )
