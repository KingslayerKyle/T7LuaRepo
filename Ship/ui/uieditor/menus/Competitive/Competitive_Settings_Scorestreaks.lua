-- 5b632ecec39bdffd4a1bee106e06f16e
...
DataSources.CompetitiveSettingsScorestreakOptions = DataSourceHelpers.ListSetup( "CompetitiveSettingsScorestreakOptions", function ( f1_arg0 )
	local f1_local0 = {}
	local f1_local1 = {}
	for f1_local2 = 0, 255, 1 do
		if Engine.ItemIndexValid( f1_local2 ) then
			local f1_local5 = Engine.GetUnlockableInfoByIndex( f1_local2 )
			if 0 <= f1_local5.allocation and LUI.startswith( f1_local5.loadoutSlot, "killstreak" ) then
				table.insert( f1_local0, CoD.OptionsUtility.CreateItemRestrictionSettings( f1_arg0, f1_local5.name, "", "CompetitiveSettings_ItemRestriction_" .. tostring( f1_local2 ), CoD.GameSettingsUtility.GetRestrictionOptions(), f1_local5.image .. "_menu_large", CoD.OptionsUtility.GametypeSettingsSetItemRestrictionState, {
					itemIndex = f1_local2
				}, function ( f2_arg0 )
	...
	table.sort( f1_local0, function ( f4_arg0, f4_arg1 )
		...
		return f4_local0.momentum < f4_local1.momentum
	end )
	return f1_local0
