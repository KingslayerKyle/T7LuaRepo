-- 4ecfaa6e502aff14b783f09a519a4753
...
LUI.createMenu.Competitive_Settings_Weapons = function ( controller )
	...
	local GameSettingsBackground = CoD.GameSettings_Background.new( f14_local1, controller )
	...
	local Options = LUI.UIList.new( f14_local1, controller, 2, 0, nil, false, false, 0, 0, false, true )
	...
	Options:registerEventHandler( "gain_focus", function ( element, event )
		...
		CoD.Menu.UpdateButtonShownState( element, f14_local1, controller, Enum.LUIButton.LUI_KEY_START )
		return f15_local0
	end )
	...
	f14_local1:AddButtonCallbackFunction( Options, controller, Enum.LUIButton.LUI_KEY_LB, nil, function ( f17_arg0, f17_arg1, f17_arg2, f17_arg3 )
		AdjustCompetitiveItemSettingsFilter( self, f17_arg0, f17_arg2, "-1" )
		return true
	end, function ( f18_arg0, f18_arg1, f18_arg2 )
		CoD.Menu.SetButtonLabel( f18_arg1, Enum.LUIButton.LUI_KEY_LB, "" )
		return false
	end, false )
	f14_local1:AddButtonCallbackFunction( Options, controller, Enum.LUIButton.LUI_KEY_RB, nil, function ( f19_arg0, f19_arg1, f19_arg2, f19_arg3 )
		AdjustCompetitiveItemSettingsFilter( self, f19_arg0, f19_arg2, "1" )
		return true
	end, function ( f20_arg0, f20_arg1, f20_arg2 )
		CoD.Menu.SetButtonLabel( f20_arg1, Enum.LUIButton.LUI_KEY_RB, "" )
		return false
	end, false )
	f14_local1:AddButtonCallbackFunction( Options, controller, Enum.LUIButton.LUI_KEY_START, "O", function ( f21_arg0, f21_arg1, f21_arg2, f21_arg3 )
	...
	local CompetitiveSettingsSelectedItemInfo = CoD.Competitive_Settings_SelectedItemInfo.new( f14_local1, controller )
	...
	local Tabs = CoD.GameSettings_TabBar.new( f14_local1, controller )
	Tabs:setLeftRight( true, false, 0, 1614 )
	Tabs:setTopBottom( true, false, 87, 125 )
	self:addElement( Tabs )
	self.Tabs = Tabs
	
	f14_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, nil, function ( f25_arg0, f25_arg1, f25_arg2, f25_arg3 )
		ForceNotifyGlobalModel( f25_arg2, "GametypeSettings.Update" )
