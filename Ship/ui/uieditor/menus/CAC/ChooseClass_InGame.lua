...
local PostLoadFunc = function ( f5_arg0, f5_arg1 )
	...
	CoD.MenuNavigation[f5_arg1] = {
		{
			"class"
		}
	}
	if IsClassSetsAvailableForCurrentGameMode() then
		f5_arg0.classSetName:setText( Engine.Localize( Engine.GetClassSetName( f5_arg1, Engine.GetCurrentClassSetIndex( f5_arg1 ) ) ) )
	end
	...
	f5_arg0:linkToElementModel( f5_arg0.ClassSetTabWidget.Internal.Tabs, nil, false, function ( model )
		if IsCACCustomClassCountDefault( f5_arg1 ) then
			...
			Engine.SetModelValue( Engine.CreateModel( Engine.GetModelForController( f5_arg1 ), "classSetValue" ), Engine.GetModelValue( Engine.GetModel( model, "classSetId" ) ) )
...
LUI.createMenu.ChooseClass_InGame = function ( controller )
	...
	f7_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, nil, function ( f28_arg0, f28_arg1, f28_arg2, f28_arg3 )
	...
	f7_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBY_PSTRIANGLE, "C", function ( f30_arg0, f30_arg1, f30_arg2, f30_arg3 )
		if IsCampaign() and not IsMulticoreActivated( f30_arg2 ) and not IsCybercoreMenuDisabled( f30_arg2 ) then
		...
		if IsCampaign() and not IsMulticoreActivated( f31_arg2 ) and not IsCybercoreMenuDisabled( f31_arg2 ) then
	...
	f7_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_LB, nil, function ( f32_arg0, f32_arg1, f32_arg2, f32_arg3 )
	...
	f7_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_RB, nil, function ( f34_arg0, f34_arg1, f34_arg2, f34_arg3 )
