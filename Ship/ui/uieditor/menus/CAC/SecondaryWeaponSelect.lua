-- 574b487ba276e9b4828e9ea455654e78
	...
	self.restoreState = function ( f2_arg0 )
		...
		if f2_local4 then
			...
			if f2_local6 then
				...
				if f2_local5 == "weapon_wrench" or f2_local5 == "weapon_knuckles" then
					f2_local5 = "weapon_knife"
				end
...
LUI.createMenu.SecondaryWeaponSelect = function ( controller )
	...
	weaponList:linkToElementModel( weaponList, "ref", true, function ( model )
		...
		CoD.Menu.UpdateButtonShownState( f13_local0, f7_local1, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS )
	end )
	...
	f7_local1:AddButtonCallbackFunction( weaponList, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f17_arg0, f17_arg1, f17_arg2, f17_arg3 )
		if not IsCACItemLocked( f17_arg1, f17_arg0, f17_arg2 ) and not IsCACItemPurchased( f17_arg0, f17_arg2 ) and not IsCACHaveTokens( f17_arg2 ) and not IsSelfModelValueTrue( f17_arg0, f17_arg2, "isBMClassified" ) and not IsCACItemContractLocked( f17_arg0, f17_arg2 ) then
			SetUnlockConfirmationInfo( f17_arg0, f17_arg2 )
			OpenPopup( self, "OutOfUnlockTokens", f17_arg2, "", "" )
			return true
		elseif not IsCACItemLocked( f17_arg1, f17_arg0, f17_arg2 ) and not IsCACItemPurchased( f17_arg0, f17_arg2 ) and IsCACHaveTokens( f17_arg2 ) and not IsSelfModelValueTrue( f17_arg0, f17_arg2, "isBMClassified" ) and not IsCACItemContractLocked( f17_arg0, f17_arg2 ) then
			OpenUnlockClassItemDialog( f17_arg1, f17_arg0, f17_arg2 )
			return true
		elseif not IsCACItemLocked( f17_arg1, f17_arg0, f17_arg2 ) and IsCACItemPurchased( f17_arg0, f17_arg2 ) and IsCACWeaponVariantAvailable( f17_arg0, f17_arg2 ) and not IsSelfModelValueTrue( f17_arg0, f17_arg2, "isBMClassified" ) and not IsCACItemContractLocked( f17_arg0, f17_arg2 ) then
			...
			return true
		elseif not IsCACItemLocked( f17_arg1, f17_arg0, f17_arg2 ) and not IsSelfModelValueTrue( f17_arg0, f17_arg2, "isBMClassified" ) and not IsCACItemContractLocked( f17_arg0, f17_arg2 ) then
		...
		if not IsCACItemLocked( f18_arg1, f18_arg0, f18_arg2 ) and not IsCACItemPurchased( f18_arg0, f18_arg2 ) and not IsCACHaveTokens( f18_arg2 ) and not IsSelfModelValueTrue( f18_arg0, f18_arg2, "isBMClassified" ) and not IsCACItemContractLocked( f18_arg0, f18_arg2 ) then
			return true
		elseif not IsCACItemLocked( f18_arg1, f18_arg0, f18_arg2 ) and not IsCACItemPurchased( f18_arg0, f18_arg2 ) and IsCACHaveTokens( f18_arg2 ) and not IsSelfModelValueTrue( f18_arg0, f18_arg2, "isBMClassified" ) and not IsCACItemContractLocked( f18_arg0, f18_arg2 ) then
			return true
		elseif not IsCACItemLocked( f18_arg1, f18_arg0, f18_arg2 ) and IsCACItemPurchased( f18_arg0, f18_arg2 ) and IsCACWeaponVariantAvailable( f18_arg0, f18_arg2 ) and not IsSelfModelValueTrue( f18_arg0, f18_arg2, "isBMClassified" ) and not IsCACItemContractLocked( f18_arg0, f18_arg2 ) then
			return true
		elseif not IsCACItemLocked( f18_arg1, f18_arg0, f18_arg2 ) and not IsSelfModelValueTrue( f18_arg0, f18_arg2, "isBMClassified" ) and not IsCACItemContractLocked( f18_arg0, f18_arg2 ) then
			return true
		else
			return false
		end
	...
	self.clipsPerState = {
		...
		ShowVariants = {
			...
			DefaultState = function ()
				...
				self.LeftPanel:setTopBottom( true, true, 78, -53 )
				LeftPanelFrame2( LeftPanel, {} )
				local f50_local1 = function ( f52_arg0, f52_arg1 )
					if not f52_arg1.interrupted then
						f52_arg0:beginAnimation( "keyframe", 100, false, false, CoD.TweenType.Linear )
					end
					f52_arg0:setAlpha( 1 )
				...
				CategoryListPanel:beginAnimation( "keyframe", 100, false, false, CoD.TweenType.Linear )
				CategoryListPanel:setAlpha( 0 )
				CategoryListPanel:registerEventHandler( "transition_complete_keyframe", f50_local1 )
				local f50_local2 = function ( f53_arg0, f53_arg1 )
				...
				weaponList:beginAnimation( "keyframe", 100, false, false, CoD.TweenType.Linear )
				weaponList:setAlpha( 0 )
				weaponList:registerEventHandler( "transition_complete_keyframe", f50_local2 )
				local variantListFrame2 = function ( variantList, event )
					local variantListFrame3 = function ( variantList, event )
						if not event.interrupted then
							variantList:beginAnimation( "keyframe", 100, false, false, CoD.TweenType.Linear )
				...
				self.attachmentList:setAlpha( 1 )
				attachmentListFrame2( attachmentList, {} )
				local f50_local5 = function ( f58_arg0, f58_arg1 )
					if not f58_arg1.interrupted then
						f58_arg0:beginAnimation( "keyframe", 100, false, false, CoD.TweenType.Linear )
					end
					f58_arg0:setAlpha( 1 )
				...
				weaponCategoryList:beginAnimation( "keyframe", 100, false, false, CoD.TweenType.Linear )
				weaponCategoryList:setAlpha( 0 )
				weaponCategoryList:registerEventHandler( "transition_complete_keyframe", f50_local5 )
				local categoryNameFrame2 = function ( categoryName, event )
					if not event.interrupted then
						categoryName:beginAnimation( "keyframe", 200, false, false, CoD.TweenType.Linear )
					end
	...
	self:subscribeToModel( Engine.GetModel( Engine.GetGlobalModel(), "WGSV_Category" ), function ( model )
		...
		CoD.Menu.UpdateButtonShownState( f60_local0, f7_local1, controller, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE )
	end )
	...
	f7_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, nil, function ( f62_arg0, f62_arg1, f62_arg2, f62_arg3 )
		if IsGlobalModelValueEqualTo( f62_arg0, f62_arg2, "WGSV_Category", CoD.WGSV_Category.WEAPON ) then
			GoBack( self, f62_arg2 )
		...
		CoD.Menu.SetButtonLabel( f63_arg1, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, "MENU_BACK" )
		return true
	end, false )
	f7_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_RSTICK_PRESSED, nil, function ( f64_arg0, f64_arg1, f64_arg2, f64_arg3 )
		return true
	end, function ( f65_arg0, f65_arg1, f65_arg2 )
		CoD.Menu.SetButtonLabel( f65_arg1, Enum.LUIButton.LUI_KEY_RSTICK_PRESSED, "PLATFORM_EMBLEM_ROTATE_LAYER" )
		return true
	end, false )
