-- 6bc3e5b58388039046054f6e40a82327
...
LUI.createMenu.PrimaryOpticSelect = function ( controller )
	...
	f4_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, nil, function ( f22_arg0, f22_arg1, f22_arg2, f22_arg3 )
		GoBack( self, f22_arg2 )
		PlaySoundSetSound( self, "menu_no_selection" )
		GetCustomClassModel( f22_arg2 )
		return true
	end, function ( f23_arg0, f23_arg1, f23_arg2 )
		CoD.Menu.SetButtonLabel( f23_arg1, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, "MENU_BACK" )
		return true
	end, false )
	f4_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_RSTICK_PRESSED, nil, function ( f24_arg0, f24_arg1, f24_arg2, f24_arg3 )
