-- 0b76a4aea4199d8903600af61fa9710b
...
LUI.createMenu.Credit_Fullscreen = function ( controller )
	...
	ImageWithButtonPrompt:registerEventHandler( "gain_focus", function ( element, event )
		...
		CoD.Menu.UpdateButtonShownState( element, f16_local1, controller, Enum.LUIButton.LUI_KEY_PCKEY_0 )
		return f17_local0
	end )
	...
	f16_local1:AddButtonCallbackFunction( ImageWithButtonPrompt, controller, Enum.LUIButton.LUI_KEY_PCKEY_0, nil, function ( f19_arg0, f19_arg1, f19_arg2, f19_arg3 )
	...
	local skipPrompt = CoD.FadingSkipPrompt.new( f16_local1, controller )
	...
	local speedUpPrompt = CoD.FadingSkipPrompt.new( f16_local1, controller )
	...
	local speedUpPromptMouse = CoD.FadingSkipPrompt.new( f16_local1, controller )
	...
	if self.m_eventHandlers.input_source_changed then
		...
		self:registerEventHandler( "input_source_changed", function ( element, event )
			event.menu = event.menu or f16_local1
			element:updateState( event )
			return f16_local7( element, event )
		end )
	else
		self:registerEventHandler( "input_source_changed", LUI.UIElement.updateState )
	end
	self:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "LastInput" ), function ( model )
		f16_local1:updateElementState( self, {
