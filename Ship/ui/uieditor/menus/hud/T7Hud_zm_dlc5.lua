-- 1d1bf1fce21758b3826b98d64996fc65
...
LUI.createMenu.T7Hud_zm_dlc5 = function ( controller )
	...
	local ZMBeastBar = CoD.ZM_BeastmodeTimeBarWidget.new( f3_local1, controller )
	...
	local BubbleGumPackInGame = CoD.BubbleGumPackInGame.new( f3_local1, controller )
	...
	local SidequestIconInventoryWidget = CoD.SidequestIconInventoryWidget.new( f3_local1, controller )
	...
	local SidequestNotificationList = LUI.GridLayout.new( f3_local1, controller, false, 0, 0, 2, 0, nil, nil, false, false, 0, 0, false, false )
