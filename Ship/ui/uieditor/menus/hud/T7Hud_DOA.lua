-- 898804b49e1ab933176a1268d96fe99c
...
LUI.createMenu.T7Hud_DOA = function ( controller )
	...
	local bezel = CoD.fullscreen.new( f9_local1, controller )
	...
	local score0 = CoD.score.new( f9_local1, controller )
	...
	score0:linkToElementModel( score0, "name", true, function ( model )
		f9_local1:updateElementState( score0, {
	...
	local score1 = CoD.score.new( f9_local1, controller )
	...
	score1:linkToElementModel( score1, "name", true, function ( model )
		f9_local1:updateElementState( score1, {
			name = "model_validation",
			menu = f9_local1,
			modelValue = Engine.GetModelValue( model ),
			modelName = "name"
	...
	local score2 = CoD.score_lower.new( f9_local1, controller )
	...
	score2:linkToElementModel( score2, "name", true, function ( model )
		f9_local1:updateElementState( score2, {
			name = "model_validation",
			menu = f9_local1,
			modelValue = Engine.GetModelValue( model ),
			modelName = "name"
	...
	local score3 = CoD.score_lower.new( f9_local1, controller )
	...
	score3:linkToElementModel( score3, "name", true, function ( model )
		f9_local1:updateElementState( score3, {
			name = "model_validation",
			menu = f9_local1,
			modelValue = Engine.GetModelValue( model ),
			modelName = "name"
	...
	local firstplace0 = CoD.firstplace.new( f9_local1, controller )
	...
	firstplace0:linkToElementModel( firstplace0, "ribbon", true, function ( model )
		f9_local1:updateElementState( firstplace0, {
			name = "model_validation",
			menu = f9_local1,
			modelValue = Engine.GetModelValue( model ),
			modelName = "ribbon"
	...
	local firstplace1 = CoD.firstplace.new( f9_local1, controller )
	...
	firstplace1:linkToElementModel( firstplace1, "ribbon", true, function ( model )
		f9_local1:updateElementState( firstplace1, {
			name = "model_validation",
			menu = f9_local1,
			modelValue = Engine.GetModelValue( model ),
			modelName = "ribbon"
	...
	local firstplace2 = CoD.firstplace.new( f9_local1, controller )
	...
	firstplace2:linkToElementModel( firstplace2, "ribbon", true, function ( model )
		f9_local1:updateElementState( firstplace2, {
			name = "model_validation",
			menu = f9_local1,
			modelValue = Engine.GetModelValue( model ),
			modelName = "ribbon"
	...
	local firstplace3 = CoD.firstplace.new( f9_local1, controller )
	...
	firstplace3:linkToElementModel( firstplace3, "ribbon", true, function ( model )
		f9_local1:updateElementState( firstplace3, {
			name = "model_validation",
			menu = f9_local1,
			modelValue = Engine.GetModelValue( model ),
			modelName = "ribbon"
	...
	local redinsHUD0 = CoD.redinsHUD.new( f9_local1, controller )
	...
	redinsHUD0:linkToElementModel( redinsHUD0, "redins", true, function ( model )
		f9_local1:updateElementState( redinsHUD0, {
			name = "model_validation",
			menu = f9_local1,
			modelValue = Engine.GetModelValue( model ),
			modelName = "redins"
	...
	local genericbanner = CoD.generic_banner_wbar.new( f9_local1, controller )
	...
	genericbanner:linkToElementModel( genericbanner, "gbanner", true, function ( model )
		f9_local1:updateElementState( genericbanner, {
			name = "model_validation",
			menu = f9_local1,
			modelValue = Engine.GetModelValue( model ),
			modelName = "gbanner"
	...
	local countbox = CoD.countbox.new( f9_local1, controller )
	...
	countbox:linkToElementModel( countbox, "countdown", true, function ( model )
		f9_local1:updateElementState( countbox, {
			name = "model_validation",
			menu = f9_local1,
			modelValue = Engine.GetModelValue( model ),
			modelName = "countdown"
	...
	local ScoreboardWidgetCP = CoD.ScoreboardWidgetCP.new( f9_local1, controller )
	...
	local fullscreenContainer = CoD.DynamicContainerWidget.new( f9_local1, controller )
	...
	local IngameChatClientContainer = CoD.IngameChatClientContainer.new( f9_local1, controller )
	...
	local roundTxt0 = CoD.round.new( f9_local1, controller )
	...
	roundTxt0:linkToElementModel( roundTxt0, "round", true, function ( model )
		f9_local1:updateElementState( roundTxt0, {
			name = "model_validation",
			menu = f9_local1,
			modelValue = Engine.GetModelValue( model ),
			modelName = "round"
	...
	local survived0 = CoD.survived.new( f9_local1, controller )
	...
	survived0:linkToElementModel( survived0, "gameover", true, function ( model )
		f9_local1:updateElementState( survived0, {
			name = "model_validation",
			menu = f9_local1,
			modelValue = Engine.GetModelValue( model ),
			modelName = "gameover"
	...
	local choosepath0 = CoD.choosepath.new( f9_local1, controller )
	...
	choosepath0:linkToElementModel( choosepath0, "numexits", true, function ( model )
		f9_local1:updateElementState( choosepath0, {
			name = "model_validation",
			menu = f9_local1,
			modelValue = Engine.GetModelValue( model ),
			modelName = "numexits"
	...
	local teleporter0 = CoD.teleporter.new( f9_local1, controller )
	...
	teleporter0:linkToElementModel( teleporter0, "teleporter", true, function ( model )
		f9_local1:updateElementState( teleporter0, {
			name = "model_validation",
			menu = f9_local1,
			modelValue = Engine.GetModelValue( model ),
