-- bc2b4010554ec1bbb9d3318ca3d06f0f
...
LUI.createMenu.StartMenu_Options_GraphicContent = function ( controller )
	...
	local StartMenuOptionHighlight = CoD.StartMenu_OptionHighlight.new( f8_local1, controller )
	...
	local StartMenuOptionIconContainer = CoD.StartMenu_Option_IconContainer.new( f8_local1, controller )
