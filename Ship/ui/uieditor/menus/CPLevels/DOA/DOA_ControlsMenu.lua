-- 46c7555fc70afd15226d88b5519e3e63
...
LUI.createMenu.DOA_ControlsMenu = function ( controller )
	...
	local DOAControlHelp0 = CoD.DOA_ControlHelp.new( f1_local1, controller )
	...
	local DOAControlKBMouse = CoD.DOA_ControlKBMouse.new( f1_local1, controller )
