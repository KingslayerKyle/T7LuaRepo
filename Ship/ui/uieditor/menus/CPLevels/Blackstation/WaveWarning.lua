-- fb71ee36004b4a5ae74255098be06f76
-- This hash is used for caching, delete to decompile the file again

LUI.createMenu.WaveWarning = function ( controller )
	local self = CoD.Menu.NewForUIEditor( "WaveWarning" )
	if PreLoadFunc then
	...
	self.buttonModel = Engine.CreateModel( Engine.GetModelForController( controller ), "WaveWarning.buttonPrompts" )
	...
	weatherWarning2:setText( Engine.Localize( "CP_MI_SING_BLACKSTATION_WAVE_WARNING" ) )
	...
	LUI.OverrideFunction_CallOriginalSecond( self, "close", function ( element )
		Engine.UnsubscribeAndFreeModel( Engine.GetModel( Engine.GetModelForController( controller ), "WaveWarning.buttonPrompts" ) )
	end )
