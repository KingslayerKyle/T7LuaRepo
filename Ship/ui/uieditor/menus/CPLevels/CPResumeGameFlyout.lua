-- d1d2ca67fd83b9c39b99b2dfdbce045e
...
LUI.createMenu.CPResumeGameFlyout = function ( controller )
	...
	local ResumeInSafehouseBtn = CoD.FE_List1ButtonLarge_PH.new( f2_local1, controller )
	...
	f2_local1:AddButtonCallbackFunction( ResumeInSafehouseBtn, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f5_arg0, f5_arg1, f5_arg2, f5_arg3 )
		GoBack( self, f5_arg2 )
		return true
	...
	local ResumeFromCheckpointBtn = CoD.FE_List1ButtonLarge_PH.new( f2_local1, controller )
	...
	f2_local1:AddButtonCallbackFunction( ResumeFromCheckpointBtn, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f9_arg0, f9_arg1, f9_arg2, f9_arg3 )
		GoBack( self, f9_arg2 )
		ResumeFromCheckpoint( self, f9_arg0, f9_arg2 )
		return true
	...
	f2_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_START, "M", function ( f13_arg0, f13_arg1, f13_arg2, f13_arg3 )
		GoBackAndOpenOverlayOnParent( self, "StartMenu_Main", f13_arg2 )
		return true
	end, function ( f14_arg0, f14_arg1, f14_arg2 )
		CoD.Menu.SetButtonLabel( f14_arg1, Enum.LUIButton.LUI_KEY_START, "MENU_MENU" )
		return true
	end, false )
