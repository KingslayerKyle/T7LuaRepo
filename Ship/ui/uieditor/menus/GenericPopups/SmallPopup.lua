-- 077beeb6d381156c4a04fa58d47ed1f6
...
local PostLoadFunc = function ( f1_arg0, f1_arg1 )
	...
	f1_arg0.setButton1Action = function ( f5_arg0, f5_arg1 )
		f5_arg0.OkButton:registerEventHandler( "button_action", function ( element, event )
			f5_arg1( f5_arg0, element, event.controller )
		end )
	end
...
LUI.createMenu.SmallPopup = function ( controller )
	...
	self.buttonModel = Engine.CreateModel( Engine.GetModelForController( controller ), "SmallPopup.buttonPrompts" )
	...
	f7_local1:AddButtonCallbackFunction( OkButton, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f11_arg0, f11_arg1, f11_arg2, f11_arg3 )
	...
	f7_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, nil, function ( f15_arg0, f15_arg1, f15_arg2, f15_arg3 )
		GenericSmallPopupGoBack( self, f15_arg2 )
		return true
	...
	LUI.OverrideFunction_CallOriginalSecond( self, "close", function ( element )
		...
		Engine.UnsubscribeAndFreeModel( Engine.GetModel( Engine.GetModelForController( controller ), "SmallPopup.buttonPrompts" ) )
	end )
