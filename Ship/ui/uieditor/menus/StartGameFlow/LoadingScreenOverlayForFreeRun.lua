-- e7bdc377b74d1be909d58ddd6cddcbaf
...
LUI.createMenu.LoadingScreenOverlayForFreeRun = function ( controller )
	...
	local LoadingElem2 = CoD.TeamIconAndNameWidgetElemSide.new( f4_local1, controller )
	...
	local LoadingElem1 = CoD.TeamIconAndNameWidgetElemSide.new( f4_local1, controller )
	...
	local LoadingStatusBox = CoD.FE_TitleNumBrdr.new( f4_local1, controller )
