-- fe50a316c97d355efde0c73b30e21026
...
LUI.createMenu.MyShowcase_Variants = function ( controller )
	...
	local variantList = LUI.UIList.new( f4_local1, controller, 7, 0, nil, true, false, 0, 0, false, false )
	...
	f4_local1:AddButtonCallbackFunction( variantList, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f8_arg0, f8_arg1, f8_arg2, f8_arg3 )
		if FileshareCanPublish( f8_arg2 ) and FileshareCanPublishItem( self, f8_arg0, f8_arg2 ) then
			FileshareShowcasePublishSelectedItem( self, f8_arg0, f8_arg2 )
			return true
		else
			
		end
	end, function ( f9_arg0, f9_arg1, f9_arg2 )
		CoD.Menu.SetButtonLabel( f9_arg1, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "MENU_PUBLISH" )
		if FileshareCanPublish( f9_arg2 ) and FileshareCanPublishItem( self, f9_arg0, f9_arg2 ) then
			return true
		else
			return false
		end
	...
	local FileshareSelector0 = CoD.FileshareSelector.new( f4_local1, controller )
	...
	local FileshareNoContent = CoD.FileshareNoContent.new( f4_local1, controller )
	...
	FileshareNoContent:subscribeToModel( Engine.GetModel( Engine.GetGlobalModel(), "fileshareRoot.itemsCount" ), function ( model )
		f4_local1:updateElementState( FileshareNoContent, {
	...
	self:subscribeToModel( Engine.GetModel( Engine.GetGlobalModel(), "FileshareRoot.PublishMode" ), function ( model )
		...
		CoD.Menu.UpdateButtonShownState( f27_local0, f4_local1, controller, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE )
	end )
	...
	f4_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, nil, function ( f29_arg0, f29_arg1, f29_arg2, f29_arg3 )
		if FileshareShowcaseIsPublishMode( f29_arg0, f29_arg2 ) then
			FileshareSetShowcasePublishMode( f29_arg2, false )
			FileshareSetDirty( f29_arg2 )
			return true
		else
			GoBack( self, f29_arg2 )
			ClearSavedState( self, f29_arg2 )
			SendClientScriptMenuChangeNotify( f29_arg2, f29_arg1, false )
			MediaManagerClearDisplay( self, f29_arg0, f29_arg2 )
			return true
		end
	end, function ( f30_arg0, f30_arg1, f30_arg2 )
		if FileshareShowcaseIsPublishMode( f30_arg0, f30_arg2 ) then
			CoD.Menu.SetButtonLabel( f30_arg1, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, "MENU_BACK" )
			return true
		else
			CoD.Menu.SetButtonLabel( f30_arg1, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, "MP_BACK" )
			return true
		end
	end, false )
