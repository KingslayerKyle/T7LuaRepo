-- 3a56fef938b627263b0b04350efe5eca
...
LUI.createMenu.Community_Variants = function ( controller )
	local self = CoD.Menu.NewForUIEditor( "Community_Variants" )
	if PreLoadFunc then
	...
	self.buttonModel = Engine.CreateModel( Engine.GetModelForController( controller ), "Community_Variants.buttonPrompts" )
	...
	local FETabBar0 = CoD.FE_TabBar.new( f1_local1, controller )
	FETabBar0:setLeftRight( true, false, 0, 1567 )
	FETabBar0:setTopBottom( true, false, 86, 121 )
	...
	f1_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, nil, function ( f5_arg0, f5_arg1, f5_arg2, f5_arg3 )
		...
		CoD.Menu.SetButtonLabel( f6_arg1, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, "MP_BACK" )
		return true
	end, false )
	...
	LUI.OverrideFunction_CallOriginalSecond( self, "close", function ( element )
		...
		Engine.UnsubscribeAndFreeModel( Engine.GetModel( Engine.GetModelForController( controller ), "Community_Variants.buttonPrompts" ) )
	end )
