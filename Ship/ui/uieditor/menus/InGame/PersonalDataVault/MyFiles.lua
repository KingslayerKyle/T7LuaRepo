-- 6c040400c1c08ab4f0f62efab2dbefba
...
LUI.createMenu.MyFiles = function ( controller )
	...
	local MyFilesWidget = CoD.MyFilesWidget.new( f1_local1, controller )
	...
	f1_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, nil, function ( f3_arg0, f3_arg1, f3_arg2, f3_arg3 )
		...
		CoD.Menu.SetButtonLabel( f4_arg1, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "MENU_SELECT" )
		return true
	end, false )
