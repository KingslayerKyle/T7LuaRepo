-- 528f82a701618953faae81126b48cc47
...
local PreLoadFunc = function ( self, controller )
	CoD.StoreUtility.InitSingleCategoryStoreMenu( self, controller, "MAPPACKS" )
end

LUI.createMenu.Store_DLC = function ( controller )
	local self = CoD.Menu.NewForUIEditor( "Store_DLC" )
	if PreLoadFunc then
	...
	self.buttonModel = Engine.CreateModel( Engine.GetModelForController( controller ), "Store_DLC.buttonPrompts" )
	...
	LUI.OverrideFunction_CallOriginalSecond( self, "close", function ( element )
		...
		Engine.UnsubscribeAndFreeModel( Engine.GetModel( Engine.GetModelForController( controller ), "Store_DLC.buttonPrompts" ) )
	end )
