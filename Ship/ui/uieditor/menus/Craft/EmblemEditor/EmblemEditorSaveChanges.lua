-- d0acc578a1209f0dd9bb9f2c98d00fbc
...
LUI.createMenu.EmblemEditorSaveChanges = function ( controller )
	...
	local emblemNameInput = CoD.GunsmithInputButton.new( f2_local1, controller )
	...
	f2_local1:AddButtonCallbackFunction( emblemNameInput, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f7_arg0, f7_arg1, f7_arg2, f7_arg3 )
		ShowKeyboard( self, f7_arg0, f7_arg2, "KEYBOARD_TYPE_EMBLEMS" )
		return true
	...
	f2_local1:AddButtonCallbackFunction( save, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f13_arg0, f13_arg1, f13_arg2, f13_arg3 )
		EmblemEditor_SaveEmblem( self, f13_arg0, f13_arg2 )
		ForceNotifyModel( f13_arg2, "Emblem.UpdateDataSource" )
	...
	f2_local1:AddButtonCallbackFunction( discard, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f18_arg0, f18_arg1, f18_arg2, f18_arg3 )
		EmblemEditor_DiscardChanges( self, f18_arg0, f18_arg2 )
	...
	f2_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, nil, function ( f21_arg0, f21_arg1, f21_arg2, f21_arg3 )
		...
		EmblemEditor_SaveChangesBack( self, f21_arg0, f21_arg2 )
		PaintjobEditor_RestoreGridState( f21_arg2 )
		return true
