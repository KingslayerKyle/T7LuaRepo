-- d04a25949497d98d3e67984951aa6dd0
...
LUI.createMenu.EmblemIconColorPicker = function ( controller )
	...
	local StartMenuBackground0 = CoD.StartMenu_Background.new( f13_local1, controller )
	...
	local colorGradientContainer = CoD.EmblemEditorGradient.new( f13_local1, controller )
	...
	local colorMixerContainer = CoD.EmblemEditorColorMixerContainer.new( f13_local1, controller )
	...
	local colorSwatchContainer = CoD.EmblemEditorColorSwatchContainer.new( f13_local1, controller )
	...
	local colorGradientSwatchContainer = CoD.EmblemEditorGradientColorSwatch.new( f13_local1, controller )
	...
	local colorGradientMixerContainer = CoD.EmblemEditorColorMixerContainer.new( f13_local1, controller )
	...
	local PaintshopColorSwatchControls = CoD.PaintshopColorSwatchControls.new( f13_local1, controller )
	...
	PaintshopColorSwatchControls:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "Emblem.EmblemProperties.isGradientMode" ), function ( model )
		f13_local1:updateElementState( PaintshopColorSwatchControls, {
	...
	local emblemEditorColorControls = CoD.EmblemEditorColorControls.new( f13_local1, controller )
	...
	emblemEditorColorControls:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "Emblem.EmblemProperties.isGradientMode" ), function ( model )
		f13_local1:updateElementState( emblemEditorColorControls, {
			name = "model_validation",
			menu = f13_local1,
			modelValue = Engine.GetModelValue( model ),
			modelName = "Emblem.EmblemProperties.isGradientMode"
	...
	local PaintshopColorLayerInfo = CoD.PaintshopColorLayerInfo.new( f13_local1, controller )
	...
	PaintshopColorLayerInfo:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "Emblem.EmblemProperties.isGradientMode" ), function ( model )
		f13_local1:updateElementState( PaintshopColorLayerInfo, {
			name = "model_validation",
			menu = f13_local1,
			modelValue = Engine.GetModelValue( model ),
			modelName = "Emblem.EmblemProperties.isGradientMode"
	...
	local ColorPickerTitle = CoD.cac_3dTitleIntermediary.new( f13_local1, controller )
	...
	local ElemsSideList = CoD.cac_ElemsSideList.new( f13_local1, controller )
	ElemsSideList:setLeftRight( true, false, 6, 73.87 )
	ElemsSideList:setTopBottom( true, false, 44, 718 )
	self:addElement( ElemsSideList )
	self.ElemsSideList = ElemsSideList
	
	local emblemDrawWidget = CoD.EmblemDrawWidgetNew.new( f13_local1, controller )
	...
	local EmblemEditorColorTypeHeader0 = CoD.EmblemEditorColorTypeHeader.new( f13_local1, controller )
	...
	EmblemEditorColorTypeHeader0:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "Emblem.EmblemProperties.isGradientMode" ), function ( model )
		f13_local1:updateElementState( EmblemEditorColorTypeHeader0, {
			name = "model_validation",
			menu = f13_local1,
			modelValue = Engine.GetModelValue( model ),
			modelName = "Emblem.EmblemProperties.isGradientMode"
	...
	local choosePaintSide = CoD.PaintshopChoosePaintSide.new( f13_local1, controller )
	...
	choosePaintSide:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "Emblem.EmblemProperties.editorMode" ), function ( model )
		f13_local1:updateElementState( choosePaintSide, {
			name = "model_validation",
			menu = f13_local1,
			modelValue = Engine.GetModelValue( model ),
	...
	MenuFrame:registerEventHandler( "menu_loaded", function ( element, event )
		...
		elseif IsPaintshop( controller ) then
			ShowHeaderKickerAndIcon( f13_local1 )
	...
	local actionsListPC = LUI.UIList.new( f13_local1, controller, 2, 0, nil, false, false, 0, 0, false, false )
	...
	if self.m_eventHandlers.input_source_changed then
		...
		self:registerEventHandler( "input_source_changed", function ( element, event )
			...
			return f13_local22( element, event )
		end )
	else
		self:registerEventHandler( "input_source_changed", LUI.UIElement.updateState )
	end
	self:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "LastInput" ), function ( model )
		f13_local1:updateElementState( self, {
			name = "model_validation",
			menu = f13_local1,
			modelValue = Engine.GetModelValue( model ),
			modelName = "LastInput"
	...
	self:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "Emblem.EmblemProperties.isGradientMode" ), function ( model )
		...
		CoD.Menu.UpdateButtonShownState( f55_local0, f13_local1, controller, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE )
		CoD.Menu.UpdateButtonShownState( f55_local0, f13_local1, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS )
		CoD.Menu.UpdateButtonShownState( f55_local0, f13_local1, controller, Enum.LUIButton.LUI_KEY_LTRIG )
		CoD.Menu.UpdateButtonShownState( f55_local0, f13_local1, controller, Enum.LUIButton.LUI_KEY_RTRIG )
	end )
	self:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "Emblem.EmblemProperties.colorMode" ), function ( model )
		...
		CoD.Menu.UpdateButtonShownState( f56_local0, f13_local1, controller, Enum.LUIButton.LUI_KEY_BACK )
		CoD.Menu.UpdateButtonShownState( f56_local0, f13_local1, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS )
		CoD.Menu.UpdateButtonShownState( f56_local0, f13_local1, controller, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE )
		CoD.Menu.UpdateButtonShownState( f56_local0, f13_local1, controller, Enum.LUIButton.LUI_KEY_RSTICK_PRESSED )
	end )
	CoD.Menu.AddNavigationHandler( f13_local1, self, controller )
	f13_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, nil, function ( f57_arg0, f57_arg1, f57_arg2, f57_arg3 )
		if IsModelValueEqualTo( f57_arg2, "Emblem.EmblemProperties.isGradientMode", 0 ) then
			GoBack( self, f57_arg2 )
			ClearSavedState( self, f57_arg2 )
			return true
		elseif IsModelValueEqualTo( f57_arg2, "Emblem.EmblemProperties.isGradientMode", 1 ) and IsModelValueEqualToEnum( f57_arg2, "Emblem.EmblemProperties.colorMode", Enum.CustomizationColorMode.CUSTOMIZATION_COLOR_MODE_NONE ) then
			GoBack( self, f57_arg2 )
			ClearMenuSavedState( f57_arg1 )
			EmblemGradient_BackFromGradientPicker( self, f57_arg0, f57_arg2 )
			return true
		elseif IsModelValueEqualTo( f57_arg2, "Emblem.EmblemProperties.isGradientMode", 1 ) and not IsModelValueEqualToEnum( f57_arg2, "Emblem.EmblemProperties.colorMode", Enum.CustomizationColorMode.CUSTOMIZATION_COLOR_MODE_NONE ) then
			EmblemGradient_BackFromColorPicker( self, f57_arg0, f57_arg2 )
			return true
		else
			
		end
	end, function ( f58_arg0, f58_arg1, f58_arg2 )
		if IsModelValueEqualTo( f58_arg2, "Emblem.EmblemProperties.isGradientMode", 0 ) then
			CoD.Menu.SetButtonLabel( f58_arg1, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, "MENU_BACK" )
			return true
		elseif IsModelValueEqualTo( f58_arg2, "Emblem.EmblemProperties.isGradientMode", 1 ) and IsModelValueEqualToEnum( f58_arg2, "Emblem.EmblemProperties.colorMode", Enum.CustomizationColorMode.CUSTOMIZATION_COLOR_MODE_NONE ) then
			CoD.Menu.SetButtonLabel( f58_arg1, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, "MP_BACK" )
			return true
		elseif IsModelValueEqualTo( f58_arg2, "Emblem.EmblemProperties.isGradientMode", 1 ) and not IsModelValueEqualToEnum( f58_arg2, "Emblem.EmblemProperties.colorMode", Enum.CustomizationColorMode.CUSTOMIZATION_COLOR_MODE_NONE ) then
			CoD.Menu.SetButtonLabel( f58_arg1, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, "MP_BACK" )
			return true
		else
			return false
	...
	f13_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, nil, function ( f59_arg0, f59_arg1, f59_arg2, f59_arg3 )
		if IsModelValueEqualTo( f59_arg2, "Emblem.EmblemProperties.isGradientMode", 0 ) then
			GoBack( self, f59_arg2 )
			ClearSavedState( self, f59_arg2 )
			return true
		elseif IsModelValueEqualTo( f59_arg2, "Emblem.EmblemProperties.isGradientMode", 1 ) and IsModelValueEqualToEnum( f59_arg2, "Emblem.EmblemProperties.colorMode", Enum.CustomizationColorMode.CUSTOMIZATION_COLOR_MODE_NONE ) then
			EmblemGradient_ShowSwatchContainer( self, f59_arg0, f59_arg2 )
			return true
		elseif IsModelValueEqualTo( f59_arg2, "Emblem.EmblemProperties.isGradientMode", 1 ) and not IsModelValueEqualToEnum( f59_arg2, "Emblem.EmblemProperties.colorMode", Enum.CustomizationColorMode.CUSTOMIZATION_COLOR_MODE_NONE ) then
			EmblemGradient_BackFromColorPicker( self, f59_arg0, f59_arg2 )
			return true
		else
		...
		if IsModelValueEqualTo( f60_arg2, "Emblem.EmblemProperties.isGradientMode", 0 ) then
			return true
		elseif IsModelValueEqualTo( f60_arg2, "Emblem.EmblemProperties.isGradientMode", 1 ) and IsModelValueEqualToEnum( f60_arg2, "Emblem.EmblemProperties.colorMode", Enum.CustomizationColorMode.CUSTOMIZATION_COLOR_MODE_NONE ) then
			return true
		elseif IsModelValueEqualTo( f60_arg2, "Emblem.EmblemProperties.isGradientMode", 1 ) and not IsModelValueEqualToEnum( f60_arg2, "Emblem.EmblemProperties.colorMode", Enum.CustomizationColorMode.CUSTOMIZATION_COLOR_MODE_NONE ) then
			return true
		else
			return false
		end
	end, false )
	f13_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_LB, nil, function ( f61_arg0, f61_arg1, f61_arg2, f61_arg3 )
		EmblemChooseColor_UpdateOpacityByStep( self, f61_arg0, "-0.01", f61_arg2 )
		return true
	end, function ( f62_arg0, f62_arg1, f62_arg2 )
		CoD.Menu.SetButtonLabel( f62_arg1, Enum.LUIButton.LUI_KEY_LB, "" )
		return false
	end, false )
	f13_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_RB, nil, function ( f63_arg0, f63_arg1, f63_arg2, f63_arg3 )
		EmblemChooseColor_UpdateOpacityByStep( self, f63_arg0, "0.01", f63_arg2 )
		return true
	end, function ( f64_arg0, f64_arg1, f64_arg2 )
		CoD.Menu.SetButtonLabel( f64_arg1, Enum.LUIButton.LUI_KEY_RB, "" )
		return false
	end, false )
	f13_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_BACK, "E", function ( f65_arg0, f65_arg1, f65_arg2, f65_arg3 )
		if not IsModelValueEqualToEnum( f65_arg2, "Emblem.EmblemProperties.colorMode", Enum.CustomizationColorMode.CUSTOMIZATION_COLOR_MODE_NONE ) then
			EmblemChooseColor_ToggleColorMode( self, f65_arg0, f65_arg2 )
		...
		CoD.Menu.SetButtonLabel( f66_arg1, Enum.LUIButton.LUI_KEY_BACK, "" )
		if not IsModelValueEqualToEnum( f66_arg2, "Emblem.EmblemProperties.colorMode", Enum.CustomizationColorMode.CUSTOMIZATION_COLOR_MODE_NONE ) then
			return false
		else
			return false
		end
	end, false )
	f13_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBX_PSSQUARE, "G", function ( f67_arg0, f67_arg1, f67_arg2, f67_arg3 )
		EmblemChooseColor_ToggleGradientMode( self, f67_arg0, f67_arg2 )
		return true
	end, function ( f68_arg0, f68_arg1, f68_arg2 )
		CoD.Menu.SetButtonLabel( f68_arg1, Enum.LUIButton.LUI_KEY_XBX_PSSQUARE, "" )
		return false
	end, false )
	f13_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_LTRIG, nil, function ( f69_arg0, f69_arg1, f69_arg2, f69_arg3 )
		if IsModelValueEqualTo( f69_arg2, "Emblem.EmblemProperties.isGradientMode", 1 ) then
			EmblemGradient_UpdateAngleByStep( self, f69_arg0, "-1", f69_arg2 )
			return true
		else
			
		end
	end, function ( f70_arg0, f70_arg1, f70_arg2 )
		CoD.Menu.SetButtonLabel( f70_arg1, Enum.LUIButton.LUI_KEY_LTRIG, "" )
		if IsModelValueEqualTo( f70_arg2, "Emblem.EmblemProperties.isGradientMode", 1 ) then
			return false
		else
			return false
		end
	end, false )
	f13_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_RTRIG, nil, function ( f71_arg0, f71_arg1, f71_arg2, f71_arg3 )
		if IsModelValueEqualTo( f71_arg2, "Emblem.EmblemProperties.isGradientMode", 1 ) then
			EmblemGradient_UpdateAngleByStep( self, f71_arg0, "1", f71_arg2 )
			return true
		else
			
		end
	end, function ( f72_arg0, f72_arg1, f72_arg2 )
		CoD.Menu.SetButtonLabel( f72_arg1, Enum.LUIButton.LUI_KEY_RTRIG, "" )
		if IsModelValueEqualTo( f72_arg2, "Emblem.EmblemProperties.isGradientMode", 1 ) then
			return false
		else
			return false
		end
	end, false )
	f13_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_RSTICK_PRESSED, nil, function ( f73_arg0, f73_arg1, f73_arg2, f73_arg3 )
		if IsModelValueEqualToEnum( f73_arg2, "Emblem.EmblemProperties.colorMode", Enum.CustomizationColorMode.CUSTOMIZATION_COLOR_MODE_NONE ) then
			EmblemGradient_ToggleGradientType( self, f73_arg0, f73_arg2 )
			return true
		else
			
		end
	end, function ( f74_arg0, f74_arg1, f74_arg2 )
		CoD.Menu.SetButtonLabel( f74_arg1, Enum.LUIButton.LUI_KEY_RSTICK_PRESSED, "" )
		if IsModelValueEqualToEnum( f74_arg2, "Emblem.EmblemProperties.colorMode", Enum.CustomizationColorMode.CUSTOMIZATION_COLOR_MODE_NONE ) then
			return false
		else
			return false
		end
	end, false )
	f13_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBY_PSTRIANGLE, nil, function ( f75_arg0, f75_arg1, f75_arg2, f75_arg3 )
		if IsPaintshop( f75_arg2 ) then
			EmblemChooseColor_ToggleBlend( self, f75_arg0, f75_arg2 )
			return true
		else
			
		end
	end, function ( f76_arg0, f76_arg1, f76_arg2 )
		CoD.Menu.SetButtonLabel( f76_arg1, Enum.LUIButton.LUI_KEY_XBY_PSTRIANGLE, "" )
		if IsPaintshop( f76_arg2 ) then
			return false
		else
			return false
		end
