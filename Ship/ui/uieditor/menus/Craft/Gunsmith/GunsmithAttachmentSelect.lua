-- 2dfa75b30aa01b978aa496a6f0174bd6
...
LUI.createMenu.GunsmithAttachmentSelect = function ( controller )
	...
	f5_local1:AddButtonCallbackFunction( selectionList, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( f9_arg0, f9_arg1, f9_arg2, f9_arg3 )
		Gunsmith_SelectAttachment( self, f9_arg0, f9_arg2 )
		GoBack( self, f9_arg2 )
	...
	local GunSmithSubDescription0 = CoD.GunSmithSubDescription.new( f5_local1, controller )
	...
	local weaponAttributes = CoD.WeaponAttributes_Internal.new( f5_local1, controller )
	...
	local warningMsg = CoD.GunsmithWarningWidget.new( f5_local1, controller )
	...
	if IsPC() then
		f5_local13 = CoD.XCamMouseControl.new( f5_local1, controller )
	else
	...
	f5_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, nil, function ( f21_arg0, f21_arg1, f21_arg2, f21_arg3 )
	...
	f5_local1:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_RSTICK_PRESSED, nil, function ( f23_arg0, f23_arg1, f23_arg2, f23_arg3 )
		if CACShowRotatePrompt( self, f23_arg0, f23_arg2 ) then
			return true
		else
