-- ed0c5f8ac9869fae10c5b1ad77ab14ff
...
LUI.createMenu.SquadControlReticuleMenu = function ( controller )
	...
	self.buttonModel = Engine.CreateModel( Engine.GetModelForController( controller ), "SquadControlReticuleMenu.buttonPrompts" )
	...
	self.SquadLabelText:linkToElementModel( self, "squad_label_text", true, function ( model )
		local squadLabelText = Engine.GetModelValue( model )
		if squadLabelText then
			SquadLabelText:setText( Engine.Localize( squadLabelText ) )
		end
	end )
	self.clipsPerState = {
		DefaultState = {
	...
	LUI.OverrideFunction_CallOriginalSecond( self, "close", function ( element )
		element.SquadLabelText:close()
		Engine.UnsubscribeAndFreeModel( Engine.GetModel( Engine.GetModelForController( controller ), "SquadControlReticuleMenu.buttonPrompts" ) )
	end )
