...
f0_local0.IsRankedGame = function ()
	local f7_local0
	if f0_local0.IsOnlineGame() == true then
		f7_local0 = not Engine.GameModeIsMode( Enum.eGameModes.MODE_GAME_MATCHMAKING_MANUAL )
	else
		f7_local0 = false
	end
	return f7_local0
...
f0_local0.QuitGame = function ( f11_arg0, f11_arg1 )
	...
	if f0_local0.IsLobbyMode( Enum.LobbyMode.LOBBY_MODE_THEATER ) == true then
		...
		return true
	elseif not f0_local0.IsRankedGame() and f0_local0.IsHost() then
