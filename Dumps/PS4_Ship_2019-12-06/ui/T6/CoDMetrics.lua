...
LUI.CoDMetrics.StoreEntry = function ( f8_arg0, f8_arg1, f8_arg2, f8_arg3 )
	Engine.RecordComScoreEvent( f8_arg1, "store_entry", "group_id", LUI.CoDMetrics.GetGroupsIDList( f8_arg1 ), "store_source", f8_arg3.name, "store_gamemode", Engine.GetModeName(), "store_action_source", f8_arg2, "store_region", Engine.GetSkuRegion() )
end
...
LUI.CoDMetrics.InventoryItemPurchased = function ( f10_arg0, f10_arg1, f10_arg2, f10_arg3 )
	Engine.RecordComScoreEvent( f10_arg0, "dw_inventory_item_purchase", "group_id", LUI.CoDMetrics.GetGroupsIDList( f10_arg0 ), "store_source", f10_arg2, "store_gamemode", Engine.GetModeName(), "product_name", f10_arg1, "product_cost_cp", f10_arg3, "store_region", Engine.GetSkuRegion() )
end
