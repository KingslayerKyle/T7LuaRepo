...
CoD.ChangeGameMode.GameModeSelected = function ( f2_arg0, f2_arg1 )
	...
	local f2_local0 = CoDShared.IsGametypeTeamBased()
	Engine.SetGametype( f2_arg1.itemInfo.gametype )
	if f2_local0 ~= CoDShared.IsGametypeTeamBased() then
...
CoD.ChangeGameMode.AddCategoryButtons = function ( f9_arg0 )
	...
	local f9_local1 = Engine.StructTableLookupString( CoDShared.gametypesStructTable, "name", Engine.DvarString( nil, "ui_gametype" ), "groupname" )
	local f9_local2 = 1
...
CoD.ChangeGameMode.CreateGameModeInfo = function ( f11_arg0, f11_arg1 )
	return {
		...
		description = Engine.Localize( Engine.StructTableLookupString( CoDShared.gametypesStructTable, "name", f11_arg1.gametype, "description" ) ),
		iconMaterial = RegisterMaterial( Engine.StructTableLookupString( CoDShared.gametypesStructTable, "name", f11_arg1.gametype, "image" ) )
	}
end
