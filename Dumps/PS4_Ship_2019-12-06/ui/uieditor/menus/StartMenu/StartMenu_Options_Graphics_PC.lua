...
DataSources.OptionPCGraphicsSceneResolution = DataSourceHelpers.ListSetup( "PC.OptionPCGraphicsSceneResolution", function ( f9_arg0 )
	...
	local f9_local3 = {}
	for f9_local4 = 50, 200, 10 do
		local f9_local7 = f9_local4 * f9_local1 / 100
		local f9_local8 = f9_local4 * f9_local2 / 100
		if f9_local4 ~= 100 then
			f9_local7 = math.floor( f9_local7 / 8 ) * 8
			f9_local8 = math.floor( f9_local8 / 8 ) * 8
		end
		table.insert( f9_local0, {
			models = {
				value = f9_local4,
				valueDisplay = string.format( "%d%% - %dx%d", f9_local4, f9_local7, f9_local8 )
			}
		} )
	end
	return f9_local0
...
DataSources.OptionPCGraphicsAntiAliasing = DataSourceHelpers.ListSetup( "PC.OptionPCGraphicsAntiAliasing", function ( f23_arg0 )
	...
	for f23_local5, f23_local6 in ipairs( Dvar.r_aaTechnique:getDomainEnumStrings() ) do
		if f23_local6 == "None" then
			...
			table.insert( f23_local0, {
				models = {
					value = f23_local6,
					valueDisplay = f23_local6
				}
			} )
		end
		if f23_local1 > 1 and f23_local5 >= 3 then
			break
		end
	end
	return f23_local0
