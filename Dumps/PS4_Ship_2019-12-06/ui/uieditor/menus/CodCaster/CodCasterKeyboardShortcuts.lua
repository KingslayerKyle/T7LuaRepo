...
LUI.createMenu.CodCasterKeyboardShortcuts = function ( controller )
	...
	local Close = CoD.FooterButtonPromptWithPCKey.new( self, controller )
	...
	local Esc = CoD.CodCasterKeyboardButtonPromptInfo.new( self, controller )
	...
	local F1 = CoD.CodCasterKeyboardButtonPromptInfo.new( self, controller )
	...
	local F2 = CoD.CodCasterKeyboardButtonPromptInfo.new( self, controller )
	...
	local F3 = CoD.CodCasterKeyboardButtonPromptInfo.new( self, controller )
	...
	local F4 = CoD.CodCasterKeyboardButtonPromptInfo.new( self, controller )
	...
	local Team1Players = CoD.CodCasterKeyboardButtonPromptInfo.new( self, controller )
	...
	local Team2Players = CoD.CodCasterKeyboardButtonPromptInfo.new( self, controller )
	...
	local TAB = CoD.CodCasterKeyboardButtonPromptInfo.new( self, controller )
	...
	local Q = CoD.CodCasterKeyboardButtonPromptInfo.new( self, controller )
	...
	local W = CoD.CodCasterKeyboardButtonPromptInfo.new( self, controller )
	...
	local E = CoD.CodCasterKeyboardButtonPromptInfo.new( self, controller )
	...
	local T = CoD.CodCasterKeyboardButtonPromptInfo.new( self, controller )
	...
	local P = CoD.CodCasterKeyboardButtonPromptInfo.new( self, controller )
	...
	local S = CoD.CodCasterKeyboardButtonPromptInfo.new( self, controller )
	...
	local L = CoD.CodCasterKeyboardButtonPromptInfo.new( self, controller )
	...
	local X = CoD.CodCasterKeyboardButtonPromptInfo.new( self, controller )
	...
	local N = CoD.CodCasterKeyboardButtonPromptInfo.new( self, controller )
	...
	local M = CoD.CodCasterKeyboardButtonPromptInfo.new( self, controller )
	...
	local PrevPlayer = CoD.CodCasterKeyboardButtonPromptInfo.new( self, controller )
	...
	local NextPlayer = CoD.CodCasterKeyboardButtonPromptInfo.new( self, controller )
	...
	local Space = CoD.CodCasterKeyboardButtonPromptInfo.new( self, controller )
	...
	self:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_NONE, "K", function ( element, menu, controller, model )
