...
LUI.createMenu.GroupAdminSettings = function ( controller )
	...
	self:AddButtonCallbackFunction( InvitePlayers, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, nil, function ( element, menu, controller, model )
	...
	self:AddButtonCallbackFunction( ApproveJoinRequests, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, nil, function ( element, menu, controller, model )
	...
	self:AddButtonCallbackFunction( RemoveMembers, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, nil, function ( element, menu, controller, model )
	...
	self:AddButtonCallbackFunction( BanMembers, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, nil, function ( element, menu, controller, model )
	...
	self:AddButtonCallbackFunction( EditFeatured, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, nil, function ( element, menu, controller, model )
	...
	self:AddButtonCallbackFunction( FavoriteShowcaseContent, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, nil, function ( element, menu, controller, model )
	...
	self:AddButtonCallbackFunction( RemoveShowcaseContent, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, nil, function ( element, menu, controller, model )
	...
	self:AddButtonCallbackFunction( EditMessage, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, nil, function ( element, menu, controller, model )
	...
	self:AddButtonCallbackFunction( EditLeaderboard, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, nil, function ( element, menu, controller, model )
	...
	self:AddButtonCallbackFunction( EditEmblem, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, nil, function ( element, menu, controller, model )
	...
	self:AddButtonCallbackFunction( EditDescription, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, nil, function ( element, menu, controller, model )
	...
	self:AddButtonCallbackFunction( EditGroupPrivacySettings, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, nil, function ( element, menu, controller, model )
	...
	self:AddButtonCallbackFunction( EditGroupName, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, nil, function ( element, menu, controller, model )
	...
	self:AddButtonCallbackFunction( ManageAdmins, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, nil, function ( element, menu, controller, model )
