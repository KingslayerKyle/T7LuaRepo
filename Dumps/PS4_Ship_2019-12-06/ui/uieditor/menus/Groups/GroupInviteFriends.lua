...
LUI.createMenu.GroupInviteFriends = function ( controller )
	...
	local List1ButtonLargeGroups = CoD.List1ButtonLarge_Groups.new( self, controller )
	...
	self:AddButtonCallbackFunction( List1ButtonLargeGroups, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( element, menu, controller, model )
	...
	local List1ButtonLargeGroups0 = CoD.List1ButtonLarge_Groups.new( self, controller )
	...
	self:AddButtonCallbackFunction( List1ButtonLargeGroups0, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( element, menu, controller, model )
	...
	self:registerEventHandler( "menu_loaded", function ( self, event )
		...
		ClearInitialGroupsInviteList( self, self, controller )
