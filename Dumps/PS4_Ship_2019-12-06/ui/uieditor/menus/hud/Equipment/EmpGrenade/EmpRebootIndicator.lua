...
LUI.createMenu.EmpRebootIndicator = function ( controller )
	...
	local EmpRebootIndicatorWidget = CoD.EmpRebootIndicatorWidget.new( self, controller )
	...
	local EmpRebootElectromagneticWidget0 = CoD.EmpRebootElectromagneticWidget.new( self, controller )
