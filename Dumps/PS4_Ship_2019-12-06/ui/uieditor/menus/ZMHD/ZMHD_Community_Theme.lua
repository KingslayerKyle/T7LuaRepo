...
LUI.createMenu.ZMHD_Community_Theme = function ( controller )
	...
	local PromoZMHDCommunityWidget0 = CoD.Promo_ZMHD_CommunityWidget.new( self, controller )
	PromoZMHDCommunityWidget0:setLeftRight( true, false, -6, 1274 )
	PromoZMHDCommunityWidget0:setTopBottom( true, false, 89, 639 )
	PromoZMHDCommunityWidget0.TitleAndDesc.title:setRGB( 0.93, 0.93, 0.6 )
	PromoZMHDCommunityWidget0.TitleAndDesc.title:setText( LocalizeToUpperString( "CONTRACT_COMMUNITY_CONTRACT_ZMHD_TITLE" ) )
	PromoZMHDCommunityWidget0.TitleAndDesc.txtDescription:setRGB( 0.93, 0.93, 0.6 )
	PromoZMHDCommunityWidget0.TitleAndDesc.txtDescription:setText( Engine.Localize( "CONTRACT_COMMUNITY_CONTRACT_ZMHD_V2_DESC" ) )
	self:addElement( PromoZMHDCommunityWidget0 )
	self.PromoZMHDCommunityWidget0 = PromoZMHDCommunityWidget0
	
	local PromoZMDHHeaderWidget0 = CoD.Promo_ZMDH_HeaderWidget.new( self, controller )
	...
	LUI.OverrideFunction_CallOriginalSecond( self, "close", function ( element )
		...
		element.PromoZMHDCommunityWidget0:close()
