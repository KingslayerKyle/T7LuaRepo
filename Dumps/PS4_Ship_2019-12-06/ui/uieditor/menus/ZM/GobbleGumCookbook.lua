		...
		DataSources.PurchaseDistillsItemList = DataSourceHelpers.ListSetup( "PurchaseDistillsItemList", function ( f10_arg0, f10_arg1 )
			...
			local f10_local6 = function ( f16_arg0, f16_arg1, f16_arg2, f16_arg3, f16_arg4, f16_arg5, f16_arg6 )
				...
				if f16_arg3 == CoD.BubbleGumBuffUtility.FREE_DISTILL then
					f16_local2 = CoD.GobbleGumCookbook_FreeDistillsListItem
				end
				local f16_local3 = Engine.Localize( "ZMUI_COOKBOOK_FREE_HINT_TIMER", SecondsAsHourMinutesSeconds( CoD.BubbleGumBuffUtility.GetDistillCooldown( f16_arg0, f16_arg3 ) ) )
				if CoD.BubbleGumBuffUtility.GetRemainingUsesForDistill( f16_arg0, CoD.BubbleGumBuffUtility.FREE_DISTILL ) >= CoD.BubbleGumBuffUtility.GetRecipeDistillCost() then
					f16_local3 = Engine.Localize( "ZMUI_COOKBOOK_FREE_HINT_HAVE_DISTILLS", math.floor( CoD.BubbleGumBuffUtility.GetRemainingUsesForDistill( f16_arg0, CoD.BubbleGumBuffUtility.FREE_DISTILL ) / CoD.BubbleGumBuffUtility.GetRecipeDistillCost() ) )
				end
				local f16_local4 = {}
				local f16_local5 = {
				...
				local f16_local6
				if f16_arg3 == CoD.BubbleGumBuffUtility.FREE_DISTILL then
					f16_local6 = CoD.BubbleGumBuffUtility.GetRemainingUsesForDistill( f16_arg0, f16_arg3 )
					if not f16_local6 then
					
					else
						f16_local5.remainingDistills = f16_local6
						f16_local5.timeRemaining = CoD.BubbleGumBuffUtility.GetDistillCooldown( f16_arg0, f16_arg3 )
						f16_local5.distillID = f16_arg3
						f16_local5.itemCODPointCost = f16_local0
						f16_local5.itemVialCost = f16_local1
						f16_local5.hintTextAlign = Enum.LUIAlignment.LUI_ALIGNMENT_LEFT
						f16_local5.hintText = f16_local3
						f16_local4.models = f16_local5
						f16_local4.properties = {
							action = f16_arg1,
							actionParam = f16_arg2,
							selectIndex = f16_arg4,
							customWidgetOverride = f16_local2
						}
						return f16_local4
					end
				end
