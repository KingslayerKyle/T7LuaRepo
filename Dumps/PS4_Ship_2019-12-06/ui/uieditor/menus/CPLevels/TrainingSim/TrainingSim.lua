...
LUI.createMenu.TrainingSim = function ( controller )
	...
	local CPTrainingSimHUDContainer = CoD.CPTrainingSimHUDContainer.new( self, controller )
	...
	local CombatImmersionCompleted = CoD.TrainingSim_CombatImmersionCompleted.new( self, controller )
	...
	local RoundComplete = CoD.TrainingSim_RoundCompleteWidget.new( self, controller )
