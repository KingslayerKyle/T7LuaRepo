...
local f0_local26 = f0_local5
local f0_local27 = f0_local10
local f0_local28 = f0_local15
local f0_local29 = f0_local18
local f0_local30 = f0_local25
...
if not CoD.isFrontend and not CoD.isCampaign and CoD.isZombie then
	...
	local f0_local31 = 4
	for f0_local32 = 0, f0_local31 - 1, 1 do
		Engine.RegisterClientUIModelField( "PlayerList.client" .. f0_local32 .. ".score_cf_damage", Enum.UIModelClientFieldType.CF_COUNTER, 3, f0_local0 )
		Engine.RegisterClientUIModelField( "PlayerList.client" .. f0_local32 .. ".score_cf_death_normal", Enum.UIModelClientFieldType.CF_COUNTER, 2, f0_local0 )
		Engine.RegisterClientUIModelField( "PlayerList.client" .. f0_local32 .. ".score_cf_death_torso", Enum.UIModelClientFieldType.CF_COUNTER, 2, f0_local0 )
		Engine.RegisterClientUIModelField( "PlayerList.client" .. f0_local32 .. ".score_cf_death_neck", Enum.UIModelClientFieldType.CF_COUNTER, 2, f0_local0 )
		Engine.RegisterClientUIModelField( "PlayerList.client" .. f0_local32 .. ".score_cf_death_head", Enum.UIModelClientFieldType.CF_COUNTER, 2, f0_local0 )
		Engine.RegisterClientUIModelField( "PlayerList.client" .. f0_local32 .. ".score_cf_death_melee", Enum.UIModelClientFieldType.CF_COUNTER, 2, f0_local0 )
	end
	if Engine.GetCurrentMap() == "zm_island" then
		Engine.RegisterClientUIModelField( "hudItems.showDpadRight_Spider", Enum.UIModelClientFieldType.CF_INT, 1, f0_local27 )
	end
	if Engine.GetCurrentMap() == "zm_stalingrad" then
		Engine.RegisterClientUIModelField( "trialWidget.icon", Enum.UIModelClientFieldType.CF_INT, 2, f0_local28 )
		Engine.RegisterClientUIModelField( "trialWidget.challenge1state", Enum.UIModelClientFieldType.CF_INT, 2, f0_local28 )
		Engine.RegisterClientUIModelField( "trialWidget.challenge2state", Enum.UIModelClientFieldType.CF_INT, 2, f0_local28 )
		Engine.RegisterClientUIModelField( "trialWidget.challenge3state", Enum.UIModelClientFieldType.CF_INT, 2, f0_local28 )
	end
	...
	if Engine.GetCurrentMap() == "zm_island" or Engine.GetCurrentMap() == "zm_stalingrad" or Engine.GetCurrentMap() == "zm_genesis" then
		Engine.RegisterClientUIModelField( "trialWidget.visible", Enum.UIModelClientFieldType.CF_INT, 1, f0_local27 )
		Engine.RegisterClientUIModelField( "trialWidget.progress", Enum.UIModelClientFieldType.CF_FLOAT, 7, f0_local27 )
	end
end
