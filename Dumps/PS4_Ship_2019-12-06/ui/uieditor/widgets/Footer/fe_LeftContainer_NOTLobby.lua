...
local PostLoadFunc = function ( f1_arg0, f1_arg1 )
	local f1_local0 = DataSources
	if f1_local0 then
		f1_local0 = DataSources.LiveEventViewer
		if f1_local0 then
			f1_local0 = DataSources.LiveEventViewer.getModel()
		end
	end
	if f1_local0 then
		local f1_local1 = Engine.GetModel( f1_local0, "currentQuality" )
		if f1_local1 then
			f1_arg0:subscribeToModel( f1_local1, function ( model )
				local f2_local0 = f1_arg0.Xbtn:getModel()
				if f2_local0 then
					f2_local0 = Engine.GetModel( f2_local0, "Label" )
				end
				if f2_local0 then
