...
CoD.Demo.new = function ( menu, controller )
	...
	self:subscribeToModel( Engine.GetModel( Engine.GetGlobalModel(), "demo.contextMode" ), function ( model )
		...
		CoD.Menu.UpdateButtonShownState( f23_local0, menu, controller, Enum.LUIButton.LUI_KEY_XBY_PSTRIANGLE )
		CoD.Menu.UpdateButtonShownState( f23_local0, menu, controller, Enum.LUIButton.LUI_KEY_XBX_PSSQUARE )
		...
		CoD.Menu.UpdateButtonShownState( f23_local0, menu, controller, Enum.LUIButton.LUI_KEY_LB )
		CoD.Menu.UpdateButtonShownState( f23_local0, menu, controller, Enum.LUIButton.LUI_KEY_RB )
	end )
	self:subscribeToModel( Engine.GetModel( Engine.GetGlobalModel(), "demo.clipState" ), function ( model )
		...
		CoD.Menu.UpdateButtonShownState( f24_local0, menu, controller, Enum.LUIButton.LUI_KEY_LTRIG )
		CoD.Menu.UpdateButtonShownState( f24_local0, menu, controller, Enum.LUIButton.LUI_KEY_RTRIG )
		CoD.Menu.UpdateButtonShownState( f24_local0, menu, controller, Enum.LUIButton.LUI_KEY_LSTICK_PRESSED )
	...
	self:subscribeToModel( Engine.GetModel( Engine.GetGlobalModel(), "demo.isCreatingHighlightReel" ), function ( model )
		...
		CoD.Menu.UpdateButtonShownState( f25_local0, menu, controller, Enum.LUIButton.LUI_KEY_LB )
		CoD.Menu.UpdateButtonShownState( f25_local0, menu, controller, Enum.LUIButton.LUI_KEY_RB )
	end )
	...
	self:subscribeToModel( Engine.GetModel( Engine.GetGlobalModel(), "demo.highlightedLightmanMarker" ), function ( model )
		...
		CoD.Menu.UpdateButtonShownState( f30_local0, menu, controller, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE )
		CoD.Menu.UpdateButtonShownState( f30_local0, menu, controller, Enum.LUIButton.LUI_KEY_RSTICK_PRESSED )
	end )
	self:subscribeToModel( Engine.GetModel( Engine.GetGlobalModel(), "demo.editingLightmanMarker" ), function ( model )
	...
	self:subscribeToModel( Engine.GetModel( Engine.GetGlobalModel(), "demo.isRepositioningDollyCamMarker" ), function ( model )
		...
		CoD.Menu.UpdateButtonShownState( f33_local0, menu, controller, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE )
	end )
	...
	self:subscribeToModel( Engine.GetModel( Engine.GetGlobalModel(), "demo.isRepositioningLightmanMarker" ), function ( model )
		...
		CoD.Menu.UpdateButtonShownState( f37_local0, menu, controller, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE )
	end )
	self:subscribeToModel( Engine.GetModel( Engine.GetGlobalModel(), "demo.showLightmanColorPicker" ), function ( model )
	...
	self:subscribeToModel( Engine.GetModel( Engine.GetGlobalModel(), "demo.cameraMode" ), function ( model )
		...
		CoD.Menu.UpdateButtonShownState( f39_local0, menu, controller, Enum.LUIButton.LUI_KEY_LB )
		CoD.Menu.UpdateButtonShownState( f39_local0, menu, controller, Enum.LUIButton.LUI_KEY_RB )
	end )
	...
	menu:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_LSTICK_PRESSED, nil, function ( element, menu, controller, model )
		if not IsDemoClipPreviewRunning() and not IsDemoCreatingHighlightReel() and not IsDemoCapturingScreenshot() then
