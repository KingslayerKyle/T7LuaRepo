			...
			DefaultClip = function ()
				...
				local f13_local1 = function ( f15_arg0, f15_arg1 )
					if not f15_arg1.interrupted then
						f15_arg0:beginAnimation( "keyframe", 200, false, false, CoD.TweenType.Bounce )
					end
					f15_arg0:setAlpha( 1 )
				...
				frequencyLabel:registerEventHandler( "transition_complete_keyframe", f13_local1 )
				local f13_local2 = function ( f16_arg0, f16_arg1 )
					if not f16_arg1.interrupted then
						f16_arg0:beginAnimation( "keyframe", 89, false, false, CoD.TweenType.Bounce )
					end
				...
				keyline1:setAlpha( 0 )
				keyline1:registerEventHandler( "transition_complete_keyframe", f13_local2 )
