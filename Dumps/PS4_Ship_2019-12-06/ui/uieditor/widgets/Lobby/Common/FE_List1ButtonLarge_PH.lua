...
CoD.FE_List1ButtonLarge_PH.new = function ( menu, controller )
	...
	local FE_VialBreadcrumb = CoD.FE_VialBreadcrumb.new( menu, controller )
	FE_VialBreadcrumb:setLeftRight( false, true, 4, 27 )
	FE_VialBreadcrumb:setTopBottom( false, false, -11.5, 11.5 )
	FE_VialBreadcrumb:setAlpha( 0 )
	self:addElement( FE_VialBreadcrumb )
	self.FE_VialBreadcrumb = FE_VialBreadcrumb
	...
	self.clipsPerState = {
		DefaultState = {
			DefaultClip = function ()
				...
				FE_VialBreadcrumb:completeAnimation()
				self.FE_VialBreadcrumb:setAlpha( 0 )
				self.clipFinished( FE_VialBreadcrumb, {} )
			end,
			Focus = function ()
		...
		HaveNewBlackMarketPromo = {
			...
			Intro = function ()
				...
				local FEBlackMarketSpecialBreadcrumbFrame2 = function ( FEBlackMarketSpecialBreadcrumb, event )
					if not event.interrupted then
						FEBlackMarketSpecialBreadcrumb:beginAnimation( "keyframe", 219, false, false, CoD.TweenType.Linear )
					end
		...
		HaveVials = {
			DefaultClip = function ()
				...
				self.clipFinished( Glow2, {} )
				FE_VialBreadcrumb:completeAnimation()
				self.FE_VialBreadcrumb:setAlpha( 1 )
				self.clipFinished( FE_VialBreadcrumb, {} )
			end,
			Focus = function ()
				self:setupElementClipCounter( 10 )
	...
	LUI.OverrideFunction_CallOriginalSecond( self, "close", function ( element )
		...
		element.FE_VialBreadcrumb:close()
