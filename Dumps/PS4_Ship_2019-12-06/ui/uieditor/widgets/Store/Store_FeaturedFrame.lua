...
CoD.Store_FeaturedFrame.new = function ( menu, controller )
	...
	menu:AddButtonCallbackFunction( button2, controller, Enum.LUIButton.LUI_KEY_XBY_PSTRIANGLE, "F", function ( element, menu, controller, model )
		if IsSelfModelValueNonEmptyString( element, controller, "videoHighResRef" ) and IsElementPropertyValue( element, "frameWidgetName", "StoreVideoProductButtonMovieWidget" ) then
			OpenStoreFeatureFrameVOD( self, element, controller )
			return true
		else
	...
	menu:AddButtonCallbackFunction( button6, controller, Enum.LUIButton.LUI_KEY_XBY_PSTRIANGLE, "F", function ( element, menu, controller, model )
		if IsSelfModelValueNonEmptyString( element, controller, "videoHighResRef" ) and IsElementPropertyValue( element, "frameWidgetName", "StoreVideoProductButtonMovieWidget" ) then
			OpenStoreFeatureFrameVOD( self, element, controller )
			return true
		else
	...
	menu:AddButtonCallbackFunction( button3, controller, Enum.LUIButton.LUI_KEY_XBY_PSTRIANGLE, "F", function ( element, menu, controller, model )
		if IsSelfModelValueNonEmptyString( element, controller, "videoHighResRef" ) and IsElementPropertyValue( element, "frameWidgetName", "StoreVideoProductButtonMovieWidget" ) then
			OpenStoreFeatureFrameVOD( self, element, controller )
			return true
		else
	...
	menu:AddButtonCallbackFunction( button1, controller, Enum.LUIButton.LUI_KEY_XBY_PSTRIANGLE, "F", function ( element, menu, controller, model )
		if IsSelfModelValueNonEmptyString( element, controller, "videoHighResRef" ) and IsElementPropertyValue( element, "frameWidgetName", "StoreFeaturePreviewMovieWidget" ) then
			OpenStoreFeatureFrameVOD( self, element, controller )
			return true
		else
	...
	menu:AddButtonCallbackFunction( button5, controller, Enum.LUIButton.LUI_KEY_XBY_PSTRIANGLE, "F", function ( element, menu, controller, model )
		if IsSelfModelValueNonEmptyString( element, controller, "videoHighResRef" ) and IsElementPropertyValue( element, "frameWidgetName", "StoreVideoProductButtonMovieWidget" ) then
			OpenStoreFeatureFrameVOD( self, element, controller )
			return true
		else
	...
	menu:AddButtonCallbackFunction( button4, controller, Enum.LUIButton.LUI_KEY_XBY_PSTRIANGLE, "F", function ( element, menu, controller, model )
		if IsSelfModelValueNonEmptyString( element, controller, "videoHighResRef" ) and IsElementPropertyValue( element, "frameWidgetName", "StoreVideoProductButtonMovieWidget" ) then
			OpenStoreFeatureFrameVOD( self, element, controller )
			return true
		else
