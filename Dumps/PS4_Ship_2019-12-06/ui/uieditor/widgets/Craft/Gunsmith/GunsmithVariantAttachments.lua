...
CoD.GunsmithVariantAttachments.new = function ( menu, controller )
	...
	Optic:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				...
				if not IsSelfModelValueEqualTo( element, controller, "attachment1", 0 ) then
					f14_local0 = IsGunsmithReticleAllowedForOptic( menu, element, controller, "attachment1" )
				else
					f14_local0 = false
				end
				return f14_local0
		...
		},
		{
			...
			condition = function ( menu, element, event )
				local f15_local0
				if not IsSelfModelValueEqualTo( element, controller, "attachment1", 0 ) then
					f15_local0 = not IsGunsmithReticleAllowedForOptic( menu, element, controller, "attachment1" )
				else
					f15_local0 = false
				end
				return f15_local0
	...
	Attachment1:linkToElementModel( Attachment1, "attachment2", true, function ( model )
		...
		CoD.Menu.UpdateButtonShownState( f19_local0, menu, controller, Enum.LUIButton.LUI_KEY_XBY_PSTRIANGLE )
	end )
	...
	Attachment1:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				...
				if not IsSelfModelValueEqualTo( element, controller, "attachment2", 0 ) then
					f29_local0 = Gunsmith_DoesACVExistForAttachment( menu, element, controller, "attachment2" )
				else
					f29_local0 = false
				end
				return f29_local0
	...
	Attachment2:linkToElementModel( Attachment2, "attachment3", true, function ( model )
		...
		CoD.Menu.UpdateButtonShownState( f34_local0, menu, controller, Enum.LUIButton.LUI_KEY_XBY_PSTRIANGLE )
	end )
	...
	Attachment2:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				...
				if not IsSelfModelValueEqualTo( element, controller, "attachment3", 0 ) then
					f44_local0 = Gunsmith_DoesACVExistForAttachment( menu, element, controller, "attachment3" )
				else
					f44_local0 = false
				end
				return f44_local0
	...
	Attachment3:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				...
				if not IsSelfModelValueEqualTo( element, controller, "attachment4", 0 ) then
					f59_local0 = Gunsmith_DoesACVExistForAttachment( menu, element, controller, "attachment4" )
				else
					f59_local0 = false
				end
				return f59_local0
	...
	Attachment4:linkToElementModel( Attachment4, "attachment5", true, function ( model )
		...
		CoD.Menu.UpdateButtonShownState( f64_local0, menu, controller, Enum.LUIButton.LUI_KEY_XBX_PSSQUARE )
		CoD.Menu.UpdateButtonShownState( f64_local0, menu, controller, Enum.LUIButton.LUI_KEY_XBY_PSTRIANGLE )
	end )
	...
	Attachment4:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				...
				if not IsSelfModelValueEqualTo( element, controller, "attachment5", 0 ) then
					f74_local0 = Gunsmith_DoesACVExistForAttachment( menu, element, controller, "attachment5" )
				else
					f74_local0 = false
				end
				return f74_local0
	...
	Attachment5:linkToElementModel( Attachment5, "attachment6", true, function ( model )
		...
		CoD.Menu.UpdateButtonShownState( f79_local0, menu, controller, Enum.LUIButton.LUI_KEY_XBX_PSSQUARE )
		CoD.Menu.UpdateButtonShownState( f79_local0, menu, controller, Enum.LUIButton.LUI_KEY_XBY_PSTRIANGLE )
	end )
	Attachment5:registerEventHandler( "gunsmith_remove_item", function ( element, event )
		...
		if not f80_local0 then
			f80_local0 = element:dispatchEventToChildren( event )
		end
		return f80_local0
	end )
	...
	Attachment5:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				...
				if not IsSelfModelValueEqualTo( element, controller, "attachment6", 0 ) then
					f89_local0 = Gunsmith_DoesACVExistForAttachment( menu, element, controller, "attachment6" )
				else
					f89_local0 = false
				end
				return f89_local0
	...
	paintjob:linkToElementModel( paintjob, "paintjobIndex", true, function ( model )
		...
		CoD.Menu.UpdateButtonShownState( f93_local0, menu, controller, Enum.LUIButton.LUI_KEY_XBX_PSSQUARE )
	end )
	paintjob:linkToElementModel( paintjob, "paintjobSlot", true, function ( model )
		local f94_local0 = paintjob
		local f94_local1 = {
			controller = controller,
			name = "model_validation",
			modelValue = Engine.GetModelValue( model ),
		...
		CoD.Menu.UpdateButtonShownState( f94_local0, menu, controller, Enum.LUIButton.LUI_KEY_XBX_PSSQUARE )
	end )
	paintjob:registerEventHandler( "gunsmith_remove_item", function ( element, event )
		...
		if not f95_local0 then
			f95_local0 = element:dispatchEventToChildren( event )
		end
		return f95_local0
	end )
	paintjob:registerEventHandler( "gain_focus", function ( element, event )
		...
		if element.gainFocus then
			f96_local0 = element:gainFocus( event )
		elseif element.super.gainFocus then
			f96_local0 = element.super:gainFocus( event )
		end
	...
	paintjob:registerEventHandler( "lose_focus", function ( element, event )
		...
		if element.loseFocus then
			f97_local0 = element:loseFocus( event )
		elseif element.super.loseFocus then
			f97_local0 = element.super:loseFocus( event )
		end
		return f97_local0
	end )
		...
		},
		{
			...
			condition = function ( menu, element, event )
				...
				if not IsSelfModelValueEqualTo( element, controller, "paintjobSlot", 15 ) then
					f103_local0 = not IsSelfModelValueEqualTo( element, controller, "paintjobIndex", 15 )
				else
					f103_local0 = false
				end
				return f103_local0
	...
	Camo:linkToElementModel( Camo, "camoIndex", true, function ( model )
		...
		CoD.Menu.UpdateButtonShownState( f108_local0, menu, controller, Enum.LUIButton.LUI_KEY_XBX_PSSQUARE )
	end )
	Camo:registerEventHandler( "gunsmith_remove_item", function ( element, event )
		...
		if not f109_local0 then
			f109_local0 = element:dispatchEventToChildren( event )
		end
		return f109_local0
	end )
	Camo:registerEventHandler( "gain_focus", function ( element, event )
		...
		if element.gainFocus then
			f110_local0 = element:gainFocus( event )
		elseif element.super.gainFocus then
			f110_local0 = element.super:gainFocus( event )
		end
	...
	Camo:registerEventHandler( "lose_focus", function ( element, event )
		...
		if element.loseFocus then
			f111_local0 = element:loseFocus( event )
		elseif element.super.loseFocus then
			f111_local0 = element.super:loseFocus( event )
		end
		return f111_local0
	end )
	...
	snapshot:registerEventHandler( "lose_focus", function ( element, event )
		...
		if element.loseFocus then
			f137_local0 = element:loseFocus( event )
		elseif element.super.loseFocus then
			f137_local0 = element.super:loseFocus( event )
		end
		return f137_local0
	end )
