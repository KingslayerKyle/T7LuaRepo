...
CoD.SystemOverlay_MegaChew.new = function ( menu, controller )
	...
	menu:AddButtonCallbackFunction( optionsVertical, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( element, menu, controller, model )
	...
	menu:AddButtonCallbackFunction( optionsVertical, controller, Enum.LUIButton.LUI_KEY_XBX_PSSQUARE, nil, function ( element, menu, controller, model )
		if IsElementPropertyValue( element, "showStoreButton", true ) then
			MegaChewOpenCodPointsStore( self, element, controller, "menuName", menu )
			return true
		else
	...
	menu:AddButtonCallbackFunction( optionsHorizontal, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( element, menu, controller, model )
		if not IsDisabled( element, controller ) then
			ProcessListAction( self, element, controller )
			return true
		else
	...
	menu:AddButtonCallbackFunction( optionsHorizontal, controller, Enum.LUIButton.LUI_KEY_XBX_PSSQUARE, nil, function ( element, menu, controller, model )
		if IsElementPropertyValue( element, "showStoreButton", true ) then
			MegaChewOpenCodPointsStore( self, element, controller, "menuName", menu )
			return true
		else
	...
	self:registerEventHandler( "gain_focus", function ( self, event )
		if self.m_focusable and self.optionsVertical:processEvent( event ) then
			return true
		else
