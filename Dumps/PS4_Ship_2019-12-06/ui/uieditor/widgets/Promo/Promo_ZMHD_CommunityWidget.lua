...
CoD.Promo_ZMHD_CommunityWidget.new = function ( menu, controller )
	...
	local PromoZMHDThermometerAndRewards0 = CoD.Promo_ZMHD_ThermometerAndRewards.new( menu, controller )
	PromoZMHDThermometerAndRewards0:setLeftRight( true, false, 736.94, 1084.94 )
	PromoZMHDThermometerAndRewards0:setTopBottom( true, false, 66.67, 504.67 )
	PromoZMHDThermometerAndRewards0:setScale( 0.9 )
	PromoZMHDThermometerAndRewards0:subscribeToGlobalModel( controller, "ZMHDPromoRewardList", nil, function ( model )
		PromoZMHDThermometerAndRewards0:setModel( model, controller )
	end )
	self:addElement( PromoZMHDThermometerAndRewards0 )
	self.PromoZMHDThermometerAndRewards0 = PromoZMHDThermometerAndRewards0
	...
	RewardsText:setText( Engine.Localize( "CONTRACT_COMMUNITY_ZMHD_TOTAL_REQUIREMENT" ) )
	...
	LUI.OverrideFunction_CallOriginalSecond( self, "close", function ( element )
		element.PromoZMHDThermometerAndRewards0:close()
