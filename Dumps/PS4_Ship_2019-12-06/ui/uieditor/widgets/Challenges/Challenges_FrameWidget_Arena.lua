...
CoD.Challenges_FrameWidget_Arena.new = function ( menu, controller )
	...
	menu:AddButtonCallbackFunction( ArenaVetButton, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( element, menu, controller, model )
		SetGlobalModelValue( "challengeCategory", "arenavet" )
		OpenPopup( self, "Challenges_Arena", controller, "", "" )
		return true
	...
	menu:AddButtonCallbackFunction( ArenaBestButton, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( element, menu, controller, model )
	...
	self:registerEventHandler( "gain_focus", function ( self, event )
		if self.m_focusable and self.ArenaVetButton:processEvent( event ) then
			return true
		else
