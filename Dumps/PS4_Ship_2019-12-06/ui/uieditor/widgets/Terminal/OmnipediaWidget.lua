			...
			BookMark_Nav = function ()
				...
				local f3_local3 = function ( f7_arg0, f7_arg1 )
					if not f7_arg1.interrupted then
						f7_arg0:beginAnimation( "keyframe", 159, false, false, CoD.TweenType.Linear )
					end
					f7_arg0:setLeftRight( true, false, 31, 870 )
					f7_arg0:setTopBottom( true, false, 412.5, 548.5 )
					f7_arg0:setAlpha( 1 )
				...
				BookmarksList:setAlpha( 0 )
				BookmarksList:registerEventHandler( "transition_complete_keyframe", f3_local3 )
			end,
			BookMark_Close = function ()
				self:setupElementClipCounter( 4 )
				local f8_local0 = function ( f9_arg0, f9_arg1 )
					if not f9_arg1.interrupted then
						f9_arg0:beginAnimation( "keyframe", 300, false, false, CoD.TweenType.Linear )
					end
					f9_arg0:setLeftRight( true, false, 21.37, 879 )
					f9_arg0:setTopBottom( true, false, 40, 541.5 )
				...
				BinaryHTML0:setLeftRight( true, false, 21.37, 879 )
				BinaryHTML0:setTopBottom( true, false, 40, 388.5 )
				BinaryHTML0:registerEventHandler( "transition_complete_keyframe", f8_local0 )
				local f8_local1 = function ( f10_arg0, f10_arg1 )
					if not f10_arg1.interrupted then
						f10_arg0:beginAnimation( "keyframe", 300, false, false, CoD.TweenType.Linear )
					end
					f10_arg0:setLeftRight( true, false, 129.62, 833.06 )
					f10_arg0:setTopBottom( true, false, 546.11, 553.11 )
				...
				Frameline000:setLeftRight( true, false, 129, 832.44 )
				Frameline000:setTopBottom( true, false, 388.5, 395.5 )
				Frameline000:registerEventHandler( "transition_complete_keyframe", f8_local1 )
				local f8_local2 = function ( f11_arg0, f11_arg1 )
					if not f11_arg1.interrupted then
						f11_arg0:beginAnimation( "keyframe", 300, false, false, CoD.TweenType.Linear )
					end
					f11_arg0:setLeftRight( true, false, 106.4, 885.99 )
					f11_arg0:setTopBottom( true, false, 546.11, 553.11 )
				...
				Frameline0002:setLeftRight( true, false, 105.79, 885.37 )
				Frameline0002:setTopBottom( true, false, 388.5, 395.5 )
				Frameline0002:registerEventHandler( "transition_complete_keyframe", f8_local2 )
