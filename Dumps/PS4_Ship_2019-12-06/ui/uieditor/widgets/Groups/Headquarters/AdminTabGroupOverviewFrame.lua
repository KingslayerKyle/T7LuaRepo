...
CoD.AdminTabGroupOverviewFrame.new = function ( menu, controller )
	...
	menu:AddButtonCallbackFunction( EmblemButton, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( element, menu, controller, model )
		if IsLive() and not IsUserContentRestricted( controller ) and HasAdminPrivilege( controller, Enum.GroupAdminPrivilege.GROUP_ADMIN_PRIVILEGE_EDIT_GROUP_EMBLEM ) then
	...
	menu:AddButtonCallbackFunction( GroupsInputButtonScroll, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, nil, function ( element, menu, controller, model )
		if HasAdminPrivilege( controller, Enum.GroupAdminPrivilege.GROUP_ADMIN_PRIVILEGE_EDIT_GROUP_MESSAGE ) then
	...
	menu:AddButtonCallbackFunction( GroupsInputButtonScroll0, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, nil, function ( element, menu, controller, model )
		if HasAdminPrivilege( controller, Enum.GroupAdminPrivilege.GROUP_ADMIN_PRIVILEGE_EDIT_GROUP_MESSAGE ) then
	...
	self:registerEventHandler( "gain_focus", function ( self, event )
		if self.m_focusable and self.GroupsInputButtonScroll0:processEvent( event ) then
			return true
		else
