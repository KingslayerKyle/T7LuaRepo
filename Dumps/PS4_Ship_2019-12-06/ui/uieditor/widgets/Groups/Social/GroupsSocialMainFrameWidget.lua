...
CoD.GroupsSocialMainFrameWidget.new = function ( menu, controller )
	...
	menu:AddButtonCallbackFunction( ButtonList, controller, Enum.LUIButton.LUI_KEY_START, nil, function ( element, menu, controller, model )
		if ListHasElements( element ) then
			SetSelectedGroup( self, element, controller )
	...
	menu:AddButtonCallbackFunction( InvitesButton, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, nil, function ( element, menu, controller, model )
		if HasPendingInvites( controller ) then
			NavigateToMenu( self, "GroupInvites", true, controller )
			return true
		else
	...
	menu:AddButtonCallbackFunction( GroupsSocialMainFindButton, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, nil, function ( element, menu, controller, model )
		NavigateToMenu( self, "FindGroups", true, controller )
		return true
	end, function ( element, menu, controller )
		CoD.Menu.SetButtonLabel( menu, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "menu_select" )
		return true
	...
	self:registerEventHandler( "gain_focus", function ( self, event )
		if self.m_focusable and self.GroupsSocialMainFindButton:processEvent( event ) then
			return true
		else
