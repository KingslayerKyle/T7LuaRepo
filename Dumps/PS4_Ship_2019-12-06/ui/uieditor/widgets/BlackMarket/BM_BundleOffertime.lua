...
CoD.BM_BundleOffertime.new = function ( menu, controller )
	...
	BMBribeOfferTime:subscribeToGlobalModel( controller, "AutoeventsBribeTimer", "autoevent_timer_lootbundle_promo", function ( model )
		local autoeventTimerLootbundlePromo = Engine.GetModelValue( model )
		if autoeventTimerLootbundlePromo then
			BMBribeOfferTime.BribeOfferTime:setText( LocalizeIntoString( "MPUI_BM_BRIBE_END_TIME", autoeventTimerLootbundlePromo ) )
		end
	end )
	...
	BMHundredBundleOfferTime:subscribeToGlobalModel( controller, "AutoeventsBribeTimer", "autoevent_timer_rare100", function ( model )
		local autoeventTimerRare100 = Engine.GetModelValue( model )
		if autoeventTimerRare100 then
			BMHundredBundleOfferTime.BribeOfferTime:setText( LocalizeIntoString( "MPUI_BM_BRIBE_END_TIME", autoeventTimerRare100 ) )
		end
	end )
