...
local PostLoadFunc = function ( self, controller, menu )
	...
	local f1_local3 = {
		CoD.BlackMarketUtility.winter_challenge_sentinel_tier1,
		CoD.BlackMarketUtility.winter_challenge_sentinel_tier2,
		CoD.BlackMarketUtility.winter_challenge_sentinel_tier3,
		CoD.BlackMarketUtility.winter_challenge_sentinel_tier4
	}
			...
			if f3_local6 then
				...
				if f3_local5.completeValue <= f3_arg0 then
					if f3_local6.currentState ~= "Complete" then
						...
						if Engine.GetInventoryItemQuantity( controller, f1_local3[f3_local5.rewardWidgetIndex] ) == 0 and f3_local3 then
...
CoD.Winter_Community_Thermometer.new = function ( menu, controller )
	...
	Chip:setImage( RegisterImage( "uie_t7_menu_community_winter_chip" ) )
	...
	RewardWidget0.PromoRewardImage.Image:setImage( RegisterImage( "uie_t7_menu_community_winter_tier02" ) )
	RewardWidget0.TextBox0:setText( Engine.Localize( "MPUI_RARE_SUPPLY_DROP_BUNDLE" ) )
	...
	RewardWidget1.PromoRewardImage.Image:setImage( RegisterImage( "uie_t7_menu_community_winter_tier02" ) )
	RewardWidget1.TextBox0:setText( Engine.Localize( "MPUI_RARE_SUPPLY_DROP_BUNDLE" ) )
	...
	RewardWidget2.PromoRewardImage.Image:setImage( RegisterImage( "uie_t7_menu_community_winter_tier03" ) )
	RewardWidget2.TextBox0:setText( Engine.Localize( "MPUI_BM_BRIBE_MELEE_WEAPON" ) )
	...
	RewardWidget3.PromoRewardImage.Image:setImage( RegisterImage( "uie_t7_menu_community_winter_tier04" ) )
	RewardWidget3.TextBox0:setText( Engine.Localize( "MPUI_BM_BRIBE_RANGE_WEAPON" ) )
	...
	menu:AddButtonCallbackFunction( RedeemBtn0, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, nil, function ( element, menu, controller, model )
		if IsSelfInState( self, "DefaultState" ) then
			RedeemWinterRewardAction( self, controller, menu, "1" )
			MakeElementNotFocusable( self, "RedeemBtn0", controller )
			HideElement( self, "RedeemBtn0" )
			return true
		else
	...
	menu:AddButtonCallbackFunction( RedeemBtn1, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, nil, function ( element, menu, controller, model )
		if IsSelfInState( self, "DefaultState" ) then
			RedeemWinterRewardAction( self, controller, menu, "2" )
			MakeElementNotFocusable( self, "RedeemBtn1", controller )
			HideElement( self, "RedeemBtn1" )
			return true
		else
	...
	menu:AddButtonCallbackFunction( RedeemBtn2, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, nil, function ( element, menu, controller, model )
		if IsSelfInState( self, "DefaultState" ) then
			RedeemWinterRewardAction( self, controller, menu, "3" )
			MakeElementNotFocusable( self, "RedeemBtn2", controller )
			HideElement( self, "RedeemBtn2" )
			return true
		else
	...
	menu:AddButtonCallbackFunction( RedeemBtn3, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, nil, function ( element, menu, controller, model )
		if IsSelfInState( self, "DefaultState" ) then
			RedeemWinterRewardAction( self, controller, menu, "4" )
			MakeElementNotFocusable( self, "RedeemBtn3", controller )
			HideElement( self, "RedeemBtn3" )
			return true
		else
	...
	self:registerEventHandler( "gain_focus", function ( self, event )
		if self.m_focusable and self.RedeemBtn0:processEvent( event ) then
			return true
		else
