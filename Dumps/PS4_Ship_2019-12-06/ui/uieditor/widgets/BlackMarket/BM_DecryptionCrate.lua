...
CoD.BM_DecryptionCrate.new = function ( menu, controller )
	...
	RareBundle10for5Count:subscribeToGlobalModel( controller, "CryptoKeyProgress", "hundredBundles", function ( model )
		local hundredBundles = Engine.GetModelValue( model )
		if hundredBundles then
			RareBundle10for5Count:setText( Engine.Localize( SetValueIfNumberIsLessThanOrEqualTo( 0, "0", hundredBundles ) ) )
		end
	end )
