...
CoD.Zombie.InitInventoryUIModels = function ( f10_arg0 )
	Engine.SetModelValue( Engine.CreateModel( Engine.GetModelForController( f10_arg0 ), "zmInventory." .. CoD.Zombie.ZOD_CRAFTABLE_IDGUN .. "_" .. CoD.Zombie.ZOD_CRAFTABLE_PIECE_IDGUN_HEART ), 0 )
	Engine.SetModelValue( Engine.CreateModel( Engine.GetModelForController( f10_arg0 ), "zmInventory." .. CoD.Zombie.ZOD_CRAFTABLE_IDGUN .. "_" .. CoD.Zombie.ZOD_CRAFTABLE_PIECE_IDGUN_SKELETON ), 0 )
	Engine.SetModelValue( Engine.CreateModel( Engine.GetModelForController( f10_arg0 ), "zmInventory." .. CoD.Zombie.ZOD_CRAFTABLE_IDGUN .. "_" .. CoD.Zombie.ZOD_CRAFTABLE_PIECE_IDGUN_XENOMATTER ), 0 )
	Engine.SetModelValue( Engine.CreateModel( Engine.GetModelForController( f10_arg0 ), "zmInventory." .. CoD.Zombie.ZOD_CRAFTABLE_SECOND_IDGUN .. "_" .. CoD.Zombie.ZOD_CRAFTABLE_PIECE_SECOND_IDGUN_HEART ), 0 )
	Engine.SetModelValue( Engine.CreateModel( Engine.GetModelForController( f10_arg0 ), "zmInventory." .. CoD.Zombie.ZOD_CRAFTABLE_SECOND_IDGUN .. "_" .. CoD.Zombie.ZOD_CRAFTABLE_PIECE_SECOND_IDGUN_SKELETON ), 0 )
	Engine.SetModelValue( Engine.CreateModel( Engine.GetModelForController( f10_arg0 ), "zmInventory." .. CoD.Zombie.ZOD_CRAFTABLE_SECOND_IDGUN .. "_" .. CoD.Zombie.ZOD_CRAFTABLE_PIECE_SECOND_IDGUN_XENOMATTER ), 0 )
	Engine.SetModelValue( Engine.CreateModel( Engine.GetModelForController( f10_arg0 ), "zmInventory." .. CoD.Zombie.ZOD_CRAFTABLE_POLICE_BOX .. "_" .. CoD.Zombie.ZOD_CRAFTABLE_POLICE_BOX_FUSE_1 ), 0 )
	Engine.SetModelValue( Engine.CreateModel( Engine.GetModelForController( f10_arg0 ), "zmInventory." .. CoD.Zombie.ZOD_CRAFTABLE_POLICE_BOX .. "_" .. CoD.Zombie.ZOD_CRAFTABLE_POLICE_BOX_FUSE_2 ), 0 )
	Engine.SetModelValue( Engine.CreateModel( Engine.GetModelForController( f10_arg0 ), "zmInventory." .. CoD.Zombie.ZOD_CRAFTABLE_POLICE_BOX .. "_" .. CoD.Zombie.ZOD_CRAFTABLE_POLICE_BOX_FUSE_3 ), 0 )
	Engine.SetModelValue( Engine.CreateModel( Engine.GetModelForController( f10_arg0 ), "zmInventory." .. CoD.Zombie.CLIENTFIELD_CRAFTABLE_PIECE_RIOTSHIELD_DOLLY ), 0 )
	Engine.SetModelValue( Engine.CreateModel( Engine.GetModelForController( f10_arg0 ), "zmInventory." .. CoD.Zombie.CLIENTFIELD_CRAFTABLE_PIECE_RIOTSHIELD_DOOR ), 0 )
	Engine.SetModelValue( Engine.CreateModel( Engine.GetModelForController( f10_arg0 ), "zmInventory." .. CoD.Zombie.CLIENTFIELD_CRAFTABLE_PIECE_RIOTSHIELD_CLAMP ), 0 )
	Engine.SetModelValue( Engine.CreateModel( Engine.GetModelForController( f10_arg0 ), "zmInventory." .. CoD.Zombie.CLIENTFIELD_ZOD_CRAFTABLE_PIECE_QUEST_KEY ), 0 )
	Engine.SetModelValue( Engine.CreateModel( Engine.GetModelForController( f10_arg0 ), "zmInventory." .. CoD.Zombie.CLIENTFIELD_QUEST_STATE_BASE .. CoD.Zombie.ZOD_NAME_BOXER ), 0 )
	Engine.SetModelValue( Engine.CreateModel( Engine.GetModelForController( f10_arg0 ), "zmInventory." .. CoD.Zombie.CLIENTFIELD_QUEST_STATE_BASE .. CoD.Zombie.ZOD_NAME_DETECTIVE ), 0 )
	Engine.SetModelValue( Engine.CreateModel( Engine.GetModelForController( f10_arg0 ), "zmInventory." .. CoD.Zombie.CLIENTFIELD_QUEST_STATE_BASE .. CoD.Zombie.ZOD_NAME_FEMME ), 0 )
	Engine.SetModelValue( Engine.CreateModel( Engine.GetModelForController( f10_arg0 ), "zmInventory." .. CoD.Zombie.CLIENTFIELD_QUEST_STATE_BASE .. CoD.Zombie.ZOD_NAME_MAGICIAN ), 0 )
	Engine.SetModelValue( Engine.CreateModel( Engine.GetModelForController( f10_arg0 ), "zmInventory." .. CoD.Zombie.CLIENTFIELD_QUEST_STATE_BASE .. CoD.Zombie.ZOD_NAME_PAP ), 0 )
	Engine.SetModelValue( Engine.CreateModel( Engine.GetModelForController( f10_arg0 ), "zmInventory." .. CoD.Zombie.CLIENTFIELD_HOLDER_OF_BASE .. CoD.Zombie.ZOD_NAME_BOXER ), 0 )
	Engine.SetModelValue( Engine.CreateModel( Engine.GetModelForController( f10_arg0 ), "zmInventory." .. CoD.Zombie.CLIENTFIELD_HOLDER_OF_BASE .. CoD.Zombie.ZOD_NAME_DETECTIVE ), 0 )
	Engine.SetModelValue( Engine.CreateModel( Engine.GetModelForController( f10_arg0 ), "zmInventory." .. CoD.Zombie.CLIENTFIELD_HOLDER_OF_BASE .. CoD.Zombie.ZOD_NAME_FEMME ), 0 )
	Engine.SetModelValue( Engine.CreateModel( Engine.GetModelForController( f10_arg0 ), "zmInventory." .. CoD.Zombie.CLIENTFIELD_HOLDER_OF_BASE .. CoD.Zombie.ZOD_NAME_MAGICIAN ), 0 )
	Engine.SetModelValue( Engine.CreateModel( Engine.GetModelForController( f10_arg0 ), "zmInventory." .. CoD.Zombie.CLIENTFIELD_HOLDER_OF_BASE .. CoD.Zombie.ZOD_NAME_PAP ), 0 )
	Engine.SetModelValue( Engine.CreateModel( Engine.GetModelForController( f10_arg0 ), "zmInventory." .. CoD.Zombie.CLIENTFIELD_CHECK_BASE .. CoD.Zombie.ZOD_NAME_BOXER .. CoD.Zombie.MEMENTO_SUFFIX ), 0 )
	Engine.SetModelValue( Engine.CreateModel( Engine.GetModelForController( f10_arg0 ), "zmInventory." .. CoD.Zombie.CLIENTFIELD_CHECK_BASE .. CoD.Zombie.ZOD_NAME_DETECTIVE .. CoD.Zombie.MEMENTO_SUFFIX ), 0 )
	Engine.SetModelValue( Engine.CreateModel( Engine.GetModelForController( f10_arg0 ), "zmInventory." .. CoD.Zombie.CLIENTFIELD_CHECK_BASE .. CoD.Zombie.ZOD_NAME_FEMME .. CoD.Zombie.MEMENTO_SUFFIX ), 0 )
	Engine.SetModelValue( Engine.CreateModel( Engine.GetModelForController( f10_arg0 ), "zmInventory." .. CoD.Zombie.CLIENTFIELD_CHECK_BASE .. CoD.Zombie.ZOD_NAME_MAGICIAN .. CoD.Zombie.MEMENTO_SUFFIX ), 0 )
	Engine.SetModelValue( Engine.CreateModel( Engine.GetModelForController( f10_arg0 ), "zmInventory." .. CoD.Zombie.USED_QUEST_KEY ), 0 )
	Engine.SetModelValue( Engine.CreateModel( Engine.GetModelForController( f10_arg0 ), "zmInventory." .. CoD.Zombie.USED_QUEST_KEY_LOCATION ), 0 )
	Engine.SetModelValue( Engine.CreateModel( Engine.GetModelForController( f10_arg0 ), "zmInventory." .. CoD.Zombie.POD_SPRAYER_HINT_RANGE ), 0 )
	Engine.SetModelValue( Engine.CreateModel( Engine.GetModelForController( f10_arg0 ), "zmInventory." .. CoD.Zombie.POD_SPRAYER_HELD ), 0 )
	Engine.SetModelValue( Engine.CreateModel( Engine.GetModelForController( f10_arg0 ), "zmInventory." .. CoD.Zombie.PLAYER_USING_SPRAYER ), 0 )
	Engine.SetModelValue( Engine.CreateModel( Engine.GetModelForController( f10_arg0 ), "zmInventory." .. CoD.Zombie.PLAYER_CHARACTER_IDENTITY ), 0 )
	Engine.SetModelValue( Engine.CreateModel( Engine.GetModelForController( f10_arg0 ), "zmInventory." .. CoD.Zombie.PLAYER_CRAFTED_FUSEBOX ), 0 )
	Engine.SetModelValue( Engine.CreateModel( Engine.GetModelForController( f10_arg0 ), "zmInventory." .. CoD.Zombie.PLAYER_CRAFTED_SHIELD ), 0 )
	Engine.SetModelValue( Engine.CreateModel( Engine.GetModelForController( f10_arg0 ), "zmInventory." .. CoD.Zombie.PLAYER_CRAFTED_IDGUN ), 0 )
	Engine.SetModelValue( Engine.CreateModel( Engine.GetModelForController( f10_arg0 ), "zmInventory." .. CoD.Zombie.WIDGET_QUEST_ITEMS ), 0 )
	Engine.SetModelValue( Engine.CreateModel( Engine.GetModelForController( f10_arg0 ), "zmInventory." .. CoD.Zombie.WIDGET_IDGUN_PARTS ), 0 )
	Engine.SetModelValue( Engine.CreateModel( Engine.GetModelForController( f10_arg0 ), "zmInventory." .. CoD.Zombie.WIDGET_ROCKETSHIELD_PARTS ), 0 )
	Engine.SetModelValue( Engine.CreateModel( Engine.GetModelForController( f10_arg0 ), "zmInventory." .. CoD.Zombie.WIDGET_FUSES ), 0 )
	Engine.SetModelValue( Engine.CreateModel( Engine.GetModelForController( f10_arg0 ), "zmInventory." .. CoD.Zombie.WIDGET_EGG ), 0 )
	Engine.SetModelValue( Engine.CreateModel( Engine.GetModelForController( f10_arg0 ), "zmInventory." .. CoD.Zombie.WIDGET_SPRAYER ), 0 )
	Engine.SetModelValue( Engine.CreateModel( Engine.GetModelForController( f10_arg0 ), "zmInventory." .. CoD.Zombie.PLAYER_SWORD_QUEST_EGG_STATE ), 0 )
	Engine.SetModelValue( Engine.CreateModel( Engine.GetModelForController( f10_arg0 ), "zmInventory." .. CoD.Zombie.PLAYER_SWORD_QUEST_COMPLETED_LEVEL_1 ), 0 )
end

CoD.Zombie.GetCharacterEnumString = function ( f11_arg0 )
	if f11_arg0 == 0 then
		return "ZOD_CRAFTABLE_RITUAL_NONE_ENUM"
	elseif f11_arg0 == 1 then
		return "ZOD_CRAFTABLE_RITUAL_BOXER_ENUM"
	elseif f11_arg0 == 2 then
		return "ZOD_CRAFTABLE_RITUAL_DETECTIVE_ENUM"
	elseif f11_arg0 == 3 then
		return "ZOD_CRAFTABLE_RITUAL_FEMME_ENUM"
	elseif f11_arg0 == 4 then
