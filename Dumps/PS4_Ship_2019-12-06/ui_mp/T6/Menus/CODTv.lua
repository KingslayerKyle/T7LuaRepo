	...
	if f43_arg0.fileData.fileID ~= "0" then
		...
		if not CoD.isZombie then
			if f43_arg0.fileData.category == "customgame" and f43_arg0.fileData.gameType ~= nil then
				f43_local1 = RegisterMaterial( Engine.StructTableLookupString( CoDShared.gametypesStructTable, "name", f43_arg0.fileData.gameType, "image" ) )
		...
		elseif f43_arg0.fileData.zmMapStartLoc and f43_arg0.fileData.zmMapStartLoc ~= "default" then
			f43_local1 = RegisterMaterial( "menu_" .. CoD.Zombie.GetMapName( f43_arg0.fileData.map ) .. "_" .. Engine.StructTableLookupString( CoDShared.gametypesStructTable, "name", f43_arg0.fileData.gameType, "groupname" ) .. "_" .. f43_arg0.fileData.zmMapStartLoc )
...
LUI.createMenu.CODTv = function ( f123_arg0 )
	...
	if f123_local0 == "playerchannel" then
		...
		if CoD.isMultiplayer and f123_local1.m_playerChannelXuid ~= nil and f123_local1.m_playerChannelXuid ~= "" then
