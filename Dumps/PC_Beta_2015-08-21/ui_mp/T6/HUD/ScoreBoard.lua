...
local f0_local52 = function ( f4_arg0 )
	...
	if f4_arg0.mode == "theater" then
		...
		local f4_local5 = {}
		local f4_local6 = Engine.Localize( Engine.StructTableLookupString( CoD.gametypesStructTable, "name", f4_local3, "name_ref" ) )
...
f0_local38 = function ( f17_arg0, f17_arg1 )
	...
	elseif Engine.IsDemoPlaying() then
		...
		local f17_local1
		if Engine.IsGuest( f17_arg0.m_ownerController ) or Engine.IsSplitscreen() or Engine.SessionModeIsMode( CoD.SESSIONMODE_OFFLINE ) or Engine.SessionModeIsMode( CoD.SESSIONMODE_SYSTEMLINK ) or CoD.isZombie == true and Engine.GetLobbyClientCount( Enum.LobbyType.LOBBY_TYPE_GAME ) <= 1 then
			f17_local1 = false
		else
			f17_local1 = true
		end
...
f0_local34 = function ( f22_arg0, f22_arg1, f22_arg2, f22_arg3, f22_arg4, f22_arg5, f22_arg6, f22_arg7 )
	...
	elseif f22_arg5.team ~= Enum.team_t.TEAM_FREE then
		...
		f22_arg0.factionIcon:setupPlayerEmblemServer( f22_local3.playerClientNum )
		f22_arg0.factionIcon:setAlpha( f0_local9 )
