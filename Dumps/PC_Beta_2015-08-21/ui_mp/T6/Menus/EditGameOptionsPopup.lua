...
LUI.createMenu.EditGameOptions = function ( f1_arg0 )
	...
	local f1_local2 = Engine.StructTableLookupString( CoD.gametypesStructTable, "name", f1_local1, "name_ref_caps" )
...
f0_local9 = function ( f11_arg0, f11_arg1 )
	if Engine.CanViewContent() == false then
		...
		local f11_local0 = Engine.StructTableLookupString( CoD.gametypesStructTable, "name", Dvar.ui_gametype:get(), "name_ref_caps" )
