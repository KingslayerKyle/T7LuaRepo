...
LUI.createMenu.EditModeSpecificOptions = function ( f1_arg0 )
	...
	f1_local0:addTitle( Engine.Localize( "MPUI_GAME_MODE_SETTINGS_CAPS", Engine.Localize( Engine.StructTableLookupString( CoD.gametypesStructTable, "name", f1_local2, "name_ref_caps" ) ) ) )
