...
LUI.UIFrame.changeFrameWidget = function ( f3_arg0, f3_arg1, f3_arg2 )
	...
	if not f3_arg0.widgetType then
		return 
	elseif type( f3_arg0.widgetType ) == "string" then
		f3_arg0.widgetType = LUI.getTableFromPath( f3_arg0.widgetType )
	end
	if f3_arg0.widgetType and f3_arg0.widgetType.new then
