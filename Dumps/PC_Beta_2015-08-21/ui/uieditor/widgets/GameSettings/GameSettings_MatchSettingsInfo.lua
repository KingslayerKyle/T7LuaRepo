...
local PostLoadFunc = function ( self, controller, menu )
	...
	local f1_local1 = Engine.StructTableLookupString( CoD.gametypesStructTable, "name", f1_local0, "image" )
	local f1_local2 = Engine.StructTableLookupString( CoD.gametypesStructTable, "name", f1_local0, "name_ref_caps" )
	local f1_local3 = Engine.StructTableLookupString( CoD.gametypesStructTable, "name", f1_local0, "description" )
	self.image:setImage( RegisterImage( f1_local1 ) )
	self.TitleBox.ScorestreaksLabel:setText( Engine.Localize( f1_local2 ) )
	self.Description:setText( Engine.Localize( f1_local3 ) )
end
