...
CoD.scorestreakButton.new = function ( menu, controller )
	...
	RestrictedItemWarning:setLeftRight( true, false, 0, 124 )
	RestrictedItemWarning:setTopBottom( true, false, 6.2, 113.3 )
	...
	self:mergeStateConditions( {
		{
			stateName = "Equipped",
			condition = function ( menu, element, event )
				return IsScorestreakEquipped( menu, element, controller )
			end
		},
		{
