...
CoD.ChooseCharacterLoadoutCarouselItem_Internal.new = function ( menu, controller )
	...
	apeRender:linkToElementModel( self, "frozenMomentRender", true, function ( model )
		local frozenMomentRender = Engine.GetModelValue( model )
		if frozenMomentRender then
			apeRender:setImage( RegisterImage( frozenMomentRender ) )
		end
	end )
	...
	characterPlusBackground:linkToElementModel( self, "backgroundWithCharacter", true, function ( model )
		...
		if backgroundWithCharacter then
			characterPlusBackground:setImage( RegisterImage( backgroundWithCharacter ) )
		end
	end )
	...
	characterOverlay:linkToElementModel( self, "frozenMomentOverlay", true, function ( model )
		local frozenMomentOverlay = Engine.GetModelValue( model )
		if frozenMomentOverlay then
			characterOverlay:setImage( RegisterImage( frozenMomentOverlay ) )
		end
	end )
	...
	LUI.OverrideFunction_CallOriginalSecond( self, "close", function ( element )
		...
		element.characterPlusBackground:close()
		element.characterOverlay:close()
