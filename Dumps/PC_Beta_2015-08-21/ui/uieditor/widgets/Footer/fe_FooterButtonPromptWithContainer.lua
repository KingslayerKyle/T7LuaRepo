...
local f0_local0 = function ( f1_arg0, f1_arg1 )
	...
	f1_arg0:registerEventHandler( "button_action", function ( element, event )
		...
		if f2_local0 then
			local f2_local1 = Engine.GetModel( f2_local0, "Button" )
			if f2_local1 then
				local f2_local2 = Engine.GetModel( Engine.GetModelForController( f1_arg1 ), "ButtonBits." .. Engine.GetModelValue( f2_local1 ) )
				if f2_local2 then
					Engine.SetModelValue( f2_local2, Enum.LUIButtonFlags.FLAG_DOWN )
				end
			end
		end
