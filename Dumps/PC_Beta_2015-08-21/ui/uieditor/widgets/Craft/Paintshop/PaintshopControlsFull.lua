...
CoD.PaintshopControlsFull.new = function ( menu, controller )
	...
	opacityText:setLeftRight( true, false, 55, 240 )
	...
	Flip:setLeftRight( true, false, 13, 246 )
	...
	Move:subscribeToGlobalModel( controller, "Controller", "left_stick_button_image", function ( model )
		...
		if leftStickButtonImage then
			Move.buttonPromptImage:setImage( RegisterImage( leftStickButtonImage ) )
		end
	end )
	...
	self.clipsPerState = {
		...
		FixedScale = {
			DefaultClip = function ()
				...
				self.FreeScale:setTopBottom( true, false, 62, 93 )
				self.FreeScale:setAlpha( 0 )
				self.clipFinished( FreeScale, {} )
				Move:completeAnimation()
				self.Move:setAlpha( 1 )
