...
CoD.EmblemEditorGradientTypeButton.new = function ( menu, controller )
	...
	toggleRadial:subscribeToGlobalModel( controller, "Controller", "right_stick_button_image", function ( model )
		local rightStickButtonImage = Engine.GetModelValue( model )
		if rightStickButtonImage then
			toggleRadial.buttonPromptImage:setImage( RegisterImage( rightStickButtonImage ) )
		end
	end )
	...
	toggleLinear:subscribeToGlobalModel( controller, "Controller", "right_stick_button_image", function ( model )
		local rightStickButtonImage = Engine.GetModelValue( model )
		if rightStickButtonImage then
			toggleLinear.buttonPromptImage:setImage( RegisterImage( rightStickButtonImage ) )
		end
	end )
