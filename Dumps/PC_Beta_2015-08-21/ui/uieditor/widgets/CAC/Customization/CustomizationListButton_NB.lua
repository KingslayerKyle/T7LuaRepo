...
CoD.CustomizationListButton_NB.new = function ( menu, controller )
	...
	itemImage0:linkToElementModel( self, "paintjobSlotAndIndex", true, function ( model )
		local paintjobSlotAndIndex = Engine.GetModelValue( model )
		if paintjobSlotAndIndex then
			itemImage0.paintjobExtraCamRender:setupWCPaintjobIconExtraCamRender( GetPaintshopExtraCamParameters( controller, paintjobSlotAndIndex ) )
		end
	end )
