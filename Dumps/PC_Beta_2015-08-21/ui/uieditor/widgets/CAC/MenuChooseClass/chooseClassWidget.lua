	...
	self.clipsPerState = {
		...
		Wildcards = {
			...
			DefaultState = function ()
				...
				self.Wildcards:setTopBottom( false, true, -153.5, 4.5 )
				WildcardsFrame2( Wildcards, {} )
				local f40_local1 = function ( f42_arg0, f42_arg1 )
					if not f42_arg1.interrupted then
						f42_arg0:beginAnimation( "keyframe", 129, false, false, CoD.TweenType.Linear )
					end
					f42_arg0:setAlpha( 1 )
				...
				WildcardHeader:setAlpha( 0 )
				WildcardHeader:registerEventHandler( "transition_complete_keyframe", f40_local1 )
			end,
			Campaign = function ()
