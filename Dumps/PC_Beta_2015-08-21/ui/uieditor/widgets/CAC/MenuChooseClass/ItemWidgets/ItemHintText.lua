	...
	self:linkToElementModel( self, "hintText", true, function ( model )
		...
		if f2_local0 then
			...
			if self.currentState == "LeftAlign" then
				...
				self:setLeftRight( true, false, -f2_local1, self.textLeftAlign:getTextWidth() + f2_local1 )
			elseif self.currentState == "RightAlign" then
				self.textRightAlign:setText( f2_local0 )
				self:setLeftRight( false, true, -self.textRightAlign:getTextWidth() - f2_local1, f2_local1 )
			elseif self.currentState == "CenterAlign" then
				self.textCenterAlign:setText( f2_local0 )
				local f2_local2 = self.textCenterAlign:getTextWidth()
				self:setLeftRight( false, false, -f2_local2 / 2 - f2_local1, f2_local2 / 2 + f2_local1 )
			end
		end
	end )
end
