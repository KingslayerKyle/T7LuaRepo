...
CoD.WeaponItemModelWidgetNew.new = function ( menu, controller )
	...
	personalizePrompt:setTopBottom( false, true, -22.5, -2.5 )
	...
	self.clipsPerState = {
		...
		CybercoreEquipped = {
			DefaultClip = function ()
				...
				self.clipFinished( itemImage, {} )
				personalizePrompt:completeAnimation()
				personalizePrompt.promptText:completeAnimation()
				self.personalizePrompt:setAlpha( 0 )
				self.personalizePrompt.promptText:setText( Engine.Localize( "CPUI_BUTTON_UPGRADE_CAPS" ) )
				self.clipFinished( personalizePrompt, {} )
				FocusBarT:completeAnimation()
				self.FocusBarT:setAlpha( 0 )
				self.clipFinished( FocusBarT, {} )
			...
			GainFocus = function ()
				...
				self.itemImage:setAlpha( 0.8 )
				itemImageFrame2( itemImage, {} )
				local personalizePromptFrame2 = function ( personalizePrompt, event )
					if not event.interrupted then
						personalizePrompt:beginAnimation( "keyframe", 140, false, false, CoD.TweenType.Linear )
					end
					personalizePrompt:setAlpha( 1 )
					if event.interrupted then
						self.clipFinished( personalizePrompt, event )
					else
						personalizePrompt:registerEventHandler( "transition_complete_keyframe", self.clipFinished )
					end
				end
				
				personalizePrompt:completeAnimation()
				self.personalizePrompt:setAlpha( 0 )
				personalizePromptFrame2( personalizePrompt, {} )
				local FocusBarTFrame2 = function ( FocusBarT, event )
					local FocusBarTFrame3 = function ( FocusBarT, event )
						local FocusBarTFrame4 = function ( FocusBarT, event )
							local FocusBarTFrame5 = function ( FocusBarT, event )
			...
			LoseFocus = function ()
				...
				local personalizePromptFrame2 = function ( personalizePrompt, event )
					if not event.interrupted then
						personalizePrompt:beginAnimation( "keyframe", 159, false, false, CoD.TweenType.Linear )
					end
					personalizePrompt:setAlpha( 0 )
					if event.interrupted then
						self.clipFinished( personalizePrompt, event )
