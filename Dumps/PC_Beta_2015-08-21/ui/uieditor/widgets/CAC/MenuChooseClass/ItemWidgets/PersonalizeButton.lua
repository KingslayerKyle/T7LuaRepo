			...
			condition = function ( menu, element, event )
				...
				if f21_local0 then
					...
					if f21_local0 then
						...
						if f21_local0 then
							if not IsGamepad( controller ) and not IsUserContentRestricted( controller ) then
								f21_local0 = not IsBooleanDvarSet( "ui_execdemo_beta" )
							else
								f21_local0 = false
							end
						end
