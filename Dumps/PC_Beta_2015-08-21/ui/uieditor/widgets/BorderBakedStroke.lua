...
CoD.BorderBakedStroke.new = function ( menu, controller )
	...
	Image0:setImage( RegisterImage( "uie_img_t7_menu_customclass_boxstrokeul" ) )
	...
	Image1:setImage( RegisterImage( "uie_img_t7_menu_customclass_boxstrokeum" ) )
	...
	Image2:setImage( RegisterImage( "uie_img_t7_menu_customclass_boxstrokeur" ) )
	...
	Image3:setImage( RegisterImage( "uie_img_t7_menu_customclass_boxstrokelm" ) )
	...
	Image4:setImage( RegisterImage( "uie_img_t7_menu_customclass_boxstrokelr" ) )
	...
	Image5:setImage( RegisterImage( "uie_img_t7_menu_customclass_boxstrokell" ) )
	...
	Image6:setImage( RegisterImage( "uie_img_t7_menu_customclass_boxstrokeml" ) )
	...
	Image7:setImage( RegisterImage( "uie_img_t7_menu_customclass_boxstrokemr" ) )
