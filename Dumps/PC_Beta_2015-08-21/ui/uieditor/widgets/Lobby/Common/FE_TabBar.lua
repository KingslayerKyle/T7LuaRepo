...
CoD.FE_TabBar.new = function ( menu, controller )
	...
	self:setLeftRight( true, false, 0, 2496 )
	...
	FETabIdle00:setTopBottom( true, false, 0, 41 )
	...
	FETabIdle0:setLeftRight( true, false, 1216, 2496 )
	FETabIdle0:setTopBottom( true, false, 0, 41 )
