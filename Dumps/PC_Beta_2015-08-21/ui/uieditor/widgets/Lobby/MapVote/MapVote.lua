...
local f0_local2 = function ( f4_arg0, f4_arg1, f4_arg2 )
	f4_arg0:subscribeToModel( Engine.GetModel( Engine.GetGlobalModel(), "lobbyRoot.mapVote" ), function ()
		...
		if f5_local0 ~= LobbyData.UITargets.UI_MPLOBBYONLINEPUBLICGAME.id and f5_local0 ~= LobbyData.UITargets.UI_CPLOBBYONLINEPUBLICGAME.id and f5_local0 ~= LobbyData.UITargets.UI_ZMLOBBYONLINEPUBLICGAME.id then
			return 
		end
		...
		elseif f5_local1 == LuaEnums.MAP_VOTE_STATE.LOCKEDIN then
			...
			local f5_local3 = Engine.GetModelValue( Engine.CreateModel( f5_local2, "mapVoteCountNext" ) )
			local f5_local4 = Engine.GetModelValue( Engine.CreateModel( f5_local2, "mapVoteCountPrevious" ) )
			local f5_local5 = Engine.GetModelValue( Engine.CreateModel( f5_local2, "mapVoteCountRandom" ) )
...
local f0_local5 = function ( f8_arg0, f8_arg1, f8_arg2 )
	...
	if f8_local0 == LobbyData.UITargets.UI_MPLOBBYONLINEPUBLICGAME.id or f8_local0 == LobbyData.UITargets.UI_CPLOBBYONLINEPUBLICGAME.id or f8_local0 == LobbyData.UITargets.UI_ZMLOBBYONLINEPUBLICGAME.id then
		f0_local2( f8_arg0, f8_arg1, f8_arg2 )
	elseif f8_local0 == LobbyData.UITargets.UI_CPLOBBYONLINECUSTOMGAME.id or f8_local0 == LobbyData.UITargets.UI_CPLOBBYLANGAME.id or f8_local0 == LobbyData.UITargets.UI_CP2LOBBYONLINECUSTOMGAME.id or f8_local0 == LobbyData.UITargets.UI_CP2LOBBYLANGAME.id or f8_local0 == LobbyData.UITargets.UI_MPLOBBYONLINECUSTOMGAME.id or f8_local0 == LobbyData.UITargets.UI_MPLOBBYLANGAME.id or f8_local0 == LobbyData.UITargets.UI_ZMLOBBYONLINECUSTOMGAME.id or f8_local0 == LobbyData.UITargets.UI_ZMLOBBYLANGAME.id or f8_local0 == LobbyData.UITargets.UI_THLOBBYONLINEGAME.id then
...
CoD.MapVote.new = function ( menu, controller )
	...
	LoadingScreenPreloadHidden:subscribeToGlobalModel( controller, "MapVote", "mapVoteMapNext", function ( model )
		local mapVoteMapNext = Engine.GetModelValue( model )
		if mapVoteMapNext then
			LoadingScreenPreloadHidden:setImage( RegisterImage( MapNameToMapLoadingImage( mapVoteMapNext ) ) )
		end
	end )
