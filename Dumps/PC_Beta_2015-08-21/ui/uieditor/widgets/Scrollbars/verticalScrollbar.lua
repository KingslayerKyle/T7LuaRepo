...
local f0_local0 = function ( f1_arg0, f1_arg1 )
	...
	f1_arg0:registerEventHandler( "mousedrag", function ( element, event )
		local f2_local0 = element:getParent()
		if f2_local0 then
			local f2_local1 = event.y - element.slider.barHeight / 2
			local f2_local2, f2_local3, f2_local4, f2_local5 = element:getRect()
			f2_local0:updateLayoutBasedOnVScrollbarPercentage( LUI.clamp( (f2_local1 - f2_local3) / (f2_local5 - f2_local3), 0, 1 ) )
		end
	end )
end
