...
local f0_local1 = function ( f2_arg0, f2_arg1 )
	...
	f2_arg0:registerEventHandler( "button_action", function ( element, event )
		...
		if f3_local0 then
			local f3_local1 = Engine.GetModel( f3_local0, "Button" )
			if f3_local1 then
				local f3_local2 = Engine.GetModel( Engine.GetModelForController( f2_arg1 ), "ButtonBits." .. Engine.GetModelValue( f3_local1 ) )
				if f3_local2 then
					Engine.SetModelValue( f3_local2, Enum.LUIButtonFlags.FLAG_DOWN )
				end
			end
		end
