...
CoD.StartMenu_Button_LG.new = function ( menu, controller )
	...
	DisabledImage.ImageContainer:setMaterial( LUI.UIImage.GetCachedMaterial( "uie_saturation_normal" ) )
	DisabledImage.ImageContainer:setShaderVector( 0, 0.2, 0, 0, 0 )
