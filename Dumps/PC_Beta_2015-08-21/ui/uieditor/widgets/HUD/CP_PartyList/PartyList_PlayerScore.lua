...
local PostLoadFunc = function ( f1_arg0 )
	f1_arg0.updatePlayerScoreWidgetLayout = function ( f2_arg0 )
		local f2_local0, f2_local1, f2_local2, f2_local3 = f2_arg0.ScoreInternal:getLocalRect()
		local f2_local4, f2_local5, f2_local6, f2_local7 = f2_arg0.ScoreInternal.LblRank:getLocalRect()
		local f2_local8, f2_local9, f2_local10, f2_local11 = f2_arg0.ScoreInternal.Gamertag:getLocalRect()
		local f2_local12 = f2_arg0.ScoreInternal.ClanContainer.LblClan:getTextWidth()
		local f2_local13, f2_local14, f2_local15, f2_local16 = f2_arg0.ScoreInternal.ClanContainer:getLocalRect()
		if f2_local12 > 0 then
			f2_local12 = f2_local12 + 6
		end
		f2_arg0.ScoreInternal.ClanContainer:setLeftRight( true, false, f2_local0, f2_local0 + f2_local12 )
		f2_arg0.Panel:setLeftRight( true, false, f2_local2 + f2_local4 + f2_local10 - f2_local8 - f2_arg0.ScoreInternal.Gamertag:getTextWidth() + f2_local15 - f2_local13 - f2_local12 + 2, f2_local2 + 4 )
	end
