...
local PostLoadFunc = function ( f1_arg0 )
	...
	if Dvar.ui_execdemo:get() then
		f1_arg0.GameRecording:close()
		f1_arg0.SetupBots:close()
	end
	f1_arg0.EditGameRules.navigation.down = nil
	f1_arg0.ChangeMap.navigation.up = nil
end
...
LUI.createMenu.GameSettingsFlyoutMP = function ( controller )
	...
	LUI.OverrideFunction_CallOriginalSecond( self, "close", function ( element )
		...
		element.SetupBots:close()
		element.GameRecording:close()
