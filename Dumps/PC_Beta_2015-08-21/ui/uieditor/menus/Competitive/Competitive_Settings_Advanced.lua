...
local f0_local1 = function ( f2_arg0 )
	local f2_local0 = {}
	table.insert( f2_local0, f0_local0( f2_arg0, "MENU_PRE_STAGE_TIME", "MENU_PRE_STAGE_DESC", "SpecialistOptions_preStageTime", "pregamePreStageTime", nil, "MENU_1_SECOND", "MENU_X_SECONDS", {
		1,
		2,
		3,
		4,
	...
	table.insert( f2_local0, f0_local0( f2_arg0, "MENU_POST_ROUND_TIME", "MENU_POST_ROUND_DESC", "SpecialistOptions_postRoundTime", "pregamePostRoundTime", nil, "MENU_1_SECOND", "MENU_X_SECONDS", {
		1,
		2,
		3,
		4,
	...
	table.insert( f2_local0, f0_local0( f2_arg0, "MENU_POST_STAGE_TIME", "MENU_POST_STAGE_DESC", "SpecialistOptions_postStageTime", "pregamePostStageTime", nil, "MENU_1_SECOND", "MENU_X_SECONDS", {
		1,
		2,
		3,
		4,
...
local f0_local2 = function ( f3_arg0 )
	local f3_local0 = {}
	table.insert( f3_local0, CoD.OptionsUtility.CreateNamedSettings( f3_arg0, "MENU_ALWAYS_SHOW_CAC_EDIT", "MENU_ALWAYS_SHOW_CAC_DESC", "SpecialistOptions_AlwaysShowCACEdit", "pregameAlwaysShowCACEdit", {
		{
			option = "MENU_ALWAYS",
			value = 1
		},
	...
	table.insert( f3_local0, CoD.OptionsUtility.CreateNamedSettings( f3_arg0, "MENU_ALWAYS_SHOW_STREAK_EDIT", "MENU_ALWAYS_SHOW_STREAK_DESC", "SpecialistOptions_AlwaysShowStreakEdit", "pregameAlwaysShowStreakEdit", {
		{
			option = "MENU_ALWAYS",
			value = 1
		},
...
local f0_local3 = function ( f4_arg0 )
	local f4_local0 = {}
	table.insert( f4_local0, CoD.OptionsUtility.CreateNamedSettings( f4_arg0, "MENU_PLAYER_SELECT_ORDER", "MENU_PLAYER_SELECT_ORDER_DESC", "SpecialistOptions_SortType", "pregamePositionSortType", {
		{
			option = "MENU_RANDOM",
	...
	table.insert( f4_local0, CoD.OptionsUtility.CreateNamedSettings( f4_arg0, "MENU_PLAYER_SELECT_SHUFFLE", "MENU_PLAYER_SELECT_SHUFFLE_DESC", "SpecialistOptions_ShuffleMethod", "pregamePositionShuffleMethod", {
		{
			option = "MENU_NONE",
...
DataSources.CompetitiveAdvancedSettings = DataSourceHelpers.ListSetup( "CompetitiveAdvancedSettings", f0_local1, nil, nil, nil )
DataSources.CompetitiveEditSettings = DataSourceHelpers.ListSetup( "CompetitiveEditSettings", f0_local2, nil, nil, nil )
DataSources.CompetitiveOrderSettings = DataSourceHelpers.ListSetup( "CompetitiveOrderSettings", f0_local3, nil, nil, nil )
LUI.createMenu.Competitive_Settings_Advanced = function ( controller )
	...
	LUI.OverrideFunction_CallOriginalSecond( self, "close", function ( element )
		...
		element.CompetitiveSettingsList1:close()
		element.CompetitiveSettingsList0:close()
		element.CompetitiveSettingsList2:close()
		element.Desc:close()
