...
local f0_local0 = function ()
	...
	if f1_local0 == CoD.LANGUAGE_ENGLISH or f1_local0 == CoD.LANGUAGE_BRITISH or f1_local0 == CoD.LANGUAGE_POLISH or f1_local0 == CoD.LANGUAGE_JAPANESE or f1_local0 == CoD.LANGUAGE_FULLJAPANESE then
		return true
	else
		return false
	end
...
DataSources.OptionPCSoundSubtitles = DataSourceHelpers.ListSetup( "PC.OptionPCSoundSubtitles", function ( f3_arg0 )
	local f3_local0 = {}
...
DataSources.OptionSoundSound = DataSourceHelpers.ListSetup( "PC.OptionSoundSound", function ( f4_arg0 )
	local f4_local0 = {}
	...
	table.insert( f4_local0, {
		models = {
			...
			profileType = "user",
			widgetType = "button",
			onPressFn = function ( f5_arg0, f5_arg1 )
...
DataSources.OptionSoundSound.getWidgetTypeForItem = function ( f6_arg0, f6_arg1, f6_arg2 )
	if f6_arg1 then
...
DataSources.OptionSoundCategories = DataSourceHelpers.ListSetup( "PC.OptionSoundCategories", function ( f7_arg0 )
	local f7_local0 = {}
