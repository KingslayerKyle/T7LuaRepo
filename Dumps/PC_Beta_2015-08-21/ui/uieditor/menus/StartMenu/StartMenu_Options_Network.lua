...
require( "ui.uieditor.widgets.StartMenu.StartMenu_Options_Network_PingImage" )
...
LUI.createMenu.StartMenu_Options_Network = function ( controller )
	...
	local NetworkBox3 = CoD.cac_ButtonBoxLrgInactiveStroke.new( self, controller )
	...
	local NetworkPanel1 = CoD.FE_ButtonPanel.new( self, controller )
	...
	local NetworkPingBars = CoD.NetworkPingBars.new( self, controller )
	...
	local StartMenuOptionsNetworkPingImage0 = CoD.StartMenu_Options_Network_PingImage.new( self, controller )
	StartMenuOptionsNetworkPingImage0:setLeftRight( true, false, 714.1, 1098.6 )
	StartMenuOptionsNetworkPingImage0:setTopBottom( true, false, 440.21, 525.08 )
	self:addElement( StartMenuOptionsNetworkPingImage0 )
	self.StartMenuOptionsNetworkPingImage0 = StartMenuOptionsNetworkPingImage0
	...
	LUI.OverrideFunction_CallOriginalSecond( self, "close", function ( element )
		...
		element.NetworkPingBars:close()
		element.MenuFrame:close()
		element.StartMenuOptionsNetworkPingImage0:close()
