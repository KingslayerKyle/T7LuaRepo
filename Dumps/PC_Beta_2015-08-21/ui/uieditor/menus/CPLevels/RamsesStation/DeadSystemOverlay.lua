local PostLoadFunc = function ( f1_arg0, f1_arg1 )
	f1_arg0.HealthBarFill0:linkToElementModel( f1_arg0, "healthbar1", true, function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
			f1_arg0.HealthBarFill0:setShaderVector( 2, modelValue, 0, 0, 0 )
		end
	end )
	f1_arg0.HealthBarFill1:linkToElementModel( f1_arg0, "healthbar2", true, function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
			f1_arg0.HealthBarFill1:setShaderVector( 2, modelValue, 0, 0, 0 )
		end
	end )
end
...
LUI.createMenu.DeadSystemOverlay = function ( controller )
	...
	self.WeaponStatus:linkToElementModel( self, "weaponStatus", true, function ( model )
		local weaponStatus = Engine.GetModelValue( model )
		if weaponStatus then
			WeaponStatus:setText( Engine.Localize( weaponStatus ) )
		end
	end )
	self.clipsPerState = {
		DefaultState = {
