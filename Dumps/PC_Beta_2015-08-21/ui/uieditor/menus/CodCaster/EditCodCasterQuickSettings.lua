...
LUI.createMenu.EditCodCasterQuickSettings = function ( controller )
	...
	ButtonList:setLeftRight( true, false, 79, 379 )
	ButtonList:setTopBottom( true, false, 107.5, 401.5 )
	...
	StartMenuOptionHighlight:linkToElementModel( ButtonList, "displayText", true, function ( model )
		...
		if displayText then
			StartMenuOptionHighlight.DescTitle:setText( Engine.Localize( LocalizeToUpperString( displayText ) ) )
		end
	end )
