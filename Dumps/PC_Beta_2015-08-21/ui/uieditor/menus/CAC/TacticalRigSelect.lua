...
LUI.createMenu.TacticalRigSelect = function ( controller )
	...
	local selectionList = LUI.UIList.new( self, controller, 7, 0, function ( f4_arg0 )
		return Engine.GetModelValue( Engine.GetModel( f4_arg0, "loadoutSlot" ) ) == "cybercom_tacrig1"
