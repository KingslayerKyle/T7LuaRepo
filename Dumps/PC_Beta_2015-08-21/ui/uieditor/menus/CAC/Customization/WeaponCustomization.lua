...
local PreLoadFunc = function ( self, controller )
	...
	CoD.WC_Category.ACV.attachmentTable = Engine.GetAttachmentCosmeticVariantTable( Engine.GetWeaponString( controller, f1_local1, f1_local2 ) )
...
local f0_local1 = function ( f2_arg0, f2_arg1, f2_arg2 )
	...
	if f2_arg2.acv == true then
		f2_local2 = Engine.GetModel( f2_local0, CoD.CACUtility.GetLoadoutSlotForAttachmentName( f2_local0, f2_local1, CoD.WC_Category.ACV.selectedAttachment ) .. "cosmeticvariant" .. ".itemIndex" )
		if f2_local2 then
			f2_local3 = f2_arg1:findItem( nil, {
				variantIndex = Engine.GetModelValue( f2_local2 )
			}, false, nil )
		end
	else
...
local PostLoadFunc = function ( f4_arg0, f4_arg1 )
	...
	CoD.GetWeaponOptionsTable( f4_arg1 )
	CoD.CACUtility.UpdateWeaponOptions( f4_arg1, f4_local0 )
	CoD.CACUtility.UpdateAttachmentCosmeticVariants( f4_arg1, f4_local0 )
	local f4_local2 = Engine.GetModel( f4_local0, f4_local1 .. ".name" )
	if f4_local2 then
		local f4_local3 = Engine.GetModelValue( f4_local2 )
		if f4_local3 and f4_arg0.background.titleLabel then
			f4_arg0.background.titleLabel:setText( Engine.Localize( "MPUI_PERSONALIZE_CAPS" ) .. " " .. f4_local3 )
		end
	end
