...
LUI.createMenu.Loading = function ( f5_arg0 )
	...
	if f5_local1 then
		if CoD.GetMapValue( f5_local2, "fadeToWhite" ) == 1 then
			local f5_local6 = "$white"
		end
		f5_local4 = f5_local6 or "black"
	else
		Engine.SetDvar( "ui_useloadingmovie", 0 )
	...
	f5_local0.mapNameLabel:setLeftRight( true, false, f5_local7, f5_local7 + 1 )
	f5_local0.mapNameLabel:setTopBottom( true, false, f5_local5, f5_local5 + f5_local10 )
	...
	f5_local5 = f5_local5 + f5_local10 - 5
	f5_local0.mapLocationLabel = LUI.UIText.new()
	f5_local0.mapLocationLabel.id = "mapLocationLabel"
	f5_local0.mapLocationLabel:setLeftRight( true, false, f5_local7, f5_local7 + 1 )
	f5_local0.mapLocationLabel:setTopBottom( true, false, f5_local5, f5_local5 + f5_local13 )
	...
	f5_local5 = f5_local5 + f5_local13 - 2
	f5_local0.gametypeLabel = LUI.UIText.new()
	f5_local0.gametypeLabel.id = "gametypeLabel"
	f5_local0.gametypeLabel:setLeftRight( true, false, f5_local7, f5_local7 + 1 )
	f5_local0.gametypeLabel:setTopBottom( true, false, f5_local5, f5_local5 + f5_local13 )
	...
	f5_local5 = f5_local5 + f5_local13 + 5
	...
	if not Engine.IsLevelPreloaded( f5_local2 ) then
		...
		f5_local0.demoInfoContainer:setLeftRight( true, false, f5_local7, 600 )
	...
	local f5_local24 = 2
	local f5_local25 = f5_local23 + 1 + f5_local24 + CoD.Loading.DYKFontHeight - f5_local5
