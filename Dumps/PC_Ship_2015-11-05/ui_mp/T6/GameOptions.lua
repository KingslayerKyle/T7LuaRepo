...
local f0_local6 = CoD.GameOptions
local f0_local7 = {
	allowAnnouncer = {
		name = "MENU_ANNOUNCER",
		hintText = {
...
f0_local7.cumulativeRoundScores = {
	name = "MENU_WIN_RULE",
	hintText = {
...
f0_local7.roundStartExplosiveDelay = {
...
f0_local7.roundStartKillstreakDelay = {
...
f0_local7.roundWinLimit_escort = {
	setting = "roundWinLimit",
	name = "MENU_ROUND_WIN_LIMIT",
	hintText = {
		"MENU_ROUND_WIN_LIMIT_HINT"
...
f0_local7.spawnteamkilledpenalty = {
...
f0_local7.teamScorePerHeadshot = {
...
f0_local7.teamScorePerKillConfirmed = {
...
f0_local7.teamScorePerKillDenied = {
...
f0_local7.timePausesWhenInZone = {
...
f0_local7.voipKillersHearVictim = {
...
f0_local7.useEmblemInsteadOfFactionIcon = {
...
f0_local6.GameSettings = f0_local7
...
CoD.GameOptionsMenu.New = function ( f13_arg0, f13_arg1 )
	...
	f13_local0:AddButtonCallbackFunction( f13_local0, f13_arg0, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, nil, function ( element, menu, controller, model )
		GoBack( f13_local0, controller )
...
f0_local6 = function ( f20_arg0, f20_arg1 )
