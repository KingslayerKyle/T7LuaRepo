...
local f0_local0 = function ( f1_arg0 )
	...
	if CoD.IsShoutcaster( f1_arg0.controller ) and not CoD.ShoutcasterProfileVarBool( f1_arg0.controller, "shoutcaster_killfeed" ) then
...
CoD.ConsoleUtility.Init = function ( f3_arg0, f3_arg1, f3_arg2, f3_arg3 )
	...
	f3_arg0:registerEventHandler( "console_notification_complete", f0_local1 )
...
CoD.ConsoleUtility.EntryInit = function ( f11_arg0, f11_arg1, f11_arg2 )
	...
	f11_arg0:registerEventHandler( "hide_console_entry", f0_local5 )
	f11_arg0.completeAllAnimations = f0_local2
	...
	f11_arg0.showConsoleEntry = f0_local3
	f11_arg0.moveConsoleEntry = f0_local4
	f11_arg0.hideConsoleEntry = f0_local5
	f11_arg0.forceHideConsoleEntry = f0_local6
end
