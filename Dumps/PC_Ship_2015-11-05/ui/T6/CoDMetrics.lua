...
LUI.CoDMetrics.StoreEntry = function ( f7_arg0, f7_arg1, f7_arg2, f7_arg3 )
	Engine.RecordComScoreEvent( f7_arg1, "store_entry", "store_source", f7_arg3.name, "store_gamemode", Engine.GetModeName(), "store_action_source", f7_arg2, "store_region", Engine.GetSkuRegion() )
end
...
LUI.CoDMetrics.GunsmithEvent = function ( f13_arg0, f13_arg1, f13_arg2, f13_arg3, f13_arg4, f13_arg5 )
	Engine.RecordComScoreEvent( f13_arg0, "gunsmith", "operation", f13_arg1, "duration", f13_arg2, "weapon_id", f13_arg3, "weapon_title", f13_arg4, "attachments_used", f13_arg5 )
end

LUI.CoDMetrics.EmblemEvent = function ( f14_arg0, f14_arg1, f14_arg2 )
	Engine.RecordComScoreEvent( f14_arg0, "save_emblem", "duration", f14_arg1, "assets_used", f14_arg2 )
end

LUI.CoDMetrics.PrestigeEvent = function ( f15_arg0, f15_arg1, f15_arg2, f15_arg3 )
	Engine.RecordComScoreEvent( f15_arg0, "prestige", "old_prestige", f15_arg1, "new_prestige", f15_arg2, "game_mode", f15_arg3 )
end

LUI.CoDMetrics.WatchVideoEvent = function ( f16_arg0, f16_arg1 )
	Engine.RecordComScoreEvent( f16_arg0, "watch_video", "video_id", f16_arg1.fileID, "video_length", f16_arg1.duration, "video_author", f16_arg1.authorName, "video_ispooled", f16_arg1.isPooled )
end
