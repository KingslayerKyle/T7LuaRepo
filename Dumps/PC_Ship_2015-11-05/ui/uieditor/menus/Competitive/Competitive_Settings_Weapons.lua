...
local f0_local2 = function ( f2_arg0 )
	...
	for f2_local3 = 0, 255, 1 do
		if Engine.ItemIndexValid( f2_local3 ) then
			local f2_local6 = Engine.GetUnlockableInfoByIndex( f2_local3 )
			local f2_local7 = f2_local6.image
			if f2_local7 ~= nil and f2_local7 ~= "" then
				f2_local7 = f2_local7 .. "_pu"
			end
			if f0_local0[modelValue].weapon_category[f2_local6.group] ~= nil and f2_local6.allocation >= 0 then
				table.insert( f2_local1, CoD.OptionsUtility.CreateItemRestrictionSettings( f2_arg0, f2_local6.name, "", "CompetitiveSettings_ItemRestriction_" .. tostring( f2_local3 ), CoD.GameSettingsUtility.GetRestrictionOptions(), f2_local7, CoD.OptionsUtility.GametypeSettingsSetItemRestrictionState, {
					itemIndex = f2_local3
				}, function ( f3_arg0 )
