...
local PostLoadFunc = function ( f2_arg0, f2_arg1 )
	local f2_local0 = CoD.GetTeamID( f2_arg1 )
	local f2_local1 = function ( f3_arg0 )
		return Engine.GetModelValue( Engine.GetModel( f3_arg0, "team" ) ) == f2_local0
	end
	
	local f2_local2 = function ( f4_arg0 )
		return Engine.GetModelValue( Engine.GetModel( f4_arg0, "team" ) ) ~= f2_local0
	end
	
	f2_arg0.Team1ListSmall.filter = f2_local1
	f2_arg0.Team1ListSmall:updateDataSource( true )
	f2_arg0.Team1ListLarge.filter = f2_local1
	f2_arg0.Team1ListLarge:updateDataSource( true )
	f2_arg0.Team2ListSmall.filter = f2_local2
	f2_arg0.Team2ListSmall:updateDataSource( true )
	f2_arg0.Team2ListLarge.filter = f2_local2
	f2_arg0.Team2ListLarge:updateDataSource( true )
	f2_arg0:subscribeToModel( Engine.CreateModel( Engine.CreateModel( Engine.GetModelForController( f2_arg1 ), "Pregame" ), "clientState" ), function ( model )
		...
		local f5_local1 = Engine.GetLobbyPregameState()
		if modelValue == Enum.LobbyClientPregameState.LOBBY_CLIENT_PREGAME_STATE_SELECTING then
			if f5_local1 == Enum.LobbyPregameState.LOBBY_PREGAME_STATE_ITEM_VOTE then
				OpenOverlay( f2_arg0, "Pregame_ItemVote", f2_arg1 )
			elseif f5_local1 == Enum.LobbyPregameState.LOBBY_PREGAME_STATE_CHARACTER_DRAFT then
				OpenChooseCharacterLoadout( nil, nil, f2_arg1, LuaEnums.CHOOSE_CHARACTER_OPENED_FROM.DRAFT, f2_arg0 )
			elseif f5_local1 == Enum.LobbyPregameState.LOBBY_PREGAME_STATE_CAC_EDIT then
				ShowCACContentWarning( f2_arg0, nil, f2_arg1 )
			elseif f5_local1 == Enum.LobbyPregameState.LOBBY_PREGAME_STATE_SCORESTREAK_EDIT then
		...
		elseif modelValue == Enum.LobbyClientPregameState.LOBBY_CLIENT_PREGAME_STATE_SELECTION_FORCED then
			if f5_local1 == Enum.LobbyPregameState.LOBBY_PREGAME_STATE_CHARACTER_DRAFT then
				local f5_local2 = Engine.GetXUID64( f2_arg1 )
				local f5_local3 = Engine.LobbyGetSessionClients( Enum.LobbyModule.LOBBY_MODULE_CLIENT, Enum.LobbyType.LOBBY_TYPE_GAME )
				for f5_local9, f5_local10 in ipairs( f5_local3.sessionClients ) do
					if f5_local10.xuid == f5_local2 then
						local f5_local7 = f5_local10.characterDraft.characterIndex
						local f5_local8 = f5_local10.characterDraft.loadout
						if f5_local7 >= 0 and f5_local8 >= 0 then
							Engine.SetHeroLoadoutItem( f2_arg1, CoD.CCUtility.customizationMode, f5_local7, f5_local8 )
							Engine.SetHero( f2_arg1, CoD.CCUtility.customizationMode, f5_local7 )
						end
					end
				end
			end
...
LUI.createMenu.Pregame_Main = function ( controller )
	...
	local Team1ListSmall = LUI.UIList.new( self, controller, 0, 0, nil, false, false, 0, 0, false, true )
	...
	local Team1ListLarge = LUI.UIList.new( self, controller, 9, 0, nil, false, false, 0, 0, false, true )
	...
	local Team2ListSmall = LUI.UIList.new( self, controller, 0, 0, nil, false, false, 0, 0, false, true )
	...
	local Team2ListLarge = LUI.UIList.new( self, controller, 9, 0, nil, false, false, 0, 0, false, true )
