...
LUI.createMenu.EditCodCasterSettings = function ( controller )
	...
	local TipText = LUI.UIText.new()
	TipText:setLeftRight( true, false, 70, 371 )
	TipText:setTopBottom( true, false, 507.7, 529.7 )
	TipText:setAlpha( 0.85 )
	TipText:setText( Engine.Localize( "CODCASTER_EDIT_SETTINGS_TOOL_TIP" ) )
	TipText:setTTF( "fonts/RefrigeratorDeluxe-Regular.ttf" )
	TipText:setAlignment( Enum.LUIAlignment.LUI_ALIGNMENT_LEFT )
	TipText:setAlignment( Enum.LUIAlignment.LUI_ALIGNMENT_TOP )
	self:addElement( TipText )
	...
	DescTitle0:setText( Engine.Localize( LocalizeToUpperString( "CODCASTER_TEAM_IDENTITY" ) ) )
