...
local PreLoadFunc = function ( self, controller )
	Engine.SetModelValue( Engine.CreateModel( Engine.GetModelForController( controller ), "displayTop3Players" ), 0 )
end
...
local PostLoadFunc = function ( f3_arg0, f3_arg1 )
	...
	local f3_local2 = function ( f6_arg0, f6_arg1 )
		...
		local f6_local4 = Engine.GetModel( Engine.GetModelForController( f6_arg1.controller ), "objective" .. f6_arg1.objId )
		local f6_local5 = f6_local4 and Engine.GetModel( f6_local4, "state" )
		local f6_local6 = CoD.SafeGetModelValue( f6_local4, "entNum" )
		local f6_local7 = CoD.GetTeamID( f3_arg1 )
		local f6_local8 = Engine.GetRoundsPlayed( f3_arg1 )
		if f6_local7 ~= f6_arg0.savedTeam or f6_local8 ~= f6_arg0.savedRound then
			f6_arg0.savedStates = {}
			f6_arg0.savedEntNums = {}
			f6_arg0.savedObjectiveNames = {}
		end
		if not CoD.isCampaign and Engine.IsVisibilityBitSet( f3_arg1, Enum.UIVisibilityBit.BIT_GAME_ENDED ) and f6_local2 == f6_local3 and f6_local6 == f6_arg0.savedEntNums[f6_arg1.objId] and f6_local0 == f6_arg0.savedObjectiveNames[f6_arg1.objId] then
			if f6_local5 ~= nil then
				Engine.ForceNotifyModelSubscriptions( f6_local5 )
			end
			return 
		elseif f6_local5 ~= nil then
			local f6_local9 = Engine.GetModelValue( f6_local5 )
			Engine.SetModelValue( f6_local5, CoD.OBJECTIVESTATE_EMPTY )
			Engine.SetModelValue( f6_local5, f6_local9 )
		end
		f6_arg0.savedStates[f6_arg1.objId] = f6_local2
		f6_arg0.savedEntNums[f6_arg1.objId] = f6_local6
		f6_arg0.savedObjectiveNames[f6_arg1.objId] = f6_local0
		f6_arg0.savedTeam = f6_local7
		f6_arg0.savedRound = f6_local8
		if CoD.IsShoutcaster( f6_arg1.controller ) then
			local f6_local9 = f3_arg0:getParent()
			f6_local9 = f6_local9.safeArea.CodCaster
			if f6_local9 and f6_local9.CodCasterHeaderWidget then
				local f6_local10 = f6_local9.CodCasterHeaderWidget.CodCasterHeaderGameModeWidget
				if f6_local10 and IsGameTypeEqualToString( "dom" ) and f6_local10.DomFlags then
					f6_local10.DomFlags:create( f6_arg1 )
				end
			end
		end
		if f6_local0 then
			local f6_local9 = CoD.WaypointWidgetContainer.new( f6_arg0, f6_arg1.controller )
			f6_local9.objective = f6_local1
			f6_local9:setupWaypoint( f6_arg1 )
			f6_arg0:addElement( f6_local9 )
			table.insert( f6_arg0.WaypointContainerList, f6_local9 )
			f6_local9:update( f6_arg1 )
			f6_local9:setModel( f6_local4 )
			local f6_local10 = f6_arg1.controller
			if Engine.GetModel( f6_local4, "entNum" ) ~= nil and f6_local0 == "sd_bomb" then
				f6_local9:subscribeToModel( Engine.GetModel( f6_local4, "entNum" ), function ( model )
					Engine.SetModelValue( Engine.CreateModel( Engine.GetModelForController( f6_local10 ), "hudItems.SDBombClient" ), Engine.GetModelValue( model ) )
				end )
			end
			local f6_local11 = f6_arg0
			f6_local9:subscribeToModel( f6_local5, function ( model )
				local modelValue = Engine.GetModelValue( model )
				...
				if modelValue == CoD.OBJECTIVESTATE_ACTIVE or modelValue == CoD.OBJECTIVESTATE_CURRENT or modelValue == CoD.OBJECTIVESTATE_DONE then
					f6_local9:show()
					f6_local9:update( {
						controller = f6_local10,
						objState = modelValue
					} )
				elseif modelValue == CoD.OBJECTIVESTATE_EMPTY then
					f6_local11:removeWaypoint( f6_arg1.objId )
					f6_arg0.savedEntNums[f6_arg1.objId] = nil
				else
					f6_local9:hide()
				end
			end )
			local f6_local12 = Engine.GetModel( f6_local4, "updateTime" )
			if f6_local12 ~= nil then
				f6_local9:subscribeToModel( f6_local12, function ( model )
					f6_local9:update( {
						controller = f6_local10
					} )
				end )
			end
			f6_local9:subscribeToModel( Engine.GetModel( f6_local4, "progress" ), function ( model )
				f6_local9:update( {
					controller = f6_local10,
					progress = Engine.GetModelValue( model )
				} )
			end )
			f6_local9:subscribeToModel( Engine.GetModel( f6_local4, "clientUseMask" ), function ( model )
				f6_local9:update( {
					controller = f6_local10,
	...
	f3_arg0.close = function ( f15_arg0 )
		f3_local5( f15_arg0 )
		if f15_arg0.BlackHat ~= nil then
			f15_arg0.BlackHat:close()
		end
	end
	...
	f3_arg0.PlayerCardObituaryCallout.playNotification = function ( f18_arg0, f18_arg1 )
		f18_arg0.currentNotification = f18_arg1
		CoD.ChallengesUtility.SetCallingCardForWidget( f18_arg0.PlayerCard0.CallingCardsFrameWidget.CardIconFrame, GetBackgroundByID( f18_arg1.selectedBg ) )
		f18_arg0.PlayerCard0.GamerTag:setAlpha( HideIfEmptyString( f18_arg1.playerName ) )
		f18_arg0.PlayerCard0.GamerTag.itemName:setText( Engine.Localize( f18_arg1.playerName ) )
		f18_arg0.PlayerCard0.ClanTag:setAlpha( HideIfEmptyString( f18_arg1.clanTag ) )
		f18_arg0.PlayerCard0.ClanTag.itemName:setText( StringAsClanTag( f18_arg1.clanTag ) )
		f18_arg0.PlayerCard0.HeroLobbyClientExtraCamRender:setupCharacterExtraCamRenderForLobbyClient( f18_arg1.xuid )
		f18_arg0.PlayerCard0.RankIcon:setImage( RegisterImage( f18_arg1.rankIcon ) )
		f18_arg0.PlayerCard0.Rank:setText( Engine.Localize( f18_arg1.rank ) )
		f18_arg0.PlayerCard0.PlayerEmblem:setupPlayerEmblemByXUID( f18_arg1.xuid )
		f18_arg0:playClip( "Bottom" )
	end
	
	f3_arg0.PlayerCardObituaryCallout.appendNotification = function ( f19_arg0, f19_arg1 )
		if f19_arg1 == nil then
			return 
		elseif f19_arg0.currentNotification ~= nil then
			local f19_local0 = f19_arg0.nextNotification
			if f19_local0 == nil then
				f19_arg0.nextNotification = f19_arg1
			end
			while f19_local0 and f19_local0.next ~= nil do
				f19_local0 = f19_local0.next
			end
			f19_local0.next = f19_arg1
		else
			f19_arg0:playNotification( f19_arg1 )
		end
	end
	
	f3_arg0.PlayerCardObituaryCallout.getModelValueTable = function ( f20_arg0, f20_arg1 )
		return {
			xuid = Engine.GetModelValue( Engine.GetModel( f20_arg1, "xuid" ) ),
			playerName = Engine.GetModelValue( Engine.GetModel( f20_arg1, "playerName" ) ),
			clanTag = Engine.GetModelValue( Engine.GetModel( f20_arg1, "clanTag" ) ),
			selectedBg = Engine.GetModelValue( Engine.GetModel( f20_arg1, "selectedBg" ) ),
			rankIcon = Engine.GetModelValue( Engine.GetModel( f20_arg1, "rankIcon" ) ),
			rank = Engine.GetModelValue( Engine.GetModel( f20_arg1, "rank" ) )
		}
	end
...
LUI.createMenu.T7Hud = function ( controller )
	...
	local SafeAreaContainerBack = CoD.T7Hud_SafeAreaContainer_Back.new( self, controller )
	...
	local OutOfBounds = CoD.OutOfBounds.new( self, controller )
	...
	OutOfBounds:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "hudItems.outOfBoundsEndTime" ), function ( model )
		self:updateElementState( OutOfBounds, {
	...
	local PlayerCardObituaryCallout = CoD.PlayerCard_ObituaryCallout.new( self, controller )
	...
	CursorHint:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				local f33_local0 = IsCursorHintActive( controller )
				if f33_local0 then
					if not Engine.IsVisibilityBitSet( controller, Enum.UIVisibilityBit.BIT_HUD_HARDCORE ) and Engine.IsVisibilityBitSet( controller, Enum.UIVisibilityBit.BIT_HUD_VISIBLE ) and not Engine.IsVisibilityBitSet( controller, Enum.UIVisibilityBit.BIT_IN_GUIDED_MISSILE ) and not Engine.IsVisibilityBitSet( controller, Enum.UIVisibilityBit.BIT_IS_DEMO_PLAYING ) and not Engine.IsVisibilityBitSet( controller, Enum.UIVisibilityBit.BIT_IS_FLASH_BANGED ) and not Engine.IsVisibilityBitSet( controller, Enum.UIVisibilityBit.BIT_SELECTING_LOCATIONAL_KILLSTREAK ) and not Engine.IsVisibilityBitSet( controller, Enum.UIVisibilityBit.BIT_SPECTATING_CLIENT ) and not Engine.IsVisibilityBitSet( controller, Enum.UIVisibilityBit.BIT_UI_ACTIVE ) then
						f33_local0 = IsModelValueEqualTo( controller, "hudItems.cursorHintIconRatio", 1 )
					else
						f33_local0 = false
					end
				end
		...
		},
		{
			...
			condition = function ( menu, element, event )
				...
				if f34_local0 then
					if not Engine.IsVisibilityBitSet( controller, Enum.UIVisibilityBit.BIT_HUD_HARDCORE ) and Engine.IsVisibilityBitSet( controller, Enum.UIVisibilityBit.BIT_HUD_VISIBLE ) and not Engine.IsVisibilityBitSet( controller, Enum.UIVisibilityBit.BIT_IN_GUIDED_MISSILE ) and not Engine.IsVisibilityBitSet( controller, Enum.UIVisibilityBit.BIT_IS_DEMO_PLAYING ) and not Engine.IsVisibilityBitSet( controller, Enum.UIVisibilityBit.BIT_IS_FLASH_BANGED ) and not Engine.IsVisibilityBitSet( controller, Enum.UIVisibilityBit.BIT_SELECTING_LOCATIONAL_KILLSTREAK ) and not Engine.IsVisibilityBitSet( controller, Enum.UIVisibilityBit.BIT_SPECTATING_CLIENT ) and not Engine.IsVisibilityBitSet( controller, Enum.UIVisibilityBit.BIT_UI_ACTIVE ) then
						f34_local0 = IsModelValueEqualTo( controller, "hudItems.cursorHintIconRatio", 2 )
					else
						f34_local0 = false
					end
				end
		...
		},
		{
			...
			condition = function ( menu, element, event )
				...
				if f35_local0 then
					if not Engine.IsVisibilityBitSet( controller, Enum.UIVisibilityBit.BIT_HUD_HARDCORE ) and Engine.IsVisibilityBitSet( controller, Enum.UIVisibilityBit.BIT_HUD_VISIBLE ) and not Engine.IsVisibilityBitSet( controller, Enum.UIVisibilityBit.BIT_IN_GUIDED_MISSILE ) and not Engine.IsVisibilityBitSet( controller, Enum.UIVisibilityBit.BIT_IS_DEMO_PLAYING ) and not Engine.IsVisibilityBitSet( controller, Enum.UIVisibilityBit.BIT_IS_FLASH_BANGED ) and not Engine.IsVisibilityBitSet( controller, Enum.UIVisibilityBit.BIT_SELECTING_LOCATIONAL_KILLSTREAK ) and not Engine.IsVisibilityBitSet( controller, Enum.UIVisibilityBit.BIT_SPECTATING_CLIENT ) and not Engine.IsVisibilityBitSet( controller, Enum.UIVisibilityBit.BIT_UI_ACTIVE ) then
						f35_local0 = IsModelValueEqualTo( controller, "hudItems.cursorHintIconRatio", 4 )
					else
						f35_local0 = false
					end
				end
		...
		},
		{
			...
			condition = function ( menu, element, event )
				...
				if f36_local0 then
					if not Engine.IsVisibilityBitSet( controller, Enum.UIVisibilityBit.BIT_HUD_HARDCORE ) and Engine.IsVisibilityBitSet( controller, Enum.UIVisibilityBit.BIT_HUD_VISIBLE ) and not Engine.IsVisibilityBitSet( controller, Enum.UIVisibilityBit.BIT_IN_GUIDED_MISSILE ) and not Engine.IsVisibilityBitSet( controller, Enum.UIVisibilityBit.BIT_IS_DEMO_PLAYING ) and not Engine.IsVisibilityBitSet( controller, Enum.UIVisibilityBit.BIT_IS_FLASH_BANGED ) and not Engine.IsVisibilityBitSet( controller, Enum.UIVisibilityBit.BIT_SELECTING_LOCATIONAL_KILLSTREAK ) and not Engine.IsVisibilityBitSet( controller, Enum.UIVisibilityBit.BIT_SPECTATING_CLIENT ) and not Engine.IsVisibilityBitSet( controller, Enum.UIVisibilityBit.BIT_UI_ACTIVE ) then
						f36_local0 = IsModelValueEqualTo( controller, "hudItems.cursorHintIconRatio", 0 )
					else
						f36_local0 = false
					end
				end
	...
	local ShockCharge0 = CoD.ShockCharge.new( self, controller )
	...
	ShockCharge0:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "hudItems.shockImageTop" ), function ( model )
		self:updateElementState( ShockCharge0, {
			name = "model_validation",
			menu = self,
			modelValue = Engine.GetModelValue( model ),
	...
	local ThrustMeterContainer0 = CoD.ThrustMeterContainer.new( self, controller )
	...
	local SafeAreaContainerFront = CoD.T7Hud_SafeAreaContainer_Front.new( self, controller )
	...
	self:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				...
				if not f56_local0 then
					...
					if not f56_local0 then
						f56_local0 = Engine.IsVisibilityBitSet( controller, Enum.UIVisibilityBit.BIT_GAME_ENDED )
						if not f56_local0 then
							f56_local0 = Engine.IsVisibilityBitSet( controller, Enum.UIVisibilityBit.BIT_IN_KILLCAM )
						end
					end
				end
				return f56_local0
