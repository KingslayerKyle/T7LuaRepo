...
CoD.WC_Category.UpdateListFromTabChanged = function ( f5_arg0, f5_arg1, f5_arg2 )
	local f5_local0 = CoD.WC_Category.ACV.selectedAttachment
	if f5_arg0.frame.framedWidget.selectionList and f5_local0 and f5_arg1.filterString then
		DataSources.WeaponOptions.setCurrentFilterItem( f5_local0 .. "_" .. f5_arg1.filterString )
		f5_arg0.frame.framedWidget.selectionList:updateDataSource()
		f5_arg0.frame.framedWidget.selectionList:findItem( {
			weaponOptionSubIndex = 0
		}, nil, true, nil )
	end
end
