		...
		if f3_local11 then
			...
			if f3_local12 then
				...
				if f3_local7 < Enum.WeaponOptionFilter.WEAPONOPTION_FILTER_MODE_COUNT then
					...
					f3_local14 = Engine.WeaponOptionNewModeAgnosticItemCount( f3_arg1, f3_local0, f3_local13, f3_local11.filterEnum )
				end
...
LUI.createMenu.ReticleSelect = function ( controller )
	...
	GenericMenuFrame0.cac3dTitleIntermediary0.FE3dTitleContainer0.MenuTitle.TextBox1.Label0:setText( Engine.Localize( GetReticlesMenuTitle( controller, "MENU_X_OPTICS" ) ) )
