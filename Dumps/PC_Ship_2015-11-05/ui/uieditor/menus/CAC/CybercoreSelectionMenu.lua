...
LUI.createMenu.CybercoreSelectionMenu = function ( controller )
	...
	local CybercoreVignetteContainer = CoD.scorestreakVignetteContainer.new( self, controller )
	...
	local CACBackgroundNoHero0 = CoD.CACBackgroundNoHero.new( self, controller )
	...
	local CybercoreSelectionMulticoreWidget0 = CoD.CybercoreSelectionMulticoreWidget.new( self, controller )
	...
	local coreList = LUI.UIList.new( self, controller, 2, 0, nil, false, false, 0, 0, false, true )
	...
	self:AddButtonCallbackFunction( coreList, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, nil, function ( element, menu, controller, model )
	...
	local CybercoreSelectionInfoWidget0 = CoD.CybercoreSelectionInfoWidget.new( self, controller )
	...
	local feFooterContainerNOTLobby0 = CoD.fe_FooterContainer_NOTLobby.new( self, controller )
	...
	local cacButtonBoxLrgInactiveStroke0 = CoD.cac_ButtonBoxLrgInactiveStroke.new( self, controller )
