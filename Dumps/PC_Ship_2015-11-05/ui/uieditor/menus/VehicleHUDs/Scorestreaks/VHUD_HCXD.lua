...
LUI.createMenu.VHUD_HCXD = function ( controller )
	...
	local vhudgenericbuttonlayout0 = CoD.vhud_generic_button_layout.new( self, controller )
	...
	local vhudhcxdTimebar0 = CoD.vhud_hcxd_Timebar.new( self, controller )
	...
	local vhudhcxdTimebar = CoD.vhud_hcxd_Timebar.new( self, controller )
