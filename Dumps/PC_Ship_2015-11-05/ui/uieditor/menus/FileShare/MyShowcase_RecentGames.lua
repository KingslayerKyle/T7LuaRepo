...
LUI.createMenu.MyShowcase_RecentGames = function ( controller )
	...
	RecentGamesList:setDataSource( "FileshareCommunityList" )
	...
	RecentGamesList:registerEventHandler( "menu_loaded", function ( element, event )
		local f5_local0 = nil
		SetElementDataSource( self, "RecentGamesList", "FileshareCommunityList" )
	...
	FileshareSpinner:setLeftRight( true, false, 336, 400 )
	FileshareSpinner:setTopBottom( true, false, 343, 407 )
	...
	self.clipsPerState = {
		...
		Loading = {
			DefaultClip = function ()
				...
				self.clipFinished( SelectedFilmInformation, {} )
				FileshareSpinner:completeAnimation()
				self.FileshareSpinner:setLeftRight( true, false, 345, 409 )
				self.FileshareSpinner:setTopBottom( true, false, 332, 396 )
