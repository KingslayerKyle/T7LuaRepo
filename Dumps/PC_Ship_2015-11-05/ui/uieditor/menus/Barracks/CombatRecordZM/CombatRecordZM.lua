...
LUI.createMenu.CombatRecordZM = function ( controller )
	...
	TimePlayedText:subscribeToGlobalModel( controller, "StorageGlobal", "stats_zm", function ( model )
		local statsZm = Engine.GetModelValue( model )
		if statsZm then
			TimePlayedText:setText( Engine.Localize( SecondsAsTimePlayedString( StorageLookup( controller, "playerstatslist.time_played_total.statvalue", statsZm ) ) ) )
		end
	end )
	...
	Emblem:setLeftRight( false, false, -563, -435 )
	Emblem:setTopBottom( true, false, 139, 267 )
	Emblem:subscribeToGlobalModel( controller, "StorageGlobal", "stats_zm", function ( model )
		local statsZm = Engine.GetModelValue( model )
		if statsZm then
			Emblem:setImage( RegisterImage( GetRankIconLarge( GetRankIcon( controller, "playerstatslist.rank.statvalue", "playerstatslist.plevel.statvalue", "zm", statsZm ) ) ) )
		end
	end )
	...
	RankNameBackground:setLeftRight( false, false, -424, -278 )
	...
	RankBackground:setLeftRight( false, false, -424, -278 )
	...
	RankName:setLeftRight( false, false, -424, -278 )
	...
	Rank:setLeftRight( false, false, -424, -278 )
	...
	Rank:subscribeToGlobalModel( controller, "StorageGlobal", "stats_zm", function ( model )
		local statsZm = Engine.GetModelValue( model )
		if statsZm then
			Rank:setText( Engine.Localize( RankToLevelString( "zm", StorageLookup( controller, "playerstatslist.rank.statvalue", statsZm ) ) ) )
		end
	end )
	...
	RoundsSurvived:subscribeToGlobalModel( controller, "StorageGlobal", "stats_zm", function ( model )
		local statsZm = Engine.GetModelValue( model )
		if statsZm then
			RoundsSurvived.StatValue:setText( Engine.Localize( StorageLookup( controller, "playerstatslist.total_rounds_survived.statvalue", statsZm ) ) )
		end
	end )
	...
	AvgGameScore:subscribeToGlobalModel( controller, "StorageGlobal", "stats_zm", function ( model )
		local statsZm = Engine.GetModelValue( model )
		if statsZm then
			AvgGameScore.StatValue:setText( Engine.Localize( StorageLookupTwoStatRatioRounded( controller, "playerstatslist.score.statvalue", "playerstatslist.total_games_played.statvalue", statsZm ) ) )
		end
	end )
	...
	Headshots:subscribeToGlobalModel( controller, "StorageGlobal", "stats_zm", function ( model )
		local statsZm = Engine.GetModelValue( model )
		if statsZm then
			Headshots.StatValue:setText( Engine.Localize( StorageLookup( controller, "playerstatslist.headshots.statvalue", statsZm ) ) )
		end
	end )
	...
	AvgRoundsPerGame:subscribeToGlobalModel( controller, "StorageGlobal", "stats_zm", function ( model )
		local statsZm = Engine.GetModelValue( model )
		if statsZm then
			AvgRoundsPerGame.StatValue:setText( Engine.Localize( StorageLookupTwoStatRatioRounded( controller, "playerstatslist.total_rounds_survived.statvalue", "playerstatslist.total_games_played.statvalue", statsZm ) ) )
		end
	end )
	...
	BubblegumBuffsButton:subscribeToGlobalModel( controller, "CombatRecordMostUsedBubblegumBuff", "itemName", function ( model )
		local itemName = Engine.GetModelValue( model )
		if itemName then
			BubblegumBuffsButton.ButtonTitle0:setText( Engine.Localize( LocalizeIntoString( "MENU_CR_MOST_USED", itemName ) ) )
		end
	end )
	...
	MapsButton.WeaponImage:setAlpha( 0 )
	...
	MapsButton:subscribeToGlobalModel( controller, "CombatRecordZMHighestRound", "mapName", function ( model )
		...
		if mapName then
			MapsButton.ItemImage:setImage( RegisterImage( SetValueIfStringEqualTo( "img_t7_menu_zm_preview_zod", "t7_menu_zombies_icon_shadowsofevil", SetValueIfStringEqualTo( "img_mapvote_zm_factory", "t7_menu_zombies_icon_giant", SetValueIfStringEqualTo( "$black", "menu_mp_lobby_none_selected_new", MapNameToMapImage( mapName ) ) ) ) ) )
		end
	end )
	MapsButton:subscribeToGlobalModel( controller, "CombatRecordZMHighestRound", "mapName", function ( model )
		local mapName = Engine.GetModelValue( model )
		if mapName then
			MapsButton.ButtonTitle0:setText( Engine.Localize( LocalizeIntoString( "MENU_CR_HIGHEST_ROUND", mapName ) ) )
		end
	end )
	...
	StartMenuframenoBG00:setLeftRight( false, false, -427, -275 )
