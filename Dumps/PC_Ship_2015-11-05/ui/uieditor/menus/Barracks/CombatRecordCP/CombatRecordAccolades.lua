...
LUI.createMenu.CombatRecordAccolades = function ( controller )
	...
	MenuFrame.titleLabel:setText( Engine.Localize( "MENU_ACCOLADES" ) )
	MenuFrame.cac3dTitleIntermediary0.FE3dTitleContainer0.MenuTitle.TextBox1.Label0:setText( Engine.Localize( "MENU_ACCOLADES" ) )
	...
	SelfIdentityBadge:setTopBottom( true, false, 21, 81 )
