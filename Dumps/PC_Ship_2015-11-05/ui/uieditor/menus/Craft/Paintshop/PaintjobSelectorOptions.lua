...
LUI.createMenu.PaintjobSelectorOptions = function ( controller )
	...
	Blackfade:setLeftRight( true, true, -987, 0 )
	...
	self:registerEventHandler( "ui_keyboard_input", function ( self, event )
		local f4_local0 = nil
		PaintjobSelector_HandleRenameKeyboardComplete( self, self, controller, event )
		PaintjobSelector_RenamePaintjob( self, self, controller )
