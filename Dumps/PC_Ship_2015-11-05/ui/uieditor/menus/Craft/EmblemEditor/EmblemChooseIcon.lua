...
LUI.createMenu.EmblemChooseIcon = function ( controller )
	...
	decalBMDescription.weaponDescTextBox:setText( Engine.Localize( LocalizeIntoString( "MPUI_BLACKMARKET_ITEM_CLASSIFIED_DESC", "MPUI_DECAL" ) ) )
	...
	self:registerEventHandler( "menu_loaded", function ( self, event )
		...
		elseif IsPaintshop( controller ) then
			EmblemChooseIcon_SetPreviewDecalCamera( self, self, controller )
