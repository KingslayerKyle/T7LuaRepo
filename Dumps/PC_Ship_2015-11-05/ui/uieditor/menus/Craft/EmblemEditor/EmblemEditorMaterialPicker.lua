...
local f0_local0 = function ( f2_arg0, f2_arg1 )
	...
	CoD.Menu.AddButtonCallbackFunction( f2_arg0, f2_arg0, f2_arg1, Enum.LUIButton.LUI_KEY_PCKEY_MWHEELUP, "MWHEELUP", function ( element, menu, controller, f6_arg3 )
	...
	CoD.Menu.AddButtonCallbackFunction( f2_arg0, f2_arg0, f2_arg1, Enum.LUIButton.LUI_KEY_PCKEY_MWHEELDOWN, "MWHEELDOWN", function ( element, menu, controller, f7_arg3 )
		if not f2_arg0.m_disableNavigation then
			Engine.ExecNow( controller, "emblemUpdateMaterialScaleX -0.02" )
			Engine.ExecNow( controller, "emblemUpdateMaterialScaleY -0.02" )
		end
...
local PreLoadFunc = function ( self, controller )
	self.restoreState = function ( f16_arg0 )
		...
		if f16_local0 ~= CoD.emblem.INVALID_ID then
			...
			if f16_local1 then
				local f16_local2 = f16_local1:getItemAt( f0_local4( controller ) )
				if f16_local2 then
					f16_local1:setActiveItem( f16_local2 )
				end
			end
...
LUI.createMenu.EmblemEditorMaterialPicker = function ( controller )
	...
	EmblemEditorFrame.cac3dTitleIntermediary0.FE3dTitleContainer0.MenuTitle.TextBox1.FeatureIcon:setImage( RegisterImage( "uie_t7_mp_icon_header_emblem" ) )
