...
CoD.chooseClassWidget.new = function ( menu, controller )
	...
	Wildcards:registerEventHandler( "menu_loaded", function ( element, event )
	...
	WildcardHeader:setTopBottom( false, true, -85.5, -66.5 )
			...
			DefaultState = function ()
				...
				local f43_local1 = function ( f45_arg0, f45_arg1 )
					if not f45_arg1.interrupted then
						f45_arg0:beginAnimation( "keyframe", 129, false, false, CoD.TweenType.Linear )
					end
					f45_arg0:setAlpha( 1 )
				...
				WildcardHeader:setAlpha( 0 )
				WildcardHeader:registerEventHandler( "transition_complete_keyframe", f43_local1 )
			end,
			Campaign = function ()
				self:setupElementClipCounter( 7 )
				primarySecondarySpacer:completeAnimation()
				...
				local f46_local1 = function ( f48_arg0, f48_arg1 )
					if not f48_arg1.interrupted then
						f48_arg0:beginAnimation( "keyframe", 129, false, false, CoD.TweenType.Linear )
					end
					f48_arg0:setAlpha( 1 )
				...
				WildcardHeader:beginAnimation( "keyframe", 119, false, false, CoD.TweenType.Linear )
				WildcardHeader:setAlpha( 0 )
				WildcardHeader:registerEventHandler( "transition_complete_keyframe", f46_local1 )
			end
		},
		Campaign = {
			DefaultClip = function ()
