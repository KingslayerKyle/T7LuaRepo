...
CoD.WeaponItemModelWidgetNew.new = function ( menu, controller )
	...
	BoxButtonLrgInactiveStroke:setShaderVector( 0, 0.24, 0.24, 0, 0 )
	...
	BoxButtonLrgInactiveDiag:setShaderVector( 0, 0.36, 0.38, 0, 0 )
	...
	FocusBorder:setShaderVector( 0, 0.06, 0.06, 0, 0 )
	...
	local removeButton = CoD.RemoveItemButton.new( menu, controller )
	removeButton:setLeftRight( false, true, -22, -3 )
	removeButton:setTopBottom( true, false, 3, 23 )
	removeButton:setAlpha( 0 )
	removeButton:linkToElementModel( self, nil, false, function ( model )
		removeButton:setModel( model, controller )
	end )
	self:addElement( removeButton )
	self.removeButton = removeButton
	
	local personalizeButton = CoD.PersonalizeButton.new( menu, controller )
	personalizeButton:setLeftRight( true, false, 3, 23 )
	personalizeButton:setTopBottom( true, false, 3.75, 23.75 )
	personalizeButton:setAlpha( 0 )
	personalizeButton.itemHintText.textCenterAlign:setText( Engine.Localize( "HEROES_PERSONALIZE" ) )
	...
	self.clipsPerState = {
		DefaultState = {
			DefaultClip = function ()
				...
				personalizeButton:completeAnimation()
				self.personalizeButton:setAlpha( 0 )
				self.clipFinished( personalizeButton, {} )
			end,
			GainFocus = function ()
		...
		Equipped = {
			...
			GainFocus = function ()
				...
				local removeButtonFrame2 = function ( removeButton, event )
					if not event.interrupted then
						removeButton:beginAnimation( "keyframe", 140, false, false, CoD.TweenType.Linear )
					end
					removeButton:setLeftRight( false, true, -16, -2 )
					removeButton:setTopBottom( true, false, 3, 17 )
		...
		WeaponEquipped = {
			...
			GainFocus = function ()
				...
				self.removeButton:setAlpha( 0 )
				removeButtonFrame2( removeButton, {} )
				local personalizeButtonFrame2 = function ( personalizeButton, event )
					if not event.interrupted then
						personalizeButton:beginAnimation( "keyframe", 140, false, false, CoD.TweenType.Linear )
					end
					personalizeButton:setAlpha( 1 )
					if event.interrupted then
						self.clipFinished( personalizeButton, event )
					else
						personalizeButton:registerEventHandler( "transition_complete_keyframe", self.clipFinished )
					end
				end
				
				personalizeButton:completeAnimation()
				self.personalizeButton:setAlpha( 0 )
				personalizeButtonFrame2( personalizeButton, {} )
			end,
			Focus = function ()
				self:setupElementClipCounter( 18 )
				BoxButtonLrgInactiveStroke:completeAnimation()
			...
			LoseFocus = function ()
				...
				local removeButtonFrame2 = function ( removeButton, event )
					if not event.interrupted then
						removeButton:beginAnimation( "keyframe", 159, false, false, CoD.TweenType.Linear )
					end
					removeButton:setAlpha( 0 )
					if event.interrupted then
						self.clipFinished( removeButton, event )
				...
				local personalizeButtonFrame2 = function ( personalizeButton, event )
					if not event.interrupted then
						personalizeButton:beginAnimation( "keyframe", 159, false, false, CoD.TweenType.Linear )
					end
					personalizeButton:setAlpha( 0 )
					if event.interrupted then
						self.clipFinished( personalizeButton, event )
