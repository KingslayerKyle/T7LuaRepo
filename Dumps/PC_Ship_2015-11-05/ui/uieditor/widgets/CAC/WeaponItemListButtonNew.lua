...
CoD.WeaponItemListButtonNew.new = function ( menu, controller )
	...
	LabelButtonCount:setLeftRight( false, true, -120, -16 )
	...
	LabelButtonCount:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				local f5_local0 = Gunsmith_IsEnabled( element, controller )
				if f5_local0 then
					f5_local0 = Gunsmith_IsVariantCountEmpty( element, controller )
					if f5_local0 then
	...
	IconNew:setLeftRight( true, false, 197, 262 )
	...
	self:mergeStateConditions( {
		...
		},
		{
			...
			condition = function ( menu, element, event )
				local f528_local0 = IsInPermanentUnlockMenu( controller )
				if f528_local0 then
					if not IsPermanentlyUnlocked( element, controller ) then
						f528_local0 = HavePermanentUnlockTokens( controller )
						if f528_local0 then
							f528_local0 = IsCACItemPurchased( element, controller )
						end
					else
						f528_local0 = false
					end
