...
local PostLoadFunc = function ( self, controller, menu )
	...
	local f1_local0 = Engine.CreateModel( Engine.GetModelForController( controller ), "displayTop3Players" )
...
CoD.Top3PlayersScreenWidget.new = function ( menu, controller )
	...
	self:registerEventHandler( "gain_focus", function ( self, event )
		if self.m_focusable and self.KillcamHeader:processEvent( event ) then
			return true
		else
