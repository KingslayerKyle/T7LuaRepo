	...
	self.clipsPerState = {
		DefaultState = {
			DefaultClip = function ()
				...
				Rightline0:completeAnimation()
				self.Rightline0:setRGB( 0, 0, 0 )
				self.Rightline0:setAlpha( 0 )
				self.clipFinished( Rightline0, {} )
			end
		},
		VictoryGreen = {
			DefaultClip = function ()
				...
				self.clipFinished( LineColorRight, {} )
				Rightline0:completeAnimation()
				self.Rightline0:setLeftRight( true, false, -55, -32 )
				self.Rightline0:setTopBottom( true, true, 25.5, -25.5 )
				self.Rightline0:setRGB( 0.36, 1, 0.15 )
				self.Rightline0:setAlpha( 0.4 )
				self.clipFinished( Rightline0, {} )
			end
		},
		DefeatRed = {
			DefaultClip = function ()
				...
				self.Rightline0:setLeftRight( true, false, -55, -32 )
				self.Rightline0:setTopBottom( true, true, 25.5, -25.5 )
				self.Rightline0:setRGB( 1, 0.01, 0 )
				self.Rightline0:setAlpha( 0.4 )
				self.Rightline0:setMaterial( LUI.UIImage.GetCachedMaterial( "ui_normal" ) )
				self.clipFinished( Rightline0, {} )
			end
		},
		OvertimeOrange = {
