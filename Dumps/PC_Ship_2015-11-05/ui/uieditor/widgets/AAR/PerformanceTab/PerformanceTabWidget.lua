...
CoD.PerformanceTabWidget.new = function ( menu, controller )
	...
	Panel10:setTopBottom( false, false, -264, 191.59 )
	...
	Panel20:setTopBottom( false, false, -264, 191.59 )
	...
	Panel30:setTopBottom( false, false, -264, 191.59 )
	...
	Panel40:setTopBottom( false, false, 191.59, 261 )
	...
	VignetteBack:setTopBottom( true, false, -102, 618 )
	...
	CategoryListLine0:setLeftRight( true, false, 383, 782.92 )
	...
	self.clipsPerState = {
		DefaultState = {
			DefaultClip = function ()
				...
				local f21_local23 = function ( f65_arg0, f65_arg1 )
					if not f65_arg1.interrupted then
						f65_arg0:beginAnimation( "keyframe", 289, false, false, CoD.TweenType.Linear )
					end
					f65_arg0:setAlpha( 0.33 )
				...
				CategoryListLine00:registerEventHandler( "transition_complete_keyframe", f21_local23 )
