...
CoD.CamoDiamondRewardsCarouselItemInternal = InheritFrom( LUI.UIElement )
CoD.CamoDiamondRewardsCarouselItemInternal.new = function ( menu, controller )
	local self = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc( self, controller )
	end
	self:setUseStencil( false )
	self:setClass( CoD.CamoDiamondRewardsCarouselItemInternal )
	self.id = "CamoDiamondRewardsCarouselItemInternal"
	self.soundSet = "HUD"
	...
	CardImage:setLeftRight( true, false, 29.21, 247.79 )
	CardImage:setTopBottom( true, false, -44.67, 166.01 )
