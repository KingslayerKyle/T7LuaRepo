...
CoD.ReticleRewardsCarouselItemInternal.new = function ( menu, controller )
	...
	highlight:setLeftRight( false, false, -105.77, 105 )
	highlight:setTopBottom( true, false, -54.67, 154.33 )
	highlight:setRGB( ColorSet.ReticleReward.r, ColorSet.ReticleReward.g, ColorSet.ReticleReward.b )
	...
	CardImage:setLeftRight( true, false, 84.61, 190.61 )
	CardImage:setTopBottom( true, false, 11.48, 116.48 )
	...
	IndividualRewardItem1.NotificationRewardBorder:setRGB( ColorSet.ReticleReward.r, ColorSet.ReticleReward.g, ColorSet.ReticleReward.b )
	...
	IndividualRewardItem2.NotificationRewardBorder:setRGB( ColorSet.ReticleReward.r, ColorSet.ReticleReward.g, ColorSet.ReticleReward.b )
	...
	IndividualRewardItem3.NotificationRewardBorder:setRGB( ColorSet.ReticleReward.r, ColorSet.ReticleReward.g, ColorSet.ReticleReward.b )
	...
	IndividualRewardItem4.NotificationRewardBorder:setRGB( ColorSet.ReticleReward.r, ColorSet.ReticleReward.g, ColorSet.ReticleReward.b )
	...
	RankUpNotificationFooterBacking:setRGB( ColorSet.ReticleReward.r, ColorSet.ReticleReward.g, ColorSet.ReticleReward.b )
	...
	verticalScrollingTextBox18:setLeftRight( false, false, -115, 115 )
