...
CoD.ScoreboardHeaderWidget.new = function ( menu, controller )
	...
	GametypeAndMapName:registerEventHandler( "menu_loaded", function ( element, event )
		local f2_local0 = nil
	...
	self.clipsPerState = {
		DefaultState = {
			DefaultClip = function ()
				...
				GametypeAndMapName:completeAnimation()
				self.GametypeAndMapName:setLeftRight( true, false, 9, 325 )
				self.GametypeAndMapName:setTopBottom( true, false, 7, 25 )
				self.clipFinished( GametypeAndMapName, {} )
		...
		ShowTimer = {
			DefaultClip = function ()
				self:setupElementClipCounter( 2 )
				GametypeAndMapName:completeAnimation()
				self.GametypeAndMapName:setLeftRight( true, false, 76, 370 )
				self.GametypeAndMapName:setTopBottom( true, false, 7, 25 )
				self.clipFinished( GametypeAndMapName, {} )
				GameTimer:completeAnimation()
