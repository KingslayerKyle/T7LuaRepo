...
CoD.GenericProjectedTabletInternal.new = function ( menu, controller )
	...
	Noise:setLeftRight( true, true, 43, -57 )
	Noise:setTopBottom( true, true, 0, 0 )
	Noise:setAlpha( 0 )
	Noise:setImage( RegisterImage( "uie_hud_t7_minimap_mp_ethiopia_shadow" ) )
	Noise:setMaterial( LUI.UIImage.GetCachedMaterial( "uie_digital_noise" ) )
	Noise:setShaderVector( 0, 0.17, 0, 0, 0 )
	Noise:setShaderVector( 1, 0.73, 0, 0, 0 )
