...
CoD.BribeDuplicatesPopupInfo.new = function ( menu, controller )
	...
	CryptokeyTypeNameAndCount0:setTopBottom( true, false, 145, 172 )
	...
	CryptokeyTypeNameAndCount1:setTopBottom( true, false, 178, 205 )
	...
	CryptokeyTypeNameAndCount2:setTopBottom( true, false, 205, 232 )
