...
CoD.StartMenu_Button_LG.new = function ( menu, controller )
	...
	StartMenuOnlineOnly.TextBox0:setText( Engine.Localize( LocalizeToUpperString( "MENU_ONLINE_ONLY" ) ) )
	...
	self.clipsPerState = {
		...
		OnlineOnly = {
			DefaultClip = function ()
				...
				self.StartMenuOnlineOnly.TextBox0:setText( Engine.Localize( LocalizeToUpperString( "MENU_ONLINE_ONLY" ) ) )
				self.clipFinished( StartMenuOnlineOnly, {} )
				FocusBarT:completeAnimation()
				self.FocusBarT:setAlpha( 0 )
				self.clipFinished( FocusBarT, {} )
		...
		ComingSoon = {
			DefaultClip = function ()
				...
				StartMenuOnlineOnly.TextBox0:completeAnimation()
				self.StartMenuOnlineOnly:setAlpha( 1 )
				self.StartMenuOnlineOnly.TextBox0:setText( Engine.Localize( LocalizeToUpperString( "MENU_COMING_SOON" ) ) )
				self.clipFinished( StartMenuOnlineOnly, {} )
				FocusBarT:completeAnimation()
				self.FocusBarT:setAlpha( 0 )
				self.clipFinished( FocusBarT, {} )
