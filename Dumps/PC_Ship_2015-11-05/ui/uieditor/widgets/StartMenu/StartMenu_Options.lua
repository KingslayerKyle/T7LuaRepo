...
CoD.StartMenu_Options.new = function ( menu, controller )
	...
	Graphics.StartMenuIdentitySubTitle0.SubTitle:setText( Engine.Localize( LocalizeToUpperString( "MENU_GRAPHICS" ) ) )
	...
	Audio.StartMenuIdentitySubTitle0.SubTitle:setText( Engine.Localize( LocalizeToUpperString( "MENU_AUDIO" ) ) )
	...
	GraphicContent.StartMenuIdentitySubTitle0.SubTitle:setText( Engine.Localize( LocalizeToUpperString( "MENU_CONTENT_FILTER" ) ) )
	...
	MusicTracks.StartMenuIdentitySubTitle0.SubTitle:setText( Engine.Localize( LocalizeToUpperString( "MENU_MUSIC_TRACKS" ) ) )
