...
CoD.StartMenu_Barracks_Button_MP.new = function ( menu, controller )
	...
	RankBackground0:setLeftRight( false, false, -141, 147 )
	...
	RankNameBackground0:setLeftRight( false, false, -141, 147 )
	RankNameBackground0:setTopBottom( true, false, 178, 206 )
	...
	Rank:setTopBottom( true, false, 207, 235 )
	...
	KD:subscribeToGlobalModel( controller, "StorageGlobal", "stats_mp", function ( model )
		local statsMp = Engine.GetModelValue( model )
		if statsMp then
			KD.Title:setText( Engine.Localize( StorageLookupTwoStatRatio( controller, "playerstatslist.kills.statvalue", "playerstatslist.deaths.statvalue", statsMp ) ) )
		end
	end )
	self:addElement( KD )
	self.KD = KD
	...
	SPM:subscribeToGlobalModel( controller, "StorageGlobal", "stats_mp", function ( model )
		local statsMp = Engine.GetModelValue( model )
		if statsMp then
			SPM.Title:setText( Engine.Localize( StorageLookupSPM( controller, "playerstatslist.score.statvalue", "playerstatslist.time_played_total.statvalue", statsMp ) ) )
		end
	end )
	self:addElement( SPM )
	self.SPM = SPM
	...
	WL:subscribeToGlobalModel( controller, "StorageGlobal", "stats_mp", function ( model )
		local statsMp = Engine.GetModelValue( model )
		if statsMp then
			WL.Title:setText( Engine.Localize( StorageLookupTwoStatRatio( controller, "playerstatslist.wins.statvalue", "playerstatslist.losses.statvalue", statsMp ) ) )
		end
	end )
	self:addElement( WL )
	self.WL = WL
