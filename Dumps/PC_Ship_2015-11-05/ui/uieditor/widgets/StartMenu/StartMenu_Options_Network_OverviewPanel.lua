...
CoD.StartMenu_Options_Network_OverviewPanel.new = function ( menu, controller )
	...
	NetworkPanel3:setLeftRight( true, true, 190, -20 )
	...
	VersionValueLabel:setTopBottom( true, false, 315, 340 )
	...
	ConnectivityLabel:setTopBottom( true, false, 339, 364 )
	...
	self.clipsPerState = {
		...
		PC = {
			DefaultClip = function ()
				...
				self.NetworkPanel3:setLeftRight( true, true, 190, -20 )
				...
				self.VersionValueLabel:setTopBottom( true, false, 85.5, 110.5 )
				...
				self.ConnectivityLabel:setTopBottom( true, false, 109.5, 134.5 )
