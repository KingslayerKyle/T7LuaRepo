...
CoD.TempestReticleInternal.new = function ( menu, controller )
	...
	OuterLineAngleCenter:setShaderVector( 0, 0.07, 0.16, 0.77, 0.05 )
	...
	OuterLineRightTop:setShaderVector( 0, 0.14, 0.15, 0.8, 0 )
	...
	OuterLineRightTopLeft2:setShaderVector( 0, 0.14, 0.15, 0.8, 0 )
	...
	OuterLineAngleCenter1:setShaderVector( 0, 0.07, 0.16, 0.77, 0.05 )
	...
	OuterLineRightTop1:setShaderVector( 0, 0.14, 0.15, 0.8, 0 )
	...
	OuterLineAngleCenterLL:setShaderVector( 0, 0.07, 0.16, 0.77, 0.05 )
	...
	OuterLineLeft2:setShaderVector( 0, 0.14, 0.15, 0.8, 0 )
	...
	Image0:setShaderVector( 0, 0.06, 0.5, 0.04, 0 )
	...
	Image1:setShaderVector( 0, 0.06, 0.5, 0.04, 0 )
	...
	Image2:setShaderVector( 0, 0.06, 0.5, 0.04, 0 )
	...
	Image3:setShaderVector( 0, 0.06, 0.5, 0.04, 0 )
	...
	self:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				return IsModelValueEqualToEnum( controller, "currentWeapon.weaponDelayFiring", Enum.WeaponFireEvent.WEAPON_EVENT_FIRING )
			end
		}
	} )
	self:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "currentWeapon.weaponDelayFiring" ), function ( model )
		menu:updateElementState( self, {
			name = "model_validation",
			menu = menu,
			modelValue = Engine.GetModelValue( model ),
			modelName = "currentWeapon.weaponDelayFiring"
		} )
	end )
