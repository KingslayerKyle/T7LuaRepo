...
CoD.CodCasterLoadoutListContainerContainer.new = function ( menu, controller )
	...
	CodCasterLoadoutListContainer:setLeftRight( true, false, -100, 621 )
	CodCasterLoadoutListContainer:setTopBottom( true, false, 0, 90 )
			...
			Visible = function ()
				...
				local CodCasterLoadoutListContainerFrame2 = function ( CodCasterLoadoutListContainer, event )
					if not event.interrupted then
						CodCasterLoadoutListContainer:beginAnimation( "keyframe", 1000, false, false, CoD.TweenType.Linear )
					end
				...
				self.CodCasterLoadoutListContainer:setTopBottom( true, false, 0, 90 )
