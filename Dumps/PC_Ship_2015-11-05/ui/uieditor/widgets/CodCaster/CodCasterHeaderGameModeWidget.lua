...
CoD.CodCasterHeaderGameModeWidget.new = function ( menu, controller )
	...
	rightB:setLeftRight( false, true, -223, -10 )
	...
	leftBG0:setLeftRight( true, false, 10, 223 )
	...
	BombTimerA.bg:setImage( RegisterImage( "uie_hud_icon_bomb_a" ) )
	BombTimerA.timer:setupBombTimer( 0 )
	...
	BombTimerB.bg:setImage( RegisterImage( "uie_hud_icon_bomb_b" ) )
	BombTimerB.timer:setupBombTimer( 1 )
	...
	self.clipsPerState = {
		...
		SDorSRorDem = {
			DefaultClip = function ()
				...
				self.BombTimerA:setTopBottom( true, false, 0, 30 )
				self.BombTimerA:setAlpha( 1 )
				self.clipFinished( BombTimerA, {} )
				BombTimerB:completeAnimation()
				self.BombTimerB:setLeftRight( false, false, 0, 47 )
				self.BombTimerB:setTopBottom( true, false, 0, 30 )
				self.BombTimerB:setAlpha( 1 )
				self.clipFinished( BombTimerB, {} )
				AlliesNumPlayersAlive:completeAnimation()
				self.AlliesNumPlayersAlive:setLeftRight( true, false, 6, 262 )
				self.AlliesNumPlayersAlive:setTopBottom( true, false, 6.5, 22.5 )
				self.AlliesNumPlayersAlive:setAlpha( 1 )
				self.clipFinished( AlliesNumPlayersAlive, {} )
				AxisNumPlayersAlive:completeAnimation()
				self.AxisNumPlayersAlive:setLeftRight( false, true, -256, -6 )
		...
		Uplink = {
			DefaultClip = function ()
				...
				self.UplinkBall:setTopBottom( true, false, -1, 55 )
