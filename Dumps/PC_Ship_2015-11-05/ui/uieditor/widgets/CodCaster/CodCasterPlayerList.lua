...
CoD.CodCasterPlayerList.new = function ( menu, controller )
	...
	Team1:makeFocusable()
	Team1:setLeftRight( false, true, -308, -1 )
	Team1:setTopBottom( true, false, 24, 200 )
	...
	spacer:setTopBottom( true, false, 200, 212 )
	spacer:setAlpha( 0 )
	...
	Team2Header:setTopBottom( true, false, 212, 236 )
	...
	Team2:makeFocusable()
	Team2:setLeftRight( false, true, -308, -1 )
	Team2:setTopBottom( true, false, 236, 412 )
