...
CoD.CodCasterBallStatus.new = function ( menu, controller )
	...
	Status:setTopBottom( true, false, 34.5, 54.5 )
	...
	self:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				return IsModelValueEqualTo( controller, "ballGametype.ballHeldByEnemy", 1 ) and IsModelValueEqualTo( controller, "ballGametype.ballHeldByFriendly", 0 )
			end
		},
		{
			stateName = "AlliesHeld",
			condition = function ( menu, element, event )
				return IsModelValueEqualTo( controller, "ballGametype.ballHeldByEnemy", 0 ) and IsModelValueEqualTo( controller, "ballGametype.ballHeldByFriendly", 1 )
			end
		},
		{
			stateName = "Neutral",
			condition = function ( menu, element, event )
				return IsModelValueEqualTo( controller, "ballGametype.ballHeldByEnemy", 0 ) and IsModelValueEqualTo( controller, "ballGametype.ballHeldByFriendly", 0 )
			end
		}
	} )
