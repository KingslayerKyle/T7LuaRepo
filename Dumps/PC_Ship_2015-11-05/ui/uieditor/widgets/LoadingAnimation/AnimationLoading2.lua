...
CoD.AnimationLoading2.new = function ( menu, controller )
	...
	Image0:setShaderVector( 0, 29, 0, 0, 0 )
	Image0:setShaderVector( 1, 20, 0, 0, 0 )
	...
	self.clipsPerState = {
		DefaultState = {
			DefaultClip = function ()
				...
				self.Image0:setMaterial( LUI.UIImage.GetCachedMaterial( "uie_flipbook" ) )
				self.Image0:setShaderVector( 0, 29, 1, 0, 0 )
				self.Image0:setShaderVector( 1, 20, 0, 0, 0 )
