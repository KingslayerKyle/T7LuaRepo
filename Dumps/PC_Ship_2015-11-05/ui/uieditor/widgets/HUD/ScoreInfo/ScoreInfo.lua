...
CoD.ScoreInfo.new = function ( menu, controller )
	...
	FactionContainer:subscribeToGlobalModel( controller, "Factions", "playerFactionIcon", function ( model )
		local playerFactionIcon = Engine.GetModelValue( model )
		if playerFactionIcon then
			FactionContainer.factionalliesAdd:setImage( RegisterImage( playerFactionIcon ) )
		end
	end )
	FactionContainer:subscribeToGlobalModel( controller, "Factions", "playerFactionIcon", function ( model )
		local playerFactionIcon = Engine.GetModelValue( model )
		if playerFactionIcon then
			FactionContainer.factionaxisAdd:setImage( RegisterImage( playerFactionIcon ) )
		end
	end )
