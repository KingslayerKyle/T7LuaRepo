...
local f0_local1 = function ( f2_arg0, f2_arg1, f2_arg2, f2_arg3, f2_arg4 )
	...
	local f2_local4 = Engine.GetModel( Engine.GetModelForController( f2_arg1 ), "gameScore" )
	local f2_local5 = f2_arg2 == Enum.team_t.TEAM_BAD
	local f2_local6 = Engine.GetModel( Engine.GetGlobalModel(), "factions" )
	Engine.SetModelValue( Engine.CreateModel( f2_local4, "draw" ), f2_local5 )
	local f2_local7 = Engine.GetModel( f2_local4, "alliesScore" )
	f2_local0.score = Engine.GetModelValue( f2_local7 )
	local f2_local8 = Engine.CreateModel( f2_local6, "winningTeamScore" )
	local f2_local9 = Engine.CreateModel( f2_local6, "losingTeamScore" )
	...
	local f2_local10 = Engine.GetModel( f2_local4, "axisScore" )
	f2_local1.score = Engine.GetModelValue( f2_local10 )
	...
	local f2_local11 = Engine.GetTeamID( f2_arg1, Engine.GetClientNum( f2_arg1 ) )
	if not f2_local5 and not f2_arg3 then
		if f2_arg2 == f2_local11 then
			Engine.SetModelValue( Engine.CreateModel( f2_local4, "victory" ), true )
		else
			Engine.SetModelValue( Engine.CreateModel( f2_local4, "defeat" ), true )
		end
	end
	local f2_local12
	if f2_arg2 == f2_local11 then
		...
		if not f2_local12 then
			...
			if f2_arg2 == f2_local11 then
				...
				if not f2_local13 then
					...
					Engine.CreateModel( f2_local4, "enemyScoreOrTime" )
					Engine.CreateModel( f2_local4, "playerScoreOrTime" )
					local f2_local15, f2_local16 = nil
					if f2_arg2 == Enum.team_t.TEAM_ALLIES or f2_local5 then
						f2_local2 = f2_local0
						f2_local3 = f2_local1
						f2_local15 = f2_local7
						f2_local16 = f2_local10
					else
						f2_local2 = f2_local1
						f2_local3 = f2_local0
						f2_local15 = f2_local10
						f2_local16 = f2_local7
					end
					...
					if not f2_local14 then
						...
						f2_arg0.winningScoreSubscription = f2_arg0:subscribeToModel( f2_local15, function ( model )
							local modelValue = Engine.GetModelValue( model )
							Engine.SetModelValue( f2_local8, modelValue )
							Engine.SetModelValue( Engine.GetModel( f2_local4, f2_local12 ), "" .. modelValue )
						end )
						f2_arg0.losingScoreSubscription = f2_arg0:subscribeToModel( f2_local16, function ( model )
							local modelValue = Engine.GetModelValue( model )
							Engine.SetModelValue( f2_local9, Engine.GetModelValue( model ) )
							Engine.SetModelValue( Engine.GetModel( f2_local4, f2_local13 ), "" .. modelValue )
						end )
					end
					local f2_local17 = function ( f5_arg0 )
					...
					Engine.SetModelValue( Engine.GetModel( f2_local4, "showTimeResults" ), f2_local14 )
					Engine.SetModelValue( Engine.GetModel( f2_local4, "playerScoreIsTimeToBeat" ), false )
					Engine.SetModelValue( Engine.GetModel( f2_local4, "enemyScoreIsTimeToBeat" ), false )
					if #f2_arg4.data >= 7 then
						local f2_local18 = Engine.SetModelValue
						local f2_local19 = Engine.GetModel( f2_local4, "playerScoreIsTimeToBeat" )
						local f2_local20
						if not f2_local5 then
							local f2_local21 = f2_arg3
							if f2_arg2 ~= f2_local11 then
								f2_local20 = false
							end
							f2_local20 = f2_local21 and true
						end
						f2_local20 = false
					end
					Engine.SetModelValue( f2_local8, f2_local2.score )
					Engine.SetModelValue( f2_local9, f2_local3.score )
					Engine.SetModelValue( Engine.CreateModel( f2_local6, "winnersFactionDisplayName" ), f2_local2.displayName )
					Engine.SetModelValue( Engine.CreateModel( f2_local6, "winnersFactionIcon" ), f2_local2.factionIcon )
					Engine.SetModelValue( Engine.CreateModel( f2_local6, "losersFactionDisplayName" ), f2_local3.displayName )
					Engine.SetModelValue( Engine.CreateModel( f2_local6, "losersFactionIcon" ), f2_local3.factionIcon )
				end
			end
...
local f0_local2 = function ( f6_arg0, f6_arg1, f6_arg2 )
	...
	f6_arg0.SubTitleNew.MatchText:setText( Engine.Localize( Engine.GetIString( f6_local2, "CS_LOCALIZED_STRINGS" ) ) )
	local f6_local8 = Engine.GetGametypeSetting( "teamCount" )
	if f6_local8 == 2 then
		f0_local1( f6_arg0, f6_local0, f6_local4, f6_local5, f6_arg1 )
		f6_arg0:playClip( "Show_Two_Team" )
	elseif f6_local8 == 1 then
		local f6_local9 = f6_arg1.data[4]
...
local PreLoadFunc = function ( self, controller )
	...
	local f12_local1 = Engine.CreateModel( Engine.GetModelForController( controller ), "displayTop3Players" )
	Engine.SetModelValue( f12_local1, 0 )
	self:subscribeToModel( f12_local1, function ( model )
		if Engine.GetModelValue( model ) == 1 then
			self:close()
		end
	end )
...
CoD.Outcome.new = function ( menu, controller )
	...
	FFATopPlayerInfo:subscribeToGlobalModel( controller, "TopPlayerInfoData1", "name", function ( model )
		...
		if name then
			FFATopPlayerInfo.FFAGamerTag.itemName:setText( Engine.Localize( name ) )
		end
	end )
	...
	FFATopPlayerInfo:subscribeToGlobalModel( controller, "TopPlayerInfoData1", "clanTag", function ( model )
		local clanTag = Engine.GetModelValue( model )
		if clanTag then
			FFATopPlayerInfo.FFAClanTag.itemName:setText( Engine.Localize( StringAsClanTag( clanTag ) ) )
		end
	end )
	...
	FFAFirstRunnerUpPlayerInfo:subscribeToGlobalModel( controller, "TopPlayerInfoData2", "name", function ( model )
		local name = Engine.GetModelValue( model )
		if name then
			FFAFirstRunnerUpPlayerInfo.FFAGamerTag.itemName:setText( Engine.Localize( name ) )
		end
	end )
	...
	FFAFirstRunnerUpPlayerInfo:subscribeToGlobalModel( controller, "TopPlayerInfoData2", "clanTag", function ( model )
		local clanTag = Engine.GetModelValue( model )
		if clanTag then
			FFAFirstRunnerUpPlayerInfo.FFAClanTag.itemName:setText( Engine.Localize( StringAsClanTag( clanTag ) ) )
		end
	end )
	...
	FFASecondRunnerUpPlayerInfo:subscribeToGlobalModel( controller, "TopPlayerInfoData3", "name", function ( model )
		local name = Engine.GetModelValue( model )
		if name then
			FFASecondRunnerUpPlayerInfo.FFAGamerTag.itemName:setText( Engine.Localize( name ) )
		end
	end )
	...
	FFASecondRunnerUpPlayerInfo:subscribeToGlobalModel( controller, "TopPlayerInfoData3", "clanTag", function ( model )
		local clanTag = Engine.GetModelValue( model )
		if clanTag then
			FFASecondRunnerUpPlayerInfo.FFAClanTag.itemName:setText( Engine.Localize( StringAsClanTag( clanTag ) ) )
		end
	end )
	...
	WinningTeamScoreNew:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				return IsModelValueEqualTo( controller, "gameScore.victory", true ) and IsModelValueEqualTo( controller, "gameScore.showTimeResults", true )
			end
		},
		{
			stateName = "LossTime",
			condition = function ( menu, element, event )
				return IsModelValueEqualTo( controller, "gameScore.defeat", true ) and IsModelValueEqualTo( controller, "gameScore.showTimeResults", true )
			end
		}
	} )
	...
	VSLabel:setTopBottom( true, false, 351, 376 )
	...
	self.clipsPerState = {
		DefaultState = {
			...
			Show_Two_Team = function ()
				...
				local f73_local10 = function ( f91_arg0, f91_arg1 )
					if not f91_arg1.interrupted then
						f91_arg0:beginAnimation( "keyframe", 210, false, false, CoD.TweenType.Linear )
					end
					f91_arg0:setAlpha( 1 )
				...
				EnemyTimeToBeatBox:setAlpha( 0 )
				EnemyTimeToBeatBox:registerEventHandler( "transition_complete_keyframe", f73_local10 )
