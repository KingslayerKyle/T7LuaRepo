...
local f0_local0 = function ( f1_arg0, f1_arg1 )
	...
	if not f1_arg0.AttachmentInfo.currentWeapon then
		return 
	elseif f1_local0 ~= f1_arg0.AttachmentInfo.currentWeapon or f1_local1 then
	...
	elseif f1_arg0.AttachmentInfo.currentWeapon ~= f1_arg0.AttachmentInfo.currentWeapon or f1_local1 then
