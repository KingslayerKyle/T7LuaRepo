	...
	AmmoWidgetMPLowAmmoGlowContainer0:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				...
				if f2_local0 then
					...
					if f2_local0 then
						f2_local0 = not IsHeroWeaponInUse( menu, controller )
					end
				end
				return f2_local0
			end
		},
		{
			...
			condition = function ( menu, element, event )
				...
				if not WeaponHasAmmo( controller ) then
					...
					if f3_local0 then
						f3_local0 = not IsHeroWeaponInUse( menu, controller )
					end
				else
					f3_local0 = false
				end
		...
		},
		{
			stateName = "Hero",
			condition = function ( menu, element, event )
				return IsHeroWeaponInUse( menu, controller )
			end
		}
	} )
		...
		},
		{
			...
			condition = function ( menu, element, event )
				...
				if not WeaponHasAmmo( controller ) then
					...
					if f13_local0 then
						f13_local0 = not IsCurrentViewmodelWeaponName( controller, "ball" )
					end
				else
					f13_local0 = false
				end
	...
	TotalAmmo:mergeStateConditions( {
		...
		},
		{
			...
			condition = function ( menu, element, event )
				local f29_local0
				if not WeaponHasAmmo( controller ) then
					f29_local0 = WeaponUsesAmmo( controller )
					if f29_local0 then
						f29_local0 = not IsCurrentViewmodelWeaponName( controller, "ball" )
					end
				else
					f29_local0 = false
				end
	...
	ClipMeter:mergeStateConditions( {
		...
		},
		{
			...
			condition = function ( menu, element, event )
				local f36_local0
				if not WeaponHasAmmo( controller ) then
					f36_local0 = WeaponUsesAmmo( controller )
				else
					f36_local0 = false
				end
				return f36_local0
	...
	AmmoColorBar:mergeStateConditions( {
		...
		},
		{
			...
			condition = function ( menu, element, event )
				local f41_local0
				if not WeaponHasAmmo( controller ) then
					f41_local0 = WeaponUsesAmmo( controller )
				else
					f41_local0 = false
				end
				return f41_local0
	...
	self:mergeStateConditions( {
		...
		},
		{
			...
			condition = function ( menu, element, event )
				...
				if not WeaponUsesAmmo( controller ) then
					f104_local0 = IsCurrentWeaponReference( controller, "bare_hands" )
					if f104_local0 then
						f104_local0 = IsGameTypeEqualToString( "gun" )
					end
				else
					f104_local0 = false
				end
		...
		},
		{
			...
			condition = function ( menu, element, event )
				local f105_local0
				if not WeaponUsesAmmo( controller ) then
					f105_local0 = IsCurrentWeaponReference( controller, "bare_hands" )
				else
					f105_local0 = false
				end
				return f105_local0
		...
		},
		{
			...
			condition = function ( menu, element, event )
				local f106_local0
				if not WeaponUsesAmmo( controller ) then
					f106_local0 = IsCurrentWeaponReference( controller, "knife_loadout" )
					if f106_local0 then
						f106_local0 = IsGameTypeEqualToString( "gun" )
					end
				else
					f106_local0 = false
				end
		...
		},
		{
			...
			condition = function ( menu, element, event )
				local f107_local0
				if not WeaponUsesAmmo( controller ) then
					f107_local0 = IsCurrentWeaponReference( controller, "knife_loadout" )
				else
					f107_local0 = false
				end
				return f107_local0
