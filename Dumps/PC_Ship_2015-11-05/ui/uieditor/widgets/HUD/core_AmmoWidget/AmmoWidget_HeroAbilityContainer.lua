	...
	f1_arg0.HeroWeaponRing:subscribeToGlobalModel( f1_arg1, "HeroWeapon", "powerRatio", function ( model )
		...
		if modelValue then
			if modelValue < f1_arg0.HeroWeaponRing.greyProgressTarget + 0.03 then
				...
				f1_arg0.HeroWeaponRing.HeroRingFillImage:beginAnimation( "keyframe", 1000, false, false, CoD.TweenType.Linear )
				f1_arg0.HeroWeaponRing.HeroRingFillImage:registerEventHandler( "transition_complete_keyframe", f2_local1 )
			end
