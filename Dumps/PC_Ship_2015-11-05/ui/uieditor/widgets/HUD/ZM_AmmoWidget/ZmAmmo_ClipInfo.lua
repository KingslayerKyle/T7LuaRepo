...
CoD.ZmAmmo_ClipInfo.new = function ( menu, controller )
	...
	self:mergeStateConditions( {
		...
		},
		{
			stateName = "Sword",
			condition = function ( menu, element, event )
				return ModelValueStartsWith( controller, "currentWeapon.viewmodelWeaponName", "glaive_apothicon_" ) and not Engine.IsVisibilityBitSet( controller, Enum.UIVisibilityBit.BIT_GAME_ENDED )
			end
		},
		{
