...
local PreLoadFunc = function ( self, controller )
	...
	if f1_local0 then
		local f1_local1 = Engine.CreateModel( f1_local0, "smokeEffect" )
		if f1_local1 then
			Engine.SetModelValue( f1_local1, -0.1 )
		end
	end
end
...
CoD.CompassGroupMP.new = function ( menu, controller )
	...
	PanelMap:setLeftRight( true, false, 16.5, 266.5 )
	...
	GlowBack0:setLeftRight( true, false, -108.87, 369.54 )
	...
	GlowBack:setLeftRight( true, false, -21.58, 292.58 )
	...
	BarTop:setLeftRight( true, false, 15, 267 )
	...
	BarBase:setLeftRight( true, false, 15, 267 )
	...
	BaseElement:setLeftRight( true, false, 130.34, 151.67 )
	...
	Dot1:setLeftRight( true, false, 6, 10 )
	...
	Dot2:setLeftRight( true, false, 271, 275 )
	...
	Dot3:setLeftRight( true, false, 6, 10 )
	...
	Dot4:setLeftRight( true, false, 271, 275 )
	...
	BackCircleOutter:setLeftRight( true, false, 87.5, 194.5 )
	...
	ArrowFull:setLeftRight( true, false, 135.5, 145.5 )
	...
	CompassMinimap:setLeftRight( true, true, -0.5, -1.5 )
	CompassMinimap:setTopBottom( true, true, 9, -32 )
	...
	CompassItems0:setLeftRight( true, true, -0.5, -1.5 )
	CompassItems0:setTopBottom( true, true, 9, -32 )
	...
	CompassItems:setLeftRight( true, true, -0.5, -1.5 )
	CompassItems:setTopBottom( true, true, 9, -32 )
	...
	CompassOverlay:setLeftRight( true, true, -0.5, -1.5 )
	CompassOverlay:setTopBottom( true, true, 9, -32 )
	...
	HorizontalCompass:setLeftRight( true, false, 19.9, 267.01 )
	...
	NotificationSixthSense:setLeftRight( true, false, 15.5, 265.5 )
	NotificationSixthSense:setTopBottom( true, false, 20, 162 )
	...
	NotificationSixthSense0:setLeftRight( true, false, 15.5, 265.5 )
	NotificationSixthSense0:setTopBottom( true, false, 20, 162 )
	...
	smokeGrenadeEffect:setLeftRight( true, true, 15.9, -19 )
	...
	smokeGrenadeEffect:subscribeToGlobalModel( controller, "HUDItems", "smokeEffect", function ( model )
		local smokeEffect = Engine.GetModelValue( model )
		if smokeEffect then
			smokeGrenadeEffect:setShaderVector( 0, CoD.GetVectorComponentFromString( smokeEffect, 1 ), CoD.GetVectorComponentFromString( smokeEffect, 2 ), CoD.GetVectorComponentFromString( smokeEffect, 3 ), CoD.GetVectorComponentFromString( smokeEffect, 4 ) )
		end
	end )
	...
	HorizontalCompass0:setLeftRight( true, false, 19.9, 267.01 )
	...
	self.clipsPerState = {
		DefaultState = {
			DefaultClip = function ()
				...
				NotificationSixthSense0:completeAnimation()
				self.NotificationSixthSense0:setAlpha( 0 )
				self.clipFinished( NotificationSixthSense0, {} )
			...
			HudStart = function ()
				...
				local NotificationSixthSenseFrame2 = function ( NotificationSixthSense, event )
					local NotificationSixthSenseFrame3 = function ( NotificationSixthSense, event )
						if not event.interrupted then
							NotificationSixthSense:beginAnimation( "keyframe", 59, false, false, CoD.TweenType.Linear )
						end
					...
					if event.interrupted then
						...
						NotificationSixthSense:beginAnimation( "keyframe", 2000, false, false, CoD.TweenType.Linear )
				...
				local NotificationSixthSense0Frame2 = function ( NotificationSixthSense0, event )
					local NotificationSixthSense0Frame3 = function ( NotificationSixthSense0, event )
						if not event.interrupted then
							NotificationSixthSense0:beginAnimation( "keyframe", 59, false, false, CoD.TweenType.Linear )
						end
						NotificationSixthSense0:setAlpha( 1 )
						if event.interrupted then
							self.clipFinished( NotificationSixthSense0, event )
						else
							NotificationSixthSense0:registerEventHandler( "transition_complete_keyframe", self.clipFinished )
						end
					end
					
					if event.interrupted then
						NotificationSixthSense0Frame3( NotificationSixthSense0, event )
						return 
					else
						NotificationSixthSense0:beginAnimation( "keyframe", 2000, false, false, CoD.TweenType.Linear )
						NotificationSixthSense0:registerEventHandler( "transition_complete_keyframe", NotificationSixthSense0Frame3 )
					end
				end
				
				NotificationSixthSense0:completeAnimation()
				self.NotificationSixthSense0:setAlpha( 0 )
				NotificationSixthSense0Frame2( NotificationSixthSense0, {} )
		...
		HudStart = {
			DefaultClip = function ()
				...
				self.clipFinished( NotificationSixthSense, {} )
				NotificationSixthSense0:completeAnimation()
				self.NotificationSixthSense0:setAlpha( 1 )
				self.clipFinished( NotificationSixthSense0, {} )
				smokeGrenadeEffect:completeAnimation()
			...
			DefaultState = function ()
				...
				local NotificationSixthSense0Frame2 = function ( NotificationSixthSense0, event )
					if not event.interrupted then
						NotificationSixthSense0:beginAnimation( "keyframe", 460, false, false, CoD.TweenType.Linear )
					end
					NotificationSixthSense0:setAlpha( 0 )
					if event.interrupted then
						self.clipFinished( NotificationSixthSense0, event )
					else
						NotificationSixthSense0:registerEventHandler( "transition_complete_keyframe", self.clipFinished )
	...
	LUI.OverrideFunction_CallOriginalSecond( self, "close", function ( element )
		...
		element.CompassMinimap:close()
		element.CompassItems0:close()
		element.CompassItems:close()
		element.CompassOverlay:close()
		element.HorizontalCompass:close()
		element.NotificationSixthSense:close()
		element.NotificationSixthSense0:close()
		element.HorizontalCompass0:close()
		element.smokeGrenadeEffect:close()
	end )
