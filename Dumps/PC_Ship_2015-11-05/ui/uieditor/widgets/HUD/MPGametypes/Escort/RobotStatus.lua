	...
	self.clipsPerState = {
		...
		EnemyRobot = {
			DefaultClip = function ()
				...
				self.clipFinished( RobotStatus, {} )
				EnemyTeamIcon:completeAnimation()
				self.EnemyTeamIcon:setRGB( ColorSet.EnemyOrange.r, ColorSet.EnemyOrange.g, ColorSet.EnemyOrange.b )
		...
		FriendlyRobot = {
			DefaultClip = function ()
				...
				self.clipFinished( RobotStatus, {} )
				EnemyTeamIcon:completeAnimation()
				self.EnemyTeamIcon:setRGB( ColorSet.FriendlyBlue.r, ColorSet.FriendlyBlue.g, ColorSet.FriendlyBlue.b )
				self.EnemyTeamIcon:setAlpha( 0 )
				self.clipFinished( EnemyTeamIcon, {} )
				FriendlyTeamIcon:completeAnimation()
