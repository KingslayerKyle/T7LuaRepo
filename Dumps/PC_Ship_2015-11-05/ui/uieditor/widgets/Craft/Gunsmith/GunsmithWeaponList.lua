...
CoD.GunsmithWeaponList.new = function ( menu, controller )
	...
	LabelButtonCount0:setLeftRight( false, true, -120, -16 )
	LabelButtonCount0:setTopBottom( false, false, -9.5, 10.5 )
	LabelButtonCount0:linkToElementModel( self, "itemIndex", true, function ( model )
		local itemIndex = Engine.GetModelValue( model )
		if itemIndex then
			LabelButtonCount0.ButtonLabelCount.itemName:setText( Engine.Localize( GetVariantCountByWeaponIndex( itemIndex ) ) )
		end
	end )
	...
	LUI.OverrideFunction_CallOriginalSecond( self, "close", function ( element )
		...
		element.LabelButtonCount0:close()
