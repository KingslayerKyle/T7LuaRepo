...
CoD.WeaponBuildKitsVariantAttachments.new = function ( menu, controller )
	...
	paintjobCategoryHeader:setLeftRight( true, false, 501.77, 579.77 )
	...
	camoCategoryHeader:setLeftRight( true, false, 611.44, 675.44 )
	...
	paintjob:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				...
				if not IsSelfModelValueEqualTo( element, controller, "paintjobSlot", 15 ) then
					f118_local0 = not IsSelfModelValueEqualTo( element, controller, "paintjobIndex", 15 )
				else
					f118_local0 = false
				end
				return f118_local0
