...
CoD.PaintshopColorLayerInfo.new = function ( menu, controller )
	...
	color0OpacityValue:setLeftRight( true, false, 10, 146.02 )
	...
	layersUsedValue0:setLeftRight( true, false, 0.45, 157 )
	...
	color1OpacityValue:setLeftRight( true, false, 10, 146.02 )
	...
	rotationValue:setLeftRight( true, false, 10, 146.02 )
