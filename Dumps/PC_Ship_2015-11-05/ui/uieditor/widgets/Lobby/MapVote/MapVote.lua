...
local f0_local2 = function ( f4_arg0, f4_arg1, f4_arg2 )
	f4_arg0:subscribeToModel( Engine.GetModel( Engine.GetGlobalModel(), "lobbyRoot.mapVote" ), function ()
		...
		elseif f5_local1 == LuaEnums.MAP_VOTE_STATE.LOCKEDIN then
			f4_arg0:makeNotFocusable()
			f4_arg0:setMouseDisabled( true )
			local f5_local2 = Engine.CreateModel( Engine.GetGlobalModel(), "MapVote" )
			local f5_local3 = Engine.GetModelValue( Engine.CreateModel( f5_local2, "mapVoteCountNext" ) ) or 0
			local f5_local4 = Engine.GetModelValue( Engine.CreateModel( f5_local2, "mapVoteCountPrevious" ) ) or 0
			local f5_local5 = Engine.GetModelValue( Engine.CreateModel( f5_local2, "mapVoteCountRandom" ) ) or 0
...
local f0_local5 = function ( f8_arg0, f8_arg1, f8_arg2 )
	...
	if f8_local0 == LobbyData.UITargets.UI_MPLOBBYONLINEPUBLICGAME.id or f8_local0 == LobbyData.UITargets.UI_CPLOBBYONLINEPUBLICGAME.id or f8_local0 == LobbyData.UITargets.UI_ZMLOBBYONLINEPUBLICGAME.id or f8_local0 == LobbyData.UITargets.UI_MPLOBBYONLINEARENAGAME.id then
		f0_local2( f8_arg0, f8_arg1, f8_arg2 )
	elseif f8_local0 == LobbyData.UITargets.UI_CPLOBBYONLINECUSTOMGAME.id or f8_local0 == LobbyData.UITargets.UI_CPLOBBYLANGAME.id or f8_local0 == LobbyData.UITargets.UI_CP2LOBBYONLINECUSTOMGAME.id or f8_local0 == LobbyData.UITargets.UI_CP2LOBBYLANGAME.id or f8_local0 == LobbyData.UITargets.UI_MPLOBBYONLINECUSTOMGAME.id or f8_local0 == LobbyData.UITargets.UI_MPLOBBYONLINETHEATER.id or f8_local0 == LobbyData.UITargets.UI_MPLOBBYLANGAME.id or f8_local0 == LobbyData.UITargets.UI_FRLOBBYONLINEGAME.id or f8_local0 == LobbyData.UITargets.UI_FRLOBBYLANGAME.id or f8_local0 == LobbyData.UITargets.UI_ZMLOBBYONLINECUSTOMGAME.id or f8_local0 == LobbyData.UITargets.UI_ZMLOBBYONLINETHEATER.id or f8_local0 == LobbyData.UITargets.UI_ZMLOBBYLANGAME.id then
...
local PreLoadFunc = function ( self, controller )
	...
	local f10_local0 = Engine.CreateModel( Engine.GetGlobalModel(), "MapVote" )
...
CoD.MapVote.new = function ( menu, controller )
	...
	MapVoteItemVoteDecided:subscribeToGlobalModel( controller, "MapVote", "mapVoteMapNext", function ( model )
		local mapVoteMapNext = Engine.GetModelValue( model )
		if mapVoteMapNext then
			MapVoteItemVoteDecided.MapNameNew.btnDisplayTextStroke:setText( Engine.Localize( MapNameToLocalizedMapName( mapVoteMapNext ) ) )
		end
	end )
	MapVoteItemVoteDecided:subscribeToGlobalModel( controller, "MapVote", "mapVoteGameModeNext", function ( model )
		...
		if mapVoteGameModeNext then
			MapVoteItemVoteDecided.GameModeNew.SubTitle:setText( Engine.Localize( mapVoteGameModeNext ) )
		end
	end )
	...
	MapVoteItemPrevious:subscribeToGlobalModel( controller, "MapVote", "mapVoteMapPrevious", function ( model )
		local mapVoteMapPrevious = Engine.GetModelValue( model )
		if mapVoteMapPrevious then
			MapVoteItemPrevious.MapNameNew.btnDisplayTextStroke:setText( Engine.Localize( MapNameToLocalizedMapName( mapVoteMapPrevious ) ) )
		end
	end )
	...
	MapVoteItemNext:subscribeToGlobalModel( controller, "MapVote", "mapVoteMapNext", function ( model )
		local mapVoteMapNext = Engine.GetModelValue( model )
		if mapVoteMapNext then
			MapVoteItemNext.MapNameNew.btnDisplayTextStroke:setText( Engine.Localize( MapNameToLocalizedMapName( mapVoteMapNext ) ) )
		end
	end )
	...
	DownloadPercent:subscribeToGlobalModel( controller, "LobbyRoot", "theaterDownloadPercent", function ( model )
		...
		if theaterDownloadPercent then
			DownloadPercent:setText( Engine.Localize( FileshareGetDownloadProgress( theaterDownloadPercent ) ) )
		end
	end )
	...
	self:mergeStateConditions( {
		...
		},
		{
			...
			condition = function ( menu, element, event )
				local f233_local0 = IsInTheaterMode()
				if f233_local0 then
					f233_local0 = IsFilmSelected()
					if f233_local0 then
						f233_local0 = not IsGlobalModelValueGreaterThan( controller, "lobbyRoot.theaterDownloadPercent", 99 )
					end
				end
				return f233_local0
			end
		...
		},
		{
			...
			condition = function ( menu, element, event )
				local f236_local0 = IsInTheaterMode()
				if f236_local0 then
					f236_local0 = IsFilmSelected()
					if f236_local0 then
						f236_local0 = IsGlobalModelValueGreaterThan( controller, "lobbyRoot.theaterDownloadPercent", 99 )
					end
				end
				return f236_local0
			end
