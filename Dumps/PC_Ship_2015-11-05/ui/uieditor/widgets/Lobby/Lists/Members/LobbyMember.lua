	...
	self:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				local f189_local0 = IsSelfItem( element, controller )
				if f189_local0 then
					f189_local0 = IsZM()
					if f189_local0 then
						f189_local0 = LobbyHas4PlayersOrLess()
					end
				end
				return f189_local0
			end
		...
		},
		{
			...
			condition = function ( menu, element, event )
				...
				if not IsSelfModelValueTrue( element, controller, "validClient" ) then
					f194_local0 = not IsCurrentLanguageReversed()
				else
					f194_local0 = false
				end
				return f194_local0
		...
		},
		{
			...
			condition = function ( menu, element, event )
				local f195_local0
				if not IsSelfModelValueTrue( element, controller, "validClient" ) then
					f195_local0 = IsCurrentLanguageReversed()
				else
					f195_local0 = false
				end
				return f195_local0
		...
		},
		{
			...
			condition = function ( menu, element, event )
				local f196_local0 = IsArenaMode()
				if f196_local0 then
					f196_local0 = IsSelfModelValueNilOrZero( element, controller, "isMember" )
					if f196_local0 then
						if not IsGlobalModelValueTrue( element, controller, "lobbyRoot.lobbyLockedIn" ) then
							f196_local0 = not MapVoteInState( "3" )
						else
							f196_local0 = false
						end
					end
