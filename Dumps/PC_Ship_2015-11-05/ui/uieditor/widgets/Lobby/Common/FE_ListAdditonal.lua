...
CoD.FE_ListAdditonal.new = function ( menu, controller )
	...
	local SplitscreenLobbyButtonPC = CoD.SplitscreenLobbyButtonPC.new( menu, controller )
	SplitscreenLobbyButtonPC:setLeftRight( true, false, 0, 490 )
	SplitscreenLobbyButtonPC:setTopBottom( true, false, 4, 31 )
	SplitscreenLobbyButtonPC:registerEventHandler( "button_action", function ( element, event )
		local f3_local0 = nil
	...
	self:addElement( SplitscreenLobbyButtonPC )
	self.SplitscreenLobbyButtonPC = SplitscreenLobbyButtonPC
	...
	self.clipsPerState = {
		DefaultState = {
			DefaultClip = function ()
				...
				SplitscreenLobbyButtonPC:completeAnimation()
				self.SplitscreenLobbyButtonPC:setAlpha( 0 )
				self.clipFinished( SplitscreenLobbyButtonPC, {} )
			end
		},
