...
CoD.FE_LobbyStatus.new = function ( menu, controller )
	...
	LobbyStatusString3:setLeftRight( true, true, 0, 0 )
	...
	LobbyStatusString2:setLeftRight( true, true, 0, 0 )
	...
	LobbyStatusString1:setLeftRight( true, true, 0, 0 )
	...
	PartyPrivacyString:setLeftRight( true, true, 0, 0 )
	...
	LeaderActivityString:setLeftRight( true, true, 0, 0 )
