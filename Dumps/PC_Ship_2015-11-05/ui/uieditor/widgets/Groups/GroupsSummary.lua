...
CoD.GroupsSummary.new = function ( menu, controller )
	...
	OwnerName:linkToElementModel( self, "owner", true, function ( model )
		local owner = Engine.GetModelValue( model )
		if owner then
			OwnerName:setText( Engine.Localize( owner ) )
		end
	end )
	...
	GroupDescription:linkToElementModel( self, "description", true, function ( model )
		...
		if description then
			GroupDescription:setText( Engine.Localize( description ) )
		end
	end )
	...
	LUI.OverrideFunction_CallOriginalSecond( self, "close", function ( element )
		...
		element.GroupLevelWidget:close()
		...
		element.OwnerName:close()
		element.GroupDescription:close()
		element.GroupClanTag:close()
	end )
