...
CoD.GroupsTooltip.new = function ( menu, controller )
	...
	BorderBakedSolid00:setLeftRight( true, false, 0, 338 )
	BorderBakedSolid00:setTopBottom( true, false, 0, 195 )
	...
	TooltipTitle:setLeftRight( true, false, 12, 208 )
	TooltipTitle:setTopBottom( true, false, 8, 33 )
	TooltipTitle:setRGB( 1, 0.6, 0 )
	TooltipTitle:setTTF( "fonts/UnitedSansSmCdMd.ttf" )
	...
	TooltipDescription:setTopBottom( true, false, 45, 65 )
