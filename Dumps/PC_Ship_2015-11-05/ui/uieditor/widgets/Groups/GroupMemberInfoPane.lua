...
CoD.GroupMemberInfoPane.new = function ( menu, controller )
	...
	notInTitle:setLeftRight( true, false, 369, 663 )
	...
	presence:setLeftRight( true, false, 376, 671 )
	...
	primaryGroup:setLeftRight( true, false, 8, 254 )
	...
	rankCP:setTopBottom( true, false, 309, 424 )
	...
	rankMP:setTopBottom( true, false, 309, 424 )
	...
	rankZM:setTopBottom( true, false, 309, 424 )
	...
	MissionRecordVaultlines01:setLeftRight( true, false, 385, 670 )
	...
	party:setLeftRight( true, false, 376, 674 )
	...
	self.rankMP:linkToElementModel( self, "mpPrestige", true, function ( model )
	...
	self.clipsPerState = {
		DefaultState = {
			DefaultClip = function ()
				...
				self.notInTitle:setLeftRight( true, false, 376, 670 )
				self.notInTitle:setTopBottom( true, false, 0, 72 )
				self.notInTitle:setAlpha( 1 )
				self.clipFinished( notInTitle, {} )
				presence:completeAnimation()
				self.presence:setLeftRight( true, false, 376, 671 )
		...
		PlayerDetails = {
			DefaultClip = function ()
				...
				self.clipFinished( Socialbackground0, {} )
				notInTitle:completeAnimation()
				self.notInTitle:setLeftRight( true, false, -1.1, 463.36 )
				self.notInTitle:setTopBottom( true, false, 148.33, 247.33 )
				self.notInTitle:setAlpha( 0 )
				self.clipFinished( notInTitle, {} )
				presence:completeAnimation()
				self.presence:setLeftRight( true, false, -1.1, 466.72 )
				self.presence:setTopBottom( true, false, 143.33, 290.33 )
				self.clipFinished( presence, {} )
				friendship:completeAnimation()
				self.friendship:setLeftRight( true, false, 198.66, 351.66 )
