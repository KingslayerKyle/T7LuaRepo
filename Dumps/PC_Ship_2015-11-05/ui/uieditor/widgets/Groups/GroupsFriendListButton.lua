...
CoD.GroupsFriendListButton.new = function ( menu, controller )
	...
	Socialbackground00:setLeftRight( true, false, 127.72, 410 )
	...
	Socialbackground000:setLeftRight( true, false, 30.25, 126.25 )
	...
	Socialbackground0000:setLeftRight( true, false, 0, 29.25 )
	...
	presence:linkToElementModel( self, "platformPresence", true, function ( model )
		...
		if platformPresence then
			presence.platformPresenceScroller.textBox:setText( Engine.Localize( PlatformPresenceToLocalizedString( platformPresence ) ) )
		end
	end )
	...
	invite:setLeftRight( true, false, 7.63, 21.63 )
	invite:setTopBottom( true, false, 23, 37 )
	...
	self:registerEventHandler( "gain_focus", function ( self, event )
		if self.m_focusable and self.invite:processEvent( event ) then
			return true
		else
