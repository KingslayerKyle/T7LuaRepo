...
CoD.GroupsRosterRow.new = function ( menu, controller )
	...
	presence:setLeftRight( true, false, 107, 306 )
	...
	memberStatus:setLeftRight( true, false, 319, 366 )
	memberStatus:setTopBottom( true, false, 30.5, 55.5 )
	memberStatus:setRGB( 0.25, 0.45, 1 )
	memberStatus:setTTF( "fonts/default.ttf" )
	...
	self.emblem:linkToElementModel( self, "xuid", true, function ( model )
	...
	self.presence:linkToElementModel( self, "presence", true, function ( model )
	...
	self.memberStatus:linkToElementModel( self, "memberStatusText", true, function ( model )
		local memberStatusText = Engine.GetModelValue( model )
		if memberStatusText then
			memberStatus:setText( Engine.Localize( memberStatusText ) )
		end
	end )
	self.clipsPerState = {
		DefaultState = {
