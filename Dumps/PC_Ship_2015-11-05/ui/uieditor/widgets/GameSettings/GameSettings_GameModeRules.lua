...
local f0_local1 = function ( f2_arg0 )
	local f2_local0 = {
		[#f2_local0 + 1] = {
			optionDisplay = Engine.Localize( "MENU_GAME_MODE_ADVANCED_CAPS", Engine.Localize( Engine.StructTableLookupString( CoDShared.gametypesStructTable, "name", Dvar.ui_gametype:get(), "name_ref_caps" ) ) ),
	...
	for f2_local5, f2_local6 in ipairs( f2_local0 ) do
		table.insert( f2_local1, {
			...
			properties = {
				title = f2_local6.optionDisplay,
				desc = f2_local6.description,
