...
CoD.Pregame_Title_Small.new = function ( menu, controller )
	...
	GameMode:setText( Engine.Localize( LocalizeToUpperString( GetGameMode( "TEAM DEATHMATCH" ) ) ) )
	...
	MapName:setText( Engine.Localize( LocalizeToUpperString( GetMapName( "REDWOOD" ) ) ) )
