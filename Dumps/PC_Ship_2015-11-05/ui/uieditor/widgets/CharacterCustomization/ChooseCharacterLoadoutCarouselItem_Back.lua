...
CoD.ChooseCharacterLoadoutCarouselItem_Back.new = function ( menu, controller )
	...
	frame:setTopBottom( true, false, 10, 456 )
	...
	ChooseCharacterLoadoutCardBackFrontOfCardFooter:setLeftRight( false, true, -84, -10 )
	ChooseCharacterLoadoutCardBackFrontOfCardFooter:setTopBottom( false, true, -39, -5.5 )
