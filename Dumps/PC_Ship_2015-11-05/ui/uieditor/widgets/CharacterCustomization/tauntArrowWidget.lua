	...
	left:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				return CurrentPlayerHasGesture( controller, Enum.CharacterGestureTypes.GESTURE_TYPE_THREATEN )
			end
		}
	} )
	...
	up:mergeStateConditions( {
		{
			stateName = "Visible",
			condition = function ( menu, element, event )
				return CurrentPlayerHasGesture( controller, Enum.CharacterGestureTypes.GESTURE_TYPE_GOOD_GAME )
			end
		}
	} )
	self:addElement( up )
	...
	right:mergeStateConditions( {
		{
			stateName = "Visible",
			condition = function ( menu, element, event )
				return CurrentPlayerHasGesture( controller, Enum.CharacterGestureTypes.GESTURE_TYPE_BOAST )
			end
		}
	} )
