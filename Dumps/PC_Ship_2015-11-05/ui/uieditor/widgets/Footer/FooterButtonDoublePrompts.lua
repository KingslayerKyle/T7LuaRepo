...
local f0_local0 = function ( f1_arg0 )
	if IsElementInState( f1_arg0, "DefaultState" ) then
		...
		if f1_local0 then
			f1_local7, f1_local7, f1_local2, f1_local7 = f1_arg0.buttonPromptImage:getLocalLeftRight()
			f1_local3, f1_local7 = f1_arg0.buttonPromptImage:getLocalSize()
			f1_local5, f1_local6, f1_local7, f1_local7 = f1_arg0.buttonPromptImage1:getLocalLeftRight()
			f1_local4, f1_local7 = f1_arg0.buttonPromptImage1:getLocalSize()
		else
