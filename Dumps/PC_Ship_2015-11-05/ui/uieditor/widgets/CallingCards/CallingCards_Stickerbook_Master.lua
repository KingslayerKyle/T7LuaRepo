...
DataSources.MasterCallingCardsSorted = DataSourceHelpers.ListSetup( "MasterCallingCardsSorted", function ( f1_arg0 )
	...
	for f1_local6, f1_local7 in ipairs( f1_local1 ) do
		...
		local f1_local22 = f1_local7.isLocked
		local f1_local23 = f1_local7.isMastery
		local f1_local24 = f1_local7.gameMode
		local f1_local25 = f1_local7.challengeType
		local f1_local15 = f1_local7.challengeCategory
		local f1_local26 = f1_local7.currChallengeStatValue
		local f1_local27 = f1_local7.imageID
		local f1_local28 = 0
		local f1_local29 = 0
		local f1_local30 = 0
		local f1_local19 = ""
		local f1_local31, f1_local32, f1_local33, f1_local20, f1_local21 = nil
		if f1_local8 ~= nil then
			local f1_local12 = ""
			local f1_local13 = ""
			local f1_local14 = ""
			if f1_local24 == Enum.eModes.MODE_CAMPAIGN then
				f1_local12 = "cp"
				f1_local13 = Engine.Localize( "MENU_CAMPAIGN" )
				f1_local14 = CoD.ChallengesUtility.GameModeIcons.CP
			elseif f1_local24 == Enum.eModes.MODE_MULTIPLAYER then
				f1_local12 = "mp"
				f1_local13 = Engine.Localize( "MENU_MULTIPLAYER" )
				f1_local14 = CoD.ChallengesUtility.GameModeIcons.MP
			elseif f1_local24 == Enum.eModes.MODE_ZOMBIES then
				f1_local12 = "zm"
			...
			local f1_local16 = CoD.getStatsMilestoneTable( f1_local10 + 1, f1_local24 )
			...
			table.insert( f1_local0, {
				models = {
					...
					iconId = f1_local27,
					percentComplete = f1_local2[f1_local15] / f1_local3[f1_local15],
					challengeCategory = f1_local7.challengeCategory,
					gameMode = f1_local24,
					gameModeName = f1_local13,
					gameModeIcon = f1_local14,
					isLocked = not (f1_local2[f1_local15] == f1_local3[f1_local15])
				},
				properties = {}
			} )
		end
