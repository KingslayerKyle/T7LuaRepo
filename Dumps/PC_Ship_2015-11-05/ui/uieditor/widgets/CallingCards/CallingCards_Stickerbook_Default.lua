...
DataSources.CallingCardsDefault = DataSourceHelpers.ListSetup( "CallingCardsDefault", function ( f1_arg0 )
	...
	local f1_local2 = function ( f2_arg0, f2_arg1 )
		if f2_arg0.models.isLocked ~= f2_arg1.models.isLocked then
	...
	for f1_local6, f1_local7 in ipairs( f1_local1 ) do
		if not f1_local7.isBGLocked then
			table.insert( f1_local0, {
				models = {
					title = Engine.Localize( f1_local7.description ),
					description = "",
					iconId = f1_local7.id,
					isLocked = f1_local7.isBGLocked
				}
			} )
		end
	end
