...
CoD.CombatRecordArenaPanel.new = function ( menu, controller )
	...
	Emblem:subscribeToGlobalModel( controller, "StorageGlobal", "stats_mp", function ( model )
		local statsMp = Engine.GetModelValue( model )
		if statsMp then
			Emblem:setImage( RegisterImage( GetArenaRankIconLG( StorageLookup( controller, "arenaBest.points", statsMp ) ) ) )
		end
	end )
	...
	RankName:subscribeToGlobalModel( controller, "StorageGlobal", "stats_mp", function ( model )
		local statsMp = Engine.GetModelValue( model )
		if statsMp then
			RankName:setText( Engine.Localize( SetValueIfEmptyString( "--", StorageLookup( controller, "arenaBestPlaylist", statsMp ) ) ) )
		end
	end )
	...
	Rank:subscribeToGlobalModel( controller, "StorageGlobal", "stats_mp", function ( model )
		local statsMp = Engine.GetModelValue( model )
		if statsMp then
			Rank:setText( Engine.Localize( GetArenaRankName( StorageLookup( controller, "arenaBest.points", statsMp ) ) ) )
		end
	end )
	...
	EquipmentButton:setLeftRight( true, false, -1, 369 )
	...
	StartMenuframenoBG00:setTopBottom( false, false, -197.5, -137.5 )
	...
	self.clipsPerState = {
		DefaultState = {
			DefaultClip = function ()
				...
				Kills:setAlpha( 0 )
				Kills:registerEventHandler( "transition_complete_keyframe", f38_local3 )
				...
				Wins:setAlpha( 0 )
				Wins:registerEventHandler( "transition_complete_keyframe", f38_local4 )
				local f38_local5 = function ( f44_arg0, f44_arg1 )
				...
				Score:setAlpha( 0 )
				Score:registerEventHandler( "transition_complete_keyframe", f38_local5 )
				local f38_local6 = function ( f45_arg0, f45_arg1 )
				...
				KDRatio:setAlpha( 0 )
				KDRatio:registerEventHandler( "transition_complete_keyframe", f38_local6 )
				local f38_local7 = function ( f46_arg0, f46_arg1 )
					if not f46_arg1.interrupted then
						f46_arg0:beginAnimation( "keyframe", 20, false, false, CoD.TweenType.Linear )
					end
					f46_arg0:setAlpha( 1 )
				...
				WLRatio:setAlpha( 0 )
				WLRatio:registerEventHandler( "transition_complete_keyframe", f38_local7 )
				local f38_local8 = function ( f47_arg0, f47_arg1 )
				...
				SPM:setAlpha( 0 )
				SPM:registerEventHandler( "transition_complete_keyframe", f38_local8 )
