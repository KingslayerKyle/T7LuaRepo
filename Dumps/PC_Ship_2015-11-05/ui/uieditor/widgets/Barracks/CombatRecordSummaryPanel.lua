...
CoD.CombatRecordSummaryPanel.new = function ( menu, controller )
	...
	WeaponsButton.ButtonTitle0:setText( Engine.Localize( LocalizeToUpperString( "MENU_DEADLIEST_WEAPON" ) ) )
	...
	EquipmentButton.ButtonTitle0:setText( Engine.Localize( "MENU_DEADLIEST_EQUIPMENT" ) )
	...
	SpecialistButton.ButtonTitle0:setText( Engine.Localize( "MENU_FAVORITE_SPECIALIST" ) )
	...
	ScorestreakButton.ButtonTitle0:setText( Engine.Localize( "MENU_DEADLIEST_SCORESTREAK" ) )
	...
	CombatRecordItemButton0.ButtonTitle0:setText( Engine.Localize( "MENU_MOST_WINS" ) )
			...
			DefaultClip = function ()
				...
				local f31_local1 = function ( f33_arg0, f33_arg1 )
					if not f33_arg1.interrupted then
						f33_arg0:beginAnimation( "keyframe", 19, false, false, CoD.TweenType.Linear )
					end
					f33_arg0:setAlpha( 1 )
				...
				RankName:setAlpha( 0 )
				RankName:registerEventHandler( "transition_complete_keyframe", f31_local1 )
				local f31_local2 = function ( f34_arg0, f34_arg1 )
					if not f34_arg1.interrupted then
						f34_arg0:beginAnimation( "keyframe", 29, false, false, CoD.TweenType.Bounce )
					end
					f34_arg0:setAlpha( 1 )
				...
				Rank:setAlpha( 0 )
				Rank:registerEventHandler( "transition_complete_keyframe", f31_local2 )
