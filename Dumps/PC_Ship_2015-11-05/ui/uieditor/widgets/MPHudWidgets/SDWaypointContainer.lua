...
local f0_local0 = function ( f1_arg0, f1_arg1 )
	if not f1_arg0.Waypoint:isOwnedByMyTeam( f1_arg1 ) then
		return false
	else
		return true
	end
...
local f0_local1 = function ( f2_arg0, f2_arg1, f2_arg2 )
	...
	if f2_local1:isOwnedByMyTeam( f2_arg1 ) then
		...
		if f2_local2 then
			...
			f2_local3.imagecolor = CoD.GetColorSetEnemyColor( f2_arg1 )
		else
			f2_local3.waypointType = f2_arg0.waypoint_label_defend
			f2_local3.imagename = f2_arg0.waypoint_image_defend
			f2_local3.imagecolor = CoD.GetColorSetFriendlyColor( f2_arg1 )
		end
	else
