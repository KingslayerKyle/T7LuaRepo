...
CoD.CodCasterButtons.new = function ( menu, controller )
	...
	SelectPlayer:setLeftRight( true, false, 117.75, 235.75 )
	...
	HighlightPlayer:setLeftRight( true, false, 258.75, 389.75 )
	...
	if HighlightPlayer.m_eventHandlers.input_source_changed then
		local QuickSettingsSideBar = HighlightPlayer.m_eventHandlers.input_source_changed
		HighlightPlayer:registerEventHandler( "input_source_changed", function ( element, event )
			event.menu = event.menu or menu
			element:updateState( event )
			return QuickSettingsSideBar( element, event )
		end )
	else
	...
	QuickSettingsSideBar:setLeftRight( true, false, 467.75, 600 )
	...
	SettingsSideBar:setLeftRight( true, false, 591.75, 690.75 )
	...
	Toolbar:setLeftRight( true, false, 690.75, 832.75 )
	...
	Map:setLeftRight( true, false, 832.75, 919.75 )
	...
	LoadoutView:setLeftRight( true, false, 919.75, 1059.75 )
	...
	if LoadoutView.m_eventHandlers.input_source_changed then
		local f1_local8 = LoadoutView.m_eventHandlers.input_source_changed
