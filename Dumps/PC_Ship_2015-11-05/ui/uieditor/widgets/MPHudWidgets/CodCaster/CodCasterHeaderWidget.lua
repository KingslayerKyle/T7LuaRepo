...
CoD.CodCasterHeaderWidget.new = function ( menu, controller )
	...
	CodCasterHeaderTeamBased:setTopBottom( true, false, -1, 131 )
	...
	CodCasterHeaderNonTeamBased:setLeftRight( false, false, -296, 295 )
	CodCasterHeaderNonTeamBased:setTopBottom( true, false, 0, 131 )
