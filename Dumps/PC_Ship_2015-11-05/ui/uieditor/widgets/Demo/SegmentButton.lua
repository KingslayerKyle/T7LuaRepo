...
CoD.SegmentButton.new = function ( menu, controller )
	...
	durationText:setLeftRight( false, true, -54.5, -11 )
	durationText:setTopBottom( true, false, 9, 30 )
	...
	segmentName:setLeftRight( true, true, 8, -8 )
	segmentName:setTopBottom( false, true, -29, -9 )
	...
	segmentNumber:setLeftRight( true, false, 8, 36.5 )
	segmentNumber:setTopBottom( true, false, 9, 35 )
	segmentNumber.Bg:setRGB( 1, 1, 1 )
	segmentNumber.Bg:setAlpha( 0.5 )
