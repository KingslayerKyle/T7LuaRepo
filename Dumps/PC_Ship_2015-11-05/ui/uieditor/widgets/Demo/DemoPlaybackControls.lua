...
CoD.DemoPlaybackControls.new = function ( menu, controller )
	...
	Top3PlayerScoreBlurBox0:setLeftRight( true, true, 2, -2 )
	...
	VSpanel:setLeftRight( true, true, 2, -2 )
	...
	LeftPanelLnT0:setLeftRight( true, true, -2, 2 )
	LeftPanelLnT0:setTopBottom( true, false, -7, 1 )
	...
	LeftPanelLnT00:setLeftRight( true, true, -2, 2 )
	LeftPanelLnT00:setTopBottom( false, true, -1, 7 )
	...
	ButtonList:setTopBottom( true, false, 47, 92 )
	...
	HintText:setTopBottom( true, false, 2, 24 )
