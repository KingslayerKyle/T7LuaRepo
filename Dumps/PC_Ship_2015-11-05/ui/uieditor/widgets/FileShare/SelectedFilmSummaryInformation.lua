...
CoD.SelectedFilmSummaryInformation.new = function ( menu, controller )
	...
	GameResultBackground:setTopBottom( true, false, 0, 24 )
	...
	SelectedFilmSummaryGameResult:setLeftRight( true, false, 0, 385 )
	SelectedFilmSummaryGameResult:setTopBottom( true, false, 0, 24 )
	...
	ScoreColumn1:setLeftRight( true, false, 0, 109.25 )
	ScoreColumn1:setTopBottom( true, false, 24, 74 )
	...
	ScoreColumn2:setLeftRight( true, false, 98.25, 212.5 )
	ScoreColumn2:setTopBottom( true, false, 24, 74 )
	...
	ScoreColumn3:setLeftRight( true, false, 212.5, 319.75 )
	ScoreColumn3:setTopBottom( true, false, 24, 74 )
	...
	ScoreColumn4:setLeftRight( true, false, 316.75, 416 )
	ScoreColumn4:setTopBottom( true, false, 24, 74 )
