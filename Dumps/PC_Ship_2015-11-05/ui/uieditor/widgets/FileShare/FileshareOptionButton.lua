...
CoD.FileshareOptionButton.new = function ( menu, controller )
	...
	FEButtonFocus.Image:setupNineSliceShader( 12, 12 )
	self:addElement( FEButtonFocus )
	self.FEButtonFocus = FEButtonFocus
	
	local Glow = LUI.UIImage.new()
	Glow:setLeftRight( true, false, 46, 106.99 )
	...
	btnDisplayText:setLeftRight( true, false, 36, 284 )
	...
	btnDisplayTextStroke:setLeftRight( true, false, 36, 232 )
	...
	Glow2:setLeftRight( true, true, -50.5, 66.5 )
	...
	Image0:setLeftRight( true, false, 5.21, 31.21 )
	Image0:setTopBottom( true, false, 5.5, 28.5 )
	...
	self.Image0:linkToElementModel( self, "displayImage", true, function ( model )
		...
		if displayImage then
			Image0:setImage( RegisterImage( displayImage ) )
		end
	end )
	self.clipsPerState = {
		DefaultState = {
			DefaultClip = function ()
				...
				self.btnDisplayText:setLeftRight( true, false, 36, 284 )
			...
			Focus = function ()
				...
				self.clipFinished( Glow, {} )
				btnDisplayText:completeAnimation()
				self.btnDisplayText:setLeftRight( true, false, 36, 306 )
				self.btnDisplayText:setTopBottom( true, false, 6.92, 26.92 )
				self.btnDisplayText:setAlpha( 0 )
				self.btnDisplayText:setZoom( -305 )
				self.clipFinished( btnDisplayText, {} )
				btnDisplayTextStroke:completeAnimation()
				self.btnDisplayTextStroke:setLeftRight( true, false, 36, 230 )
			...
			LoseFocus = function ()
				...
				local btnDisplayTextFrame2 = function ( btnDisplayText, event )
					local btnDisplayTextFrame3 = function ( btnDisplayText, event )
						...
						btnDisplayText:setLeftRight( true, false, 36, 306 )
						btnDisplayText:setTopBottom( true, false, 6.5, 26.5 )
						btnDisplayText:setAlpha( 1 )
						btnDisplayText:setZoom( 0 )
						if event.interrupted then
							self.clipFinished( btnDisplayText, event )
					...
					if event.interrupted then
						...
						btnDisplayText:setLeftRight( true, false, 36, 306.13 )
						btnDisplayText:setTopBottom( true, false, 6.76, 26.76 )
						btnDisplayText:setAlpha( 1 )
						btnDisplayText:setZoom( 0 )
				...
				btnDisplayText:completeAnimation()
				self.btnDisplayText:setLeftRight( true, false, 36, 306.21 )
				self.btnDisplayText:setTopBottom( true, false, 6.92, 26.92 )
				self.btnDisplayText:setAlpha( 0 )
				...
				local btnDisplayTextStrokeFrame2 = function ( btnDisplayTextStroke, event )
					...
					btnDisplayTextStroke:setLeftRight( true, false, 36, 306.21 )
					btnDisplayTextStroke:setTopBottom( true, false, 6.92, 26.92 )
				...
				btnDisplayTextStroke:completeAnimation()
				self.btnDisplayTextStroke:setLeftRight( true, false, 36, 306.21 )
				self.btnDisplayTextStroke:setTopBottom( true, false, 6.92, 26.92 )
				self.btnDisplayTextStroke:setAlpha( 1 )
				self.btnDisplayTextStroke:setZoom( 10 )
			...
			GainFocus = function ()
				...
				local btnDisplayTextFrame2 = function ( btnDisplayText, event )
					...
					btnDisplayText:setLeftRight( true, false, 36, 308 )
					btnDisplayText:setTopBottom( true, false, 6.92, 26.92 )
					btnDisplayText:setAlpha( 0 )
					btnDisplayText:setZoom( 10 )
					if event.interrupted then
				...
				btnDisplayText:completeAnimation()
				self.btnDisplayText:setLeftRight( true, false, 36, 308 )
				self.btnDisplayText:setTopBottom( true, false, 6.92, 26.92 )
				self.btnDisplayText:setAlpha( 1 )
				self.btnDisplayText:setZoom( 0 )
				btnDisplayTextFrame2( btnDisplayText, {} )
		...
		DefaultStateArabic = {
			DefaultClip = function ()
				...
				local btnDisplayTextFrame2 = function ( btnDisplayText, event )
					...
					btnDisplayText:setAlpha( 1 )
					btnDisplayText:setZoom( 0 )
					btnDisplayText:setAlignment( Enum.LUIAlignment.LUI_ALIGNMENT_RIGHT )
					if event.interrupted then
						self.clipFinished( btnDisplayText, event )
					else
						btnDisplayText:registerEventHandler( "transition_complete_keyframe", self.clipFinished )
				...
				self.btnDisplayTextStroke:setAlpha( 0 )
				self.btnDisplayTextStroke:setZoom( 0 )
				self.btnDisplayTextStroke:setAlignment( Enum.LUIAlignment.LUI_ALIGNMENT_RIGHT )
				self.clipFinished( btnDisplayTextStroke, {} )
				Arrow:completeAnimation()
				self.Arrow:setLeftRight( true, false, 3, 11 )
				self.Arrow:setTopBottom( true, false, 12, 20 )
	...
	self:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				return IsDisabled( element, controller ) and not IsCurrentLanguageArabic()
			end
		},
		{
			...
			condition = function ( menu, element, event )
				...
				if not IsDisabled( element, controller ) then
					f92_local0 = IsCurrentLanguageArabic()
				else
					f92_local0 = false
				end
				return f92_local0
		...
		},
		{
			...
			condition = function ( menu, element, event )
				return IsDisabled( element, controller ) and IsCurrentLanguageArabic()
			end
		}
	} )
