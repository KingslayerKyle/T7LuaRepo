...
CoD.FullscreenPopupTemplate.new = function ( menu, controller )
	...
	WorkingTitle:setTopBottom( true, false, 228.26, 276.26 )
	...
	Title:setTopBottom( true, false, 228.26, 276.26 )
	...
	Subtitle:setTopBottom( true, false, 275.41, 300.41 )
	...
	DoneTitle:setLeftRight( true, false, 460.07, 740.07 )
	DoneTitle:setTopBottom( true, false, 228.26, 276.26 )
	...
	ErrorTitle:setTopBottom( true, false, 228.26, 276.26 )
	...
	ErrorSubtitle:setLeftRight( true, false, 460.07, 931.57 )
	ErrorSubtitle:setTopBottom( true, false, 275.41, 300.41 )
