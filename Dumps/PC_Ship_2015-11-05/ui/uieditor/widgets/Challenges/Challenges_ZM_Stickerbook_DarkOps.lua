...
CoD.Challenges_ZM_Stickerbook_DarkOps.new = function ( menu, controller )
	...
	local CallingCardGrid = LUI.UIList.new( menu, controller, 10, 0, nil, true, false, 0, 0, false, true )
	CallingCardGrid:makeFocusable()
	CallingCardGrid:setLeftRight( true, false, 10, 762 )
	CallingCardGrid:setTopBottom( true, false, 16, 491 )
