...
CoD.Challenges_NearCompletionWidget.new = function ( menu, controller )
	...
	ProgressBarBorder:setLeftRight( true, true, 120, -72.11 )
	...
	ProgressBar:setLeftRight( true, true, 121.77, -72.11 )
	...
	ProgressFraction:setLeftRight( false, true, -66, -1 )
	ProgressFraction:setTopBottom( false, false, 15.5, 35.5 )
	...
	ChallengeIcon:setTopBottom( false, false, -32, 32 )
	...
	ChallengeDescription:setTopBottom( false, false, -9, 9 )
