	...
	self.clipsPerState = {
		...
		Locked = {
			DefaultClip = function ()
				...
				self.clipFinished( TierList, {} )
				XPIcon:completeAnimation()
				self.XPIcon:setLeftRight( true, false, 17.5, 49.5 )
				self.XPIcon:setTopBottom( true, false, 276.5, 308.5 )
				self.XPIcon:setAlpha( 0 )
				self.clipFinished( XPIcon, {} )
				XPText:completeAnimation()
				self.XPText:setAlpha( 0 )
		...
		LockedOneTier = {
			DefaultClip = function ()
				...
				self.clipFinished( TierList, {} )
				XPIcon:completeAnimation()
				self.XPIcon:setLeftRight( true, false, 236, 268 )
				self.XPIcon:setTopBottom( true, false, 270.5, 302.5 )
				self.XPIcon:setAlpha( 1 )
				self.clipFinished( XPIcon, {} )
				XPText:completeAnimation()
				self.XPText:setLeftRight( true, false, 272, 327 )
				self.XPText:setTopBottom( true, false, 276.5, 296.5 )
