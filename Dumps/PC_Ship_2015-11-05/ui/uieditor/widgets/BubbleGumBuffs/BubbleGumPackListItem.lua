...
CoD.BubbleGumPackListItem.new = function ( menu, controller )
	...
	btnDisplayText:setLeftRight( true, true, 12, -12 )
	...
	btnDisplayTextStroke:setLeftRight( true, true, 12, -12 )
	...
	self.btnDisplayText:linkToElementModel( self, "bgbPackIndex", true, function ( model )
		...
		if bgbPackIndex then
			btnDisplayText:setText( Engine.Localize( GetBubbleGumPackNameFromPackIndex( controller, bgbPackIndex ) ) )
		end
	end )
	self.btnDisplayTextStroke:linkToElementModel( self, "bgbPackIndex", true, function ( model )
		local bgbPackIndex = Engine.GetModelValue( model )
		if bgbPackIndex then
			btnDisplayTextStroke:setText( Engine.Localize( GetBubbleGumPackNameFromPackIndex( controller, bgbPackIndex ) ) )
		end
	end )
	self.clipsPerState = {
		DefaultState = {
