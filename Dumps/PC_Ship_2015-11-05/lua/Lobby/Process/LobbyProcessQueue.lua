...
Lobby.ProcessQueue.CompleteEvent = function ( f13_arg0, f13_arg1, f13_arg2 )
	...
	elseif f13_local0 == nil then
		...
		if f13_arg0 == Lobby.ProcessQueue.ACTIONSTATE.FAILURE then
			Engine.PrintWarning( Enum.consoleLabel.LABEL_LOBBYHOST, f13_local2 )
		elseif f13_arg0 == Lobby.ProcessQueue.ACTIONSTATE.ERROR then
			Engine.PrintError( Enum.consoleLabel.LABEL_LOBBYHOST, "***********************************************************************\n" )
			Engine.PrintError( Enum.consoleLabel.LABEL_LOBBYHOST, f13_local2 )
			Engine.PrintError( Enum.consoleLabel.LABEL_LOBBYHOST, "***********************************************************************\n" )
		else
			Engine.PrintInfo( Enum.consoleLabel.LABEL_LOBBYHOST, f13_local2 )
		end
		if f13_local0.actionId ~= f13_local1 then
			Engine.PrintError( Enum.consoleLabel.LABEL_LOBBYHOST, "^6LobbyAction: mismatched task completed " .. f13_arg1 .. " event. Head: " .. f13_local0.name .. " was at actionId: " .. f13_local0.actionId .. " but we received actionId: " .. f13_local1 .. ".\n" )
		...
		elseif f13_local0.state ~= Lobby.ProcessQueue.ACTIONSTATE.RUNNING and (not f13_local0.canceled or f13_local0.canceled == false) then
			Engine.PrintError( Enum.consoleLabel.LABEL_LOBBYHOST, "^6LobbyAction: received a task completed " .. f13_arg1 .. " event for non-running action queue head: " .. f13_local0.name .. ", actionId: " .. f13_local0.actionId .. ".\n" )
			error( "LOBBY VM ERROR: Please copy full log and email to codcoreonline@treyarch.com" )
			return 
		end
...
Lobby.ProcessQueue.Update = function ( f17_arg0 )
	...
	elseif f17_local0 == nil then
		Engine.PrintError( Enum.consoleLabel.LABEL_LOBBYHOST, "LobbyAction: received an update but the action queue is empty. actionId: " .. f17_local1 .. ".\n" )
	else
		Engine.PrintInfo( Enum.consoleLabel.LABEL_LOBBYHOST, "LobbyAction: Lobby.ProcessQueue.Update. Head:" .. f17_local0.name .. ", actionId: " .. f17_local0.actionId .. ".\n" )
		if f17_local0.actionId ~= f17_local1 then
			Engine.PrintError( Enum.consoleLabel.LABEL_LOBBYHOST, "LobbyAction: mismatched update. Head: " .. f17_local0.name .. " was at actionId: " .. f17_local0.actionId .. " but we received actionId: " .. f17_local1 .. ".\n" )
		end
		if f17_local0.state ~= Lobby.ProcessQueue.ACTIONSTATE.RUNNING then
			Engine.PrintError( Enum.consoleLabel.LABEL_LOBBYHOST, "LobbyAction: received a update for non-running action queue head: " .. f17_local0.name .. ", actionId: " .. f17_local0.actionId .. ".\n" )
		end
		if f17_local0.updateFuncPtr == nil then
			Engine.PrintError( Enum.consoleLabel.LABEL_LOBBYHOST, "LobbyAction: received a update for an action at head that doesn't have a head:updateFuncPtr() defined. Head: " .. f17_local0.name .. ", actionId: " .. f17_local0.actionId .. "\n" )
		end
