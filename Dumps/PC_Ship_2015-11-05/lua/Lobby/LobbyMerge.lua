...
Lobby.Merge.IsMergingAllowed = function ( f2_arg0 )
	...
	elseif Engine.GetSessionStatus and Engine.GetSessionStatus( f2_arg0 ) ~= Enum.SessionStatus.SESSION_STATUS_IDLE then
		...
		if f2_local0 == Lobby.Timer.LOBBY_STATUS.STARTING or f2_local0 == Lobby.Timer.LOBBY_STATUS.IDLE or f2_local0 == Lobby.Timer.LOBBY_STATUS.NOT_RUNNING or f2_local0 == Lobby.Timer.MATCH_START_INVALID then
			return false
		else
			return true
		end
