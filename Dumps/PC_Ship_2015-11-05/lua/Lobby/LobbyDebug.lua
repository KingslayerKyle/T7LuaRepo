...
Lobby.Debug.SendKVSComError = function ( f18_arg0 )
	...
	if f18_arg0.isInGame then
		f18_arg0.gameInfo = {}
		local f18_local4 = Engine.LobbyGetGameData()
...
Lobby.Debug.OnInit = function ( f25_arg0 )
	Lobby.Debug.KVSInit( f25_arg0 )
	Lobby.Debug.InitProcessQueueDebug()
end

Lobby.Debug.OnUILoad = function ( f26_arg0 )
	if f26_arg0.init == true then
...
Lobby.Debug.OnSessionStart = function ( f27_arg0 )
	local f27_local0 = f27_arg0.lobbyModule
	local f27_local1 = f27_arg0.lobbyType
	local f27_local2 = f27_arg0.lobbyMode
	f27_arg0.lobbyID = Engine.GetLobbyLobbyID( f27_local1 )
	LuaUtils.LogQoS( "session_start", f27_arg0 )
	if f27_local1 == Enum.LobbyType.LOBBY_TYPE_GAME and f27_local0 == Enum.LobbyModule.LOBBY_MODULE_HOST then
		Lobby.Debug.SessionSQJClear()
	end
end

Lobby.Debug.OnSessionEnd = function ( f28_arg0 )
	...
	LuaUtils.LogQoS( "session_end", f28_arg0 )
end

Lobby.Debug.OnMatchStart = function ( f29_arg0 )
	LuaUtils.LogQoS( "match_start", f29_arg0 )
end

Lobby.Debug.OnMatchEnd = function ( f30_arg0 )
	LuaUtils.LogQoS( "match_end", f30_arg0 )
	Engine.FlushKVS( Engine.GetPrimaryController(), Enum.KVSChannel.MATCHMAKING_QOS )
end

Lobby.Debug.OnComError = function ( f31_arg0 )
	Lobby.Debug.SendKVSComError( f31_arg0 )
end

Lobby.Debug.OnJoinComplete = function ( f32_arg0 )
	Lobby.Debug.SendKVSJoin( f32_arg0 )
end
