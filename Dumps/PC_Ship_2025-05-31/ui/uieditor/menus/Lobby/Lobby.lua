...
LUI.createMenu.Lobby = function ( controller )
	...
	if IsPC() then
		f35_local16 = CoD.ChatClientContainer.new( self, controller )
	else
	...
	self:subscribeToModel( Engine.GetModel( Engine.GetGlobalModel(), "lobbyRoot.hideMenusForGameStart" ), function ( model )
		...
		CoD.Menu.UpdateButtonShownState( f111_local0, self, controller, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE )
	end )
	self:subscribeToModel( Engine.GetModel( Engine.GetGlobalModel(), "lobbyRoot.lobbyLockedIn" ), function ( model )
		...
		CoD.Menu.UpdateButtonShownState( f112_local0, self, controller, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE )
	end )
	self:subscribeToModel( Engine.GetModel( Engine.GetGlobalModel(), "lobbyRoot.lobbyNetworkMode" ), function ( model )
		...
		CoD.Menu.UpdateButtonShownState( f113_local0, self, controller, Enum.LUIButton.LUI_KEY_XBY_PSTRIANGLE )
		CoD.Menu.UpdateButtonShownState( f113_local0, self, controller, Enum.LUIButton.LUI_KEY_XBX_PSSQUARE )
	end )
	self:subscribeToModel( Engine.GetModel( Engine.GetGlobalModel(), "lobbyRoot.lobbyNav" ), function ( model )
		...
		CoD.Menu.UpdateButtonShownState( f114_local0, self, controller, Enum.LUIButton.LUI_KEY_XBY_PSTRIANGLE )
		CoD.Menu.UpdateButtonShownState( f114_local0, self, controller, Enum.LUIButton.LUI_KEY_LB )
		CoD.Menu.UpdateButtonShownState( f114_local0, self, controller, Enum.LUIButton.LUI_KEY_RB )
		CoD.Menu.UpdateButtonShownState( f114_local0, self, controller, Enum.LUIButton.LUI_KEY_BACK )
		CoD.Menu.UpdateButtonShownState( f114_local0, self, controller, Enum.LUIButton.LUI_KEY_XBX_PSSQUARE )
	end )
	...
	self:subscribeToModel( Engine.GetModel( Engine.GetGlobalModel(), "lobbyRoot.lobbyMainMode" ), function ( model )
		...
		CoD.Menu.UpdateButtonShownState( f117_local0, self, controller, Enum.LUIButton.LUI_KEY_BACK )
	end )
	self:subscribeToModel( Engine.GetModel( Engine.GetGlobalModel(), "FeaturedCardsRoot.Enabled" ), function ( model )
		...
		CoD.Menu.UpdateButtonShownState( f118_local0, self, controller, Enum.LUIButton.LUI_KEY_RB )
		CoD.Menu.UpdateButtonShownState( f118_local0, self, controller, Enum.LUIButton.LUI_KEY_LB )
	end )
	self:subscribeToModel( Engine.GetModel( Engine.GetGlobalModel(), "liveEventViewer.stream" ), function ( model )
		...
		CoD.Menu.UpdateButtonShownState( f119_local0, self, controller, Enum.LUIButton.LUI_KEY_XBX_PSSQUARE )
		CoD.Menu.UpdateButtonShownState( f119_local0, self, controller, Enum.LUIButton.LUI_KEY_RB )
		CoD.Menu.UpdateButtonShownState( f119_local0, self, controller, Enum.LUIButton.LUI_KEY_LB )
	end )
	self:subscribeToModel( Engine.GetModel( Engine.GetGlobalModel(), "autoevents.cycled" ), function ( model )
		...
		CoD.Menu.UpdateButtonShownState( f120_local0, self, controller, Enum.LUIButton.LUI_KEY_XBX_PSSQUARE )
		CoD.Menu.UpdateButtonShownState( f120_local0, self, controller, Enum.LUIButton.LUI_KEY_RB )
		CoD.Menu.UpdateButtonShownState( f120_local0, self, controller, Enum.LUIButton.LUI_KEY_LB )
	end )
	self:subscribeToModel( Engine.GetModel( Engine.GetGlobalModel(), "PlayGoDownloadProgress.progress" ), function ( model )
		...
		CoD.Menu.UpdateButtonShownState( f121_local0, self, controller, Enum.LUIButton.LUI_KEY_XBX_PSSQUARE )
	end )
	self:subscribeToModel( Engine.GetModel( Engine.GetGlobalModel(), "ModsGlobal.update" ), function ( model )
		...
		CoD.Menu.UpdateButtonShownState( f122_local0, self, controller, Enum.LUIButton.LUI_KEY_XBX_PSSQUARE )
	end )
	...
	self:registerEventHandler( "unused_gamepad_button", function ( self, event )
		...
		if not f123_local0 then
			f123_local0 = self:dispatchEventToChildren( event )
		end
		return f123_local0
	end )
	self:registerEventHandler( "record_curr_focused_elem_id", function ( self, event )
		...
		if self.RecordCurrFocusedElemID then
			f124_local0 = self:RecordCurrFocusedElemID( event )
		elseif self.super.RecordCurrFocusedElemID then
			f124_local0 = self.super:RecordCurrFocusedElemID( event )
		end
	...
	self:registerEventHandler( "menu_loaded", function ( self, event )
		...
		if not f125_local0 then
			f125_local0 = self:dispatchEventToChildren( event )
		end
		return f125_local0
	end )
	self:registerEventHandler( "menu_opened", function ( self, event )
		...
		if not f126_local0 then
			f126_local0 = self:dispatchEventToChildren( event )
		end
		return f126_local0
	end )
	...
	self:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_LSTICK_PRESSED, "B", function ( element, menu, controller, model )
		if IsServerBrowserEnabled() then
			OpenServerBrowser( self, element, controller, "", menu )
			return true
		else
		...
		if IsServerBrowserEnabled() then
			CoD.Menu.SetButtonLabel( menu, Enum.LUIButton.LUI_KEY_LSTICK_PRESSED, "MENU_SERVER_BROWSER" )
			return true
		else
			return false
		end
