...
local PreLoadFunc = function ( self, controller )
	...
	self:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, nil, f1_local6, function ( element, menu, controller )
		CoD.Menu.SetButtonLabel( menu, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, "MENU_CLOSE" )
		return true
	end, false )
	self:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBX_PSSQUARE, nil, f1_local7, function ( element, menu, controller )
	...
	self:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBY_PSTRIANGLE, nil, f1_local8, function ( element, menu, controller )
...
LUI.createMenu.VoDViewer = function ( controller )
	...
	local LiveEventViewerMovieAndBackground = CoD.VoDViewerMovieAndBackground.new( self, controller )
	...
	local LiveEventViewerFooterContainer0 = CoD.VoDViewerFooterContainer.new( self, controller )
	...
	self:registerEventHandler( "menu_opened", function ( self, event )
		...
		UpdateButtonPromptState( self, self, controller, Enum.LUIButton.LUI_KEY_XBY_PSTRIANGLE )
	...
	self:subscribeToGlobalModel( controller, "LiveEventViewer", "currentQuality", function ( model )
		UpdateButtonPromptState( self, self, controller, Enum.LUIButton.LUI_KEY_XBX_PSSQUARE )
	end )
