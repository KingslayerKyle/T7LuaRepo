...
LUI.createMenu.LoadingScreenOverlayForTeamGames = function ( controller )
	...
	local LoadingScreenVSCirclePnl = CoD.LoadingScreenVSCirclePnl.new( self, controller )
	...
	local FrameForCodCasterRight = CoD.TeamIconAndNameWidgetForCodCaster.new( self, controller )
	...
	local FrameForCodCasterLeft = CoD.TeamIconAndNameWidgetForCodCaster.new( self, controller )
	...
	local LoadingScreenFactionIcon = CoD.LoadingScreenFactionIcon.new( self, controller )
	...
	local LoadingScreenFactionIcon0 = CoD.LoadingScreenFactionIcon.new( self, controller )
	...
	local LoadingScreenTeamPlayerList = CoD.LoadingScreenTeamPlayerList.new( self, controller )
