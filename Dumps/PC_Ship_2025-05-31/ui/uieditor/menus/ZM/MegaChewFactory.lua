...
LUI.createMenu.MegaChewFactory = function ( controller )
	...
	MegaChewMachine0:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "MegaChewFactory.disableInput" ), function ( model )
		...
		CoD.Menu.UpdateButtonShownState( f73_local0, self, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS )
	end )
	...
	MegaChewMachine1:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "MegaChewFactory.disableInput" ), function ( model )
		...
		CoD.Menu.UpdateButtonShownState( f79_local0, self, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS )
	end )
	...
	MegaChewMachine2:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "MegaChewFactory.disableInput" ), function ( model )
		...
		CoD.Menu.UpdateButtonShownState( f85_local0, self, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS )
	end )
	...
	self:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "MegaChewFactory.disableInput" ), function ( model )
		...
		CoD.Menu.UpdateButtonShownState( f98_local0, self, controller, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE )
		CoD.Menu.UpdateButtonShownState( f98_local0, self, controller, Enum.LUIButton.LUI_KEY_LSTICK_PRESSED )
		CoD.Menu.UpdateButtonShownState( f98_local0, self, controller, Enum.LUIButton.LUI_KEY_XBY_PSTRIANGLE )
		CoD.Menu.UpdateButtonShownState( f98_local0, self, controller, Enum.LUIButton.LUI_KEY_XBX_PSSQUARE )
	end )
	...
	self:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "LastInput" ), function ( model )
		...
		CoD.Menu.UpdateButtonShownState( f100_local0, self, controller, Enum.LUIButton.LUI_KEY_LSTICK_PRESSED )
	end )
	self:subscribeToModel( Engine.GetModel( Engine.GetGlobalModel(), "lobbyRoot.lobbyNetworkMode" ), function ( model )
		...
		CoD.Menu.UpdateButtonShownState( f101_local0, self, controller, Enum.LUIButton.LUI_KEY_XBY_PSTRIANGLE )
		CoD.Menu.UpdateButtonShownState( f101_local0, self, controller, Enum.LUIButton.LUI_KEY_XBX_PSSQUARE )
	end )
	...
	self:registerEventHandler( "menu_loaded", function ( self, event )
		...
		if not f103_local0 then
			f103_local0 = self:dispatchEventToChildren( event )
		end
		return f103_local0
	end )
	self:registerEventHandler( "menu_opened", function ( self, event )
		...
		if not f104_local0 then
			f104_local0 = self:dispatchEventToChildren( event )
		end
		return f104_local0
	end )
	...
	self:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBY_PSTRIANGLE, "B", function ( element, menu, controller, model )
