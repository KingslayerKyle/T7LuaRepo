...
LUI.createMenu.ServerBrowserFilters = function ( controller )
	...
	local mapFilters = LUI.UIList.new( self, controller, 2, 0, nil, false, false, 0, 0, false, true )
	...
	self:AddButtonCallbackFunction( mapFilters, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( element, menu, controller, model )
		ServerBrowserToggleFilter( self, element, menu, model )
		return true
	...
	local dlcMapFilters = LUI.UIList.new( self, controller, 2, 0, nil, false, false, 0, 0, false, true )
	...
	self:AddButtonCallbackFunction( dlcMapFilters, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( element, menu, controller, model )
		ServerBrowserToggleFilter( self, element, menu, model )
		return true
	end, function ( element, menu, controller )
		CoD.Menu.SetButtonLabel( menu, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "MENU_SELECT" )
	...
	local gameModeFilters = LUI.UIList.new( self, controller, 2, 0, nil, false, false, 0, 0, false, true )
	...
	self:AddButtonCallbackFunction( gameModeFilters, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( element, menu, controller, model )
		ServerBrowserToggleFilter( self, element, menu, model )
		return true
	end, function ( element, menu, controller )
		CoD.Menu.SetButtonLabel( menu, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "MENU_SELECT" )
	...
	local attributeFilters = LUI.UIList.new( self, controller, 2, 0, nil, false, false, 0, 0, false, true )
	...
	self:AddButtonCallbackFunction( attributeFilters, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( element, menu, controller, model )
		ServerBrowserToggleFilter( self, element, menu, model )
		return true
	end, function ( element, menu, controller )
		CoD.Menu.SetButtonLabel( menu, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "MENU_SELECT" )
	...
	local modsFilters = LUI.UIList.new( self, controller, 2, 0, nil, false, false, 0, 0, false, true )
	...
	self:AddButtonCallbackFunction( modsFilters, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( element, menu, controller, model )
		ServerBrowserToggleFilter( self, element, menu, model )
		return true
	end, function ( element, menu, controller )
		CoD.Menu.SetButtonLabel( menu, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "MENU_SELECT" )
	...
	local keywordsInput = CoD.GroupsInputButtonScroll.new( self, controller )
	...
	self:AddButtonCallbackFunction( keywordsInput, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( element, menu, controller, model )
		ServerFiltersEditKeywords( self, element, controller )
		return true
	end, function ( element, menu, controller )
		CoD.Menu.SetButtonLabel( menu, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "MENU_SELECT" )
		return true
	...
	local keywordsTitle = CoD.GroupsSubTitle.new( self, controller )
	...
	self:registerEventHandler( "ui_keyboard_input", function ( self, event )
		...
		ServerFiltersHandleKeyboardComplete( self, self, controller, event )
