...
LUI.createMenu.ServerSettings = function ( controller )
	...
	local nameTitle = CoD.GroupsSubTitle.new( self, controller )
	...
	local nameInput = CoD.GroupsInputButtonScroll.new( self, controller )
	...
	self:AddButtonCallbackFunction( nameInput, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( element, menu, controller, model )
		ServerSettingsEditName( self, element, controller )
		return true
	...
	local descriptionTitle = CoD.GroupsSubTitle.new( self, controller )
	...
	self:AddButtonCallbackFunction( descriptionInput, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( element, menu, controller, model )
		ServerSettingsEditDescription( self, element, controller )
		return true
	end, function ( element, menu, controller )
		CoD.Menu.SetButtonLabel( menu, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "MENU_SELECT" )
		return true
	...
	local passwordTitle = CoD.GroupsSubTitle.new( self, controller )
	...
	local passwordInput = CoD.GroupsInputButtonScroll.new( self, controller )
	...
	self:AddButtonCallbackFunction( passwordInput, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( element, menu, controller, model )
		ServerSettingsEditPassword( self, element, controller )
		return true
	end, function ( element, menu, controller )
		CoD.Menu.SetButtonLabel( menu, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "MENU_SELECT" )
		return true
	...
	self:registerEventHandler( "ui_keyboard_input", function ( self, event )
		...
		ServerSettingsHandleKeyboardComplete( self, self, controller, event )
