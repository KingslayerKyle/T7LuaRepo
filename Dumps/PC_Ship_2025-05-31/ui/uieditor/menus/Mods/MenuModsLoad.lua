...
LUI.createMenu.MenuModsLoad = function ( controller )
	...
	local WidgetModsLoad0 = CoD.WidgetModsLoad.new( self, controller )
	...
	self:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBY_PSTRIANGLE, "U", function ( element, menu, controller, model )
