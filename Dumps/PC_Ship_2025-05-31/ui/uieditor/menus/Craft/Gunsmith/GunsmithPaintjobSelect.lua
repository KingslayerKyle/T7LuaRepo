...
LUI.createMenu.GunsmithPaintjobSelect = function ( controller )
	...
	self:AddButtonCallbackFunction( paintjobsList, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( element, menu, controller, model )
		if not Paintjobs_IsOccupied( element, controller ) and PaintshopEditAvailable( element, controller ) then
	...
	self:AddButtonCallbackFunction( paintjobsList, controller, Enum.LUIButton.LUI_KEY_XBX_PSSQUARE, "E", function ( element, menu, controller, model )
		if Paintjobs_IsOccupied( element, controller ) and PaintshopEditAvailable( element, controller ) then
			OpenEmblemEditor( element, menu, controller, model, "PaintjobSelect" )
			return true
		else
