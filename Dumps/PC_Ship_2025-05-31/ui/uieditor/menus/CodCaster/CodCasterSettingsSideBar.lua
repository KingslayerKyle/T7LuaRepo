...
LUI.createMenu.CodCasterSettingsSideBar = function ( controller )
	...
	self:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_NONE, "W", function ( element, menu, controller, model )
		ToggleControllerModelValueNumber( controller, "CodCaster.showSettingsSideBar" )
		SaveShoutcasterSettings( self, element, controller )
		GoBack( self, controller )
		SetLuiKeyCatcher( false )
	...
	self:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_NONE, "E", function ( element, menu, controller, model )
		ToggleControllerModelValueNumber( controller, "CodCaster.showSettingsSideBar" )
		SaveShoutcasterSettings( self, element, controller )
		GoBack( self, controller )
		SetLuiKeyCatcher( false )
