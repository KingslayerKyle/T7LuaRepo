...
LUI.createMenu.T7Hud_zm_tomb = function ( controller )
	...
	local stoneTabletClean = CoD.onOffImage.new( self, controller )
	...
	stoneTabletClean:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_HUD_VISIBLE ), function ( model )
		self:updateElementState( stoneTabletClean, {
	...
	local stoneTabletDirty = CoD.onOffImage.new( self, controller )
	...
	stoneTabletDirty:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_HUD_VISIBLE ), function ( model )
		self:updateElementState( stoneTabletDirty, {
			name = "model_validation",
			menu = self,
			modelValue = Engine.GetModelValue( model ),
			modelName = "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_HUD_VISIBLE
	...
	local ZMPerksContainerFactory = CoD.ZMPerksContainerFactory.new( self, controller )
	...
	local Ammo = CoD.ZmAmmoContainerFactory.new( self, controller )
	...
	local GenericWaypointContainer = CoD.GenericWaypointContainer.new( self, controller )
	...
	MPScore:subscribeToGlobalModel( controller, "PerController", "scriptNotify", function ( model )
		...
		if IsParamModelEqualToString( model, "score_event" ) and PropertyIsTrue( self, "menuLoaded" ) then
			...
			SetMPScoreText( self, f80_local0, controller, model )
		end
	end )
	self:addElement( MPScore )
	self.MPScore = MPScore
	
	local ZMPrematchCountdown0 = CoD.ZM_PrematchCountdown.new( self, controller )
	...
	local RocketShieldWidgetTomb = CoD.RocketShieldWidget_Tomb.new( self, controller )
	...
	RocketShieldWidgetTomb:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_SCOREBOARD_OPEN ), function ( model )
		self:updateElementState( RocketShieldWidgetTomb, {
			name = "model_validation",
			menu = self,
			modelValue = Engine.GetModelValue( model ),
			modelName = "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_SCOREBOARD_OPEN
	...
	local ElementalStaffsWidget = CoD.ElementalStaffsWidget.new( self, controller )
	...
	ElementalStaffsWidget:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "zmInventory.air_staff.visible" ), function ( model )
		self:updateElementState( ElementalStaffsWidget, {
			name = "model_validation",
			menu = self,
			modelValue = Engine.GetModelValue( model ),
	...
	local MaxisDroneBlueprintWidgetTomb = CoD.MaxisDroneBlueprintWidget_Tomb.new( self, controller )
	...
	MaxisDroneBlueprintWidgetTomb:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_SCOREBOARD_OPEN ), function ( model )
		self:updateElementState( MaxisDroneBlueprintWidgetTomb, {
			name = "model_validation",
			menu = self,
			modelValue = Engine.GetModelValue( model ),
			modelName = "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_SCOREBOARD_OPEN
	...
	local MusicalPartsWidgetTomb = CoD.MusicalPartsWidget_Tomb.new( self, controller )
	...
	MusicalPartsWidgetTomb:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_HUD_VISIBLE ), function ( model )
		self:updateElementState( MusicalPartsWidgetTomb, {
			name = "model_validation",
			menu = self,
			modelValue = Engine.GetModelValue( model ),
			modelName = "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_HUD_VISIBLE
	...
	local IngameChatClientContainer0 = CoD.IngameChatClientContainer.new( self, controller )
	...
	local InventoryWidget = CoD.InventoryWidgetTomb.new( self, controller )
	...
	local CaptureGeneratorWheelWidgetTomb = CoD.CaptureGeneratorWheelWidget_Tomb.new( self, controller )
	...
	CaptureGeneratorWheelWidgetTomb:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "zmInventory.capture_generator_wheel_widget" ), function ( model )
		self:updateElementState( CaptureGeneratorWheelWidgetTomb, {
			name = "model_validation",
			menu = self,
			modelValue = Engine.GetModelValue( model ),
	...
	local ZMTombCaptureZoneWaypointContainer = CoD.ZMTombCaptureZoneWaypointContainer.new( self, controller )
	...
	self:registerEventHandler( "menu_loaded", function ( self, event )
		...
		if not f116_local0 then
			f116_local0 = self:dispatchEventToChildren( event )
		end
		return f116_local0
	end )
