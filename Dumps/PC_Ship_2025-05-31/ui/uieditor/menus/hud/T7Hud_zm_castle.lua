...
LUI.createMenu.T7Hud_zm_castle = function ( controller )
	...
	local RocketShield = CoD.RocketShieldBlueprintWidget_Castle.new( self, controller )
	...
	local RagnarokBlueprintWidgetCastle = CoD.RagnarokBlueprintWidget_Castle.new( self, controller )
	...
	RagnarokBlueprintWidgetCastle:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "zmInventory.widget_gravityspike_parts" ), function ( model )
		self:updateElementState( RagnarokBlueprintWidgetCastle, {
			name = "model_validation",
			menu = self,
			modelValue = Engine.GetModelValue( model ),
	...
	local InventoryWidget = CoD.InventoryWidgetFactory.new( self, controller )
	...
	local FuseBoxWidget = CoD.FuseBoxWidget_Castle.new( self, controller )
	...
	local CastleElementalArrowNotificationWidgets = CoD.CastleElementalArrowNotificationWidgets.new( self, controller )
