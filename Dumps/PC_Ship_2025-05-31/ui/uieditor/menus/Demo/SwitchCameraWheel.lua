...
LUI.createMenu.SwitchCameraWheel = function ( controller )
	...
	local CameraButton7 = CoD.AbilityButtonNew.new( self, controller )
	...
	CameraButton7:linkToElementModel( CameraButton7, "enabled", true, function ( model )
		self:updateElementState( CameraButton7, {
	...
	local CameraButton6 = CoD.AbilityButtonNew.new( self, controller )
	...
	CameraButton6:linkToElementModel( CameraButton6, "enabled", true, function ( model )
		self:updateElementState( CameraButton6, {
			name = "model_validation",
			menu = self,
			modelValue = Engine.GetModelValue( model ),
			modelName = "enabled"
	...
	local CameraButton5 = CoD.AbilityButtonNew.new( self, controller )
	...
	CameraButton5:linkToElementModel( CameraButton5, "enabled", true, function ( model )
		self:updateElementState( CameraButton5, {
			name = "model_validation",
			menu = self,
			modelValue = Engine.GetModelValue( model ),
			modelName = "enabled"
	...
	local CameraButton4 = CoD.AbilityButtonNew.new( self, controller )
	...
	CameraButton4:linkToElementModel( CameraButton4, "enabled", true, function ( model )
		self:updateElementState( CameraButton4, {
			name = "model_validation",
			menu = self,
			modelValue = Engine.GetModelValue( model ),
			modelName = "enabled"
	...
	local CameraButton3 = CoD.AbilityButtonNew.new( self, controller )
	...
	CameraButton3:linkToElementModel( CameraButton3, "enabled", true, function ( model )
		self:updateElementState( CameraButton3, {
			name = "model_validation",
			menu = self,
			modelValue = Engine.GetModelValue( model ),
			modelName = "enabled"
	...
	local CameraButton2 = CoD.AbilityButtonNew.new( self, controller )
	...
	CameraButton2:linkToElementModel( CameraButton2, "enabled", true, function ( model )
		self:updateElementState( CameraButton2, {
			name = "model_validation",
			menu = self,
			modelValue = Engine.GetModelValue( model ),
			modelName = "enabled"
	...
	local CameraButton1 = CoD.AbilityButtonNew.new( self, controller )
	...
	CameraButton1:linkToElementModel( CameraButton1, "enabled", true, function ( model )
		self:updateElementState( CameraButton1, {
			name = "model_validation",
			menu = self,
			modelValue = Engine.GetModelValue( model ),
			modelName = "enabled"
	...
	self:registerEventHandler( "menu_loaded", function ( self, event )
		...
		if not f264_local0 then
			f264_local0 = self:dispatchEventToChildren( event )
		end
		return f264_local0
	end )
	self:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_LB, "MWHEELUP", function ( element, menu, controller, model )
	...
	self:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_RB, "MWHEELDOWN", function ( element, menu, controller, model )
		if IsMulticoreActivated( controller ) then
			ChangeAbilityWheelItems( controller, menu, 1 )
