...
LUI.createMenu.ChooseModeSidebar = function ( controller )
	...
	self:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBX_PSSQUARE, "M", function ( element, menu, controller, model )
		GoBack( self, controller )
		SetGlobalModelValueFalse( "demo.showChooseModeSidebar" )
		return true
	end, function ( element, menu, controller )
		CoD.Menu.SetButtonLabel( menu, Enum.LUIButton.LUI_KEY_XBX_PSSQUARE, "MENU_DISMISS_MENU" )
		return true
	end, false )
