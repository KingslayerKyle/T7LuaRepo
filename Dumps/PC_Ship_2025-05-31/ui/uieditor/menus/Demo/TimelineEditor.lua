...
LUI.createMenu.TimelineEditor = function ( controller )
	...
	self:AddButtonCallbackFunction( SegmentButtonList, controller, Enum.LUIButton.LUI_KEY_START, "O", function ( element, menu, controller, model )
	...
	self:AddButtonCallbackFunction( SegmentButtonList, controller, Enum.LUIButton.LUI_KEY_XBX_PSSQUARE, "P", function ( element, menu, controller, model )
		if SegmentCountGreaterThan( controller, 0 ) and not IsGlobalModelValueTrue( element, controller, "demo.showFilmOptionsSidebar" ) and not IsTimelineEditorInMoveState( controller ) then
	...
	self:AddButtonCallbackFunction( SegmentButtonList, controller, Enum.LUIButton.LUI_KEY_XBY_PSTRIANGLE, "T", function ( element, menu, controller, model )
	...
	self:AddButtonCallbackFunction( SegmentButtonList, controller, Enum.LUIButton.LUI_KEY_PCKEY_0, "M", function ( element, menu, controller, model )
		return true
	end, function ( element, menu, controller )
