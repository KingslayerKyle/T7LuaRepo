...
LUI.createMenu.DniWipe = function ( controller )
	...
	local GenericUpdateBar0 = CoD.GenericUpdateBar.new( self, controller )
	...
	local OutterThinInternal0 = CoD.VehicleGround_IrisOutterThinInternal.new( self, controller )
	...
	local DniWipeLinesSide = CoD.DniWipe_LinesSide.new( self, controller )
	...
	local DniWipeLinesSide0 = CoD.DniWipe_LinesSide.new( self, controller )
	...
	local DniWipeLinesSide1 = CoD.DniWipe_LinesSide.new( self, controller )
	...
	local DniWipeLinesSide2 = CoD.DniWipe_LinesSide.new( self, controller )
	...
	local dotUL = CoD.outofbounds_dotblinkwidget.new( self, controller )
	dotUL:setLeftRight( false, false, 310.5, 318.5 )
	dotUL:setTopBottom( false, false, -237, -229 )
	self:addElement( dotUL )
	self.dotUL = dotUL
	
	local dotUR = CoD.outofbounds_dotblinkwidget.new( self, controller )
	dotUR:setLeftRight( false, false, -308.5, -300.5 )
	dotUR:setTopBottom( false, false, -237, -229 )
	self:addElement( dotUR )
	self.dotUR = dotUR
	
	local outofboundsdotblinkwidget0 = CoD.outofbounds_dotblinkwidget.new( self, controller )
	...
	local outofboundsdotblinkwidget1 = CoD.outofbounds_dotblinkwidget.new( self, controller )
	...
	local DNImod = CoD.DniWipe_DniWidget.new( self, controller )
	...
	local CenterDotLR = CoD.outofbounds_dotblinkwidget.new( self, controller )
	...
	local CenterDotR = CoD.outofbounds_dotblinkwidget.new( self, controller )
	...
	local CenterDotLL = CoD.outofbounds_dotblinkwidget.new( self, controller )
	...
	local CenterDotL = CoD.outofbounds_dotblinkwidget.new( self, controller )
	...
	local DniWipeCenterAngledLines = CoD.DniWipe_CenterAngledBlurLines.new( self, controller )
	...
	local DniWipeCenterAngledBlurLines = CoD.DniWipe_CenterAngledLines.new( self, controller )
	...
	local DniWipeCircleSpinWidget = CoD.DniWipe_CircleSpinWidget.new( self, controller )
	...
	local DniWipeDottedCircleWidget0 = CoD.DniWipe_DottedCircleWidget.new( self, controller )
	...
	local DniWipePurgingTextWidget = CoD.DniWipe_PurgingTextWidget.new( self, controller )
	...
	local DniWipeDniTextWidget = CoD.DniWipe_DniTextWidget.new( self, controller )
	...
	local DniWipeOuterIrisBlink0 = CoD.DniWipe_OuterIrisBlink.new( self, controller )
	...
	local Numbers = CoD.PrematchCountdown_NumbersInternal.new( self, controller )
