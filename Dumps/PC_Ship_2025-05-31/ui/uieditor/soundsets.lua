...
SoundSet.SelectColor_ColorMixer = {
	list_up = "uin_paint_grid_nav",
	list_down = "uin_paint_grid_nav",
...
SoundSet.Special_widgets = {
	feature_update = "uin_featured_scroll",
	menu_open = "uin_spinner"
}
SoundSet.CAC_PrimaryWeapon = LUI.ShallowCopy( SoundSet.CAC_SubMenu )
...
SoundSet.Siegebot = LUI.ShallowCopy( SoundSet.default )
