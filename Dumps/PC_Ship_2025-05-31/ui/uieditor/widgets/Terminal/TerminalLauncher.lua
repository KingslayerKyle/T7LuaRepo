...
local f0_local1 = function ( f2_arg0, f2_arg1, f2_arg2 )
	...
	f2_arg2:AddButtonCallbackFunction( f2_arg0, f2_arg1, Enum.LUIButton.LUI_KEY_LB, "+actionslot 1", function ( element, menu, controller, model )
		SendMenuResponse( f2_arg0, "PersonalDataVaultMenu", "musicTrackBack", controller )
		return true
	end, function ( element, menu, controller )
		CoD.Menu.SetButtonLabel( menu, Enum.LUIButton.LUI_KEY_LB, "MENU_MUSICPLAYER_BACK" )
		return true
	end, false )
	f2_arg2:AddButtonCallbackFunction( f2_arg0, f2_arg1, Enum.LUIButton.LUI_KEY_RB, "+actionslot 2", function ( element, menu, controller, model )
		SendMenuResponse( f2_arg0, "PersonalDataVaultMenu", "musicTrackNext", controller )
		return true
	end, function ( element, menu, controller )
...
local PostLoadFunc = function ( self, controller, menu )
	...
	menu:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_RTRIG, nil, function ( element, menu, controller, model )
		if self.FilesApplet:isInFocus() and self.FilesApplet.cheatstate == 2 then
			...
			local f18_local1 = f18_local0:openPopup( "NumericKeypad", controller )
			return true
		else
