...
CoD.heroCustomizationOption.new = function ( menu, controller )
	...
	menu:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, nil, function ( element, menu, controller, model )
		if IsSelfInState( self, "BMPurchasable" ) and IsElementInFocus( element ) then
			OpenOutfitStore( self, element, controller, "OutfitStore", menu )
			return true
		else
		...
		if IsSelfInState( self, "BMPurchasable" ) and IsElementInFocus( element ) then
			CoD.Menu.SetButtonLabel( menu, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "MENU_VIEW_STORE_OUTFITS" )
			return true
		else
			return false
		end
