...
local f0_local1 = function ( f2_arg0, f2_arg1, f2_arg2 )
	...
	f2_arg2:AddButtonCallbackFunction( f2_arg0, f2_arg1, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( element, menu, controller, model )
	...
	if f2_arg2.menuName == "StartMenu_Options_Sound_PC" then
		...
		f2_arg2:AddButtonCallbackFunction( f2_arg0, f2_arg1, Enum.LUIButton.LUI_KEY_XBY_PSTRIANGLE, "P", function ( element, menu, controller, model )
			local f15_local0 = f2_local0( f2_arg0, controller, "alias" )
			if f15_local0 then
				f2_local1( f2_arg0, f15_local0 )
				StopMPMusicPreview( controller, f2_arg0 )
				PlayMPMusicPreview( controller, f2_arg0 )
				return true
			else
				return false
			end
		end, function ( element, menu, controller )
			if f2_local0( f2_arg0, controller, "alias" ) then
				CoD.Menu.SetButtonLabel( menu, Enum.LUIButton.LUI_KEY_XBY_PSTRIANGLE, "MENU_PLAY_MUSIC_SAMPLE" )
				return true
			else
				return false
			end
