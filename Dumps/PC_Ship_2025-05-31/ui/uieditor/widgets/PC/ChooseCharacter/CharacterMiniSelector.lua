...
DataSources.HeroesListMini = DataSourceHelpers.ListSetup( "HeroesListMini", function ( f1_arg0 )
	local f1_local0 = Engine.GetHeroList( CoD.CCUtility.customizationMode )
	local f1_local1 = {}
	for f1_local5, f1_local6 in ipairs( f1_local0 ) do
		...
		if CoDShared.IsLootHero( f1_local6 ) then
			if AllowLootHero( f1_arg0 ) then
				table.insert( f1_local1, 1, f1_local7 )
			end
		end
...
local PostLoadFunc = function ( f3_arg0, f3_arg1 )
	...
	f3_arg0.characterGrid:setDataSource( "HeroesListMini" )
