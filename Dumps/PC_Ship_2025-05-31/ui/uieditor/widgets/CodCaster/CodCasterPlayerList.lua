...
CoD.CodCasterPlayerList.new = function ( menu, controller )
	...
	menu:AddButtonCallbackFunction( Team1, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( element, menu, controller, model )
		SpectateSelectedPlayer( self, element, controller )
		return true
	end, function ( element, menu, controller )
		CoD.Menu.SetButtonLabel( menu, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "" )
		return false
	end, false )
	menu:AddButtonCallbackFunction( Team1, controller, Enum.LUIButton.LUI_KEY_NONE, "ENTER", function ( element, menu, controller, model )
		SpectateSelectedPlayer( self, element, controller )
		return true
	end, function ( element, menu, controller )
	...
	menu:AddButtonCallbackFunction( Team2, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( element, menu, controller, model )
		SpectateSelectedPlayer( self, element, controller )
		return true
	end, function ( element, menu, controller )
		CoD.Menu.SetButtonLabel( menu, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "" )
	...
	menu:AddButtonCallbackFunction( Team2, controller, Enum.LUIButton.LUI_KEY_NONE, "ENTER", function ( element, menu, controller, model )
		SpectateSelectedPlayer( self, element, controller )
		return true
	end, function ( element, menu, controller )
		CoD.Menu.SetButtonLabel( menu, Enum.LUIButton.LUI_KEY_NONE, "" )
