...
CoD.AdminTabGroupDeleteFrame.new = function ( menu, controller )
	...
	menu:AddButtonCallbackFunction( DeleteButton, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, nil, function ( element, menu, controller, model )
	...
	self:registerEventHandler( "gain_focus", function ( self, event )
		if self.m_focusable and self.DeleteButton:processEvent( event ) then
			return true
		else
