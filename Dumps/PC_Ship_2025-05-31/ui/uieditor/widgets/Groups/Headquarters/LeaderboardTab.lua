...
CoD.LeaderboardTab.new = function ( menu, controller )
	...
	menu:AddButtonCallbackFunction( CreateLeaderboardButton, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( element, menu, controller, model )
		if HasAdminPrivilege( controller, Enum.GroupAdminPrivilege.GROUP_ADMIN_PRIVILEGE_EDIT_GROUP_LEADERBOARD ) then
	...
	menu:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_START, nil, function ( element, menu, controller, model )
		if HasAdminPrivilege( controller, Enum.GroupAdminPrivilege.GROUP_ADMIN_PRIVILEGE_EDIT_GROUP_LEADERBOARD ) and IsGroupLeaderboardAvailable() then
			OpenPopup( self, "GroupLeaderboardOptions", controller, "", "" )
			return true
		else
		...
		if HasAdminPrivilege( controller, Enum.GroupAdminPrivilege.GROUP_ADMIN_PRIVILEGE_EDIT_GROUP_LEADERBOARD ) and IsGroupLeaderboardAvailable() then
			CoD.Menu.SetButtonLabel( menu, Enum.LUIButton.LUI_KEY_START, "MENU_OPTIONS_CAPS" )
			return true
		else
			return false
		end
	...
	self:registerEventHandler( "gain_focus", function ( self, event )
		if self.m_focusable and self.CreateLeaderboardButton:processEvent( event ) then
			return true
		else
