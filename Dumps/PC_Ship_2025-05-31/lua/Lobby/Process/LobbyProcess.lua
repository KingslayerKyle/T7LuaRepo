...
Lobby.Process.JoinSystemlink = function ( f22_arg0, f22_arg1, f22_arg2, f22_arg3, f22_arg4, f22_arg5 )
	...
	f22_local6.probeResult.ugcInfo = f22_arg5
	local f22_local7 = Lobby.Actions.CheckMods( f22_arg0, f22_local6, true )
	local f22_local8 = Lobby.Actions.ErrorPopup( f22_local7 )
	local f22_local9 = Lobby.Actions.SubscribeUGC( f22_arg0, f22_local7 )
	local f22_local10 = Lobby.Actions.ErrorPopup( f22_local9 )
	local f22_local11 = Lobby.Actions.CloseSpinner()
	f22_local11.name = f22_local3.name .. "SubscribeUGC"
	local f22_local12 = Lobby.Actions.InstalledUGC( f22_arg0, f22_local7 )
	local f22_local13 = Lobby.Actions.ErrorPopup( f22_local12 )
	local f22_local14 = Lobby.Actions.CloseSpinner()
	f22_local14.name = f22_local3.name .. "InstalledUGC"
	local f22_local15 = Lobby.Actions.LoadMod( f22_arg0, f22_local7 )
	local f22_local16 = Lobby.Actions.ErrorPopup( f22_local15 )
	local f22_local17 = Lobby.Actions.CloseSpinner()
	f22_local17.name = f22_local3.name .. "LoadedMod"
	...
	Lobby.Process.AddActions( f22_local0, f22_local7 )
	Lobby.Process.AddActions( f22_local7, f22_local9, f22_local3, f22_local5 )
	Lobby.Process.AddActions( f22_local9, f22_local12, f22_local3, f22_local11 )
	Lobby.Process.AddActions( f22_local12, f22_local15, f22_local3, f22_local14 )
	Lobby.Process.AddActions( f22_local15, f22_local2, f22_local3, f22_local17 )
	Lobby.Process.AddActions( f22_local2, f22_local1, f22_local3, f22_local3 )
	Lobby.Process.ForceAction( f22_local5, f22_local8 )
	Lobby.Process.ForceAction( f22_local11, f22_local10 )
	Lobby.Process.ForceAction( f22_local14, f22_local13 )
	Lobby.Process.ForceAction( f22_local17, f22_local16 )
	return f22_local18
end
...
Lobby.Process.LoadMod = function ( f50_arg0, f50_arg1 )
	...
	f50_local3.probeResult.ugcInfo = f50_arg1
	local f50_local4 = Lobby.Actions.CheckMods( f50_arg0, f50_local3, false )
	local f50_local5 = Lobby.Actions.ErrorPopup( f50_local4 )
	local f50_local6 = Lobby.Actions.CloseSpinner()
	f50_local6.name = f50_local6.name .. "CheckMods"
	local f50_local7 = Lobby.Actions.LoadMod( f50_arg0, f50_local4 )
	local f50_local8 = Lobby.Actions.ErrorPopup( f50_local7 )
	local f50_local9 = Lobby.Actions.CloseSpinner()
	f50_local9.name = f50_local2.name .. "LoadedMod"
	local f50_local10 = {
		head = f50_local0,
		interrupt = Lobby.Interrupt.NONE,
		force = false,
	...
	Lobby.Process.AddActions( f50_local0, f50_local4, f50_local2, f50_local2 )
	Lobby.Process.AddActions( f50_local4, f50_local7, f50_local2, f50_local6 )
	Lobby.Process.AddActions( f50_local7, f50_local1, f50_local2, f50_local9 )
	Lobby.Process.ForceAction( f50_local6, f50_local5 )
	Lobby.Process.ForceAction( f50_local9, f50_local8 )
	return f50_local10
end
...
Lobby.Process.NeedInstallUGC = function ( f51_arg0, f51_arg1 )
	...
	f51_local3.probeResult.ugcInfo = f51_arg1
	local f51_local4 = Lobby.Actions.CheckMods( f51_arg0, f51_local3, false )
	local f51_local5 = Lobby.Actions.ErrorPopup( f51_local4 )
	local f51_local6 = Lobby.Actions.CloseSpinner()
	f51_local6.name = f51_local6.name .. "CheckMods"
	local f51_local7 = Lobby.Actions.SubscribeUGC( f51_arg0, f51_local4 )
	local f51_local8 = Lobby.Actions.ErrorPopup( f51_local7 )
	local f51_local9 = Lobby.Actions.CloseSpinner()
	f51_local9.name = f51_local2.name .. "SubscribeUGC"
	local f51_local10 = Lobby.Actions.InstalledUGC( f51_arg0, f51_local4 )
	local f51_local11 = Lobby.Actions.ErrorPopup( f51_local10 )
	local f51_local12 = Lobby.Actions.CloseSpinner()
	f51_local12.name = f51_local2.name .. "InstalledUGC"
	local f51_local13 = Lobby.Actions.LoadMod( f51_arg0, f51_local4 )
	local f51_local14 = Lobby.Actions.ErrorPopup( f51_local13 )
	local f51_local15 = Lobby.Actions.CloseSpinner()
	f51_local15.name = f51_local2.name .. "LoadedMod"
	local f51_local16 = Engine.GetLobbyNetworkMode()
	if f51_local16 ~= Enum.LobbyNetworkMode.LOBBY_NETWORKMODE_LAN and f51_local16 ~= Enum.LobbyNetworkMode.LOBBY_NETWORKMODE_LIVE then
		f51_local16 = Enum.LobbyNetworkMode.LOBBY_NETWORKMODE_LIVE
	end
	local f51_local17 = Lobby.Process.ReloadPrivateLobby( f51_arg0, f51_local16 )
	local f51_local18 = Lobby.Actions.LobbySettings( f51_arg0, LobbyData.UITargets.UI_MODESELECT )
	local f51_local19 = Lobby.Actions.UpdateUI( f51_arg0, LobbyData.UITargets.UI_MODESELECT )
	local f51_local20 = f51_local17.head
	Lobby.Process.ForceAction( f51_local17.tail, f51_local18 )
	Lobby.Process.ForceAction( f51_local18, f51_local19 )
	local f51_local21 = {
		head = f51_local4,
		interrupt = Lobby.Interrupt.NONE,
		force = false,
	...
	if f51_arg1.waitForInstall then
		f51_local21.head = f51_local0
		Lobby.Process.AddActions( f51_local0, f51_local4, f51_local2, f51_local2 )
	end
	Lobby.Process.AddActions( f51_local4, f51_local7, f51_local2, f51_local6 )
	Lobby.Process.AddActions( f51_local7, f51_local10, f51_local2, f51_local9 )
	Lobby.Process.AddActions( f51_local10, f51_local13, f51_local2, f51_local12 )
	Lobby.Process.AddActions( f51_local13, f51_local1, f51_local2, f51_local15 )
	Lobby.Process.ForceAction( f51_local6, f51_local5 )
	Lobby.Process.ForceAction( f51_local5, f51_local20 )
	Lobby.Process.ForceAction( f51_local9, f51_local8 )
	Lobby.Process.ForceAction( f51_local8, f51_local20 )
	Lobby.Process.ForceAction( f51_local12, f51_local11 )
	Lobby.Process.ForceAction( f51_local11, f51_local20 )
	Lobby.Process.ForceAction( f51_local15, f51_local14 )
	Lobby.Process.ForceAction( f51_local14, f51_local20 )
	return f51_local21
end
