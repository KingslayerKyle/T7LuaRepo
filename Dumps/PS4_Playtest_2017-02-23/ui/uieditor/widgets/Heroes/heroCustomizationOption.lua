...
CoD.heroCustomizationOption.new = function ( menu, controller )
	...
	classifiedIcon:setLeftRight( 0, 1, 2, -2 )
	classifiedIcon:setTopBottom( 0, 1, -2, 2 )
	...
	colorImage:setLeftRight( 0, 1, 0, 0 )
	colorImage:setTopBottom( 0, 0, 0, 128 )
	...
	colorImage:linkToElementModel( self, "color", true, function ( model )
		...
		if modelValue then
			colorImage:setRGB( modelValue )
		end
	end )
	colorImage:linkToElementModel( self, "image", true, function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
			colorImage:setImage( RegisterImage( modelValue ) )
		end
	end )
	...
	itemImage:linkToElementModel( self, "itemExtraCamInfo", true, function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
			itemImage:setupCharacterItemRender( SplitString( ":", modelValue ) )
		end
	end )
	...
	LabelButton:setLeftRight( 0, 0, 5, 158 )
	...
	IconEquipped:setLeftRight( 0, 0, 132, 156 )
	IconEquipped:setTopBottom( 0, 0, 6, 30 )
	...
	classifiedText:setLeftRight( 0, 1, 0, 0 )
	classifiedText:setTopBottom( 0.5, 0.5, -15, 15 )
