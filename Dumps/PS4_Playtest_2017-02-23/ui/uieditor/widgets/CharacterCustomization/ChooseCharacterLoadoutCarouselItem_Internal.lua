...
CoD.ChooseCharacterLoadoutCarouselItem_Internal.new = function ( menu, controller )
	...
	ChooseCharacterLoadoutButtonFooter:setLeftRight( 1, 1, -343, -13 )
	ChooseCharacterLoadoutButtonFooter:setTopBottom( 0.5, 0.5, 317, 366 )
	...
	LUI.OverrideFunction_CallOriginalSecond( self, "close", function ( self )
		...
		self.ChooseCharacterLoadoutButtonFooter:close()
