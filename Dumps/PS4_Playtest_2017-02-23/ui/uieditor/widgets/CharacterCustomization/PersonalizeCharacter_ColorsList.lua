...
CoD.PersonalizeCharacter_ColorsList.new = function ( menu, controller )
	...
	BlackBox:setLeftRight( 0, 0, 0, 291 )
	BlackBox:setTopBottom( 0, 0, 12, 57 )
	...
	FETitleNumBrdr1:setTopBottom( 0.5, 0.5, -353, 353 )
	FETitleNumBrdr1:setAlpha( 0 )
	self:addElement( FETitleNumBrdr1 )
	self.FETitleNumBrdr1 = FETitleNumBrdr1
	
	local colorsList = LUI.UIList.new( menu, controller, 10, 0, nil, true, false, 0, 0, false, false )
	colorsList:makeFocusable()
	colorsList:setLeftRight( 0, 0, 5, 507 )
	colorsList:setTopBottom( 0, 0, 69.5, 539.5 )
	colorsList:setWidgetType( CoD.PersonalizeCharacter_ColorOptionList )
	colorsList:setVerticalCount( 3 )
	colorsList:setSpacing( 10 )
	...
	categoryName:setLeftRight( 0, 0, 8, 500 )
	categoryName:setTopBottom( 0, 0, 30, 60 )
	...
	GrayBoxBackground:setLeftRight( 0.5, 0.5, -261, 0 )
	GrayBoxBackground:setTopBottom( 0, 0, 15, 63 )
