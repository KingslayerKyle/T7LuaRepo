...
CoD.ChooseCharacterLoadout_CardBack_Stats.new = function ( menu, controller )
	...
	weaponHeaderBar:setLeftRight( 0, 1, 7, -383 )
	weaponHeaderBar:setTopBottom( 0, 0, 185, 227 )
	...
	abilityHeaderBard:setLeftRight( 0, 1, 383, -7 )
	abilityHeaderBard:setTopBottom( 0, 0, 185, 227 )
	...
	weaponName:setLeftRight( 0, 1, 7, -383 )
	weaponName:setTopBottom( 0, 0, 191, 221 )
	...
	weaponName:linkToElementModel( self, "weaponName", true, function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
			weaponName:setText( LocalizeToUpperString( modelValue ) )
		end
	end )
	...
	abilityName:setLeftRight( 0, 1, 383, -7 )
	abilityName:setTopBottom( 0, 0, 191, 221 )
	...
	abilityName:linkToElementModel( self, "abilityName", true, function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
			abilityName:setText( LocalizeToUpperString( modelValue ) )
		end
	end )
	...
	weaponBorder:setLeftRight( 0, 1, 8, -384 )
	weaponBorder:setTopBottom( 0, 0, 227, 414 )
	...
	abilityBorder:setLeftRight( 0, 1, 383, -7 )
	abilityBorder:setTopBottom( 0, 0, 227, 414 )
	...
	weaponKeyline:setLeftRight( 0, 1, 9, -385 )
	weaponKeyline:setTopBottom( 0, 0, 301, 303 )
	...
	abilityKeyline:setLeftRight( 0, 1, 384, -8 )
	abilityKeyline:setTopBottom( 0, 0, 301, 303 )
	...
	weaponKillsLabel:setLeftRight( 0, 1, 9, -381 )
	weaponKillsLabel:setTopBottom( 0, 0, 279, 300 )
	...
	abilityKillsLabel:setLeftRight( 0, 1, 383, -7 )
	abilityKillsLabel:setTopBottom( 0, 0, 279, 300 )
	...
	abilityKillsLabel:linkToElementModel( self, "abilityKillsLabel", true, function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
			abilityKillsLabel:setText( Engine.Localize( modelValue ) )
		end
	end )
	...
	weaponKills:setLeftRight( 0, 1, 7, -383 )
	weaponKills:setTopBottom( 0, 0, 235, 274 )
	...
	weaponKills:linkToElementModel( self, "weaponKills", true, function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
			weaponKills:setText( modelValue )
		end
	end )
	...
	abilityKills:setLeftRight( 0, 1, 383, -7 )
	abilityKills:setTopBottom( 0, 0, 235, 274 )
	...
	abilityKills:linkToElementModel( self, "abilityKills", true, function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
			abilityKills:setText( modelValue )
		end
	end )
	...
	weaponKillsPerUseLAbel:setLeftRight( 0, 1, 9, -381 )
	weaponKillsPerUseLAbel:setTopBottom( 0, 0, 310, 331 )
	...
	abilityKillsPerUseLabel:setLeftRight( 0, 1, 384, -6 )
	abilityKillsPerUseLabel:setTopBottom( 0, 0, 310, 331 )
	...
	abilityKillsPerUseLabel:linkToElementModel( self, "abilityKillsPerUseLabel", true, function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
			abilityKillsPerUseLabel:setText( Engine.Localize( modelValue ) )
		end
	end )
	...
	weaponKillsPerUse:setLeftRight( 0, 1, 9, -381 )
	weaponKillsPerUse:setTopBottom( 0, 0, 337, 376 )
	...
	weaponKillsPerUse:linkToElementModel( self, "weaponKillsPerUse", true, function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
			weaponKillsPerUse:setText( modelValue )
		end
	end )
	...
	abilityKillsPerUse:setLeftRight( 0, 1, 384, -6 )
	abilityKillsPerUse:setTopBottom( 0, 0, 337, 376 )
	...
	abilityKillsPerUse:linkToElementModel( self, "abilityKillsPerUse", true, function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
			abilityKillsPerUse:setText( modelValue )
		end
	end )
	self:addElement( abilityKillsPerUse )
	self.abilityKillsPerUse = abilityKillsPerUse
	
	local weaponKDKeyline = LUI.UIImage.new()
	weaponKDKeyline:setLeftRight( 0, 1, 9, -385 )
	weaponKDKeyline:setTopBottom( 0, 0, 379, 381 )
	weaponKDKeyline:setRGB( 0.82, 0.98, 1 )
	weaponKDKeyline:setAlpha( 0.7 )
	self:addElement( weaponKDKeyline )
	self.weaponKDKeyline = weaponKDKeyline
	
	local TextBox0 = LUI.UIText.new()
	TextBox0:setLeftRight( 0, 1, 9, -381 )
	TextBox0:setTopBottom( 0, 0, 385, 406 )
	TextBox0:setRGB( 0.82, 0.98, 1 )
	TextBox0:setTTF( "fonts/default.ttf" )
	TextBox0:setAlignment( Enum.LUIAlignment.LUI_ALIGNMENT_CENTER )
	TextBox0:setAlignment( Enum.LUIAlignment.LUI_ALIGNMENT_TOP )
	TextBox0:linkToElementModel( self, "weaponKillsPerDeath", true, function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
			TextBox0:setText( LocalizeIntoString( "MENU_KD_N", modelValue ) )
		end
	end )
	...
	LUI.OverrideFunction_CallOriginalSecond( self, "close", function ( self )
		...
		self.TabBar3:close()
		self.weaponHeaderBar:close()
		self.abilityHeaderBard:close()
		self.weaponBorder:close()
		self.abilityBorder:close()
		self.face:close()
		self.name:close()
		self.gender:close()
		self.index:close()
		...
		self.abilityKillsLabel:close()
		self.weaponKills:close()
		self.abilityKills:close()
		self.abilityKillsPerUseLabel:close()
		self.weaponKillsPerUse:close()
		self.abilityKillsPerUse:close()
		self.TextBox0:close()
	end )
