...
CoD.ChooseTaunts_GestureOptions.new = function ( menu, controller )
	...
	categoryName:linkToElementModel( self, "categoryName", true, function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
			categoryName:setText( LocalizeIntoString( "HEROES_X_GESTURES", modelValue ) )
		end
	end )
	...
	ChooseTauntsGestureOptionInfo0:setLeftRight( 0, 0, 354, 926 )
	ChooseTauntsGestureOptionInfo0:setTopBottom( 0, 0, 37.5, 88.5 )
	...
	LUI.OverrideFunction_CallOriginalSecond( self, "close", function ( self )
		...
		self.ChooseTauntsGestureOptionInfo0:close()
