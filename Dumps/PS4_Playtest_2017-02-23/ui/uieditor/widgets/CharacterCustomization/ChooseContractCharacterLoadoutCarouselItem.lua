...
CoD.ChooseContractCharacterLoadoutCarouselItem.new = function ( menu, controller )
	...
	item.ChooseCharacterLoadoutCardFrontBackOfCardOnlyFooter0:setAlpha( HideIfInPermanentUnlockMenu( 1 ) )
	...
	self.clipsPerState = {
		DefaultState = {
			DefaultClip = function ()
				...
				item.ChooseCharacterLoadoutCardFrontBackOfCardOnlyFooter0:completeAnimation()
				self.item:setLeftRight( 0, 1, 0, 0 )
				self.item:setTopBottom( 0, 1, 30, -30 )
				self.item.characterWithBackground:setAlpha( 0 )
				self.item.unlockSliverRender:setAlpha( 1 )
				self.item.lockImage:setAlpha( 0 )
				self.item.ChooseCharacterLoadoutCardFrontBackOfCardOnlyFooter0:setAlpha( HideIfInPermanentUnlockMenu( 0 ) )
			...
			Over = function ()
				...
				self.clipFinished( item, {} )
				FocusBarB0:completeAnimation()
				self.FocusBarB0:setLeftRight( 0.5, 0.5, -45.5, 45.5 )
				self.FocusBarB0:setTopBottom( 0.5, 0.5, 221, 217 )
				self.FocusBarB0:setAlpha( 1 )
				self.clipFinished( FocusBarB0, {} )
				FocusBarB00:completeAnimation()
				self.FocusBarB00:setLeftRight( 0.5, 0.5, -45.5, 45.5 )
				self.FocusBarB00:setTopBottom( 0.5, 0.5, -217, -221 )
