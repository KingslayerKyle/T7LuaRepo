...
CoD.Leaderboard_GameModeTabItem.new = function ( menu, controller )
	...
	FETabFocus:setLeftRight( 0, 1, -3, 3 )
	FETabFocus:setTopBottom( 0, 1, -8, 8 )
	...
	FETabFocus:setShaderVector( 0, 0, 0, 0.42, 0.33 )
	FETabFocus:setupNineSliceShader( 144, 36 )
	self:addElement( FETabFocus )
	self.FETabFocus = FETabFocus
	
	local FETabIdle = LUI.UIImage.new()
	FETabIdle:setLeftRight( 0, 1, -2, 2 )
	FETabIdle:setTopBottom( 0, 1, -3, 3 )
	...
	Glow2:setLeftRight( 0, 1, -124, 156 )
	Glow2:setTopBottom( 0, 0, -35, 87 )
	...
	text:setLeftRight( 0.5, 0.5, -150, 150 )
	text:setTopBottom( 0.5, 0.5, -14, 18 )
	text:setAlpha( 0.7 )
	...
	textDark:setLeftRight( 0.5, 0.5, -150, 150 )
	textDark:setTopBottom( 0.5, 0.5, -14, 18 )
	textDark:setRGB( 0, 0, 0 )
	textDark:setAlpha( 0 )
	textDark:setTTF( "fonts/escom.ttf" )
	textDark:setMaterial( LUI.UIImage.GetCachedMaterial( "uie_font_cached_glow" ) )
	...
	glitch:setLeftRight( 0, 1, 0, 0 )
	glitch:setTopBottom( 0, 1, 0, 0 )
	...
	glitch2:setLeftRight( 0, 1, 0, 0 )
	glitch2:setTopBottom( 0, 1, 0, 0 )
	...
	buttonText:setLeftRight( 0, 1, 6, -6 )
	buttonText:setTopBottom( 0.5, 0.5, -21, 23 )
	...
	local newBreadcrumb = CoD.NewBreadcrumb.new( menu, controller )
	newBreadcrumb:setLeftRight( 0, 0, 309, 339 )
	newBreadcrumb:setTopBottom( 0, 0, -9, 21 )
	newBreadcrumb:setAlpha( 0 )
	newBreadcrumb:linkToElementModel( self, nil, false, function ( model )
		newBreadcrumb:setModel( model, controller )
	end )
	...
	self.clipsPerState = {
		DefaultState = {
			...
			LoseActive = function ()
				...
				self.FETabFocus:setAlpha( 1 )
				FETabFocusFrame2( FETabFocus, {} )
				local FETabIdleFrame2 = function ( FETabIdle, event )
					local FETabIdleFrame3 = function ( FETabIdle, event )
						if not event.interrupted then
							FETabIdle:beginAnimation( "keyframe", 19, false, false, CoD.TweenType.Linear )
						end
						FETabIdle:setAlpha( 1 )
						if event.interrupted then
							self.clipFinished( FETabIdle, event )
						else
							FETabIdle:registerEventHandler( "transition_complete_keyframe", self.clipFinished )
						end
					end
					
					if event.interrupted then
						FETabIdleFrame3( FETabIdle, event )
						return 
					else
						FETabIdle:beginAnimation( "keyframe", 50, false, false, CoD.TweenType.Linear )
						FETabIdle:registerEventHandler( "transition_complete_keyframe", FETabIdleFrame3 )
					end
				end
				
				FETabIdle:completeAnimation()
				self.FETabIdle:setAlpha( 0 )
				FETabIdleFrame2( FETabIdle, {} )
				local Glow2Frame2 = function ( Glow2, event )
	...
	self:mergeStateConditions( {
		...
		},
		{
			...
			condition = function ( menu, element, event )
				local f137_local0 = ShouldDisplayButton( element, controller )
				if f137_local0 then
		...
		{
			stateName = "Breadcrumb",
			condition = function ( menu, element, event )
				return IsCurrentMenu( menu, "chooseClass" ) and ShowCACExtraClassBreadcrumb( controller )
			end
		}
	} )
