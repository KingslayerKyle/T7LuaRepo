...
CoD.GunsmithRemoveButton.new = function ( menu, controller )
	...
	itemHintText:setLeftRight( 0, 0, -75, 21 )
	...
	self.clipsPerState = {
		DefaultState = {
			DefaultClip = function ()
				...
				itemHintText:completeAnimation()
				self.itemHintText:setLeftRight( 0, 0, -84, 22 )
				self.itemHintText:setTopBottom( 1, 1, 0, 45 )
		...
		Visible = {
			...
			Over = function ()
				...
				self.clipFinished( RemoveIcon, {} )
				itemHintText:completeAnimation()
				self.itemHintText:setLeftRight( 0, 0, -84, 24 )
				self.itemHintText:setTopBottom( 1, 1, 3, 48 )
			...
			GainOver = function ()
				...
				itemHintText:completeAnimation()
				self.itemHintText:setLeftRight( 0, 0, -84.5, 20.5 )
				self.itemHintText:setTopBottom( 1, 1, 0, 45 )
				self.clipFinished( itemHintText, {} )
			end,
			LoseOver = function ()
