...
CoD.CombatRecordMedalButton.new = function ( menu, controller )
	...
	backing:setLeftRight( 0.5, 0.5, -92, 91 )
	backing:setTopBottom( 0, 0, 21, 204 )
	...
	image:setLeftRight( 0.5, 0.5, -86, 82 )
	image:setTopBottom( 0, 0, 28, 196 )
	image:setAlpha( 0.75 )
	...
	name:setLeftRight( 0, 0, 4, 100 )
	name:setTopBottom( 1, 1, -33, -5 )
	name:linkToElementModel( self, "name", true, function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
			name.name:setText( Engine.Localize( modelValue ) )
		end
	end )
	...
	self.clipsPerState = {
		...
		Arabic = {
			DefaultClip = function ()
				...
				name:completeAnimation()
				self.name:setLeftRight( 0, 0, 8, 272 )
				self.name:setTopBottom( 1, 1, -33, -5 )
				self.clipFinished( name, {} )
				TimesEarned:completeAnimation()
				self.TimesEarned:setLeftRight( 0, 0, 223, 272 )
