...
CoD.CombatRecordItemButton.new = function ( menu, controller )
	...
	WeaponImage:setLeftRight( 0.5, 0.5, -212, 213 )
	WeaponImage:setTopBottom( 0, 0, 27, 211 )
	self:addElement( WeaponImage )
	self.WeaponImage = WeaponImage
	
	local ItemImage = LUI.UIImage.new()
	ItemImage:setLeftRight( 0.5, 0.5, -92, 93 )
	ItemImage:setTopBottom( 0, 0, 27, 211 )
	self:addElement( ItemImage )
	self.ItemImage = ItemImage
	
	local GameModeImage2 = LUI.UIImage.new()
	GameModeImage2:setLeftRight( 0, 1, 104, -112 )
	GameModeImage2:setTopBottom( 0, 1, 74, -70 )
	...
	ButtonTitleBG:setTopBottom( 0, 0, 6, 41 )
	...
	ButtonTitle:setLeftRight( 0, 1, 16.5, -7.5 )
	ButtonTitle:setTopBottom( 0, 0, 8, 38 )
	...
	Image0:setLeftRight( 0, 1, 550, -550 )
	Image0:setTopBottom( 1, 1, -40, -28 )
	...
	ButtonTitle0:setLeftRight( 0, 1, 12, -12 )
	ButtonTitle0:setTopBottom( 1, 1, -35, -5 )
	ButtonTitle0:setRGB( 0.93, 0.74, 0.29 )
	ButtonTitle0:setText( LocalizeToUpperString( "MENU_DEADLIEST_WEAPON" ) )
