...
CoD.Social_Options_Slider.new = function ( menu, controller )
	...
	Socialbackground000:setLeftRight( 0, 0, 501, 805 )
	Socialbackground000:setTopBottom( 0, 0, 5, 95 )
	...
	Socialbackground00:setLeftRight( 0, 0, 62, 494 )
	Socialbackground00:setTopBottom( 0, 0, 5, 95 )
	self:addElement( Socialbackground00 )
	self.Socialbackground00 = Socialbackground00
	
	local Title = LUI.UIText.new()
	Title:setLeftRight( 0, 0, 153, 481 )
	Title:setTopBottom( 0, 0, 36, 64 )
	...
	Slider:setLeftRight( 0, 0, 527, 779 )
	Slider:setTopBottom( 0, 0, 27, 72 )
	Slider:setWidgetType( CoD.StartMenu_Options_Slider_Control_Item )
	self:addElement( Slider )
	self.Slider = Slider
	
	local Icon = LUI.UIImage.new()
	Icon:setLeftRight( 0, 0, 74, 139 )
	Icon:setTopBottom( 0, 0, 18, 82 )
	self:addElement( Icon )
	self.Icon = Icon
	
	local pixel1 = LUI.UIImage.new()
	pixel1:setLeftRight( 1, 1, -950, -937 )
	pixel1:setTopBottom( 0, 0, -2, 11 )
	...
	pixel00:setLeftRight( 1, 1, -950, -937 )
	pixel00:setTopBottom( 1, 1, -13, 0 )
	...
	pixel10:setLeftRight( 1, 1, -518, -505 )
	pixel10:setTopBottom( 0, 0, -2, 11 )
	...
	pixel000:setLeftRight( 1, 1, -518, -505 )
	pixel000:setTopBottom( 1, 1, -13, 0 )
	...
	FocusBarT:setLeftRight( 0, 1, 59, -509 )
	FocusBarT:setTopBottom( 0, 0, 1, 7 )
	...
	FocusBarB:setLeftRight( 0, 1, 59, -509 )
	...
	FocusBorder:setLeftRight( 0, 1, 61, -511 )
	...
	glitch:setLeftRight( 0, 1, 43, -501 )
	glitch:setTopBottom( 0, 0, -6, 14 )
	...
	glitch2:setLeftRight( 0, 1, 49, -499 )
	glitch2:setTopBottom( 1, 1, -15, 7 )
	...
	buttonText:setLeftRight( 0, 1, 501, -201 )
	buttonText:setTopBottom( 0.5, 0.5, -15, 15 )
	...
	self.clipsPerState = {
		DefaultState = {
			...
			GainFocus = function ()
							...
							local FocusBarTFrame5 = function ( FocusBarT, event )
								local FocusBarTFrame6 = function ( FocusBarT, event )
									local FocusBarTFrame7 = function ( FocusBarT, event )
										...
										FocusBarT:setLeftRight( 0, 1, 497, -197 )
										FocusBarT:setTopBottom( 0, 0, 1, 7 )
				...
				FocusBarT:completeAnimation()
				self.FocusBarT:setLeftRight( 0, 1, 497, -197 )
				self.FocusBarT:setTopBottom( 0, 0, 1, 7 )
							...
							local FocusBarBFrame5 = function ( FocusBarB, event )
								local FocusBarBFrame6 = function ( FocusBarB, event )
									local FocusBarBFrame7 = function ( FocusBarB, event )
										...
										FocusBarB:setLeftRight( 0, 1, 497, -197 )
										FocusBarB:setTopBottom( 1, 1, -6, 0 )
				...
				FocusBarB:completeAnimation()
				self.FocusBarB:setLeftRight( 0, 1, 497, -197 )
								...
								local FocusBorderFrame6 = function ( FocusBorder, event )
									local FocusBorderFrame7 = function ( FocusBorder, event )
										local FocusBorderFrame8 = function ( FocusBorder, event )
											...
											FocusBorder:setLeftRight( 0, 1, 500, -200 )
											FocusBorder:setTopBottom( 0, 1, 0, 0 )
											FocusBorder:setAlpha( 0 )
											if event.interrupted then
				...
				FocusBorder:completeAnimation()
				self.FocusBorder:setLeftRight( 0, 1, 500, -200 )
				self.FocusBorder:setTopBottom( 0, 1, 0, 0 )
							...
							local glitchFrame5 = function ( glitch, event )
								local glitchFrame6 = function ( glitch, event )
									local glitchFrame7 = function ( glitch, event )
										...
										glitch:setLeftRight( 0, 1, 487, -189 )
										glitch:setTopBottom( 0, 0, -6, 14 )
										glitch:setAlpha( 0 )
										if event.interrupted then
				...
				glitch:completeAnimation()
				self.glitch:setLeftRight( 0, 1, 487, -189 )
				self.glitch:setTopBottom( 0, 0, -6, 14 )
							...
							local glitch2Frame5 = function ( glitch2, event )
								local glitch2Frame6 = function ( glitch2, event )
									local glitch2Frame7 = function ( glitch2, event )
										...
										glitch2:setLeftRight( 0, 1, 487, -187 )
										glitch2:setTopBottom( 1, 1, -15, 7 )
										glitch2:setAlpha( 0 )
										if event.interrupted then
				...
				glitch2:completeAnimation()
				self.glitch2:setLeftRight( 0, 1, 487, -187 )
				self.glitch2:setTopBottom( 1, 1, -15, 7 )
			...
			Focus = function ()
				...
				glitch:completeAnimation()
				self.glitch:setLeftRight( 0, 1, 482, -190 )
				self.glitch:setTopBottom( 0, 0, -6, 14 )
