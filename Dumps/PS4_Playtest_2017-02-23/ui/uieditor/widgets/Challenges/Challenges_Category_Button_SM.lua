...
CoD.Challenges_Category_Button_SM.new = function ( menu, controller )
	...
	PercentCompleteWidget:setLeftRight( 1, 1, -84, -12 )
	PercentCompleteWidget:setTopBottom( 1, 1, -84, -12 )
	...
	UnlockInstructions:setLeftRight( 0, 1, 9.5, 9.5 )
	UnlockInstructions:setTopBottom( 1, 1, -78, -51 )
