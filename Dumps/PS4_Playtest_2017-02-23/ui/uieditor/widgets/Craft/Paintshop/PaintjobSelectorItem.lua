...
CoD.PaintjobSelectorItem.new = function ( menu, controller )
	...
	FEPanelNoBlur0:setLeftRight( 0, 1, 12, -10 )
	FEPanelNoBlur0:setTopBottom( 0, 1, 126, -4 )
	...
	horizontalScrollingTextBox20pt0:setLeftRight( 0, 0, 12, 152 )
	horizontalScrollingTextBox20pt0:setTopBottom( 0, 0, 126, 158 )
	...
	horizontalScrollingTextBox20pt0:linkToElementModel( self, "paintjobName", true, function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
			horizontalScrollingTextBox20pt0.textBox:setText( GetPaintjobName( modelValue ) )
		end
	end )
	...
	LUI.OverrideFunction_CallOriginalSecond( self, "close", function ( self )
		...
		self.horizontalScrollingTextBox20pt0:close()
