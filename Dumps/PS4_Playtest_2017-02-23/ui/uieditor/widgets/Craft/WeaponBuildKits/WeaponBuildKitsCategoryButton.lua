...
CoD.WeaponBuildKitsCategoryButton.new = function ( menu, controller )
	...
	BoxButtonLrgIdle:setLeftRight( 0, 1, -2, 0 )
	...
	ImageContainer:setLeftRight( 0.5, 0.5, -154.5, 154.5 )
	ImageContainer:setTopBottom( 0.5, 0.5, -154.5, 154.5 )
	...
	StartMenuIdentitySubTitle0:setLeftRight( 0, 0, 7, 385 )
	...
	IconNew:setLeftRight( 0, 0, 205, 303 )
	IconNew:setTopBottom( 0.5, 0.5, 16, 52 )
	...
	breadcrumbCount:setLeftRight( 1, 1, -197.5, -170.5 )
	breadcrumbCount:setTopBottom( 0, 0, 103.5, 130.5 )
	...
	self.ImageContainer:linkToElementModel( self, "categoryImage", true, function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
			ImageContainer.ImageContainer:setImage( RegisterImage( modelValue ) )
		end
	end )
