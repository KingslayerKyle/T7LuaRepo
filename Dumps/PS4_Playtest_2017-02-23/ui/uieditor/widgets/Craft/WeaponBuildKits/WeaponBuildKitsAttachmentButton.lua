	...
	self.clipsPerState = {
		...
		IsEquipped = {
			...
			Focus = function ()
				...
				itemHintText:registerEventHandler( "transition_complete_keyframe", itemHintTextFrame2 )
				local hintArrowFrame2 = function ( hintArrow, event )
					if not event.interrupted then
				...
				hintArrow:registerEventHandler( "transition_complete_keyframe", hintArrowFrame2 )
			end,
			LoseFocus = function ()
				self.resetProperties()
				self:setupElementClipCounter( 7 )
