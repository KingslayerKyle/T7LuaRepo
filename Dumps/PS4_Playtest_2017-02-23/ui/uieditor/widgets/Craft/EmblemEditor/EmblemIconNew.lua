...
CoD.EmblemIconNew.new = function ( menu, controller )
	...
	BoxButtonLrgInactive:setLeftRight( 0, 1, 0, 2 )
	BoxButtonLrgInactive:setTopBottom( 0, 1, 0, 0 )
	self:addElement( BoxButtonLrgInactive )
	self.BoxButtonLrgInactive = BoxButtonLrgInactive
	
	local bgImage = LUI.UIImage.new()
	bgImage:setLeftRight( 0, 1, 2, -2 )
	bgImage:setTopBottom( 0, 1, 2, -2 )
	...
	BMGoldBarMed:setLeftRight( 0, 0, 0, 144 )
	BMGoldBarMed:setTopBottom( 0, 0, 58, 82 )
	...
	blackMarketBrandIcon:setLeftRight( 0.5, 0.5, -47, 47 )
	blackMarketBrandIcon:setTopBottom( 0, 0, 25, 119 )
	...
	drawPaintshop:setLeftRight( 0, 1, 6, -6 )
	drawPaintshop:setTopBottom( 0, 1, 6, -6 )
	...
	self.clipsPerState = {
		...
		BMClassified = {
			DefaultClip = function ()
				...
				self:setupElementClipCounter( 4 )
				BoxButtonLrgInactive:completeAnimation()
				self.BoxButtonLrgInactive:setLeftRight( 0, 1, 0, 0 )
				self.BoxButtonLrgInactive:setTopBottom( 0, 1, 0, 0 )
				self.clipFinished( BoxButtonLrgInactive, {} )
				bgImage:completeAnimation()
				self.bgImage:setLeftRight( 0, 1, 3, -3 )
				self.bgImage:setTopBottom( 0, 1, 3, -3 )
