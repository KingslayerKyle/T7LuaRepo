...
CoD.EmblemBrowseControlsBar.new = function ( menu, controller )
	...
	rightButtonBar:setLeftRight( 1, 1, -584, -66 )
	rightButtonBar:setTopBottom( 1, 1, -54, -4 )
	...
	link:setLeftRight( 0.5, 0.5, -105, 0 )
	link:setTopBottom( 1, 1, -51, -5 )
	...
	group:setLeftRight( 0.5, 0.5, 0, 135 )
	group:setTopBottom( 1, 1, -51, -5 )
	...
	self.resetProperties = function ()
		...
		rightButtonBar.change:setAlpha( 1 )
		rightButtonBar.cut:setAlpha( 1 )
		rightButtonBar.copy:setAlpha( 1 )
		rightButtonBar.new:setAlpha( 1 )
		rightButtonBar.new.label:setText( Engine.Localize( "MENU_EMBLEM_INSERT_LAYER" ) )
		link:setAlpha( 1 )
		link.label:setText( Engine.Localize( "MENU_EMBLEM_LINK_LAYERS" ) )
		group:setLeftRight( 0.5, 0.5, 0, 135 )
	...
	self.clipsPerState = {
		...
		BrowseModeGroupedLayer = {
			DefaultClip = function ()
				...
				self.group:setLeftRight( 0.5, 0.5, -105, 30 )
				self.group:setTopBottom( 1, 1, -51, -5 )
