...
CoD.EmblemEditorColorControls.new = function ( menu, controller )
	...
	rotateText:setLeftRight( 1, 1, -291, -13 )
	rotateText:setTopBottom( 0, 0, 171, 195 )
	...
	rightTriggerButton:setTopBottom( 0, 0, 162, 208 )
	...
	leftTriggerButton:setTopBottom( 0, 0, 162, 208 )
