...
CoD.EmblemItem.new = function ( menu, controller )
	...
	BMGoldBarMed:setLeftRight( 0, 0, 9, 257 )
	BMGoldBarMed:setTopBottom( 0, 0, 63, 93 )
	BMGoldBarMed:setAlpha( 0 )
	self:addElement( BMGoldBarMed )
	self.BMGoldBarMed = BMGoldBarMed
	
	local black = LUI.UIImage.new()
	black:setLeftRight( 0, 0, 264, 264 )
	black:setTopBottom( 0, 0, 129, 162 )
	...
	blackMarketBrandIcon0:setLeftRight( 0.5, 0.5, -47, 49 )
	blackMarketBrandIcon0:setTopBottom( 0, 0, 30, 126 )
	...
	itemImage:linkToElementModel( self, "emblemIndex", true, function ( model )
		...
		if modelValue then
			itemImage:setupEmblemByEmblemIndex( GetEmblemIndexParams( controller, modelValue ) )
		end
	end )
	...
	LabelButton:setLeftRight( 0, 1, 4, -4 )
	...
	itemHintText:setTopBottom( 1, 1, 1, 46 )
	...
	self.clipsPerState = {
		...
		EmptySlot = {
			DefaultClip = function ()
				...
				black:completeAnimation()
				self.black:setLeftRight( 0, 0, 74.5, 191.5 )
				self.black:setTopBottom( 0, 0, 73, 78 )
		...
		BMClassified = {
			DefaultClip = function ()
				...
				self:setupElementClipCounter( 5 )
				bgImage:completeAnimation()
				self.bgImage:setLeftRight( 0, 1, 2, -2 )
				self.bgImage:setTopBottom( 0, 1, 2, -2 )
				...
				black:completeAnimation()
				self.black:setLeftRight( 0, 0, 91, 175 )
				self.black:setTopBottom( 0, 0, 70.5, 84.5 )
			...
			LoseFocus = function ()
				...
				local blackFrame2 = function ( black, event )
					...
					black:setLeftRight( 0, 0, 90.5, 173.5 )
					black:setTopBottom( 0, 0, 70.5, 84.5 )
					black:setAlpha( 1 )
					if event.interrupted then
				...
				black:completeAnimation()
				self.black:setLeftRight( 0, 0, 90.5, 173.5 )
				self.black:setTopBottom( 0, 0, 70.5, 84.5 )
				self.black:setAlpha( 1 )
				blackFrame2( black, {} )
				local blackMarketBrandIcon0Frame2 = function ( blackMarketBrandIcon0, event )
