...
CoD.GunsmithVariantItemND.new = function ( menu, controller )
	...
	local variantOptionsButton = CoD.VariantOptionsButton.new( menu, controller )
	variantOptionsButton:setLeftRight( 0, 0, 126, 156 )
	variantOptionsButton:setTopBottom( 0, 0, 5, 35 )
	variantOptionsButton:setAlpha( 0 )
	variantOptionsButton.itemHintText.textCenterAlign:setText( Engine.Localize( "MENU_GUNSMITH_VARIANT_OPTIONS" ) )
	variantOptionsButton:linkToElementModel( self, nil, false, function ( model )
		variantOptionsButton:setModel( model, controller )
	end )
	self:addElement( variantOptionsButton )
	self.variantOptionsButton = variantOptionsButton
	...
	Panel0:setLeftRight( 0, 1, 6, -6 )
	Panel0:setTopBottom( 0, 1, 126, -6 )
	Panel0:setRGB( 0, 0, 0 )
	Panel0:setAlpha( 0.4 )
	...
	horizontalScrollingTextBox20pt:setLeftRight( 0, 0, 6, 156 )
	horizontalScrollingTextBox20pt:setTopBottom( 0, 0, 126, 159 )
	...
	self.horizontalScrollingTextBox20pt:linkToElementModel( self, "variantName", true, function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
			horizontalScrollingTextBox20pt.textBox:setText( modelValue )
		end
	end )
	...
	self.clipsPerState = {
		DefaultState = {
			...
			GainFocus = function ()
				...
				local variantOptionsButtonFrame2 = function ( variantOptionsButton, event )
					if not event.interrupted then
						variantOptionsButton:beginAnimation( "keyframe", 150, false, false, CoD.TweenType.Linear )
					end
					variantOptionsButton:setAlpha( 1 )
					if event.interrupted then
						self.clipFinished( variantOptionsButton, event )
					else
						variantOptionsButton:registerEventHandler( "transition_complete_keyframe", self.clipFinished )
					end
				end
	...
	LUI.OverrideFunction_CallOriginalSecond( self, "close", function ( self )
		...
		self.variantOptionsButton:close()
		self.Panel0:close()
		self.horizontalScrollingTextBox20pt:close()
