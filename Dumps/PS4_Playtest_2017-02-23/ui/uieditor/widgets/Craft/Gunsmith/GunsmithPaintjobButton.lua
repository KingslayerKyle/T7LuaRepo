...
CoD.GunsmithPaintjobButton.new = function ( menu, controller )
	...
	plusIcon:setLeftRight( 0.5, 0.5, -9, 9 )
	plusIcon:setTopBottom( 0.5, 0.5, -9, 9 )
			...
			condition = function ( menu, element, event )
				...
				if f7_local0 then
					if not IsGamepad( controller ) and not IsSelfModelValueEqualTo( element, controller, "paintjobIndex", 32 ) then
						f7_local0 = not IsSelfModelValueEqualTo( element, controller, "paintjobSlot", 64 )
					else
						f7_local0 = false
					end
				end
	...
	removeButton:setLeftRight( 1, 1, -26, -4 )
	...
	local currentEv = CoD.cac_lock.new( menu, controller )
	currentEv:setLeftRight( 0.5, 0.5, -19, 17 )
	currentEv:setTopBottom( 0.5, 0.5, -24, 24 )
	currentEv:setAlpha( 0 )
	self:addElement( currentEv )
	self.LockIcon = currentEv
