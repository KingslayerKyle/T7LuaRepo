...
CoD.GunsmithAttachmentButton = InheritFrom( LUI.UIElement )
CoD.GunsmithAttachmentButton.new = function ( menu, controller )
	local self = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc( self, controller )
	end
	self:setUseStencil( false )
	self:setClass( CoD.GunsmithAttachmentButton )
	...
	opticIndicator:setLeftRight( 0, 1, 36, -36 )
	opticIndicator:setTopBottom( 1, 1, -44, -26 )
	...
	itemHintText:setTopBottom( 1, 1, 25, 70 )
	...
	hintArrow:setTopBottom( 1, 1, 6.5, 21.5 )
			...
			Focus = function ()
				...
				local itemHintTextFrame2 = function ( itemHintText, event )
					local itemHintTextFrame3 = function ( itemHintText, event )
						if not event.interrupted then
							itemHintText:beginAnimation( "keyframe", 250, false, false, CoD.TweenType.Linear )
						end
						itemHintText:setAlpha( 0 )
						if event.interrupted then
							self.clipFinished( itemHintText, event )
					...
					if event.interrupted then
						...
						itemHintText:beginAnimation( "keyframe", 1320, false, false, CoD.TweenType.Linear )
						itemHintText:setAlpha( 0.9 )
				...
				local hintArrowFrame2 = function ( hintArrow, event )
					local hintArrowFrame3 = function ( hintArrow, event )
						if not event.interrupted then
							hintArrow:beginAnimation( "keyframe", 250, false, false, CoD.TweenType.Linear )
						end
						hintArrow:setAlpha( 0 )
						if event.interrupted then
							self.clipFinished( hintArrow, event )
					...
					if event.interrupted then
						...
						hintArrow:beginAnimation( "keyframe", 1320, false, false, CoD.TweenType.Linear )
