...
CoD.FileshareSelectedItemAuthor.new = function ( menu, controller )
	...
	self:setLeftRight( 0, 0, 0, 475 )
	self:setTopBottom( 0, 0, 0, 36 )
	
	local LblAuthor = LUI.UITightText.new()
	LblAuthor:setLeftRight( 0, 0, 0, 93 )
	LblAuthor:setTopBottom( 0, 0, 0, 36 )
	...
	AuthorName:setLeftRight( 0, 0, 96, 480 )
	AuthorName:setTopBottom( 0, 0, 0, 36 )
