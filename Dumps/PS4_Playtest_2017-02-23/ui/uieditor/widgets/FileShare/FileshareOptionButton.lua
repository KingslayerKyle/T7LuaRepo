...
CoD.FileshareOptionButton.new = function ( menu, controller )
	...
	FEButtonPanelShaderContainer:setLeftRight( 0, 1, -16, 12 )
	FEButtonPanelShaderContainer:setTopBottom( 0.5, 0.5, -24, 24 )
	...
	btnDisplayTextStroke:setLeftRight( 0, 0, 54, 426 )
		...
		},
		{
			...
			condition = function ( menu, element, event )
				...
				if not IsDisabled( element, controller ) then
					f89_local0 = IsCurrentLanguageArabic()
				else
					f89_local0 = false
				end
				return f89_local0
