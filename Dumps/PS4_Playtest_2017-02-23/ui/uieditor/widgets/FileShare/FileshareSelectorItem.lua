...
CoD.FileshareSelectorItem.new = function ( menu, controller )
	...
	FileImage:setLeftRight( 0, 0, 4, 158 )
	FileImage:setTopBottom( 0, 0, -3, 119 )
	...
	PlusImage:setLeftRight( 0, 0, 33, 129 )
	PlusImage:setTopBottom( 0, 0, 17, 113 )
	...
	WCFileshareIconExtraCamRender0:setLeftRight( 0, 0, 0, 158 )
	WCFileshareIconExtraCamRender0:setTopBottom( 0, 0, 2, 156 )
	...
	Panel0:setLeftRight( 0, 1, 5, -7 )
	Panel0:setTopBottom( 0, 1, 129, -3 )
	Panel0:setRGB( 0, 0, 0 )
	Panel0:setAlpha( 0.4 )
	...
	horizontalScrollingTextBox20pt:setLeftRight( 0, 0, 5, 159 )
	horizontalScrollingTextBox20pt:setTopBottom( 0, 0, 129, 159 )
	...
	self.horizontalScrollingTextBox20pt:linkToElementModel( self, "fileName", true, function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
			horizontalScrollingTextBox20pt.textBox:setText( Engine.Localize( modelValue ) )
		end
	end )
