require( "ui.uieditor.widgets.MP.PositionsLoadout.positionLoadoutsSelectedItem_major2" )
require( "ui.uieditor.widgets.MP.PositionsLoadout.SelectionItemCount" )

CoD.positionLoadoutsSelectionItem_major2 = InheritFrom( LUI.UIElement )
CoD.positionLoadoutsSelectionItem_major2.new = function ( menu, controller )
	local self = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc( self, controller )
	end
	self:setUseStencil( false )
	self:setClass( CoD.positionLoadoutsSelectionItem_major2 )
	self.id = "positionLoadoutsSelectionItem_major2"
	self.soundSet = "none"
	...
	local selectedItem = CoD.positionLoadoutsSelectedItem_major2.new( menu, controller )
