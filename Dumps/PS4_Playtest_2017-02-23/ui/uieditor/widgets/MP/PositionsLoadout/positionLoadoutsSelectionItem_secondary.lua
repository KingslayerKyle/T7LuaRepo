...
require( "ui.uieditor.widgets.MP.PositionsLoadout.positionLoadoutsSelectedItem_secondary" )
require( "ui.uieditor.widgets.MP.PositionsLoadout.SelectionItemCount" )

CoD.positionLoadoutsSelectionItem_secondary = InheritFrom( LUI.UIElement )
CoD.positionLoadoutsSelectionItem_secondary.new = function ( menu, controller )
	local self = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc( self, controller )
	end
	self:setUseStencil( false )
	self:setClass( CoD.positionLoadoutsSelectionItem_secondary )
	self.id = "positionLoadoutsSelectionItem_secondary"
	self.soundSet = "none"
	...
	local selectedItem = CoD.positionLoadoutsSelectedItem_secondary.new( menu, controller )
