CoD.positionLoadoutsSelectedItem_secondary = InheritFrom( LUI.UIElement )
CoD.positionLoadoutsSelectedItem_secondary.new = function ( menu, controller )
	local self = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc( self, controller )
	end
	self:setUseStencil( false )
	self:setClass( CoD.positionLoadoutsSelectedItem_secondary )
	self.id = "positionLoadoutsSelectedItem_secondary"
	self.soundSet = "none"
