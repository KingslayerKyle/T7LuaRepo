CoD.positionLoadoutsSelectedItem_gadget3 = InheritFrom( LUI.UIElement )
CoD.positionLoadoutsSelectedItem_gadget3.new = function ( menu, controller )
	local self = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc( self, controller )
	end
	self:setUseStencil( false )
	self:setClass( CoD.positionLoadoutsSelectedItem_gadget3 )
	self.id = "positionLoadoutsSelectedItem_gadget3"
	self.soundSet = "none"
	...
	highlight:setLeftRight( 0, 0, -77, 283 )
	highlight:setTopBottom( 0, 0, -34, 230 )
	highlight:setYRot( 180 )
	highlight:setZRot( -90 )
