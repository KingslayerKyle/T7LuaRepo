CoD.positionLoadoutsSelectedItem_gadget1 = InheritFrom( LUI.UIElement )
CoD.positionLoadoutsSelectedItem_gadget1.new = function ( menu, controller )
	local self = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc( self, controller )
	end
	self:setUseStencil( false )
	self:setClass( CoD.positionLoadoutsSelectedItem_gadget1 )
	self.id = "positionLoadoutsSelectedItem_gadget1"
	self.soundSet = "none"
	...
	highlight:setLeftRight( 0, 0, -159, 201 )
