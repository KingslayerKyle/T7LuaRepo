require( "ui.uieditor.widgets.MP.PositionsLoadout.positionLoadoutsSelectedItem_major1" )
require( "ui.uieditor.widgets.MP.PositionsLoadout.SelectionItemCount" )

CoD.positionLoadoutsSelectionItem_major1 = InheritFrom( LUI.UIElement )
CoD.positionLoadoutsSelectionItem_major1.new = function ( menu, controller )
	local self = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc( self, controller )
	end
	self:setUseStencil( false )
	self:setClass( CoD.positionLoadoutsSelectionItem_major1 )
	self.id = "positionLoadoutsSelectionItem_major1"
	self.soundSet = "none"
	...
	local selectedItem = CoD.positionLoadoutsSelectedItem_major1.new( menu, controller )
