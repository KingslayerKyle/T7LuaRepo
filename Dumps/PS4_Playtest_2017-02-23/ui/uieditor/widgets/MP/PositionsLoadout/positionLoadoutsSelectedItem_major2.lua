CoD.positionLoadoutsSelectedItem_major2 = InheritFrom( LUI.UIElement )
CoD.positionLoadoutsSelectedItem_major2.new = function ( menu, controller )
	local self = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc( self, controller )
	end
	self:setUseStencil( false )
	self:setClass( CoD.positionLoadoutsSelectedItem_major2 )
	self.id = "positionLoadoutsSelectedItem_major2"
	self.soundSet = "none"
	...
	highlight:setLeftRight( 0, 0, -115, 197 )
	highlight:setTopBottom( 0, 0, -82, 194 )
	highlight:setYRot( 180 )
	highlight:setImage( RegisterImage( "uie_menu_loadout_wheel_highlight_large" ) )
