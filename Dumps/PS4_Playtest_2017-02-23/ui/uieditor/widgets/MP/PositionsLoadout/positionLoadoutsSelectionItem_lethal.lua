...
require( "ui.uieditor.widgets.MP.PositionsLoadout.positionLoadoutsSelectedItem_lethal" )
require( "ui.uieditor.widgets.MP.PositionsLoadout.SelectionItemCount" )

CoD.positionLoadoutsSelectionItem_lethal = InheritFrom( LUI.UIElement )
CoD.positionLoadoutsSelectionItem_lethal.new = function ( menu, controller )
	local self = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc( self, controller )
	end
	self:setUseStencil( false )
	self:setClass( CoD.positionLoadoutsSelectionItem_lethal )
	self.id = "positionLoadoutsSelectionItem_lethal"
	self.soundSet = "none"
	...
	local selectedItem = CoD.positionLoadoutsSelectedItem_lethal.new( menu, controller )
