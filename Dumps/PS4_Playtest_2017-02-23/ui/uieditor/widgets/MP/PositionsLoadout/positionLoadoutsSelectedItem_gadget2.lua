CoD.positionLoadoutsSelectedItem_gadget2 = InheritFrom( LUI.UIElement )
CoD.positionLoadoutsSelectedItem_gadget2.new = function ( menu, controller )
	local self = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc( self, controller )
	end
	self:setUseStencil( false )
	self:setClass( CoD.positionLoadoutsSelectedItem_gadget2 )
	self.id = "positionLoadoutsSelectedItem_gadget2"
	self.soundSet = "none"
	...
	highlight:setLeftRight( 0, 0, -119, 241 )
	highlight:setTopBottom( 0, 0, -17, 247 )
	highlight:setYRot( 180 )
	highlight:setZRot( -45 )
