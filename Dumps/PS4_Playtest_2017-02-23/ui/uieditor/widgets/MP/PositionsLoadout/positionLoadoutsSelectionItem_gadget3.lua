require( "ui.uieditor.widgets.MP.PositionsLoadout.positionLoadoutsSelectedItem_gadget3" )
require( "ui.uieditor.widgets.MP.PositionsLoadout.SelectionItemCount" )

CoD.positionLoadoutsSelectionItem_gadget3 = InheritFrom( LUI.UIElement )
CoD.positionLoadoutsSelectionItem_gadget3.new = function ( menu, controller )
	local self = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc( self, controller )
	end
	self:setUseStencil( false )
	self:setClass( CoD.positionLoadoutsSelectionItem_gadget3 )
	self.id = "positionLoadoutsSelectionItem_gadget3"
	self.soundSet = "none"
	...
	local selectedItem = CoD.positionLoadoutsSelectedItem_gadget3.new( menu, controller )
