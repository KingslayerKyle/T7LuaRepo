CoD.EscalationItemSelected_major2 = InheritFrom( LUI.UIElement )
CoD.EscalationItemSelected_major2.new = function ( menu, controller )
	local self = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc( self, controller )
	end
	self:setUseStencil( false )
	self:setClass( CoD.EscalationItemSelected_major2 )
	self.id = "EscalationItemSelected_major2"
	self.soundSet = "none"
