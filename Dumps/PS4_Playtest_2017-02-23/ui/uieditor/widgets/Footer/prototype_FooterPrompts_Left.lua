require( "ui.uieditor.widgets.FooterButtonPromptWithBacking" )

CoD.prototype_FooterPrompts_Left = InheritFrom( LUI.UIElement )
CoD.prototype_FooterPrompts_Left.new = function ( menu, controller )
	...
	self:setClass( CoD.prototype_FooterPrompts_Left )
	self.id = "prototype_FooterPrompts_Left"
	self.soundSet = "default"
	self:setLeftRight( 0, 0, 0, 792 )
	self:setTopBottom( 0, 0, 0, 48 )
	self.anyChildUsesUpdateState = true
	
	local Abtn = CoD.FooterButtonPromptWithBacking.new( menu, controller )
	...
	local Bbtn = CoD.FooterButtonPromptWithBacking.new( menu, controller )
	...
	local Xbtn = CoD.FooterButtonPromptWithBacking.new( menu, controller )
	...
	local OptionsBtn = CoD.FooterButtonPromptWithBacking.new( menu, controller )
	...
	local Ybtn = CoD.FooterButtonPromptWithBacking.new( menu, controller )
	...
	local LTbtn = CoD.FooterButtonPromptWithBacking.new( menu, controller )
	...
	local RTbtn = CoD.FooterButtonPromptWithBacking.new( menu, controller )
	...
	local LeftStick = CoD.FooterButtonPromptWithBacking.new( menu, controller )
