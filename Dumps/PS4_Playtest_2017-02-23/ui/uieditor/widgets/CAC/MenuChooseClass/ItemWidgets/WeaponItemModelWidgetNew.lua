...
CoD.WeaponItemModelWidgetNew.new = function ( menu, controller )
	...
	cacNewTag0:setLeftRight( 1, 1, -29, 1 )
	cacNewTag0:setTopBottom( 0, 0, -1, 29 )
	...
	FocusBorder:setLeftRight( 0, 1, -2, 2 )
	FocusBorder:setTopBottom( 0, 1, -2, 2 )
	...
	if IsPC() then
		removeButton = CoD.RemoveItemButton.new( menu, controller )
		removeButton:setLeftRight( 1, 1, -33, -5 )
		removeButton:setTopBottom( 0, 0, 5, 35 )
		...
		removeButton = LUI.UIElement.createFake()
		self.removeButton = removeButton
	end
	local personalizeButton = nil
	if IsPC() then
		personalizeButton = CoD.PersonalizeButton.new( menu, controller )
		personalizeButton:setLeftRight( 0, 0, 5, 35 )
		personalizeButton:setTopBottom( 0, 0, 6, 36 )
		...
		personalizeButton = LUI.UIElement.createFake()
		self.personalizeButton = personalizeButton
	end
	...
	RestrictedItemWarning:setLeftRight( 0, 0, 0, 194 )
	RestrictedItemWarning:setTopBottom( 0, 0, 13, 180 )
	...
	GridItemUpgradeIconWidget:setLeftRight( 0, 0, 4.5, 31.5 )
	GridItemUpgradeIconWidget:setTopBottom( 0, 0, 4.5, 31.5 )
	...
	self.clipsPerState = {
		...
		Equipped = {
			DefaultClip = function ()
				...
				self.clipFinished( FocusBorder, {} )
				removeButton:completeAnimation()
				self.removeButton:setLeftRight( 1, 1, -24.5, -3.5 )
				self.removeButton:setTopBottom( 0, 0, 4.5, 25.5 )
				self.clipFinished( removeButton, {} )
			end,
			GainFocus = function ()
				self.resetProperties()
				self:setupElementClipCounter( IsPC() and 8 or 7 )
				local BoxButtonLrgInactiveFrame2 = function ( BoxButtonLrgInactive, event )
					if not event.interrupted then
				...
				local removeButtonFrame2 = function ( removeButton, event )
					...
					removeButton:setLeftRight( 1, 1, -24.5, -3.5 )
					removeButton:setTopBottom( 0, 0, 4.5, 25.5 )
			...
			Focus = function ()
				self.resetProperties()
				self:setupElementClipCounter( IsPC() and 6 or 5 )
				BoxButtonLrgInactive:completeAnimation()
				self.BoxButtonLrgInactive:setAlpha( 1 )
		...
		WeaponEquipped = {
			DefaultClip = function ()
				...
				self.clipFinished( FocusBorder, {} )
				removeButton:completeAnimation()
				self.removeButton:setLeftRight( 1, 1, -35, -5 )
				self.removeButton:setTopBottom( 0, 0, 5, 35 )
				self.clipFinished( removeButton, {} )
			end,
			GainFocus = function ()
				self.resetProperties()
				self:setupElementClipCounter( IsPC() and 11 or 9 )
				local BoxButtonLrgInactiveFrame2 = function ( BoxButtonLrgInactive, event )
					if not event.interrupted then
						BoxButtonLrgInactive:beginAnimation( "keyframe", 109, false, false, CoD.TweenType.Linear )
					end
			...
			Focus = function ()
				self.resetProperties()
				self:setupElementClipCounter( IsPC() and 9 or 7 )
				BoxButtonLrgInactive:completeAnimation()
				self.BoxButtonLrgInactive:setAlpha( 1 )
				self.clipFinished( BoxButtonLrgInactive, {} )
				itemImage:completeAnimation()
