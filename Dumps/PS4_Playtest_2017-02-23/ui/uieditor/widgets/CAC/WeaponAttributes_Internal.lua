...
CoD.WeaponAttributes_Internal.new = function ( menu, controller )
	...
	self:setLeftRight( 0, 0, 0, 558 )
	self:setTopBottom( 0, 0, 0, 126 )
	self.anyChildUsesUpdateState = true
	
	local damageLabel = LUI.UITightText.new()
	damageLabel:setLeftRight( 0, 0, 0, 93 )
	damageLabel:setTopBottom( 0, 0, 3, 33 )
	...
	rangeLabel:setLeftRight( 0, 0, 0, 76 )
	rangeLabel:setTopBottom( 0, 0, 33, 63 )
	...
	fireRangeLabel:setLeftRight( 0, 0, 0, 118 )
	fireRangeLabel:setTopBottom( 0, 0, 63, 93 )
	...
	accuracyLabel:setLeftRight( 0, 0, 0, 111 )
	accuracyLabel:setTopBottom( 0, 0, 93, 123 )
	...
	accuracyAttribute:setLeftRight( 0, 0, 132, 552 )
	accuracyAttribute:setTopBottom( 0, 0, 99.5, 120.5 )
	...
	accuracyAttribute:linkToElementModel( self, "accuracy", true, function ( model )
		...
		if modelValue then
			accuracyAttribute.weaponAttribute:setShaderVector( 0, GetWeaponAttributes( controller, CoD.GetVectorComponentFromString( modelValue, 1 ), CoD.GetVectorComponentFromString( modelValue, 2 ), CoD.GetVectorComponentFromString( modelValue, 3 ), CoD.GetVectorComponentFromString( modelValue, 4 ) ) )
		end
	end )
	accuracyAttribute:linkToElementModel( self, "accuracy", true, function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
			accuracyAttribute.attachmentAttribute:setShaderVector( 0, GetWeaponAttributesForAttachment( controller, CoD.GetVectorComponentFromString( modelValue, 1 ), CoD.GetVectorComponentFromString( modelValue, 2 ), CoD.GetVectorComponentFromString( modelValue, 3 ), CoD.GetVectorComponentFromString( modelValue, 4 ) ) )
		end
	end )
	...
	fireRateAttribute:setLeftRight( 0, 0, 132, 552 )
	fireRateAttribute:setTopBottom( 0, 0, 67.5, 88.5 )
	...
	fireRateAttribute:linkToElementModel( self, "fireRate", true, function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
			fireRateAttribute.weaponAttribute:setShaderVector( 0, GetWeaponAttributes( controller, CoD.GetVectorComponentFromString( modelValue, 1 ), CoD.GetVectorComponentFromString( modelValue, 2 ), CoD.GetVectorComponentFromString( modelValue, 3 ), CoD.GetVectorComponentFromString( modelValue, 4 ) ) )
		end
	end )
	fireRateAttribute:linkToElementModel( self, "fireRate", true, function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
			fireRateAttribute.attachmentAttribute:setShaderVector( 0, GetWeaponAttributesForAttachment( controller, CoD.GetVectorComponentFromString( modelValue, 1 ), CoD.GetVectorComponentFromString( modelValue, 2 ), CoD.GetVectorComponentFromString( modelValue, 3 ), CoD.GetVectorComponentFromString( modelValue, 4 ) ) )
		end
	end )
	...
	rangeAttribute:setLeftRight( 0, 0, 132, 552 )
	rangeAttribute:setTopBottom( 0, 0, 37.5, 58.5 )
	...
	rangeAttribute:linkToElementModel( self, "range", true, function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
			rangeAttribute.weaponAttribute:setShaderVector( 0, GetWeaponAttributes( controller, CoD.GetVectorComponentFromString( modelValue, 1 ), CoD.GetVectorComponentFromString( modelValue, 2 ), CoD.GetVectorComponentFromString( modelValue, 3 ), CoD.GetVectorComponentFromString( modelValue, 4 ) ) )
		end
	end )
	rangeAttribute:linkToElementModel( self, "range", true, function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
			rangeAttribute.attachmentAttribute:setShaderVector( 0, GetWeaponAttributesForAttachment( controller, CoD.GetVectorComponentFromString( modelValue, 1 ), CoD.GetVectorComponentFromString( modelValue, 2 ), CoD.GetVectorComponentFromString( modelValue, 3 ), CoD.GetVectorComponentFromString( modelValue, 4 ) ) )
		end
	end )
	...
	damageAttribute:setLeftRight( 0, 0, 132, 552 )
	damageAttribute:setTopBottom( 0, 0, 5.5, 26.5 )
	...
	damageAttribute:linkToElementModel( self, "damage", true, function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
			damageAttribute.weaponAttribute:setShaderVector( 0, GetWeaponAttributes( controller, CoD.GetVectorComponentFromString( modelValue, 1 ), CoD.GetVectorComponentFromString( modelValue, 2 ), CoD.GetVectorComponentFromString( modelValue, 3 ), CoD.GetVectorComponentFromString( modelValue, 4 ) ) )
		end
	end )
	damageAttribute:linkToElementModel( self, "damage", true, function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
			damageAttribute.attachmentAttribute:setShaderVector( 0, GetWeaponAttributesForAttachment( controller, CoD.GetVectorComponentFromString( modelValue, 1 ), CoD.GetVectorComponentFromString( modelValue, 2 ), CoD.GetVectorComponentFromString( modelValue, 3 ), CoD.GetVectorComponentFromString( modelValue, 4 ) ) )
		end
	end )
	...
	frame:setLeftRight( 0, 0, 298, 562 )
	frame:setTopBottom( 0, 0, -3, 129 )
	frame:setAlpha( 0.5 )
	...
	Pixel1:setLeftRight( 0, 0, 570, 624 )
	Pixel1:setTopBottom( 0, 0, -1, 5 )
	Pixel1:setAlpha( 0.2 )
	Pixel1:setYRot( -180 )
	...
	Pixel2:setLeftRight( 0, 0, 570, 624 )
	Pixel2:setTopBottom( 0, 0, 123, 129 )
	Pixel2:setAlpha( 0.2 )
	Pixel2:setYRot( -180 )
