...
local UpdateTreeModel = function ( controller )
	...
	if CoD.CACUtility.UnlockablesTable then
		...
		if loadoutSlot then
			CoD.perController[controller].weaponCategory = loadoutSlot
			local nodeCount = 1
			for index, model in ipairs( CoD.CACUtility.UnlockablesTable[loadoutSlot] ) do
...
CoD.CybercoreUpgradeTreeWidget.new = function ( menu, controller )
	...
	self:setTopBottom( 0, 0, 0, 1050 )
	self:makeFocusable()
	self.onlyChildrenFocusable = true
	self.anyChildUsesUpdateState = true
	
	local Image0 = LUI.UIImage.new()
	Image0:setLeftRight( 0, 0, 0, 1050 )
	Image0:setTopBottom( 0, 0, 0, 1050 )
	Image0:setAlpha( 0 )
	self:addElement( Image0 )
	self.Image0 = Image0
	
	local nodeLinkLH = CoD.CybercoreNodeLinkWidget.new( menu, controller )
	nodeLinkLH:setLeftRight( 0, 0, 342, 468 )
	nodeLinkLH:setTopBottom( 0, 0, 202, 352 )
	...
	nodeLinkL1:setLeftRight( 0, 0, 219, 384 )
	nodeLinkL1:setTopBottom( 0, 0, 247, 388 )
	...
	nodeLinkL2:setLeftRight( 0, 0, 215, 379 )
	nodeLinkL2:setTopBottom( 0, 0, 458, 601 )
	...
	nodeLinkL3:setLeftRight( 0, 0, 215, 380 )
	nodeLinkL3:setTopBottom( 0, 0, 670, 813 )
	...
	nodeLinkRH:setLeftRight( 0, 0, 534, 702 )
	nodeLinkRH:setTopBottom( 0, 0, 202, 352 )
	...
	nodeLinkR1:setLeftRight( 0, 0, 643, 808 )
	nodeLinkR1:setTopBottom( 0, 0, 247, 388 )
	...
	nodeLinkR2:setLeftRight( 0, 0, 636, 808 )
	nodeLinkR2:setTopBottom( 0, 0, 455, 604 )
	...
	nodeLinkR3:setLeftRight( 0, 0, 641, 806 )
	nodeLinkR3:setTopBottom( 0, 0, 670, 813 )
	...
	abilityL1:setLeftRight( 0, 0, 210, 390 )
	abilityL1:setTopBottom( 0, 0, 333, 513 )
	...
	abilityL2:setLeftRight( 0, 0, 210, 390 )
	abilityL2:setTopBottom( 0, 0, 546, 726 )
	...
	abilityL3:setLeftRight( 0, 0, 210, 390 )
	abilityL3:setTopBottom( 0, 0, 756, 936 )
	...
	abilityR1:setLeftRight( 0, 0, 636, 816 )
	abilityR1:setTopBottom( 0, 0, 333, 513 )
	...
	abilityR2:setLeftRight( 0, 0, 636, 816 )
	abilityR2:setTopBottom( 0, 0, 546, 726 )
	...
	abilityR3:setLeftRight( 0, 0, 636, 816 )
	abilityR3:setTopBottom( 0, 0, 756, 936 )
	...
	abilityRoot:setLeftRight( 0.5, 0.5, -104, 76 )
	abilityRoot:setTopBottom( 0.5, 0.5, -314, -134 )
	...
	rightBranchHeader:setLeftRight( 0, 0, 636, 816 )
	rightBranchHeader:setTopBottom( 0, 0, 250, 298 )
	rightBranchHeader:linkToElementModel( self, "rightBranchHeader", true, function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
			rightBranchHeader.headerText:setText( LocalizeToUpperString( modelValue ) )
		end
	end )
	...
	leftBranchHeader:setLeftRight( 0, 0, 210, 390 )
	leftBranchHeader:setTopBottom( 0, 0, 250, 298 )
	leftBranchHeader:linkToElementModel( self, "leftBranchHeader", true, function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
			leftBranchHeader.headerText:setText( LocalizeToUpperString( modelValue ) )
		end
	end )
