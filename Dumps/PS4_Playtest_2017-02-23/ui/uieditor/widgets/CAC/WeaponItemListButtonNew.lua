...
CoD.WeaponItemListButtonNew.new = function ( menu, controller )
	...
	LabelButtonCount:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				...
				if not IsInPermanentUnlockMenu( controller ) then
					f4_local0 = IsCACWeaponVariantAvailable( element, controller )
				else
					f4_local0 = false
				end
				return f4_local0
	...
	LabelButtonCount:setLeftRight( 1, 1, -180, -24 )
	LabelButtonCount:setTopBottom( 0.5, 0.5, -14, 16 )
	...
	tokenPermanentUnlock:setLeftRight( 1, 1, -62, -14 )
	...
	lockedIcon:setLeftRight( 0, 0, 25, 70 )
	...
	IconNew:setLeftRight( 0, 0, 273, 371 )
	...
	RestrictedItemWarning:setLeftRight( 0, 0, 0, 98 )
	RestrictedItemWarning:setTopBottom( 0, 0, 8, 92 )
	...
	TokenRefundHint:setLeftRight( 1, 1, 15, 297 )
	TokenRefundHint:setTopBottom( 0.5, 0.5, -24, 24 )
	...
	self.clipsPerState = {
		...
		BMClassified = {
			DefaultClip = function ()
				...
				BMGoldBarMed:completeAnimation()
				self.BMGoldBarMed:setLeftRight( 0.5, 0.5, -149, 148 )
				self.BMGoldBarMed:setTopBottom( 0.5, 0.5, -10, 10 )
				self.BMGoldBarMed:setAlpha( 0.9 )
				self.clipFinished( BMGoldBarMed, {} )
				blackMarketBrandIcon:completeAnimation()
				self.blackMarketBrandIcon:setLeftRight( 0.5, 0.5, -35, 34 )
				self.blackMarketBrandIcon:setTopBottom( 0.5, 0.5, -35, 34 )
	...
	self:mergeStateConditions( {
		...
		},
		{
			...
			condition = function ( menu, element, event )
				local f532_local0 = IsInPermanentUnlockMenu( controller )
				if f532_local0 then
					if not IsPermanentlyUnlocked( element, controller ) then
						f532_local0 = HavePermanentUnlockTokens( controller )
						if f532_local0 then
							f532_local0 = IsCACItemPurchased( element, controller )
						end
					else
						f532_local0 = false
					end
