...
CoD.cac_3dTitleContainerNoLoc.new = function ( menu, controller )
	...
	circles:setLeftRight( 0, 0, 117, 261 )
	circles:setTopBottom( 0, 0, 15, 155 )
	circles:setZoom( -40 )
	...
	diaglrg:setLeftRight( 0, 0, 57, 285 )
	diaglrg:setTopBottom( 0, 0, 82, 94 )
	diaglrg:setZRot( 45 )
	...
	diagsm:setLeftRight( 0, 0, 241, 295 )
	diagsm:setTopBottom( 0, 0, 22, 34 )
	diagsm:setZRot( 45 )
	...
	centersquare:setLeftRight( 0, 0, 171, 201 )
	centersquare:setTopBottom( 0, 0, 73, 91 )
	...
	ElemBackB:setLeftRight( 0, 0, 159, 201 )
	ElemBackB:setTopBottom( 0, 0, -8, 172 )
	...
	MenuTitle:setLeftRight( 0, 0, 201, 741 )
	MenuTitle:setTopBottom( 0, 0, 44, 120 )
			...
			Intro = function ()
				...
				local ElemBackBFrame2 = function ( ElemBackB, event )
					...
					if event.interrupted then
						...
						ElemBackB:setLeftRight( 0, 0, 835, 877 )
						ElemBackB:registerEventHandler( "transition_complete_keyframe", ElemBackBFrame3 )
					end
				end
				
				ElemBackB:completeAnimation()
				self.ElemBackB:setLeftRight( 0, 0, 237, 279 )
				self.ElemBackB:setTopBottom( 0, 0, -8, 172 )
