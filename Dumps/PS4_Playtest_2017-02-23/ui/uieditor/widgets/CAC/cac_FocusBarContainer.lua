...
CoD.cac_FocusBarContainer.new = function ( menu, controller )
	...
	FEFocusBarSolid:setLeftRight( 0, 1, 0, 0 )
	FEFocusBarSolid:setTopBottom( 0.5, 0.5, -6, 6 )
	...
	Glow2:setLeftRight( 0, 1, -32, 32 )
	Glow2:setTopBottom( 0, 0, 0, 12 )
	Glow2:setAlpha( 0.69 )
