...
CoD.ItemGridButton.new = function ( menu, controller )
	...
	itemGridButtom:setLeftRight( 0.5, 0.5, -120, 120 )
	itemGridButtom:setTopBottom( 0.5, 0.5, -67.5, 67.5 )
	self:addElement( itemGridButtom )
	self.itemGridButtom = itemGridButtom
	
	local border = CoD.Border.new( menu, controller )
	border:setLeftRight( 0.5, 0.5, -120, 120 )
	border:setTopBottom( 0.5, 0.5, -67.5, 67.5 )
