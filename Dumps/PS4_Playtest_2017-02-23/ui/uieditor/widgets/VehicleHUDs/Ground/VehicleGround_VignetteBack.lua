...
CoD.VehicleGround_VignetteBack.new = function ( menu, controller )
	...
	VignetteLL:setLeftRight( 0, 0, 0, 984 )
	VignetteLL:setTopBottom( 0.5, 0.5, 0, 570 )
	...
	VignetteLR:setLeftRight( 1, 1, -984, 0 )
	VignetteLR:setTopBottom( 0.5, 0.5, 0, 570 )
	...
	VignetteUL:setLeftRight( 0, 0, 0, 984 )
	VignetteUL:setTopBottom( 0.5, 0.5, -570, 0 )
	...
	VignetteUR:setLeftRight( 1, 1, -984, 0 )
	VignetteUR:setTopBottom( 0.5, 0.5, -570, 0 )
