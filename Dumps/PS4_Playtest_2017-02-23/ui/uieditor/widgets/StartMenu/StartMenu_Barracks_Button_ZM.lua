...
CoD.StartMenu_Barracks_Button_ZM.new = function ( menu, controller )
	...
	TotalKills:setLeftRight( 0, 0, 0, 166 )
	...
	RoundsSurvived:setLeftRight( 0, 0, 174, 366 )
	RoundsSurvived:setTopBottom( 0, 0, 564, 656 )
	...
	lockedIcon:setTopBottom( 0, 0, 240, 288 )
	...
	PrestigeMasterTierWidget:setLeftRight( 0.5, 0.5, -147, 157 )
