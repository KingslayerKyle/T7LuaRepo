...
CoD.StartMenu_3dTitle.new = function ( menu, controller )
	...
	FETitleLineU:setTopBottom( 0.5, 0.5, -37, -31 )
	...
	StartMenu3dTitleLabel:setLeftRight( 0, 0, 2, 1517 )
	StartMenu3dTitleLabel:setTopBottom( 0, 0, 0, 76 )
