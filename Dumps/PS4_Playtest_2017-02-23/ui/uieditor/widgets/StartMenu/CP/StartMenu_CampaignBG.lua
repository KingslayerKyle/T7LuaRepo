...
CoD.StartMenu_CampaignBG.new = function ( menu, controller )
	...
	blackimage:setLeftRight( 0, 1, 0, 0 )
	blackimage:setTopBottom( 0, 1, 0, 0 )
	...
	StartMenuCampaignBGTextures:setLeftRight( 0, 1, 0, 0 )
	StartMenuCampaignBGTextures:setTopBottom( 0, 1, 0, 0 )
	...
	LUI.OverrideFunction_CallOriginalSecond( self, "close", function ( self )
		self.StartMenuCampaignBGTextures:close()
	end )
