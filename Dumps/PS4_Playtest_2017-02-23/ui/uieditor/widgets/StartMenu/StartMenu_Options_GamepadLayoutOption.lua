...
local PostLoadFunc = function ( self, controller, menu )
	...
	CoD.Menu.AddButtonCallbackFunction( menu, self, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( self, event )
		local model = self:getModel()
		if model then
...
CoD.StartMenu_Options_GamepadLayoutOption.new = function ( menu, controller )
	...
	actionText:setLeftRight( 0, 0, 12, 297 )
	...
	valueBacking:setLeftRight( 1, 1, -375, -90 )
	valueBacking:setTopBottom( 0, 1, 8, -8 )
	...
	valueText:setLeftRight( 1, 1, -375, -90 )
	valueText:setTopBottom( 0, 0, 11, 49 )
	...
	self.clipsPerState = {
		DefaultState = {
			...
			Focus = function ()
				...
				self.FocusBarB:setTopBottom( 1, 1, -8, 0 )
