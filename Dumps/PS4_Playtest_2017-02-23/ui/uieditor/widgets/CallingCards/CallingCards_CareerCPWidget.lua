...
CoD.CallingCards_CareerCPWidget.new = function ( menu, controller )
	...
	GlowOrangeOver:setLeftRight( 0, 0, 231, 594 )
	GlowOrangeOver:setTopBottom( 0, 0, -229, 147 )
	...
	clouds1:setLeftRight( 0, 0, 0, 720 )
	clouds1:setTopBottom( 0, 0, 1, 180 )
	...
	cloud2:setLeftRight( 0, 0, 0, 720 )
	cloud2:setTopBottom( 0, 0, 1, 180 )
	...
	cloud3:setLeftRight( 0, 0, 0, 720 )
	cloud3:setTopBottom( 0, 0, 1, 181 )
	...
	sword:setLeftRight( 0, 0, 453, 525 )
	sword:setTopBottom( 0, 0, 0, 180 )
	sword:setImage( RegisterImage( "uie_t7_callingcard_careercp_sword" ) )
	self:addElement( sword )
	self.sword = sword
	
	local swordtail = LUI.UIImage.new()
	swordtail:setLeftRight( 0, 0, 493, 562 )
	swordtail:setTopBottom( 0, 0, 0, 78 )
	...
	leafs:setLeftRight( 0, 0, 127, 685 )
	leafs:setTopBottom( 0, 0, 1, 181 )
