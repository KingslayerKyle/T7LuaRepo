...
CoD.CallingCards_ZMHunterWidget.new = function ( menu, controller )
	...
	manDark:setLeftRight( 0, 0, 474, 670 )
	manDark:setTopBottom( 0, 0, 0, 196 )
	...
	manLight:setLeftRight( 0, 0, 474, 670 )
	manLight:setTopBottom( 0, 0, 0, 196 )
	...
	GlowOrangeOver:setLeftRight( 0, 0, 543, 974 )
	GlowOrangeOver:setTopBottom( 0, 0, -80, 307 )
