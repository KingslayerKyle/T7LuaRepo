...
CoD.CallingCards_Perk2Widget.new = function ( menu, controller )
	...
	BG:setLeftRight( 0, 0, -53, 772 )
	BG:setTopBottom( 0, 0, -54, 233 )
	BG:setImage( RegisterImage( "uie_t7_callingcard_perk2_bg" ) )
	self:addElement( BG )
	self.BG = BG
	
	local GlowOrangeOver = LUI.UIImage.new()
	GlowOrangeOver:setLeftRight( 0, 0, 246, 677 )
	GlowOrangeOver:setTopBottom( 0, 0, -204, 465 )
	...
	boat:setLeftRight( 0, 0, 311, 708 )
	boat:setTopBottom( 0, 0, -17, 200 )
	boat:setAlpha( 0.9 )
	...
	sails:setLeftRight( 0, 0, 385, 738 )
	sails:setTopBottom( 0, 0, -54, 233 )
	sails:setImage( RegisterImage( "uie_t7_callingcard_perk2_sails" ) )
	self:addElement( sails )
	self.sails = sails
	
	local GlowOrangeOver0 = LUI.UIImage.new()
	GlowOrangeOver0:setLeftRight( 0, 0, 154, 398 )
	GlowOrangeOver0:setTopBottom( 0, 0, -189, 189 )
	...
	octo:setLeftRight( 0, 0, -52, 772 )
	octo:setTopBottom( 0, 0, -62, 227 )
	octo:setImage( RegisterImage( "uie_t7_callingcard_perk2_octopus" ) )
	self:addElement( octo )
	self.octo = octo
	
	local splash = LUI.UIImage.new()
	splash:setLeftRight( 0, 0, 16, 440 )
	splash:setTopBottom( 0, 0, -35, 254 )
	...
	octoright:setLeftRight( 0, 0, 669, 744 )
	octoright:setTopBottom( 0, 0, 45, 109 )
	...
	octoleft:setLeftRight( 0, 0, 582, 649 )
	octoleft:setTopBottom( 0, 0, -34, 45 )
	...
	self.clipsPerState = {
		DefaultState = {
			DefaultClip = function ()
				...
				boat:completeAnimation()
				self.boat:setLeftRight( 0, 0, 311, 708 )
				self.boat:setTopBottom( 0, 0, -17, 200 )
				self.boat:setZRot( 0 )
				boatFrame2( boat, {} )
