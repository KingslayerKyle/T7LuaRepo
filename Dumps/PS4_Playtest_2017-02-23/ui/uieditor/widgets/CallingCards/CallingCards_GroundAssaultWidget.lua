...
CoD.CallingCards_GroundAssaultWidget.new = function ( menu, controller )
	...
	BackLights:setLeftRight( 0, 0, 0, 720 )
	BackLights:setTopBottom( 0, 0, 0, 180 )
	...
	GlowBlue:setLeftRight( 0, 0, 451, 1295 )
	GlowBlue:setTopBottom( 0, 0, -260, 686 )
	...
	CallingCardsGroundAssaultEyes:setLeftRight( 0, 0, 343, 352 )
	CallingCardsGroundAssaultEyes:setTopBottom( 0, 0, -37, 77 )
	...
	GlowOrange:setLeftRight( 0, 0, -532, 312 )
	GlowOrange:setTopBottom( 0, 0, -443, 503 )
	...
	LUI.OverrideFunction_CallOriginalSecond( self, "close", function ( self )
		self.CallingCardsGroundAssaultEyes:close()
	end )
