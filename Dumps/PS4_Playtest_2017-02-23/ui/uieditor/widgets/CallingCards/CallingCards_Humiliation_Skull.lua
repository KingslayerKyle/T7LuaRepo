...
CoD.CallingCards_Humiliation_Skull.new = function ( menu, controller )
	...
	GlowOrangeOver0:setLeftRight( 0, 0, 151, 167 )
	GlowOrangeOver0:setTopBottom( 0, 0, 31, 63 )
	...
	Image0:setLeftRight( 0, 0, 78, 94 )
	Image0:setTopBottom( 0, 0, 33, 65 )
