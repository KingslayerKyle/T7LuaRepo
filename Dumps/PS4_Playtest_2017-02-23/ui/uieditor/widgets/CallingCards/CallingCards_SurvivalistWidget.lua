...
CoD.CallingCards_SurvivalistWidget.new = function ( menu, controller )
	...
	cloud4:setLeftRight( 0, 0, 285, 555 )
	cloud4:setTopBottom( 0, 0, 0, 108 )
	cloud4:setImage( RegisterImage( "uie_t7_callingcard_survivalist_cloud4" ) )
	self:addElement( cloud4 )
	self.cloud4 = cloud4
	
	local cloud40 = LUI.UIImage.new()
	cloud40:setLeftRight( 0, 0, 316, 586 )
	cloud40:setTopBottom( 0, 0, 0, 108 )
	...
	mountains:setLeftRight( 0, 0, 0, 720 )
	mountains:setTopBottom( 0, 0, 0, 180 )
	...
	cloud10:setLeftRight( 0, 0, 342, 720 )
	cloud10:setTopBottom( 0, 0, 0, 180 )
	cloud10:setAlpha( 0 )
	...
	car:setLeftRight( 0, 0, 135, 414 )
	car:setTopBottom( 0, 0, 74, 180 )
			...
			DefaultClip = function ()
				...
				local cloud4Frame2 = function ( cloud4, event )
					local cloud4Frame3 = function ( cloud4, event )
						...
						cloud4:setLeftRight( 0, 0, 270, 540 )
						cloud4:setTopBottom( 0, 0, 0, 108 )
						cloud4:setAlpha( 0 )
					...
					if event.interrupted then
						...
						cloud4:setLeftRight( 0, 0, 283.49, 553.49 )
						cloud4:registerEventHandler( "transition_complete_keyframe", cloud4Frame3 )
					end
				end
				
				cloud4:completeAnimation()
				self.cloud4:setLeftRight( 0, 0, 316, 586 )
				self.cloud4:setTopBottom( 0, 0, 0, 108 )
				self.cloud4:setAlpha( 1 )
				cloud4Frame2( cloud4, {} )
				local cloud40Frame2 = function ( cloud40, event )
					if not event.interrupted then
						cloud40:beginAnimation( "keyframe", 1549, false, false, CoD.TweenType.Linear )
					end
					cloud40:setAlpha( 1 )
					if event.interrupted then
						self.clipFinished( cloud40, event )
					else
						cloud40:registerEventHandler( "transition_complete_keyframe", self.clipFinished )
					end
				end
				
				cloud40:beginAnimation( "keyframe", 1450, false, false, CoD.TweenType.Linear )
				cloud40:setAlpha( 0 )
				cloud40:registerEventHandler( "transition_complete_keyframe", cloud40Frame2 )
				cloud10:completeAnimation()
							...
							local cloud2Frame5 = function ( cloud2, event )
								local cloud2Frame6 = function ( cloud2, event )
									local cloud2Frame7 = function ( cloud2, event )
										...
										cloud2:setLeftRight( 0, 0, 470, 758 )
										cloud2:setTopBottom( 0, 0, 0, 180 )
				...
				cloud2:completeAnimation()
				self.cloud2:setLeftRight( 0, 0, 470, 758 )
				self.cloud2:setTopBottom( 0, 0, 0, 180 )
						...
						local cloud20Frame4 = function ( cloud20, event )
							local cloud20Frame5 = function ( cloud20, event )
								local cloud20Frame6 = function ( cloud20, event )
									...
									cloud20:setLeftRight( 0, 0, 432, 720 )
									cloud20:setTopBottom( 0, 0, 0, 180 )
									cloud20:setAlpha( 0 )
									if event.interrupted then
				...
				cloud20:completeAnimation()
				self.cloud20:setLeftRight( 0, 0, 432, 720 )
				self.cloud20:setTopBottom( 0, 0, 0, 180 )
				...
				car:completeAnimation()
				self.car:setLeftRight( 0, 0, 135, 414 )
				self.car:setTopBottom( 0, 0, 74, 180 )
				carFrame2( car, {} )
