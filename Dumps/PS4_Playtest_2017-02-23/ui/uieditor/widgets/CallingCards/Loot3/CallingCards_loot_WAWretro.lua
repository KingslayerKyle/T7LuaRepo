...
CoD.CallingCards_loot_WAWretro.new = function ( menu, controller )
	...
	Glow000:setLeftRight( 0, 0, 423, 685 )
	Glow000:setTopBottom( 0, 0, 17, 445 )
	...
	leaf2:setLeftRight( 0, 0, 206, 461 )
	leaf2:setTopBottom( 0, 0, -20, 108 )
	...
	self.clipsPerState = {
		DefaultState = {
			DefaultClip = function ()
				...
				smoke:completeAnimation()
				self.smoke:setLeftRight( 0, 0, -75, 573 )
				self.smoke:setTopBottom( 0, 0, 0, 180 )
				...
				local smoke0Frame2 = function ( smoke0, event )
					local smoke0Frame3 = function ( smoke0, event )
						...
						smoke0:setLeftRight( 0, 0, -81, 567 )
						smoke0:setTopBottom( 0, 0, 0, 180 )
						smoke0:setAlpha( 1 )
						if event.interrupted then
					...
					if event.interrupted then
						...
						smoke0:setLeftRight( 0, 0, -144, 504 )
						smoke0:registerEventHandler( "transition_complete_keyframe", smoke0Frame3 )
					end
				end
				
				smoke0:completeAnimation()
				self.smoke0:setLeftRight( 0, 0, -75, 573 )
				self.smoke0:setTopBottom( 0, 0, 0, 180 )
				...
				leaf1:completeAnimation()
				self.leaf1:setLeftRight( 0, 0, 225, 621 )
				self.leaf1:setTopBottom( 0, 0, -18, 180 )
