...
CoD.CallingCards_loot_Dinosaur.new = function ( menu, controller )
	...
	Glow00:setLeftRight( 0, 0, 80, 884 )
	Glow00:setTopBottom( 0, 0, -123, 123 )
	...
	Dino2:setLeftRight( 0, 0, 0, 720 )
	Dino2:setTopBottom( 0, 0, 0, 180 )
	...
	Dino1:setLeftRight( 0, 0, 0, 720 )
	Dino1:setTopBottom( 0, 0, 0, 180 )
	...
	glow1:setLeftRight( 0, 0, 179, 272 )
	glow1:setTopBottom( 0, 0, 30, 123 )
	glow1:setImage( RegisterImage( "uie_t7_loot_callingcard_dinosaurs_master_ray2" ) )
	self:addElement( glow1 )
	self.glow1 = glow1
	
	local glow2 = LUI.UIImage.new()
	glow2:setLeftRight( 0, 0, 179, 272 )
	glow2:setTopBottom( 0, 0, 30, 123 )
	...
	self.clipsPerState = {
		DefaultState = {
			DefaultClip = function ()
				...
				Dino2:completeAnimation()
				self.Dino2:setLeftRight( 0, 0, 0, 720 )
				self.Dino2:setTopBottom( 0, 0, 0, 180 )
				...
				Dino1:completeAnimation()
				self.Dino1:setLeftRight( 0, 0, 0, 720 )
				self.Dino1:setTopBottom( 0, 0, 0, 180 )
						...
						local glow2Frame4 = function ( glow2, event )
							local glow2Frame5 = function ( glow2, event )
								...
								if event.interrupted then
									...
									glow2:beginAnimation( "keyframe", 289, false, false, CoD.TweenType.Linear )
									glow2:setAlpha( 0.72 )
									glow2:setScale( 1.7 )
