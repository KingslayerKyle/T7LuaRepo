...
CoD.CallingCards_loot_GirlPower.new = function ( menu, controller )
	...
	fire1:setLeftRight( 0, 0, 0, 720 )
	fire1:setTopBottom( 0, 0, 0, 180 )
	...
	fire2:setLeftRight( 0, 0, 0, 720 )
	fire2:setTopBottom( 0, 0, 0, 180 )
	...
	fire3:setLeftRight( 0, 0, 0, 720 )
	fire3:setTopBottom( 0, 0, 0, 180 )
	...
	Image40:setLeftRight( 0, 0, 0, 720 )
	Image40:setTopBottom( 0, 0, 0, 180 )
	...
	Image300:setLeftRight( 0, 0, 0, 720 )
	Image300:setTopBottom( 0, 0, 0, 180 )
	...
	Image4:setLeftRight( 0, 0, 0, 720 )
	Image4:setTopBottom( 0, 0, 0, 180 )
	Image4:setImage( RegisterImage( "uie_t7_loot_callingcard_girlpower_master_wiz2" ) )
	self:addElement( Image4 )
	self.Image4 = Image4
	
	local Image3000 = LUI.UIImage.new()
	Image3000:setLeftRight( 0, 0, 0, 720 )
	Image3000:setTopBottom( 0, 0, 0, 180 )
