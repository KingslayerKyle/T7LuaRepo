...
CoD.CallingCards_GamemodesWidget.new = function ( menu, controller )
	...
	GlowOrangeOver0:setLeftRight( 0, 0, 453, 658 )
	GlowOrangeOver0:setTopBottom( 0, 0, -116, 343 )
	...
	Clouds:setLeftRight( 0, 0, -326, 918 )
	Clouds:setTopBottom( 0, 0, -215, 134 )
	Clouds:setAlpha( 0.6 )
	...
	beard:setLeftRight( 0, 0, 520, 616 )
	beard:setTopBottom( 0, 0, 48, 96 )
	...
	ribbon4:setLeftRight( 0, 0, 540, 720 )
	ribbon4:setTopBottom( 0, 0, 122, 170 )
	...
	ribbon3:setLeftRight( 0, 0, 540, 720 )
	ribbon3:setTopBottom( 0, 0, 110, 158 )
	...
	ribbon2:setLeftRight( 0, 0, 404, 584 )
	ribbon2:setTopBottom( 0, 0, 86, 134 )
	...
	ribbon1:setLeftRight( 0, 0, 375, 555 )
	ribbon1:setTopBottom( 0, 0, 98, 146 )
	...
	swordglow:setLeftRight( 0, 0, 212, 262 )
	swordglow:setTopBottom( 0, 0, -6, 166 )
	...
	self.clipsPerState = {
		DefaultState = {
			DefaultClip = function ()
					...
					local swordglowFrame3 = function ( swordglow, event )
						local swordglowFrame4 = function ( swordglow, event )
							local swordglowFrame5 = function ( swordglow, event )
								...
								swordglow:setLeftRight( 0, 0, 211.5, 290.5 )
								swordglow:setTopBottom( 0, 0, -49, 221 )
				...
				swordglow:completeAnimation()
				self.swordglow:setLeftRight( 0, 0, 211.5, 290.5 )
				self.swordglow:setTopBottom( 0, 0, -49, 221 )
