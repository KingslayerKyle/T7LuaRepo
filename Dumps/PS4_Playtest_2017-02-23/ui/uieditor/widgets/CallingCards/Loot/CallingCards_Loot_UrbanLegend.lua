...
CoD.CallingCards_Loot_UrbanLegend.new = function ( menu, controller )
	...
	beast:setLeftRight( 0, 0, 2, 722 )
	beast:setTopBottom( 0, 0, 0, 180 )
			...
			DefaultClip = function ()
				...
				local dudeFrame2 = function ( dude, event )
					...
					if event.interrupted then
						...
						dude:setLeftRight( 0, 0, 14, 734 )
						dude:registerEventHandler( "transition_complete_keyframe", dudeFrame3 )
					end
				end
				
				dude:completeAnimation()
				self.dude:setLeftRight( 0, 0, 2, 722 )
				self.dude:setTopBottom( 0, 0, 0, 180 )
				...
				Glow:completeAnimation()
				self.Glow:setLeftRight( 0, 0, -689, 324 )
				self.Glow:setTopBottom( 0, 0, -595, 484 )
						...
						local beastFrame4 = function ( beast, event )
							local beastFrame5 = function ( beast, event )
																				...
																				local beastFrame18 = function ( beast, event )
																					local beastFrame19 = function ( beast, event )
																						...
																						if event.interrupted then
																							...
																							beast:setLeftRight( 0, 0, -1.73, 718.27 )
																							beast:setScale( 1.05 )
								...
								if event.interrupted then
									...
									beast:setLeftRight( 0, 0, -0.22, 719.78 )
									beast:setScale( 1.05 )
				...
				beast:completeAnimation()
				self.beast:setLeftRight( 0, 0, 2, 722 )
				self.beast:setTopBottom( 0, 0, 0, 180 )
