...
CoD.CallingCards_Loot_LegendaryAnimals.new = function ( menu, controller )
	...
	Glow:setLeftRight( 0, 0, 70, 567 )
	Glow:setTopBottom( 0, 0, -271, 808 )
	...
	Smoke:setLeftRight( 0, 0, -18, 531 )
	Smoke:setTopBottom( 0, 0, -44, 196 )
	...
	Drago:setLeftRight( 0, 0, 0, 720 )
	Drago:setTopBottom( 0, 0, 0, 180 )
	...
	Glow0:setLeftRight( 0, 0, 495, 507 )
	Glow0:setTopBottom( 0, 0, 6, 32 )
	...
	Clouds:setLeftRight( 0, 0, -406, 838 )
	Clouds:setTopBottom( 0, 0, -272, 77 )
