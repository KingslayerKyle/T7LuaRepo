...
CoD.FindGroupsGridButton.new = function ( menu, controller )
	...
	itemImageLine:setLeftRight( 0, 0, 144, 150 )
	...
	LabelButton:setLeftRight( 0, 0, 157, 375 )
	LabelButton:setTopBottom( 0.5, 0.5, -38, -8 )
	...
	NumFriends:setLeftRight( 0, 0, 157, 375 )
	NumFriends:setTopBottom( 0.5, 0.5, 1, 39 )
	...
	GroupEmblem:setLeftRight( 0, 0, 0, 144 )
	GroupEmblem:setTopBottom( 0, 0, 0, 98 )
	...
	self.NumFriends:linkToElementModel( self, "friendCount", true, function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
			NumFriends:setText( Engine.Localize( modelValue ) )
		end
	end )
