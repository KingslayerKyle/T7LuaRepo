...
CoD.GroupsFriendListButton.new = function ( menu, controller )
	...
	Socialbackground00:setLeftRight( 0, 0, 192, 615 )
	...
	Socialbackground000:setLeftRight( 0, 0, 45, 189 )
	...
	Socialbackground0000:setLeftRight( 0, 0, 0, 44 )
	...
	emblem:setLeftRight( 0, 0, 45, 189 )
	emblem:setTopBottom( 0, 1, 0, 0 )
	self:addElement( emblem )
	self.emblem = emblem
	
	local gamertag = LUI.UIText.new()
	gamertag:setLeftRight( 0, 0, 209, 547 )
	...
	presence:setLeftRight( 0, 0, 206, 602 )
	...
	local invite = CoD.checkboxNoLabel.new( menu, controller )
	invite:setLeftRight( 0, 0, 11.5, 32.5 )
	invite:setTopBottom( 0, 0, 34.5, 55.5 )
	self:addElement( invite )
	self.invite = invite
	...
	self.clipsPerState = {
		DefaultState = {
			DefaultClip = function ()
				...
				Socialbackground00:completeAnimation()
				self.Socialbackground00:setLeftRight( 0, 0, 146, 561 )
				self.Socialbackground00:setTopBottom( 0, 0, 0, 90 )
				self.clipFinished( Socialbackground00, {} )
				Socialbackground000:completeAnimation()
				self.Socialbackground000:setLeftRight( 0, 0, 0, 144 )
				self.Socialbackground000:setTopBottom( 0, 0, 0, 90 )
				self.clipFinished( Socialbackground000, {} )
				emblem:completeAnimation()
				self.emblem:setLeftRight( 0, 0, 0, 144 )
				self.emblem:setTopBottom( 0, 1, 0, 0 )
				self.clipFinished( emblem, {} )
				gamertag:completeAnimation()
				self.gamertag:setLeftRight( 0, 0, 163, 501 )
				self.gamertag:setTopBottom( 0.5, 0.5, -30, 0 )
				...
				presence:completeAnimation()
				self.presence:setLeftRight( 0, 0, 160, 556 )
				self.presence:setTopBottom( 0, 0, 48, 86 )
			...
			Focus = function ()
				...
				self.FocusBarT:setTopBottom( 0, 0, -3, 3 )
				self.FocusBarT:setAlpha( 1 )
				self.clipFinished( FocusBarT, {} )
				FocusBarB:completeAnimation()
				self.FocusBarB:setLeftRight( 0, 1, 0, 0 )
