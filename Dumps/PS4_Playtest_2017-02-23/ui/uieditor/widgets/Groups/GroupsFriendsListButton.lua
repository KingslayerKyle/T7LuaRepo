...
CoD.GroupsFriendsListButton.new = function ( menu, controller )
	...
	GroupsCheckbox:setLeftRight( 0, 0, -27.5, -6.5 )
	GroupsCheckbox:setTopBottom( 0, 0, 32.5, 53.5 )
	...
	self:registerEventHandler( "gain_focus", function ( self, event )
		if self.m_focusable and self.GroupsCheckbox:processEvent( event ) then
			return true
		else
