...
CoD.GroupsCreateButton.new = function ( menu, controller )
	...
	LobbyMemberBackingMask0:setTopBottom( 0.5, 0.5, -49, 49 )
	...
	local LobbyMemberBacking0 = nil
	if IsPC() then
		LobbyMemberBacking0 = CoD.LobbyMemberBacking.new( menu, controller )
		LobbyMemberBacking0:setLeftRight( 0, 1, 0, 0 )
		LobbyMemberBacking0:setTopBottom( 0.5, 0.5, -35, 35 )
		LobbyMemberBacking0:setAlpha( 0 )
		self:addElement( LobbyMemberBacking0 )
		self.LobbyMemberBacking0 = LobbyMemberBacking0
		
	else
		self.LobbyMemberBacking0 = LUI.UIElement.createFake()
	end
	...
	Text:setLeftRight( 0, 0, 76, 543 )
	Text:setTopBottom( 0.5, 0.5, -11, 17 )
	...
	SelectedIcon:setTopBottom( 0.5, 0.5, 0, 12 )
	...
	CustomClassPlusSymbol0:setLeftRight( 0, 0, 14, 62 )
	CustomClassPlusSymbol0:setTopBottom( 0, 0, 12, 60 )
