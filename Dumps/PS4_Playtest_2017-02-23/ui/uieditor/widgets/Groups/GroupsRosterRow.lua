...
CoD.GroupsRosterRow.new = function ( menu, controller )
	...
	gamertag:setLeftRight( 0, 0, 155, 519 )
	...
	MemberStatus:setLeftRight( 0, 0, 439, 519 )
	MemberStatus:setTopBottom( 0, 0, 13, 43 )
	MemberStatus:setRGB( 0.43, 0.54, 1 )
	MemberStatus:setTTF( "fonts/escom.ttf" )
	...
	MemberStatus:linkToElementModel( self, "groupMemberStatus", true, function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
			MemberStatus:setText( Engine.Localize( GroupMemberStatusEnumToString( modelValue ) ) )
		end
	end )
