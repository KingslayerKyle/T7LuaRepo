...
CoD.CodCasterQuickSettingsListButton.new = function ( menu, controller )
	...
	BoxButtonLrgIdle:setLeftRight( 0, 0, 30, 360 )
	...
	Options:setLeftRight( 0, 0, 85, 351 )
	Options:setTopBottom( 0, 0, 6, 39 )
	Options:setTTF( "fonts/RefrigeratorDeluxe-Regular.ttf" )
	self:addElement( Options )
	self.Options = Options
	
	local FocusBarT = CoD.FE_FocusBarContainer.new( menu, controller )
	FocusBarT:setLeftRight( 0, 1, 30, -2 )
	...
	FocusBarB:setLeftRight( 0, 1, 30, -2 )
	...
	Image0000:setLeftRight( 0, 0, -27, -3 )
