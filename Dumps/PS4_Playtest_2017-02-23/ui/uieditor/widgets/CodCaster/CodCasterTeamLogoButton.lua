...
CoD.CodCasterTeamLogoButton.new = function ( menu, controller )
	...
	BoxButtonLrgInactive:setAlpha( 0.75 )
	...
	unfocused:setLeftRight( 0, 1, 0, 0 )
	unfocused:setTopBottom( 0, 1, 0, 0 )
	...
	LabelButton:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				return AlwaysFalse() and IsCACItemBubbleGum( menu, element, controller )
			end
		}
	} )
	...
	LabelButton.Panel:setAlpha( 0.84 )
	...
	alertIcon:setLeftRight( 1, 1, -28, -4 )
	alertIcon:setTopBottom( 0, 0, 4, 28 )
	...
	self.clipsPerState = {
		...
		Disabled = {
			DefaultClip = function ()
				...
				BoxButtonLrgInactiveDiag:completeAnimation()
				self.BoxButtonLrgInactiveDiag:setAlpha( 0.25 )
				self.clipFinished( BoxButtonLrgInactiveDiag, {} )
				BoxButtonLrgInactive:completeAnimation()
				self.BoxButtonLrgInactive:setAlpha( 1 )
				self.clipFinished( BoxButtonLrgInactive, {} )
				unfocused:completeAnimation()
				self.unfocused:setAlpha( 0.5 )
