...
CoD.LootDecryptionFakeImageCycle.new = function ( menu, controller )
	...
	RarityColor5:setLeftRight( 0, 1, -44, 44 )
	RarityColor5:setTopBottom( 0, 1, -35, 41 )
	...
	RarityColor1:setLeftRight( 0, 1, -44, 44 )
	RarityColor1:setTopBottom( 0, 1, -35, 41 )
	...
	RarityColor2:setLeftRight( 0, 1, -44, 44 )
	RarityColor2:setTopBottom( 0, 1, -35, 41 )
	...
	RarityColor3:setLeftRight( 0, 1, -44, 44 )
	RarityColor3:setTopBottom( 0, 1, -35, 41 )
	...
	RarityColor4:setLeftRight( 0, 1, -44, 44 )
	RarityColor4:setTopBottom( 0, 1, -35, 41 )
	...
	FakeImage5:setLeftRight( 0.5, 0.5, -169, 169 )
	FakeImage5:setTopBottom( 0.5, 0.5, -114, 120 )
	...
	FakeImage1:setLeftRight( 0.5, 0.5, -169, 169 )
	FakeImage1:setTopBottom( 0.5, 0.5, -114, 120 )
	...
	FakeImage2:setLeftRight( 0.5, 0.5, -169, 169 )
	FakeImage2:setTopBottom( 0.5, 0.5, -114, 120 )
	...
	FakeImage3:setLeftRight( 0.5, 0.5, -169, 169 )
	FakeImage3:setTopBottom( 0.5, 0.5, -114, 120 )
	...
	FakeImage4:setLeftRight( 0.5, 0.5, -169, 169 )
	FakeImage4:setTopBottom( 0.5, 0.5, -114, 120 )
	...
	self.resetProperties = function ()
		...
		FakeImage4:setAlpha( 1 )
		FakeImage2:setAlpha( 1 )
		FakeImage1:setAlpha( 1 )
		FakeImage3:setAlpha( 1 )
		FakeImage5:setAlpha( 1 )
		RarityColor4:setAlpha( 1 )
		RarityColor3:setAlpha( 0.08 )
		RarityColor2:setAlpha( 0.08 )
	...
	LUI.OverrideFunction_CallOriginalSecond( self, "close", function ( self )
		self.RarityColor5:close()
		self.RarityColor1:close()
		self.RarityColor2:close()
		self.RarityColor3:close()
		self.RarityColor4:close()
		self.FakeImage5:close()
		self.FakeImage1:close()
		self.FakeImage2:close()
		self.FakeImage3:close()
		self.FakeImage4:close()
	end )
