...
CoD.CryptokeyTypeNameInternal.new = function ( menu, controller )
	...
	nameText:setLeftRight( 0.5, 0.5, -150, 150 )
	nameText:setTopBottom( 0, 0, 0, 33 )
	nameText:setText( Engine.Localize( "MPUI_BM_RARE" ) )
	nameText:setTTF( "fonts/escom.ttf" )
	nameText:setMaterial( LUI.UIImage.GetCachedMaterial( "uie_font_cached_glow" ) )
	...
	self:mergeStateConditions( {
		...
		},
		{
			stateName = "Bribe",
			condition = function ( menu, element, event )
				return IsSelfModelValueEqualTo( element, controller, "rarity", "MPUI_BM_BRIBE" )
			end
		}
	} )
