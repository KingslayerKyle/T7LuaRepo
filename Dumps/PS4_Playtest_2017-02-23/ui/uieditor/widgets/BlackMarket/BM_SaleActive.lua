...
CoD.BM_SaleActive.new = function ( menu, controller )
	...
	Label0:setLeftRight( 0, 0, 22, 70 )
	Label0:setTopBottom( 0, 0, 3, 36 )
	...
	bg:setLeftRight( 0, 0, 15, 73 )
	bg:setTopBottom( 0, 0, 5, 63 )
	bg:setImage( RegisterImage( "uie_t7_blackmarket_promo_crossout" ) )
	self:addElement( bg )
	self.bg = bg
	
	local codpointText = LUI.UITightText.new()
	codpointText:setLeftRight( 0, 0, 22, 70 )
	codpointText:setTopBottom( 0, 0, 31, 64 )
	...
	codpointIcon:setTopBottom( 0, 0, 2, 38 )
