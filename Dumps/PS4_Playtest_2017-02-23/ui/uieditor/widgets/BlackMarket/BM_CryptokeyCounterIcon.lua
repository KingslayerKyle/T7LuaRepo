...
CoD.BM_CryptokeyCounterIcon.new = function ( menu, controller )
	...
	Glow:setLeftRight( 0.5, 0.5, -45, 47 )
	Glow:setTopBottom( 0.5, 0.5, -46, 48 )
	Glow:setAlpha( 0 )
	...
	ring:setLeftRight( 0.5, 0.5, -39, 41 )
	ring:setTopBottom( 0.5, 0.5, -39, 41 )
	ring:setAlpha( 0 )
	...
	cryptokey:setLeftRight( 0.5, 0.5, -18, 20 )
	cryptokey:setTopBottom( 0.5, 0.5, -18, 20 )
