...
CoD.systemOverlay_Layout_GenericForeground_Full.new = function ( menu, controller )
	...
	systemOverlayLayoutForegroundVLayout0:setLeftRight( 0, 0, 633, 1825 )
	systemOverlayLayoutForegroundVLayout0:setTopBottom( 0, 0, 63, 483 )
	...
	LUI.OverrideFunction_CallOriginalSecond( self, "close", function ( self )
		self.systemOverlayLayoutForegroundVLayout0:close()
