...
CoD.systemOverlay_Layout_SaveVariant.new = function ( menu, controller )
	...
	description:setLeftRight( 0, 0, 635, 1827 )
	description:setTopBottom( 0, 0, 61, 91 )
	...
	options:setTopBottom( 0, 0, 167, 267 )
	...
	warning:setLeftRight( 0, 0, 632, 1686 )
	warning:setTopBottom( 0, 0, 390, 426 )
