...
CoD.CenterConsoleEntry.new = function ( menu, controller )
	...
	Text1:setLeftRight( 0.5, 0.5, 53, 555 )
	Text1:setTopBottom( 0.5, 0.5, -19.5, 19.5 )
	Text1:setRGB( 1, 0, 0 )
	Text1:setAlpha( 0.9 )
	Text1:linkToElementModel( self, "text1color", true, function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
			Text1.Text:setRGB( ConsoleColorFromIndex( controller, modelValue ) )
		end
	end )
	...
	Icon1:setLeftRight( 0.5, 0.5, 14, 53 )
	Icon1:setTopBottom( 0.5, 0.5, -19.5, 19.5 )
	...
	Text0:setLeftRight( 0.5, 0.5, -516, 14 )
	Text0:setTopBottom( 0.5, 0.5, -19.5, 19.5 )
	Text0:linkToElementModel( self, "text0color", true, function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
			Text0.Text:setRGB( ConsoleColorFromIndex( controller, modelValue ) )
		end
	end )
	...
	Icon0:setLeftRight( 0.5, 0.5, -555, -516 )
	Icon0:setTopBottom( 0.5, 0.5, -19.5, 19.5 )
