...
CoD.Voip_Container.new = function ( menu, controller )
	...
	self.soundSet = "HUD"
	self:setLeftRight( 0, 0, 0, 409 )
	self:setTopBottom( 0, 0, 0, 108 )
	self.anyChildUsesUpdateState = true
	
	local VoipEntry0 = CoD.Voip_Entry.new( menu, controller )
	VoipEntry0:setLeftRight( 0, 0, 0, 410 )
	VoipEntry0:setTopBottom( 0, 0, 0.5, 27.5 )
	...
	VoipEntry1:setLeftRight( 0, 0, 0, 410 )
	VoipEntry1:setTopBottom( 0, 0, 26.5, 53.5 )
	...
	VoipEntry2:setLeftRight( 0, 0, 0, 410 )
	VoipEntry2:setTopBottom( 0, 0, 54.5, 81.5 )
	...
	VoipEntry3:setLeftRight( 0, 0, 0, 410 )
	VoipEntry3:setTopBottom( 0, 0, 80.5, 107.5 )
	...
	self.resetProperties = function ()
		...
		VoipEntry3:setAlpha( 1 )
		VoipEntry2:setAlpha( 1 )
		VoipEntry1:setAlpha( 1 )
		VoipEntry0:setAlpha( 1 )
	end
