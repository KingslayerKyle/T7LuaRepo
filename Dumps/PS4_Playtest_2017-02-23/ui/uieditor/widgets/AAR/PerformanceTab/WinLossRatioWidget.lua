...
CoD.WinLossRatioWidget.new = function ( menu, controller )
	...
	Glow:setLeftRight( 0, 0, -59, 346 )
	Glow:setTopBottom( 0, 0, -59, 346 )
	...
	LossesBg:setLeftRight( 0, 0, 144, 216 )
	LossesBg:setTopBottom( 0, 0, 56, 128 )
	...
	WinsBg:setLeftRight( 0, 0, 72, 144 )
	WinsBg:setTopBottom( 0, 0, 56, 128 )
	...
	WinsAbbr:setLeftRight( 0, 0, 72, 144 )
	WinsAbbr:setTopBottom( 0, 0, 59, 92 )
	...
	TotalWins:setLeftRight( 0, 0, 72, 144 )
	TotalWins:setTopBottom( 0, 0, 92, 125 )
	...
	LossesAbbr:setLeftRight( 0, 0, 144, 216 )
	LossesAbbr:setTopBottom( 0, 0, 59, 92 )
	...
	TotalLosses:setLeftRight( 0, 0, 144, 216 )
	TotalLosses:setTopBottom( 0, 0, 92, 125 )
	...
	WinsRing:setLeftRight( 0, 0, 0, 288 )
	WinsRing:setTopBottom( 0, 0, 0, 288 )
	...
	LossesRing:setLeftRight( 0, 0, 0, 288 )
	LossesRing:setTopBottom( 0, 0, 0, 288 )
	...
	LossesRing:setShaderVector( 4, 0, 0, 0, 0 )
	self:addElement( LossesRing )
	self.LossesRing = LossesRing
	
	local Hex0 = LUI.UIImage.new()
	Hex0:setLeftRight( 0, 0, 76, 212 )
	Hex0:setTopBottom( 0, 0, 134, 257 )
	Hex0:setZRot( 90 )
	...
	WinLossRatio:setLeftRight( 0, 0, 72, 216 )
	WinLossRatio:setTopBottom( 0, 0, 191, 229 )
	...
	RatioLabel:setLeftRight( 0, 0, 72, 216 )
	RatioLabel:setTopBottom( 0, 0, 164, 197 )
