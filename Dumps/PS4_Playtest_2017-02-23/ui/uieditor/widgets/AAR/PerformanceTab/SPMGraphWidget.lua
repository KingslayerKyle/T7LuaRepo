...
CoD.SPMGraphWidget.new = function ( menu, controller )
	...
	LastMatchScore:setTopBottom( 0, 0, 20, 82 )
	...
	SecondLastMatchScore:setLeftRight( 0, 0, 381, 468 )
	SecondLastMatchScore:setTopBottom( 0, 0, 45, 72 )
	...
	SecondLastMatchScore:subscribeToGlobalModel( controller, "AARSPMGraph", "value2Valid", function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
	...
	ThirdLastMatchScore:setLeftRight( 0, 0, 266, 353 )
	ThirdLastMatchScore:setTopBottom( 0, 0, 45, 72 )
	...
	ThirdLastMatchScore:subscribeToGlobalModel( controller, "AARSPMGraph", "value3Valid", function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
	...
	FifthLastMatchScore:setTopBottom( 0, 0, 45, 72 )
	...
	FifthLastMatchScore:subscribeToGlobalModel( controller, "AARSPMGraph", "value5Valid", function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
	...
	Vline4:setLeftRight( 0, 0, 422, 428 )
	...
	Average:setTopBottom( 0, 0, 124, 174 )
	...
	FourthLastMatchScore:setLeftRight( 0, 0, 155, 242 )
	FourthLastMatchScore:setTopBottom( 0, 0, 45, 72 )
	...
	FourthLastMatchScore:subscribeToGlobalModel( controller, "AARSPMGraph", "value4Valid", function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
	...
	MyAverageLabel:setLeftRight( 0, 0, -19, 104 )
	...
	MyAverageLabel0:setLeftRight( 0, 0, 476, 599 )
	MyAverageLabel0:setTopBottom( 0, 0, 5, 26 )
	...
	Segment4:setLeftRight( 0, 0, 82, 204 )
	...
	Segment4:setShaderVector( 3, 0.08, 0.07, 0.04, 0 )
	...
	Segment4:subscribeToGlobalModel( controller, "AARSPMGraph", "graphValue5", function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
	...
	Segment4:subscribeToGlobalModel( controller, "AARSPMGraph", "graphValue4", function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
	...
	Segment3:subscribeToGlobalModel( controller, "AARSPMGraph", "graphValue4", function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
	...
	Segment3:subscribeToGlobalModel( controller, "AARSPMGraph", "graphValue3", function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
	...
	Segment2:setLeftRight( 0, 0, 306, 430 )
	...
	Segment2:subscribeToGlobalModel( controller, "AARSPMGraph", "graphValue3", function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
	...
	Segment2:subscribeToGlobalModel( controller, "AARSPMGraph", "graphValue2", function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
	...
	Segment1:setLeftRight( 0, 0, 420, 542 )
	...
	Segment1:subscribeToGlobalModel( controller, "AARSPMGraph", "graphValue2", function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
	...
	Segment1:subscribeToGlobalModel( controller, "AARSPMGraph", "graphValue1", function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
