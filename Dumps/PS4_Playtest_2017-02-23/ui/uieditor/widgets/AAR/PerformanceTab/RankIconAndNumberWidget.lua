...
CoD.RankIconAndNumberWidget.new = function ( menu, controller )
	...
	self.soundSet = "HUD"
	self:setLeftRight( 0, 0, 0, 130 )
	self:setTopBottom( 0, 0, 0, 60 )
	
	local NextRankIcon = LUI.UIImage.new()
	NextRankIcon:setLeftRight( 0, 0, 0, 61 )
	NextRankIcon:setTopBottom( 0, 0, 0, 60 )
	self:addElement( NextRankIcon )
	self.NextRankIcon = NextRankIcon
	
	local NextRank = LUI.UITightText.new()
	NextRank:setLeftRight( 0, 0, 65, 130 )
	NextRank:setTopBottom( 0, 0, 15, 48 )
