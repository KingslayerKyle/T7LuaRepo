...
CoD.MedalsGridItem.new = function ( menu, controller )
	...
	MedalImageBacking:setLeftRight( 0.5, 0.5, -76, 76 )
	MedalImageBacking:setTopBottom( 0, 0, 35, 187 )
	...
	MedalImage:setLeftRight( 0.5, 0.5, -76, 76 )
	MedalImage:setTopBottom( 0, 0, 35, 187 )
	...
	name:setLeftRight( 0, 0, 5, 119 )
	name:setTopBottom( 1, 1, -33, -5 )
	self:addElement( name )
	self.name = name
	
	local TimesEarned = CoD.PrestigeButton_label.new( menu, controller )
	TimesEarned:setLeftRight( 0, 0, 4, 42 )
	TimesEarned:setTopBottom( 1, 1, -61, -33 )
	TimesEarned:setAlpha( HideIfEmptyString( 1 ) )
	LUI.OverrideFunction_CallOriginalFirst( TimesEarned, "setText", function ( element, text )
	...
	self.name:linkToElementModel( self, "medalIndex", true, function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
			name.name:setText( GetAARMedalName( modelValue ) )
		end
	end )
	self.TimesEarned:linkToElementModel( self, "medalTimesObtained", true, function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
			TimesEarned.name:setText( LocalizeIntoString( "MENU_MULTIPLIER_X", modelValue ) )
		end
	end )
	...
	self.clipsPerState = {
		Arabic = {
			DefaultClip = function ()
				...
				name:completeAnimation()
				self.name:setLeftRight( 0, 0, 5, 261 )
				self.name:setTopBottom( 1, 1, -33, -5 )
				self.clipFinished( name, {} )
				TimesEarned:completeAnimation()
				self.TimesEarned:setLeftRight( 0, 0, 223, 261 )
				self.TimesEarned:setTopBottom( 1, 1, -61, -33 )
