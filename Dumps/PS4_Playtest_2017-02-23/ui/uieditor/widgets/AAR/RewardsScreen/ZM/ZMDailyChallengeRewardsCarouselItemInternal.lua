...
CoD.ZMDailyChallengeRewardsCarouselItemInternal = InheritFrom( LUI.UIElement )
CoD.ZMDailyChallengeRewardsCarouselItemInternal.new = function ( menu, controller )
	local self = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc( self, controller )
	end
	self:setUseStencil( false )
	self:setClass( CoD.ZMDailyChallengeRewardsCarouselItemInternal )
	self.id = "ZMDailyChallengeRewardsCarouselItemInternal"
	self.soundSet = "HUD"
	...
	highlight:setRGB( ColorSet.RewardChallenge.r, ColorSet.RewardChallenge.g, ColorSet.RewardChallenge.b )
	...
	CardImage:setLeftRight( 0, 0, 88, 327 )
	CardImage:setTopBottom( 0, 0, -36, 204 )
	CardImage:setScale( 0.6 )
	CardImage:setImage( RegisterImage( "uie_t7_menu_challenges_complete_icon" ) )
	...
	IndividualRewardItem1.NotificationRewardBorder:setRGB( ColorSet.RewardChallenge.r, ColorSet.RewardChallenge.g, ColorSet.RewardChallenge.b )
	...
	IndividualRewardItem2.NotificationRewardBorder:setRGB( ColorSet.RewardChallenge.r, ColorSet.RewardChallenge.g, ColorSet.RewardChallenge.b )
	...
	IndividualRewardItem3.NotificationRewardBorder:setRGB( ColorSet.RewardChallenge.r, ColorSet.RewardChallenge.g, ColorSet.RewardChallenge.b )
	...
	IndividualRewardItem4.NotificationRewardBorder:setRGB( ColorSet.RewardChallenge.r, ColorSet.RewardChallenge.g, ColorSet.RewardChallenge.b )
	...
	RankUpNotificationFooterBacking:setRGB( ColorSet.RewardChallenge.r, ColorSet.RewardChallenge.g, ColorSet.RewardChallenge.b )
	...
	verticalScrollingTextBox18:setLeftRight( 0.5, 0.5, -175.5, 175.5 )
