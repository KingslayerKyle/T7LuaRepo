...
CoD.AbilityWheel_Texture.new = function ( menu, controller )
	...
	self:setLeftRight( 0, 0, 0, 1200 )
	self:setTopBottom( 0, 0, 0, 804 )
	
	local TextureL = LUI.UIImage.new()
	TextureL:setLeftRight( 0, 0, 0, 600 )
	TextureL:setTopBottom( 0, 0, 0, 804 )
	...
	TextureR:setLeftRight( 0, 0, 600, 1200 )
	TextureR:setTopBottom( 0, 0, 0, 804 )
