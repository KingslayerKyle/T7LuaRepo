...
CoD.StoreFeaturedCenterButton.new = function ( menu, controller )
	...
	itemImage:setLeftRight( 0, 1, 2, -2 )
	itemImage:setTopBottom( 0, 1, 2, -2 )
	...
	productName:setLeftRight( 0, 0, 1, 843 )
	productName:setTopBottom( 1, 1, -42, 0 )
	...
	price:setLeftRight( 1, 1, -121, -3 )
	price:setTopBottom( 0, 0, 3, 31 )
	...
	price:linkToElementModel( self, "price", true, function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
			price.StorePriceLabel.itemName:setText( Engine.Localize( modelValue ) )
		end
	end )
	...
	purchase:setLeftRight( 1, 1, -123, -3 )
	purchase:setTopBottom( 0, 0, 3, 31 )
	purchase:setAlpha( 0 )
	...
	self.clipsPerState = {
		...
		Purchased = {
			DefaultClip = function ()
				...
				self.purchase:setLeftRight( 1, 1, -102, -2 )
				self.purchase:setTopBottom( 0, 0, 2, 30 )
