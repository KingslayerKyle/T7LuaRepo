require( "ui.uieditor.widgets.CPFlow.chooseCompanionButton" )

CoD.lobbyFlyout_CharacterHeadshotRender = InheritFrom( LUI.UIElement )
CoD.lobbyFlyout_CharacterHeadshotRender.new = function ( menu, controller )
	local self = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc( self, controller )
	end
	self:setUseStencil( false )
	self:setClass( CoD.lobbyFlyout_CharacterHeadshotRender )
	self.id = "lobbyFlyout_CharacterHeadshotRender"
	self.soundSet = "none"
	...
	local selectedItem = CoD.chooseCompanionButton.new( menu, controller )
	...
	possibleItemsList:setWidgetType( CoD.chooseCompanionButton )
