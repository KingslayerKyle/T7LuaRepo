...
CoD.LobbySlideEmblemWidget.new = function ( menu, controller )
	...
	pixelU:setTopBottom( 0.5, 0.5, -148, -143 )
	...
	pixelB:setTopBottom( 0.5, 0.5, 145, 150 )
	...
	pixelB0:setLeftRight( 1, 1, -523, -469 )
	pixelB0:setTopBottom( 0.5, 0.5, 145, 150 )
	pixelB0:setZRot( 180 )
	...
	FETitleLineSingle:setTopBottom( 0, 0, 291, 297 )
