...
CoD.LobbyMemberTeamSwitcher.new = function ( menu, controller )
	...
	self:setLeftRight( 0, 0, 0, 244 )
	self:setTopBottom( 0, 0, 0, 37 )
	
	local spectatorColor = LUI.UIImage.new()
	spectatorColor:setLeftRight( 1, 1, -244, 0 )
	...
	TeamSwitchName:setLeftRight( 1, 1, -192, -46 )
	TeamSwitchName:setTopBottom( 0.5, 0.5, -13, 17 )
	...
	leftBumper:setLeftRight( 1, 1, -230, -192 )
	leftBumper:setTopBottom( 0.5, 0.5, -13.5, 13.5 )
	...
	rightBumper:setLeftRight( 1, 1, -47, -9 )
	rightBumper:setTopBottom( 0.5, 0.5, -13.5, 13.5 )
