...
CoD.SearchingForPlayer.new = function ( menu, controller )
	...
	SearchingForPlayer:setLeftRight( 0, 0, 0, 300 )
	...
	Dot4:setLeftRight( 0, 0, 324, 330 )
	Dot4:setTopBottom( 0, 0, 0, 38 )
