...
require( "ui.uieditor.widgets.Lobby.Lists.Members.LobbyMemberListFreeCursorTeamChangeButtons" )
...
CoD.LobbyMemberList.new = function ( menu, controller )
	...
	self:setTopBottom( 0, 0, 0, 1527 )
	self:makeFocusable()
	self.onlyChildrenFocusable = true
	self.anyChildUsesUpdateState = true
	
	local LobbyMemberListFreeCursorTeamChangeButtons = CoD.LobbyMemberListFreeCursorTeamChangeButtons.new( menu, controller )
	LobbyMemberListFreeCursorTeamChangeButtons:setLeftRight( 0, 0, 0, 735 )
	LobbyMemberListFreeCursorTeamChangeButtons:setTopBottom( 0, 0, 0, 40 )
	self:addElement( LobbyMemberListFreeCursorTeamChangeButtons )
	self.LobbyMemberListFreeCursorTeamChangeButtons = LobbyMemberListFreeCursorTeamChangeButtons
	...
	FEListSubHeader1:setTopBottom( 0, 0, 40, 80 )
	...
	lobbyList:setLeftRight( 0, 0, 0, 735 )
	lobbyList:setTopBottom( 0, 0, 93, 847 )
	...
	menu:AddButtonCallbackFunction( lobbyList, controller, Enum.LUIButton.LUI_KEY_XBX_PSSQUARE, "N", function ( element, menu, controller, model )
		...
		if IsLobbyNetworkModeLive() and IsMultiplayer() and AlwaysFalse() then
			CoD.Menu.SetButtonLabel( menu, Enum.LUIButton.LUI_KEY_XBX_PSSQUARE, "MENU_INSPECT_PLAYER", nil )
			return true
		else
			return false
		end
	...
	menu:AddButtonCallbackFunction( lobbyList, controller, Enum.LUIButton.LUI_KEY_LB, "Q", function ( element, menu, controller, model )
		if not IsRepeatButtonPress( model ) and IsLobbyHostOfCurrentMenu() and IsLobbyWithTeamAssignment() and IsTeamAssignment( LuaEnum.TEAM_ASSIGNMENT.HOST ) then
			LobbyTeamSelectionLB( self, element, controller )
			PlaySoundSetSound( self, "team_switch" )
			return true
		elseif not IsRepeatButtonPress( model ) and IsLobbyHost() and IsLobbyBot( element ) then
			LobbyTeamSelectionLB( self, element, controller )
			PlaySoundSetSound( self, "team_switch" )
			return true
		else
	...
	FEListAdditonal0:setTopBottom( 0, 0, 860, 916 )
	...
	FEListHeaderFull0:setTopBottom( 0, 0, 916, 960 )
	...
	spacer:setTopBottom( 0, 0, 960, 963 )
	spacer:setAlpha( 0 )
	...
	FEListSubHeader0:setTopBottom( 0, 0, 963, 1003 )
	...
	friendsAndGroups:setTopBottom( 0, 0, 1012, 1556 )
	...
	LobbyMemberListFreeCursorTeamChangeButtons.navigation = {
		down = lobbyList
	}
	lobbyList.navigation = {
		up = LobbyMemberListFreeCursorTeamChangeButtons,
	...
	LobbyMemberListFreeCursorTeamChangeButtons.id = "LobbyMemberListFreeCursorTeamChangeButtons"
	...
	LUI.OverrideFunction_CallOriginalSecond( self, "close", function ( self )
		self.LobbyMemberListFreeCursorTeamChangeButtons:close()
