...
CoD.Competitive_CharacterDraft_StateIcon.new = function ( menu, controller )
	...
	checkmark:setLeftRight( 0, 0, -8, 47 )
	...
	self.clipsPerState = {
		DefaultState = {
			...
			Choosing = function ()
				...
				Arrow0:completeAnimation()
				self.Arrow0:setLeftRight( 0, 0, 40, 92 )
				...
				Arrow:completeAnimation()
				self.Arrow:setLeftRight( 0, 0, 40, 92 )
