...
local PostLoadFunc = function ( self, controller, menu )
	self.MissionRecordVaultAccolade:linkToElementModel( self, nil, false, function ( model )
		if model then
			local newWidgetType = Engine.GetModelValue( Engine.GetModel( model, "challengeWidget" ) )
			local f2_local0 = CoD
			local f2_local1 = "MissionRecordVault_Accolades"
			local newAccolade = f2_local0["MissionRecordVault_Accolades" .. newWidgetType].new( menu, controller )
			newAccolade:setLeftRight( REG3:getLocalLeftRight() )
			newAccolade:setTopBottom( REG3:getLocalTopBottom() )
			newAccolade:setModel( model, controller )
			newAccolade:addElementBefore( REG3 )
			self.MissionRecordVaultAccolade = newAccolade
			REG3:close()
		end
	end )
end
...
CoD.MissionRecordVault_ChallengeRow.new = function ( menu, controller )
	...
	yellowstar:setLeftRight( 0, 0, 189, 240 )
	yellowstar:setTopBottom( 0, 0, -2, 49 )
	...
	Name:setLeftRight( 0, 1, 14, -12 )
	Name:setTopBottom( 0, 0, 140, 167 )
	...
	MissionRecordVaultAccolade:setLeftRight( 0.5, 0.5, -75, 75 )
	MissionRecordVaultAccolade:setTopBottom( 0, 0, -1, 149 )
