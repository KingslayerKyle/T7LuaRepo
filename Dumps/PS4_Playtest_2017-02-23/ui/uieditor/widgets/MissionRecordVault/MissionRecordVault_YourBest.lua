...
CoD.MissionRecordVault_YourBest.new = function ( menu, controller )
	...
	Image1:setLeftRight( 0, 0, 0, 192 )
	Image1:setTopBottom( 0, 0, 0, 34 )
	Image1:setRGB( 0.68, 0.68, 0.68 )
	self:addElement( Image1 )
	self.Image1 = Image1
	
	local title = LUI.UIText.new()
	title:setLeftRight( 0, 0, 0, 192 )
	title:setTopBottom( 0, 0, 0, 34 )
	title:setRGB( 0, 0, 0 )
	...
	value:setLeftRight( 0, 0, 10, 181 )
	value:setTopBottom( 0, 0, 48, 86 )
	...
	CPFrame0:setLeftRight( 0, 0, 0, 192 )
	CPFrame0:setTopBottom( 0, 0, 0, 96 )
