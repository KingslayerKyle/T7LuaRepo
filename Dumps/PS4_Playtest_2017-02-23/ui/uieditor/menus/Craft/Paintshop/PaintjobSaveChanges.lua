...
LUI.createMenu.PaintjobSaveChanges = function ( controller )
	...
	paintjobNameInput:setLeftRight( 0, 0, 874, 1452 )
	paintjobNameInput:setTopBottom( 0, 0, 456, 526 )
	paintjobNameInput.Text:setAlignment( Enum.LUIAlignment.LUI_ALIGNMENT_CENTER )
	...
	paintjob:setLeftRight( 0, 0, 184, 772 )
	paintjob:setTopBottom( 0, 0, 402, 763 )
	paintjob:setAlpha( 0 )
	...
	save:setLeftRight( 0, 0, 878, 1298 )
	...
	discard:setLeftRight( 0, 0, 878, 1298 )
	discard:setTopBottom( 0, 0, 638, 686 )
	...
	alertStatusBar:setTopBottom( 0, 0, 288, 296 )
	...
	title:setLeftRight( 0, 0, 878, 1178 )
