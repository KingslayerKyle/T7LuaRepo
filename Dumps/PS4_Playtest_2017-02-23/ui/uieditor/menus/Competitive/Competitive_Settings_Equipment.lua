...
local PrepareEquipmentOptions = function ( controller )
	local optionsTable = {}
	local items = {}
	...
	local EquipmentSort = function ( a, b )
		return a.models.name < b.models.name
	end
	
	table.sort( optionsTable, EquipmentSort )
	return optionsTable
end
...
DataSources.CompetitiveSettingsEquipmentOptions = DataSourceHelpers.ListSetup( "CompetitiveSettingsEquipmentOptions", PrepareEquipmentOptions, nil, nil, ItemOptionsUpdate )
