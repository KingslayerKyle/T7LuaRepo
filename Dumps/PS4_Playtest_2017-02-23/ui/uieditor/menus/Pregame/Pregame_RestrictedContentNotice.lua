...
LUI.createMenu.Pregame_RestrictedContentNotice = function ( controller )
	...
	TopBar:setLeftRight( 0, 0, 0, 1920 )
	TopBar:setTopBottom( 0, 0, 122, 126 )
	TopBar:setRGB( 0.97, 0.58, 0.15 )
	self:addElement( TopBar )
	self.TopBar = TopBar
	
	local Title = LUI.UIText.new()
	Title:setLeftRight( 0, 0, 615, 1779 )
	Title:setTopBottom( 0, 0, 152, 222 )
	...
	Description:setLeftRight( 0, 0, 619, 1765 )
	Description:setTopBottom( 0, 0, 222, 272 )
	...
	local BannedItemsList = LUI.UIList.new( self, controller, 15, 0, nil, false, false, 0, 0, false, false )
	BannedItemsList:makeFocusable()
	BannedItemsList:setLeftRight( 0, 0, 600, 1824 )
	BannedItemsList:setTopBottom( 0, 0, 419, 581 )
	...
	ButtonList:setLeftRight( 0, 0, 651, 999 )
	ButtonList:setTopBottom( 0, 0, 723, 821 )
