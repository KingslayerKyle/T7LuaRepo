...
LUI.createMenu.BarracksZM = function ( controller )
	...
	local CombatRecordButton = CoD.CombatRecordButtonZM.new( self, controller )
	CombatRecordButton:setLeftRight( 0, 0, 138, 1198 )
	...
	self:AddButtonCallbackFunction( CombatRecordButton, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, nil, function ( element, menu, controller, model )
		CombatRecordSetXUIDForLocalController( controller )
		NavigateToMenu( self, "CombatRecordZM", true, controller )
		return true
	end, function ( element, menu, controller )
		CoD.Menu.SetButtonLabel( menu, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "MENU_SELECT", nil )
		return true
