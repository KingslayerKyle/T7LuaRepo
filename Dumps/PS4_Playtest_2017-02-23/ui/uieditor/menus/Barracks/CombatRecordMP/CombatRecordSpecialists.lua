...
LUI.createMenu.CombatRecordSpecialists = function ( controller )
	...
	ItemList:setLeftRight( 0, 0, 116, 536 )
	...
	WeaponLabel:setLeftRight( 0, 0, 116, 188 )
	...
	StatLabel:setLeftRight( 0, 0, 365, 638 )
	...
	KillsStat:setLeftRight( 1, 1, -1305, -1119 )
	KillsStat:setTopBottom( 0, 0, 273, 357 )
	...
	UsedStat:setLeftRight( 1, 1, -1119, -933 )
	UsedStat:setTopBottom( 0, 0, 273, 357 )
	...
	KillsPerUseStat:setLeftRight( 1, 1, -933, -747 )
	KillsPerUseStat:setTopBottom( 0, 0, 273, 357 )
	...
	HeroName:setLeftRight( 0, 0, 617, 890 )
	HeroName:setTopBottom( 0, 0, 184, 222 )
	...
	WeaponTitle:setLeftRight( 0, 0, 615, 708 )
	WeaponTitle:setTopBottom( 0, 0, 223, 268 )
	...
	CombatRecordStatDescription:setLeftRight( 0, 0, 615, 1173 )
	CombatRecordStatDescription:setTopBottom( 0, 0, 357, 395 )
	...
	CombatRecordComparingPlayerInfo:setTopBottom( 0, 0, 36, 126 )
	...
	KillsPerUseStat:linkToElementModel( ItemList, "killsPerUse", true, function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
			KillsPerUseStat.StatValue:setText( Engine.Localize( modelValue ) )
		end
	end )
	KillsPerUseStat:linkToElementModel( ItemList, "killsPerUseComparison", true, function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
			KillsPerUseStat.ComparedStatValue:setText( Engine.Localize( modelValue ) )
		end
	end )
	...
	WeaponTitle:linkToElementModel( ItemList, "name", true, function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
			WeaponTitle.Label:setText( Engine.Localize( modelValue ) )
		end
	end )
	CombatRecordStatDescription:linkToElementModel( ItemList, "statDesc", true, function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
			CombatRecordStatDescription.StatDescription:setText( Engine.Localize( modelValue ) )
		end
	end )
