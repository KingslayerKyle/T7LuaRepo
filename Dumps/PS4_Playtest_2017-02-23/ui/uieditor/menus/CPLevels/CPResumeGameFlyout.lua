...
LUI.createMenu.CPResumeGameFlyout = function ( controller )
	...
	ResumeInSafehouseBtn:setLeftRight( 0, 0, 365, 848 )
	ResumeInSafehouseBtn:setTopBottom( 0, 0, 257, 327 )
	...
	ResumeFromCheckpointBtn:setLeftRight( 0, 0, 364, 847 )
	ResumeFromCheckpointBtn:setTopBottom( 0, 0, 215, 285 )
