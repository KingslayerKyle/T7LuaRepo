...
LUI.createMenu.ScorestreakOverCapacity = function ( controller )
	...
	selectedScorestreak:setLeftRight( 0, 0, 138, 495 )
	selectedScorestreak:setTopBottom( 0, 0, 339, 696 )
	...
	selectionList:setLeftRight( 0, 0, 675, 1245 )
	selectionList:setTopBottom( 0, 0, 392, 572 )
