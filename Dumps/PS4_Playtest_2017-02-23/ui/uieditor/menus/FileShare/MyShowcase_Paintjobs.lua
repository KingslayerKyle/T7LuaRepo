...
LUI.createMenu.MyShowcase_Paintjobs = function ( controller )
	...
	paintjobsList:setLeftRight( 0, 0, 117.5, 623.5 )
	paintjobsList:setTopBottom( 0, 0, 207, 885 )
	...
	FileshareSelector0:setTopBottom( 0, 0, 188, 1026 )
