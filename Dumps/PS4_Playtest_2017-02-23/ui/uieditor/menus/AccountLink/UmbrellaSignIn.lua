...
LUI.createMenu.UmbrellaSignIn = function ( controller )
	...
	Image0:setLeftRight( 0, 0, 976, 1639 )
	Image0:setTopBottom( 0, 0, 92, 828 )
	...
	emailEntry:setLeftRight( 0, 0, 316, 894 )
	emailEntry:setTopBottom( 0, 0, 431.5, 482.5 )
	...
	passwordEntry:setLeftRight( 0, 0, 316, 894 )
	passwordEntry:setTopBottom( 0, 0, 490.5, 541.5 )
	...
	button0:setLeftRight( 0, 0, 324, 608 )
	button0:setTopBottom( 0, 0, 569.5, 614.5 )
	...
	PromptBack:setTopBottom( 0, 0, 773, 819 )
