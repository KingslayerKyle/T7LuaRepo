...
LUI.createMenu.InGameOptIn = function ( controller )
	...
	skipbtn:setLeftRight( 0, 0, 324, 645 )
	skipbtn:setTopBottom( 0, 0, 638.5, 683.5 )
	...
	optinbtn:setLeftRight( 0, 0, 324, 645 )
	optinbtn:setTopBottom( 0, 0, 588.5, 633.5 )
	...
	Image0:setLeftRight( 0, 0, 977, 1641 )
	Image0:setTopBottom( 0, 0, 92, 831 )
