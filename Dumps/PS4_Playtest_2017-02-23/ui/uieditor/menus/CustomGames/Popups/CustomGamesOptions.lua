...
LUI.createMenu.CustomGamesOptions = function ( controller )
	...
	self:registerEventHandler( "customgames_save_success", function ( element, event )
		local retVal = nil
	...
	self:registerEventHandler( "customgames_save_failure", function ( element, event )
		local retVal = nil
	...
	self:registerEventHandler( "customgames_delete_success", function ( element, event )
		local retVal = nil
	...
	self:registerEventHandler( "customgames_delete_failure", function ( element, event )
		local retVal = nil
	...
	self:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_START, nil, function ( element, menu, controller, model )
		...
		CoD.Menu.SetButtonLabel( menu, Enum.LUIButton.LUI_KEY_START, "MENU_CLOSE", nil )
		return true
	end, false )
