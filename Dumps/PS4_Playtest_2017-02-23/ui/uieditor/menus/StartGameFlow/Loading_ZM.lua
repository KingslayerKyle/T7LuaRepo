...
LUI.createMenu.Loading_ZM = function ( controller )
	local self = CoD.Menu.NewForUIEditor( "Loading_ZM" )
	if PreLoadFunc then
	...
	self.buttonModel = Engine.CreateModel( Engine.GetModelForController( controller ), "Loading_ZM.buttonPrompts" )
	...
	LUI.OverrideFunction_CallOriginalSecond( self, "close", function ( self )
		...
		Engine.UnsubscribeAndFreeModel( Engine.GetModel( Engine.GetModelForController( controller ), "Loading_ZM.buttonPrompts" ) )
	end )
