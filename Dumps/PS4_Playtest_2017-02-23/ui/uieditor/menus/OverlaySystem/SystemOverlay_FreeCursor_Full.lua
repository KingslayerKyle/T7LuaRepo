...
LUI.createMenu.SystemOverlay_FreeCursor_Full = function ( controller )
	local self = CoD.Menu.NewForUIEditor( "SystemOverlay_FreeCursor_Full" )
	if PreLoadFunc then
	...
	self.buttonModel = Engine.CreateModel( Engine.GetModelForController( controller ), "SystemOverlay_FreeCursor_Full.buttonPrompts" )
	self.anyChildUsesUpdateState = true
	
	local layout = CoD.systemOverlay_FreeCursor_Full_Layout.new( self, controller )
	...
	LUI.OverrideFunction_CallOriginalSecond( self, "close", function ( self )
		...
		Engine.UnsubscribeAndFreeModel( Engine.GetModel( Engine.GetModelForController( controller ), "SystemOverlay_FreeCursor_Full.buttonPrompts" ) )
	end )
