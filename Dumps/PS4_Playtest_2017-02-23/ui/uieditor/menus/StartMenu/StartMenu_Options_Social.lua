...
local CreateModels_Link_Twitch = function ()
	...
	if Engine.IsPlayerUnderage( controller ) then
		...
		listInfo.properties.disabled = true
	end
	return listInfo
end
...
LUI.createMenu.StartMenu_Options_Social = function ( controller )
	...
	ButtonList:setLeftRight( 0, 0, 96, 1101 )
	ButtonList:setTopBottom( 0, 0, 168, 1006 )
	...
	Image:setLeftRight( 0, 0, 1060, 1246 )
	Image:setTopBottom( 0, 0, 164, 350 )
	self:addElement( Image )
	self.Image = Image
	
	local DescTitle = LUI.UIText.new()
	DescTitle:setLeftRight( 0, 0, 1268, 1824 )
	DescTitle:setTopBottom( 0, 0, 162, 211 )
	...
	Desc:setLeftRight( 0, 0, 1268, 1824 )
	Desc:setTopBottom( 0, 0, 211, 243 )
