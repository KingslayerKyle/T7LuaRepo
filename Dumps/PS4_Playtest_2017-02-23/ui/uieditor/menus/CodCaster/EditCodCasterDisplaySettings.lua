...
LUI.createMenu.EditCodCasterDisplaySettings = function ( controller )
	...
	GenericMenuFrame.titleLabel:setText( LocalizeToUpperString( "CODCASTER_DISPLAY_SETTINGS" ) )
	GenericMenuFrame.cac3dTitleIntermediary0.FE3dTitleContainer0.MenuTitle.TextBox1.Label0:setText( LocalizeToUpperString( "CODCASTER_DISPLAY_SETTINGS" ) )
	...
	ButtonList:setTopBottom( 0, 0, 227, 925 )
