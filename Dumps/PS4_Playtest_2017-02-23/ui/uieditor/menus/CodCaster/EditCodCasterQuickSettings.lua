...
LUI.createMenu.EditCodCasterQuickSettings = function ( controller )
	...
	GenericMenuFrame.titleLabel:setText( LocalizeToUpperString( "CODCASTER_QUICK_SETTINGS" ) )
	GenericMenuFrame.cac3dTitleIntermediary0.FE3dTitleContainer0.MenuTitle.TextBox1.Label0:setText( LocalizeToUpperString( "CODCASTER_QUICK_SETTINGS" ) )
	self:addElement( GenericMenuFrame )
	self.GenericMenuFrame = GenericMenuFrame
	
	local ButtonList = LUI.UIList.new( self, controller, 6, 0, nil, false, false, 0, 0, false, false )
	ButtonList:makeFocusable()
	ButtonList:setLeftRight( 0, 0, 68, 428 )
	ButtonList:setTopBottom( 0, 0, 218, 644 )
