...
Lobby.MatchmakingDedicated.SetupMatchmakingStage = function ( controller )
	...
	local hostInfo = Engine.GetLobbyHostInfo( Enum.LobbyModule.LOBBY_MODULE_HOST, Enum.LobbyType.LOBBY_TYPE_GAME )
	Dvar.lobbySearchServerLocation1:set( hostInfo.serverLocation )
	return true
end
