...
LUI.createMenu.ButtonLayout = function ( controller, userData )
	...
	if CoD.isPS4 and not isDemoPlaying then
	...
	if CoD.isPS4 then
		...
		buttonLayoutMenu.controllerImage:setLeftRight( false, false, -250, 250 )
		buttonLayoutMenu.controllerImage:setTopBottom( false, false, -175, 325 )
	end
...
CoD.ButtonLayout.UpdateButtonLinesAndLabels = function ( self, layout, controller )
	...
	for index, buttonRef in pairs( CoD.ButtonLayout.ButtonRefs ) do
		...
		if CoD.isPS4 and flipped == 0 then
...
CoD.ButtonLayout.AddPS4LinesAndLabels = function ( self, controller )
	...
	local lBumpLineStartTop = dy( 175 )
	...
	f17_local18 = {}
	local f17_local19 = dx( 135 )
	local f17_local20 = dy( 145 )
	...
	if not CoD.isSinglePlayer then
		local backLineEndLeft = dx( 220 )
		local backLineEndTop = dy( 110 )
		f17_local18 = self.buttonLines
		f17_local19 = CoD.ButtonLayout.AddLine
		f17_local20 = self
		f17_local21 = {}
		local f17_local22 = dx( 220 )
		local f17_local23 = dy( 256 )
	...
	local startLineEndLeft = dx( 290 )
	local startLineEndTop = dy( 140 )
	f17_local18 = self.buttonLines
	f17_local19 = CoD.ButtonLayout.AddLine
	f17_local20 = self
	f17_local21 = {}
	local f17_local22 = dx( 290 )
	local f17_local23 = dy( 256 )
	...
	local lStickLineStartLeft = dx( 194 )
	...
	local f17_local24 = {}
	local f17_local25 = dx( 194 )
	local f17_local26 = dy( 336 )
	...
	local rStickLineEndLeft = dx( 320 )
