...
local PlaceElementsPS3 = function ( self )
	self.stickLayoutImageContainer.leftStickImage:setLeftRight( false, false, -120, 0 )
	self.stickLayoutImageContainer.leftStickImage:setTopBottom( false, false, 90, 210 )
	self.stickLayoutImageContainer.rightStickImage:setLeftRight( false, false, 0, 120 )
	self.stickLayoutImageContainer.rightStickImage:setTopBottom( false, false, 90, 210 )
	local safeAreaWidth, safeAreaHeight = Engine.GetUserSafeArea()
	local textSize = CoD.textSize.Condensed
	self.stickLayoutImageContainer.textUL:setLeftRight( false, false, -120, 0 )
	self.stickLayoutImageContainer.textUL:setTopBottom( false, false, 60, 60 + textSize )
	self.stickLayoutImageContainer.textL:setLeftRight( false, false, -safeAreaWidth / 2, -130 )
	self.stickLayoutImageContainer.textL:setTopBottom( false, false, 130, 130 + textSize )
	self.stickLayoutImageContainer.textL:setAlignment( LUI.Alignment.Right )
	self.stickLayoutImageContainer.textLL:setLeftRight( false, false, -120, 0 )
	self.stickLayoutImageContainer.textLL:setTopBottom( false, false, 215, 215 + textSize )
	self.stickLayoutImageContainer.textUR:setLeftRight( false, false, 120, 0 )
	self.stickLayoutImageContainer.textUR:setTopBottom( false, false, 60, 60 + textSize )
	self.stickLayoutImageContainer.textUR:setAlignment( LUI.Alignment.Center )
	self.stickLayoutImageContainer.textLR:setLeftRight( false, false, 120, 0 )
	self.stickLayoutImageContainer.textLR:setTopBottom( false, false, 215, 215 + textSize )
	self.stickLayoutImageContainer.textR:setLeftRight( false, false, 130, safeAreaWidth / 2 )
	self.stickLayoutImageContainer.textR:setTopBottom( false, false, 130, 130 + textSize )
	self.stickLayoutImageContainer.textR:setAlignment( LUI.Alignment.Left )
end

local PlaceElementsXenon = function ( self )
