LUI.createMenu.SpikeLauncherDetonateTutorial = function ( controller )
	local self = CoD.Menu.NewForUIEditor( "SpikeLauncherDetonateTutorial" )
	if PreLoadFunc then
	...
	Hint:setLeftRight( false, false, -152, 180 )
	Hint:setTopBottom( true, false, 427, 452 )
	Hint:setRGB( 1, 1, 1 )
	Hint:setText( Engine.Localize( "CP_MI_CAIRO_RAMSES_SPIKE_LAUNCHER_DETONATE" ) )
