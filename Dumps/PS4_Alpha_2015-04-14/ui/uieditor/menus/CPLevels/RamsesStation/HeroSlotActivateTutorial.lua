LUI.createMenu.HeroSlotActivateTutorial = function ( controller )
	local self = CoD.Menu.NewForUIEditor( "HeroSlotActivateTutorial" )
	if PreLoadFunc then
	...
	Hint:setLeftRight( false, false, -228.73, 351.27 )
	Hint:setTopBottom( true, false, 427, 452 )
	Hint:setRGB( 1, 1, 1 )
	Hint:setText( Engine.Localize( "CP_MI_CAIRO_RAMSES_ACTIVATE_HERO_SLOT" ) )
