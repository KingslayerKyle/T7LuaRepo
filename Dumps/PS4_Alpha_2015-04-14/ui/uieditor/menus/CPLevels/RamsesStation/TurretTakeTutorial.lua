LUI.createMenu.TurretTakeTutorial = function ( controller )
	local self = CoD.Menu.NewForUIEditor( "TurretTakeTutorial" )
	if PreLoadFunc then
	...
	Hint:setLeftRight( false, false, -133, 161 )
	Hint:setTopBottom( true, false, 427, 452 )
	Hint:setRGB( 1, 1, 1 )
	Hint:setText( Engine.Localize( "CP_MI_CAIRO_RAMSES_TURRET_TAKE" ) )
