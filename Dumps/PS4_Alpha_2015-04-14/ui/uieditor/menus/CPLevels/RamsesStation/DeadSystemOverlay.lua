...
LUI.createMenu.DeadSystemOverlay = function ( controller )
	...
	Toolow:setMaterial( LUI.UIImage.GetCachedMaterial( "ui_normal" ) )
	...
	HealthBar:setRGB( 1, 1, 1 )
	HealthBar:setImage( RegisterImage( "uie_img_t7_cp_hud_deadsys_meterframedouble" ) )
	HealthBar:setMaterial( LUI.UIImage.GetCachedMaterial( "ui_normal" ) )
