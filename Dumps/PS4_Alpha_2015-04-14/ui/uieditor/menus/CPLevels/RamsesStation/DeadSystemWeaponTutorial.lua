LUI.createMenu.DeadSystemWeaponTutorial = function ( controller )
	local self = CoD.Menu.NewForUIEditor( "DeadSystemWeaponTutorial" )
	if PreLoadFunc then
	...
	Hint:setLeftRight( false, false, -256.5, 284.5 )
	Hint:setTopBottom( true, false, 427, 451 )
	Hint:setRGB( 1, 1, 1 )
	Hint:setText( Engine.Localize( "CP_MI_CAIRO_RAMSES_DEAD_CONTROL_WEAPON" ) )
