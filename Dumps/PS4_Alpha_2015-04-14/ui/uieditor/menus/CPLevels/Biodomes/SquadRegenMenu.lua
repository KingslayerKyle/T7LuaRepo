LUI.createMenu.SquadRegenMenu = function ( controller )
	local self = CoD.Menu.NewForUIEditor( "SquadRegenMenu" )
	if PreLoadFunc then
	...
	self.SquadGoneText:linkToElementModel( self, "squad_regen_text", true, function ( model )
