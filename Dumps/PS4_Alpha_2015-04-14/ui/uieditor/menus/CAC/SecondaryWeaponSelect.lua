...
LUI.createMenu.SecondaryWeaponSelect = function ( controller )
	...
	TabRight:setLeftRight( true, false, 405, 1397 )
	...
	RightBumperWidget:setLeftRight( true, false, 415, 447 )
	...
	self:registerEventHandler( "menu_opened", function ( element, event )
		local retVal = nil
		SetElementStateByElementName( self, "selectMenuWidget", controller, "Update2" )
		if not retVal then
			retVal = element:dispatchEventToChildren( event )
		end
		return retVal
