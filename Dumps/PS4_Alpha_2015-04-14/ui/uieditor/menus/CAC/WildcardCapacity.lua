...
local PostLoadFunc = function ( self, controller )
	...
	if not wildcardNeeded then
		wildcardNeeded = CoD.CACUtility.WildcardNeededForSlot( loadoutSlotName )
	end
	if wildcardNeeded then
		local weaponVariantModel = Engine.GetModel( Engine.GetModelForController( controller ), "WeaponVariantList.curWeaponVariantName" )
			...
			for index, model in ipairs( CoD.UnlockablesTable.bonuscard ) do
				...
				if refModel then
					...
					if refName == wildcardNeeded then
						local imageModel = Engine.GetModel( model, "image" )
...
LUI.createMenu.WildcardCapacity = function ( controller )
	...
	selectedWildcard:setTopBottom( true, false, 247.06, 495.22 )
	selectedWildcard:setRGB( 1, 1, 1 )
	selectedWildcard:setMaterial( LUI.UIImage.GetCachedMaterial( "ui_normal" ) )
	...
	selectionList:setLeftRight( true, false, 435, 767 )
	selectionList:setTopBottom( true, false, 328, 470 )
	...
	Image5:setLeftRight( true, false, 769, 805 )
	Image5:setTopBottom( false, false, -32, -28.5 )
	Image5:setRGB( 1, 1, 1 )
	...
	Image0:setLeftRight( true, false, 769, 805 )
	Image0:setTopBottom( false, false, 105.25, 108.75 )
	Image0:setRGB( 1, 1, 1 )
	...
	Image1:setLeftRight( true, false, 397, 433 )
	Image1:setTopBottom( false, false, -31.75, -28.25 )
	Image1:setRGB( 1, 1, 1 )
	Image1:setZRot( 180 )
	...
	Image3:setTopBottom( false, false, 132.56, 136.06 )
	Image3:setRGB( 1, 1, 1 )
	Image3:setZRot( 180 )
	...
	LineSide0:setTopBottom( true, false, 257.06, 487.44 )
	...
	Image40:setTopBottom( true, false, 317.06, 369.06 )
	...
	Image10:setLeftRight( true, false, 397, 433 )
	Image10:setTopBottom( false, false, 104.5, 108 )
	...
	Image30:setTopBottom( false, false, 133.38, 137.06 )
	...
	LineSide00:setTopBottom( true, false, 257.06, 487.44 )
	...
	Image400:setTopBottom( true, false, 317, 369 )
	...
	desc:setLeftRight( true, false, 435, 862 )
	desc:setTopBottom( true, false, 257.06, 293.06 )
	desc:setRGB( 1, 1, 1 )
	...
	cac2lines0:setLeftRight( true, false, 397, 433 )
	cac2lines0:setTopBottom( true, false, 256.31, 293.06 )
