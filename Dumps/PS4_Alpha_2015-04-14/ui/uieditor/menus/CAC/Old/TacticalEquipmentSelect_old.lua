...
local PreLoadFunc = function ( self, controller )
	CoD.GenericCACSelectionPreLoadFunc( self, controller, "secondarygadget" )
end

LUI.createMenu.TacticalEquipmentSelect_old = function ( controller )
	local self = CoD.Menu.NewForUIEditor( "TacticalEquipmentSelect_old" )
	if PreLoadFunc then
	...
	selectMenuWidget.background.titleLabel:setText( Engine.Localize( "MENU_TACTICAL_CAPS" ) )
	...
	local selectionList = LUI.UIList.new( self, controller, 4, 0, function ( model )
		return Engine.GetModelValue( Engine.GetModel( model, "group" ) ) == "weapon_grenade"
