...
LUI.createMenu.PrimaryAttachmentSelect_old = function ( controller )
	local self = CoD.Menu.NewForUIEditor( "PrimaryAttachmentSelect_old" )
	if PreLoadFunc then
	...
	BackdropImage:setRGB( 0.51, 0.51, 0.51 )
	...
	selectMenuWidget.background.titleLabel:setText( Engine.Localize( "MPUI_ATTACHMENTS_CAPS" ) )
