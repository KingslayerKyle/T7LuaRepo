...
LUI.createMenu.SpecialGadgetSelect_old = function ( controller )
	local self = CoD.Menu.NewForUIEditor( "SpecialGadgetSelect_old" )
	if PreLoadFunc then
	...
	selectMenuWidget.background.titleLabel:setText( Engine.Localize( "MPUI_SPECIALGADGET_CAPS" ) )
