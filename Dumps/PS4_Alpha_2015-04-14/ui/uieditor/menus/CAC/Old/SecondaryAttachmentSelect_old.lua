...
local PostLoadFunc = function ( self )
	...
	local nameModel = self:getModel( controller, "secondary.name" )
	if nameModel then
...
LUI.createMenu.SecondaryAttachmentSelect_old = function ( controller )
	local self = CoD.Menu.NewForUIEditor( "SecondaryAttachmentSelect_old" )
	if PreLoadFunc then
	...
	selectMenuWidget.background.titleLabel:setText( Engine.Localize( AppendString( "MPUI_ATTACHMENTS_CAPS", "_CAPS" ) ) )
