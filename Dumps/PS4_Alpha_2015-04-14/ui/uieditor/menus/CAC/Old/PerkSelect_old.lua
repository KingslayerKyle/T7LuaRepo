...
local PostLoadFunc = function ( self, controller )
	...
	if weaponCategory == "specialty1" then
		self.selectMenuWidget.background.titleLabel:setText( Engine.Localize( "MPUI_PERK1_CAPS" ) )
	elseif weaponCategory == "specialty2" then
		self.selectMenuWidget.background.titleLabel:setText( Engine.Localize( "MPUI_PERK2_CAPS" ) )
	elseif weaponCategory == "specialty3" then
		self.selectMenuWidget.background.titleLabel:setText( Engine.Localize( "MPUI_PERK3_CAPS" ) )
	end
	self.getEquippedLoadoutSlot = GetEquippedPerkLoudoutSlot
end

LUI.createMenu.PerkSelect_old = function ( controller )
	local self = CoD.Menu.NewForUIEditor( "PerkSelect_old" )
	if PreLoadFunc then
	...
	BackdropImage:setImage( RegisterImage( "uie_img_t7_menu_cacselection_tempbackdrop2" ) )
	...
	selectMenuWidget.background.titleLabel:setText( Engine.Localize( "MPUI_PERKS_CAPS" ) )
