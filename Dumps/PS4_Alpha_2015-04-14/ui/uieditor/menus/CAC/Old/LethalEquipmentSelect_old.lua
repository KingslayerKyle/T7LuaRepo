...
LUI.createMenu.LethalEquipmentSelect_old = function ( controller )
	local self = CoD.Menu.NewForUIEditor( "LethalEquipmentSelect_old" )
	if PreLoadFunc then
	...
	selectMenuWidget.background.titleLabel:setText( Engine.Localize( "MPUI_PRIMARYGRENADE_CAPS" ) )
