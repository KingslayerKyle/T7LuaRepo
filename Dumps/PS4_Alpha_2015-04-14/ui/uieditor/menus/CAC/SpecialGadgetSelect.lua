...
LUI.createMenu.SpecialGadgetSelect = function ( controller )
	local self = CoD.Menu.NewForUIEditor( "SpecialGadgetSelect" )
	if PreLoadFunc then
	...
	selectMenuWidget.background.cac3dTitleIntermediary0.FE3dTitleContainer0.MenuTitle.TextBox1.Label0:setText( Engine.Localize( "MPUI_SPECIALGADGET_CAPS" ) )
