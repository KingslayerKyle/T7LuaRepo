...
LUI.createMenu.MediumPopup = function ( controller )
	...
	BackButtonPrompt.buttonPromptAddFunctions = {}
	BackButtonPrompt.buttonPromptAddFunctions.secondary = function ( menu, element, event )
	...
	BackButtonPrompt:registerEventHandler( "gamepad_button", function ( element, event )
		local retVal = nil
