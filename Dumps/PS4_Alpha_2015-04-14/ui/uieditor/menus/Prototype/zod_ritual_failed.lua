LUI.createMenu.zod_ritual_failed = function ( controller )
	local self = CoD.Menu.NewForUIEditor( "zod_ritual_failed" )
	if PreLoadFunc then
	...
	TextBox0:setAlignment( LUI.Alignment.Left )
				...
				self.TextBox0:animationQueue( {
					{
						...
						funct = function ( TextBox0, time )
							...
							self.TextBox0:setLeftRight( true, false, 313.5, 966.5 )
					...
					},
					{
						...
						funct = function ( TextBox0, time )
							TextBox0:beginAnimation( "keyframe", time, false, false, CoD.TweenType.Linear )
							TextBox0:setLeftRight( true, false, 313.5, 966.5 )
							TextBox0:setTopBottom( true, false, 611, 666 )
							TextBox0:setAlpha( 0 )
						end
					},
					{
