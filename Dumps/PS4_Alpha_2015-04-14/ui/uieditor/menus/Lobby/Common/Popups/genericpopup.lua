...
LUI.createMenu.GenericPopup = function ( controller )
	...
	lstOptions:registerEventHandler( "list_item_button_action", function ( element, event )
		local retVal = nil
	...
	Spinner:setMaterial( LUI.UIImage.GetCachedMaterial( "ui_normal" ) )
