...
LUI.createMenu.DebugLobbyOnlineCustomGame = function ( controller )
	local self = CoD.Menu.NewForUIEditor( "DebugLobbyOnlineCustomGame" )
	if PreLoadFunc then
	...
	btnStart:setTopBottom( true, false, 528, 558 )
	...
	btnStart:registerEventHandler( "button_action", function ( element, event )
		local retVal = nil
		LobbyOnlineCustomLaunchGame( self, controller )
		if not retVal then
	...
	btnCAC:setTopBottom( true, false, 558, 588 )
	btnCAC:setRGB( 1, 1, 1 )
	...
	btnChangeMap:setLeftRight( true, false, 96, 346 )
	btnChangeMap:setTopBottom( true, false, 588, 618 )
	...
	btnChangeGameMode:setTopBottom( true, false, 618, 648 )
