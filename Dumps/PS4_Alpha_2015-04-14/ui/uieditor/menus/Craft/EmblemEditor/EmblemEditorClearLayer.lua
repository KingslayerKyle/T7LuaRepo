...
LUI.createMenu.EmblemEditorClearLayer = function ( controller )
	local self = CoD.Menu.NewForUIEditor( "EmblemEditorClearLayer" )
	if PreLoadFunc then
	...
	title:setRGB( 1, 1, 1 )
	title:setText( Engine.Localize( "MENU_EMBLEM_CLEAR_LAYER_CAPS" ) )
	...
	yesButton.buttoninternal0.Text0:setText( Engine.Localize( "MENU_YES" ) )
	...
	noButton:setTopBottom( true, false, 360, 390 )
	noButton:setRGB( 1, 1, 1 )
	noButton.buttoninternal0.Text0:setText( Engine.Localize( "MENU_NO" ) )
