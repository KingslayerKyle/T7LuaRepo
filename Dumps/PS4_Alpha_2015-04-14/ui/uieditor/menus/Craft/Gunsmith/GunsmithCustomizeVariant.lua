...
LUI.createMenu.GunsmithCustomizeVariant = function ( controller )
	...
	variantAttachments:setRGB( 1, 1, 1 )
	...
	GunsmithCustomizeGraphics0:setRGB( 1, 1, 1 )
