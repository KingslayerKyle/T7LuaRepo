...
CoD.GroupsSummary.new = function ( menu, controller )
	...
	GroupMemberSummary.MemberCount.Title:setText( Engine.Localize( AppendString( "GROUPS_MEMBERS", "_CAPS" ) ) )
	GroupMemberSummary.PlayingCount.Title:setText( Engine.Localize( AppendString( "GROUPS_PLAYING", "_CAPS" ) ) )
	GroupMemberSummary.OnlineCount.Title:setText( Engine.Localize( AppendString( "GROUPS_ONLINE", "_CAPS" ) ) )
	...
	GroupsSummaryStatus0:setRGB( 1, 1, 1 )
	...
	CountryFlagImage:setRGB( 1, 1, 1 )
	CountryFlagImage:setImage( RegisterImage( "uie_img_t7_menu_groups_flag_us" ) )
	CountryFlagImage:setMaterial( LUI.UIImage.GetCachedMaterial( "ui_normal" ) )
	...
	self.close = function ( self )
		...
		CoD.GroupsSummary.super.close( self )
	end
