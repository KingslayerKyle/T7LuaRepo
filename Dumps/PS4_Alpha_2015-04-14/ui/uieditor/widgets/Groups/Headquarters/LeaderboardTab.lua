...
local UpdateNavigation = function ( self, controller )
	...
	if DoesHaveAdminRightsForGroup( self, nil, event ) and not IsGroupLeaderboardInitialized( self, nil, event ) then
	...
	elseif not IsGroupLeaderboardAvailable( self, nil, event ) then
		self.CreateLeaderboardButton.navigation = {}
		self.UseDefaultButton.navigation = {}
		self.Leaderboard.navigation = {}
	else
...
CoD.LeaderboardTab.new = function ( menu, controller )
	...
	CreateLeaderboardTitle:setRGB( 1, 1, 1 )
	...
	CreateLeaderboardDesc:setRGB( 1, 1, 1 )
	...
	LeaderboardInformation:setRGB( 1, 1, 1 )
	...
	GroupsLeaderboardSummary0:setRGB( 1, 1, 1 )
	...
	CreateLeaderboardButton:setRGB( 1, 1, 1 )
	CreateLeaderboardButton:setAlpha( 0 )
	CreateLeaderboardButton.Text:setText( Engine.Localize( "GROUPS_CREATE" ) )
	CreateLeaderboardButton:registerEventHandler( "button_action", function ( element, event )
		local retVal = nil
	...
	UseDefaultButton:setRGB( 1, 1, 1 )
	UseDefaultButton:setAlpha( 0 )
	UseDefaultButton.Text:setText( Engine.Localize( "GROUPS_USE_DEFAULT_CAREER" ) )
	UseDefaultButton:registerEventHandler( "button_action", function ( element, event )
		local retVal = nil
	...
	self.close = function ( self )
		...
		CoD.LeaderboardTab.super.close( self )
	end
