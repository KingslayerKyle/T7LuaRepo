...
CoD.GroupsLeaderboardSummary.new = function ( menu, controller )
	...
	CallingCardDummy:setRGB( 1, 1, 1 )
	CallingCardDummy:setImage( RegisterImage( "uie_img_t7_menu_partyeaseslide_gamercard1dummy" ) )
	CallingCardDummy:setMaterial( LUI.UIImage.GetCachedMaterial( "ui_normal" ) )
	...
	GroupMemberSummary:setRGB( 1, 1, 1 )
	...
	GroupClanTagBacking:setMaterial( LUI.UIImage.GetCachedMaterial( "ui_normal" ) )
	...
	EmblemDummy:setRGB( 1, 1, 1 )
	EmblemDummy:setImage( RegisterImage( "uie_img_t7_menu_partyeaseslide_emblemdummy" ) )
	EmblemDummy:setMaterial( LUI.UIImage.GetCachedMaterial( "ui_normal" ) )
	...
	self.close = function ( self )
		...
		self.Name:close()
		CoD.GroupsLeaderboardSummary.super.close( self )
	end
