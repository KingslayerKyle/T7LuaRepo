...
CoD.NotificationPerksContainer.new = function ( menu, controller )
	...
	Perks:setAlpha( 0 )
	Perks:setYRot( -20 )
	Perks:registerEventHandler( "show_perk_notification", function ( element, event )
		local retVal = nil
		if not IsInPrematchPeriod() and HasPerksInAnySlot( controller ) then
	...
	self.close = function ( self )
		self.Perks:close()
		CoD.NotificationPerksContainer.super.close( self )
	end
