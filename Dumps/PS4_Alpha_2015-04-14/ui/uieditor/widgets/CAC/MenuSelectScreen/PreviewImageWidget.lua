...
CoD.PreviewImageWidget.new = function ( menu, controller )
	...
	image:setLeftRight( false, false, -363, 387 )
	image:setTopBottom( false, false, -180, 180 )
	image:setRGB( 1, 1, 1 )
	...
	self.clipsPerState = {
		DefaultState = {
			DefaultClip = function ()
				...
				self.image:setLeftRight( false, false, -363, 387 )
				self.image:setTopBottom( false, false, -180, 180 )
