...
CoD.TacticalEquipmentWidget_old = InheritFrom( LUI.UIElement )
CoD.TacticalEquipmentWidget_old.new = function ( menu, controller )
	local self = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc( self, controller )
	end
	self:setUseStencil( false )
	self:setClass( CoD.TacticalEquipmentWidget_old )
	self.id = "TacticalEquipmentWidget_old"
	self.soundSet = "CAC"
	...
	local equipment2 = CoD.EquipmentWidget_old.new( menu, controller )
	equipment2:setLeftRight( false, true, -98, -39 )
	equipment2:setTopBottom( false, true, -63, -4 )
	equipment2:setRGB( 1, 1, 1 )
	equipment2:setAlpha( 0 )
	equipment2:linkToElementModel( self, "image", true, function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
			equipment2.mainItem:setImage( RegisterImage( modelValue ) )
		end
	end )
	...
	headerLabel.text:setText( Engine.Localize( "MPUI_SPECIALGRENADE_CAPS" ) )
	...
	self.clipsPerState = {
		DefaultState = {
			DefaultClip = function ()
				...
				self.equipment1:setLeftRight( false, false, -29.5, 29.5 )
				self.equipment1:setTopBottom( false, true, -63, -4 )
				self.equipment1:setAlpha( 1 )
				self.clipFinished( equipment1, {} )
				equipment2:completeAnimation()
				self.equipment2:setLeftRight( false, true, -98, -39 )
				self.equipment2:setTopBottom( false, true, -63, -4 )
				self.equipment2:setAlpha( 0 )
				self.clipFinished( equipment2, {} )
		...
		TakeTwo = {
			DefaultClip = function ()
				...
				self.clipFinished( BorderBakedSolid0, {} )
				equipment1:completeAnimation()
				self.equipment1:setLeftRight( false, false, -67.5, -8.5 )
				self.equipment1:setTopBottom( false, true, -63, -4 )
				self.equipment1:setAlpha( 1 )
				self.clipFinished( equipment1, {} )
				equipment2:completeAnimation()
				self.equipment2:setLeftRight( false, false, 7.5, 66.5 )
				self.equipment2:setTopBottom( false, true, -63, -4 )
				self.equipment2:setAlpha( 1 )
				self.clipFinished( equipment2, {} )
				nameLabel:completeAnimation()
				self.nameLabel:setAlpha( 1 )
				self.clipFinished( nameLabel, {} )
		...
		NotVisible = {
			DefaultClip = function ()
				...
				self.clipFinished( BorderBakedSolid0, {} )
				equipment1:completeAnimation()
				self.equipment1:setLeftRight( false, false, -73.5, -3.5 )
				self.equipment1:setTopBottom( false, true, -70, 0 )
	...
	self.close = function ( self )
		...
		CoD.TacticalEquipmentWidget_old.super.close( self )
	end
