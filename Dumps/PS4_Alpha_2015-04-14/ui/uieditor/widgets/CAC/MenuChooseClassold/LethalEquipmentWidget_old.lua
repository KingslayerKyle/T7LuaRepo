...
CoD.LethalEquipmentWidget_old = InheritFrom( LUI.UIElement )
CoD.LethalEquipmentWidget_old.new = function ( menu, controller )
	local self = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc( self, controller )
	end
	self:setUseStencil( false )
	self:setClass( CoD.LethalEquipmentWidget_old )
	self.id = "LethalEquipmentWidget_old"
	self.soundSet = "CAC"
	...
	equipment1:setLeftRight( false, false, -67.5, -8.5 )
	...
	equipment2:setLeftRight( false, false, 7.5, 66.5 )
	...
	nameLabel:setLeftRight( true, false, 10, 103 )
	...
	self.clipsPerState = {
		...
		NotVisible = {
			DefaultClip = function ()
				...
				self.clipFinished( BorderBakedSolid0, {} )
				equipment1:completeAnimation()
				self.equipment1:setLeftRight( false, false, -72.5, -13.5 )
				self.equipment1:setTopBottom( false, true, -63, -4 )
	...
	self.close = function ( self )
		...
		CoD.LethalEquipmentWidget_old.super.close( self )
	end
