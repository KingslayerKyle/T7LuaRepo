...
CoD.WildcardWidgetNew.new = function ( menu, controller )
	...
	wildcard2:linkToElementModel( self, "image", true, function ( model )
		...
		if modelValue then
			wildcard2.itemImageSolid:setImage( RegisterImage( modelValue ) )
		end
	end )
	wildcard2:linkToElementModel( self, "image", true, function ( model )
		local modelValue = Engine.GetModelValue( model )
	...
	wildcard3:linkToElementModel( self, "image", true, function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
			wildcard3.itemImageSolid:setImage( RegisterImage( modelValue ) )
		end
	end )
	wildcard3:linkToElementModel( self, "image", true, function ( model )
		local modelValue = Engine.GetModelValue( model )
	...
	wildcard1:linkToElementModel( self, "image", true, function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
			wildcard1.itemImageSolid:setImage( RegisterImage( modelValue ) )
		end
	end )
	wildcard1:linkToElementModel( self, "image", true, function ( model )
		local modelValue = Engine.GetModelValue( model )
	...
	self:registerEventHandler( "gain_focus", function ( self, event )
		if self.m_focusable and self.wildcard2:processEvent( event ) then
			return true
		else
	...
	self.close = function ( self )
		...
		CoD.WildcardWidgetNew.super.close( self )
	end
