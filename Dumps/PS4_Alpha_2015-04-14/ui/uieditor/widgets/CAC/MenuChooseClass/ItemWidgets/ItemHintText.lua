require( "ui.uieditor.widgets.CAC.cac_hitBG" )
...
CoD.ItemHintText.new = function ( menu, controller )
	...
	self.close = function ( self )
		self.cachitBG0:close()
		CoD.ItemHintText.super.close( self )
	end
