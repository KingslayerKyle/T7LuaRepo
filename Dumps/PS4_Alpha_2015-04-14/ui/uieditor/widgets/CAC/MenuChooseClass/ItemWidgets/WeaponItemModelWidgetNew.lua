...
CoD.WeaponItemModelWidgetNew.new = function ( menu, controller )
	...
	BoxButtonLrgInactiveStroke:setRGB( 1, 1, 1 )
	...
	personalizePrompt:setRGB( 1, 1, 1 )
	...
	opticIndicator:setRGB( 1, 1, 1 )
	opticIndicator:setAlpha( 0 )
	opticIndicator:setImage( RegisterImage( "uie_t7_menu_cac_iconoptics" ) )
	opticIndicator:setMaterial( LUI.UIImage.GetCachedMaterial( "ui_normal" ) )
	...
	self.close = function ( self )
		...
		CoD.WeaponItemModelWidgetNew.super.close( self )
	end
