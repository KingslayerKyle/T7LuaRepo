CoD.TacticalGrenadeModItemSlotWidget = InheritFrom( LUI.UIElement )
CoD.TacticalGrenadeModItemSlotWidget.new = function ( menu, controller )
	local self = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc( self, controller )
	end
	self:setUseStencil( true )
	self:setClass( CoD.TacticalGrenadeModItemSlotWidget )
	self.id = "TacticalGrenadeModItemSlotWidget"
	...
	notAvailableImage:setLeftRight( true, false, -42, 158 )
	...
	self.close = function ( self )
		...
		CoD.TacticalGrenadeModItemSlotWidget.super.close( self )
	end
