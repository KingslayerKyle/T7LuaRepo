CoD.SecondaryWeaponSlotWidget = InheritFrom( LUI.UIElement )
CoD.SecondaryWeaponSlotWidget.new = function ( menu, controller )
	local self = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc( self, controller )
	end
	self:setUseStencil( false )
	self:setClass( CoD.SecondaryWeaponSlotWidget )
	self.id = "SecondaryWeaponSlotWidget"
	...
	self.close = function ( self )
		...
		CoD.SecondaryWeaponSlotWidget.super.close( self )
	end
