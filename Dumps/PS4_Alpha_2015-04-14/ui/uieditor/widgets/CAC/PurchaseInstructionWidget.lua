...
CoD.PurchaseInstructionWidget.new = function ( menu, controller )
	...
	TokenImage:setLeftRight( false, true, -46, 0 )
	...
	PurchaseInstruction:setLeftRight( true, true, 0, 0 )
	PurchaseInstruction:setTopBottom( false, true, -39.5, -14.5 )
	PurchaseInstruction:setRGB( 1, 1, 1 )
	PurchaseInstruction:setText( Engine.Localize( "MENU_NEW" ) )
	PurchaseInstruction:setTTF( "fonts/UnitedSansSmCdMd.ttf" )
