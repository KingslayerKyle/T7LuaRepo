...
CoD.cac_IconTokenStatic.new = function ( menu, controller )
	...
	imgIconTokenMult:setMaterial( LUI.UIImage.GetCachedMaterial( "ui_normal" ) )
	...
	glow:setAlpha( RandomAddPercent( 0.26, -15 ) )
	...
	self.clipsPerState = {
		DefaultState = {
			DefaultClip = function ()
				...
				self.glow:setAlpha( RandomAddPercent( 0.26, -15 ) )
				glowFrame2( glow, {} )
