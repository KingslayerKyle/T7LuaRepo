...
CoD.CategoryNameWidget.new = function ( menu, controller )
	...
	categoryNameLabel:setTTF( "fonts/Entovo.ttf" )
	...
	categoryNameLabel:linkToElementModel( self, "name", true, function ( model )
		...
		if modelValue then
			categoryNameLabel:setText( Engine.Localize( modelValue ) )
		end
	end )
	...
	self.close = function ( self )
		self.categoryNameLabel:close()
		CoD.CategoryNameWidget.super.close( self )
	end
