...
CoD.SpecialGadgetSlot = InheritFrom( LUI.UIElement )
CoD.SpecialGadgetSlot.new = function ( menu, controller )
	local self = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc( self, controller )
	end
	self:setUseStencil( false )
	self:setClass( CoD.SpecialGadgetSlot )
	self.id = "SpecialGadgetSlot"
	...
	BorderBakedSymbols0:setAlpha( 0 )
	...
	Image0:linkToElementModel( self, "image_big", true, function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
	...
	Label0:setLeftRight( true, false, 11.46, 52.46 )
	...
	self.clipsPerState = {
		...
		NotInUse = {
			DefaultClip = function ()
				...
				BorderBakedSymbols0:completeAnimation()
				self.BorderBakedSymbols0:setAlpha( 0 )
				self.clipFinished( BorderBakedSymbols0, {} )
				BorderBakedStroke0:completeAnimation()
				self.BorderBakedStroke0:setAlpha( 0 )
				self.clipFinished( BorderBakedStroke0, {} )
				...
				CustomClassCategoryHeader0:completeAnimation()
				self.CustomClassCategoryHeader0:setAlpha( 0 )
				self.clipFinished( CustomClassCategoryHeader0, {} )
				BorderBakedMask0:completeAnimation()
				self.BorderBakedMask0:setAlpha( 0 )
				self.clipFinished( BorderBakedMask0, {} )
				...
				self.clipFinished( BorderFooter, {} )
				BorderFocusHeader:completeAnimation()
				self.BorderFocusHeader:setAlpha( 0 )
				self.clipFinished( BorderFocusHeader, {} )
				CustomClassPlusSymbol0:completeAnimation()
				self.CustomClassPlusSymbol0:setAlpha( 0 )
				self.clipFinished( CustomClassPlusSymbol0, {} )
	...
	self.close = function ( self )
		...
		self.Image0:close()
		self.Label0:close()
		CoD.SpecialGadgetSlot.super.close( self )
	end
