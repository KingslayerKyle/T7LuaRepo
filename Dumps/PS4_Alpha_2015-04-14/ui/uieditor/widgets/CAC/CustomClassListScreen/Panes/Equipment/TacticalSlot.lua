...
CoD.TacticalSlot = InheritFrom( LUI.UIElement )
CoD.TacticalSlot.new = function ( menu, controller )
	local self = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc( self, controller )
	end
	self:setUseStencil( false )
	self:setClass( CoD.TacticalSlot )
	self.id = "TacticalSlot"
	...
	self.close = function ( self )
		...
		self.Image0:close()
		self.Label0:close()
		CoD.TacticalSlot.super.close( self )
	end
