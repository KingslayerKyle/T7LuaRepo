...
CoD.PrimaryWeaponAttachments = InheritFrom( LUI.UIElement )
CoD.PrimaryWeaponAttachments.new = function ( menu, controller )
	local self = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc( self, controller )
	end
	self:setUseStencil( false )
	self:setClass( CoD.PrimaryWeaponAttachments )
	self.id = "PrimaryWeaponAttachments"
	...
	self.close = function ( self )
		...
		CoD.PrimaryWeaponAttachments.super.close( self )
	end
