...
CoD.TacticalAttachments = InheritFrom( LUI.UIElement )
CoD.TacticalAttachments.new = function ( menu, controller )
	local self = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc( self, controller )
	end
	self:setUseStencil( false )
	self:setClass( CoD.TacticalAttachments )
	self.id = "TacticalAttachments"
	...
	self.TacticalQuantityHeader = currentEv
	...
	self.close = function ( self )
		...
		self.TacticalQuantityHeader:close()
		CoD.TacticalAttachments.super.close( self )
	end
