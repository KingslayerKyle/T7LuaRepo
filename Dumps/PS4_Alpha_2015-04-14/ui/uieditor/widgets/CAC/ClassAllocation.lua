...
CoD.ClassAllocation.new = function ( menu, controller )
	...
	self:setLeftRight( true, false, 0, 435 )
	...
	TextBoxSlash:setTTF( "fonts/Entovo.ttf" )
	...
	totalCapacityLabel:setText( Engine.Localize( "10" ) )
	totalCapacityLabel:setTTF( "fonts/Entovo.ttf" )
	...
	capacityValueLabel:setTTF( "fonts/Entovo.ttf" )
	...
	UnlockTokensWidget:setLeftRight( false, true, -511, -321 )
	UnlockTokensWidget:setTopBottom( true, false, -1, 44 )
	...
	self.clipsPerState = {
		DefaultState = {
			DefaultClip = function ()
				...
				self.UnlockTokensWidget:setLeftRight( false, true, -511, -321 )
	...
	self.close = function ( self )
		...
		CoD.ClassAllocation.super.close( self )
	end
