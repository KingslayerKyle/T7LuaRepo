...
CoD.GridItemButton = InheritFrom( LUI.UIElement )
CoD.GridItemButton.new = function ( menu, controller )
	local self = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc( self, controller )
	end
	self:setUseStencil( false )
	self:setClass( CoD.GridItemButton )
	self.id = "GridItemButton"
	...
	self.close = function ( self )
		...
		CoD.GridItemButton.super.close( self )
	end
