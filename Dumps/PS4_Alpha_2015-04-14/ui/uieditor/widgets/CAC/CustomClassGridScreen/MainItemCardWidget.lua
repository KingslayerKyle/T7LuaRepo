require( "ui.uieditor.widgets.CAC.CustomClassGridScreen.MainItemCardWidget_Internal" )
require( "ui.uieditor.widgets.Border" )

CoD.MainItemCardWidget = InheritFrom( LUI.UIElement )
CoD.MainItemCardWidget.new = function ( menu, controller )
	local self = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc( self, controller )
	end
	self:setUseStencil( false )
	self:setClass( CoD.MainItemCardWidget )
	self.id = "MainItemCardWidget"
	...
	local mainItemCard = CoD.MainItemCardWidget_Internal.new( menu, controller )
	mainItemCard:setLeftRight( true, false, 0, 537 )
	...
	groupNameLabel:setRGB( 0.41, 0.44, 0.52 )
	...
	self.close = function ( self )
		...
		CoD.MainItemCardWidget.super.close( self )
	end
