CoD.SecondaryWeaponCardWidget_Internal = InheritFrom( LUI.UIElement )
CoD.SecondaryWeaponCardWidget_Internal.new = function ( menu, controller )
	local self = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc( self, controller )
	end
	self:setUseStencil( false )
	self:setClass( CoD.SecondaryWeaponCardWidget_Internal )
	self.id = "SecondaryWeaponCardWidget_Internal"
	self.soundSet = "default"
	self:setLeftRight( true, false, 0, 407 )
	...
	weaponImage:setLeftRight( false, false, -82, 82 )
	weaponImage:setTopBottom( true, false, 35, 117 )
	...
	plus:setTopBottom( true, false, 60, 92 )
	...
	self.close = function ( self )
		...
		CoD.SecondaryWeaponCardWidget_Internal.super.close( self )
	end
