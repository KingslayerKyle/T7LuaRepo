require( "ui.uieditor.widgets.CAC.CustomClassGridScreen.SecondaryWeapon.SecondaryWeaponModItemWidget_Internal" )

CoD.SecondaryWeaponModItemWidget = InheritFrom( LUI.UIElement )
CoD.SecondaryWeaponModItemWidget.new = function ( menu, controller )
	local self = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc( self, controller )
	end
	self:setUseStencil( false )
	self:setClass( CoD.SecondaryWeaponModItemWidget )
	self.id = "SecondaryWeaponModItemWidget"
	...
	local modItemWidget = CoD.SecondaryWeaponModItemWidget_Internal.new( menu, controller )
	...
	self.close = function ( self )
		...
		CoD.SecondaryWeaponModItemWidget.super.close( self )
	end
