...
CoD.SecondaryWeaponModItemWidget_Internal = InheritFrom( LUI.UIElement )
CoD.SecondaryWeaponModItemWidget_Internal.new = function ( menu, controller )
	local self = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc( self, controller )
	end
	self:setUseStencil( true )
	self:setClass( CoD.SecondaryWeaponModItemWidget_Internal )
	self.id = "SecondaryWeaponModItemWidget_Internal"
	...
	notAvailableImage:setLeftRight( false, false, -100, 100 )
	notAvailableImage:setTopBottom( false, false, -50, 50 )
	...
	iconImage:setLeftRight( false, false, -20, 20 )
	iconImage:setTopBottom( true, false, 3, 43 )
	...
	self.clipsPerState = {
		DefaultState = {
			DefaultClip = function ()
				...
				self.nameLabel:setRGB( 0.9, 0.9, 0.9 )
		...
		NotAvailable = {
			...
			Focus = function ()
				...
				self.clipFinished( iconImage, {} )
				nameLabel:completeAnimation()
				self.nameLabel:setRGB( 0.22, 0.23, 0.28 )
				self.nameLabel:setAlpha( 0 )
				self.clipFinished( nameLabel, {} )
				notAvailableLabel:completeAnimation()
				self.notAvailableLabel:setLeftRight( true, false, 4, 99 )
				self.notAvailableLabel:setTopBottom( false, true, -22, -2 )
				self.notAvailableLabel:setRGB( 0.34, 0.37, 0.46 )
				self.notAvailableLabel:setAlpha( 1 )
				self.clipFinished( notAvailableLabel, {} )
				needsLabel:completeAnimation()
				self.needsLabel:setLeftRight( true, false, 2, 112 )
				self.needsLabel:setTopBottom( false, true, -22, -2 )
				self.needsLabel:setRGB( 0.22, 0.23, 0.28 )
				self.needsLabel:setAlpha( 0 )
				self.clipFinished( needsLabel, {} )
				plus:completeAnimation()
				self.plus:setRGB( 0.4, 0.44, 0.52 )
	...
	self.close = function ( self )
		...
		CoD.SecondaryWeaponModItemWidget_Internal.super.close( self )
	end
