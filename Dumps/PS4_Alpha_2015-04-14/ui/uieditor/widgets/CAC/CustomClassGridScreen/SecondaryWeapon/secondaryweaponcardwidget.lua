require( "ui.uieditor.widgets.CAC.CustomClassGridScreen.SecondaryWeapon.SecondaryWeaponCardWidget_Internal" )
require( "ui.uieditor.widgets.Border" )

CoD.SecondaryWeaponCardWidget = InheritFrom( LUI.UIElement )
CoD.SecondaryWeaponCardWidget.new = function ( menu, controller )
	local self = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc( self, controller )
	end
	self:setUseStencil( false )
	self:setClass( CoD.SecondaryWeaponCardWidget )
	self.id = "SecondaryWeaponCardWidget"
	...
	local mainItemCard = CoD.SecondaryWeaponCardWidget_Internal.new( menu, controller )
	mainItemCard:setLeftRight( true, false, 0, 402 )
	mainItemCard:setTopBottom( true, false, 0, 128 )
	...
	self.close = function ( self )
		...
		CoD.SecondaryWeaponCardWidget.super.close( self )
	end
