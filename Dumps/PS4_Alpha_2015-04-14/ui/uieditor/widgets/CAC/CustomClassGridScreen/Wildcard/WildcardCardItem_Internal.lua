CoD.WildcardCardItem_Internal = InheritFrom( LUI.UIElement )
CoD.WildcardCardItem_Internal.new = function ( menu, controller )
	local self = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc( self, controller )
	end
	self:setUseStencil( false )
	self:setClass( CoD.WildcardCardItem_Internal )
	self.id = "WildcardCardItem_Internal"
	...
	nameLabel:setTopBottom( true, false, 45, 65 )
	...
	self.close = function ( self )
		...
		CoD.WildcardCardItem_Internal.super.close( self )
	end
