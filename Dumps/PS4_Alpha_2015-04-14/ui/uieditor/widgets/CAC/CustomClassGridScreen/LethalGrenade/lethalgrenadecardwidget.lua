require( "ui.uieditor.widgets.CAC.CustomClassGridScreen.LethalGrenade.LethalGrenadeCardWidget_Internal" )
require( "ui.uieditor.widgets.Border" )

CoD.LethalGrenadeCardWidget = InheritFrom( LUI.UIElement )
CoD.LethalGrenadeCardWidget.new = function ( menu, controller )
	local self = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc( self, controller )
	end
	self:setUseStencil( false )
	self:setClass( CoD.LethalGrenadeCardWidget )
	self.id = "LethalGrenadeCardWidget"
	...
	local mainItemCard = CoD.LethalGrenadeCardWidget_Internal.new( menu, controller )
	...
	groupNameLabel:setLeftRight( true, false, 2, 86 )
	...
	self.close = function ( self )
		...
		CoD.LethalGrenadeCardWidget.super.close( self )
	end
