require( "ui.uieditor.widgets.CAC.CustomClassGridScreen.PrimaryWeapon.PrimaryWeaponModItemWidget_Internal" )

CoD.PrimaryWeaponModItemWidget = InheritFrom( LUI.UIElement )
CoD.PrimaryWeaponModItemWidget.new = function ( menu, controller )
	local self = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc( self, controller )
	end
	self:setUseStencil( false )
	self:setClass( CoD.PrimaryWeaponModItemWidget )
	self.id = "PrimaryWeaponModItemWidget"
	...
	local modItemWidget = CoD.PrimaryWeaponModItemWidget_Internal.new( menu, controller )
	...
	self.close = function ( self )
		...
		CoD.PrimaryWeaponModItemWidget.super.close( self )
	end
