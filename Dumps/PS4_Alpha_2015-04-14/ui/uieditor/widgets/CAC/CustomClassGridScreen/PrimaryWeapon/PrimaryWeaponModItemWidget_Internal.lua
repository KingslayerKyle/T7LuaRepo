...
CoD.PrimaryWeaponModItemWidget_Internal = InheritFrom( LUI.UIElement )
CoD.PrimaryWeaponModItemWidget_Internal.new = function ( menu, controller )
	local self = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc( self, controller )
	end
	self:setUseStencil( true )
	self:setClass( CoD.PrimaryWeaponModItemWidget_Internal )
	self.id = "PrimaryWeaponModItemWidget_Internal"
	...
	nameLabel:setRGB( 0.22, 0.23, 0.28 )
	...
	notAvailableLabel:setLeftRight( true, false, 3, 32 )
	notAvailableLabel:setTopBottom( false, true, -23, -3 )
	notAvailableLabel:setRGB( 0.34, 0.37, 0.46 )
	notAvailableLabel:setAlpha( 0 )
	notAvailableLabel:setText( Engine.Localize( "N/A" ) )
	...
	needsLabel:setLeftRight( true, false, 3, 26 )
	needsLabel:setTopBottom( false, true, -23, -3 )
	needsLabel:setRGB( 0.23, 0.25, 0.3 )
	needsLabel:setAlpha( 0 )
	needsLabel:setText( Engine.Localize( "WC" ) )
	...
	self.clipsPerState = {
		DefaultState = {
			DefaultClip = function ()
				...
				self.needsLabel:setRGB( 0.23, 0.25, 0.3 )
	...
	self.close = function ( self )
		...
		CoD.PrimaryWeaponModItemWidget_Internal.super.close( self )
	end
