require( "ui.uieditor.widgets.CAC.CustomClassGridScreen.TacticalGrenade.TacticalGrenadeModItemWidget_Internal" )

local PostLoadFunc = function ( self, controller )
	self.modItemWidget.navigation = {}
end

CoD.TacticalGrenadeModItemWidget = InheritFrom( LUI.UIElement )
CoD.TacticalGrenadeModItemWidget.new = function ( menu, controller )
	local self = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc( self, controller )
	end
	self:setUseStencil( false )
	self:setClass( CoD.TacticalGrenadeModItemWidget )
	self.id = "TacticalGrenadeModItemWidget"
	...
	local modItemWidget = CoD.TacticalGrenadeModItemWidget_Internal.new( menu, controller )
	...
	self.close = function ( self )
		...
		CoD.TacticalGrenadeModItemWidget.super.close( self )
	end
