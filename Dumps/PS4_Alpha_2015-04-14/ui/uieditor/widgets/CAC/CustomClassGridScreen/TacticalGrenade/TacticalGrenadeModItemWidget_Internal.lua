...
CoD.TacticalGrenadeModItemWidget_Internal = InheritFrom( LUI.UIElement )
CoD.TacticalGrenadeModItemWidget_Internal.new = function ( menu, controller )
	local self = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc( self, controller )
	end
	self:setUseStencil( true )
	self:setClass( CoD.TacticalGrenadeModItemWidget_Internal )
	self.id = "TacticalGrenadeModItemWidget_Internal"
	...
	notAvailableImage:setLeftRight( true, false, -56.5, 143.5 )
	notAvailableImage:setTopBottom( true, false, -18, 82 )
	...
	self.clipsPerState = {
		...
		Unavailable = {
			DefaultClip = function ()
				self:setupElementClipCounter( 8 )
				background:completeAnimation()
				self.background:setRGB( 0.04, 0.04, 0.04 )
				self.background:setAlpha( 0 )
				self.clipFinished( background, {} )
				notAvailableImage:completeAnimation()
				self.notAvailableImage:setAlpha( 0.2 )
	...
	self.close = function ( self )
		...
		CoD.TacticalGrenadeModItemWidget_Internal.super.close( self )
	end
