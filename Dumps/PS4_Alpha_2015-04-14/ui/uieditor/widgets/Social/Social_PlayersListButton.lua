...
CoD.Social_PlayersListButton.new = function ( menu, controller )
	...
	emblem:setLeftRight( true, false, 2, 105 )
	emblem:setTopBottom( true, true, 1.5, -3 )
	emblem:setRGB( 1, 1, 1 )
	...
	gamertag:setLeftRight( true, false, 115, 340 )
	gamertag:setTopBottom( false, false, -21, -1 )
	...
	presence:setLeftRight( true, false, 112, 370 )
	presence:setTopBottom( true, false, 35.5, 55.5 )
	...
	joinable:setLeftRight( false, false, 164, 180 )
	joinable:setTopBottom( true, false, 9.5, 33.5 )
	...
	self:registerEventHandler( "gain_focus", function ( self, event )
		if self.m_focusable and self.presence:processEvent( event ) then
			return true
		else
	...
	self.close = function ( self )
		...
		self.emblem:close()
		self.gamertag:close()
		CoD.Social_PlayersListButton.super.close( self )
	end
