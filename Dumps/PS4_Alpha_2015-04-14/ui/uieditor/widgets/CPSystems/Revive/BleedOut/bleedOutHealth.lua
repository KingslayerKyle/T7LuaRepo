...
CoD.bleedOutHealth.new = function ( menu, controller )
	...
	bleedOutBlurContainer0:setRGB( 1, 1, 1 )
	...
	bleedoutring3top0:setRGB( 1, 1, 1 )
	...
	bleedoutring3bottom0:setRGB( 1, 1, 1 )
	...
	bleedoutring3right0:setRGB( 1, 1, 1 )
	...
	bleedoutring3left0:setRGB( 1, 1, 1 )
	...
	bleedoutdot3:setRGB( 1, 1, 1 )
	self:addElement( bleedoutdot3 )
	self.bleedoutdot3 = bleedoutdot3
	
	local percentRing = LUI.UIImage.new()
	percentRing:setLeftRight( false, false, -72, 72 )
	percentRing:setTopBottom( false, false, -72, 72 )
	percentRing:setRGB( 1, 0.82, 0 )
	percentRing:setAlpha( 0.6 )
	percentRing:setImage( RegisterImage( "uie_t7_hud_cp_bleeding_out_progresscircle" ) )
	percentRing:setMaterial( LUI.UIImage.GetCachedMaterial( "uie_clock_normal" ) )
	percentRing:setShaderVector( 1, 0.5, 0, 0, 0 )
	percentRing:setShaderVector( 2, 0.5, 0, 0, 0 )
	percentRing:setShaderVector( 3, 0, 0, 0, 0 )
	percentRing:linkToElementModel( self, "clockPercent", true, function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
			percentRing:setShaderVector( 0, CoD.GetVectorComponentFromString( modelValue, 1 ), CoD.GetVectorComponentFromString( modelValue, 2 ), CoD.GetVectorComponentFromString( modelValue, 3 ), CoD.GetVectorComponentFromString( modelValue, 4 ) )
		end
	end )
	self:addElement( percentRing )
	self.percentRing = percentRing
	...
	self.clipsPerState = {
		DefaultState = {
			DefaultClip = function ()
				...
				percentRing:completeAnimation()
				self.percentRing:setAlpha( 0 )
				self.clipFinished( percentRing, {} )
			...
			BleedingOut = function ()
				...
				local percentRingFrame2 = function ( percentRing, event )
					local percentRingFrame3 = function ( percentRing, event )
						local percentRingFrame4 = function ( percentRing, event )
							local percentRingFrame5 = function ( percentRing, event )
								local percentRingFrame6 = function ( percentRing, event )
									if not event.interrupted then
										percentRing:beginAnimation( "keyframe", 70, false, false, CoD.TweenType.Linear )
									end
									percentRing:setRGB( 1, 0.82, 0 )
									percentRing:setAlpha( 0.6 )
									if event.interrupted then
										self.clipFinished( percentRing, event )
									else
										percentRing:registerEventHandler( "transition_complete_keyframe", self.clipFinished )
									end
								end
								
								if event.interrupted then
									percentRingFrame6( percentRing, event )
									return 
								else
									percentRing:beginAnimation( "keyframe", 110, false, false, CoD.TweenType.Linear )
									percentRing:setAlpha( 0.75 )
									percentRing:registerEventHandler( "transition_complete_keyframe", percentRingFrame6 )
								end
							end
							
							if event.interrupted then
								percentRingFrame5( percentRing, event )
								return 
							else
								percentRing:beginAnimation( "keyframe", 49, false, false, CoD.TweenType.Linear )
								percentRing:setAlpha( 0 )
								percentRing:registerEventHandler( "transition_complete_keyframe", percentRingFrame5 )
							end
						end
						
						if event.interrupted then
							percentRingFrame4( percentRing, event )
							return 
						else
							percentRing:beginAnimation( "keyframe", 19, false, false, CoD.TweenType.Linear )
							percentRing:setAlpha( 1 )
							percentRing:registerEventHandler( "transition_complete_keyframe", percentRingFrame4 )
						end
					end
					
					if event.interrupted then
						percentRingFrame3( percentRing, event )
						return 
					else
						percentRing:beginAnimation( "keyframe", 1480, false, false, CoD.TweenType.Linear )
						percentRing:registerEventHandler( "transition_complete_keyframe", percentRingFrame3 )
					end
				end
				
				percentRing:completeAnimation()
				self.percentRing:setRGB( 1, 0.82, 0 )
				self.percentRing:setAlpha( 0 )
				percentRingFrame2( percentRing, {} )
		...
		BleedingOut_Low = {
			DefaultClip = function ()
				...
				self.clipFinished( bleedoutdot3, {} )
				percentRing:completeAnimation()
				self.percentRing:setRGB( 1, 0, 0.01 )
				self.percentRing:setAlpha( 1 )
				self.clipFinished( percentRing, {} )
				bleedoutmainring1:completeAnimation()
				self.bleedoutmainring1:setZoom( 0 )
				self.clipFinished( bleedoutmainring1, {} )
			...
			Reviving = function ()
				...
				bleedoutdot3Frame2( bleedoutdot3, {} )
				percentRing:completeAnimation()
				self.percentRing:setRGB( 1, 1, 1 )
				self.percentRing:setAlpha( 0.6 )
				self.clipFinished( percentRing, {} )
				bleedoutmainring1:completeAnimation()
				...
				local percentRingFrame2 = function ( percentRing, event )
					local percentRingFrame3 = function ( percentRing, event )
						local percentRingFrame4 = function ( percentRing, event )
							local percentRingFrame5 = function ( percentRing, event )
								local percentRingFrame6 = function ( percentRing, event )
									local percentRingFrame7 = function ( percentRing, event )
										local percentRingFrame8 = function ( percentRing, event )
											local percentRingFrame9 = function ( percentRing, event )
												local percentRingFrame10 = function ( percentRing, event )
													local percentRingFrame11 = function ( percentRing, event )
														local percentRingFrame12 = function ( percentRing, event )
															if not event.interrupted then
																percentRing:beginAnimation( "keyframe", 200, false, false, CoD.TweenType.Linear )
															end
															percentRing:setRGB( 1, 0, 0.01 )
															percentRing:setAlpha( 0.6 )
															if event.interrupted then
																self.clipFinished( percentRing, event )
															else
														...
														if event.interrupted then
															percentRingFrame12( percentRing, event )
															return 
														else
															percentRing:beginAnimation( "keyframe", 110, false, false, CoD.TweenType.Linear )
															percentRing:setAlpha( 0 )
															percentRing:registerEventHandler( "transition_complete_keyframe", percentRingFrame12 )
														end
													end
													
													if event.interrupted then
														percentRingFrame11( percentRing, event )
														return 
													else
														percentRing:beginAnimation( "keyframe", 90, false, false, CoD.TweenType.Linear )
														percentRing:setAlpha( 0.6 )
														percentRing:registerEventHandler( "transition_complete_keyframe", percentRingFrame11 )
													end
												end
												
												if event.interrupted then
													percentRingFrame10( percentRing, event )
													return 
												else
													percentRing:beginAnimation( "keyframe", 199, false, false, CoD.TweenType.Linear )
													percentRing:setAlpha( 1 )
													percentRing:registerEventHandler( "transition_complete_keyframe", percentRingFrame10 )
												end
											end
											
											if event.interrupted then
												percentRingFrame9( percentRing, event )
												return 
											else
												percentRing:beginAnimation( "keyframe", 200, false, false, CoD.TweenType.Linear )
												percentRing:setAlpha( 0 )
												percentRing:registerEventHandler( "transition_complete_keyframe", percentRingFrame9 )
											end
										end
										
										if event.interrupted then
											percentRingFrame8( percentRing, event )
											return 
										else
											percentRing:beginAnimation( "keyframe", 199, false, false, CoD.TweenType.Linear )
											percentRing:setAlpha( 0.6 )
											percentRing:registerEventHandler( "transition_complete_keyframe", percentRingFrame8 )
										end
									end
									
									if event.interrupted then
										percentRingFrame7( percentRing, event )
										return 
									else
										percentRing:beginAnimation( "keyframe", 199, false, false, CoD.TweenType.Linear )
										percentRing:setAlpha( 0 )
										percentRing:registerEventHandler( "transition_complete_keyframe", percentRingFrame7 )
									end
								end
								...
								if event.interrupted then
									...
									percentRing:beginAnimation( "keyframe", 210, false, false, CoD.TweenType.Linear )
									percentRing:setRGB( 1, 0, 0.01 )
									percentRing:setAlpha( 0.6 )
									percentRing:registerEventHandler( "transition_complete_keyframe", percentRingFrame6 )
								end
							...
							if event.interrupted then
								...
								percentRing:beginAnimation( "keyframe", 89, false, false, CoD.TweenType.Linear )
								percentRing:setAlpha( 0 )
								percentRing:registerEventHandler( "transition_complete_keyframe", percentRingFrame5 )
							end
						end
						...
						if event.interrupted then
							...
							percentRing:beginAnimation( "keyframe", 109, false, false, CoD.TweenType.Linear )
							percentRing:setAlpha( 1 )
							percentRing:registerEventHandler( "transition_complete_keyframe", percentRingFrame4 )
						end
					end
	...
	self:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				return IsSelfModelValueTrue( element, controller, "bleedingOut" ) and IsSelfModelValueLessThanOrEqualTo( element, controller, "clockPercent", 0.3 )
			end
		},
		{
			stateName = "Reviving",
	...
	self.close = function ( self )
		self.bleedOutBlurContainer0:close()
		self.bleedoutcross0:close()
		self.bleedoutring10:close()
		self.bleedoutring20:close()
		self.bleedoutring3top0:close()
		self.bleedoutring3bottom0:close()
		self.bleedoutring3right0:close()
		self.bleedoutring3left0:close()
		self.bleedoutdot0:close()
		self.bleedoutdot1:close()
		self.bleedoutdot2:close()
		self.bleedoutdot3:close()
		self.bleedoutmainring1:close()
		self.percentRing:close()
		CoD.bleedOutHealth.super.close( self )
	end
