...
CoD.SpikeLauncherLine.new = function ( menu, controller )
	...
	SpikeLauncherLineTop0:setRGB( 1, 1, 1 )
	...
	self.close = function ( self )
		self.SpikeLauncherLineTop0:close()
		CoD.SpikeLauncherLine.super.close( self )
	end
