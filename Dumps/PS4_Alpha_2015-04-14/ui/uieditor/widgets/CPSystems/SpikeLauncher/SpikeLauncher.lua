...
CoD.SpikeLauncher.new = function ( menu, controller )
	...
	SpikeLauncherLine:setRGB( 1, 1, 1 )
	...
	DestroyLineBottom:setRGB( 1, 1, 1 )
	...
	self.clipsPerState = {
		...
		State1 = {
			...
			State2 = function ()
				...
				DestroyLineTop:setLeftRight( true, false, 71, 123.33 )
				DestroyLineTop:setTopBottom( true, false, 116.83, 120.17 )
				DestroyLineTop:setAlpha( 0 )
				...
				local SidesFrame2 = function ( Sides, event )
					if not event.interrupted then
						Sides:beginAnimation( "keyframe", 670, true, true, CoD.TweenType.Linear )
					end
					Sides:setLeftRight( true, false, 128, 195.85 )
				...
				Sides:setAlpha( 0 )
				Sides:registerEventHandler( "transition_complete_keyframe", SidesFrame2 )
				...
				local DistanceTextFrame2 = function ( DistanceText, event )
					if not event.interrupted then
						DistanceText:beginAnimation( "keyframe", 480, false, true, CoD.TweenType.Back )
					end
					DistanceText:setLeftRight( true, false, 213.61, 265 )
				...
				DistanceText:registerEventHandler( "transition_complete_keyframe", DistanceTextFrame2 )
				...
				local ArrowRightFrame2 = function ( ArrowRight, event )
					local ArrowRightFrame3 = function ( ArrowRight, event )
						...
						if event.interrupted then
							...
							ArrowRight:setLeftRight( true, false, 197.67, 191 )
		...
		State2 = {
			DefaultClip = function ()
				...
				self.DestroyLineTop:setTopBottom( true, false, 116.83, 120.17 )
			...
			State1 = function ()
				...
				local ArrowRightFrame2 = function ( ArrowRight, event )
					local ArrowRightFrame3 = function ( ArrowRight, event )
						local ArrowRightFrame4 = function ( ArrowRight, event )
							local ArrowRightFrame5 = function ( ArrowRight, event )
								local ArrowRightFrame6 = function ( ArrowRight, event )
									if not event.interrupted then
										ArrowRight:beginAnimation( "keyframe", 69, true, true, CoD.TweenType.Linear )
									end
									ArrowRight:setLeftRight( true, false, 197.67, 191 )
									ArrowRight:setTopBottom( true, false, 119.66, 133 )
									ArrowRight:setAlpha( 1 )
									ArrowRight:setZRot( 0 )
									if event.interrupted then
										self.clipFinished( ArrowRight, event )
									else
										ArrowRight:registerEventHandler( "transition_complete_keyframe", self.clipFinished )
								...
								if event.interrupted then
									...
									ArrowRight:beginAnimation( "keyframe", 19, false, false, CoD.TweenType.Linear )
									ArrowRight:registerEventHandler( "transition_complete_keyframe", ArrowRightFrame6 )
								end
							end
							...
							if event.interrupted then
								...
								ArrowRight:beginAnimation( "keyframe", 160, false, false, CoD.TweenType.Linear )
								ArrowRight:setLeftRight( true, false, 197.67, 191 )
								ArrowRight:registerEventHandler( "transition_complete_keyframe", ArrowRightFrame5 )
							end
						end
						...
						if event.interrupted then
							...
							ArrowRight:beginAnimation( "keyframe", 160, false, false, CoD.TweenType.Linear )
							ArrowRight:setLeftRight( true, false, 214.5, 207.83 )
							ArrowRight:setAlpha( 1 )
							ArrowRight:registerEventHandler( "transition_complete_keyframe", ArrowRightFrame4 )
						end
					end
					...
					if event.interrupted then
						...
						ArrowRight:beginAnimation( "keyframe", 259, false, false, CoD.TweenType.Linear )
						ArrowRight:setLeftRight( true, false, 231.32, 224.65 )
						ArrowRight:registerEventHandler( "transition_complete_keyframe", ArrowRightFrame3 )
					end
				end
				...
				ArrowRight:setAlpha( 0 )
				ArrowRight:setZRot( 180 )
				ArrowRight:registerEventHandler( "transition_complete_keyframe", ArrowRightFrame2 )
			end,
			State3 = function ()
				self:setupElementClipCounter( 21 )
				VignetteState1:completeAnimation()
				...
				local CircleAnimFrame2 = function ( CircleAnim, event )
					if not event.interrupted then
						CircleAnim:beginAnimation( "keyframe", 449, false, false, CoD.TweenType.Linear )
					end
					CircleAnim:setRGB( 1, 1, 1 )
				...
				CircleAnim:setAlpha( 0.5 )
				CircleAnim:setZoom( -150 )
				CircleAnim:registerEventHandler( "transition_complete_keyframe", CircleAnimFrame2 )
				local BackBoxFrame2 = function ( BackBox, event )
					if not event.interrupted then
				...
				local LargeTriangleFrame2 = function ( LargeTriangle, event )
					if not event.interrupted then
						LargeTriangle:beginAnimation( "keyframe", 539, false, false, CoD.TweenType.Linear )
					end
					LargeTriangle:setLeftRight( true, false, 61, 264.95 )
					LargeTriangle:setTopBottom( true, false, 71.89, 238.91 )
					LargeTriangle:setAlpha( 1 )
					if event.interrupted then
				...
				LargeTriangle:setTopBottom( true, false, 71.89, 238.91 )
				LargeTriangle:setAlpha( 0 )
				LargeTriangle:registerEventHandler( "transition_complete_keyframe", LargeTriangleFrame2 )
				local TriangleTopFrame2 = function ( TriangleTop, event )
					if not event.interrupted then
				...
				local iconDestroyFrame2 = function ( iconDestroy, event )
					if not event.interrupted then
						iconDestroy:beginAnimation( "keyframe", 519, false, true, CoD.TweenType.Back )
					end
					iconDestroy:setAlpha( 1 )
					iconDestroy:setYRot( 0 )
					if event.interrupted then
						self.clipFinished( iconDestroy, event )
					else
						iconDestroy:registerEventHandler( "transition_complete_keyframe", self.clipFinished )
					end
				end
				...
				iconDestroy:setAlpha( 0 )
				iconDestroy:setYRot( -90 )
				iconDestroy:registerEventHandler( "transition_complete_keyframe", iconDestroyFrame2 )
				...
				local MetersFrame2 = function ( Meters, event )
					if not event.interrupted then
						Meters:beginAnimation( "keyframe", 459, false, false, CoD.TweenType.Linear )
						Meters.MetersBase:beginAnimation( "subkeyframe", 459, false, false, CoD.TweenType.Linear )
						Meters.MetersTop:beginAnimation( "subkeyframe", 459, false, false, CoD.TweenType.Linear )
					end
					Meters:setAlpha( 1 )
					Meters.MetersBase:setAlpha( 1 )
					Meters.MetersTop:setAlpha( 1 )
					if event.interrupted then
						self.clipFinished( Meters, event )
					else
						Meters:registerEventHandler( "transition_complete_keyframe", self.clipFinished )
					end
				end
				...
				Meters.MetersBase:setAlpha( 0 )
				Meters.MetersTop:setAlpha( 0 )
				Meters:registerEventHandler( "transition_complete_keyframe", MetersFrame2 )
				local DestroyLineTopFrame2 = function ( DestroyLineTop, event )
					if not event.interrupted then
						DestroyLineTop:beginAnimation( "keyframe", 400, false, true, CoD.TweenType.Back )
					end
					DestroyLineTop:setLeftRight( true, false, 71, 123.33 )
					DestroyLineTop:setTopBottom( true, false, 87.84, 91.16 )
					DestroyLineTop:setAlpha( 1 )
					if event.interrupted then
						self.clipFinished( DestroyLineTop, event )
					else
						DestroyLineTop:registerEventHandler( "transition_complete_keyframe", self.clipFinished )
					end
				end
				...
				DestroyLineTop:setTopBottom( true, false, 116.84, 120.17 )
				DestroyLineTop:setAlpha( 0 )
				DestroyLineTop:registerEventHandler( "transition_complete_keyframe", DestroyLineTopFrame2 )
				local DestroyLineBottomFrame2 = function ( DestroyLineBottom, event )
					if not event.interrupted then
						DestroyLineBottom:beginAnimation( "keyframe", 379, false, true, CoD.TweenType.Back )
					end
					DestroyLineBottom:setLeftRight( true, false, 71, 123.33 )
					DestroyLineBottom:setTopBottom( true, false, 164, 160.84 )
					DestroyLineBottom:setAlpha( 1 )
					if event.interrupted then
						self.clipFinished( DestroyLineBottom, event )
					else
						DestroyLineBottom:registerEventHandler( "transition_complete_keyframe", self.clipFinished )
					end
				end
				...
				DestroyLineBottom:setTopBottom( true, false, 136, 132.84 )
				DestroyLineBottom:setAlpha( 0 )
				DestroyLineBottom:registerEventHandler( "transition_complete_keyframe", DestroyLineBottomFrame2 )
				local ArrowLeftFrame2 = function ( ArrowLeft, event )
				...
				local SidesFrame2 = function ( Sides, event )
					if not event.interrupted then
						Sides:beginAnimation( "keyframe", 399, false, true, CoD.TweenType.Back )
					end
					Sides:setLeftRight( true, false, 128, 195.85 )
					Sides:setTopBottom( true, false, 104.16, 153.83 )
					Sides:setAlpha( 1 )
				...
				local AreaTextFrame2 = function ( AreaText, event )
					if not event.interrupted then
						AreaText:beginAnimation( "keyframe", 370, false, true, CoD.TweenType.Linear )
					end
					AreaText:setLeftRight( true, false, 48.16, 145.16 )
					AreaText:setTopBottom( true, false, 97.83, 152.83 )
					AreaText:setAlpha( 1 )
					if event.interrupted then
				...
				AreaText:setTopBottom( true, false, 96.84, 151.84 )
				AreaText:setAlpha( 0 )
				AreaText:registerEventHandler( "transition_complete_keyframe", AreaTextFrame2 )
				local DistanceTextFrame2 = function ( DistanceText, event )
					if not event.interrupted then
				...
				self.DistanceText:setAlpha( 1 )
				DistanceTextFrame2( DistanceText, {} )
				local DataTextFrame2 = function ( DataText, event )
					if not event.interrupted then
						DataText:beginAnimation( "keyframe", 399, false, true, CoD.TweenType.Linear )
					end
					DataText:setLeftRight( true, false, 169.94, 290 )
					DataText:setTopBottom( true, false, 146, 225 )
					DataText:setAlpha( 1 )
					if event.interrupted then
						self.clipFinished( DataText, event )
					else
						DataText:registerEventHandler( "transition_complete_keyframe", self.clipFinished )
					end
				end
				...
				DataText:setTopBottom( true, false, 146.83, 225.83 )
				DataText:setAlpha( 0 )
				DataText:registerEventHandler( "transition_complete_keyframe", DataTextFrame2 )
				local MessageTextFrame2 = function ( MessageText, event )
					local MessageTextFrame3 = function ( MessageText, event )
		...
		State3 = {
			...
			State2 = function ()
				...
				local CircleAnimFrame2 = function ( CircleAnim, event )
					if not event.interrupted then
						CircleAnim:beginAnimation( "keyframe", 590, true, true, CoD.TweenType.Linear )
					end
					CircleAnim:setRGB( 1, 1, 1 )
					CircleAnim:setAlpha( 0.5 )
					CircleAnim:setZoom( -150 )
				...
				local BackBoxFrame2 = function ( BackBox, event )
					if not event.interrupted then
						BackBox:beginAnimation( "keyframe", 509, true, true, CoD.TweenType.Linear )
					end
					BackBox:setLeftRight( true, false, 123, 200.94 )
					BackBox:setTopBottom( true, false, 93.83, 158.83 )
					BackBox:setAlpha( 1 )
				...
				BackBox:setTopBottom( true, false, 93.83, 158.83 )
				BackBox:setAlpha( 1 )
				BackBox:registerEventHandler( "transition_complete_keyframe", BackBoxFrame2 )
				local LargeTriangleFrame2 = function ( LargeTriangle, event )
					if not event.interrupted then
				...
				local IconWeakFrame2 = function ( IconWeak, event )
					if not event.interrupted then
						IconWeak:beginAnimation( "keyframe", 439, false, true, CoD.TweenType.Back )
					end
					IconWeak:setAlpha( 1 )
					IconWeak:setYRot( 0 )
					if event.interrupted then
				...
				IconWeak:setAlpha( 1 )
				IconWeak:setYRot( -90 )
				IconWeak:registerEventHandler( "transition_complete_keyframe", IconWeakFrame2 )
				local iconDestroyFrame2 = function ( iconDestroy, event )
					if not event.interrupted then
						iconDestroy:beginAnimation( "keyframe", 259, false, true, CoD.TweenType.Back )
					end
					iconDestroy:setAlpha( 0 )
					iconDestroy:setYRot( -90 )
					if event.interrupted then
				...
				local MetersFrame2 = function ( Meters, event )
					if not event.interrupted then
						Meters:beginAnimation( "keyframe", 370, true, true, CoD.TweenType.Linear )
						Meters.MetersBase:beginAnimation( "subkeyframe", 370, true, true, CoD.TweenType.Linear )
						Meters.MetersTop:beginAnimation( "subkeyframe", 370, true, true, CoD.TweenType.Linear )
					end
					Meters:setAlpha( 1 )
					Meters.MetersBase:setAlpha( 0 )
					Meters.MetersTop:setAlpha( 0 )
				...
				local DestroyLineTopFrame2 = function ( DestroyLineTop, event )
					if not event.interrupted then
						DestroyLineTop:beginAnimation( "keyframe", 390, true, false, CoD.TweenType.Linear )
					end
					DestroyLineTop:setLeftRight( true, false, 71, 123.33 )
					DestroyLineTop:setTopBottom( true, false, 116.83, 120.17 )
					DestroyLineTop:setAlpha( 0 )
				...
				local DestroyLineBottomFrame2 = function ( DestroyLineBottom, event )
					if not event.interrupted then
						DestroyLineBottom:beginAnimation( "keyframe", 370, true, false, CoD.TweenType.Linear )
					end
					DestroyLineBottom:setLeftRight( true, false, 71, 123.33 )
					DestroyLineBottom:setTopBottom( true, false, 136, 132.84 )
					DestroyLineBottom:setAlpha( 0 )
				...
				local DataTextFrame2 = function ( DataText, event )
					if not event.interrupted then
						DataText:beginAnimation( "keyframe", 569, true, false, CoD.TweenType.Linear )
					end
					DataText:setLeftRight( true, false, 75.92, 195.98 )
					DataText:setTopBottom( true, false, 146.83, 225.83 )
					DataText:setAlpha( 0 )
				...
				local MessageTextFrame2 = function ( MessageText, event )
					local MessageTextFrame3 = function ( MessageText, event )
						local MessageTextFrame4 = function ( MessageText, event )
							local MessageTextFrame5 = function ( MessageText, event )
								local MessageTextFrame6 = function ( MessageText, event )
									local MessageTextFrame7 = function ( MessageText, event )
										local MessageTextFrame8 = function ( MessageText, event )
											local MessageTextFrame9 = function ( MessageText, event )
												if not event.interrupted then
													MessageText:beginAnimation( "keyframe", 129, false, false, CoD.TweenType.Linear )
													MessageText.LineLowerL:beginAnimation( "subkeyframe", 129, false, false, CoD.TweenType.Linear )
													MessageText.LineLowerM:beginAnimation( "subkeyframe", 129, false, false, CoD.TweenType.Linear )
													MessageText.LineLowerR:beginAnimation( "subkeyframe", 129, false, false, CoD.TweenType.Linear )
													MessageText.DescLbl:beginAnimation( "subkeyframe", 129, false, false, CoD.TweenType.Linear )
												end
												MessageText:setLeftRight( true, false, 206.5, 329.49 )
												MessageText:setTopBottom( true, false, 115.5, 140.83 )
												MessageText:setAlpha( 1 )
											...
											if event.interrupted then
												...
												MessageText.LineLowerR:beginAnimation( "subkeyframe", 129, false, false, CoD.TweenType.Linear )
												MessageText.DescLbl:beginAnimation( "subkeyframe", 129, false, false, CoD.TweenType.Linear )
												MessageText:setLeftRight( true, false, 206.5, 325.44 )
												MessageText.LineLowerL:setRGB( 0.95, 0.46, 0.14 )
												MessageText.LineLowerM:setRGB( 0.95, 0.46, 0.14 )
												MessageText.LineLowerR:setRGB( 0.95, 0.46, 0.14 )
												MessageText.DescLbl:setText( Engine.Localize( "W E A K N E S S" ) )
												MessageText:registerEventHandler( "transition_complete_keyframe", MessageTextFrame9 )
											end
										end
										...
										if event.interrupted then
											...
											MessageText:beginAnimation( "keyframe", 60, false, false, CoD.TweenType.Linear )
											MessageText.LineLowerL:beginAnimation( "subkeyframe", 60, false, false, CoD.TweenType.Linear )
											MessageText.LineLowerM:beginAnimation( "subkeyframe", 60, false, false, CoD.TweenType.Linear )
											MessageText.LineLowerR:beginAnimation( "subkeyframe", 60, false, false, CoD.TweenType.Linear )
											MessageText.DescLbl:beginAnimation( "subkeyframe", 60, false, false, CoD.TweenType.Linear )
											MessageText:setLeftRight( true, false, 206.5, 321.39 )
											MessageText.LineLowerL:setRGB( 0.9, 0.37, 0.13 )
											MessageText.LineLowerM:setRGB( 0.9, 0.37, 0.13 )
											MessageText.LineLowerR:setRGB( 0.9, 0.37, 0.13 )
											MessageText.DescLbl:setText( Engine.Localize( "W W K N E E" ) )
											MessageText:registerEventHandler( "transition_complete_keyframe", MessageTextFrame8 )
										end
									end
									...
									if event.interrupted then
										...
										MessageText.LineLowerR:beginAnimation( "subkeyframe", 19, false, false, CoD.TweenType.Linear )
										MessageText.DescLbl:beginAnimation( "subkeyframe", 19, false, false, CoD.TweenType.Linear )
										MessageText:setLeftRight( true, false, 206.5, 319.53 )
										MessageText.LineLowerL:setRGB( 0.88, 0.33, 0.13 )
										MessageText.LineLowerM:setRGB( 0.88, 0.33, 0.13 )
										MessageText.LineLowerR:setRGB( 0.88, 0.33, 0.13 )
										MessageText.DescLbl:setText( Engine.Localize( "D S T R Y W" ) )
										MessageText:registerEventHandler( "transition_complete_keyframe", MessageTextFrame7 )
									end
								end
								...
								if event.interrupted then
									...
									MessageText:beginAnimation( "keyframe", 20, false, false, CoD.TweenType.Linear )
									MessageText.LineLowerL:beginAnimation( "subkeyframe", 20, false, false, CoD.TweenType.Linear )
									MessageText.LineLowerM:beginAnimation( "subkeyframe", 20, false, false, CoD.TweenType.Linear )
									MessageText.LineLowerR:beginAnimation( "subkeyframe", 20, false, false, CoD.TweenType.Linear )
									MessageText.DescLbl:beginAnimation( "subkeyframe", 20, false, false, CoD.TweenType.Linear )
									MessageText:setLeftRight( true, false, 206.5, 318.9 )
									MessageText.LineLowerL:setRGB( 0.88, 0.31, 0.13 )
									MessageText.LineLowerM:setRGB( 0.88, 0.31, 0.13 )
									MessageText.LineLowerR:setRGB( 0.88, 0.31, 0.13 )
									MessageText.DescLbl:setText( Engine.Localize( "W K N R O Y" ) )
									MessageText:registerEventHandler( "transition_complete_keyframe", MessageTextFrame6 )
								end
							end
							...
							if event.interrupted then
								...
								MessageText:beginAnimation( "keyframe", 29, false, false, CoD.TweenType.Linear )
								MessageText.LineLowerL:beginAnimation( "subkeyframe", 29, false, false, CoD.TweenType.Linear )
								MessageText.LineLowerM:beginAnimation( "subkeyframe", 29, false, false, CoD.TweenType.Linear )
								MessageText.LineLowerR:beginAnimation( "subkeyframe", 29, false, false, CoD.TweenType.Linear )
								MessageText.DescLbl:beginAnimation( "subkeyframe", 29, false, false, CoD.TweenType.Linear )
								MessageText:setLeftRight( true, false, 206.5, 318.28 )
								MessageText.LineLowerL:setRGB( 0.87, 0.3, 0.13 )
								MessageText.LineLowerM:setRGB( 0.87, 0.3, 0.13 )
								MessageText.LineLowerR:setRGB( 0.87, 0.3, 0.13 )
								MessageText.DescLbl:setText( Engine.Localize( "D E S T R O Y" ) )
						...
						if event.interrupted then
							...
							MessageText:beginAnimation( "keyframe", 9, false, false, CoD.TweenType.Linear )
							MessageText.LineLowerL:beginAnimation( "subkeyframe", 9, false, false, CoD.TweenType.Linear )
							MessageText.LineLowerM:beginAnimation( "subkeyframe", 9, false, false, CoD.TweenType.Linear )
							MessageText.LineLowerR:beginAnimation( "subkeyframe", 9, false, false, CoD.TweenType.Linear )
							MessageText.DescLbl:beginAnimation( "subkeyframe", 9, false, false, CoD.TweenType.Linear )
							MessageText:setLeftRight( true, false, 206.5, 317.34 )
							MessageText.LineLowerL:setRGB( 0.86, 0.28, 0.13 )
							MessageText.LineLowerM:setRGB( 0.86, 0.28, 0.13 )
							MessageText.LineLowerR:setRGB( 0.86, 0.28, 0.13 )
							MessageText.DescLbl:setText( Engine.Localize( "W E A T R Y" ) )
							MessageText:registerEventHandler( "transition_complete_keyframe", MessageTextFrame4 )
						end
					end
					...
					if event.interrupted then
						...
						MessageText:beginAnimation( "keyframe", 210, true, true, CoD.TweenType.Linear )
						MessageText.LineLowerL:beginAnimation( "subkeyframe", 210, true, true, CoD.TweenType.Linear )
						MessageText.LineLowerM:beginAnimation( "subkeyframe", 210, true, true, CoD.TweenType.Linear )
						MessageText.LineLowerR:beginAnimation( "subkeyframe", 210, true, true, CoD.TweenType.Linear )
						MessageText:setLeftRight( true, false, 206.5, 317.03 )
						MessageText.LineLowerL:setRGB( 0.85, 0.27, 0.13 )
						MessageText.LineLowerM:setRGB( 0.85, 0.27, 0.13 )
						MessageText.LineLowerR:setRGB( 0.85, 0.27, 0.13 )
						MessageText:registerEventHandler( "transition_complete_keyframe", MessageTextFrame3 )
				...
				MessageText.LineLowerR:setRGB( 0.78, 0.13, 0.13 )
				MessageText.DescLbl:setText( Engine.Localize( "D E S T R O Y" ) )
				MessageText:registerEventHandler( "transition_complete_keyframe", MessageTextFrame2 )
				local DataTextState2Frame2 = function ( DataTextState2, event )
					if not event.interrupted then
	...
	self.close = function ( self )
		self.CircleAnim:close()
		self.BackBox:close()
		self.SpikeLauncherLine:close()
		self.Meters:close()
		self.Sides:close()
		self.AreaText:close()
		self.DistanceText:close()
		self.DataText:close()
		self.MessageText:close()
		CoD.SpikeLauncher.super.close( self )
	end
