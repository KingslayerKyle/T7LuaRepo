...
CoD.SpikeLuancherSpikeCounter_TitleReady.new = function ( menu, controller )
	...
	Ready:setMaterial( LUI.UIImage.GetCachedMaterial( "ui_normal" ) )
	...
	Blast:setMaterial( LUI.UIImage.GetCachedMaterial( "ui_normal" ) )
