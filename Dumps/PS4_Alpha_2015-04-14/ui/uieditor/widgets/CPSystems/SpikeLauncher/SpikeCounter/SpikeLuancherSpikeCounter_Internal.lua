...
CoD.SpikeLuancherSpikeCounter_Internal.new = function ( menu, controller )
	...
	ImgMain:setRGB( 1, 1, 1 )
	ImgMain:setImage( RegisterImage( "uie_t7_cp_hud_system_spikelaunchercounter_main" ) )
	ImgMain:setMaterial( LUI.UIImage.GetCachedMaterial( "ui_normal" ) )
	...
	self.close = function ( self )
		self.MeterFill0:close()
		self.MeterFill1:close()
		self.MeterFill2:close()
		self.MeterFill3:close()
		self.MeterFill4:close()
		self.MeterBlast:close()
		self.TitleReady:close()
		self.Meter1:close()
		self.Meter2:close()
		self.Meter3:close()
		self.Meter4:close()
		self.Meter5:close()
		CoD.SpikeLuancherSpikeCounter_Internal.super.close( self )
	end
