...
CoD.EnemyTarget_Target.new = function ( menu, controller )
	...
	Target0:setRGB( 1, 1, 1 )
	Target0:setAlpha( RandomAddPercent( 1, -40 ) )
		...
		DefaultState = {
			DefaultClip = function ()
				...
				local Target0Frame2 = function ( Target0, event )
					...
					Target0:setAlpha( RandomAddPercent( 0.99, -40 ) )
				...
				self.Target0:setAlpha( RandomAddPercent( 1, -40 ) )
