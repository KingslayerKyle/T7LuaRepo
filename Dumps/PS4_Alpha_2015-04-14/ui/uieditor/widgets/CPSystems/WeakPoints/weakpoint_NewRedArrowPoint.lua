...
CoD.weakpoint_NewRedArrowPoint.new = function ( menu, controller )
	...
	weakpointNewRedArrow1:setRGB( 1, 1, 1 )
	...
	weakpointNewRedArrow2:setRGB( 1, 1, 1 )
	...
	self.close = function ( self )
		self.weakpointNewRedArrow1:close()
		self.weakpointNewRedArrow2:close()
		CoD.weakpoint_NewRedArrowPoint.super.close( self )
	end
