...
CoD.weakpoint_NewArrowSmallContainer.new = function ( menu, controller )
	...
	weakpointNewArrowSmall0:setRGB( 1, 1, 1 )
	...
	weakpointNewArrowSmall1:setRGB( 1, 1, 1 )
	...
	self.close = function ( self )
		self.weakpointNewArrowSmall0:close()
		self.weakpointNewArrowSmall1:close()
		CoD.weakpoint_NewArrowSmallContainer.super.close( self )
	end
