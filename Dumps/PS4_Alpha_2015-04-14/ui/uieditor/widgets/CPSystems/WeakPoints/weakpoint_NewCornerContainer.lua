...
CoD.weakpoint_NewCornerContainer.new = function ( menu, controller )
	...
	weakpointNewCorner0:setRGB( 1, 1, 1 )
	...
	weakpointNewCorner1:setRGB( 1, 1, 1 )
	...
	weakpointNewCorner2:setRGB( 1, 1, 1 )
	...
	weakpointNewCorner3:setRGB( 1, 1, 1 )
	weakpointNewCorner3:setZRot( 176 )
	self:addElement( weakpointNewCorner3 )
	self.weakpointNewCorner3 = weakpointNewCorner3
	
	self.close = function ( self )
		self.weakpointNewCorner0:close()
		self.weakpointNewCorner1:close()
		self.weakpointNewCorner2:close()
		self.weakpointNewCorner3:close()
		CoD.weakpoint_NewCornerContainer.super.close( self )
	end
