...
CoD.weakpointIndicator.new = function ( menu, controller )
	...
	weakpointNewRedLineH0:setRGB( 1, 1, 1 )
	...
	weakpointNewRedLineV0:setRGB( 1, 1, 1 )
	...
	weakpointNewRedLineV1:setRGB( 1, 1, 1 )
	...
	weakpointNewRedLineH1:setRGB( 1, 1, 1 )
	...
	weakpointNewRedLineContainer0:setRGB( 1, 1, 1 )
	...
	weakpointNewRedLineContainer1:setRGB( 1, 1, 1 )
	...
	weakpointNewRedArrow0:setRGB( 1, 1, 1 )
	...
	weakpointNewRedArrow5:setRGB( 1, 1, 1 )
	...
	weakpointNewRedArrowPoint0:setRGB( 1, 1, 1 )
	...
	weakpointNewRedArrowPoint1:setRGB( 1, 1, 1 )
	...
	self.clipsPerState = {
		DefaultState = {
			DefaultClip = function ()
				...
				self.weakpointNewDashEl00:setLeftRight( false, false, -8, 28 )
			...
			DefaultState = function ()
				...
				local weakpointNewDashEl00Frame2 = function ( weakpointNewDashEl00, event )
					local weakpointNewDashEl00Frame3 = function ( weakpointNewDashEl00, event )
						...
						weakpointNewDashEl00:setLeftRight( false, false, -8, 28 )
						weakpointNewDashEl00:setTopBottom( false, false, -7, 9 )
						weakpointNewDashEl00:setAlpha( 0 )
						if event.interrupted then
							self.clipFinished( weakpointNewDashEl00, event )
	...
	self.close = function ( self )
		self.Diagonals:close()
		self.weakpointNewArrowSmallContainer0:close()
		self.weakpointNewCornerContainer0:close()
		self.weakpointNewDashContainer0:close()
		self.weakpointNewHex0:close()
		self.weakpointNewRedLineH0:close()
		self.weakpointNewRedLineV0:close()
		self.weakpointNewRedLineV1:close()
		self.weakpointNewRedLineH1:close()
		self.weakpointNewRedLineContainer0:close()
		self.weakpointNewRedLineContainer1:close()
		self.weakpointNewDashEl0:close()
		self.weakpointNewDashEl1:close()
		self.weakpointNewThickPlus0:close()
		self.weakpointNewRedArrow0:close()
		self.weakpointNewRedArrow5:close()
		self.weakpointNewRedArrowPoint0:close()
		self.weakpointNewRedArrowPoint1:close()
		self.weakpointNewDashEl00:close()
		self.weakpointNewDashEl10:close()
		CoD.weakpointIndicator.super.close( self )
	end
