...
CoD.weakpoint_NewDashContainer.new = function ( menu, controller )
	...
	weakpointNewDash0:setRGB( 1, 1, 1 )
	...
	weakpointNewDash1:setRGB( 1, 1, 1 )
	...
	weakpointNewDash2:setRGB( 1, 1, 1 )
	...
	weakpointNewDash3:setRGB( 1, 1, 1 )
	...
	self.close = function ( self )
		self.weakpointNewDash0:close()
		self.weakpointNewDash1:close()
		self.weakpointNewDash2:close()
		self.weakpointNewDash3:close()
		CoD.weakpoint_NewDashContainer.super.close( self )
	end
