...
CoD.StartMenu_Options_Slider.new = function ( menu, controller )
	...
	Slider:setTopBottom( true, false, 6, 49 )
	Slider:setRGB( 1, 1, 1 )
	...
	Image0:setTopBottom( true, false, 45, 53 )
	Image0:setRGB( 1, 1, 1 )
	...
	Image00:setTopBottom( true, false, 46, 54 )
	...
	self.clipsPerState = {
		DefaultState = {
			DefaultClip = function ()
				...
				self.Slider:setLeftRight( true, false, 357.27, 525.27 )
				self.Slider:setTopBottom( true, false, 6, 49 )
	...
	self.close = function ( self )
		...
		self.Title:close()
		CoD.StartMenu_Options_Slider.super.close( self )
	end
