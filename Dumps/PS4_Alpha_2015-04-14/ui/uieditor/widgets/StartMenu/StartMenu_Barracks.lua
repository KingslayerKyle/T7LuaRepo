...
CoD.StartMenu_Barracks.new = function ( menu, controller )
	...
	CP:setRGB( 1, 1, 1 )
	CP.Title0:setText( Engine.Localize( "MENU_CAMPAIGN_CAPS" ) )
	...
	CP:subscribeToGlobalModel( controller, "StorageGlobal", "stats_cp_offline", function ( model )
		...
		if modelValue then
			CP.RankName:setText( Engine.Localize( RankToTitleString( StorageLookup( modelValue, controller, "playerstatslist.rank.statvalue" ), "cp" ) ) )
		end
	end )
	CP:subscribeToGlobalModel( controller, "StorageGlobal", "stats_cp_offline", function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
			CP.Rank:setText( Engine.Localize( RankToLevelString( StorageLookup( modelValue, controller, "playerstatslist.rank.statvalue" ), "cp" ) ) )
		end
	end )
	self:addElement( CP )
	self.CP = CP
	...
	MP:setRGB( 1, 1, 1 )
	MP.Title0:setText( Engine.Localize( "MENU_MULTIPLAYER_CAPS" ) )
	...
	MP:subscribeToGlobalModel( controller, "StorageGlobal", "stats_mp", function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
			MP.RankName:setText( Engine.Localize( RankToTitleString( StorageLookup( modelValue, controller, "playerstatslist.rank.statvalue" ), "mp" ) ) )
		end
	end )
	MP:subscribeToGlobalModel( controller, "StorageGlobal", "stats_mp", function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
			MP.Rank:setText( Engine.Localize( RankToLevelString( StorageLookup( modelValue, controller, "playerstatslist.rank.statvalue" ), "mp" ) ) )
		end
	end )
	self:addElement( MP )
	self.MP = MP
	...
	ZM:setRGB( 1, 1, 1 )
	ZM.Title0:setText( Engine.Localize( "MENU_ZOMBIE_CAPS" ) )
	...
	ZM:subscribeToGlobalModel( controller, "StorageGlobal", "stats_zm", function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
			ZM.RankName:setText( Engine.Localize( RankToTitleString( StorageLookup( modelValue, controller, "playerstatslist.rank.statvalue" ), "zm" ) ) )
		end
	end )
	ZM:subscribeToGlobalModel( controller, "StorageGlobal", "stats_zm", function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
			ZM.Rank:setText( Engine.Localize( RankToLevelString( StorageLookup( modelValue, controller, "playerstatslist.rank.statvalue" ), "zm" ) ) )
		end
	end )
	self:addElement( ZM )
	self.ZM = ZM
	...
	self.close = function ( self )
		...
		self.SPM:close()
		self.WL:close()
		CoD.StartMenu_Barracks.super.close( self )
	end
