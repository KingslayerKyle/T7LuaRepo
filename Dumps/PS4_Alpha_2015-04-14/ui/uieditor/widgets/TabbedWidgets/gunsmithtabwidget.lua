...
CoD.gunsmithTabWidget = InheritFrom( LUI.UIElement )
CoD.gunsmithTabWidget.new = function ( menu, controller )
	local self = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc( self, controller )
	end
	self:setUseStencil( false )
	self:setClass( CoD.gunsmithTabWidget )
	self.id = "gunsmithTabWidget"
	...
	self.close = function ( self )
		...
		CoD.gunsmithTabWidget.super.close( self )
	end
