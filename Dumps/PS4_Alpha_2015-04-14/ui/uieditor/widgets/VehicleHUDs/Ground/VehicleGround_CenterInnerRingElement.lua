...
CoD.VehicleGround_CenterInnerRingElement.new = function ( menu, controller )
	...
	InnerRingElement:setLeftRight( false, false, -3.5, 28.5 )
	InnerRingElement:setTopBottom( false, false, -34.5, -2.5 )
	InnerRingElement:setRGB( 1, 1, 1 )
	...
	Image0:setLeftRight( false, false, -28.5, -20.5 )
	Image0:setTopBottom( false, false, 26.5, 34.5 )
	Image0:setRGB( 1, 1, 1 )
	Image0:setAlpha( 0.5 )
