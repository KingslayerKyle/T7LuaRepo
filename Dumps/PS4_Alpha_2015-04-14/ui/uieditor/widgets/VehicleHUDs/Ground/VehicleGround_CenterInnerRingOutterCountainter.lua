...
CoD.VehicleGround_CenterInnerRingOutterCountainter.new = function ( menu, controller )
	...
	self.close = function ( self )
		self.InnerRingIn:close()
		self.InnerRingOutter:close()
		CoD.VehicleGround_CenterInnerRingOutterCountainter.super.close( self )
	end
