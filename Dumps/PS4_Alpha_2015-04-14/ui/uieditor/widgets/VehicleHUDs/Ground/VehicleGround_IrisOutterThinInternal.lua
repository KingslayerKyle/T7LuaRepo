...
CoD.VehicleGround_IrisOutterThinInternal.new = function ( menu, controller )
	...
	VehicleGroundIrisOutterThin0:setLeftRight( true, false, 0, 1421 )
	VehicleGroundIrisOutterThin0:setTopBottom( true, false, 0, 943 )
	VehicleGroundIrisOutterThin0:setRGB( 1, 1, 1 )
	...
	self.close = function ( self )
		self.VehicleGroundIrisOutterThin0:close()
		CoD.VehicleGround_IrisOutterThinInternal.super.close( self )
	end
