...
CoD.VehicleGround_HashText.new = function ( menu, controller )
	...
	VehicleGroundHashTextInternal0:setRGB( 1, 1, 1 )
	...
	Image0:setLeftRight( true, false, 16, 26 )
	Image0:setTopBottom( true, false, 1, 42 )
	Image0:setRGB( 1, 1, 1 )
	Image0:setZRot( 90 )
	...
	Image1:setLeftRight( true, false, 16, 22 )
	Image1:setTopBottom( true, false, -19.5, 21.5 )
	Image1:setRGB( 1, 1, 1 )
	Image1:setZRot( -90 )
	...
	self.close = function ( self )
		self.VehicleGroundHashTextInternal0:close()
		CoD.VehicleGround_HashText.super.close( self )
	end
