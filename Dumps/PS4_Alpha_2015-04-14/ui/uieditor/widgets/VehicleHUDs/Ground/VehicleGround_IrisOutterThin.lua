...
CoD.VehicleGround_IrisOutterThin.new = function ( menu, controller )
	...
	Image0:setLeftRight( false, false, -730.5, -485.75 )
	Image0:setTopBottom( false, false, -471.5, 471.5 )
	...
	Image1:setLeftRight( false, false, 485.5, 730.25 )
	Image1:setTopBottom( false, false, -471.5, 471.5 )
	Image1:setRGB( 1, 1, 1 )
	Image1:setZRot( -180 )
