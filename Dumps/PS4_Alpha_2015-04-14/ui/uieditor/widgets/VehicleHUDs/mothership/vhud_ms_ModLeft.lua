...
require( "ui.uieditor.widgets.VehicleHUDs.mothership.vhud_ms_ModDNI" )
...
CoD.vhud_ms_ModLeft.new = function ( menu, controller )
	...
	VehicleGroundModT60:setRGB( 1, 1, 1 )
	...
	VehicleGroundModT50:setRGB( 1, 1, 1 )
	...
	VehicleGroundModT40:setRGB( 1, 1, 1 )
	...
	VehicleGroundModT30:setRGB( 1, 1, 1 )
	...
	VehicleGroundModT20:setRGB( 1, 1, 1 )
	...
	VehicleGroundModT10:setRGB( 1, 1, 1 )
	VehicleGroundModT10:setAlpha( 0 )
	self:addElement( VehicleGroundModT10 )
	self.VehicleGroundModT10 = VehicleGroundModT10
	
	local vhudmsModDNI0 = CoD.vhud_ms_ModDNI.new( menu, controller )
	vhudmsModDNI0:setLeftRight( true, false, 0, 52 )
	vhudmsModDNI0:setTopBottom( true, false, 1, 58 )
	vhudmsModDNI0:setRGB( 1, 1, 1 )
	self:addElement( vhudmsModDNI0 )
	self.vhudmsModDNI0 = vhudmsModDNI0
	...
	self.close = function ( self )
		self.VehicleGroundModT60:close()
		self.VehicleGroundModT50:close()
		self.VehicleGroundModT40:close()
		self.VehicleGroundModT30:close()
		self.VehicleGroundModT20:close()
		self.VehicleGroundModT10:close()
		self.vhudmsModDNI0:close()
		CoD.vhud_ms_ModLeft.super.close( self )
	end
