...
CoD.vhud_ms_ReticleLineHostUR.new = function ( menu, controller )
	...
	Image0:setLeftRight( false, false, -77.5, 77.5 )
	Image0:setTopBottom( false, false, -28.42, 28.68 )
	...
	msReticleHostUpperR:setLeftRight( false, false, -77.5, 77.5 )
	msReticleHostUpperR:setTopBottom( false, false, -28.55, 28.55 )
