...
CoD.vhud_ms_FrameTopRightxml.new = function ( menu, controller )
	...
	msTopFrameRight:setLeftRight( false, false, -240.39, 240.39 )
	msTopFrameRight:setTopBottom( false, false, -72.5, 72.5 )
	msTopFrameRight:setRGB( 0.74, 0.94, 0.99 )
	msTopFrameRight:setAlpha( 0.5 )
	msTopFrameRight:setImage( RegisterImage( "uie_t7_cp_hud_vehicle_mothership_topframeside" ) )
