...
CoD.vhud_ms_HelpButtonContainerRight = InheritFrom( LUI.UIElement )
CoD.vhud_ms_HelpButtonContainerRight.new = function ( menu, controller )
	local self = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc( self, controller )
	end
	self:setUseStencil( false )
	self:setClass( CoD.vhud_ms_HelpButtonContainerRight )
	self.id = "vhud_ms_HelpButtonContainerRight"
	...
	HelpButtonShader:linkToElementModel( self, "imageText", true, function ( model )
		...
		if modelValue then
			HelpButtonShader.buttonText:setText( Engine.Localize( modelValue ) )
		end
	end )
	...
	self.close = function ( self )
		self.HelpButtonShader:close()
		self.text:close()
		CoD.vhud_ms_HelpButtonContainerRight.super.close( self )
	end
