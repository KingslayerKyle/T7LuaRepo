...
CoD.vhud_ms_ReticleLineHostLR.new = function ( menu, controller )
	...
	Host:setLeftRight( false, false, -77.71, 77.71 )
	Host:setTopBottom( false, false, -28.5, 28.76 )
	...
	msReticleHostLowerR:setLeftRight( false, false, -77.71, 77.71 )
	msReticleHostLowerR:setTopBottom( false, false, -28.63, 28.63 )
