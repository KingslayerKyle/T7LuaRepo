...
CoD.vhud_ms_FrameTopCenter.new = function ( menu, controller )
	...
	Image0:setLeftRight( false, false, -259.5, 259.56 )
	Image0:setTopBottom( false, false, -32, 31.88 )
	...
	msTopFrameCenter:setLeftRight( false, false, -259.5, 259.56 )
	msTopFrameCenter:setTopBottom( false, false, -32, 31.88 )
