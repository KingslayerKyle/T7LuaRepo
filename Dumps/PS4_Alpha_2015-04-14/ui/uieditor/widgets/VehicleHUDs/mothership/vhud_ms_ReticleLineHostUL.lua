...
CoD.vhud_ms_ReticleLineHostUL.new = function ( menu, controller )
	...
	Image0:setLeftRight( false, false, -77.71, 77.71 )
	Image0:setTopBottom( false, false, -28.5, 28.76 )
	...
	msReticleHostUpperL:setLeftRight( false, false, -77.71, 77.71 )
	msReticleHostUpperL:setTopBottom( false, false, -28.63, 28.63 )
