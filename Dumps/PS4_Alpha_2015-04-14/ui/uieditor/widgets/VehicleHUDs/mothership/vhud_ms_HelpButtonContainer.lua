...
CoD.vhud_ms_HelpButtonContainer = InheritFrom( LUI.UIElement )
CoD.vhud_ms_HelpButtonContainer.new = function ( menu, controller )
	local self = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc( self, controller )
	end
	self:setUseStencil( false )
	self:setClass( CoD.vhud_ms_HelpButtonContainer )
	self.id = "vhud_ms_HelpButtonContainer"
	...
	self.close = function ( self )
		...
		self.text:close()
		CoD.vhud_ms_HelpButtonContainer.super.close( self )
	end
