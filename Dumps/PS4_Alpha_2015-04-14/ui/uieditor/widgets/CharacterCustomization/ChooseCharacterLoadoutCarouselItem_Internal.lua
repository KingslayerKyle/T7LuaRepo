...
CoD.ChooseCharacterLoadoutCarouselItem_Internal.new = function ( menu, controller )
	...
	chooseCharacterVignette:setRGB( 1, 1, 1 )
	...
	apeRender:setRGB( 1, 1, 1 )
	apeRender:setAlpha( 0 )
	apeRender:setMaterial( LUI.UIImage.GetCachedMaterial( "ui_normal" ) )
	...
	infoArea:setTopBottom( true, false, 0, 500 )
	...
	self.close = function ( self )
		...
		CoD.ChooseCharacterLoadoutCarouselItem_Internal.super.close( self )
	end
