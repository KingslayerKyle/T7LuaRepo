...
CoD.PersonalizeCharacterCarouselItem_InfoPanel.new = function ( menu, controller )
	...
	selectedShowcaseWeapon:setRGB( 1, 1, 1 )
	...
	self.close = function ( self )
		...
		CoD.PersonalizeCharacterCarouselItem_InfoPanel.super.close( self )
	end
