...
CoD.overCapacityScorestreakInfo.new = function ( menu, controller )
	...
	cacButtonBoxLrgInactiveStroke:setRGB( 1, 1, 1 )
	...
	descText:setRGB( 1, 1, 1 )
	descText:setTTF( "fonts/Entovo.ttf" )
	...
	descText:linkToElementModel( self, "itemIndex", true, function ( model )
		...
		if modelValue then
			descText:setText( Engine.Localize( LocalizeIntoString( GetScorestreakMomentumFromIndex( modelValue ), "MENU_SCORE_REQUIRED" ) ) )
		end
	end )
	...
	self.close = function ( self )
		...
		CoD.overCapacityScorestreakInfo.super.close( self )
	end
