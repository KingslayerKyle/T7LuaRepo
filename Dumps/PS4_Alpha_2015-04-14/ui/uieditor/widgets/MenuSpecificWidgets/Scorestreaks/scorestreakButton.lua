...
CoD.scorestreakButton.new = function ( menu, controller )
	...
	equippedIcon:setImage( RegisterImage( "uie_t7_hud_scorestreak_equipped_16" ) )
	...
	self.clipsPerState = {
		...
		Locked = {
			DefaultClip = function ()
				...
				self.clipFinished( BoxButtonLrgInactiveDiag, {} )
				BoxButtonLrgInactive:completeAnimation()
				self.BoxButtonLrgInactive:setAlpha( 0.25 )
				self.clipFinished( BoxButtonLrgInactive, {} )
				lockedIcon:completeAnimation()
	...
	self:registerEventHandler( "gain_focus", function ( self, event )
		if self.m_focusable and self.name:processEvent( event ) then
			return true
		else
	...
	self.close = function ( self )
		...
		self.name:close()
		self.image:close()
		CoD.scorestreakButton.super.close( self )
	end
