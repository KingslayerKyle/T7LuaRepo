...
CoD.PartyList_PlayerScore.new = function ( menu, controller )
	...
	self.clipsPerState = {
		...
		IsSelf = {
			DefaultClip = function ()
				...
				self.Panel:setTopBottom( true, false, -1.66, 22 )
				self.Panel:setAlpha( 1 )
				self.clipFinished( Panel, {} )
				ScoreInternal:completeAnimation()
				ScoreInternal.Gamertag:completeAnimation()
				...
				self.ScoreInternal:setShaderVector( 0, 0.2, 0, 0, 0 )
				self.ScoreInternal:setShaderVector( 1, 0, 0, 0, 0 )
				self.ScoreInternal:setShaderVector( 2, 0, 0, 0, 0 )
				self.ScoreInternal:setShaderVector( 3, 0, 0, 0, 0 )
	...
	self.close = function ( self )
		...
		CoD.PartyList_PlayerScore.super.close( self )
	end
