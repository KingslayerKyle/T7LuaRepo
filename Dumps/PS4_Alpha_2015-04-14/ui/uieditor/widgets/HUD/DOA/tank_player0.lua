...
CoD.tank_player0 = InheritFrom( LUI.UIElement )
CoD.tank_player0.new = function ( menu, controller )
	local self = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc( self, controller )
	end
	self:setUseStencil( false )
	self:setClass( CoD.tank_player0 )
	self.id = "tank_player0"
	self.soundSet = "HUD"
	self:setLeftRight( true, false, 0, 316 )
	self:setTopBottom( true, false, 0, 31 )
	
	local PlayerName = LUI.UIText.new()
	PlayerName:setLeftRight( true, false, -85, 261.5 )
	PlayerName:setTopBottom( true, false, -60, -30 )
	...
	healthBar:setLeftRight( true, false, -1, 79.13 )
	...
	health:setLeftRight( true, false, -2, 78.13 )
	...
	fuel:setLeftRight( true, false, -102, -77 )
	...
	fuelBar:setLeftRight( true, false, -95, -88 )
	...
	self.close = function ( self )
		...
		CoD.tank_player0.super.close( self )
	end
