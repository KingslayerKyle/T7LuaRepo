...
CoD.score_lower.new = function ( menu, controller )
	...
	lives:linkToElementModel( self, "lives", true, function ( model )
		...
		if modelValue then
			lives:setText( Engine.Localize( modelValue ) )
		end
	end )
	...
	bombs:setTopBottom( true, false, 19.5, 55.5 )
	bombs:setRGB( 1, 1, 1 )
	...
	bombs:linkToElementModel( self, "bombs", true, function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
			bombs:setText( Engine.Localize( modelValue ) )
		end
	end )
	...
	boost:setTopBottom( true, false, 19.5, 55.5 )
	boost:setRGB( 1, 1, 1 )
	...
	boost:linkToElementModel( self, "boosts", true, function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
			boost:setText( Engine.Localize( modelValue ) )
		end
	end )
	...
	points:setLeftRight( true, false, 154.75, 379.25 )
	...
	points:linkToElementModel( self, "score", true, function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
			points:setText( Engine.Localize( modelValue ) )
		end
	end )
	...
	multiplier:setLeftRight( true, false, 353.75, 375.75 )
	multiplier:setTopBottom( true, false, -17, 3 )
	...
	multiplier:linkToElementModel( self, "multiplier", true, function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
			multiplier:setText( Engine.Localize( modelValue ) )
		end
	end )
	...
	Label0:setLeftRight( true, false, 348.75, 359.75 )
	Label0:setTopBottom( true, false, -25.28, 6.22 )
	Label0:setRGB( 1, 1, 1 )
	...
	PlayerName:setLeftRight( true, false, 4.75, 351.25 )
	...
	bulletbar1:setLeftRight( true, false, 4.75, 337.75 )
	bulletbar1:setTopBottom( true, false, -26.25, -11.25 )
	...
	self.close = function ( self )
		...
		CoD.score_lower.super.close( self )
	end
