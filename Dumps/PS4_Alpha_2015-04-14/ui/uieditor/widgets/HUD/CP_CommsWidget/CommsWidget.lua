...
CoD.CommsWidget.new = function ( menu, controller )
	...
	CharacterBack:setLeftRight( true, false, 303.33, 483.66 )
	CharacterBack:setTopBottom( true, false, 11.81, 177.14 )
	CharacterBack:setRGB( 1, 1, 1 )
	...
	CharacterImages:setLeftRight( true, false, 321.57, 481.66 )
	CharacterImages:setTopBottom( true, false, 14, 144.36 )
	CharacterImages:setRGB( 1, 1, 1 )
	CharacterImages:setZoom( 50 )
	...
	ImgArrow:setLeftRight( true, false, 207.17, 213.84 )
	ImgArrow:setTopBottom( true, false, 71.2, 76.53 )
	...
	RingContainer:setLeftRight( true, false, 342.49, 446.49 )
	RingContainer:setTopBottom( true, false, 24.53, 128.53 )
	RingContainer:setRGB( 1, 1, 1 )
	...
	CharacterText0:setLeftRight( false, true, -271, -149.51 )
	CharacterText0:setTopBottom( true, false, 46.86, 68.77 )
	CharacterText0:setRGB( 1, 1, 1 )
	CharacterText0:setZoom( 5 )
	CharacterText0:linkToElementModel( self, "characterName", true, function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
			CharacterText0.CommsName:setText( Engine.Localize( modelValue ) )
		end
	end )
	...
	CharacterSpeech:setLeftRight( true, false, 200, 221 )
	CharacterSpeech:setTopBottom( true, false, 46.87, 67.77 )
	CharacterSpeech:setRGB( 1, 1, 1 )
	...
	WaveFormFore:setLeftRight( true, false, 298.98, 490.01 )
	WaveFormFore:setTopBottom( true, false, -13.89, 177.14 )
	WaveFormFore:setRGB( 1, 1, 1 )
	...
	WaveFormFore:setShaderVector( 0, 1, 1.35, 0, 0 )
	...
	self.clipsPerState = {
		DefaultState = {
			...
			HudStart = function ()
				...
				RingContainer:completeAnimation()
				self.RingContainer:setLeftRight( true, false, 342.49, 446.49 )
				self.RingContainer:setTopBottom( true, false, 24.53, 128.53 )
				self.RingContainer:setAlpha( 0 )
	...
	self.close = function ( self )
		self.CharacterBack:close()
		self.CharacterImages:close()
		self.ImgArrow:close()
		self.RingContainer:close()
		self.CharacterText0:close()
		self.CharacterSpeech:close()
		self.Dot1:close()
		self.Dot2:close()
		self.Dot3:close()
		self.Dot4:close()
		CoD.CommsWidget.super.close( self )
	end
