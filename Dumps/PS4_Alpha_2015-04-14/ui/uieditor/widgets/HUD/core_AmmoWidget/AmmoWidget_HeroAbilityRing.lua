...
CoD.AmmoWidget_HeroAbilityRing.new = function ( menu, controller )
	...
	HeroRingGold2:subscribeToGlobalModel( controller, "PlayerAbilities", "playerGadget3.powerRatio", function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
			HeroRingGold2:setShaderVector( 0, CoD.GetVectorComponentFromString( modelValue, 1 ), CoD.GetVectorComponentFromString( modelValue, 2 ), CoD.GetVectorComponentFromString( modelValue, 3 ), CoD.GetVectorComponentFromString( modelValue, 4 ) )
		end
	end )
	...
	HeroRingGoldWeapon:setRGB( 1, 1, 1 )
	...
	AbilitySwirl0:setLeftRight( false, true, -108, -12 )
	...
	ImgRingDeplete00:subscribeToGlobalModel( controller, "PlayerAbilities", "playerGadget3.powerRatio", function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
			ImgRingDeplete00:setShaderVector( 0, CoD.GetVectorComponentFromString( modelValue, 1 ), CoD.GetVectorComponentFromString( modelValue, 2 ), CoD.GetVectorComponentFromString( modelValue, 3 ), CoD.GetVectorComponentFromString( modelValue, 4 ) )
		end
	end )
	...
	self.close = function ( self )
		self.HeroRingGoldWeapon:close()
		self.HeroRingImage:close()
		self.HeroRingGold:close()
		self.HeroRingGold2:close()
		self.ImgRingDeplete00:close()
		CoD.AmmoWidget_HeroAbilityRing.super.close( self )
	end
