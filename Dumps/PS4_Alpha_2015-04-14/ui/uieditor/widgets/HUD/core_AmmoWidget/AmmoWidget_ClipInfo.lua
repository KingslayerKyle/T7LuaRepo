...
CoD.AmmoWidget_ClipInfo.new = function ( menu, controller )
	...
	Knife:setShaderVector( 2, 17, 0, 0, 0 )
	...
	AmmoColorBar:setLeftRight( true, false, 19, 139 )
	AmmoColorBar:setTopBottom( true, false, 53, 57 )
	...
	ClipMeter:setLeftRight( true, false, 19, 85 )
	ClipMeter:setTopBottom( true, false, 53, 57 )
	...
	self.clipsPerState = {
		...
		HeroWeapon = {
			DefaultClip = function ()
				...
				self.clipFinished( TotalAmmo, {} )
				AmmoColorBar:completeAnimation()
				self.AmmoColorBar:setLeftRight( true, false, 19, 139 )
				self.AmmoColorBar:setTopBottom( true, false, 53, 57 )
				self.clipFinished( AmmoColorBar, {} )
				ClipMeter:completeAnimation()
				self.ClipMeter:setLeftRight( true, false, 19, 85 )
				self.ClipMeter:setTopBottom( true, false, 53, 57 )
				self.clipFinished( ClipMeter, {} )
			end
		}
	}
	...
	self.close = function ( self )
		...
		CoD.AmmoWidget_ClipInfo.super.close( self )
	end
