...
CoD.AmmoWidget_ClipContainerDummyxml = InheritFrom( LUI.UIElement )
CoD.AmmoWidget_ClipContainerDummyxml.new = function ( menu, controller )
	local self = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc( self, controller )
	end
	self:setUseStencil( false )
	self:setClass( CoD.AmmoWidget_ClipContainerDummyxml )
	self.id = "AmmoWidget_ClipContainerDummyxml"
	...
	self.close = function ( self )
		self.Clip:close()
		CoD.AmmoWidget_ClipContainerDummyxml.super.close( self )
	end
