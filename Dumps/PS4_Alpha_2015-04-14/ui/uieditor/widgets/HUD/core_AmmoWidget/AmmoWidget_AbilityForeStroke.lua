...
CoD.AmmoWidget_AbilityForeStroke.new = function ( menu, controller )
	...
	local ImgAbilityForeStroke = LUI.UIImage.new()
	ImgAbilityForeStroke:setLeftRight( true, true, 0, 0 )
	ImgAbilityForeStroke:setTopBottom( true, true, 0, 0 )
	ImgAbilityForeStroke:setRGB( 1, 1, 1 )
	ImgAbilityForeStroke:setImage( RegisterImage( "uie_t7_core_hud_ammowidget_abilitystrokefore" ) )
	ImgAbilityForeStroke:setMaterial( LUI.UIImage.GetCachedMaterial( "ui_add" ) )
	self:addElement( ImgAbilityForeStroke )
	self.ImgAbilityForeStroke = ImgAbilityForeStroke
