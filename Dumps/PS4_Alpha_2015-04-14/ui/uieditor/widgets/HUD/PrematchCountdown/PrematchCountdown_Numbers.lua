...
CoD.PrematchCountdown_Numbers.new = function ( menu, controller )
	...
	Numbers:setShaderVector( 4, 0.24, 0.02, 0, 0 )
	...
	self.close = function ( self )
		...
		self.Numbers:close()
		self.MatchText:close()
		self.Dot61:close()
		self.Dot600:close()
		self.Dot62:close()
		self.Dot601:close()
		self.LineTop:close()
		CoD.PrematchCountdown_Numbers.super.close( self )
	end
