CoD.KnifeProto = InheritFrom( LUI.UIElement )
CoD.KnifeProto.new = function ( menu, controller )
	local self = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc( self, controller )
	end
	self:setUseStencil( false )
	self:setClass( CoD.KnifeProto )
	self.id = "KnifeProto"
	...
	Knife:setMaterial( LUI.UIImage.GetCachedMaterial( "ui_normal" ) )
