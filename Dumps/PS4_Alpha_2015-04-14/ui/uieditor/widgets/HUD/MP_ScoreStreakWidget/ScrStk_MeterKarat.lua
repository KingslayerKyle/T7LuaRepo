...
CoD.ScrStk_MeterKarat.new = function ( menu, controller )
	...
	FocusMeterFillWhite0:setRGB( 1, 1, 1 )
	FocusMeterFillWhite0:setImage( RegisterImage( "uie_t7_mp_hud_scorestreak_focusmeterbit" ) )
	FocusMeterFillWhite0:setMaterial( LUI.UIImage.GetCachedMaterial( "ui_normal" ) )
	...
	ScrStkMeterKaratInner0:setRGB( 1, 1, 1 )
	...
	ScrStkMeterKaratInner00:setRGB( 1, 1, 1 )
	...
	self.close = function ( self )
		self.ScrStkMeterKaratInner0:close()
		self.ScrStkMeterKaratInner00:close()
		CoD.ScrStk_MeterKarat.super.close( self )
	end
