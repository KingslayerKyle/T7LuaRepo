...
CoD.ScrStk_MeterKaratInner.new = function ( menu, controller )
	...
	ScrStkCombatEfficiencyScrollFX000:setRGB( 1, 1, 1 )
	...
	ScrStkCombatEfficiencyScrollFX0000:setRGB( 1, 1, 1 )
	...
	self.close = function ( self )
		self.ScrStkCombatEfficiencyScrollFX000:close()
		self.ScrStkCombatEfficiencyScrollFX0000:close()
		CoD.ScrStk_MeterKaratInner.super.close( self )
	end
