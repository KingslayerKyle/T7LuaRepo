...
CoD.ScrStk_Meter.new = function ( menu, controller )
	...
	ScrStkMeterPanel0:setLeftRight( true, false, 33, 39 )
	ScrStkMeterPanel0:setTopBottom( true, false, 9, 129 )
	ScrStkMeterPanel0:setRGB( 1, 1, 1 )
	...
	ScrStkNumberMove0:setLeftRight( true, false, -7, 48 )
	ScrStkNumberMove0:setTopBottom( true, false, 0, 21.5 )
	ScrStkNumberMove0:setRGB( 1, 1, 1 )
	ScrStkNumberMove0.TextBox:setRGB( 1, 1, 1 )
	...
	self.close = function ( self )
		self.ScrStkMeterPanel0:close()
		self.ScrStkNumberMove0:close()
		self.Meter:close()
		CoD.ScrStk_Meter.super.close( self )
	end
