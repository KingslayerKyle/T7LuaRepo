...
CoD.ScoreInfo_RdTri.new = function ( menu, controller )
	...
	TriFill:setRGB( 1, 1, 1 )
	TriFill:setImage( RegisterImage( "uie_t7_core_hud_scorewidget_rdtrifill" ) )
	TriFill:setMaterial( LUI.UIImage.GetCachedMaterial( "ui_normal" ) )
