...
CoD.RoundsContainer.new = function ( menu, controller )
	...
	Overtime:setRGB( 1, 1, 1 )
	Overtime:setAlpha( 0 )
	Overtime:setText( Engine.Localize( "MP_OVERTIME_CAPS" ) )
	Overtime:setTTF( "fonts/Entovo.ttf" )
	...
	self.close = function ( self )
		self.Rounds:close()
		self.RoundsUnlimited:close()
		self.TriCont:close()
		CoD.RoundsContainer.super.close( self )
	end
