...
CoD.ScoreInfo_UserScorePanel.new = function ( menu, controller )
	...
	PanelScale2:setLeftRight( false, false, -41, 19 )
	PanelScale2:setTopBottom( false, false, -17, 14 )
	...
	self.clipsPerState = {
		...
		Count3 = {
			DefaultClip = function ()
				self:setupElementClipCounter( 2 )
				PanelScale2:completeAnimation()
				self.PanelScale2:setLeftRight( false, false, -41, 19 )
				self.PanelScale2:setTopBottom( false, false, -17, 14 )
				self.clipFinished( PanelScale2, {} )
				PanelScale1:completeAnimation()
				self.PanelScale1:setLeftRight( false, false, -124, -39 )
		...
		Count4 = {
			DefaultClip = function ()
				self:setupElementClipCounter( 2 )
				PanelScale2:completeAnimation()
				self.PanelScale2:setLeftRight( false, false, -21, 39 )
				self.PanelScale2:setTopBottom( false, false, -17, 14 )
				self.clipFinished( PanelScale2, {} )
				PanelScale1:completeAnimation()
				self.PanelScale1:setLeftRight( false, false, -124, -19 )
				self.PanelScale1:setTopBottom( false, false, -22, 14 )
				self.clipFinished( PanelScale1, {} )
			end
		},
		Count5 = {
			DefaultClip = function ()
				self:setupElementClipCounter( 2 )
				PanelScale2:completeAnimation()
				self.PanelScale2:setLeftRight( false, false, -1, 59 )
				self.PanelScale2:setTopBottom( false, false, -17, 14 )
				self.clipFinished( PanelScale2, {} )
				PanelScale1:completeAnimation()
				self.PanelScale1:setLeftRight( false, false, -124, 1 )
				self.PanelScale1:setTopBottom( false, false, -22, 14 )
				self.clipFinished( PanelScale1, {} )
			end
		},
		Count6 = {
			DefaultClip = function ()
				self:setupElementClipCounter( 2 )
				PanelScale2:completeAnimation()
				self.PanelScale2:setLeftRight( false, false, 19, 79 )
				self.PanelScale2:setTopBottom( false, false, -17, 14 )
				self.clipFinished( PanelScale2, {} )
				PanelScale1:completeAnimation()
				self.PanelScale1:setLeftRight( false, false, -124, 21 )
				self.PanelScale1:setTopBottom( false, false, -22, 14 )
				self.clipFinished( PanelScale1, {} )
			end
		},
		Count7 = {
			DefaultClip = function ()
				self:setupElementClipCounter( 2 )
				PanelScale2:completeAnimation()
				self.PanelScale2:setLeftRight( false, false, 39, 99 )
				self.PanelScale2:setTopBottom( false, false, -17, 14 )
				self.clipFinished( PanelScale2, {} )
				PanelScale1:completeAnimation()
				self.PanelScale1:setLeftRight( false, false, -124, 41 )
				self.PanelScale1:setTopBottom( false, false, -22, 14 )
				self.clipFinished( PanelScale1, {} )
			end
		}
	...
	self.close = function ( self )
		...
		CoD.ScoreInfo_UserScorePanel.super.close( self )
	end
