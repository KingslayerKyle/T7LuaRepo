...
CoD.DamageWidget_HealthState.new = function ( menu, controller )
	...
	ImgStateShape:setMaterial( LUI.UIImage.GetCachedMaterial( "ui_normal" ) )
	...
	self.close = function ( self )
		self.HealthStateRegen:close()
		CoD.DamageWidget_HealthState.super.close( self )
	end
