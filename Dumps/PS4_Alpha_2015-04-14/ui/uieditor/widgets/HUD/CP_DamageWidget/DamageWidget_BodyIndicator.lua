...
CoD.DamageWidget_BodyIndicator.new = function ( menu, controller )
	...
	ImgBodyFull:setRGB( 1, 1, 1 )
	ImgBodyFull:setImage( RegisterImage( "uie_t7_cp_hud_damagewidget_bodyfull" ) )
	ImgBodyFull:setMaterial( LUI.UIImage.GetCachedMaterial( "ui_normal" ) )
	...
	self.close = function ( self )
		self.BodyIndicatorQ1:close()
		self.BodyIndicatorQ4:close()
		self.BodyIndicatorQ2:close()
		self.BodyIndicatorQ3:close()
		CoD.DamageWidget_BodyIndicator.super.close( self )
	end
