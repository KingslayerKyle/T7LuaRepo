...
CoD.DamageWidget.new = function ( menu, controller )
	...
	EnviroHazardContainer:setRGB( 1, 1, 1 )
	...
	self.clipsPerState = {
		DefaultState = {
			DefaultClip = function ()
				...
				self.PanelContainer:setTopBottom( true, false, 6.67, 101.33 )
			...
			Invisible = function ()
				...
				local PanelContainerFrame2 = function ( PanelContainer, event )
					...
					PanelContainer:setTopBottom( true, false, 6.67, 101.33 )
	...
	self.close = function ( self )
		...
		self.HealthState:close()
		self.Repair:close()
		self.BodyIndicatorSolid:close()
		self.BodyIndicator:close()
		self.EnviroHazardContainer:close()
		self.Dot1:close()
		self.Dot2:close()
		self.Dot3:close()
		self.Dot4:close()
		self.Dot5:close()
		self.Dot6:close()
		CoD.DamageWidget.super.close( self )
	end
