...
local PreLoadFunc = function ( self, controller )
	...
	if Engine.GetModel( hudItemsModel, "hess2.ratio" ) == nil then
		Engine.SetModelValue( Engine.CreateModel( hudItemsModel, "hess1.type" ), 0 )
		Engine.SetModelValue( Engine.CreateModel( hudItemsModel, "hess1.ratio" ), 0.5 )
		Engine.SetModelValue( Engine.CreateModel( hudItemsModel, "hess2.type" ), 0 )
		Engine.SetModelValue( Engine.CreateModel( hudItemsModel, "hess2.ratio" ), 0.5 )
	end
end
...
CoD.DamageWidgetContainer.new = function ( menu, controller )
	...
	DamageWidget:setRGB( 1, 1, 1 )
	DamageWidget:setAlpha( 0.2 )
	DamageWidget:setXRot( 38 )
	DamageWidget:setYRot( 45 )
	...
	self.close = function ( self )
		self.DamageWidget:close()
		CoD.DamageWidgetContainer.super.close( self )
	end
