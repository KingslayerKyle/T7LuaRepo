...
CoD.woundedSoldier_EKG.new = function ( menu, controller )
	...
	Solid:setRGB( 0, 0, 0 )
	Solid:setMaterial( LUI.UIImage.GetCachedMaterial( "ui_normal" ) )
	...
	Grid1:setMaterial( LUI.UIImage.GetCachedMaterial( "ui_normal" ) )
	...
	Grid2:setMaterial( LUI.UIImage.GetCachedMaterial( "ui_normal" ) )
	...
	SideMaskR2:setRGB( 1, 1, 1 )
	SideMaskR2:setImage( RegisterImage( "uie_t7_cp_hud_woundedsoldier_sidemask" ) )
	SideMaskR2:setMaterial( LUI.UIImage.GetCachedMaterial( "ui_normal" ) )
	...
	SideMaskL2:setRGB( 1, 1, 1 )
	SideMaskL2:setImage( RegisterImage( "uie_t7_cp_hud_woundedsoldier_sidemask" ) )
	SideMaskL2:setMaterial( LUI.UIImage.GetCachedMaterial( "ui_normal" ) )
