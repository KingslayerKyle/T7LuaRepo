...
CoD.SPMGraphWidget.new = function ( menu, controller )
	...
	LastMatchScore:setLeftRight( true, false, 53.25, 135.25 )
	...
	SecondLastMatchScore:setLeftRight( true, false, 131, 189 )
	...
	ThirdLastMatchScore:setLeftRight( true, false, 205.75, 263.75 )
	...
	Segment4:setLeftRight( true, false, 283, 358 )
	...
	self.close = function ( self )
		...
		self.Segment3:close()
		self.Segment4:close()
		CoD.SPMGraphWidget.super.close( self )
	end
