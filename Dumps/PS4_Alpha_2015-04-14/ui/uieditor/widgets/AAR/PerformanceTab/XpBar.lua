...
CoD.XpBar.new = function ( menu, controller )
	...
	XpBarBg:setMaterial( LUI.UIImage.GetCachedMaterial( "ui_normal" ) )
	...
	XpBarEarnedXPBg:setRGB( 0, 0.62, 0.83 )
	XpBarEarnedXPBg:setMaterial( LUI.UIImage.GetCachedMaterial( "uie_wipe" ) )
	XpBarEarnedXPBg:setShaderVector( 0, 0.54, 0, 0, 0 )
	...
	XpBarCurrXPBg:setMaterial( LUI.UIImage.GetCachedMaterial( "uie_wipe" ) )
	XpBarCurrXPBg:setShaderVector( 0, 0.36, 0, 0, 0 )
