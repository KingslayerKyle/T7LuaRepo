...
CoD.ChallengeWidget.new = function ( menu, controller )
	...
	RewardsTextBg:setMaterial( LUI.UIImage.GetCachedMaterial( "ui_normal" ) )
	...
	ChallengeImage:setRGB( 1, 1, 1 )
	ChallengeImage:setMaterial( LUI.UIImage.GetCachedMaterial( "ui_normal" ) )
	...
	ChallengeDescription:setRGB( 1, 1, 1 )
	...
	self.close = function ( self )
		self.Border:close()
		CoD.ChallengeWidget.super.close( self )
	end
