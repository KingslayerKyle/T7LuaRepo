...
CoD.ArenaRankSmall.new = function ( menu, controller )
	...
	rankIcon:linkToElementModel( self, "levelIcon", true, function ( model )
	...
	levelLabel:linkToElementModel( self, "level", true, function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
			levelLabel:setText( modelValue )
		end
	end )
	...
	self.close = function ( self )
		...
		CoD.ArenaRankSmall.super.close( self )
	end
