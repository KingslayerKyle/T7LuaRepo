...
CoD.AbilityWheel_IconHex.new = function ( menu, controller )
	...
	IconHex0:setLeftRight( true, true, -0.17, 0.17 )
	IconHex0:setTopBottom( true, true, 0, 0 )
	IconHex0:setRGB( 1, 1, 1 )
	IconHex0:setAlpha( RandomAddPercent( 1, -10 ) )
	IconHex0:setImage( RegisterImage( "uie_t7_cp_hud_abilitywheel_iconhex" ) )
	IconHex0:setMaterial( LUI.UIImage.GetCachedMaterial( "ui_add" ) )
	...
	self.clipsPerState = {
		DefaultState = {
			DefaultClip = function ()
				...
				self.IconHex0:setAlpha( RandomAddPercent( 1, -10 ) )
