...
CoD.AbilityWheel_BracketBlur.new = function ( menu, controller )
	...
	B1:setRGB( 1, 1, 1 )
	B1:setAlpha( RandomAddPercent( 0.99, -10 ) )
	B1:setZoom( 257 )
	...
	B4:setRGB( 1, 1, 1 )
	B4:setAlpha( RandomAddPercent( 0.99, -10 ) )
	B4:setXRot( -180 )
	B4:setZoom( 257 )
	...
	B2:setRGB( 1, 1, 1 )
	B2:setAlpha( RandomAddPercent( 0.99, -10 ) )
	B2:setZRot( -60 )
	B2:setZoom( 257 )
	...
	B3:setRGB( 1, 1, 1 )
	B3:setAlpha( RandomAddPercent( 0.99, -10 ) )
	B3:setZRot( -120 )
	B3:setZoom( 257 )
	...
	B6:setRGB( 1, 1, 1 )
	B6:setAlpha( RandomAddPercent( 0.99, -10 ) )
	B6:setYRot( 180 )
	B6:setZRot( -60 )
	B6:setZoom( 257 )
	...
	B5:setRGB( 1, 1, 1 )
	B5:setAlpha( RandomAddPercent( 0.99, -10 ) )
	B5:setYRot( -180 )
	B5:setZRot( -120 )
	B5:setZoom( 257 )
	...
	self.clipsPerState = {
		DefaultState = {
			DefaultClip = function ()
				...
				self.B1:setAlpha( RandomAddPercent( 1, -10 ) )
				B1Frame2( B1, {} )
				...
				self.B4:setAlpha( RandomAddPercent( 1, -10 ) )
				B4Frame2( B4, {} )
				...
				self.B2:setAlpha( RandomAddPercent( 1, -10 ) )
				B2Frame2( B2, {} )
				...
				self.B3:setAlpha( RandomAddPercent( 1, -10 ) )
				B3Frame2( B3, {} )
				...
				self.B6:setAlpha( RandomAddPercent( 1, -10 ) )
				B6Frame2( B6, {} )
				...
				self.B5:setAlpha( RandomAddPercent( 1, -10 ) )
				B5Frame2( B5, {} )
