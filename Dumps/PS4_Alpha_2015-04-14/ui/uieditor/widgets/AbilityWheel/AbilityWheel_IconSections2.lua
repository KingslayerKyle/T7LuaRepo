...
CoD.AbilityWheel_IconSections2.new = function ( menu, controller )
	...
	img6:setRGB( 1, 1, 1 )
	img6:setAlpha( RandomAddPercent( 0, 40 ) )
	img6:setZRot( 30 )
	...
	img1:setRGB( 1, 1, 1 )
	img1:setAlpha( RandomAddPercent( 0, 50 ) )
	img1:setZRot( -30 )
	...
	img5:setRGB( 1, 1, 1 )
	img5:setAlpha( RandomAddPercent( 0, 40 ) )
	img5:setZRot( 90 )
	...
	img2:setRGB( 1, 1, 1 )
	img2:setAlpha( RandomAddPercent( 0, 100 ) )
	img2:setZRot( -90 )
		...
		DefaultState = {
			DefaultClip = function ()
				...
				local img6Frame2 = function ( img6, event )
					...
					img6:setAlpha( RandomAddPercent( 0.01, 40 ) )
				...
				self.img2:setAlpha( RandomAddPercent( 0, 100 ) )
				img2Frame2( img2, {} )
