...
CoD.AbilityWheel_ElementsSide.new = function ( menu, controller )
	...
	AbilityWheelPixel6:setRGB( 1, 1, 1 )
	...
	AbilityWheelPixel7:setRGB( 1, 1, 1 )
	...
	AbilityWheelPixel8:setRGB( 1, 1, 1 )
	...
	AbilityWheelPixel9:setRGB( 1, 1, 1 )
	...
	self.close = function ( self )
		self.AbilityWheelPixel6:close()
		self.AbilityWheelPixel7:close()
		self.AbilityWheelPixel8:close()
		self.AbilityWheelPixel9:close()
		CoD.AbilityWheel_ElementsSide.super.close( self )
	end
