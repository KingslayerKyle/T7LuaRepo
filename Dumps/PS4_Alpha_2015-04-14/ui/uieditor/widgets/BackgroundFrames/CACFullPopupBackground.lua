...
CoD.CACFullPopupBackground.new = function ( menu, controller )
	...
	selectButtonPrompt.label:setText( Engine.Localize( "MENU_SELECT_CAPS" ) )
	...
	backButtonPrompt:setLeftRight( true, false, 243, 457 )
	backButtonPrompt:setTopBottom( true, false, 545, 576 )
	backButtonPrompt:setRGB( 1, 1, 1 )
	backButtonPrompt.label:setText( Engine.Localize( "MENU_BACK_CAPS" ) )
	...
	self.close = function ( self )
		...
		CoD.CACFullPopupBackground.super.close( self )
	end
