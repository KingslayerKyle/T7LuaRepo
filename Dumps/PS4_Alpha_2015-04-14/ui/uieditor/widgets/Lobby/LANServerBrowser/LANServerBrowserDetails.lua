...
CoD.LANServerBrowserDetails.new = function ( menu, controller )
	...
	PlayerList:setTopBottom( true, false, 273.5, 541.5 )
	PlayerList:setRGB( 1, 1, 1 )
	...
	PlayerListTitle:setTopBottom( true, false, 241.5, 266.5 )
	PlayerListTitle:setRGB( 1, 1, 1 )
	...
	MapBackImage:setMaterial( LUI.UIImage.GetCachedMaterial( "ui_normal" ) )
	...
	self.close = function ( self )
		...
		self.GameType:close()
		self.MapName:close()
		CoD.LANServerBrowserDetails.super.close( self )
	end
