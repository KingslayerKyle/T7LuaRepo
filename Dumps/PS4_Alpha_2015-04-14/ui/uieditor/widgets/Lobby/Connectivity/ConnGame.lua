...
CoD.ConnGame = InheritFrom( LUI.UIElement )
CoD.ConnGame.new = function ( menu, controller )
	local self = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc( self, controller )
	end
	self:setUseStencil( true )
	self:setClass( CoD.ConnGame )
	self.id = "ConnGame"
	...
	ConnectivityBlip0:registerEventHandler( "lobby_data_host_gameLobby", function ( element, event )
		local retVal = nil
	...
	ConnectivityBlip0:registerEventHandler( "lobby_data_silent_gameLobby", function ( element, event )
		local retVal = nil
		PlayClipOnElement( self, {
			elementName = "ConnectivityBlip0",
	...
	ConnectivityBlip1:registerEventHandler( "lobby_data_client_gameLobby", function ( element, event )
		local retVal = nil
		PlayClipOnElement( self, {
