...
CoD.LobbyMemberTeamColor.new = function ( menu, controller )
	...
	TeamColorBackground:setRGB( 1, 1, 1 )
	...
	TeamSwitchName:setTopBottom( false, false, -9.5, 10.5 )
	TeamSwitchName:setRGB( 1, 1, 1 )
	...
	leftBumper:setTopBottom( false, false, -12.5, 12.5 )
	...
	rightBumper:setTopBottom( false, false, -12.5, 12.5 )
	...
	self.close = function ( self )
		...
		CoD.LobbyMemberTeamColor.super.close( self )
	end
