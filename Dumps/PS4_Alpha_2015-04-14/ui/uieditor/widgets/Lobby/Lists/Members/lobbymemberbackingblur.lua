CoD.LobbyMemberBackingBlur = InheritFrom( LUI.UIElement )
CoD.LobbyMemberBackingBlur.new = function ( menu, controller )
	local self = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc( self, controller )
	end
	self:setUseStencil( false )
	self:setClass( CoD.LobbyMemberBackingBlur )
	self.id = "LobbyMemberBackingBlur"
	...
	Image0:setRGB( 1, 1, 1 )
	Image0:setAlpha( 0 )
	Image0:setImage( RegisterImage( "uie_img_t7_menu_partyease_boxblurul" ) )
	...
	Image2:setRGB( 1, 1, 1 )
	Image2:setAlpha( 0 )
	Image2:setImage( RegisterImage( "uie_img_t7_menu_partyease_boxblurll" ) )
	...
	Image1:setRGB( 1, 1, 1 )
	Image1:setAlpha( 0 )
	Image1:setImage( RegisterImage( "uie_img_t7_menu_partyease_boxblurur" ) )
	...
	Image3:setRGB( 1, 1, 1 )
	Image3:setAlpha( 0 )
	Image3:setImage( RegisterImage( "uie_img_t7_menu_partyease_boxblurlr" ) )
	...
	Image4:setRGB( 1, 1, 1 )
	Image4:setAlpha( 0 )
	Image4:setImage( RegisterImage( "uie_img_t7_menu_partyease_boxblurlm" ) )
	...
	Image5:setRGB( 1, 1, 1 )
	Image5:setAlpha( 0 )
	Image5:setImage( RegisterImage( "uie_img_t7_menu_partyease_boxblurum" ) )
	...
	Image6:setRGB( 1, 1, 1 )
	Image6:setAlpha( 0 )
	Image6:setImage( RegisterImage( "uie_img_t7_menu_partyease_boxblurml" ) )
	...
	Image7:setRGB( 1, 1, 1 )
	Image7:setAlpha( 0 )
	Image7:setImage( RegisterImage( "uie_img_t7_menu_partyease_boxblurmr" ) )
	...
	Image8:setRGB( 1, 1, 1 )
	Image8:setAlpha( 0 )
	Image8:setImage( RegisterImage( "uie_img_t7_menu_partyease_boxblurmm" ) )
