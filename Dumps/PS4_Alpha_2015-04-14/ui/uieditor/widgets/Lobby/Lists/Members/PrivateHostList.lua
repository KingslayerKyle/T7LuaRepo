...
CoD.PrivateHostList.new = function ( menu, controller )
	...
	txtKey:subscribeToGlobalModel( controller, "Lobby", "privateHost.key", function ( model )
	...
	txtPhrase:subscribeToGlobalModel( controller, "Lobby", "privateHost.name", function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
	...
	self.close = function ( self )
		...
		CoD.PrivateHostList.super.close( self )
	end
