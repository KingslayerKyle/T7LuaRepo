...
CoD.List1ButtonLarge_Left = InheritFrom( LUI.UIElement )
CoD.List1ButtonLarge_Left.new = function ( menu, controller )
	local self = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc( self, controller )
	end
	self:setUseStencil( false )
	self:setClass( CoD.List1ButtonLarge_Left )
	self.id = "List1ButtonLarge_Left"
	...
	self.close = function ( self )
		...
		CoD.List1ButtonLarge_Left.super.close( self )
	end
