...
CoD.FE_PanelNoBlur.new = function ( menu, controller )
	...
	Image56:setRGB( 1, 1, 1 )
	Image56:setImage( RegisterImage( "uie_t7_menu_frontend_listheaderpanelll" ) )
	Image56:setMaterial( LUI.UIImage.GetCachedMaterial( "ui_normal" ) )
	...
	Image57:setRGB( 1, 1, 1 )
	Image57:setImage( RegisterImage( "uie_t7_menu_frontend_listheaderpanellm" ) )
	Image57:setMaterial( LUI.UIImage.GetCachedMaterial( "ui_normal" ) )
	...
	Image58:setRGB( 1, 1, 1 )
	Image58:setImage( RegisterImage( "uie_t7_menu_frontend_listheaderpanellr" ) )
	Image58:setMaterial( LUI.UIImage.GetCachedMaterial( "ui_normal" ) )
	...
	Image59:setRGB( 1, 1, 1 )
	Image59:setImage( RegisterImage( "uie_t7_menu_frontend_listheaderpanelml" ) )
	Image59:setMaterial( LUI.UIImage.GetCachedMaterial( "ui_normal" ) )
	...
	Image60:setMaterial( LUI.UIImage.GetCachedMaterial( "ui_normal" ) )
	...
	Image61:setRGB( 1, 1, 1 )
	Image61:setImage( RegisterImage( "uie_t7_menu_frontend_listheaderpanelul" ) )
	Image61:setMaterial( LUI.UIImage.GetCachedMaterial( "ui_normal" ) )
	...
	Image62:setRGB( 1, 1, 1 )
	Image62:setImage( RegisterImage( "uie_t7_menu_frontend_listheaderpanelum" ) )
	Image62:setMaterial( LUI.UIImage.GetCachedMaterial( "ui_normal" ) )
	...
	Image63:setRGB( 1, 1, 1 )
	Image63:setImage( RegisterImage( "uie_t7_menu_frontend_listheaderpanelur" ) )
	Image63:setMaterial( LUI.UIImage.GetCachedMaterial( "ui_normal" ) )
	...
	Image64:setRGB( 1, 1, 1 )
	Image64:setImage( RegisterImage( "uie_t7_menu_frontend_listheaderpanelmm" ) )
	Image64:setMaterial( LUI.UIImage.GetCachedMaterial( "ui_normal" ) )
