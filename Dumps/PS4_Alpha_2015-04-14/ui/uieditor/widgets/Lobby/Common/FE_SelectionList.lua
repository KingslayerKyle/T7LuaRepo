...
CoD.FE_SelectionList.new = function ( menu, controller )
	...
	self:setTopBottom( true, false, 0, 346 )
	self:makeFocusable()
	...
	Image3:setTopBottom( false, false, -173, -169 )
	Image3:setRGB( 1, 1, 1 )
	...
	Image4:setTopBottom( false, false, 165, 168.5 )
	Image4:setRGB( 1, 1, 1 )
	Image4:setYRot( -180 )
	...
	self.close = function ( self )
		...
		CoD.FE_SelectionList.super.close( self )
	end
