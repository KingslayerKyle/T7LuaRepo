CoD.FE_TabFocus = InheritFrom( LUI.UIElement )
CoD.FE_TabFocus.new = function ( menu, controller )
	local self = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc( self, controller )
	end
	self:setUseStencil( false )
	self:setClass( CoD.FE_TabFocus )
	self.id = "FE_TabFocus"
	...
	Image1:setImage( RegisterImage( "uie_t7_menu_cac_buttontabfocusul" ) )
	...
	Image2:setRGB( 1, 1, 1 )
	Image2:setImage( RegisterImage( "uie_t7_menu_cac_buttontabfocusum" ) )
	...
	Image3:setRGB( 1, 1, 1 )
	Image3:setImage( RegisterImage( "uie_t7_menu_cac_buttontabfocusur" ) )
