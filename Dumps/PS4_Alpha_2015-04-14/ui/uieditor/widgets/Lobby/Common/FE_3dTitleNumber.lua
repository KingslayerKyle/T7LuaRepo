...
CoD.FE_3dTitleNumber.new = function ( menu, controller )
	...
	FELabelSubHeadingA0:setTopBottom( true, false, 4, 33 )
	FELabelSubHeadingA0:setRGB( 1, 1, 1 )
	...
	FELabelSubHeadingA0.Label0:setTTF( "fonts/Entovo.ttf" )
	...
	FE3dTitleNumberGames0:setLeftRight( true, false, 81, 172 )
	FE3dTitleNumberGames0:setTopBottom( true, false, 2, 31 )
	FE3dTitleNumberGames0:setRGB( 1, 1, 1 )
	FE3dTitleNumberGames0.FELabelSubHeadingB0.Label1:setRGB( 0.74, 0.78, 0.79 )
	FE3dTitleNumberGames0.FELabelSubHeadingB0.Label1:setText( Engine.Localize( "MENU_ONLINE_CAPS" ) )
	FE3dTitleNumberGames0.FELabelSubHeadingB0.Label1:setTTF( "fonts/Entovo.ttf" )
	...
	self.close = function ( self )
		...
		CoD.FE_3dTitleNumber.super.close( self )
	end
