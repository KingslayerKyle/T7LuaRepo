...
CoD.FE_3dTitleContainer.new = function ( menu, controller )
	...
	ElemBackB:setLeftRight( true, false, 158, 186 )
	ElemBackB:setTopBottom( true, false, -5, 115 )
	ElemBackB:setRGB( 1, 1, 1 )
	...
	MenuTitle:setLeftRight( true, false, 136, 496 )
	MenuTitle:setTopBottom( true, false, 29.39, 80.39 )
	MenuTitle:setRGB( 1, 1, 1 )
	MenuTitle.TextBox1.Label0:setText( Engine.Localize( "MULTIPLAYER" ) )
	...
	Local.Label0:setTTF( "fonts/Entovo.ttf" )
	Local:subscribeToGlobalModel( controller, "LobbyGlobal", "lobbyNetworkMode", function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
			Local:setAlpha( GetOfflineAlpha( modelValue ) )
		end
	end )
	...
	self.close = function ( self )
		...
		self.Local:close()
		CoD.FE_3dTitleContainer.super.close( self )
	end
