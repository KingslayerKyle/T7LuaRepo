...
CoD.FE_HelpWidgetLeft = InheritFrom( LUI.UIElement )
CoD.FE_HelpWidgetLeft.new = function ( menu, controller )
	local self = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc( self, controller )
	end
	self:setUseStencil( false )
	self:setClass( CoD.FE_HelpWidgetLeft )
	self.id = "FE_HelpWidgetLeft"
	...
	FEButtonPanel0:setLeftRight( true, true, -213, -0.5 )
	...
	buttonPromptImage:setLeftRight( true, false, 6, 30 )
	...
	buttonPromptImage:subscribeToGlobalModel( controller, "Controller", "start_button_image", function ( model )
	...
	label:setLeftRight( true, false, 32, 158 )
	label:setTopBottom( true, false, -14, 6 )
	label:setRGB( 1, 1, 1 )
	...
	FETitleNumBrdr0:setLeftRight( true, true, -213, 0 )
	FETitleNumBrdr0:setTopBottom( true, false, -21, 13 )
	...
	self.clipsPerState = {
		DefaultState = {
			DefaultClip = function ()
						...
						local ArrowFrame4 = function ( Arrow, event )
							local ArrowFrame5 = function ( Arrow, event )
								local ArrowFrame6 = function ( Arrow, event )
									...
									Arrow:setLeftRight( false, true, -14, -6 )
				...
				self.Arrow:setLeftRight( false, true, -14, -6 )
	...
	self.close = function ( self )
		...
		CoD.FE_HelpWidgetLeft.super.close( self )
	end
