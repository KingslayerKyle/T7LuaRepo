...
CoD.List1ButtonLarge_Left_DataVault = InheritFrom( LUI.UIElement )
CoD.List1ButtonLarge_Left_DataVault.new = function ( menu, controller )
	local self = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc( self, controller )
	end
	self:setUseStencil( false )
	self:setClass( CoD.List1ButtonLarge_Left_DataVault )
	self.id = "List1ButtonLarge_Left_DataVault"
	...
	label:setLeftRight( true, false, 8.82, 247 )
	label:setTopBottom( false, false, -7.77, 11.23 )
	label:setRGB( 0.81, 0.83, 0.76 )
	...
	label:linkToElementModel( self, "displayText", true, function ( model )
	...
	LobbyMemberBackingFooter0:setLeftRight( true, true, -4, 4 )
	LobbyMemberBackingFooter0:setTopBottom( false, false, 12, 17 )
	...
	imgArrow:setLeftRight( true, false, 264.34, 253.34 )
	imgArrow:setTopBottom( true, false, 7.92, 25.23 )
	imgArrow:setRGB( 1, 1, 1 )
	imgArrow:setAlpha( 0 )
	imgArrow:setImage( RegisterImage( "uie_img_t7_menu_frontend_asset_list1l_focusarrow" ) )
	imgArrow:setMaterial( LUI.UIImage.GetCachedMaterial( "ui_add" ) )
	...
	self.clipsPerState = {
		DefaultState = {
			DefaultClip = function ()
				...
				self.label:setLeftRight( true, false, 8.82, 201.82 )
				self.label:setTopBottom( false, false, -7.77, 11.23 )
				self.label:setRGB( 0.81, 0.83, 0.76 )
				self.label:setAlpha( 1 )
				self.label:setZoom( 0 )
			...
			GainFocus = function ()
				...
				local labelFrame2 = function ( label, event )
					if not event.interrupted then
						label:beginAnimation( "keyframe", 150, true, false, CoD.TweenType.Back )
					end
					label:setRGB( 1, 1, 1 )
					label:setAlpha( 1 )
					label:setZoom( 60 )
			...
			LoseFocus = function ()
				...
				local labelFrame2 = function ( label, event )
					if not event.interrupted then
						label:beginAnimation( "keyframe", 200, false, true, CoD.TweenType.Back )
					end
					label:setRGB( 0.81, 0.83, 0.76 )
					label:setAlpha( 1 )
					label:setZoom( 0 )
		...
		NoListFocus = {
			...
			Active = function ()
				...
				self.LobbyMemberBackingMask0:setTopBottom( false, false, -16.17, 16 )
				self.LobbyMemberBackingMask0:setRGB( 0.16, 0.22, 0.27 )
				self.LobbyMemberBackingMask0:setAlpha( 0.8 )
				self.LobbyMemberBackingMask0:setZoom( 60 )
				self.clipFinished( LobbyMemberBackingMask0, {} )
				LobbyMemberBacking0:completeAnimation()
				self.LobbyMemberBacking0:setLeftRight( true, true, -2.33, 1.67 )
				self.LobbyMemberBacking0:setTopBottom( false, false, -16.17, 16 )
				self.LobbyMemberBacking0:setAlpha( 0.5 )
				self.LobbyMemberBacking0:setZoom( 60 )
				self.clipFinished( LobbyMemberBacking0, {} )
				LfocusLINE:completeAnimation()
				...
				self.clipFinished( LobbyMemberBackingFooter0, {} )
				imgArrow:completeAnimation()
				self.imgArrow:setLeftRight( true, false, 267.34, 256.34 )
				self.imgArrow:setTopBottom( true, false, 7.91, 25.23 )
				self.imgArrow:setAlpha( 1 )
				self.imgArrow:setZoom( 60 )
				self.clipFinished( imgArrow, {} )
			end
		}
	}
	...
	self.close = function ( self )
		...
		self.label:close()
		CoD.List1ButtonLarge_Left_DataVault.super.close( self )
	end
