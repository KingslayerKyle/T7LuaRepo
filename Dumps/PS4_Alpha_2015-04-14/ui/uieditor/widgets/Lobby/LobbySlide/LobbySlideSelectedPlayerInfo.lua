...
CoD.LobbySlideSelectedPlayerInfo.new = function ( menu, controller )
	...
	rank:setTopBottom( true, false, 337.5, 427.5 )
	rank:setRGB( 1, 1, 1 )
	rank:setAlpha( 0.94 )
	rank:setYRot( -25 )
	...
	rank:linkToElementModel( self, "rankIcon", true, function ( model )
		...
		if modelValue then
			rank.rankIcon.imgSolid:setImage( RegisterImage( AppendString( modelValue, "_lrg" ) ) )
		end
	end )
	...
	playercard.LobbySlideGamerCardInternalWidget0.GamerCard:setImage( RegisterImage( "uie_t7_icon_callingcard_temp1_lrg" ) )
	...
	LobbySlideEmblemWidget:setRGB( 1, 1, 1 )
	...
	self.close = function ( self )
		...
		CoD.LobbySlideSelectedPlayerInfo.super.close( self )
	end
