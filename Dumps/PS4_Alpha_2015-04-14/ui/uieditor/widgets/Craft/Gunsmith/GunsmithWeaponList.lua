...
CoD.GunsmithWeaponList.new = function ( menu, controller )
	...
	LabelButtonCount0:setLeftRight( false, true, -36, -14 )
	LabelButtonCount0:setTopBottom( false, false, -9, 11 )
	LabelButtonCount0:setRGB( 1, 1, 1 )
	...
	self.close = function ( self )
		...
		CoD.GunsmithWeaponList.super.close( self )
	end
