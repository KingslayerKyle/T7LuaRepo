...
CoD.GunsmithVariantItemND.new = function ( menu, controller )
	...
	self.itemImage:linkToElementModel( self, "variantImage", true, function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
			itemImage:setImage( RegisterImage( modelValue ) )
		end
	end )
	self.LabelButton:linkToElementModel( self, "variantName", true, function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
	...
	self.close = function ( self )
		...
		CoD.GunsmithVariantItemND.super.close( self )
	end
