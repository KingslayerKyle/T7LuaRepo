...
CoD.EmblemIconNew.new = function ( menu, controller )
	...
	drawPaintshop:setRGB( 1, 1, 1 )
	drawPaintshop:setAlpha( 0 )
	drawPaintshop:setMaterial( LUI.UIImage.GetCachedMaterial( "ui_normal" ) )
	drawPaintshop:linkToElementModel( self, "iconID", true, function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
			drawPaintshop:setupDrawEmblemById( modelValue )
		end
	end )
	...
	self.close = function ( self )
		...
		CoD.EmblemIconNew.super.close( self )
	end
