CoD.EmblemEditorTabWidget = InheritFrom( LUI.UIElement )
CoD.EmblemEditorTabWidget.new = function ( menu, controller )
	local self = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc( self, controller )
	end
	self:setUseStencil( false )
	self:setClass( CoD.EmblemEditorTabWidget )
	self.id = "EmblemEditorTabWidget"
	...
	self.close = function ( self )
		...
		CoD.EmblemEditorTabWidget.super.close( self )
	end
