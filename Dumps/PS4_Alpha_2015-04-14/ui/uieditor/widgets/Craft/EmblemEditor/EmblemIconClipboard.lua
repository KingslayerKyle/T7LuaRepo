...
CoD.EmblemIconClipboard.new = function ( menu, controller )
	...
	bgBorder:setRGB( 1, 1, 1 )
	bgBorder:setAlpha( 0 )
	bgBorder:setMaterial( LUI.UIImage.GetCachedMaterial( "ui_normal" ) )
	...
	bgMask:setRGB( 0, 0, 0 )
	bgMask:setAlpha( 0 )
	bgMask:setMaterial( LUI.UIImage.GetCachedMaterial( "ui_normal" ) )
	...
	copyIcon:setLeftRight( true, true, 10, 0 )
	copyIcon:setTopBottom( true, true, 27, -33 )
	copyIcon:setRGB( 1, 1, 1 )
	copyIcon:setMaterial( LUI.UIImage.GetCachedMaterial( "ui_normal" ) )
	...
	self.clipsPerState = {
		...
		Visible = {
			DefaultClip = function ()
				...
				self.clipFinished( BackingGradient, {} )
				copyIcon:completeAnimation()
				self.copyIcon:setLeftRight( true, true, 10, 0 )
				self.copyIcon:setTopBottom( true, true, 27, -33 )
	...
	self.close = function ( self )
		...
		CoD.EmblemIconClipboard.super.close( self )
	end
