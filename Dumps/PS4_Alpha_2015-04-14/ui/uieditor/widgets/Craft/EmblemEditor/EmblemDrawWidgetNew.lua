...
CoD.EmblemDrawWidgetNew.new = function ( menu, controller )
	...
	emblemDrawingArea:setTopBottom( true, true, 4, -4 )
	emblemDrawingArea:setRGB( 1, 1, 1 )
	emblemDrawingArea:setMaterial( LUI.UIImage.GetCachedMaterial( "ui_normal" ) )
	...
	self.clipsPerState = {
		DefaultState = {
			...
			Focus = function ()
				...
				self.emblemDrawingArea:setZoom( 0 )
			...
			GainFocus = function ()
				...
				self.clipFinished( BorderBaked0, {} )
				FocusBarT:completeAnimation()
				self.FocusBarT:setLeftRight( true, true, -1.12, 1.38 )
				self.FocusBarT:setTopBottom( true, false, -1, 7.5 )
				self.FocusBarT:setAlpha( 0 )
				self.clipFinished( FocusBarT, {} )
				FocusBarT0:completeAnimation()
				self.FocusBarT0:setAlpha( 0 )
				self.clipFinished( FocusBarT0, {} )
				glitch2:completeAnimation()
				self.glitch2:setLeftRight( true, true, 5.5, -6.5 )
				self.glitch2:setTopBottom( false, true, -9.5, 5.5 )
				self.glitch2:setAlpha( 0 )
				self.clipFinished( glitch2, {} )
				glitch:completeAnimation()
				self.glitch:setAlpha( 0 )
	...
	self.close = function ( self )
		...
		CoD.EmblemDrawWidgetNew.super.close( self )
	end
