...
LUI.createMenu.EditGameOptions = function ( controller )
	...
	if subLevelSettings and #subLevelSettings > 0 then
		...
		modeSpecificButton:setActionEventName( "open_game_mode_specific_settings" )
	...
	generalButton:setActionEventName( "open_general_settings" )
	...
	healthAndDamageButton:setActionEventName( "open_health_and_damage_settings" )
	...
	if Engine.GetGametypeSetting( "disableClassSelection", true ) == 0 then
		...
		customClassesButton:setActionEventName( "open_custom_classes" )
		...
		defaultClassesButton:setActionEventName( "open_default_classes" )
