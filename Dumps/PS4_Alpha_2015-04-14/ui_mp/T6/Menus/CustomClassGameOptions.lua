...
CreateButtons = function ( self )
	self.disableCACSelector = self:addGametypeSetting( self:getOwner(), "disableCAC", true )
	self.maxAllocationSelector = self:addGametypeSetting( self:getOwner(), "maxAllocation", true )
	self.primaryWeaponsButton = self.buttonList:addButton( Engine.Localize( "MENU_RESTRICT_PRIMARY_WEAPONS_CAPS" ) )
	self.primaryWeaponsButton:setActionEventName( "restrict_primary_weapons" )
	...
	self.secondaryWeaponsButton:setActionEventName( "restrict_secondary_weapons" )
	...
	self.attachmentsButton:setActionEventName( "restrict_attachments" )
	...
	self.perks1Button:setActionEventName( "restrict_perks1" )
	...
	self.perks2Button:setActionEventName( "restrict_perks2" )
	...
	self.perks3Button:setActionEventName( "restrict_perks3" )
	...
	self.lethalsButton:setActionEventName( "restrict_lethals" )
	...
	self.tacticalsButton:setActionEventName( "restrict_tacticals" )
	...
	self.bonusCardsButton:setActionEventName( "restrict_bonus_cards" )
