...
LUI.createMenu.PlaylistSelection = function ( controller )
	local playlistSelectionMenu = CoD.Menu.New( "PlaylistSelection" )
	...
	local selectionContainerLeft = -100
	...
	playlistSelectionMenu.infoContainer.titleElement:setTTF( "fonts/Entovo.ttf" )
