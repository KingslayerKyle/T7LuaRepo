CoD.ConsoleUtility = {}
local UpdateConsole = function ( self )
	local activeCount = 0
	...
	if CoD.IsShoutcaster( self.controller ) and not CoD.ShoutcasterProfileVarBool( self.controller, "shoutcaster_killfeed" ) then
...
CoD.ConsoleUtility.Init = function ( self, controller, modelName, maxElements )
	...
	self:registerEventHandler( "console_notification_complete", ConsoleNotificationComplete )
...
local ShowConsoleEntry = function ( self, id )
	self.id = id
	local padding = 4
