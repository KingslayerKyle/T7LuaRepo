...
function ShouldPlayLobbyFadeAnim( menu, controller )
	return menu.previousMenuName and f221_local0 or menu.previousMenuName == "ModeSelect"
end
...
function HasPerk( controller, perkId )
	return IsModelValueEqualTo( controller, "playerAbilities.playerGadget3.name", "WEAPON_GADGET_COMBAT_EFFICIENCY" ) and IsModelValueEqualTo( controller, "playerAbilities.playerGadget3.isInUse", true )
end
...
function IsHeroWeaponAbilityNotAvailable( element, controller )
	return IsLive() and f359_local0 or isFirstTimeSetup
end
