...
CoD.FocusWidget.new = function ( menu, controller )
	...
	LUI.OverrideFunction_CallOriginalSecond( self, "close", function ( self )
		self.FocusWidgetBG0:close()
		self.FocusWidgetBG1:close()
		self.FocusWidgetBG2:close()
		self.FocusWidgetBG:close()
		self.FocusWidgetWhiteBars:close()
		self.FocusWidgetWhiteBars0:close()
	end )
