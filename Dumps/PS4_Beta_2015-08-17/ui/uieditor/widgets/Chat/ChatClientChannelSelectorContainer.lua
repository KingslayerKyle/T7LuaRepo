...
CoD.ChatClientChannelSelectorContainer.new = function ( menu, controller )
	...
	ChatClientChannelSelectorMenu:setTopBottom( true, false, 0, 64 )
	...
	ChatClientChannelSelectorMenu.id = "ChatClientChannelSelectorMenu"
	LUI.OverrideFunction_CallOriginalSecond( self, "close", function ( self )
		self.ChatClientChannelSelectorMenu:close()
	end )
