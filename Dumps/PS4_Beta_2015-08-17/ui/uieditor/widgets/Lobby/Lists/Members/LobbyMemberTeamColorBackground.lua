local PostLoadFunc = function ( self, controller )
	self.SetupTeamColors = function ( self, team )
		if team == Enum.team_t.TEAM_SPECTATOR then
			self.alliesColor:setRGB( CoD.GetDefaultTeamFactionColor( Enum.team_t.TEAM_ALLIES ) )
			self.axisColor:setRGB( CoD.GetDefaultTeamFactionColor( Enum.team_t.TEAM_AXIS ) )
		else
			self.alliesColor:setRGB( CoD.GetTeamFactionColor( Enum.team_t.TEAM_ALLIES ) )
			self.axisColor:setRGB( CoD.GetTeamFactionColor( Enum.team_t.TEAM_AXIS ) )
		end
	end
