...
CoD.PrimaryWeaponAttachmentsWidget.new = function ( menu, controller )
	...
	attachment5:linkToElementModel( self, "image", true, function ( model )
		...
		if modelValue then
			attachment5.itemImageSolid:setImage( RegisterImage( modelValue ) )
		end
	end )
	attachment5:linkToElementModel( self, "image", true, function ( model )
		local modelValue = Engine.GetModelValue( model )
	...
	attachment4:linkToElementModel( self, "image", true, function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
			attachment4.itemImageSolid:setImage( RegisterImage( modelValue ) )
		end
	end )
	attachment4:linkToElementModel( self, "image", true, function ( model )
		local modelValue = Engine.GetModelValue( model )
	...
	attachment3:linkToElementModel( self, "image", true, function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
			attachment3.itemImageSolid:setImage( RegisterImage( modelValue ) )
		end
	end )
	attachment3:linkToElementModel( self, "image", true, function ( model )
		local modelValue = Engine.GetModelValue( model )
