...
DataSources.HealthAndDamageSettings = DataSourceHelpers.ListSetup( "HealthAndDamageSettings", PrepareHealthAndDamageSettingsOptions, nil, nil, nil )
LUI.createMenu.GameSettings_HealthAndDamageSettings = function ( controller )
	...
	cac3dTitleIntermediary0.FE3dTitleContainer0.MenuTitle.TextBox1.Label0:setText( Engine.Localize( "MENU_HEALTH_AND_DAMAGE_SETTINGS_CAPS" ) )
	...
	CompetitiveSettingsList0.ButtonList:setDataSource( "HealthAndDamageSettings" )
