...
local PreLoadFunc = function ( self, controller )
	...
	self.restoreState = function ( self )
		if Paintjobs_IsOccupied( self, controller ) then
...
LUI.createMenu.PaintjobSaveChanges = function ( controller )
	...
	paintjobNameInput:linkToElementModel( self, "paintjobTextEntry", true, function ( model )
		...
		if modelValue then
			paintjobNameInput.Text:setText( modelValue )
		end
	end )
	...
	LUI.OverrideFunction_CallOriginalFirst( paintjobNameInput, "setState", function ( element, state )
