...
LUI.createMenu.WelcomeMenuMain = function ( controller )
	...
	local GotItButton = CoD.GotIt_Button.new( self, controller )
	...
	self:AddButtonCallbackFunction( GotItButton, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( element, menu, controller, model )
