...
LUI.createMenu.Pregame_Main = function ( controller )
	...
	local Team1ListSmall = LUI.UIList.new( self, controller, 0, 0, function ( model )
	...
	local Team1ListLarge = LUI.UIList.new( self, controller, 10, 0, function ( model )
		return Engine.GetModelValue( Engine.GetModel( model, "teamString" ) ) == "1"
	end, false, false, 0, 0, false, true )
	...
	local Team2ListSmall = LUI.UIList.new( self, controller, 0, 0, function ( model )
	...
	local Team2ListLarge = LUI.UIList.new( self, controller, 11, 0, function ( model )
		return Engine.GetModelValue( Engine.GetModel( model, "teamString" ) ) == "2"
	end, false, false, 0, 0, false, true )
