...
CoD.Menu.UpdateButtonShownState = function ( element, menu, controller, luiButton )
	...
	for _, data in ipairs( results ) do
		...
		if f49_local3 then
			...
			break
		elseif not (not data.element or not data.element.showButtonDisabled or not data.element.showButtonDisabled[luiButton]) or menu.showButtonDisabled and menu.showButtonDisabled[luiButton] then
