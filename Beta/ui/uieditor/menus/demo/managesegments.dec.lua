...
LUI.createMenu.ManageSegments = function ( controller )
	...
	local IdentityBadge = CoD.IdentityBadge.new( menu, controller )
	...
	local SegmentButtonList = LUI.UIList.new( menu, controller, 5, 0, nil, false, false, 0, 0, false, true )
	...
	SegmentButtonList:registerEventHandler( "list_item_gain_focus", function ( element, event )
		local retVal = nil
		ManageSegmentsUpdateTimeline( self, element, controller, "gain_focus", menu )
		return retVal
	end )
	SegmentButtonList:registerEventHandler( "list_item_lose_focus", function ( element, event )
		local retVal = nil
		ManageSegmentsUpdateTimeline( self, element, controller, "lose_focus", menu )
		return retVal
	end )
	...
	menu:AddButtonCallbackFunction( SegmentButtonList, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( element, menu, controller, model )
	...
	menu:AddButtonCallbackFunction( SegmentButtonList, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, nil, function ( element, menu, controller, model )
	...
	menu:AddButtonCallbackFunction( SegmentButtonList, controller, Enum.LUIButton.LUI_KEY_XBY_PSTRIANGLE, nil, function ( element, menu, controller, model )
		if not IsSegmentSelectedForMove( element, controller ) then
	...
	menu:AddButtonCallbackFunction( SegmentButtonList, controller, Enum.LUIButton.LUI_KEY_XBX_PSSQUARE, nil, function ( element, menu, controller, model )
		if not IsSegmentSelectedForMove( element, controller ) then
	...
	local SegmentInformation = CoD.SegmentInformation.new( menu, controller )
