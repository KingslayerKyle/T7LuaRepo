...
LUI.createMenu.ClassOptions = function ( controller )
	...
	local renameButton = CoD.List1ButtonLarge_PH.new( menu, controller )
	...
	menu:AddButtonCallbackFunction( renameButton, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( element, menu, controller, model )
	...
	local copyButton = CoD.List1ButtonLarge_PH.new( menu, controller )
	...
	menu:AddButtonCallbackFunction( copyButton, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( element, menu, controller, model )
	...
	local resetButton = CoD.List1ButtonLarge_PH.new( menu, controller )
	...
	menu:AddButtonCallbackFunction( resetButton, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( element, menu, controller, model )
	...
	local clearButton = CoD.List1ButtonLarge_PH.new( menu, controller )
	...
	menu:AddButtonCallbackFunction( clearButton, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( element, menu, controller, model )
