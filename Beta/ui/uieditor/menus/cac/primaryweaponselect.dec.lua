...
LUI.createMenu.PrimaryWeaponSelect = function ( controller )
	...
	selectMenuWidget:subscribeToModel( Engine.GetModel( Engine.GetGlobalModel(), "WGSV_Category" ), function ( model )
		menu:updateElementState( selectMenuWidget, {
	...
	menu:AddButtonCallbackFunction( variantList, controller, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, nil, function ( element, menu, controller, model )
	...
	local weaponCategoryList = CoD.craftTabList.new( menu, controller )
