...
LUI.createMenu.WeaponCustomization = function ( controller )
	...
	local background = CoD.CACBackground.new( menu, controller )
	...
	local categoryList = LUI.UIList.new( menu, controller, 5, 0, nil, true, false, 0, 0, false, false )
	...
	categoryList:linkToElementModel( "disabled", true, function ( model )
	...
	menu:AddButtonCallbackFunction( categoryList, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( element, menu, controller, model )
	...
	local previewPane = CoD.WeaponPreviewPane.new( menu, controller )
