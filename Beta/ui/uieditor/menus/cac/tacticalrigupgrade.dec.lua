...
LUI.createMenu.TacticalRigUpgrade = function ( controller )
	...
	local TacRigUpgradeWidget = CoD.TacRigUpgradeWidget.new( menu, controller )
	...
	local TacRigUpgradeList = LUI.UIList.new( menu, controller, 40, 0, nil, false, false, 0, 0, false, true )
	...
	TacRigUpgradeList:linkToElementModel( "itemIndex", true, function ( model )
	...
	menu:AddButtonCallbackFunction( TacRigUpgradeList, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( element, menu, controller, model )
