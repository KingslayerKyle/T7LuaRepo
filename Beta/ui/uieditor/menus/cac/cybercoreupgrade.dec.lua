...
LUI.createMenu.CybercoreUpgrade = function ( controller )
	...
	local CACBackgroundNew0 = CoD.CACBackgroundNew.new( menu, controller )
	...
	local upgradeTree = CoD.CybercoreUpgradeTreeWidget.new( menu, controller )
	...
	local infoWidget = CoD.CybercoreInfoModelWidget.new( menu, controller )
	...
	local ElemsSideList0 = CoD.cac_ElemsSideList.new( menu, controller )
	...
	local coreTabList = CoD.craftTabList.new( menu, controller )
