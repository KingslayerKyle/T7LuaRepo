...
LUI.createMenu.Social_Party_ManagePartyPopup = function ( controller )
	...
	local playersManageParty = CoD.Social_PlayersList_ManageParty.new( menu, controller )
	...
	menu:AddButtonCallbackFunction( playersManageParty, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( element, menu, controller, model )
