...
LUI.createMenu.Competitive_Settings_Advanced = function ( controller )
	...
	local CompetitiveSettingsList1 = CoD.Competitive_SettingsList.new( menu, controller )
	...
	local CompetitiveSettingsList2 = CoD.Competitive_SettingsList.new( menu, controller )
