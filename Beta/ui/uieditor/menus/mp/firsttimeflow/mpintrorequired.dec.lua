...
LUI.createMenu.MPIntroRequired = function ( controller )
	...
	local StartIntroButton = CoD.list1ButtonNewStyle.new( menu, controller )
	...
	menu:AddButtonCallbackFunction( StartIntroButton, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( element, menu, controller, model )
	...
	local CancelButton = CoD.list1ButtonNewStyle.new( menu, controller )
	...
	menu:AddButtonCallbackFunction( CancelButton, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( element, menu, controller, model )
		GoBack( self, controller )
		return true
	end, function ( element, menu, controller )
		CoD.Menu.SetButtonLabel( menu, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "MENU_SELECT" )
	...
	self:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				local f13_local0 = IsPC()
				if f13_local0 then
					f13_local0 = not IsGamepad( controller )
				end
				return f13_local0
			end
		},
