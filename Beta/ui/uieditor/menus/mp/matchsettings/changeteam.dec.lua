...
LUI.createMenu.ChangeTeam = function ( controller )
	...
	local playerList = LUI.UIList.new( menu, controller, 0, 0, nil, false, false, 0, 0, false, true )
