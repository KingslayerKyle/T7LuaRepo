...
LUI.createMenu.MegaChewFactory = function ( controller )
	...
	local MegaChewMachine0 = CoD.MegaChewMachine.new( menu, controller )
	...
	menu:AddButtonCallbackFunction( MegaChewMachine0, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, nil, function ( element, menu, controller, model )
	...
	local MegaChewMachine1 = CoD.MegaChewMachine.new( menu, controller )
	...
	menu:AddButtonCallbackFunction( MegaChewMachine1, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, nil, function ( element, menu, controller, model )
		if HasBGBTokensRemaining( element, controller ) then
			MegaChewFactoryPurchase( self, element, controller )
			return true
		else
	...
	local MegaChewMachine2 = CoD.MegaChewMachine.new( menu, controller )
	...
	menu:AddButtonCallbackFunction( MegaChewMachine2, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, nil, function ( element, menu, controller, model )
		if HasBGBTokensRemaining( element, controller ) then
			MegaChewFactoryPurchase( self, element, controller )
			return true
		else
	...
	menu:AddButtonCallbackFunction( self, controller, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, "T", function ( element, menu, controller, model )
