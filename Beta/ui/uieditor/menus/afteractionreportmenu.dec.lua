...
LUI.createMenu.AfterActionReportMenu = function ( controller )
	...
	local playerSummaryList = LUI.UIList.new( menu, controller, 25, 0, nil, false, false, 0, 0, false, true )
	...
	local emptySummary1 = CoD.AARPlayerSummaryEmptyWidget.new( menu, controller )
	...
	local emptySummary2 = CoD.AARPlayerSummaryEmptyWidget.new( menu, controller )
	...
	local emptySummary3 = CoD.AARPlayerSummaryEmptyWidget.new( menu, controller )
