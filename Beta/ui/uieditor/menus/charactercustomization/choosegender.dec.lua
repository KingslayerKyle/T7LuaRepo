...
LUI.createMenu.ChooseGender = function ( controller )
	...
	local genderList = LUI.UIList.new( menu, controller, 20, 0, nil, false, false, 0, 0, false, false )
	...
	menu:AddButtonCallbackFunction( genderList, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( element, menu, controller, model )
	...
	local FEGuide0 = CoD.FE_Guide.new( menu, controller )
