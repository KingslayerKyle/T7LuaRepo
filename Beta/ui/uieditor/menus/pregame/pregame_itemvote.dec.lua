...
LUI.createMenu.Pregame_ItemVote = function ( controller )
	...
	local List = LUI.UIList.new( menu, controller, 5, 0, nil, false, false, 0, 0, false, false )
	List:makeFocusable()
	...
	menu:AddButtonCallbackFunction( List, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, nil, function ( element, menu, controller, model )
	...
	local PregameItemVoteTabs = CoD.Pregame_ItemVote_Tabs.new( menu, controller )
	...
	local PregameItemVoteVoteCount = CoD.Pregame_ItemVote_VoteCount.new( menu, controller )
