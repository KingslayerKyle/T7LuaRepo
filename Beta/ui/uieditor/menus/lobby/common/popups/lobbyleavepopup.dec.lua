...
LUI.createMenu.LobbyLeavePopup = function ( controller )
	...
	local DisplayText = LUI.UIList.new( menu, controller, 2, 0, nil, false, false, 0, 0, false, true )
	...
	menu:AddButtonCallbackFunction( DisplayText, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( element, menu, controller, model )
