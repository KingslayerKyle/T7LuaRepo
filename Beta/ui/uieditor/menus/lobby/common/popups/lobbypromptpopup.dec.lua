...
LUI.createMenu.LobbyPromptPopup = function ( controller )
	...
	local LobbyMemberBackingMask = CoD.LobbyMemberBackingMask.new( menu, controller )
	...
	local lstOptions = LUI.UIList.new( menu, controller, 2, 0, nil, false, false, 0, 0, false, false )
	...
	menu:AddButtonCallbackFunction( lstOptions, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( element, menu, controller, model )
