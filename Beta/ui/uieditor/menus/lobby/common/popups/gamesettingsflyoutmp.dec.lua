...
LUI.createMenu.GameSettingsFlyoutMP = function ( controller )
	...
	menu:AddButtonCallbackFunction( EditGameRules, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( element, menu, controller, model )
	...
	local ChangeGameMode = CoD.List1ButtonLarge_PH.new( menu, controller )
	...
	local SetupBots = CoD.List1ButtonLarge_PH.new( menu, controller )
	...
	local GameRecording = CoD.List1ButtonLarge_PH.new( menu, controller )
