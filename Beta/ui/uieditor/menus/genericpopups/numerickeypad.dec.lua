...
LUI.createMenu.NumericKeypad = function ( controller )
	...
	local buttonA = CoD.button.new( menu, controller )
	...
	local buttonB = CoD.button.new( menu, controller )
	...
	local buttonC = CoD.button.new( menu, controller )
	...
	local buttonD = CoD.button.new( menu, controller )
	...
	local buttonE = CoD.button.new( menu, controller )
	...
	local buttonF = CoD.button.new( menu, controller )
	...
	local buttonG = CoD.button.new( menu, controller )
	...
	local buttonH = CoD.button.new( menu, controller )
	...
	local buttonI = CoD.button.new( menu, controller )
	...
	local buttonP = CoD.button.new( menu, controller )
	...
	local OkButton = CoD.button.new( menu, controller )
	...
	local Console0 = CoD.Console.new( menu, controller )
	...
	local buttonJ = CoD.button.new( menu, controller )
	...
	local buttonK = CoD.button.new( menu, controller )
	...
	local buttonL = CoD.button.new( menu, controller )
	...
	local buttonM = CoD.button.new( menu, controller )
	...
	local buttonN = CoD.button.new( menu, controller )
	...
	local buttonO = CoD.button.new( menu, controller )
	...
	local buttonQ = CoD.button.new( menu, controller )
	...
	local buttonR = CoD.button.new( menu, controller )
	...
	local buttonS = CoD.button.new( menu, controller )
	...
	local buttonT = CoD.button.new( menu, controller )
	...
	local buttonU = CoD.button.new( menu, controller )
	...
	local buttonV = CoD.button.new( menu, controller )
	...
	local buttonW = CoD.button.new( menu, controller )
	...
	local buttonX = CoD.button.new( menu, controller )
	...
	local buttonY = CoD.button.new( menu, controller )
	...
	local buttonZ = CoD.button.new( menu, controller )
