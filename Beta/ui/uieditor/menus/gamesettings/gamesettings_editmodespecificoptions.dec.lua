...
local PrepareGameModeSpecificOptions = function ( controller )
	...
	if subLevelSettings and #subLevelSettings > 0 then
		for index, setting in ipairs( subLevelSettings ) do
			...
			table.insert( optionsTable, CoD.OptionsUtility.CreateListOptions( controller, settingInfo.name, settingInfo.hintText, setting, settingInfo, "GameModeSpecificOptionsList_" .. REG9 ) )
		end
	end
	return optionsTable
end

DataSources.GameModeSpecificOptions = DataSourceHelpers.ListSetup( "GameModeSpecificOptions", PrepareGameModeSpecificOptions, nil, nil, nil )
LUI.createMenu.GameSettings_EditModeSpecificOptions = function ( controller )
	...
	CompetitiveSettingsList0.ButtonList:setDataSource( "GameModeSpecificOptions" )
	CompetitiveSettingsList0.ButtonList:setVerticalCount( 15 )
	...
	local GameSettingsDescription00 = CoD.GameSettings_Description.new( menu, controller )
	GameSettingsDescription00:setLeftRight( true, false, 690.5, 1179.5 )
	GameSettingsDescription00:setTopBottom( true, false, 125, 260 )
	self:addElement( GameSettingsDescription00 )
	self.GameSettingsDescription00 = GameSettingsDescription00
	...
	LUI.OverrideFunction_CallOriginalSecond( self, "close", function ( self )
		...
		self.GameSettingsDescription00:close()
