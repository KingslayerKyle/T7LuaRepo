...
local PrepareHealthAndDamageSettingsOptions = function ( controller )
	...
	for index, setting in ipairs( CoD.GameOptions.HealthAndDamageSettings ) do
		...
		table.insert( optionsTable, CoD.OptionsUtility.CreateListOptions( controller, settingInfo.name, settingInfo.hintText, setting, settingInfo, "HealthAndDamageSettingsOptionsList_" .. REG7 ) )
	end
	return optionsTable
end
