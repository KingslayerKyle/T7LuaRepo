...
LUI.createMenu.GunsmithCreateVariantName = function ( controller )
	...
	local variantNameInput = CoD.GunsmithInputButton.new( menu, controller )
	...
	menu:AddButtonCallbackFunction( variantNameInput, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( element, menu, controller, model )
	...
	StartMenuTitlePopup:subscribeToGlobalModel( controller, "Customization", "weapon_index", function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
			StartMenuTitlePopup.StartMenuTitleContainerLOC.StartMenu3dTitle.StartMenu3dTitleLabel.Label0:setText( Engine.Localize( LocalizeWeaponNameIntoString( "MENU_GUNSMITH_CREATE_VARIANT_NAME_TITLE", controller, modelValue ) ) )
		end
	end )
	...
	local List1ButtonLargeLeftND0 = CoD.List1ButtonLarge_Left_ND.new( menu, controller )
	...
	menu:AddButtonCallbackFunction( List1ButtonLargeLeftND0, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( element, menu, controller, model )
	...
	List1ButtonLargeLeftND0:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "Gunsmith.validVariantNameEntered" ), function ( model )
		menu:updateElementState( List1ButtonLargeLeftND0, {
