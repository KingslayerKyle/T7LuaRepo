...
LUI.createMenu.PaintjobSaveChanges = function ( controller )
	...
	local paintjobNameInput = CoD.GunsmithInputButton.new( menu, controller )
	...
	menu:AddButtonCallbackFunction( paintjobNameInput, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( element, menu, controller, model )
