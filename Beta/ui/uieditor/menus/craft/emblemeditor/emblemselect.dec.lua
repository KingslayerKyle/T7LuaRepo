...
LUI.createMenu.EmblemSelect = function ( controller )
	...
	menu:AddButtonCallbackFunction( emblemList, controller, Enum.LUIButton.LUI_KEY_XBX_PSSQUARE, nil, function ( element, menu, controller, model )
	...
	menu:AddButtonCallbackFunction( emblemList, controller, Enum.LUIButton.LUI_KEY_XBY_PSTRIANGLE, nil, function ( element, menu, controller, model )
		if Emblem_IsOccupied( element, controller ) then
