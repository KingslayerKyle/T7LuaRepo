...
LUI.createMenu.EditTeamLogo = function ( controller )
	...
	local LogoList = LUI.UIList.new( menu, controller, 35, 0, nil, false, false, 0, 0, false, false )
	...
	LogoList:linkToElementModel( "disabled", true, function ( model )
	...
	menu:AddButtonCallbackFunction( LogoList, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( element, menu, controller, model )
