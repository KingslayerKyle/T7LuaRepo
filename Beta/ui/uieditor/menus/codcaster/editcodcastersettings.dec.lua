...
LUI.createMenu.EditCodCasterSettings = function ( controller )
	...
	local CodCasterTeamIdentityInformationPanel = CoD.CodCasterTeamIdentityInformationPanel.new( menu, controller )
	...
	CodCasterTeamIdentityInformationPanel:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				local f7_local0 = IsSelfModelValueTrue( element, controller, "showTeam1Info" )
				if f7_local0 then
					f7_local0 = IsSelfModelValueTrue( element, controller, "showTeam2Info" )
				end
				return f7_local0
			end
		},
		{
			...
			condition = function ( menu, element, event )
				local f8_local0 = IsSelfModelValueTrue( element, controller, "showTeam1Info" )
				if f8_local0 then
					f8_local0 = not IsSelfModelValueTrue( element, controller, "showTeam2Info" )
				end
				return f8_local0
			end
		},
	...
	CodCasterTeamIdentityInformationPanel:linkToElementModel( "showTeam1Info", true, function ( model )
		menu:updateElementState( CodCasterTeamIdentityInformationPanel, {
	...
	CodCasterTeamIdentityInformationPanel:linkToElementModel( "showTeam2Info", true, function ( model )
		menu:updateElementState( CodCasterTeamIdentityInformationPanel, {
			name = "model_validation",
			menu = menu,
			modelValue = Engine.GetModelValue( model ),
