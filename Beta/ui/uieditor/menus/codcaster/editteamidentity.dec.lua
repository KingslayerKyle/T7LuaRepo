...
LUI.createMenu.EditTeamIdentity = function ( controller )
	...
	local TeamNameInputButton = CoD.InputButton.new( menu, controller )
	...
	menu:AddButtonCallbackFunction( TeamNameInputButton, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( element, menu, controller, model )
	...
	local TeamColorList = LUI.UIList.new( menu, controller, 2, 0, nil, false, false, 0, 0, false, true )
	...
	menu:AddButtonCallbackFunction( TeamColorList, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( element, menu, controller, model )
	...
	local TeamLogoImageButton = CoD.CodCasterTeamLogoButton.new( menu, controller )
	...
	menu:AddButtonCallbackFunction( TeamLogoImageButton, controller, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", function ( element, menu, controller, model )
	...
	local CodCasterFakeMap = CoD.CodCasterFakeMap.new( menu, controller )
