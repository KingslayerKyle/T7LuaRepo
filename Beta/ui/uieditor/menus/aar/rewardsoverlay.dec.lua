...
LUI.createMenu.RewardsOverlay = function ( controller )
	...
	local RewardsCarousel = LUI.UIList.new( menu, controller, 30, 200, nil, false, true, 452, 0, false, false )
	...
	local horizontalCounter = CoD.horizontalCounter.new( menu, controller )
