...
CoD.ChatClientInput.new = function ( menu, controller )
	...
	ChatClientSettingContainer:linkToElementModel( "menuSettingsShow", true, function ( model )
	...
	ChatClientChannelSelectorContainer:linkToElementModel( "menuInputChannelShow", true, function ( model )
