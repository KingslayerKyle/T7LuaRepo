	...
	self:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				local f73_local0 = ShouldDisplayButton( element, controller )
				if f73_local0 then
					f73_local0 = IsGamepad( controller )
				end
				return f73_local0
			end
		},
		{
			...
			condition = function ( menu, element, event )
				local f74_local0 = ShouldDisplayButton( element, controller )
				if f74_local0 then
					f74_local0 = not IsGamepad( controller )
				end
				return f74_local0
			end
		},
