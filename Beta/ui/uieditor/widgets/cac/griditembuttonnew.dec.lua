...
CoD.GridItemButtonNew.new = function ( menu, controller )
	...
	tokenUnlock:linkToElementModel( "itemIndex", true, function ( model )
	...
	ConsumableLabel:linkToElementModel( self, "itemIndex", true, function ( model )
		local modelValue = Engine.GetModelValue( model )
		if modelValue then
			ConsumableLabel.ConsumableCountLabel:setText( Engine.Localize( GetConsumableCountFromIndex( controller, modelValue ) ) )
		end
	end )
	...
	HeaderLabel:linkToElementModel( "headerName", true, function ( model )
