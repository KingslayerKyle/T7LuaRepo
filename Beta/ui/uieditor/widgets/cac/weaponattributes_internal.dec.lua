...
CoD.WeaponAttributes_Internal.new = function ( menu, controller )
	...
	accuracyAttribute:linkToElementModel( "accuracy", true, function ( model )
	...
	fireRateAttribute:linkToElementModel( "fireRate", true, function ( model )
	...
	rangeAttribute:linkToElementModel( "range", true, function ( model )
	...
	damageAttribute:linkToElementModel( "damage", true, function ( model )
