	...
	self:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				local f7_local0 = IsCACSlotSpecificItemEquipped( element, controller, "bonuscard_primary_gunfighter" )
				if f7_local0 then
					f7_local0 = IsCACEquippedWildcardItemCount( menu, "bonuscard_primary_gunfighter", 0 )
				end
				return f7_local0
			end
		},
		{
			stateName = "Equipped1",
			condition = function ( menu, element, event )
				local f8_local0 = IsCACSlotSpecificItemEquipped( element, controller, "bonuscard_primary_gunfighter" )
				if f8_local0 then
					f8_local0 = IsCACEquippedWildcardItemCount( menu, "bonuscard_primary_gunfighter", 1 )
				end
				return f8_local0
			end
		},
		{
			stateName = "Equipped2",
			condition = function ( menu, element, event )
				local f9_local0 = IsCACSlotSpecificItemEquipped( element, controller, "bonuscard_primary_gunfighter" )
				if f9_local0 then
					f9_local0 = IsCACEquippedWildcardItemCount( menu, "bonuscard_primary_gunfighter", 2 )
				end
				return f9_local0
			end
		},
		{
			stateName = "Equipped3",
			condition = function ( menu, element, event )
				local f10_local0 = IsCACSlotSpecificItemEquipped( element, controller, "bonuscard_primary_gunfighter" )
				if f10_local0 then
					f10_local0 = IsCACEquippedWildcardItemCount( menu, "bonuscard_primary_gunfighter", 3 )
				end
				return f10_local0
			end
		}
