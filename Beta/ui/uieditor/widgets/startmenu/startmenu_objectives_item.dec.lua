	...
	self:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				local f9_local0 = PropertyIsTrue( self, "subobjective" )
				if f9_local0 then
					f9_local0 = PropertyIsTrue( self, "completed" )
				end
				return f9_local0
			end
		},
		...
		},
		{
			...
			condition = function ( menu, element, event )
				local f11_local0 = PropertyIsTrue( self, "awaitingOrders" )
				if f11_local0 then
					f11_local0 = PropertyIsTrue( self, "subobjective" )
				end
				return f11_local0
			end
		},
