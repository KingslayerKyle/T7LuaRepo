	...
	self:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				local f32_local0 = IsGamepad( controller )
				if f32_local0 then
					f32_local0 = FirstTimeSetup_Overview( controller )
				end
				return f32_local0
			end
		},
		{
			...
			condition = function ( menu, element, event )
				local f33_local0 = FirstTimeSetup_ChangedCharacter( controller )
				if f33_local0 then
					f33_local0 = IsGamepad( controller )
				end
				return f33_local0
			end
		},
		{
			...
			condition = function ( menu, element, event )
				local f34_local0 = IsGamepad( controller )
				if f34_local0 then
					f34_local0 = FirstTimeSetup_Complete( controller )
				end
				return f34_local0
			end
		},
		...
		},
		{
			...
			condition = function ( menu, element, event )
				local f37_local0 = IsPC()
				if f37_local0 then
					f37_local0 = IsGamepad( controller )
				end
				return f37_local0
			end
		}
