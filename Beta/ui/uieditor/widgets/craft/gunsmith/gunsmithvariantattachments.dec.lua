...
CoD.GunsmithVariantAttachments.new = function ( menu, controller )
	...
	OpticsHeader:linkToElementModel( "attachmentType", true, function ( model )
	...
	AttachmentsHeader:linkToElementModel( "attachmentType", true, function ( model )
	...
	PaintjobHeader:linkToElementModel( "attachmentType", true, function ( model )
	...
	CamoHeader:linkToElementModel( "attachmentType", true, function ( model )
