...
CoD.WeaponBuildKitsVariantAttachments.new = function ( menu, controller )
	...
	Optic:linkToElementModel( "attachment1", true, function ( model )
		local element = Optic
		local event = {
	...
	Attachment1:linkToElementModel( "attachment2", true, function ( model )
	...
	Attachment2:linkToElementModel( "attachment3", true, function ( model )
	...
	Attachment3:linkToElementModel( "attachment4", true, function ( model )
	...
	Attachment4:linkToElementModel( "attachment5", true, function ( model )
	...
	Attachment5:linkToElementModel( "attachment6", true, function ( model )
	...
	paintjob:linkToElementModel( "paintjobIndex", true, function ( model )
	...
	paintjob:linkToElementModel( "paintjobSlot", true, function ( model )
		local element = paintjob
		local event = {
			controller = controller,
			name = "model_validation",
	...
	Camo:linkToElementModel( "camoIndex", true, function ( model )
		local element = Camo
		local event = {
			controller = controller,
			name = "model_validation",
