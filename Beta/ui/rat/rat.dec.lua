...
f0_local0 = function ( trackingId, menu, steps, step, ignoreFirstDelay )
	...
	Engine.RatTransactionCompleted( trackingId, nil )
end
...
Rat.SimulateDPadButton = function ( menu, controller, direction )
	menu:processEvent( {
		name = "gamepad_button",
...
local RatMenuInfo_New = function ()
	local builder = {
		...
		result = {},
		result = "Unknown",
		setMenuName = RatMenuInfo_SetMenuName
	}
	return builder
end
