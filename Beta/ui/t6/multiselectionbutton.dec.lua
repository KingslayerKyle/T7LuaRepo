...
CoD.MultiSelectionButton.New = function ( defaultAnimationState, actionEventName, fontName, buttonIndex, menu, controller )
	local multiSelectionButton = CoD.CoD9Button.new( defaultAnimationState, actionEventName, nil, menu, controller )
