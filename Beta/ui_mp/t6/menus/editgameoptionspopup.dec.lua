...
LUI.createMenu.EditGameOptions = function ( controller )
	...
	self.resetToDefaultButton = CoD.ButtonPrompt.new( "select", Engine.Localize( "MENU_RESET_TO_DEFAULT" ), self, "button_prompt_reset_to_default", false, false, false, false, "R" )
	self:addRightButtonPrompt( self.resetToDefaultButton )
	self.saveButton = CoD.ButtonPrompt.new( "alt1", Engine.Localize( "MENU_SAVE" ), self, "button_prompt_save_game_settings", false, false, false, false, "S" )
